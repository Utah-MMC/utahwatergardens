...
const Pond-dredgingUintahPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Uintah | Professional Pond Dredging Services"
        description="Expert pond dredging services in Uintah. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, uintah pond dredging, pond dredging uintah"
        canonical="https://utahwatergardens.com/pond-dredging-uintah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Uintah",
          "description": "Professional pond dredging services in Uintah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Uintah"
        subtitle="Professional pond services for Pond Dredging Services in Uintah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Uintah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Uintah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Uintah Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Uintah Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Uintah Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Uintah Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingUintahPage;