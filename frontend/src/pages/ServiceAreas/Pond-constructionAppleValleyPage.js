...
const Pond-constructionAppleValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Apple Valley | Professional Pond Construction Services"
        description="Expert pond construction services in Apple Valley. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, apple valley pond construction, pond construction apple valley"
        canonical="https://utahwatergardens.com/pond-construction-apple-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Apple Valley",
          "description": "Professional pond construction services in Apple Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Apple Valley"
        subtitle="Professional pond services for Pond Construction Services in Apple Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Apple Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Apple Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Apple Valley Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Apple Valley Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Apple Valley Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Apple Valley Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionAppleValleyPage;