...
const Pond-cleaningMagnaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Magna | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Magna. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, magna pond cleaning, pond cleaning magna"
        canonical="https://utahwatergardens.com/pond-cleaning-magna"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Magna",
          "description": "Professional pond cleaning services in Magna",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Magna"
        subtitle="Professional pond services for Pond Cleaning Services in Magna and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Magna"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Magna</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Magna Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Magna Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Magna Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Magna Customers Say About Our Pond Cleaning</h2>
