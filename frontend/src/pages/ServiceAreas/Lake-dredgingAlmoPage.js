...
const Lake-dredgingAlmoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Almo | Professional Lake Dredging Services"
        description="Expert lake dredging services in Almo. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, almo lake dredging, lake dredging almo"
        canonical="https://utahwatergardens.com/lake-dredging-almo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Almo",
          "description": "Professional lake dredging services in Almo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Almo"
        subtitle="Professional pond services for Lake Dredging Services in Almo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Almo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Almo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Almo Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Almo Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Almo Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Almo Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAlmoPage;