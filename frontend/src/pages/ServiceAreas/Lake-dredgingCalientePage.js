...
const Lake-dredgingCalientePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Caliente | Professional Lake Dredging Services"
        description="Expert lake dredging services in Caliente. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, caliente lake dredging, lake dredging caliente"
        canonical="https://utahwatergardens.com/lake-dredging-caliente"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Caliente",
          "description": "Professional lake dredging services in Caliente",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Caliente"
        subtitle="Professional pond services for Lake Dredging Services in Caliente and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Caliente"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Caliente</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Caliente Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Caliente Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Caliente Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Caliente Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingCalientePage;