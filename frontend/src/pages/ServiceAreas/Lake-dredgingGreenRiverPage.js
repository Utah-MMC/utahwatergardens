...
const Lake-dredgingGreenRiverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Green River | Professional Lake Dredging Services"
        description="Expert lake dredging services in Green River. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, green river lake dredging, lake dredging green river"
        canonical="https://utahwatergardens.com/lake-dredging-green-river"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Green River",
          "description": "Professional lake dredging services in Green River",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Green River"
        subtitle="Professional pond services for Lake Dredging Services in Green River and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Green River"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Green River</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Green River Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Green River Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Green River Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Green River Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingGreenRiverPage;