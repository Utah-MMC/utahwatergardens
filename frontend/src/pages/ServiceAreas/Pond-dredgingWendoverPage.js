...
const Pond-dredgingWendoverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Wendover | Professional Pond Dredging Services"
        description="Expert pond dredging services in Wendover. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, wendover pond dredging, pond dredging wendover"
        canonical="https://utahwatergardens.com/pond-dredging-wendover"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Wendover",
          "description": "Professional pond dredging services in Wendover",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Wendover"
        subtitle="Professional pond services for Pond Dredging Services in Wendover and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Wendover"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Wendover</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wendover Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wendover Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wendover Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wendover Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWendoverPage;