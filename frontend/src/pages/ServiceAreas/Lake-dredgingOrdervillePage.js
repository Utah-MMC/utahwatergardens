...
const Lake-dredgingOrdervillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Orderville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Orderville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, orderville lake dredging, lake dredging orderville"
        canonical="https://utahwatergardens.com/lake-dredging-orderville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Orderville",
          "description": "Professional lake dredging services in Orderville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Orderville"
        subtitle="Professional pond services for Lake Dredging Services in Orderville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Orderville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Orderville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Orderville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Orderville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Orderville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Orderville Customers Say About Our Lake Dredging</h2>
