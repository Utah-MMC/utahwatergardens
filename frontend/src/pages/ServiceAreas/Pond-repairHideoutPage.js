...
const Pond-repairHideoutPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Hideout | Professional Pond Repair Services"
        description="Expert pond repair services in Hideout. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, hideout pond repair, pond repair hideout"
        canonical="https://utahwatergardens.com/pond-repair-hideout"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Hideout",
          "description": "Professional pond repair services in Hideout",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Hideout"
        subtitle="Professional pond services for Pond Repair Services in Hideout and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Hideout"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Hideout</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hideout Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hideout Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hideout Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hideout Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHideoutPage;