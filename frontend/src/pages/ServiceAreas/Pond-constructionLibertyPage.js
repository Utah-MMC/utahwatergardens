...
const Pond-constructionLibertyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Liberty | Professional Pond Construction Services"
        description="Expert pond construction services in Liberty. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, liberty pond construction, pond construction liberty"
        canonical="https://utahwatergardens.com/pond-construction-liberty"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Liberty",
          "description": "Professional pond construction services in Liberty",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Liberty"
        subtitle="Professional pond services for Pond Construction Services in Liberty and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Liberty"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Liberty</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Liberty Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Liberty Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Liberty Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Liberty Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionLibertyPage;