...
const Pond-repairUconPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Ucon | Professional Pond Repair Services"
        description="Expert pond repair services in Ucon. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, ucon pond repair, pond repair ucon"
        canonical="https://utahwatergardens.com/pond-repair-ucon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Ucon",
          "description": "Professional pond repair services in Ucon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Ucon"
        subtitle="Professional pond services for Pond Repair Services in Ucon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Ucon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Ucon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ucon Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ucon Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ucon Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ucon Customers Say About Our Pond Repair</h2>
...
export default Pond-repairUconPage;