...
const Pond-dredgingFruitlandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Fruitland | Professional Pond Dredging Services"
        description="Expert pond dredging services in Fruitland. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, fruitland pond dredging, pond dredging fruitland"
        canonical="https://utahwatergardens.com/pond-dredging-fruitland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Fruitland",
          "description": "Professional pond dredging services in Fruitland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Fruitland"
        subtitle="Professional pond services for Pond Dredging Services in Fruitland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Fruitland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Fruitland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruitland Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruitland Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruitland Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruitland Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFruitlandPage;