...
const Pond-repairMaltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Malta | Professional Pond Repair Services"
        description="Expert pond repair services in Malta. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, malta pond repair, pond repair malta"
        canonical="https://utahwatergardens.com/pond-repair-malta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Malta",
          "description": "Professional pond repair services in Malta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Malta"
        subtitle="Professional pond services for Pond Repair Services in Malta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Malta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Malta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Malta Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Malta Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Malta Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Malta Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMaltaPage;