...
const HarvestingMurtaughPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Murtaugh | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Murtaugh. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, murtaugh aquatic plant harvesting, aquatic plant harvesting murtaugh"
        canonical="https://utahwatergardens.com/harvesting-murtaugh"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Murtaugh",
          "description": "Professional aquatic plant harvesting services in Murtaugh",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Murtaugh"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Murtaugh and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Murtaugh"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Murtaugh</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Murtaugh Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3021.9346!2d-111.8910!3d40.7608!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8752f38c0c0c0c0c%3A0x0c0c0c0c0c0c0c0c!2sMurtaugh!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen=""
                  ...
                  title="Murtaugh Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Murtaugh Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Murtaugh Customers Say About Our Aquatic Plant Harvesting</h2>
...
export default HarvestingMurtaughPage;