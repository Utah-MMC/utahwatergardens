...
const Lake-dredgingJordanellePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Jordanelle | Professional Lake Dredging Services"
        description="Expert lake dredging services in Jordanelle. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, jordanelle lake dredging, lake dredging jordanelle"
        canonical="https://utahwatergardens.com/lake-dredging-jordanelle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Jordanelle",
          "description": "Professional lake dredging services in Jordanelle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Jordanelle"
        subtitle="Professional pond services for Lake Dredging Services in Jordanelle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Jordanelle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Jordanelle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jordanelle Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jordanelle Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jordanelle Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jordanelle Customers Say About Our Lake Dredging</h2>
