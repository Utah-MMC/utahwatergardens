...
const Pond-dredgingSpringValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Spring Valley | Professional Pond Dredging Services"
        description="Expert pond dredging services in Spring Valley. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, spring valley pond dredging, pond dredging spring valley"
        canonical="https://utahwatergardens.com/pond-dredging-spring-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Spring Valley",
          "description": "Professional pond dredging services in Spring Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Spring Valley"
        subtitle="Professional pond services for Pond Dredging Services in Spring Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Spring Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Spring Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spring Valley Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spring Valley Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spring Valley Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spring Valley Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSpringValleyPage;