...
const Pond-constructionNewHarmonyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction New Harmony | Professional Pond Construction Services"
        description="Expert pond construction services in New Harmony. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, new harmony pond construction, pond construction new harmony"
        canonical="https://utahwatergardens.com/pond-construction-new-harmony"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services New Harmony",
          "description": "Professional pond construction services in New Harmony",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in New Harmony"
        subtitle="Professional pond services for Pond Construction Services in New Harmony and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in New Harmony"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in New Harmony</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Harmony Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Harmony Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Harmony Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Harmony Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionNewHarmonyPage;