...
const Pond-repairKaysvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Kaysville | Professional Pond Repair Services"
        description="Expert pond repair services in Kaysville. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, kaysville pond repair, pond repair kaysville"
        canonical="https://utahwatergardens.com/pond-repair-kaysville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Kaysville",
          "description": "Professional pond repair services in Kaysville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Kaysville"
        subtitle="Professional pond services for Pond Repair Services in Kaysville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Kaysville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Kaysville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kaysville Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kaysville Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kaysville Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kaysville Customers Say About Our Pond Repair</h2>
...
export default Pond-repairKaysvillePage;