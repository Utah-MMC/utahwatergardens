...
const Pond-maintenanceWashingtonTerracePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Washington Terrace | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Washington Terrace. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, washington terrace pond maintenance, pond maintenance washington terrace"
        canonical="https://utahwatergardens.com/pond-maintenance-washington-terrace"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Washington Terrace",
          "description": "Professional pond maintenance services in Washington Terrace",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Washington Terrace"
        subtitle="Professional pond services for Pond Maintenance Services in Washington Terrace and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Washington Terrace"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Washington Terrace</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Washington Terrace Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Washington Terrace Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Washington Terrace Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Washington Terrace Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceWashingtonTerracePage;