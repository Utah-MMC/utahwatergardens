...
const Lake-dredgingGardnervillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Gardnerville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Gardnerville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, gardnerville lake dredging, lake dredging gardnerville"
        canonical="https://utahwatergardens.com/lake-dredging-gardnerville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Gardnerville",
          "description": "Professional lake dredging services in Gardnerville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Gardnerville"
        subtitle="Professional pond services for Lake Dredging Services in Gardnerville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Gardnerville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Gardnerville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gardnerville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gardnerville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gardnerville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gardnerville Customers Say About Our Lake Dredging</h2>
