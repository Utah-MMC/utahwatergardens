...
const Pond-dredgingBluebellPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Bluebell | Professional Pond Dredging Services"
        description="Expert pond dredging services in Bluebell. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, bluebell pond dredging, pond dredging bluebell"
        canonical="https://utahwatergardens.com/pond-dredging-bluebell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Bluebell",
          "description": "Professional pond dredging services in Bluebell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Bluebell"
        subtitle="Professional pond services for Pond Dredging Services in Bluebell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Bluebell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Bluebell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bluebell Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bluebell Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bluebell Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bluebell Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBluebellPage;