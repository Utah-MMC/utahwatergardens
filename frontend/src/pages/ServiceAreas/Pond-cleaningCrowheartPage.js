...
const Pond-cleaningCrowheartPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Crowheart | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Crowheart. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, crowheart pond cleaning, pond cleaning crowheart"
        canonical="https://utahwatergardens.com/pond-cleaning-crowheart"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Crowheart",
          "description": "Professional pond cleaning services in Crowheart",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Crowheart"
        subtitle="Professional pond services for Pond Cleaning Services in Crowheart and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Crowheart"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Crowheart</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crowheart Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crowheart Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crowheart Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crowheart Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCrowheartPage;