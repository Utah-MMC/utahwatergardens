...
const Lake-dredgingHomedalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Homedale | Professional Lake Dredging Services"
        description="Expert lake dredging services in Homedale. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, homedale lake dredging, lake dredging homedale"
        canonical="https://utahwatergardens.com/lake-dredging-homedale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Homedale",
          "description": "Professional lake dredging services in Homedale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Homedale"
        subtitle="Professional pond services for Lake Dredging Services in Homedale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Homedale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Homedale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Homedale Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Homedale Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Homedale Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Homedale Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingHomedalePage;