...
const Pond-constructionDuchesnePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Duchesne | Professional Pond Construction Services"
        description="Expert pond construction services in Duchesne. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, duchesne pond construction, pond construction duchesne"
        canonical="https://utahwatergardens.com/pond-construction-duchesne"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Duchesne",
          "description": "Professional pond construction services in Duchesne",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Duchesne"
        subtitle="Professional pond services for Pond Construction Services in Duchesne and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Duchesne"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Duchesne</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Duchesne Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Duchesne Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Duchesne Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Duchesne Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionDuchesnePage;