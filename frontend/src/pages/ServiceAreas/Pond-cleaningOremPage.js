...
const Pond-cleaningOremPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Orem | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Orem. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, orem pond cleaning, pond cleaning orem"
        canonical="https://utahwatergardens.com/pond-cleaning-orem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Orem",
          "description": "Professional pond cleaning services in Orem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Orem"
        subtitle="Professional pond services for Pond Cleaning Services in Orem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Orem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Orem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Orem Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Orem Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Orem Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Orem Customers Say About Our Pond Cleaning</h2>
