...
const Lake-dredgingLibertyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Liberty | Professional Lake Dredging Services"
        description="Expert lake dredging services in Liberty. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, liberty lake dredging, lake dredging liberty"
        canonical="https://utahwatergardens.com/lake-dredging-liberty"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Liberty",
          "description": "Professional lake dredging services in Liberty",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Liberty"
        subtitle="Professional pond services for Lake Dredging Services in Liberty and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Liberty"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Liberty</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Liberty Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Liberty Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Liberty Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Liberty Customers Say About Our Lake Dredging</h2>
