...
const Pond-cleaningOntarioPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Ontario | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Ontario. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, ontario pond cleaning, pond cleaning ontario"
        canonical="https://utahwatergardens.com/pond-cleaning-ontario"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Ontario",
          "description": "Professional pond cleaning services in Ontario",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Ontario"
        subtitle="Professional pond services for Pond Cleaning Services in Ontario and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Ontario"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Ontario</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ontario Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ontario Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ontario Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ontario Customers Say About Our Pond Cleaning</h2>
