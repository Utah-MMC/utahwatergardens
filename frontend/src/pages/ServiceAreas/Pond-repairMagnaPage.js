...
const Pond-repairMagnaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Magna | Professional Pond Repair Services"
        description="Expert pond repair services in Magna. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, magna pond repair, pond repair magna"
        canonical="https://utahwatergardens.com/pond-repair-magna"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Magna",
          "description": "Professional pond repair services in Magna",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Magna"
        subtitle="Professional pond services for Pond Repair Services in Magna and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Magna"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Magna</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Magna Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Magna Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Magna Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Magna Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMagnaPage;