...
const Lake-dredgingKamasPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Kamas | Professional Lake Dredging Services"
        description="Expert lake dredging services in Kamas. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, kamas lake dredging, lake dredging kamas"
        canonical="https://utahwatergardens.com/lake-dredging-kamas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Kamas",
          "description": "Professional lake dredging services in Kamas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Kamas"
        subtitle="Professional pond services for Lake Dredging Services in Kamas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Kamas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Kamas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kamas Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kamas Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kamas Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kamas Customers Say About Our Lake Dredging</h2>
