...
const Lake-dredgingBothwellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Bothwell | Professional Lake Dredging Services"
        description="Expert lake dredging services in Bothwell. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, bothwell lake dredging, lake dredging bothwell"
        canonical="https://utahwatergardens.com/lake-dredging-bothwell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Bothwell",
          "description": "Professional lake dredging services in Bothwell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Bothwell"
        subtitle="Professional pond services for Lake Dredging Services in Bothwell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Bothwell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Bothwell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bothwell Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bothwell Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bothwell Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bothwell Customers Say About Our Lake Dredging</h2>
