...
const Pond-repairLanderPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lander | Professional Pond Repair Services"
        description="Expert pond repair services in Lander. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lander pond repair, pond repair lander"
        canonical="https://utahwatergardens.com/pond-repair-lander"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lander",
          "description": "Professional pond repair services in Lander",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lander"
        subtitle="Professional pond services for Pond Repair Services in Lander and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lander"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lander</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lander Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lander Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lander Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lander Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLanderPage;