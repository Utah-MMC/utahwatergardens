...
const Pond-dredgingDeweyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Dewey | Professional Pond Dredging Services"
        description="Expert pond dredging services in Dewey. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, dewey pond dredging, pond dredging dewey"
        canonical="https://utahwatergardens.com/pond-dredging-dewey"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Dewey",
          "description": "Professional pond dredging services in Dewey",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Dewey"
        subtitle="Professional pond services for Pond Dredging Services in Dewey and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Dewey"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Dewey</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dewey Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dewey Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dewey Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dewey Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingDeweyPage;