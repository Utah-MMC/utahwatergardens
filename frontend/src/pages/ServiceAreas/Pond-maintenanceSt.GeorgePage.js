...
const Pond-maintenanceSt.GeorgePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance St. George | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in St. George. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, st. george pond maintenance, pond maintenance st. george"
        canonical="https://utahwatergardens.com/pond-maintenance-st.-george"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services St. George",
          "description": "Professional pond maintenance services in St. George",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in St. George"
        subtitle="Professional pond services for Pond Maintenance Services in St. George and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in St. George"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in St. George</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. George Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. George Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. George Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. George Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSt.GeorgePage;