...
const Pond-repairSt.StephensPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair St. Stephens | Professional Pond Repair Services"
        description="Expert pond repair services in St. Stephens. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, st. stephens pond repair, pond repair st. stephens"
        canonical="https://utahwatergardens.com/pond-repair-st.-stephens"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services St. Stephens",
          "description": "Professional pond repair services in St. Stephens",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in St. Stephens"
        subtitle="Professional pond services for Pond Repair Services in St. Stephens and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in St. Stephens"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in St. Stephens</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. Stephens Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. Stephens Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. Stephens Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. Stephens Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSt.StephensPage;