...
const Pond-cleaningJeromePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Jerome | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Jerome. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, jerome pond cleaning, pond cleaning jerome"
        canonical="https://utahwatergardens.com/pond-cleaning-jerome"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Jerome",
          "description": "Professional pond cleaning services in Jerome",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Jerome"
        subtitle="Professional pond services for Pond Cleaning Services in Jerome and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Jerome"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Jerome</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jerome Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jerome Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jerome Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jerome Customers Say About Our Pond Cleaning</h2>
