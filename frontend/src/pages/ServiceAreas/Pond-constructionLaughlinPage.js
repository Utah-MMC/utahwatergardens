...
const Pond-constructionLaughlinPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Laughlin | Professional Pond Construction Services"
        description="Expert pond construction services in Laughlin. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, laughlin pond construction, pond construction laughlin"
        canonical="https://utahwatergardens.com/pond-construction-laughlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Laughlin",
          "description": "Professional pond construction services in Laughlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Laughlin"
        subtitle="Professional pond services for Pond Construction Services in Laughlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Laughlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Laughlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Laughlin Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Laughlin Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Laughlin Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Laughlin Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionLaughlinPage;