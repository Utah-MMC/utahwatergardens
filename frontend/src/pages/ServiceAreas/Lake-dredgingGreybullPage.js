...
const Lake-dredgingGreybullPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Greybull | Professional Lake Dredging Services"
        description="Expert lake dredging services in Greybull. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, greybull lake dredging, lake dredging greybull"
        canonical="https://utahwatergardens.com/lake-dredging-greybull"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Greybull",
          "description": "Professional lake dredging services in Greybull",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Greybull"
        subtitle="Professional pond services for Lake Dredging Services in Greybull and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Greybull"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Greybull</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Greybull Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Greybull Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Greybull Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Greybull Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingGreybullPage;