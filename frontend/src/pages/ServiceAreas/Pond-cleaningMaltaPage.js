...
const Pond-cleaningMaltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Malta | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Malta. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, malta pond cleaning, pond cleaning malta"
        canonical="https://utahwatergardens.com/pond-cleaning-malta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Malta",
          "description": "Professional pond cleaning services in Malta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Malta"
        subtitle="Professional pond services for Pond Cleaning Services in Malta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Malta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Malta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Malta Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Malta Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Malta Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Malta Customers Say About Our Pond Cleaning</h2>
