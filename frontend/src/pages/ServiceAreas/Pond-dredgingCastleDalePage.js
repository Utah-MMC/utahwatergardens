...
const Pond-dredgingCastleDalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Castle Dale | Professional Pond Dredging Services"
        description="Expert pond dredging services in Castle Dale. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, castle dale pond dredging, pond dredging castle dale"
        canonical="https://utahwatergardens.com/pond-dredging-castle-dale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Castle Dale",
          "description": "Professional pond dredging services in Castle Dale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Castle Dale"
        subtitle="Professional pond services for Pond Dredging Services in Castle Dale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Castle Dale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Castle Dale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Castle Dale Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Castle Dale Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Castle Dale Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Castle Dale Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCastleDalePage;