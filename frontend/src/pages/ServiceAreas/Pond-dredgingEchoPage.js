...
const Pond-dredgingEchoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Echo | Professional Pond Dredging Services"
        description="Expert pond dredging services in Echo. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, echo pond dredging, pond dredging echo"
        canonical="https://utahwatergardens.com/pond-dredging-echo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Echo",
          "description": "Professional pond dredging services in Echo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Echo"
        subtitle="Professional pond services for Pond Dredging Services in Echo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Echo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Echo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Echo Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Echo Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Echo Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Echo Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingEchoPage;