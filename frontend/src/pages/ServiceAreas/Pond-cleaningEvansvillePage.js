...
const Pond-cleaningEvansvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Evansville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Evansville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, evansville pond cleaning, pond cleaning evansville"
        canonical="https://utahwatergardens.com/pond-cleaning-evansville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Evansville",
          "description": "Professional pond cleaning services in Evansville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Evansville"
        subtitle="Professional pond services for Pond Cleaning Services in Evansville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Evansville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Evansville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Evansville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Evansville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Evansville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Evansville Customers Say About Our Pond Cleaning</h2>
