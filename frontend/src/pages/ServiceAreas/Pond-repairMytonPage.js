...
const Pond-repairMytonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Myton | Professional Pond Repair Services"
        description="Expert pond repair services in Myton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, myton pond repair, pond repair myton"
        canonical="https://utahwatergardens.com/pond-repair-myton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Myton",
          "description": "Professional pond repair services in Myton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Myton"
        subtitle="Professional pond services for Pond Repair Services in Myton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Myton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Myton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Myton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Myton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Myton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Myton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMytonPage;