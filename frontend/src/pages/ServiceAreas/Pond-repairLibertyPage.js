...
const Pond-repairLibertyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Liberty | Professional Pond Repair Services"
        description="Expert pond repair services in Liberty. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, liberty pond repair, pond repair liberty"
        canonical="https://utahwatergardens.com/pond-repair-liberty"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Liberty",
          "description": "Professional pond repair services in Liberty",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Liberty"
        subtitle="Professional pond services for Pond Repair Services in Liberty and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Liberty"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Liberty</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Liberty Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Liberty Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Liberty Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Liberty Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLibertyPage;