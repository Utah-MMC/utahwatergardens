...
const Lake-dredgingKearnsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Kearns | Professional Lake Dredging Services"
        description="Expert lake dredging services in Kearns. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, kearns lake dredging, lake dredging kearns"
        canonical="https://utahwatergardens.com/lake-dredging-kearns"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Kearns",
          "description": "Professional lake dredging services in Kearns",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Kearns"
        subtitle="Professional pond services for Lake Dredging Services in Kearns and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Kearns"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Kearns</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kearns Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kearns Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kearns Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kearns Customers Say About Our Lake Dredging</h2>
