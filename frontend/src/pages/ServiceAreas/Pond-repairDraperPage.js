...
const Pond-repairDraperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Draper | Professional Pond Repair Services"
        description="Expert pond repair services in Draper. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, draper pond repair, pond repair draper"
        canonical="https://utahwatergardens.com/pond-repair-draper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Draper",
          "description": "Professional pond repair services in Draper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Draper"
        subtitle="Professional pond services for Pond Repair Services in Draper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Draper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Draper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Draper Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Draper Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Draper Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Draper Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDraperPage;