...
const Pond-repairSparksPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Sparks | Professional Pond Repair Services"
        description="Expert pond repair services in Sparks. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, sparks pond repair, pond repair sparks"
        canonical="https://utahwatergardens.com/pond-repair-sparks"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Sparks",
          "description": "Professional pond repair services in Sparks",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Sparks"
        subtitle="Professional pond services for Pond Repair Services in Sparks and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Sparks"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Sparks</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sparks Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sparks Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sparks Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sparks Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSparksPage;