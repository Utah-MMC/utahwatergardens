...
const Lake-dredgingVernonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Vernon | Professional Lake Dredging Services"
        description="Expert lake dredging services in Vernon. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, vernon lake dredging, lake dredging vernon"
        canonical="https://utahwatergardens.com/lake-dredging-vernon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Vernon",
          "description": "Professional lake dredging services in Vernon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Vernon"
        subtitle="Professional pond services for Lake Dredging Services in Vernon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Vernon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Vernon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vernon Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vernon Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vernon Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vernon Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingVernonPage;