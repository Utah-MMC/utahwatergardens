...
const Pond-dredgingElwoodPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Elwood | Professional Pond Dredging Services"
        description="Expert pond dredging services in Elwood. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, elwood pond dredging, pond dredging elwood"
        canonical="https://utahwatergardens.com/pond-dredging-elwood"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Elwood",
          "description": "Professional pond dredging services in Elwood",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Elwood"
        subtitle="Professional pond services for Pond Dredging Services in Elwood and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Elwood"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Elwood</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elwood Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elwood Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elwood Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elwood Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingElwoodPage;