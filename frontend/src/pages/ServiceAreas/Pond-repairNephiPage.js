...
const Pond-repairNephiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Nephi | Professional Pond Repair Services"
        description="Expert pond repair services in Nephi. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, nephi pond repair, pond repair nephi"
        canonical="https://utahwatergardens.com/pond-repair-nephi"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Nephi",
          "description": "Professional pond repair services in Nephi",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Nephi"
        subtitle="Professional pond services for Pond Repair Services in Nephi and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Nephi"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Nephi</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nephi Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nephi Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nephi Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nephi Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNephiPage;