...
const Pond-repairAuroraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Aurora | Professional Pond Repair Services"
        description="Expert pond repair services in Aurora. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, aurora pond repair, pond repair aurora"
        canonical="https://utahwatergardens.com/pond-repair-aurora"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Aurora",
          "description": "Professional pond repair services in Aurora",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Aurora"
        subtitle="Professional pond services for Pond Repair Services in Aurora and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Aurora"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Aurora</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aurora Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aurora Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aurora Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aurora Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAuroraPage;