...
const Pond-repairAlmoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Almo | Professional Pond Repair Services"
        description="Expert pond repair services in Almo. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, almo pond repair, pond repair almo"
        canonical="https://utahwatergardens.com/pond-repair-almo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Almo",
          "description": "Professional pond repair services in Almo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Almo"
        subtitle="Professional pond services for Pond Repair Services in Almo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Almo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Almo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Almo Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Almo Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Almo Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Almo Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAlmoPage;