...
const Pond-cleaningCarlinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Carlin | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Carlin. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, carlin pond cleaning, pond cleaning carlin"
        canonical="https://utahwatergardens.com/pond-cleaning-carlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Carlin",
          "description": "Professional pond cleaning services in Carlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Carlin"
        subtitle="Professional pond services for Pond Cleaning Services in Carlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Carlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Carlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carlin Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carlin Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carlin Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carlin Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCarlinPage;