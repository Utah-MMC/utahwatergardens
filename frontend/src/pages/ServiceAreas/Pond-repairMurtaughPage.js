...
const Pond-repairMurtaughPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Murtaugh | Professional Pond Repair Services"
        description="Expert pond repair services in Murtaugh. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, murtaugh pond repair, pond repair murtaugh"
        canonical="https://utahwatergardens.com/pond-repair-murtaugh"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Murtaugh",
          "description": "Professional pond repair services in Murtaugh",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Murtaugh"
        subtitle="Professional pond services for Pond Repair Services in Murtaugh and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Murtaugh"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Murtaugh</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Murtaugh Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Murtaugh Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Murtaugh Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Murtaugh Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMurtaughPage;