...
const Pond-maintenanceCrestedButtePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Crested Butte | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Crested Butte. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, crested butte pond maintenance, pond maintenance crested butte"
        canonical="https://utahwatergardens.com/pond-maintenance-crested-butte"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Crested Butte",
          "description": "Professional pond maintenance services in Crested Butte",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Crested Butte"
        subtitle="Professional pond services for Pond Maintenance Services in Crested Butte and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Crested Butte"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Crested Butte</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crested Butte Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crested Butte Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crested Butte Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crested Butte Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceCrestedButtePage;