...
const HarvestingNaturitaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Naturita | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Naturita. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, naturita aquatic plant harvesting, aquatic plant harvesting naturita"
        canonical="https://utahwatergardens.com/harvesting-naturita"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Naturita",
          "description": "Professional aquatic plant harvesting services in Naturita",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Naturita"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Naturita and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Naturita"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Naturita</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Naturita Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Naturita Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Naturita Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Naturita Customers Say About Our Aquatic Plant Harvesting</h2>
