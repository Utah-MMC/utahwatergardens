...
const Pond-cleaningNeolaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Neola | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Neola. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, neola pond cleaning, pond cleaning neola"
        canonical="https://utahwatergardens.com/pond-cleaning-neola"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Neola",
          "description": "Professional pond cleaning services in Neola",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Neola"
        subtitle="Professional pond services for Pond Cleaning Services in Neola and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Neola"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Neola</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Neola Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Neola Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Neola Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Neola Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningNeolaPage;