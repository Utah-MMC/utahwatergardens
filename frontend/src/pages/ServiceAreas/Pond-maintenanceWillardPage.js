...
const Pond-maintenanceWillardPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Willard | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Willard. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, willard pond maintenance, pond maintenance willard"
        canonical="https://utahwatergardens.com/pond-maintenance-willard"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Willard",
          "description": "Professional pond maintenance services in Willard",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Willard"
        subtitle="Professional pond services for Pond Maintenance Services in Willard and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Willard"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Willard</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Willard Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Willard Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Willard Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Willard Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceWillardPage;