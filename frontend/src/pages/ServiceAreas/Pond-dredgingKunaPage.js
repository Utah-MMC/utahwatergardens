...
const Pond-dredgingKunaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Kuna | Professional Pond Dredging Services"
        description="Expert pond dredging services in Kuna. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, kuna pond dredging, pond dredging kuna"
        canonical="https://utahwatergardens.com/pond-dredging-kuna"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Kuna",
          "description": "Professional pond dredging services in Kuna",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Kuna"
        subtitle="Professional pond services for Pond Dredging Services in Kuna and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Kuna"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Kuna</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kuna Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kuna Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kuna Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kuna Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingKunaPage;