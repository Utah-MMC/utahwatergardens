...
const Pond-repairNewCastlePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair New Castle | Professional Pond Repair Services"
        description="Expert pond repair services in New Castle. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, new castle pond repair, pond repair new castle"
        canonical="https://utahwatergardens.com/pond-repair-new-castle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services New Castle",
          "description": "Professional pond repair services in New Castle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in New Castle"
        subtitle="Professional pond services for Pond Repair Services in New Castle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in New Castle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in New Castle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Castle Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Castle Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Castle Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Castle Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNewCastlePage;