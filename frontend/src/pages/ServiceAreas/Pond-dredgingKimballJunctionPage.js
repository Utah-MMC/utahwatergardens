...
const Pond-dredgingKimballJunctionPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Kimball Junction | Professional Pond Dredging Services"
        description="Expert pond dredging services in Kimball Junction. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, kimball junction pond dredging, pond dredging kimball junction"
        canonical="https://utahwatergardens.com/pond-dredging-kimball-junction"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Kimball Junction",
          "description": "Professional pond dredging services in Kimball Junction",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Kimball Junction"
        subtitle="Professional pond services for Pond Dredging Services in Kimball Junction and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Kimball Junction"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Kimball Junction</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kimball Junction Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kimball Junction Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kimball Junction Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kimball Junction Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingKimballJunctionPage;