...
const Pond-cleaningRandlettPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Randlett | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Randlett. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, randlett pond cleaning, pond cleaning randlett"
        canonical="https://utahwatergardens.com/pond-cleaning-randlett"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Randlett",
          "description": "Professional pond cleaning services in Randlett",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Randlett"
        subtitle="Professional pond services for Pond Cleaning Services in Randlett and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Randlett"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Randlett</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Randlett Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Randlett Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Randlett Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Randlett Customers Say About Our Pond Cleaning</h2>
