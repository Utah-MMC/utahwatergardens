...
const Pond-repairGoshenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Goshen | Professional Pond Repair Services"
        description="Expert pond repair services in Goshen. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, goshen pond repair, pond repair goshen"
        canonical="https://utahwatergardens.com/pond-repair-goshen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Goshen",
          "description": "Professional pond repair services in Goshen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Goshen"
        subtitle="Professional pond services for Pond Repair Services in Goshen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Goshen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Goshen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goshen Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goshen Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goshen Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goshen Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGoshenPage;