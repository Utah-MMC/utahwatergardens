...
const Pond-repairGilbertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Gilbert | Professional Pond Repair Services"
        description="Expert pond repair services in Gilbert. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, gilbert pond repair, pond repair gilbert"
        canonical="https://utahwatergardens.com/pond-repair-gilbert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Gilbert",
          "description": "Professional pond repair services in Gilbert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Gilbert"
        subtitle="Professional pond services for Pond Repair Services in Gilbert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Gilbert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Gilbert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gilbert Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gilbert Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gilbert Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gilbert Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGilbertPage;