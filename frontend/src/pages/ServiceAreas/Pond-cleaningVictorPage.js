...
const Pond-cleaningVictorPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Victor | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Victor. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, victor pond cleaning, pond cleaning victor"
        canonical="https://utahwatergardens.com/pond-cleaning-victor"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Victor",
          "description": "Professional pond cleaning services in Victor",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Victor"
        subtitle="Professional pond services for Pond Cleaning Services in Victor and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Victor"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Victor</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Victor Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Victor Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Victor Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Victor Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningVictorPage;