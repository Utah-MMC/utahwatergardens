...
const HarvestingGarlandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Garland | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Garland. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, garland aquatic plant harvesting, aquatic plant harvesting garland"
        canonical="https://utahwatergardens.com/harvesting-garland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Garland",
          "description": "Professional aquatic plant harvesting services in Garland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Garland"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Garland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Garland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Garland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Garland Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Garland Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Garland Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Garland Customers Say About Our Aquatic Plant Harvesting</h2>
