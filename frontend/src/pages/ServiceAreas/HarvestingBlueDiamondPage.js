...
const HarvestingBlueDiamondPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Blue Diamond | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Blue Diamond. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, blue diamond aquatic plant harvesting, aquatic plant harvesting blue diamond"
        canonical="https://utahwatergardens.com/harvesting-blue-diamond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Blue Diamond",
          "description": "Professional aquatic plant harvesting services in Blue Diamond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Blue Diamond"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Blue Diamond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Blue Diamond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Blue Diamond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Blue Diamond Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Blue Diamond Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Blue Diamond Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Blue Diamond Customers Say About Our Aquatic Plant Harvesting</h2>
