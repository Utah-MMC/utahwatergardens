...
const Lake-dredgingPayettePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Payette | Professional Lake Dredging Services"
        description="Expert lake dredging services in Payette. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, payette lake dredging, lake dredging payette"
        canonical="https://utahwatergardens.com/lake-dredging-payette"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Payette",
          "description": "Professional lake dredging services in Payette",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Payette"
        subtitle="Professional pond services for Lake Dredging Services in Payette and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Payette"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Payette</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Payette Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Payette Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Payette Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Payette Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingPayettePage;