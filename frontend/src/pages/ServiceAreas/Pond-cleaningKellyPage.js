...
const Pond-cleaningKellyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Kelly | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Kelly. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, kelly pond cleaning, pond cleaning kelly"
        canonical="https://utahwatergardens.com/pond-cleaning-kelly"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Kelly",
          "description": "Professional pond cleaning services in Kelly",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Kelly"
        subtitle="Professional pond services for Pond Cleaning Services in Kelly and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Kelly"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Kelly</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kelly Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kelly Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kelly Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kelly Customers Say About Our Pond Cleaning</h2>
