...
const Pond-dredgingChinoValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Chino Valley | Professional Pond Dredging Services"
        description="Expert pond dredging services in Chino Valley. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, chino valley pond dredging, pond dredging chino valley"
        canonical="https://utahwatergardens.com/pond-dredging-chino-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Chino Valley",
          "description": "Professional pond dredging services in Chino Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Chino Valley"
        subtitle="Professional pond services for Pond Dredging Services in Chino Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Chino Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Chino Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Chino Valley Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Chino Valley Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Chino Valley Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Chino Valley Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingChinoValleyPage;