...
const Lake-dredgingMeeteetsePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Meeteetse | Professional Lake Dredging Services"
        description="Expert lake dredging services in Meeteetse. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, meeteetse lake dredging, lake dredging meeteetse"
        canonical="https://utahwatergardens.com/lake-dredging-meeteetse"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Meeteetse",
          "description": "Professional lake dredging services in Meeteetse",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Meeteetse"
        subtitle="Professional pond services for Lake Dredging Services in Meeteetse and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Meeteetse"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Meeteetse</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Meeteetse Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Meeteetse Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Meeteetse Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Meeteetse Customers Say About Our Lake Dredging</h2>
