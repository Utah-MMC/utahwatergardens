...
const Pond-dredgingOremPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Orem | Professional Pond Dredging Services"
        description="Expert pond dredging services in Orem. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, orem pond dredging, pond dredging orem"
        canonical="https://utahwatergardens.com/pond-dredging-orem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Orem",
          "description": "Professional pond dredging services in Orem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Orem"
        subtitle="Professional pond services for Pond Dredging Services in Orem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Orem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Orem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Orem Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Orem Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Orem Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Orem Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingOremPage;