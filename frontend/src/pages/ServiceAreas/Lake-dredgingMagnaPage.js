...
const Lake-dredgingMagnaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Magna | Professional Lake Dredging Services"
        description="Expert lake dredging services in Magna. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, magna lake dredging, lake dredging magna"
        canonical="https://utahwatergardens.com/lake-dredging-magna"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Magna",
          "description": "Professional lake dredging services in Magna",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Magna"
        subtitle="Professional pond services for Lake Dredging Services in Magna and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Magna"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Magna</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Magna Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Magna Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Magna Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Magna Customers Say About Our Lake Dredging</h2>
