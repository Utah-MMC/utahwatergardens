...
const Pond-dredgingApacheJunctionPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Apache Junction | Professional Pond Dredging Services"
        description="Expert pond dredging services in Apache Junction. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, apache junction pond dredging, pond dredging apache junction"
        canonical="https://utahwatergardens.com/pond-dredging-apache-junction"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Apache Junction",
          "description": "Professional pond dredging services in Apache Junction",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Apache Junction"
        subtitle="Professional pond services for Pond Dredging Services in Apache Junction and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Apache Junction"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Apache Junction</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Apache Junction Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Apache Junction Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Apache Junction Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Apache Junction Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingApacheJunctionPage;