...
const Pond-constructionSunCityWestPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Sun City West | Professional Pond Construction Services"
        description="Expert pond construction services in Sun City West. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, sun city west pond construction, pond construction sun city west"
        canonical="https://utahwatergardens.com/pond-construction-sun-city-west"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Sun City West",
          "description": "Professional pond construction services in Sun City West",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Sun City West"
        subtitle="Professional pond services for Pond Construction Services in Sun City West and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Sun City West"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Sun City West</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sun City West Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sun City West Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sun City West Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sun City West Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSunCityWestPage;