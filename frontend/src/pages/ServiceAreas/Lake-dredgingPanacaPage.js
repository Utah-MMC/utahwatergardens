...
const Lake-dredgingPanacaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Panaca | Professional Lake Dredging Services"
        description="Expert lake dredging services in Panaca. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, panaca lake dredging, lake dredging panaca"
        canonical="https://utahwatergardens.com/lake-dredging-panaca"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Panaca",
          "description": "Professional lake dredging services in Panaca",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Panaca"
        subtitle="Professional pond services for Lake Dredging Services in Panaca and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Panaca"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Panaca</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Panaca Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Panaca Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Panaca Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Panaca Customers Say About Our Lake Dredging</h2>
