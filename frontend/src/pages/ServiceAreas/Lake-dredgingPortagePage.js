...
const Lake-dredgingPortagePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Portage | Professional Lake Dredging Services"
        description="Expert lake dredging services in Portage. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, portage lake dredging, lake dredging portage"
        canonical="https://utahwatergardens.com/lake-dredging-portage"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Portage",
          "description": "Professional lake dredging services in Portage",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Portage"
        subtitle="Professional pond services for Lake Dredging Services in Portage and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Portage"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Portage</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Portage Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Portage Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Portage Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Portage Customers Say About Our Lake Dredging</h2>
