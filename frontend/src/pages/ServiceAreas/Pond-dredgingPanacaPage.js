...
const Pond-dredgingPanacaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Panaca | Professional Pond Dredging Services"
        description="Expert pond dredging services in Panaca. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, panaca pond dredging, pond dredging panaca"
        canonical="https://utahwatergardens.com/pond-dredging-panaca"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Panaca",
          "description": "Professional pond dredging services in Panaca",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Panaca"
        subtitle="Professional pond services for Pond Dredging Services in Panaca and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Panaca"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Panaca</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Panaca Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Panaca Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Panaca Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Panaca Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPanacaPage;