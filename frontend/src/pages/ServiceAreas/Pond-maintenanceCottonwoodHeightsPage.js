...
const Pond-maintenanceCottonwoodHeightsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Cottonwood Heights | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Cottonwood Heights. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, cottonwood heights pond maintenance, pond maintenance cottonwood heights"
        canonical="https://utahwatergardens.com/pond-maintenance-cottonwood-heights"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Cottonwood Heights",
          "description": "Professional pond maintenance services in Cottonwood Heights",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Cottonwood Heights"
        subtitle="Professional pond services for Pond Maintenance Services in Cottonwood Heights and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Cottonwood Heights"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Cottonwood Heights</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cottonwood Heights Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cottonwood Heights Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cottonwood Heights Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cottonwood Heights Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceCottonwoodHeightsPage;