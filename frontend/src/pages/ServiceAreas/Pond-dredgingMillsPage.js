...
const Pond-dredgingMillsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Mills | Professional Pond Dredging Services"
        description="Expert pond dredging services in Mills. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, mills pond dredging, pond dredging mills"
        canonical="https://utahwatergardens.com/pond-dredging-mills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Mills",
          "description": "Professional pond dredging services in Mills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Mills"
        subtitle="Professional pond services for Pond Dredging Services in Mills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Mills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Mills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mills Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mills Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mills Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mills Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMillsPage;