...
const Pond-dredgingOphirPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Ophir | Professional Pond Dredging Services"
        description="Expert pond dredging services in Ophir. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, ophir pond dredging, pond dredging ophir"
        canonical="https://utahwatergardens.com/pond-dredging-ophir"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Ophir",
          "description": "Professional pond dredging services in Ophir",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Ophir"
        subtitle="Professional pond services for Pond Dredging Services in Ophir and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Ophir"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Ophir</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ophir Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ophir Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ophir Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ophir Customers Say About Our Pond Dredging</h2>
