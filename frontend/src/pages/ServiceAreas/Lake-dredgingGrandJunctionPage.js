...
const Lake-dredgingGrandJunctionPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Grand Junction | Professional Lake Dredging Services"
        description="Expert lake dredging services in Grand Junction. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, grand junction lake dredging, lake dredging grand junction"
        canonical="https://utahwatergardens.com/lake-dredging-grand-junction"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Grand Junction",
          "description": "Professional lake dredging services in Grand Junction",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Grand Junction"
        subtitle="Professional pond services for Lake Dredging Services in Grand Junction and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Grand Junction"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Grand Junction</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Grand Junction Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Grand Junction Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Grand Junction Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Grand Junction Customers Say About Our Lake Dredging</h2>
