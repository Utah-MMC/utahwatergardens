...
const Pond-repairNeolaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Neola | Professional Pond Repair Services"
        description="Expert pond repair services in Neola. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, neola pond repair, pond repair neola"
        canonical="https://utahwatergardens.com/pond-repair-neola"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Neola",
          "description": "Professional pond repair services in Neola",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Neola"
        subtitle="Professional pond services for Pond Repair Services in Neola and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Neola"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Neola</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Neola Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Neola Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Neola Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Neola Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNeolaPage;