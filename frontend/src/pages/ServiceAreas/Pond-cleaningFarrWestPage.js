...
const Pond-cleaningFarrWestPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Farr West | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Farr West. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, farr west pond cleaning, pond cleaning farr west"
        canonical="https://utahwatergardens.com/pond-cleaning-farr-west"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Farr West",
          "description": "Professional pond cleaning services in Farr West",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Farr West"
        subtitle="Professional pond services for Pond Cleaning Services in Farr West and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Farr West"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Farr West</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farr West Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farr West Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farr West Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farr West Customers Say About Our Pond Cleaning</h2>
