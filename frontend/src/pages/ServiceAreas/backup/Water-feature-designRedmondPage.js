...
const Water-feature-designRedmondPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Redmond | Professional Water Feature Design Services"
        description="Expert water feature design services in Redmond. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, redmond water feature design, water feature design redmond"
        canonical="https://utahwatergardens.com/water-feature-design-redmond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Redmond",
          "description": "Professional water feature design services in Redmond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Redmond"
        subtitle="Professional pond services for Water Feature Design Services in Redmond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Redmond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Redmond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Redmond Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Redmond Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Redmond Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Redmond Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designRedmondPage;