...
const Pond-dredgingGoshenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Goshen | Professional Pond Dredging Services"
        description="Expert pond dredging services in Goshen. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, goshen pond dredging, pond dredging goshen"
        canonical="https://utahwatergardens.com/pond-dredging-goshen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Goshen",
          "description": "Professional pond dredging services in Goshen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Goshen"
        subtitle="Professional pond services for Pond Dredging Services in Goshen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Goshen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Goshen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goshen Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goshen Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goshen Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goshen Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingGoshenPage;