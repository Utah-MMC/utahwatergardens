...
const Lake-dredgingKimballJunctionPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Kimball Junction | Professional Lake Dredging Services"
        description="Expert lake dredging services in Kimball Junction. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, kimball junction lake dredging, lake dredging kimball junction"
        canonical="https://utahwatergardens.com/lake-dredging-kimball-junction"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Kimball Junction",
          "description": "Professional lake dredging services in Kimball Junction",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Kimball Junction"
        subtitle="Professional pond services for Lake Dredging Services in Kimball Junction and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Kimball Junction"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Kimball Junction</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kimball Junction Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kimball Junction Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kimball Junction Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kimball Junction Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingKimballJunctionPage;