...
const Pond-cleaningCrystalPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Crystal | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Crystal. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, crystal pond cleaning, pond cleaning crystal"
        canonical="https://utahwatergardens.com/pond-cleaning-crystal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Crystal",
          "description": "Professional pond cleaning services in Crystal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Crystal"
        subtitle="Professional pond services for Pond Cleaning Services in Crystal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Crystal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Crystal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crystal Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crystal Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crystal Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crystal Customers Say About Our Pond Cleaning</h2>
