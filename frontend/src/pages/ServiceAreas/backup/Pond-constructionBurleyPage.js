...
const Pond-constructionBurleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Burley | Professional Pond Construction Services"
        description="Expert pond construction services in Burley. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, burley pond construction, pond construction burley"
        canonical="https://utahwatergardens.com/pond-construction-burley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Burley",
          "description": "Professional pond construction services in Burley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Burley"
        subtitle="Professional pond services for Pond Construction Services in Burley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Burley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Burley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Burley Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Burley Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Burley Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Burley Customers Say About Our Pond Construction</h2>
