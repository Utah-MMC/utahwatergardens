...
const Pond-cleaningDuboisPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Dubois | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Dubois. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, dubois pond cleaning, pond cleaning dubois"
        canonical="https://utahwatergardens.com/pond-cleaning-dubois"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Dubois",
          "description": "Professional pond cleaning services in Dubois",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Dubois"
        subtitle="Professional pond services for Pond Cleaning Services in Dubois and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Dubois"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Dubois</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dubois Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dubois Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dubois Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dubois Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDuboisPage;