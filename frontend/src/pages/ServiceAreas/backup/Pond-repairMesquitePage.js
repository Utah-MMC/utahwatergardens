...
const Pond-repairMesquitePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Mesquite | Professional Pond Repair Services"
        description="Expert pond repair services in Mesquite. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, mesquite pond repair, pond repair mesquite"
        canonical="https://utahwatergardens.com/pond-repair-mesquite"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Mesquite",
          "description": "Professional pond repair services in Mesquite",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Mesquite"
        subtitle="Professional pond services for Pond Repair Services in Mesquite and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Mesquite"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Mesquite</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mesquite Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mesquite Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mesquite Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mesquite Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMesquitePage;