...
const Pond-repairIbapahPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Ibapah | Professional Pond Repair Services"
        description="Expert pond repair services in Ibapah. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, ibapah pond repair, pond repair ibapah"
        canonical="https://utahwatergardens.com/pond-repair-ibapah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Ibapah",
          "description": "Professional pond repair services in Ibapah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Ibapah"
        subtitle="Professional pond services for Pond Repair Services in Ibapah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Ibapah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Ibapah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ibapah Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ibapah Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ibapah Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ibapah Customers Say About Our Pond Repair</h2>
...
export default Pond-repairIbapahPage;