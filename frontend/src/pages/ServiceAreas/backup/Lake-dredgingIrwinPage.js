...
const Lake-dredgingIrwinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Irwin | Professional Lake Dredging Services"
        description="Expert lake dredging services in Irwin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, irwin lake dredging, lake dredging irwin"
        canonical="https://utahwatergardens.com/lake-dredging-irwin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Irwin",
          "description": "Professional lake dredging services in Irwin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Irwin"
        subtitle="Professional pond services for Lake Dredging Services in Irwin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Irwin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Irwin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Irwin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Irwin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Irwin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Irwin Customers Say About Our Lake Dredging</h2>
