...
const Lake-dredgingHuntleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Huntley | Professional Lake Dredging Services"
        description="Expert lake dredging services in Huntley. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, huntley lake dredging, lake dredging huntley"
        canonical="https://utahwatergardens.com/lake-dredging-huntley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Huntley",
          "description": "Professional lake dredging services in Huntley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Huntley"
        subtitle="Professional pond services for Lake Dredging Services in Huntley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Huntley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Huntley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntley Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntley Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntley Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntley Customers Say About Our Lake Dredging</h2>
