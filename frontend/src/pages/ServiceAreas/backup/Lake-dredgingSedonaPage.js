...
const Lake-dredgingSedonaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sedona | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sedona. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sedona lake dredging, lake dredging sedona"
        canonical="https://utahwatergardens.com/lake-dredging-sedona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sedona",
          "description": "Professional lake dredging services in Sedona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sedona"
        subtitle="Professional pond services for Lake Dredging Services in Sedona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sedona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sedona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sedona Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sedona Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sedona Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sedona Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSedonaPage;