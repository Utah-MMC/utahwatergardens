...
const Lake-dredgingCallaoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Callao | Professional Lake Dredging Services"
        description="Expert lake dredging services in Callao. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, callao lake dredging, lake dredging callao"
        canonical="https://utahwatergardens.com/lake-dredging-callao"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Callao",
          "description": "Professional lake dredging services in Callao",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Callao"
        subtitle="Professional pond services for Lake Dredging Services in Callao and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Callao"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Callao</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Callao Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Callao Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Callao Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Callao Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingCallaoPage;