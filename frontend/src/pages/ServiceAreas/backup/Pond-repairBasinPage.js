...
const Pond-repairBasinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Basin | Professional Pond Repair Services"
        description="Expert pond repair services in Basin. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, basin pond repair, pond repair basin"
        canonical="https://utahwatergardens.com/pond-repair-basin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Basin",
          "description": "Professional pond repair services in Basin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Basin"
        subtitle="Professional pond services for Pond Repair Services in Basin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Basin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Basin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Basin Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Basin Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Basin Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Basin Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBasinPage;