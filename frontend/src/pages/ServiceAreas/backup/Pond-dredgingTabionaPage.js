...
const Pond-dredgingTabionaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Tabiona | Professional Pond Dredging Services"
        description="Expert pond dredging services in Tabiona. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, tabiona pond dredging, pond dredging tabiona"
        canonical="https://utahwatergardens.com/pond-dredging-tabiona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Tabiona",
          "description": "Professional pond dredging services in Tabiona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Tabiona"
        subtitle="Professional pond services for Pond Dredging Services in Tabiona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Tabiona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Tabiona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tabiona Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tabiona Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tabiona Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tabiona Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingTabionaPage;