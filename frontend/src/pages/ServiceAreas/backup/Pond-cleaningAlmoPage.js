...
const Pond-cleaningAlmoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Almo | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Almo. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, almo pond cleaning, pond cleaning almo"
        canonical="https://utahwatergardens.com/pond-cleaning-almo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Almo",
          "description": "Professional pond cleaning services in Almo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Almo"
        subtitle="Professional pond services for Pond Cleaning Services in Almo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Almo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Almo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Almo Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Almo Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Almo Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Almo Customers Say About Our Pond Cleaning</h2>
