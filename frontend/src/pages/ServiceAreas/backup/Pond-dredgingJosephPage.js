...
const Pond-dredgingJosephPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Joseph | Professional Pond Dredging Services"
        description="Expert pond dredging services in Joseph. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, joseph pond dredging, pond dredging joseph"
        canonical="https://utahwatergardens.com/pond-dredging-joseph"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Joseph",
          "description": "Professional pond dredging services in Joseph",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Joseph"
        subtitle="Professional pond services for Pond Dredging Services in Joseph and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Joseph"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Joseph</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Joseph Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Joseph Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Joseph Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Joseph Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingJosephPage;