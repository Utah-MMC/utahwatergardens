...
const Lake-dredgingGilbertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Gilbert | Professional Lake Dredging Services"
        description="Expert lake dredging services in Gilbert. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, gilbert lake dredging, lake dredging gilbert"
        canonical="https://utahwatergardens.com/lake-dredging-gilbert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Gilbert",
          "description": "Professional lake dredging services in Gilbert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Gilbert"
        subtitle="Professional pond services for Lake Dredging Services in Gilbert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Gilbert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Gilbert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gilbert Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gilbert Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gilbert Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gilbert Customers Say About Our Lake Dredging</h2>
