...
const Pond-cleaningFruitHeightsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Fruit Heights | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Fruit Heights. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, fruit heights pond cleaning, pond cleaning fruit heights"
        canonical="https://utahwatergardens.com/pond-cleaning-fruit-heights"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Fruit Heights",
          "description": "Professional pond cleaning services in Fruit Heights",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Fruit Heights"
        subtitle="Professional pond services for Pond Cleaning Services in Fruit Heights and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Fruit Heights"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Fruit Heights</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruit Heights Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruit Heights Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruit Heights Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruit Heights Customers Say About Our Pond Cleaning</h2>
