...
const Pond-maintenanceAuroraPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Aurora | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Aurora. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, aurora pond maintenance, pond maintenance aurora"
        canonical="https://utahwatergardens.com/pond-maintenance-aurora"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Aurora",
          "description": "Professional pond maintenance services in Aurora",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Aurora"
        subtitle="Professional pond services for Pond Maintenance Services in Aurora and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Aurora"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Aurora</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aurora Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aurora Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aurora Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aurora Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceAuroraPage;