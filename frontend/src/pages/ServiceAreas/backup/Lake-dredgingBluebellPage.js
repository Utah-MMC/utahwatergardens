...
const Lake-dredgingBluebellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Bluebell | Professional Lake Dredging Services"
        description="Expert lake dredging services in Bluebell. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, bluebell lake dredging, lake dredging bluebell"
        canonical="https://utahwatergardens.com/lake-dredging-bluebell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Bluebell",
          "description": "Professional lake dredging services in Bluebell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Bluebell"
        subtitle="Professional pond services for Lake Dredging Services in Bluebell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Bluebell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Bluebell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bluebell Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bluebell Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bluebell Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bluebell Customers Say About Our Lake Dredging</h2>
