...
const Lake-dredgingMarsingPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Marsing | Professional Lake Dredging Services"
        description="Expert lake dredging services in Marsing. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, marsing lake dredging, lake dredging marsing"
        canonical="https://utahwatergardens.com/lake-dredging-marsing"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Marsing",
          "description": "Professional lake dredging services in Marsing",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Marsing"
        subtitle="Professional pond services for Lake Dredging Services in Marsing and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Marsing"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Marsing</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marsing Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marsing Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marsing Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marsing Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMarsingPage;