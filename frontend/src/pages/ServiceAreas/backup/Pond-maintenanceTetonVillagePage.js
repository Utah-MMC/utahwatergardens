...
const Pond-maintenanceTetonVillagePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Teton Village | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Teton Village. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, teton village pond maintenance, pond maintenance teton village"
        canonical="https://utahwatergardens.com/pond-maintenance-teton-village"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Teton Village",
          "description": "Professional pond maintenance services in Teton Village",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Teton Village"
        subtitle="Professional pond services for Pond Maintenance Services in Teton Village and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Teton Village"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Teton Village</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Teton Village Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Teton Village Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Teton Village Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Teton Village Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceTetonVillagePage;