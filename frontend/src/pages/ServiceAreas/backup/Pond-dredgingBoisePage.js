...
const Pond-dredgingBoisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Boise | Professional Pond Dredging Services"
        description="Expert pond dredging services in Boise. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, boise pond dredging, pond dredging boise"
        canonical="https://utahwatergardens.com/pond-dredging-boise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Boise",
          "description": "Professional pond dredging services in Boise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Boise"
        subtitle="Professional pond services for Pond Dredging Services in Boise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Boise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Boise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boise Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boise Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boise Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boise Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBoisePage;