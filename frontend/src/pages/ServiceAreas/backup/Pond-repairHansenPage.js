...
const Pond-repairHansenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Hansen | Professional Pond Repair Services"
        description="Expert pond repair services in Hansen. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, hansen pond repair, pond repair hansen"
        canonical="https://utahwatergardens.com/pond-repair-hansen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Hansen",
          "description": "Professional pond repair services in Hansen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Hansen"
        subtitle="Professional pond services for Pond Repair Services in Hansen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Hansen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Hansen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hansen Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hansen Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hansen Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hansen Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHansenPage;