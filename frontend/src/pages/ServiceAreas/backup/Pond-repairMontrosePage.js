...
const Pond-repairMontrosePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Montrose | Professional Pond Repair Services"
        description="Expert pond repair services in Montrose. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, montrose pond repair, pond repair montrose"
        canonical="https://utahwatergardens.com/pond-repair-montrose"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Montrose",
          "description": "Professional pond repair services in Montrose",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Montrose"
        subtitle="Professional pond services for Pond Repair Services in Montrose and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Montrose"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Montrose</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Montrose Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Montrose Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Montrose Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Montrose Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMontrosePage;