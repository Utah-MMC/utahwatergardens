...
const Lake-dredgingStocktonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Stockton | Professional Lake Dredging Services"
        description="Expert lake dredging services in Stockton. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, stockton lake dredging, lake dredging stockton"
        canonical="https://utahwatergardens.com/lake-dredging-stockton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Stockton",
          "description": "Professional lake dredging services in Stockton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Stockton"
        subtitle="Professional pond services for Lake Dredging Services in Stockton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Stockton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Stockton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Stockton Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Stockton Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Stockton Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Stockton Customers Say About Our Lake Dredging</h2>
