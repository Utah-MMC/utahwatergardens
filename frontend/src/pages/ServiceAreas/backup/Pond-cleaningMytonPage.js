...
const Pond-cleaningMytonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Myton | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Myton. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, myton pond cleaning, pond cleaning myton"
        canonical="https://utahwatergardens.com/pond-cleaning-myton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Myton",
          "description": "Professional pond cleaning services in Myton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Myton"
        subtitle="Professional pond services for Pond Cleaning Services in Myton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Myton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Myton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Myton Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Myton Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Myton Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Myton Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMytonPage;