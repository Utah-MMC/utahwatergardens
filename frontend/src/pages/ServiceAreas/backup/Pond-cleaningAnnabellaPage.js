...
const Pond-cleaningAnnabellaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Annabella | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Annabella. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, annabella pond cleaning, pond cleaning annabella"
        canonical="https://utahwatergardens.com/pond-cleaning-annabella"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Annabella",
          "description": "Professional pond cleaning services in Annabella",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Annabella"
        subtitle="Professional pond services for Pond Cleaning Services in Annabella and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Annabella"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Annabella</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Annabella Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Annabella Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Annabella Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Annabella Customers Say About Our Pond Cleaning</h2>
