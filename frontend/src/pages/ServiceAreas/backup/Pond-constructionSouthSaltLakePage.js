...
const Pond-constructionSouthSaltLakePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction South Salt Lake | Professional Pond Construction Services"
        description="Expert pond construction services in South Salt Lake. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, south salt lake pond construction, pond construction south salt lake"
        canonical="https://utahwatergardens.com/pond-construction-south-salt-lake"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services South Salt Lake",
          "description": "Professional pond construction services in South Salt Lake",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in South Salt Lake"
        subtitle="Professional pond services for Pond Construction Services in South Salt Lake and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in South Salt Lake"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in South Salt Lake</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Salt Lake Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Salt Lake Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Salt Lake Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Salt Lake Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSouthSaltLakePage;