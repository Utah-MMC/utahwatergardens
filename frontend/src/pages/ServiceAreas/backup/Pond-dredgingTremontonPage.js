...
const Pond-dredgingTremontonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Tremonton | Professional Pond Dredging Services"
        description="Expert pond dredging services in Tremonton. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, tremonton pond dredging, pond dredging tremonton"
        canonical="https://utahwatergardens.com/pond-dredging-tremonton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Tremonton",
          "description": "Professional pond dredging services in Tremonton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Tremonton"
        subtitle="Professional pond services for Pond Dredging Services in Tremonton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Tremonton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Tremonton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tremonton Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tremonton Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tremonton Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tremonton Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingTremontonPage;