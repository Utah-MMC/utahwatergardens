...
const Pond-repairMesaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Mesa | Professional Pond Repair Services"
        description="Expert pond repair services in Mesa. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, mesa pond repair, pond repair mesa"
        canonical="https://utahwatergardens.com/pond-repair-mesa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Mesa",
          "description": "Professional pond repair services in Mesa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Mesa"
        subtitle="Professional pond services for Pond Repair Services in Mesa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Mesa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Mesa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mesa Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mesa Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mesa Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mesa Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMesaPage;