...
const Lake-dredgingApacheJunctionPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Apache Junction | Professional Lake Dredging Services"
        description="Expert lake dredging services in Apache Junction. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, apache junction lake dredging, lake dredging apache junction"
        canonical="https://utahwatergardens.com/lake-dredging-apache-junction"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Apache Junction",
          "description": "Professional lake dredging services in Apache Junction",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Apache Junction"
        subtitle="Professional pond services for Lake Dredging Services in Apache Junction and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Apache Junction"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Apache Junction</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Apache Junction Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Apache Junction Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Apache Junction Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Apache Junction Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingApacheJunctionPage;