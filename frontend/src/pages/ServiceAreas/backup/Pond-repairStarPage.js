...
const Pond-repairStarPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Star | Professional Pond Repair Services"
        description="Expert pond repair services in Star. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, star pond repair, pond repair star"
        canonical="https://utahwatergardens.com/pond-repair-star"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Star",
          "description": "Professional pond repair services in Star",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Star"
        subtitle="Professional pond services for Pond Repair Services in Star and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Star"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Star</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Star Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Star Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Star Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Star Customers Say About Our Pond Repair</h2>
...
export default Pond-repairStarPage;