...
const Pond-dredgingBasaltPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Basalt | Professional Pond Dredging Services"
        description="Expert pond dredging services in Basalt. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, basalt pond dredging, pond dredging basalt"
        canonical="https://utahwatergardens.com/pond-dredging-basalt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Basalt",
          "description": "Professional pond dredging services in Basalt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Basalt"
        subtitle="Professional pond services for Pond Dredging Services in Basalt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Basalt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Basalt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Basalt Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Basalt Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Basalt Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Basalt Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBasaltPage;