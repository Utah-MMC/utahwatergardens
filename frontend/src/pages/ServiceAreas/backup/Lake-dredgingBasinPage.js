...
const Lake-dredgingBasinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Basin | Professional Lake Dredging Services"
        description="Expert lake dredging services in Basin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, basin lake dredging, lake dredging basin"
        canonical="https://utahwatergardens.com/lake-dredging-basin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Basin",
          "description": "Professional lake dredging services in Basin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Basin"
        subtitle="Professional pond services for Lake Dredging Services in Basin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Basin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Basin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Basin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Basin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Basin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Basin Customers Say About Our Lake Dredging</h2>
