...
const Pond-repairFlorencePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Florence | Professional Pond Repair Services"
        description="Expert pond repair services in Florence. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, florence pond repair, pond repair florence"
        canonical="https://utahwatergardens.com/pond-repair-florence"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Florence",
          "description": "Professional pond repair services in Florence",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Florence"
        subtitle="Professional pond services for Pond Repair Services in Florence and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Florence"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Florence</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Florence Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Florence Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Florence Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Florence Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFlorencePage;