...
const Pond-cleaningEckertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Eckert | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Eckert. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, eckert pond cleaning, pond cleaning eckert"
        canonical="https://utahwatergardens.com/pond-cleaning-eckert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Eckert",
          "description": "Professional pond cleaning services in Eckert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Eckert"
        subtitle="Professional pond services for Pond Cleaning Services in Eckert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Eckert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Eckert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eckert Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eckert Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eckert Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eckert Customers Say About Our Pond Cleaning</h2>
