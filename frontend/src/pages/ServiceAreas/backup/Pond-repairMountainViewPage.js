...
const Pond-repairMountainViewPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Mountain View | Professional Pond Repair Services"
        description="Expert pond repair services in Mountain View. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, mountain view pond repair, pond repair mountain view"
        canonical="https://utahwatergardens.com/pond-repair-mountain-view"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Mountain View",
          "description": "Professional pond repair services in Mountain View",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Mountain View"
        subtitle="Professional pond services for Pond Repair Services in Mountain View and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Mountain View"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Mountain View</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mountain View Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mountain View Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mountain View Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mountain View Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMountainViewPage;