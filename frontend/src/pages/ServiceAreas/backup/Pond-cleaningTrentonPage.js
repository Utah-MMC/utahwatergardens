...
const Pond-cleaningTrentonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Trenton | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Trenton. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, trenton pond cleaning, pond cleaning trenton"
        canonical="https://utahwatergardens.com/pond-cleaning-trenton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Trenton",
          "description": "Professional pond cleaning services in Trenton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Trenton"
        subtitle="Professional pond services for Pond Cleaning Services in Trenton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Trenton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Trenton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Trenton Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Trenton Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Trenton Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Trenton Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningTrentonPage;