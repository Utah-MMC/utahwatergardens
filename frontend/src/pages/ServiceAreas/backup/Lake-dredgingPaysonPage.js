...
const Lake-dredgingPaysonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Payson | Professional Lake Dredging Services"
        description="Expert lake dredging services in Payson. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, payson lake dredging, lake dredging payson"
        canonical="https://utahwatergardens.com/lake-dredging-payson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Payson",
          "description": "Professional lake dredging services in Payson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Payson"
        subtitle="Professional pond services for Lake Dredging Services in Payson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Payson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Payson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Payson Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Payson Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Payson Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Payson Customers Say About Our Lake Dredging</h2>
