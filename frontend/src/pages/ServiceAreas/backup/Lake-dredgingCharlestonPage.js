...
const Lake-dredgingCharlestonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Charleston | Professional Lake Dredging Services"
        description="Expert lake dredging services in Charleston. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, charleston lake dredging, lake dredging charleston"
        canonical="https://utahwatergardens.com/lake-dredging-charleston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Charleston",
          "description": "Professional lake dredging services in Charleston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Charleston"
        subtitle="Professional pond services for Lake Dredging Services in Charleston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Charleston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Charleston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Charleston Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Charleston Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Charleston Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Charleston Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingCharlestonPage;