...
const Pond-dredgingHooperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hooper | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hooper. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hooper pond dredging, pond dredging hooper"
        canonical="https://utahwatergardens.com/pond-dredging-hooper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hooper",
          "description": "Professional pond dredging services in Hooper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hooper"
        subtitle="Professional pond services for Pond Dredging Services in Hooper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hooper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hooper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hooper Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hooper Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hooper Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hooper Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHooperPage;