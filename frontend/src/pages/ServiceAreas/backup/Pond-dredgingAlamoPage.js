...
const Pond-dredgingAlamoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Alamo | Professional Pond Dredging Services"
        description="Expert pond dredging services in Alamo. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, alamo pond dredging, pond dredging alamo"
        canonical="https://utahwatergardens.com/pond-dredging-alamo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Alamo",
          "description": "Professional pond dredging services in Alamo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Alamo"
        subtitle="Professional pond services for Pond Dredging Services in Alamo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Alamo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Alamo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alamo Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alamo Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alamo Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alamo Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAlamoPage;