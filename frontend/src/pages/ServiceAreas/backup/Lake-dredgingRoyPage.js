...
const Lake-dredgingRoyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Roy | Professional Lake Dredging Services"
        description="Expert lake dredging services in Roy. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, roy lake dredging, lake dredging roy"
        canonical="https://utahwatergardens.com/lake-dredging-roy"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Roy",
          "description": "Professional lake dredging services in Roy",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Roy"
        subtitle="Professional pond services for Lake Dredging Services in Roy and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Roy"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Roy</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Roy Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Roy Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Roy Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Roy Customers Say About Our Lake Dredging</h2>
