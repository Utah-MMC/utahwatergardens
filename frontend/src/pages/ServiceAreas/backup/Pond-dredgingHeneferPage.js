...
const Pond-dredgingHeneferPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Henefer | Professional Pond Dredging Services"
        description="Expert pond dredging services in Henefer. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, henefer pond dredging, pond dredging henefer"
        canonical="https://utahwatergardens.com/pond-dredging-henefer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Henefer",
          "description": "Professional pond dredging services in Henefer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Henefer"
        subtitle="Professional pond services for Pond Dredging Services in Henefer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Henefer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Henefer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Henefer Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Henefer Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Henefer Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Henefer Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHeneferPage;