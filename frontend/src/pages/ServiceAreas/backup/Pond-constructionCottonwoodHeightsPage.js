...
const Pond-constructionCottonwoodHeightsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Cottonwood Heights | Professional Pond Construction Services"
        description="Expert pond construction services in Cottonwood Heights. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, cottonwood heights pond construction, pond construction cottonwood heights"
        canonical="https://utahwatergardens.com/pond-construction-cottonwood-heights"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Cottonwood Heights",
          "description": "Professional pond construction services in Cottonwood Heights",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Cottonwood Heights"
        subtitle="Professional pond services for Pond Construction Services in Cottonwood Heights and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Cottonwood Heights"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Cottonwood Heights</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cottonwood Heights Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cottonwood Heights Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cottonwood Heights Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cottonwood Heights Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionCottonwoodHeightsPage;