...
const Pond-maintenanceSummitParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Summit Park | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Summit Park. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, summit park pond maintenance, pond maintenance summit park"
        canonical="https://utahwatergardens.com/pond-maintenance-summit-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Summit Park",
          "description": "Professional pond maintenance services in Summit Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Summit Park"
        subtitle="Professional pond services for Pond Maintenance Services in Summit Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Summit Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Summit Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Summit Park Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Summit Park Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Summit Park Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Summit Park Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSummitParkPage;