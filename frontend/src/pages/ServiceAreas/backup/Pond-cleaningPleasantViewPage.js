...
const Pond-cleaningPleasantViewPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Pleasant View | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Pleasant View. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, pleasant view pond cleaning, pond cleaning pleasant view"
        canonical="https://utahwatergardens.com/pond-cleaning-pleasant-view"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Pleasant View",
          "description": "Professional pond cleaning services in Pleasant View",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Pleasant View"
        subtitle="Professional pond services for Pond Cleaning Services in Pleasant View and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Pleasant View"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Pleasant View</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pleasant View Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pleasant View Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pleasant View Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pleasant View Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningPleasantViewPage;