...
const Lake-dredgingSaratogaSpringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Saratoga Springs | Professional Lake Dredging Services"
        description="Expert lake dredging services in Saratoga Springs. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, saratoga springs lake dredging, lake dredging saratoga springs"
        canonical="https://utahwatergardens.com/lake-dredging-saratoga-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Saratoga Springs",
          "description": "Professional lake dredging services in Saratoga Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Saratoga Springs"
        subtitle="Professional pond services for Lake Dredging Services in Saratoga Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Saratoga Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Saratoga Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Saratoga Springs Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Saratoga Springs Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Saratoga Springs Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Saratoga Springs Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSaratogaSpringsPage;