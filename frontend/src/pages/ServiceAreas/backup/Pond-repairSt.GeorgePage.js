...
const Pond-repairSt.GeorgePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair St. George | Professional Pond Repair Services"
        description="Expert pond repair services in St. George. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, st. george pond repair, pond repair st. george"
        canonical="https://utahwatergardens.com/pond-repair-st.-george"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services St. George",
          "description": "Professional pond repair services in St. George",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in St. George"
        subtitle="Professional pond services for Pond Repair Services in St. George and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in St. George"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in St. George</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. George Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. George Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. George Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. George Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSt.GeorgePage;