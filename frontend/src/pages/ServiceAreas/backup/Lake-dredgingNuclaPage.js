...
const Lake-dredgingNuclaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Nucla | Professional Lake Dredging Services"
        description="Expert lake dredging services in Nucla. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, nucla lake dredging, lake dredging nucla"
        canonical="https://utahwatergardens.com/lake-dredging-nucla"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Nucla",
          "description": "Professional lake dredging services in Nucla",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Nucla"
        subtitle="Professional pond services for Lake Dredging Services in Nucla and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Nucla"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Nucla</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nucla Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nucla Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nucla Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nucla Customers Say About Our Lake Dredging</h2>
