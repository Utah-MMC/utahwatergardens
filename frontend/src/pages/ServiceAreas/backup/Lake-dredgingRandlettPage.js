...
const Lake-dredgingRandlettPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Randlett | Professional Lake Dredging Services"
        description="Expert lake dredging services in Randlett. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, randlett lake dredging, lake dredging randlett"
        canonical="https://utahwatergardens.com/lake-dredging-randlett"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Randlett",
          "description": "Professional lake dredging services in Randlett",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Randlett"
        subtitle="Professional pond services for Lake Dredging Services in Randlett and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Randlett"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Randlett</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Randlett Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Randlett Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Randlett Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Randlett Customers Say About Our Lake Dredging</h2>
