...
const Lake-dredgingWoodlandHillsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Woodland Hills | Professional Lake Dredging Services"
        description="Expert lake dredging services in Woodland Hills. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, woodland hills lake dredging, lake dredging woodland hills"
        canonical="https://utahwatergardens.com/lake-dredging-woodland-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Woodland Hills",
          "description": "Professional lake dredging services in Woodland Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Woodland Hills"
        subtitle="Professional pond services for Lake Dredging Services in Woodland Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Woodland Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Woodland Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Woodland Hills Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Woodland Hills Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Woodland Hills Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Woodland Hills Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingWoodlandHillsPage;