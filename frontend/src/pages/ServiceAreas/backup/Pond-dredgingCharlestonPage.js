...
const Pond-dredgingCharlestonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Charleston | Professional Pond Dredging Services"
        description="Expert pond dredging services in Charleston. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, charleston pond dredging, pond dredging charleston"
        canonical="https://utahwatergardens.com/pond-dredging-charleston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Charleston",
          "description": "Professional pond dredging services in Charleston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Charleston"
        subtitle="Professional pond services for Pond Dredging Services in Charleston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Charleston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Charleston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Charleston Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Charleston Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Charleston Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Charleston Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCharlestonPage;