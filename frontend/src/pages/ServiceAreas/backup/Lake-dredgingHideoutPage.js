...
const Lake-dredgingHideoutPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Hideout | Professional Lake Dredging Services"
        description="Expert lake dredging services in Hideout. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, hideout lake dredging, lake dredging hideout"
        canonical="https://utahwatergardens.com/lake-dredging-hideout"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Hideout",
          "description": "Professional lake dredging services in Hideout",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Hideout"
        subtitle="Professional pond services for Lake Dredging Services in Hideout and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Hideout"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Hideout</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hideout Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hideout Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hideout Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hideout Customers Say About Our Lake Dredging</h2>
