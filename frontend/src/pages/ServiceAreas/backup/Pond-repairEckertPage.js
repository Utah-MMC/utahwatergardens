...
const Pond-repairEckertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Eckert | Professional Pond Repair Services"
        description="Expert pond repair services in Eckert. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, eckert pond repair, pond repair eckert"
        canonical="https://utahwatergardens.com/pond-repair-eckert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Eckert",
          "description": "Professional pond repair services in Eckert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Eckert"
        subtitle="Professional pond services for Pond Repair Services in Eckert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Eckert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Eckert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eckert Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eckert Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eckert Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eckert Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEckertPage;