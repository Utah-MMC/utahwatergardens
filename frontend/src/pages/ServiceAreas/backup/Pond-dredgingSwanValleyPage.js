...
const Pond-dredgingSwanValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Swan Valley | Professional Pond Dredging Services"
        description="Expert pond dredging services in Swan Valley. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, swan valley pond dredging, pond dredging swan valley"
        canonical="https://utahwatergardens.com/pond-dredging-swan-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Swan Valley",
          "description": "Professional pond dredging services in Swan Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Swan Valley"
        subtitle="Professional pond services for Pond Dredging Services in Swan Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Swan Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Swan Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Swan Valley Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Swan Valley Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Swan Valley Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Swan Valley Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSwanValleyPage;