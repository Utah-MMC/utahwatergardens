...
const Pond-repairBoisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Boise | Professional Pond Repair Services"
        description="Expert pond repair services in Boise. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, boise pond repair, pond repair boise"
        canonical="https://utahwatergardens.com/pond-repair-boise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Boise",
          "description": "Professional pond repair services in Boise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Boise"
        subtitle="Professional pond services for Pond Repair Services in Boise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Boise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Boise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boise Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boise Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boise Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boise Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBoisePage;