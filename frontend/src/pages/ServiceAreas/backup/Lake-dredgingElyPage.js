...
const Lake-dredgingElyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Ely | Professional Lake Dredging Services"
        description="Expert lake dredging services in Ely. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, ely lake dredging, lake dredging ely"
        canonical="https://utahwatergardens.com/lake-dredging-ely"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Ely",
          "description": "Professional lake dredging services in Ely",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Ely"
        subtitle="Professional pond services for Lake Dredging Services in Ely and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Ely"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Ely</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ely Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ely Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ely Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ely Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingElyPage;