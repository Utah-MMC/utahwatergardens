...
const Lake-dredgingCarlinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Carlin | Professional Lake Dredging Services"
        description="Expert lake dredging services in Carlin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, carlin lake dredging, lake dredging carlin"
        canonical="https://utahwatergardens.com/lake-dredging-carlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Carlin",
          "description": "Professional lake dredging services in Carlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Carlin"
        subtitle="Professional pond services for Lake Dredging Services in Carlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Carlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Carlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carlin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carlin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carlin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carlin Customers Say About Our Lake Dredging</h2>
