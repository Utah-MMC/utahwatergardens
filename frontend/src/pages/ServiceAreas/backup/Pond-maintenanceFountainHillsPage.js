...
const Pond-maintenanceFountainHillsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Fountain Hills | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Fountain Hills. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, fountain hills pond maintenance, pond maintenance fountain hills"
        canonical="https://utahwatergardens.com/pond-maintenance-fountain-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Fountain Hills",
          "description": "Professional pond maintenance services in Fountain Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Fountain Hills"
        subtitle="Professional pond services for Pond Maintenance Services in Fountain Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Fountain Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Fountain Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fountain Hills Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fountain Hills Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fountain Hills Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fountain Hills Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceFountainHillsPage;