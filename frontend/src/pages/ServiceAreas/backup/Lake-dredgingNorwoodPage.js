...
const Lake-dredgingNorwoodPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Norwood | Professional Lake Dredging Services"
        description="Expert lake dredging services in Norwood. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, norwood lake dredging, lake dredging norwood"
        canonical="https://utahwatergardens.com/lake-dredging-norwood"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Norwood",
          "description": "Professional lake dredging services in Norwood",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Norwood"
        subtitle="Professional pond services for Lake Dredging Services in Norwood and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Norwood"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Norwood</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Norwood Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Norwood Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Norwood Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Norwood Customers Say About Our Lake Dredging</h2>
