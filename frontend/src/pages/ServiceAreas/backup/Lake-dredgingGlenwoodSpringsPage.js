...
const Lake-dredgingGlenwoodSpringsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Glenwood Springs | Professional Lake Dredging Services"
        description="Expert lake dredging services in Glenwood Springs. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, glenwood springs lake dredging, lake dredging glenwood springs"
        canonical="https://utahwatergardens.com/lake-dredging-glenwood-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Glenwood Springs",
          "description": "Professional lake dredging services in Glenwood Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Glenwood Springs"
        subtitle="Professional pond services for Lake Dredging Services in Glenwood Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Glenwood Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Glenwood Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glenwood Springs Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glenwood Springs Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glenwood Springs Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glenwood Springs Customers Say About Our Lake Dredging</h2>
