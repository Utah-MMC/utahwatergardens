...
const Lake-dredgingPenrosePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Penrose | Professional Lake Dredging Services"
        description="Expert lake dredging services in Penrose. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, penrose lake dredging, lake dredging penrose"
        canonical="https://utahwatergardens.com/lake-dredging-penrose"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Penrose",
          "description": "Professional lake dredging services in Penrose",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Penrose"
        subtitle="Professional pond services for Lake Dredging Services in Penrose and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Penrose"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Penrose</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Penrose Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Penrose Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Penrose Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Penrose Customers Say About Our Lake Dredging</h2>
