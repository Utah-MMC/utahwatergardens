...
const Pond-repairGreybullPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Greybull | Professional Pond Repair Services"
        description="Expert pond repair services in Greybull. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, greybull pond repair, pond repair greybull"
        canonical="https://utahwatergardens.com/pond-repair-greybull"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Greybull",
          "description": "Professional pond repair services in Greybull",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Greybull"
        subtitle="Professional pond services for Pond Repair Services in Greybull and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Greybull"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Greybull</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Greybull Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Greybull Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Greybull Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Greybull Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGreybullPage;