...
const Pond-dredgingNewCastlePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging New Castle | Professional Pond Dredging Services"
        description="Expert pond dredging services in New Castle. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, new castle pond dredging, pond dredging new castle"
        canonical="https://utahwatergardens.com/pond-dredging-new-castle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services New Castle",
          "description": "Professional pond dredging services in New Castle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in New Castle"
        subtitle="Professional pond services for Pond Dredging Services in New Castle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in New Castle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in New Castle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Castle Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Castle Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Castle Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Castle Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNewCastlePage;