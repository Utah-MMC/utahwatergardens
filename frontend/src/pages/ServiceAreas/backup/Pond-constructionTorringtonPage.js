...
const Pond-constructionTorringtonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Torrington | Professional Pond Construction Services"
        description="Expert pond construction services in Torrington. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, torrington pond construction, pond construction torrington"
        canonical="https://utahwatergardens.com/pond-construction-torrington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Torrington",
          "description": "Professional pond construction services in Torrington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Torrington"
        subtitle="Professional pond services for Pond Construction Services in Torrington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Torrington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Torrington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Torrington Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Torrington Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Torrington Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Torrington Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionTorringtonPage;