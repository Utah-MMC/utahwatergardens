...
const Pond-constructionMarbletonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Marbleton | Professional Pond Construction Services"
        description="Expert pond construction services in Marbleton. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, marbleton pond construction, pond construction marbleton"
        canonical="https://utahwatergardens.com/pond-construction-marbleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Marbleton",
          "description": "Professional pond construction services in Marbleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Marbleton"
        subtitle="Professional pond services for Pond Construction Services in Marbleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Marbleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Marbleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marbleton Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marbleton Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marbleton Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marbleton Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionMarbletonPage;