...
const Pond-cleaningSwanValleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Swan Valley | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Swan Valley. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, swan valley pond cleaning, pond cleaning swan valley"
        canonical="https://utahwatergardens.com/pond-cleaning-swan-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Swan Valley",
          "description": "Professional pond cleaning services in Swan Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Swan Valley"
        subtitle="Professional pond services for Pond Cleaning Services in Swan Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Swan Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Swan Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Swan Valley Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Swan Valley Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Swan Valley Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Swan Valley Customers Say About Our Pond Cleaning</h2>
