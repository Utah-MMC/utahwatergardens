...
const Pond-dredgingProvoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Provo | Professional Pond Dredging Services"
        description="Expert pond dredging services in Provo. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, provo pond dredging, pond dredging provo"
        canonical="https://utahwatergardens.com/pond-dredging-provo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Provo",
          "description": "Professional pond dredging services in Provo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Provo"
        subtitle="Professional pond services for Pond Dredging Services in Provo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Provo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Provo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Provo Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Provo Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Provo Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Provo Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingProvoPage;