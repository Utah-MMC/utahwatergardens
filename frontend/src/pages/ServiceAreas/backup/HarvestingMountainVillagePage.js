...
const HarvestingMountainVillagePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Mountain Village | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Mountain Village. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, mountain village aquatic plant harvesting, aquatic plant harvesting mountain village"
        canonical="https://utahwatergardens.com/harvesting-mountain-village"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Mountain Village",
          "description": "Professional aquatic plant harvesting services in Mountain Village",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Mountain Village"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Mountain Village and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Mountain Village"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Mountain Village</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mountain Village Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mountain Village Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mountain Village Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mountain Village Customers Say About Our Aquatic Plant Harvesting</h2>
