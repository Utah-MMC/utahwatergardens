...
const Pond-repairTempePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Tempe | Professional Pond Repair Services"
        description="Expert pond repair services in Tempe. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, tempe pond repair, pond repair tempe"
        canonical="https://utahwatergardens.com/pond-repair-tempe"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Tempe",
          "description": "Professional pond repair services in Tempe",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Tempe"
        subtitle="Professional pond services for Pond Repair Services in Tempe and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Tempe"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Tempe</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tempe Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tempe Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tempe Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tempe Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTempePage;