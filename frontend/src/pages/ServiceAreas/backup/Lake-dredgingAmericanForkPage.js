...
const Lake-dredgingAmericanForkPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging American Fork | Professional Lake Dredging Services"
        description="Expert lake dredging services in American Fork. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, american fork lake dredging, lake dredging american fork"
        canonical="https://utahwatergardens.com/lake-dredging-american-fork"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services American Fork",
          "description": "Professional lake dredging services in American Fork",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in American Fork"
        subtitle="Professional pond services for Lake Dredging Services in American Fork and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in American Fork"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in American Fork</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our American Fork Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="American Fork Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our American Fork Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What American Fork Customers Say About Our Lake Dredging</h2>
