...
const Lake-dredgingLakepointPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lakepoint | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lakepoint. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lakepoint lake dredging, lake dredging lakepoint"
        canonical="https://utahwatergardens.com/lake-dredging-lakepoint"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lakepoint",
          "description": "Professional lake dredging services in Lakepoint",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lakepoint"
        subtitle="Professional pond services for Lake Dredging Services in Lakepoint and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lakepoint"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lakepoint</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lakepoint Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lakepoint Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lakepoint Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lakepoint Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingLakepointPage;