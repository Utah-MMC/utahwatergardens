...
const Pond-dredgingPinedalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Pinedale | Professional Pond Dredging Services"
        description="Expert pond dredging services in Pinedale. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, pinedale pond dredging, pond dredging pinedale"
        canonical="https://utahwatergardens.com/pond-dredging-pinedale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Pinedale",
          "description": "Professional pond dredging services in Pinedale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Pinedale"
        subtitle="Professional pond services for Pond Dredging Services in Pinedale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Pinedale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Pinedale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pinedale Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pinedale Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pinedale Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pinedale Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPinedalePage;