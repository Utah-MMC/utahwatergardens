...
const Pond-repairEvanstonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Evanston | Professional Pond Repair Services"
        description="Expert pond repair services in Evanston. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, evanston pond repair, pond repair evanston"
        canonical="https://utahwatergardens.com/pond-repair-evanston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Evanston",
          "description": "Professional pond repair services in Evanston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Evanston"
        subtitle="Professional pond services for Pond Repair Services in Evanston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Evanston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Evanston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Evanston Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Evanston Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Evanston Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Evanston Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEvanstonPage;