...
const Lake-dredgingNewtonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Newton | Professional Lake Dredging Services"
        description="Expert lake dredging services in Newton. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, newton lake dredging, lake dredging newton"
        canonical="https://utahwatergardens.com/lake-dredging-newton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Newton",
          "description": "Professional lake dredging services in Newton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Newton"
        subtitle="Professional pond services for Lake Dredging Services in Newton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Newton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Newton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Newton Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Newton Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Newton Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Newton Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingNewtonPage;