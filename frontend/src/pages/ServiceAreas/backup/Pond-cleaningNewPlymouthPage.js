...
const Pond-cleaningNewPlymouthPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning New Plymouth | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in New Plymouth. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, new plymouth pond cleaning, pond cleaning new plymouth"
        canonical="https://utahwatergardens.com/pond-cleaning-new-plymouth"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services New Plymouth",
          "description": "Professional pond cleaning services in New Plymouth",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in New Plymouth"
        subtitle="Professional pond services for Pond Cleaning Services in New Plymouth and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in New Plymouth"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in New Plymouth</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Plymouth Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Plymouth Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Plymouth Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Plymouth Customers Say About Our Pond Cleaning</h2>
