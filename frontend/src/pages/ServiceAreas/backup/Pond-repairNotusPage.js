...
const Pond-repairNotusPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Notus | Professional Pond Repair Services"
        description="Expert pond repair services in Notus. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, notus pond repair, pond repair notus"
        canonical="https://utahwatergardens.com/pond-repair-notus"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Notus",
          "description": "Professional pond repair services in Notus",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Notus"
        subtitle="Professional pond services for Pond Repair Services in Notus and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Notus"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Notus</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Notus Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Notus Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Notus Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Notus Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNotusPage;