...
const Pond-cleaningBasaltPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Basalt | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Basalt. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, basalt pond cleaning, pond cleaning basalt"
        canonical="https://utahwatergardens.com/pond-cleaning-basalt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Basalt",
          "description": "Professional pond cleaning services in Basalt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Basalt"
        subtitle="Professional pond services for Pond Cleaning Services in Basalt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Basalt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Basalt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Basalt Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Basalt Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Basalt Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Basalt Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningBasaltPage;