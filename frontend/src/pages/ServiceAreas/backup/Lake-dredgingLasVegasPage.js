...
const Lake-dredgingLasVegasPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Las Vegas | Professional Lake Dredging Services"
        description="Expert lake dredging services in Las Vegas. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, las vegas lake dredging, lake dredging las vegas"
        canonical="https://utahwatergardens.com/lake-dredging-las-vegas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Las Vegas",
          "description": "Professional lake dredging services in Las Vegas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Las Vegas"
        subtitle="Professional pond services for Lake Dredging Services in Las Vegas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Las Vegas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Las Vegas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Las Vegas Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Las Vegas Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Las Vegas Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Las Vegas Customers Say About Our Lake Dredging</h2>
