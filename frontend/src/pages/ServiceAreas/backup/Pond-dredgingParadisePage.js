...
const Pond-dredgingParadisePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Paradise | Professional Pond Dredging Services"
        description="Expert pond dredging services in Paradise. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, paradise pond dredging, pond dredging paradise"
        canonical="https://utahwatergardens.com/pond-dredging-paradise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Paradise",
          "description": "Professional pond dredging services in Paradise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Paradise"
        subtitle="Professional pond services for Pond Dredging Services in Paradise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Paradise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Paradise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paradise Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paradise Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paradise Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paradise Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingParadisePage;