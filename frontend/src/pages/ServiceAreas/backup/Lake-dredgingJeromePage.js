...
const Lake-dredgingJeromePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Jerome | Professional Lake Dredging Services"
        description="Expert lake dredging services in Jerome. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, jerome lake dredging, lake dredging jerome"
        canonical="https://utahwatergardens.com/lake-dredging-jerome"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Jerome",
          "description": "Professional lake dredging services in Jerome",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Jerome"
        subtitle="Professional pond services for Lake Dredging Services in Jerome and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Jerome"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Jerome</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jerome Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jerome Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jerome Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jerome Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingJeromePage;