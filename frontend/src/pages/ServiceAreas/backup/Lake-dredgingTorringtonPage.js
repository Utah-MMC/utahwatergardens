...
const Lake-dredgingTorringtonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Torrington | Professional Lake Dredging Services"
        description="Expert lake dredging services in Torrington. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, torrington lake dredging, lake dredging torrington"
        canonical="https://utahwatergardens.com/lake-dredging-torrington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Torrington",
          "description": "Professional lake dredging services in Torrington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Torrington"
        subtitle="Professional pond services for Lake Dredging Services in Torrington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Torrington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Torrington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Torrington Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Torrington Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Torrington Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Torrington Customers Say About Our Lake Dredging</h2>
