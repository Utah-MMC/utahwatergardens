...
const Pond-cleaningGlenrockPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Glenrock | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Glenrock. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, glenrock pond cleaning, pond cleaning glenrock"
        canonical="https://utahwatergardens.com/pond-cleaning-glenrock"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Glenrock",
          "description": "Professional pond cleaning services in Glenrock",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Glenrock"
        subtitle="Professional pond services for Pond Cleaning Services in Glenrock and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Glenrock"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Glenrock</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glenrock Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glenrock Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glenrock Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glenrock Customers Say About Our Pond Cleaning</h2>
