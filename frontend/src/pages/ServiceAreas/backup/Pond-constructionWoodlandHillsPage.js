...
const Pond-constructionWoodlandHillsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Woodland Hills | Professional Pond Construction Services"
        description="Expert pond construction services in Woodland Hills. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, woodland hills pond construction, pond construction woodland hills"
        canonical="https://utahwatergardens.com/pond-construction-woodland-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Woodland Hills",
          "description": "Professional pond construction services in Woodland Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Woodland Hills"
        subtitle="Professional pond services for Pond Construction Services in Woodland Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Woodland Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Woodland Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Woodland Hills Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Woodland Hills Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Woodland Hills Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Woodland Hills Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionWoodlandHillsPage;