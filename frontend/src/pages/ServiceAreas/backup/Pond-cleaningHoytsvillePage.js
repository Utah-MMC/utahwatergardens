...
const Pond-cleaningHoytsvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Hoytsville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Hoytsville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, hoytsville pond cleaning, pond cleaning hoytsville"
        canonical="https://utahwatergardens.com/pond-cleaning-hoytsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Hoytsville",
          "description": "Professional pond cleaning services in Hoytsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Hoytsville"
        subtitle="Professional pond services for Pond Cleaning Services in Hoytsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Hoytsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Hoytsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hoytsville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hoytsville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hoytsville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hoytsville Customers Say About Our Pond Cleaning</h2>
