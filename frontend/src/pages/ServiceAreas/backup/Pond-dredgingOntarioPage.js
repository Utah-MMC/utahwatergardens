...
const Pond-dredgingOntarioPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Ontario | Professional Pond Dredging Services"
        description="Expert pond dredging services in Ontario. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, ontario pond dredging, pond dredging ontario"
        canonical="https://utahwatergardens.com/pond-dredging-ontario"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Ontario",
          "description": "Professional pond dredging services in Ontario",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Ontario"
        subtitle="Professional pond services for Pond Dredging Services in Ontario and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Ontario"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Ontario</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ontario Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ontario Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ontario Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ontario Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingOntarioPage;