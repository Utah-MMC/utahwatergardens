...
const Pond-cleaningMillsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Mills | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Mills. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, mills pond cleaning, pond cleaning mills"
        canonical="https://utahwatergardens.com/pond-cleaning-mills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Mills",
          "description": "Professional pond cleaning services in Mills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Mills"
        subtitle="Professional pond services for Pond Cleaning Services in Mills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Mills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Mills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mills Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mills Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mills Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mills Customers Say About Our Pond Cleaning</h2>
