...
const Pond-dredgingFallonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Fallon | Professional Pond Dredging Services"
        description="Expert pond dredging services in Fallon. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, fallon pond dredging, pond dredging fallon"
        canonical="https://utahwatergardens.com/pond-dredging-fallon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Fallon",
          "description": "Professional pond dredging services in Fallon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Fallon"
        subtitle="Professional pond services for Pond Dredging Services in Fallon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Fallon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Fallon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fallon Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fallon Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fallon Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fallon Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFallonPage;