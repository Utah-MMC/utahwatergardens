...
const Pond-constructionLaBargePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction La Barge | Professional Pond Construction Services"
        description="Expert pond construction services in La Barge. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, la barge pond construction, pond construction la barge"
        canonical="https://utahwatergardens.com/pond-construction-la-barge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services La Barge",
          "description": "Professional pond construction services in La Barge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in La Barge"
        subtitle="Professional pond services for Pond Construction Services in La Barge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in La Barge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in La Barge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Barge Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Barge Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Barge Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Barge Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionLaBargePage;