...
const Pond-repairJeromePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Jerome | Professional Pond Repair Services"
        description="Expert pond repair services in Jerome. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, jerome pond repair, pond repair jerome"
        canonical="https://utahwatergardens.com/pond-repair-jerome"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Jerome",
          "description": "Professional pond repair services in Jerome",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Jerome"
        subtitle="Professional pond services for Pond Repair Services in Jerome and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Jerome"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Jerome</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jerome Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jerome Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jerome Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jerome Customers Say About Our Pond Repair</h2>
...
export default Pond-repairJeromePage;