...
const Pond-repairChandlerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Chandler | Professional Pond Repair Services"
        description="Expert pond repair services in Chandler. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, chandler pond repair, pond repair chandler"
        canonical="https://utahwatergardens.com/pond-repair-chandler"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Chandler",
          "description": "Professional pond repair services in Chandler",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Chandler"
        subtitle="Professional pond services for Pond Repair Services in Chandler and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Chandler"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Chandler</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Chandler Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Chandler Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Chandler Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Chandler Customers Say About Our Pond Repair</h2>
...
export default Pond-repairChandlerPage;