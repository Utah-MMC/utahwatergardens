...
const Pond-cleaningMoosePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Moose | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Moose. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, moose pond cleaning, pond cleaning moose"
        canonical="https://utahwatergardens.com/pond-cleaning-moose"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Moose",
          "description": "Professional pond cleaning services in Moose",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Moose"
        subtitle="Professional pond services for Pond Cleaning Services in Moose and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Moose"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Moose</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moose Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moose Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moose Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moose Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMoosePage;