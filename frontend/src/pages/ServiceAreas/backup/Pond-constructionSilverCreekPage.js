...
const Pond-constructionSilverCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Silver Creek | Professional Pond Construction Services"
        description="Expert pond construction services in Silver Creek. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, silver creek pond construction, pond construction silver creek"
        canonical="https://utahwatergardens.com/pond-construction-silver-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Silver Creek",
          "description": "Professional pond construction services in Silver Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Silver Creek"
        subtitle="Professional pond services for Pond Construction Services in Silver Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Silver Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Silver Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Silver Creek Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Silver Creek Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Silver Creek Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Silver Creek Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSilverCreekPage;