...
const Pond-dredgingOrdervillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Orderville | Professional Pond Dredging Services"
        description="Expert pond dredging services in Orderville. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, orderville pond dredging, pond dredging orderville"
        canonical="https://utahwatergardens.com/pond-dredging-orderville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Orderville",
          "description": "Professional pond dredging services in Orderville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Orderville"
        subtitle="Professional pond services for Pond Dredging Services in Orderville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Orderville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Orderville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Orderville Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Orderville Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Orderville Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Orderville Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingOrdervillePage;