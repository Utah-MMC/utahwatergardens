...
const HarvestingGuernseyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Guernsey | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Guernsey. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, guernsey aquatic plant harvesting, aquatic plant harvesting guernsey"
        canonical="https://utahwatergardens.com/harvesting-guernsey"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Guernsey",
          "description": "Professional aquatic plant harvesting services in Guernsey",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Guernsey"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Guernsey and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Guernsey"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Guernsey</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Guernsey Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Guernsey Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Guernsey Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Guernsey Customers Say About Our Aquatic Plant Harvesting</h2>
