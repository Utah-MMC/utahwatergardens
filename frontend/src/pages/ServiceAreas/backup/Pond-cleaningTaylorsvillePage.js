...
const Pond-cleaningTaylorsvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Taylorsville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Taylorsville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, taylorsville pond cleaning, pond cleaning taylorsville"
        canonical="https://utahwatergardens.com/pond-cleaning-taylorsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Taylorsville",
          "description": "Professional pond cleaning services in Taylorsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Taylorsville"
        subtitle="Professional pond services for Pond Cleaning Services in Taylorsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Taylorsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Taylorsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Taylorsville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Taylorsville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Taylorsville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Taylorsville Customers Say About Our Pond Cleaning</h2>
