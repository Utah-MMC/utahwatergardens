...
const Pond-repairLuskPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lusk | Professional Pond Repair Services"
        description="Expert pond repair services in Lusk. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lusk pond repair, pond repair lusk"
        canonical="https://utahwatergardens.com/pond-repair-lusk"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lusk",
          "description": "Professional pond repair services in Lusk",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lusk"
        subtitle="Professional pond services for Pond Repair Services in Lusk and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lusk"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lusk</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lusk Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lusk Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lusk Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lusk Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLuskPage;