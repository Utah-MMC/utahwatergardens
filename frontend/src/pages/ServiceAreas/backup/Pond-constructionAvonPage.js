...
const Pond-constructionAvonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Avon | Professional Pond Construction Services"
        description="Expert pond construction services in Avon. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, avon pond construction, pond construction avon"
        canonical="https://utahwatergardens.com/pond-construction-avon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Avon",
          "description": "Professional pond construction services in Avon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Avon"
        subtitle="Professional pond services for Pond Construction Services in Avon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Avon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Avon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Avon Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Avon Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Avon Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Avon Customers Say About Our Pond Construction</h2>
