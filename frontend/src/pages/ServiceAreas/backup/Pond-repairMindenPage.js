...
const Pond-repairMindenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Minden | Professional Pond Repair Services"
        description="Expert pond repair services in Minden. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, minden pond repair, pond repair minden"
        canonical="https://utahwatergardens.com/pond-repair-minden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Minden",
          "description": "Professional pond repair services in Minden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Minden"
        subtitle="Professional pond services for Pond Repair Services in Minden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Minden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Minden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Minden Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Minden Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Minden Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Minden Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMindenPage;