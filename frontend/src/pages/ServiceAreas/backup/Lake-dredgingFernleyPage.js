...
const Lake-dredgingFernleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Fernley | Professional Lake Dredging Services"
        description="Expert lake dredging services in Fernley. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, fernley lake dredging, lake dredging fernley"
        canonical="https://utahwatergardens.com/lake-dredging-fernley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Fernley",
          "description": "Professional lake dredging services in Fernley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Fernley"
        subtitle="Professional pond services for Lake Dredging Services in Fernley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Fernley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Fernley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fernley Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fernley Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fernley Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fernley Customers Say About Our Lake Dredging</h2>
