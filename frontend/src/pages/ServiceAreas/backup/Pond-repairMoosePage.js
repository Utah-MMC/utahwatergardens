...
const Pond-repairMoosePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Moose | Professional Pond Repair Services"
        description="Expert pond repair services in Moose. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, moose pond repair, pond repair moose"
        canonical="https://utahwatergardens.com/pond-repair-moose"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Moose",
          "description": "Professional pond repair services in Moose",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Moose"
        subtitle="Professional pond services for Pond Repair Services in Moose and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Moose"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Moose</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moose Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moose Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moose Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moose Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMoosePage;