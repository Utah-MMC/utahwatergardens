...
const Pond-cleaningDraperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Draper | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Draper. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, draper pond cleaning, pond cleaning draper"
        canonical="https://utahwatergardens.com/pond-cleaning-draper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Draper",
          "description": "Professional pond cleaning services in Draper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Draper"
        subtitle="Professional pond services for Pond Cleaning Services in Draper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Draper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Draper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Draper Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Draper Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Draper Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Draper Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDraperPage;