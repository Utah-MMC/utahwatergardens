...
const Lake-dredgingGoshutePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Goshute | Professional Lake Dredging Services"
        description="Expert lake dredging services in Goshute. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, goshute lake dredging, lake dredging goshute"
        canonical="https://utahwatergardens.com/lake-dredging-goshute"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Goshute",
          "description": "Professional lake dredging services in Goshute",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Goshute"
        subtitle="Professional pond services for Lake Dredging Services in Goshute and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Goshute"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Goshute</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goshute Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goshute Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goshute Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goshute Customers Say About Our Lake Dredging</h2>
