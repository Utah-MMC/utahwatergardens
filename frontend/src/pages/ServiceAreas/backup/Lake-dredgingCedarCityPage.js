...
const Lake-dredgingCedarCityPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Cedar City | Professional Lake Dredging Services"
        description="Expert lake dredging services in Cedar City. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, cedar city lake dredging, lake dredging cedar city"
        canonical="https://utahwatergardens.com/lake-dredging-cedar-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Cedar City",
          "description": "Professional lake dredging services in Cedar City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Cedar City"
        subtitle="Professional pond services for Lake Dredging Services in Cedar City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Cedar City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Cedar City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cedar City Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cedar City Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cedar City Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cedar City Customers Say About Our Lake Dredging</h2>
