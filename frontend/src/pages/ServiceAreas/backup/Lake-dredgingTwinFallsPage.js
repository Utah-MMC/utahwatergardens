...
const Lake-dredgingTwinFallsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Twin Falls | Professional Lake Dredging Services"
        description="Expert lake dredging services in Twin Falls. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, twin falls lake dredging, lake dredging twin falls"
        canonical="https://utahwatergardens.com/lake-dredging-twin-falls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Twin Falls",
          "description": "Professional lake dredging services in Twin Falls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Twin Falls"
        subtitle="Professional pond services for Lake Dredging Services in Twin Falls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Twin Falls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Twin Falls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Twin Falls Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Twin Falls Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Twin Falls Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Twin Falls Customers Say About Our Lake Dredging</h2>
