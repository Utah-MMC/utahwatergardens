...
const Pond-repairClawsonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Clawson | Professional Pond Repair Services"
        description="Expert pond repair services in Clawson. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, clawson pond repair, pond repair clawson"
        canonical="https://utahwatergardens.com/pond-repair-clawson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Clawson",
          "description": "Professional pond repair services in Clawson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Clawson"
        subtitle="Professional pond services for Pond Repair Services in Clawson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Clawson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Clawson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clawson Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clawson Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clawson Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clawson Customers Say About Our Pond Repair</h2>
...
export default Pond-repairClawsonPage;