...
const Pond-repairRedmondPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Redmond | Professional Pond Repair Services"
        description="Expert pond repair services in Redmond. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, redmond pond repair, pond repair redmond"
        canonical="https://utahwatergardens.com/pond-repair-redmond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Redmond",
          "description": "Professional pond repair services in Redmond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Redmond"
        subtitle="Professional pond services for Pond Repair Services in Redmond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Redmond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Redmond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Redmond Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Redmond Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Redmond Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Redmond Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRedmondPage;