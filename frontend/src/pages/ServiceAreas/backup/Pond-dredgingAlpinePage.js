...
const Pond-dredgingAlpinePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Alpine | Professional Pond Dredging Services"
        description="Expert pond dredging services in Alpine. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, alpine pond dredging, pond dredging alpine"
        canonical="https://utahwatergardens.com/pond-dredging-alpine"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Alpine",
          "description": "Professional pond dredging services in Alpine",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Alpine"
        subtitle="Professional pond services for Pond Dredging Services in Alpine and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Alpine"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Alpine</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alpine Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alpine Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alpine Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alpine Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAlpinePage;