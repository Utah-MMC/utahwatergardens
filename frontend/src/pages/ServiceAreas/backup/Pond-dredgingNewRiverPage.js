...
const Pond-dredgingNewRiverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging New River | Professional Pond Dredging Services"
        description="Expert pond dredging services in New River. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, new river pond dredging, pond dredging new river"
        canonical="https://utahwatergardens.com/pond-dredging-new-river"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services New River",
          "description": "Professional pond dredging services in New River",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in New River"
        subtitle="Professional pond services for Pond Dredging Services in New River and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in New River"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in New River</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New River Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New River Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New River Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New River Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNewRiverPage;