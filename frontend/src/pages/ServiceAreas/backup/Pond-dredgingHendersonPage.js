...
const Pond-dredgingHendersonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Henderson | Professional Pond Dredging Services"
        description="Expert pond dredging services in Henderson. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, henderson pond dredging, pond dredging henderson"
        canonical="https://utahwatergardens.com/pond-dredging-henderson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Henderson",
          "description": "Professional pond dredging services in Henderson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Henderson"
        subtitle="Professional pond services for Pond Dredging Services in Henderson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Henderson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Henderson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Henderson Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Henderson Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Henderson Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Henderson Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHendersonPage;