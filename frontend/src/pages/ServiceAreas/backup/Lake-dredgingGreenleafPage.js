...
const Lake-dredgingGreenleafPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Greenleaf | Professional Lake Dredging Services"
        description="Expert lake dredging services in Greenleaf. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, greenleaf lake dredging, lake dredging greenleaf"
        canonical="https://utahwatergardens.com/lake-dredging-greenleaf"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Greenleaf",
          "description": "Professional lake dredging services in Greenleaf",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Greenleaf"
        subtitle="Professional pond services for Lake Dredging Services in Greenleaf and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Greenleaf"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Greenleaf</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Greenleaf Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Greenleaf Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Greenleaf Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Greenleaf Customers Say About Our Lake Dredging</h2>
