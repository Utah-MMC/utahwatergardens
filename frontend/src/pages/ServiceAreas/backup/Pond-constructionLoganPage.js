...
const Pond-constructionLoganPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Logan | Professional Pond Construction Services"
        description="Expert pond construction services in Logan. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, logan pond construction, pond construction logan"
        canonical="https://utahwatergardens.com/pond-construction-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Logan",
          "description": "Professional pond construction services in Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Logan"
        subtitle="Professional pond services for Pond Construction Services in Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Logan Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Logan Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Logan Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Logan Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionLoganPage;