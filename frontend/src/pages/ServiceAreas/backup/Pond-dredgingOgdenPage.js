...
const Pond-dredgingOgdenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Ogden | Professional Pond Dredging Services"
        description="Expert pond dredging services in Ogden. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, ogden pond dredging, pond dredging ogden"
        canonical="https://utahwatergardens.com/pond-dredging-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Ogden",
          "description": "Professional pond dredging services in Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Ogden"
        subtitle="Professional pond services for Pond Dredging Services in Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ogden Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ogden Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ogden Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ogden Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingOgdenPage;