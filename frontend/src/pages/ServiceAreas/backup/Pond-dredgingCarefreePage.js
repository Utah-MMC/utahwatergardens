...
const Pond-dredgingCarefreePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Carefree | Professional Pond Dredging Services"
        description="Expert pond dredging services in Carefree. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, carefree pond dredging, pond dredging carefree"
        canonical="https://utahwatergardens.com/pond-dredging-carefree"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Carefree",
          "description": "Professional pond dredging services in Carefree",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Carefree"
        subtitle="Professional pond services for Pond Dredging Services in Carefree and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Carefree"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Carefree</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carefree Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carefree Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carefree Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carefree Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCarefreePage;