...
const Pond-repairHeneferPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Henefer | Professional Pond Repair Services"
        description="Expert pond repair services in Henefer. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, henefer pond repair, pond repair henefer"
        canonical="https://utahwatergardens.com/pond-repair-henefer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Henefer",
          "description": "Professional pond repair services in Henefer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Henefer"
        subtitle="Professional pond services for Pond Repair Services in Henefer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Henefer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Henefer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Henefer Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Henefer Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Henefer Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Henefer Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHeneferPage;