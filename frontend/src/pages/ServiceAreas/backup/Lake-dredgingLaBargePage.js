...
const Lake-dredgingLaBargePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging La Barge | Professional Lake Dredging Services"
        description="Expert lake dredging services in La Barge. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, la barge lake dredging, lake dredging la barge"
        canonical="https://utahwatergardens.com/lake-dredging-la-barge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services La Barge",
          "description": "Professional lake dredging services in La Barge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in La Barge"
        subtitle="Professional pond services for Lake Dredging Services in La Barge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in La Barge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in La Barge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Barge Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Barge Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Barge Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Barge Customers Say About Our Lake Dredging</h2>
