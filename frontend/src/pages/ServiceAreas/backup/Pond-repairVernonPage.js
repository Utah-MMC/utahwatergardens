...
const Pond-repairVernonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Vernon | Professional Pond Repair Services"
        description="Expert pond repair services in Vernon. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, vernon pond repair, pond repair vernon"
        canonical="https://utahwatergardens.com/pond-repair-vernon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Vernon",
          "description": "Professional pond repair services in Vernon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Vernon"
        subtitle="Professional pond services for Pond Repair Services in Vernon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Vernon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Vernon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vernon Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vernon Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vernon Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vernon Customers Say About Our Pond Repair</h2>
...
export default Pond-repairVernonPage;