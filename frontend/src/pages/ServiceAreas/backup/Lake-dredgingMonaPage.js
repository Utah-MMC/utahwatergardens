...
const Lake-dredgingMonaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mona | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mona. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mona lake dredging, lake dredging mona"
        canonical="https://utahwatergardens.com/lake-dredging-mona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mona",
          "description": "Professional lake dredging services in Mona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mona"
        subtitle="Professional pond services for Lake Dredging Services in Mona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mona Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mona Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mona Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mona Customers Say About Our Lake Dredging</h2>
