...
const Pond-cleaningFountainHillsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Fountain Hills | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Fountain Hills. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, fountain hills pond cleaning, pond cleaning fountain hills"
        canonical="https://utahwatergardens.com/pond-cleaning-fountain-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Fountain Hills",
          "description": "Professional pond cleaning services in Fountain Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Fountain Hills"
        subtitle="Professional pond services for Pond Cleaning Services in Fountain Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Fountain Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Fountain Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fountain Hills Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fountain Hills Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fountain Hills Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fountain Hills Customers Say About Our Pond Cleaning</h2>
