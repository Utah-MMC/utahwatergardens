...
const Lake-dredgingWellsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Wells | Professional Lake Dredging Services"
        description="Expert lake dredging services in Wells. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, wells lake dredging, lake dredging wells"
        canonical="https://utahwatergardens.com/lake-dredging-wells"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Wells",
          "description": "Professional lake dredging services in Wells",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Wells"
        subtitle="Professional pond services for Lake Dredging Services in Wells and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Wells"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Wells</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wells Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wells Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wells Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wells Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingWellsPage;