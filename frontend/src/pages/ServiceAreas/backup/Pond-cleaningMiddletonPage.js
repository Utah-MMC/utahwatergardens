...
const Pond-cleaningMiddletonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Middleton | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Middleton. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, middleton pond cleaning, pond cleaning middleton"
        canonical="https://utahwatergardens.com/pond-cleaning-middleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Middleton",
          "description": "Professional pond cleaning services in Middleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Middleton"
        subtitle="Professional pond services for Pond Cleaning Services in Middleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Middleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Middleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Middleton Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Middleton Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Middleton Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Middleton Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMiddletonPage;