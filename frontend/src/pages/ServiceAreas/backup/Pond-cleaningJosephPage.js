...
const Pond-cleaningJosephPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Joseph | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Joseph. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, joseph pond cleaning, pond cleaning joseph"
        canonical="https://utahwatergardens.com/pond-cleaning-joseph"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Joseph",
          "description": "Professional pond cleaning services in Joseph",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Joseph"
        subtitle="Professional pond services for Pond Cleaning Services in Joseph and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Joseph"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Joseph</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Joseph Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Joseph Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Joseph Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Joseph Customers Say About Our Pond Cleaning</h2>
