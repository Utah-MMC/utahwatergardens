...
const Pond-repairCalientePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Caliente | Professional Pond Repair Services"
        description="Expert pond repair services in Caliente. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, caliente pond repair, pond repair caliente"
        canonical="https://utahwatergardens.com/pond-repair-caliente"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Caliente",
          "description": "Professional pond repair services in Caliente",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Caliente"
        subtitle="Professional pond services for Pond Repair Services in Caliente and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Caliente"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Caliente</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Caliente Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Caliente Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Caliente Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Caliente Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCalientePage;