...
const Pond-cleaningTwinFallsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Twin Falls | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Twin Falls. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, twin falls pond cleaning, pond cleaning twin falls"
        canonical="https://utahwatergardens.com/pond-cleaning-twin-falls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Twin Falls",
          "description": "Professional pond cleaning services in Twin Falls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Twin Falls"
        subtitle="Professional pond services for Pond Cleaning Services in Twin Falls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Twin Falls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Twin Falls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Twin Falls Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Twin Falls Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Twin Falls Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Twin Falls Customers Say About Our Pond Cleaning</h2>
