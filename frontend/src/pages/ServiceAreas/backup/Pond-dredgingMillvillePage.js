...
const Pond-dredgingMillvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Millville | Professional Pond Dredging Services"
        description="Expert pond dredging services in Millville. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, millville pond dredging, pond dredging millville"
        canonical="https://utahwatergardens.com/pond-dredging-millville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Millville",
          "description": "Professional pond dredging services in Millville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Millville"
        subtitle="Professional pond services for Pond Dredging Services in Millville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Millville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Millville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Millville Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Millville Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Millville Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Millville Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMillvillePage;