...
const Lake-dredgingEckertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Eckert | Professional Lake Dredging Services"
        description="Expert lake dredging services in Eckert. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, eckert lake dredging, lake dredging eckert"
        canonical="https://utahwatergardens.com/lake-dredging-eckert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Eckert",
          "description": "Professional lake dredging services in Eckert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Eckert"
        subtitle="Professional pond services for Lake Dredging Services in Eckert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Eckert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Eckert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eckert Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eckert Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eckert Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eckert Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingEckertPage;