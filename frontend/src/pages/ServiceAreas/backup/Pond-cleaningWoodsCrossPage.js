...
const Pond-cleaningWoodsCrossPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Woods Cross | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Woods Cross. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, woods cross pond cleaning, pond cleaning woods cross"
        canonical="https://utahwatergardens.com/pond-cleaning-woods-cross"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Woods Cross",
          "description": "Professional pond cleaning services in Woods Cross",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Woods Cross"
        subtitle="Professional pond services for Pond Cleaning Services in Woods Cross and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Woods Cross"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Woods Cross</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Woods Cross Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Woods Cross Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Woods Cross Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Woods Cross Customers Say About Our Pond Cleaning</h2>
