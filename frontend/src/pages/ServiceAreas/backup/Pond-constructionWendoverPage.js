...
const Pond-constructionWendoverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Wendover | Professional Pond Construction Services"
        description="Expert pond construction services in Wendover. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, wendover pond construction, pond construction wendover"
        canonical="https://utahwatergardens.com/pond-construction-wendover"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Wendover",
          "description": "Professional pond construction services in Wendover",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Wendover"
        subtitle="Professional pond services for Pond Construction Services in Wendover and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Wendover"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Wendover</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wendover Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wendover Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wendover Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wendover Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionWendoverPage;