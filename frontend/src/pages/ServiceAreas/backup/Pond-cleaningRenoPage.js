...
const Pond-cleaningRenoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Reno | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Reno. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, reno pond cleaning, pond cleaning reno"
        canonical="https://utahwatergardens.com/pond-cleaning-reno"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Reno",
          "description": "Professional pond cleaning services in Reno",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Reno"
        subtitle="Professional pond services for Pond Cleaning Services in Reno and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Reno"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Reno</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Reno Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Reno Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Reno Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Reno Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningRenoPage;