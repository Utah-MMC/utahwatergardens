...
const Lake-dredgingEvanstonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Evanston | Professional Lake Dredging Services"
        description="Expert lake dredging services in Evanston. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, evanston lake dredging, lake dredging evanston"
        canonical="https://utahwatergardens.com/lake-dredging-evanston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Evanston",
          "description": "Professional lake dredging services in Evanston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Evanston"
        subtitle="Professional pond services for Lake Dredging Services in Evanston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Evanston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Evanston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Evanston Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Evanston Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Evanston Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Evanston Customers Say About Our Lake Dredging</h2>
