...
const Lake-dredgingTimberLakesPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Timber Lakes | Professional Lake Dredging Services"
        description="Expert lake dredging services in Timber Lakes. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, timber lakes lake dredging, lake dredging timber lakes"
        canonical="https://utahwatergardens.com/lake-dredging-timber-lakes"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Timber Lakes",
          "description": "Professional lake dredging services in Timber Lakes",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Timber Lakes"
        subtitle="Professional pond services for Lake Dredging Services in Timber Lakes and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Timber Lakes"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Timber Lakes</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Timber Lakes Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Timber Lakes Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Timber Lakes Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Timber Lakes Customers Say About Our Lake Dredging</h2>
