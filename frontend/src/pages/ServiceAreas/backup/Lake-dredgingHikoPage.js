...
const Lake-dredgingHikoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Hiko | Professional Lake Dredging Services"
        description="Expert lake dredging services in Hiko. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, hiko lake dredging, lake dredging hiko"
        canonical="https://utahwatergardens.com/lake-dredging-hiko"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Hiko",
          "description": "Professional lake dredging services in Hiko",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Hiko"
        subtitle="Professional pond services for Lake Dredging Services in Hiko and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Hiko"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Hiko</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hiko Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hiko Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hiko Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hiko Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingHikoPage;