...
const Pond-dredgingMenanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Menan | Professional Pond Dredging Services"
        description="Expert pond dredging services in Menan. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, menan pond dredging, pond dredging menan"
        canonical="https://utahwatergardens.com/pond-dredging-menan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Menan",
          "description": "Professional pond dredging services in Menan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Menan"
        subtitle="Professional pond services for Pond Dredging Services in Menan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Menan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Menan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Menan Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Menan Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Menan Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Menan Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMenanPage;