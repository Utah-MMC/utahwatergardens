...
const Pond-dredgingNorthSaltLakePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging North Salt Lake | Professional Pond Dredging Services"
        description="Expert pond dredging services in North Salt Lake. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, north salt lake pond dredging, pond dredging north salt lake"
        canonical="https://utahwatergardens.com/pond-dredging-north-salt-lake"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services North Salt Lake",
          "description": "Professional pond dredging services in North Salt Lake",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in North Salt Lake"
        subtitle="Professional pond services for Pond Dredging Services in North Salt Lake and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in North Salt Lake"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in North Salt Lake</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Salt Lake Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Salt Lake Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Salt Lake Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Salt Lake Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNorthSaltLakePage;