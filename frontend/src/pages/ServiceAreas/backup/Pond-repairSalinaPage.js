...
const Pond-repairSalinaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Salina | Professional Pond Repair Services"
        description="Expert pond repair services in Salina. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, salina pond repair, pond repair salina"
        canonical="https://utahwatergardens.com/pond-repair-salina"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Salina",
          "description": "Professional pond repair services in Salina",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Salina"
        subtitle="Professional pond services for Pond Repair Services in Salina and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Salina"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Salina</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Salina Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Salina Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Salina Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Salina Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSalinaPage;