...
const Pond-cleaningRushValleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Rush Valley | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Rush Valley. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, rush valley pond cleaning, pond cleaning rush valley"
        canonical="https://utahwatergardens.com/pond-cleaning-rush-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Rush Valley",
          "description": "Professional pond cleaning services in Rush Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Rush Valley"
        subtitle="Professional pond services for Pond Cleaning Services in Rush Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Rush Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Rush Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rush Valley Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rush Valley Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rush Valley Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rush Valley Customers Say About Our Pond Cleaning</h2>
