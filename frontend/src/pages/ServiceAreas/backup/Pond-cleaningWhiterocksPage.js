...
const Pond-cleaningWhiterocksPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Whiterocks | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Whiterocks. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, whiterocks pond cleaning, pond cleaning whiterocks"
        canonical="https://utahwatergardens.com/pond-cleaning-whiterocks"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Whiterocks",
          "description": "Professional pond cleaning services in Whiterocks",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Whiterocks"
        subtitle="Professional pond services for Pond Cleaning Services in Whiterocks and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Whiterocks"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Whiterocks</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Whiterocks Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Whiterocks Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Whiterocks Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Whiterocks Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningWhiterocksPage;