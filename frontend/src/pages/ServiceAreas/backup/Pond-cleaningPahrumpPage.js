...
const Pond-cleaningPahrumpPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Pahrump | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Pahrump. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, pahrump pond cleaning, pond cleaning pahrump"
        canonical="https://utahwatergardens.com/pond-cleaning-pahrump"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Pahrump",
          "description": "Professional pond cleaning services in Pahrump",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Pahrump"
        subtitle="Professional pond services for Pond Cleaning Services in Pahrump and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Pahrump"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Pahrump</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pahrump Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pahrump Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pahrump Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pahrump Customers Say About Our Pond Cleaning</h2>
