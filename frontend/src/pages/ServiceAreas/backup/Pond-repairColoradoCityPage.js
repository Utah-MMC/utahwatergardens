...
const Pond-repairColoradoCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Colorado City | Professional Pond Repair Services"
        description="Expert pond repair services in Colorado City. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, colorado city pond repair, pond repair colorado city"
        canonical="https://utahwatergardens.com/pond-repair-colorado-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Colorado City",
          "description": "Professional pond repair services in Colorado City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Colorado City"
        subtitle="Professional pond services for Pond Repair Services in Colorado City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Colorado City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Colorado City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Colorado City Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Colorado City Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Colorado City Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Colorado City Customers Say About Our Pond Repair</h2>
...
export default Pond-repairColoradoCityPage;