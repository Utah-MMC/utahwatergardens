...
const Pond-maintenanceVernalPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Vernal | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Vernal. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, vernal pond maintenance, pond maintenance vernal"
        canonical="https://utahwatergardens.com/pond-maintenance-vernal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Vernal",
          "description": "Professional pond maintenance services in Vernal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Vernal"
        subtitle="Professional pond services for Pond Maintenance Services in Vernal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Vernal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Vernal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vernal Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vernal Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vernal Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vernal Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceVernalPage;