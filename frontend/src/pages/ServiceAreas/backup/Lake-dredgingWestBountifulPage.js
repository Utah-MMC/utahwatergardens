...
const Lake-dredgingWestBountifulPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging West Bountiful | Professional Lake Dredging Services"
        description="Expert lake dredging services in West Bountiful. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, west bountiful lake dredging, lake dredging west bountiful"
        canonical="https://utahwatergardens.com/lake-dredging-west-bountiful"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services West Bountiful",
          "description": "Professional lake dredging services in West Bountiful",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in West Bountiful"
        subtitle="Professional pond services for Lake Dredging Services in West Bountiful and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in West Bountiful"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in West Bountiful</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Bountiful Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Bountiful Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Bountiful Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Bountiful Customers Say About Our Lake Dredging</h2>
