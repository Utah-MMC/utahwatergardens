...
const Pond-constructionBuhlPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Buhl | Professional Pond Construction Services"
        description="Expert pond construction services in Buhl. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, buhl pond construction, pond construction buhl"
        canonical="https://utahwatergardens.com/pond-construction-buhl"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Buhl",
          "description": "Professional pond construction services in Buhl",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Buhl"
        subtitle="Professional pond services for Pond Construction Services in Buhl and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Buhl"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Buhl</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Buhl Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Buhl Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Buhl Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Buhl Customers Say About Our Pond Construction</h2>
