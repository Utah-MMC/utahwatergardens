...
const Pond-cleaningLymanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lyman | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lyman. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lyman pond cleaning, pond cleaning lyman"
        canonical="https://utahwatergardens.com/pond-cleaning-lyman"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lyman",
          "description": "Professional pond cleaning services in Lyman",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lyman"
        subtitle="Professional pond services for Pond Cleaning Services in Lyman and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lyman"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lyman</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lyman Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lyman Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lyman Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lyman Customers Say About Our Pond Cleaning</h2>
