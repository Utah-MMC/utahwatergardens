...
const Pond-cleaningKunaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Kuna | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Kuna. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, kuna pond cleaning, pond cleaning kuna"
        canonical="https://utahwatergardens.com/pond-cleaning-kuna"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Kuna",
          "description": "Professional pond cleaning services in Kuna",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Kuna"
        subtitle="Professional pond services for Pond Cleaning Services in Kuna and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Kuna"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Kuna</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kuna Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kuna Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kuna Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kuna Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningKunaPage;