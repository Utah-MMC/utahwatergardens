...
const Lake-dredgingTelluridePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Telluride | Professional Lake Dredging Services"
        description="Expert lake dredging services in Telluride. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, telluride lake dredging, lake dredging telluride"
        canonical="https://utahwatergardens.com/lake-dredging-telluride"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Telluride",
          "description": "Professional lake dredging services in Telluride",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Telluride"
        subtitle="Professional pond services for Lake Dredging Services in Telluride and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Telluride"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Telluride</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Telluride Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Telluride Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Telluride Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Telluride Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingTelluridePage;