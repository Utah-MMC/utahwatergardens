...
const Pond-dredgingFilerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Filer | Professional Pond Dredging Services"
        description="Expert pond dredging services in Filer. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, filer pond dredging, pond dredging filer"
        canonical="https://utahwatergardens.com/pond-dredging-filer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Filer",
          "description": "Professional pond dredging services in Filer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Filer"
        subtitle="Professional pond services for Pond Dredging Services in Filer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Filer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Filer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Filer Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Filer Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Filer Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Filer Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFilerPage;