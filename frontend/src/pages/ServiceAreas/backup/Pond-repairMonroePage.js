...
const Pond-repairMonroePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Monroe | Professional Pond Repair Services"
        description="Expert pond repair services in Monroe. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, monroe pond repair, pond repair monroe"
        canonical="https://utahwatergardens.com/pond-repair-monroe"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Monroe",
          "description": "Professional pond repair services in Monroe",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Monroe"
        subtitle="Professional pond services for Pond Repair Services in Monroe and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Monroe"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Monroe</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Monroe Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Monroe Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Monroe Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Monroe Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMonroePage;