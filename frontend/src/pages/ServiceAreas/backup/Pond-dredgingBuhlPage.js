...
const Pond-dredgingBuhlPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Buhl | Professional Pond Dredging Services"
        description="Expert pond dredging services in Buhl. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, buhl pond dredging, pond dredging buhl"
        canonical="https://utahwatergardens.com/pond-dredging-buhl"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Buhl",
          "description": "Professional pond dredging services in Buhl",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Buhl"
        subtitle="Professional pond services for Pond Dredging Services in Buhl and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Buhl"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Buhl</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Buhl Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Buhl Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Buhl Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Buhl Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBuhlPage;