...
const Pond-dredgingFruitHeightsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Fruit Heights | Professional Pond Dredging Services"
        description="Expert pond dredging services in Fruit Heights. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, fruit heights pond dredging, pond dredging fruit heights"
        canonical="https://utahwatergardens.com/pond-dredging-fruit-heights"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Fruit Heights",
          "description": "Professional pond dredging services in Fruit Heights",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Fruit Heights"
        subtitle="Professional pond services for Pond Dredging Services in Fruit Heights and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Fruit Heights"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Fruit Heights</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruit Heights Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruit Heights Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruit Heights Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruit Heights Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFruitHeightsPage;