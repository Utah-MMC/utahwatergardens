...
const Pond-repairCallaoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Callao | Professional Pond Repair Services"
        description="Expert pond repair services in Callao. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, callao pond repair, pond repair callao"
        canonical="https://utahwatergardens.com/pond-repair-callao"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Callao",
          "description": "Professional pond repair services in Callao",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Callao"
        subtitle="Professional pond services for Pond Repair Services in Callao and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Callao"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Callao</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Callao Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Callao Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Callao Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Callao Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCallaoPage;