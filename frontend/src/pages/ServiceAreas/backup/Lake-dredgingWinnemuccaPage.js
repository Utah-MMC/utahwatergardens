...
const Lake-dredgingWinnemuccaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Winnemucca | Professional Lake Dredging Services"
        description="Expert lake dredging services in Winnemucca. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, winnemucca lake dredging, lake dredging winnemucca"
        canonical="https://utahwatergardens.com/lake-dredging-winnemucca"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Winnemucca",
          "description": "Professional lake dredging services in Winnemucca",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Winnemucca"
        subtitle="Professional pond services for Lake Dredging Services in Winnemucca and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Winnemucca"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Winnemucca</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Winnemucca Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Winnemucca Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Winnemucca Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Winnemucca Customers Say About Our Lake Dredging</h2>
