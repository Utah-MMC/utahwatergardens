...
const Lake-dredgingEnochPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Enoch | Professional Lake Dredging Services"
        description="Expert lake dredging services in Enoch. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, enoch lake dredging, lake dredging enoch"
        canonical="https://utahwatergardens.com/lake-dredging-enoch"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Enoch",
          "description": "Professional lake dredging services in Enoch",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Enoch"
        subtitle="Professional pond services for Lake Dredging Services in Enoch and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Enoch"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Enoch</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Enoch Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Enoch Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Enoch Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Enoch Customers Say About Our Lake Dredging</h2>
