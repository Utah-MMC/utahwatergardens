...
const Pond-constructionMarriott-SlatervillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Marriott-Slaterville | Professional Pond Construction Services"
        description="Expert pond construction services in Marriott-Slaterville. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, marriott-slaterville pond construction, pond construction marriott-slaterville"
        canonical="https://utahwatergardens.com/pond-construction-marriott-slaterville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Marriott-Slaterville",
          "description": "Professional pond construction services in Marriott-Slaterville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Marriott-Slaterville"
        subtitle="Professional pond services for Pond Construction Services in Marriott-Slaterville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Marriott-Slaterville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Marriott-Slaterville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marriott-Slaterville Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marriott-Slaterville Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marriott-Slaterville Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marriott-Slaterville Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionMarriott-SlatervillePage;