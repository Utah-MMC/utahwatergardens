...
const Pond-constructionStansburyParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Stansbury Park | Professional Pond Construction Services"
        description="Expert pond construction services in Stansbury Park. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, stansbury park pond construction, pond construction stansbury park"
        canonical="https://utahwatergardens.com/pond-construction-stansbury-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Stansbury Park",
          "description": "Professional pond construction services in Stansbury Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Stansbury Park"
        subtitle="Professional pond services for Pond Construction Services in Stansbury Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Stansbury Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Stansbury Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Stansbury Park Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Stansbury Park Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Stansbury Park Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Stansbury Park Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionStansburyParkPage;