...
const Pond-repairBoulderCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Boulder City | Professional Pond Repair Services"
        description="Expert pond repair services in Boulder City. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, boulder city pond repair, pond repair boulder city"
        canonical="https://utahwatergardens.com/pond-repair-boulder-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Boulder City",
          "description": "Professional pond repair services in Boulder City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Boulder City"
        subtitle="Professional pond services for Pond Repair Services in Boulder City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Boulder City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Boulder City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boulder City Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boulder City Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boulder City Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boulder City Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBoulderCityPage;