...
const Pond-dredgingMiddletonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Middleton | Professional Pond Dredging Services"
        description="Expert pond dredging services in Middleton. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, middleton pond dredging, pond dredging middleton"
        canonical="https://utahwatergardens.com/pond-dredging-middleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Middleton",
          "description": "Professional pond dredging services in Middleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Middleton"
        subtitle="Professional pond services for Pond Dredging Services in Middleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Middleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Middleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Middleton Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Middleton Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Middleton Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Middleton Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMiddletonPage;