...
const Lake-dredgingAmmonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Ammon | Professional Lake Dredging Services"
        description="Expert lake dredging services in Ammon. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, ammon lake dredging, lake dredging ammon"
        canonical="https://utahwatergardens.com/lake-dredging-ammon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Ammon",
          "description": "Professional lake dredging services in Ammon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Ammon"
        subtitle="Professional pond services for Lake Dredging Services in Ammon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Ammon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Ammon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ammon Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ammon Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ammon Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ammon Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAmmonPage;