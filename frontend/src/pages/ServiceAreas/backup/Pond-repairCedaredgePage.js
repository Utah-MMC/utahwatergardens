...
const Pond-repairCedaredgePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Cedaredge | Professional Pond Repair Services"
        description="Expert pond repair services in Cedaredge. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, cedaredge pond repair, pond repair cedaredge"
        canonical="https://utahwatergardens.com/pond-repair-cedaredge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Cedaredge",
          "description": "Professional pond repair services in Cedaredge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Cedaredge"
        subtitle="Professional pond services for Pond Repair Services in Cedaredge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Cedaredge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Cedaredge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cedaredge Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cedaredge Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cedaredge Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cedaredge Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCedaredgePage;