...
const Pond-cleaningParachutePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Parachute | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Parachute. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, parachute pond cleaning, pond cleaning parachute"
        canonical="https://utahwatergardens.com/pond-cleaning-parachute"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Parachute",
          "description": "Professional pond cleaning services in Parachute",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Parachute"
        subtitle="Professional pond services for Pond Cleaning Services in Parachute and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Parachute"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Parachute</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parachute Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parachute Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parachute Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parachute Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningParachutePage;