...
const Pond-cleaningNewRiverPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning New River | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in New River. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, new river pond cleaning, pond cleaning new river"
        canonical="https://utahwatergardens.com/pond-cleaning-new-river"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services New River",
          "description": "Professional pond cleaning services in New River",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in New River"
        subtitle="Professional pond services for Pond Cleaning Services in New River and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in New River"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in New River</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New River Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New River Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New River Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New River Customers Say About Our Pond Cleaning</h2>
