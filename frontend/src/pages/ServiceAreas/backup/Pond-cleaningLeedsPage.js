...
const Pond-cleaningLeedsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Leeds | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Leeds. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, leeds pond cleaning, pond cleaning leeds"
        canonical="https://utahwatergardens.com/pond-cleaning-leeds"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Leeds",
          "description": "Professional pond cleaning services in Leeds",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Leeds"
        subtitle="Professional pond services for Pond Cleaning Services in Leeds and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Leeds"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Leeds</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Leeds Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Leeds Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Leeds Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Leeds Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLeedsPage;