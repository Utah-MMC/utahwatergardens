...
const Lake-dredgingWeiserPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Weiser | Professional Lake Dredging Services"
        description="Expert lake dredging services in Weiser. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, weiser lake dredging, lake dredging weiser"
        canonical="https://utahwatergardens.com/lake-dredging-weiser"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Weiser",
          "description": "Professional lake dredging services in Weiser",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Weiser"
        subtitle="Professional pond services for Lake Dredging Services in Weiser and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Weiser"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Weiser</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Weiser Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Weiser Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Weiser Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Weiser Customers Say About Our Lake Dredging</h2>
