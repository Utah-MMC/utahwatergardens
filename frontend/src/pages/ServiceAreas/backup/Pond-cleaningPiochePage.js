...
const Pond-cleaningPiochePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Pioche | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Pioche. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, pioche pond cleaning, pond cleaning pioche"
        canonical="https://utahwatergardens.com/pond-cleaning-pioche"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Pioche",
          "description": "Professional pond cleaning services in Pioche",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Pioche"
        subtitle="Professional pond services for Pond Cleaning Services in Pioche and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Pioche"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Pioche</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pioche Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pioche Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pioche Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pioche Customers Say About Our Pond Cleaning</h2>
