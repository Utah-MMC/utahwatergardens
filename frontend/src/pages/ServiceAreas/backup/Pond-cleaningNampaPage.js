...
const Pond-cleaningNampaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Nampa | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Nampa. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, nampa pond cleaning, pond cleaning nampa"
        canonical="https://utahwatergardens.com/pond-cleaning-nampa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Nampa",
          "description": "Professional pond cleaning services in Nampa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Nampa"
        subtitle="Professional pond services for Pond Cleaning Services in Nampa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Nampa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Nampa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nampa Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nampa Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nampa Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nampa Customers Say About Our Pond Cleaning</h2>
