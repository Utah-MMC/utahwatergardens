...
const Pond-dredgingEckertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Eckert | Professional Pond Dredging Services"
        description="Expert pond dredging services in Eckert. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, eckert pond dredging, pond dredging eckert"
        canonical="https://utahwatergardens.com/pond-dredging-eckert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Eckert",
          "description": "Professional pond dredging services in Eckert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Eckert"
        subtitle="Professional pond services for Pond Dredging Services in Eckert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Eckert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Eckert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eckert Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eckert Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eckert Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eckert Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingEckertPage;