...
const HarvestingElMiragePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting El Mirage | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in El Mirage. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, el mirage aquatic plant harvesting, aquatic plant harvesting el mirage"
        canonical="https://utahwatergardens.com/harvesting-el-mirage"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services El Mirage",
          "description": "Professional aquatic plant harvesting services in El Mirage",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in El Mirage"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in El Mirage and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in El Mirage"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in El Mirage</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our El Mirage Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="El Mirage Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our El Mirage Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What El Mirage Customers Say About Our Aquatic Plant Harvesting</h2>
