...
const Pond-dredgingMeridianPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Meridian | Professional Pond Dredging Services"
        description="Expert pond dredging services in Meridian. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, meridian pond dredging, pond dredging meridian"
        canonical="https://utahwatergardens.com/pond-dredging-meridian"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Meridian",
          "description": "Professional pond dredging services in Meridian",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Meridian"
        subtitle="Professional pond services for Pond Dredging Services in Meridian and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Meridian"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Meridian</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Meridian Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Meridian Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Meridian Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Meridian Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMeridianPage;