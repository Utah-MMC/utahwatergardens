...
const Lake-dredgingChandlerPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Chandler | Professional Lake Dredging Services"
        description="Expert lake dredging services in Chandler. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, chandler lake dredging, lake dredging chandler"
        canonical="https://utahwatergardens.com/lake-dredging-chandler"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Chandler",
          "description": "Professional lake dredging services in Chandler",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Chandler"
        subtitle="Professional pond services for Lake Dredging Services in Chandler and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Chandler"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Chandler</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Chandler Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Chandler Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Chandler Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Chandler Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingChandlerPage;