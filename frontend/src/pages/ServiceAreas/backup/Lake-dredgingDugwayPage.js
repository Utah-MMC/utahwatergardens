...
const Lake-dredgingDugwayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Dugway | Professional Lake Dredging Services"
        description="Expert lake dredging services in Dugway. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, dugway lake dredging, lake dredging dugway"
        canonical="https://utahwatergardens.com/lake-dredging-dugway"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Dugway",
          "description": "Professional lake dredging services in Dugway",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Dugway"
        subtitle="Professional pond services for Lake Dredging Services in Dugway and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Dugway"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Dugway</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dugway Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dugway Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dugway Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dugway Customers Say About Our Lake Dredging</h2>
