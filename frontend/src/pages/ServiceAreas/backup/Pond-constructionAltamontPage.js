...
const Pond-constructionAltamontPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Altamont | Professional Pond Construction Services"
        description="Expert pond construction services in Altamont. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, altamont pond construction, pond construction altamont"
        canonical="https://utahwatergardens.com/pond-construction-altamont"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Altamont",
          "description": "Professional pond construction services in Altamont",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Altamont"
        subtitle="Professional pond services for Pond Construction Services in Altamont and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Altamont"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Altamont</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Altamont Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Altamont Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Altamont Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Altamont Customers Say About Our Pond Construction</h2>
