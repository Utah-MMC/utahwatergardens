...
const Pond-repairWilsonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Wilson | Professional Pond Repair Services"
        description="Expert pond repair services in Wilson. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, wilson pond repair, pond repair wilson"
        canonical="https://utahwatergardens.com/pond-repair-wilson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Wilson",
          "description": "Professional pond repair services in Wilson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Wilson"
        subtitle="Professional pond services for Pond Repair Services in Wilson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Wilson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Wilson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wilson Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wilson Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wilson Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wilson Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWilsonPage;