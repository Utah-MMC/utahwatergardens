...
const Pond-cleaningTimberLakesPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Timber Lakes | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Timber Lakes. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, timber lakes pond cleaning, pond cleaning timber lakes"
        canonical="https://utahwatergardens.com/pond-cleaning-timber-lakes"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Timber Lakes",
          "description": "Professional pond cleaning services in Timber Lakes",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Timber Lakes"
        subtitle="Professional pond services for Pond Cleaning Services in Timber Lakes and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Timber Lakes"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Timber Lakes</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Timber Lakes Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Timber Lakes Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Timber Lakes Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Timber Lakes Customers Say About Our Pond Cleaning</h2>
