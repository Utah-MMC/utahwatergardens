...
const Lake-dredgingProvoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Provo | Professional Lake Dredging Services"
        description="Expert lake dredging services in Provo. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, provo lake dredging, lake dredging provo"
        canonical="https://utahwatergardens.com/lake-dredging-provo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Provo",
          "description": "Professional lake dredging services in Provo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Provo"
        subtitle="Professional pond services for Lake Dredging Services in Provo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Provo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Provo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Provo Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Provo Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Provo Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Provo Customers Say About Our Lake Dredging</h2>
