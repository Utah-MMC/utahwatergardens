...
const Pond-cleaningAmmonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Ammon | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Ammon. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, ammon pond cleaning, pond cleaning ammon"
        canonical="https://utahwatergardens.com/pond-cleaning-ammon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Ammon",
          "description": "Professional pond cleaning services in Ammon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Ammon"
        subtitle="Professional pond services for Pond Cleaning Services in Ammon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Ammon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Ammon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ammon Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ammon Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ammon Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ammon Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAmmonPage;