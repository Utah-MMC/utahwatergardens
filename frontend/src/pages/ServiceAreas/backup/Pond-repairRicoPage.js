...
const Pond-repairRicoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Rico | Professional Pond Repair Services"
        description="Expert pond repair services in Rico. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, rico pond repair, pond repair rico"
        canonical="https://utahwatergardens.com/pond-repair-rico"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Rico",
          "description": "Professional pond repair services in Rico",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Rico"
        subtitle="Professional pond services for Pond Repair Services in Rico and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Rico"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Rico</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rico Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rico Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rico Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rico Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRicoPage;