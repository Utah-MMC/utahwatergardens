...
const Lake-dredgingWestPointPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging West Point | Professional Lake Dredging Services"
        description="Expert lake dredging services in West Point. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, west point lake dredging, lake dredging west point"
        canonical="https://utahwatergardens.com/lake-dredging-west-point"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services West Point",
          "description": "Professional lake dredging services in West Point",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in West Point"
        subtitle="Professional pond services for Lake Dredging Services in West Point and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in West Point"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in West Point</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Point Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Point Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Point Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Point Customers Say About Our Lake Dredging</h2>
