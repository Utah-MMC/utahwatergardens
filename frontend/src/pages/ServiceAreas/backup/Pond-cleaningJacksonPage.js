...
const Pond-cleaningJacksonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Jackson | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Jackson. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, jackson pond cleaning, pond cleaning jackson"
        canonical="https://utahwatergardens.com/pond-cleaning-jackson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Jackson",
          "description": "Professional pond cleaning services in Jackson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Jackson"
        subtitle="Professional pond services for Pond Cleaning Services in Jackson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Jackson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Jackson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jackson Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jackson Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jackson Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jackson Customers Say About Our Pond Cleaning</h2>
