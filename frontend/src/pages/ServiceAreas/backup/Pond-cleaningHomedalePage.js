...
const Pond-cleaningHomedalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Homedale | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Homedale. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, homedale pond cleaning, pond cleaning homedale"
        canonical="https://utahwatergardens.com/pond-cleaning-homedale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Homedale",
          "description": "Professional pond cleaning services in Homedale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Homedale"
        subtitle="Professional pond services for Pond Cleaning Services in Homedale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Homedale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Homedale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Homedale Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Homedale Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Homedale Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Homedale Customers Say About Our Pond Cleaning</h2>
