...
const Pond-cleaningGarlandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Garland | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Garland. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, garland pond cleaning, pond cleaning garland"
        canonical="https://utahwatergardens.com/pond-cleaning-garland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Garland",
          "description": "Professional pond cleaning services in Garland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Garland"
        subtitle="Professional pond services for Pond Cleaning Services in Garland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Garland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Garland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Garland Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Garland Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Garland Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Garland Customers Say About Our Pond Cleaning</h2>
