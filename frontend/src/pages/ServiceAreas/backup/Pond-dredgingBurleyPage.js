...
const Pond-dredgingBurleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Burley | Professional Pond Dredging Services"
        description="Expert pond dredging services in Burley. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, burley pond dredging, pond dredging burley"
        canonical="https://utahwatergardens.com/pond-dredging-burley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Burley",
          "description": "Professional pond dredging services in Burley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Burley"
        subtitle="Professional pond services for Pond Dredging Services in Burley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Burley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Burley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Burley Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Burley Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Burley Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Burley Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBurleyPage;