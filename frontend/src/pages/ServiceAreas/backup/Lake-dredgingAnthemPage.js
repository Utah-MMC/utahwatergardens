...
const Lake-dredgingAnthemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Anthem | Professional Lake Dredging Services"
        description="Expert lake dredging services in Anthem. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, anthem lake dredging, lake dredging anthem"
        canonical="https://utahwatergardens.com/lake-dredging-anthem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Anthem",
          "description": "Professional lake dredging services in Anthem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Anthem"
        subtitle="Professional pond services for Lake Dredging Services in Anthem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Anthem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Anthem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Anthem Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Anthem Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Anthem Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Anthem Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAnthemPage;