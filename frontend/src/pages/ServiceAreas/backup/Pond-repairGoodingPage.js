...
const Pond-repairGoodingPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Gooding | Professional Pond Repair Services"
        description="Expert pond repair services in Gooding. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, gooding pond repair, pond repair gooding"
        canonical="https://utahwatergardens.com/pond-repair-gooding"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Gooding",
          "description": "Professional pond repair services in Gooding",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Gooding"
        subtitle="Professional pond services for Pond Repair Services in Gooding and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Gooding"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Gooding</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gooding Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gooding Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gooding Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gooding Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGoodingPage;