...
const Pond-repairBenjaminPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Benjamin | Professional Pond Repair Services"
        description="Expert pond repair services in Benjamin. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, benjamin pond repair, pond repair benjamin"
        canonical="https://utahwatergardens.com/pond-repair-benjamin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Benjamin",
          "description": "Professional pond repair services in Benjamin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Benjamin"
        subtitle="Professional pond services for Pond Repair Services in Benjamin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Benjamin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Benjamin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Benjamin Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Benjamin Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Benjamin Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Benjamin Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBenjaminPage;