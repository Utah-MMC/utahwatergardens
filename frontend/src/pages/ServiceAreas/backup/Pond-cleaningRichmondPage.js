...
const Pond-cleaningRichmondPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Richmond | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Richmond. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, richmond pond cleaning, pond cleaning richmond"
        canonical="https://utahwatergardens.com/pond-cleaning-richmond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Richmond",
          "description": "Professional pond cleaning services in Richmond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Richmond"
        subtitle="Professional pond services for Pond Cleaning Services in Richmond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Richmond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Richmond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Richmond Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Richmond Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Richmond Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Richmond Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningRichmondPage;