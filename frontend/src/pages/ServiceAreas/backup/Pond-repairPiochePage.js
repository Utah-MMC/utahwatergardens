...
const Pond-repairPiochePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Pioche | Professional Pond Repair Services"
        description="Expert pond repair services in Pioche. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, pioche pond repair, pond repair pioche"
        canonical="https://utahwatergardens.com/pond-repair-pioche"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Pioche",
          "description": "Professional pond repair services in Pioche",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Pioche"
        subtitle="Professional pond services for Pond Repair Services in Pioche and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Pioche"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Pioche</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pioche Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pioche Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pioche Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pioche Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPiochePage;