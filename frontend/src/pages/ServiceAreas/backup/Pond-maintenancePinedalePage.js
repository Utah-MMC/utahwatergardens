...
const Pond-maintenancePinedalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Pinedale | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Pinedale. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, pinedale pond maintenance, pond maintenance pinedale"
        canonical="https://utahwatergardens.com/pond-maintenance-pinedale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Pinedale",
          "description": "Professional pond maintenance services in Pinedale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Pinedale"
        subtitle="Professional pond services for Pond Maintenance Services in Pinedale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Pinedale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Pinedale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pinedale Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pinedale Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pinedale Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pinedale Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenancePinedalePage;