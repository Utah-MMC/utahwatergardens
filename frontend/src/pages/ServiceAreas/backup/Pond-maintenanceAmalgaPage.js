...
const Pond-maintenanceAmalgaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Amalga | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Amalga. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, amalga pond maintenance, pond maintenance amalga"
        canonical="https://utahwatergardens.com/pond-maintenance-amalga"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Amalga",
          "description": "Professional pond maintenance services in Amalga",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Amalga"
        subtitle="Professional pond services for Pond Maintenance Services in Amalga and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Amalga"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Amalga</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Amalga Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Amalga Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Amalga Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Amalga Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceAmalgaPage;