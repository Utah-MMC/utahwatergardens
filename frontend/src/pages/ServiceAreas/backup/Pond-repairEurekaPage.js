...
const Pond-repairEurekaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Eureka | Professional Pond Repair Services"
        description="Expert pond repair services in Eureka. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, eureka pond repair, pond repair eureka"
        canonical="https://utahwatergardens.com/pond-repair-eureka"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Eureka",
          "description": "Professional pond repair services in Eureka",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Eureka"
        subtitle="Professional pond services for Pond Repair Services in Eureka and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Eureka"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Eureka</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eureka Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eureka Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eureka Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eureka Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEurekaPage;