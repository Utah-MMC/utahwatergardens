...
const Lake-dredgingKellyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Kelly | Professional Lake Dredging Services"
        description="Expert lake dredging services in Kelly. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, kelly lake dredging, lake dredging kelly"
        canonical="https://utahwatergardens.com/lake-dredging-kelly"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Kelly",
          "description": "Professional lake dredging services in Kelly",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Kelly"
        subtitle="Professional pond services for Lake Dredging Services in Kelly and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Kelly"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Kelly</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kelly Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kelly Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kelly Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kelly Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingKellyPage;