...
const Pond-cleaningOphirPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Ophir | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Ophir. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, ophir pond cleaning, pond cleaning ophir"
        canonical="https://utahwatergardens.com/pond-cleaning-ophir"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Ophir",
          "description": "Professional pond cleaning services in Ophir",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Ophir"
        subtitle="Professional pond services for Pond Cleaning Services in Ophir and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Ophir"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Ophir</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ophir Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ophir Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ophir Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ophir Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningOphirPage;