...
const Pond-repairRivertonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Riverton | Professional Pond Repair Services"
        description="Expert pond repair services in Riverton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, riverton pond repair, pond repair riverton"
        canonical="https://utahwatergardens.com/pond-repair-riverton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Riverton",
          "description": "Professional pond repair services in Riverton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Riverton"
        subtitle="Professional pond services for Pond Repair Services in Riverton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Riverton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Riverton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Riverton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Riverton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Riverton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Riverton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRivertonPage;