...
const Pond-maintenanceLaVerkinPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance La Verkin | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in La Verkin. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, la verkin pond maintenance, pond maintenance la verkin"
        canonical="https://utahwatergardens.com/pond-maintenance-la-verkin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services La Verkin",
          "description": "Professional pond maintenance services in La Verkin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in La Verkin"
        subtitle="Professional pond services for Pond Maintenance Services in La Verkin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in La Verkin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in La Verkin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Verkin Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Verkin Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Verkin Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Verkin Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceLaVerkinPage;