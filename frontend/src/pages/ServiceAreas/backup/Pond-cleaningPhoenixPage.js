...
const Pond-cleaningPhoenixPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Phoenix | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Phoenix. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, phoenix pond cleaning, pond cleaning phoenix"
        canonical="https://utahwatergardens.com/pond-cleaning-phoenix"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Phoenix",
          "description": "Professional pond cleaning services in Phoenix",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Phoenix"
        subtitle="Professional pond services for Pond Cleaning Services in Phoenix and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Phoenix"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Phoenix</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Phoenix Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Phoenix Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Phoenix Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Phoenix Customers Say About Our Pond Cleaning</h2>
