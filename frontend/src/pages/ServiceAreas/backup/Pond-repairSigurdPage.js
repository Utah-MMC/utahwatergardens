...
const Pond-repairSigurdPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Sigurd | Professional Pond Repair Services"
        description="Expert pond repair services in Sigurd. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, sigurd pond repair, pond repair sigurd"
        canonical="https://utahwatergardens.com/pond-repair-sigurd"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Sigurd",
          "description": "Professional pond repair services in Sigurd",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Sigurd"
        subtitle="Professional pond services for Pond Repair Services in Sigurd and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Sigurd"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Sigurd</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sigurd Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sigurd Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sigurd Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sigurd Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSigurdPage;