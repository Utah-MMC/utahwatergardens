...
const Lake-dredgingHeyburnPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Heyburn | Professional Lake Dredging Services"
        description="Expert lake dredging services in Heyburn. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, heyburn lake dredging, lake dredging heyburn"
        canonical="https://utahwatergardens.com/lake-dredging-heyburn"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Heyburn",
          "description": "Professional lake dredging services in Heyburn",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Heyburn"
        subtitle="Professional pond services for Lake Dredging Services in Heyburn and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Heyburn"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Heyburn</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Heyburn Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Heyburn Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Heyburn Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Heyburn Customers Say About Our Lake Dredging</h2>
