...
const Lake-dredgingIvinsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Ivins | Professional Lake Dredging Services"
        description="Expert lake dredging services in Ivins. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, ivins lake dredging, lake dredging ivins"
        canonical="https://utahwatergardens.com/lake-dredging-ivins"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Ivins",
          "description": "Professional lake dredging services in Ivins",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Ivins"
        subtitle="Professional pond services for Lake Dredging Services in Ivins and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Ivins"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Ivins</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ivins Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ivins Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ivins Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ivins Customers Say About Our Lake Dredging</h2>
