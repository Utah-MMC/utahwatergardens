...
const Pond-repairEdenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Eden | Professional Pond Repair Services"
        description="Expert pond repair services in Eden. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, eden pond repair, pond repair eden"
        canonical="https://utahwatergardens.com/pond-repair-eden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Eden",
          "description": "Professional pond repair services in Eden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Eden"
        subtitle="Professional pond services for Pond Repair Services in Eden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Eden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Eden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eden Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eden Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eden Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eden Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEdenPage;