...
const Lake-dredgingNampaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Nampa | Professional Lake Dredging Services"
        description="Expert lake dredging services in Nampa. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, nampa lake dredging, lake dredging nampa"
        canonical="https://utahwatergardens.com/lake-dredging-nampa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Nampa",
          "description": "Professional lake dredging services in Nampa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Nampa"
        subtitle="Professional pond services for Lake Dredging Services in Nampa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Nampa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Nampa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nampa Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nampa Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nampa Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nampa Customers Say About Our Lake Dredging</h2>
