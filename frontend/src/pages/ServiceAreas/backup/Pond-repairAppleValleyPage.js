...
const Pond-repairAppleValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Apple Valley | Professional Pond Repair Services"
        description="Expert pond repair services in Apple Valley. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, apple valley pond repair, pond repair apple valley"
        canonical="https://utahwatergardens.com/pond-repair-apple-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Apple Valley",
          "description": "Professional pond repair services in Apple Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Apple Valley"
        subtitle="Professional pond services for Pond Repair Services in Apple Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Apple Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Apple Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Apple Valley Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Apple Valley Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Apple Valley Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Apple Valley Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAppleValleyPage;