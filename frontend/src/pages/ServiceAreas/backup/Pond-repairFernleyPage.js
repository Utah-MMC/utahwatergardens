...
const Pond-repairFernleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Fernley | Professional Pond Repair Services"
        description="Expert pond repair services in Fernley. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, fernley pond repair, pond repair fernley"
        canonical="https://utahwatergardens.com/pond-repair-fernley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Fernley",
          "description": "Professional pond repair services in Fernley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Fernley"
        subtitle="Professional pond services for Pond Repair Services in Fernley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Fernley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Fernley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fernley Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fernley Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fernley Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fernley Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFernleyPage;