...
const Lake-dredgingQueenCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Queen Creek | Professional Lake Dredging Services"
        description="Expert lake dredging services in Queen Creek. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, queen creek lake dredging, lake dredging queen creek"
        canonical="https://utahwatergardens.com/lake-dredging-queen-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Queen Creek",
          "description": "Professional lake dredging services in Queen Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Queen Creek"
        subtitle="Professional pond services for Lake Dredging Services in Queen Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Queen Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Queen Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Queen Creek Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Queen Creek Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Queen Creek Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Queen Creek Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingQueenCreekPage;