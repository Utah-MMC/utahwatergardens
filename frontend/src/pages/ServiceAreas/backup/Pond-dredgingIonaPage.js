...
const Pond-dredgingIonaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Iona | Professional Pond Dredging Services"
        description="Expert pond dredging services in Iona. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, iona pond dredging, pond dredging iona"
        canonical="https://utahwatergardens.com/pond-dredging-iona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Iona",
          "description": "Professional pond dredging services in Iona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Iona"
        subtitle="Professional pond services for Pond Dredging Services in Iona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Iona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Iona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Iona Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Iona Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Iona Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Iona Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingIonaPage;