...
const Lake-dredgingNephiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Nephi | Professional Lake Dredging Services"
        description="Expert lake dredging services in Nephi. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, nephi lake dredging, lake dredging nephi"
        canonical="https://utahwatergardens.com/lake-dredging-nephi"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Nephi",
          "description": "Professional lake dredging services in Nephi",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Nephi"
        subtitle="Professional pond services for Lake Dredging Services in Nephi and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Nephi"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Nephi</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nephi Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nephi Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nephi Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nephi Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingNephiPage;