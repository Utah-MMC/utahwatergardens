...
const Lake-dredgingCaveCreekPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Cave Creek | Professional Lake Dredging Services"
        description="Expert lake dredging services in Cave Creek. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, cave creek lake dredging, lake dredging cave creek"
        canonical="https://utahwatergardens.com/lake-dredging-cave-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Cave Creek",
          "description": "Professional lake dredging services in Cave Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Cave Creek"
        subtitle="Professional pond services for Lake Dredging Services in Cave Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Cave Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Cave Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cave Creek Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cave Creek Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cave Creek Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cave Creek Customers Say About Our Lake Dredging</h2>
