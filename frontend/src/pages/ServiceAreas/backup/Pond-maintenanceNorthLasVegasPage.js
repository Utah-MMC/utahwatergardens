...
const Pond-maintenanceNorthLasVegasPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance North Las Vegas | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in North Las Vegas. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, north las vegas pond maintenance, pond maintenance north las vegas"
        canonical="https://utahwatergardens.com/pond-maintenance-north-las-vegas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services North Las Vegas",
          "description": "Professional pond maintenance services in North Las Vegas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in North Las Vegas"
        subtitle="Professional pond services for Pond Maintenance Services in North Las Vegas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in North Las Vegas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in North Las Vegas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Las Vegas Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Las Vegas Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Las Vegas Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Las Vegas Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceNorthLasVegasPage;