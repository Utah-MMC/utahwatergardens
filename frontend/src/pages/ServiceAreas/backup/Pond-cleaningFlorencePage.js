...
const Pond-cleaningFlorencePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Florence | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Florence. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, florence pond cleaning, pond cleaning florence"
        canonical="https://utahwatergardens.com/pond-cleaning-florence"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Florence",
          "description": "Professional pond cleaning services in Florence",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Florence"
        subtitle="Professional pond services for Pond Cleaning Services in Florence and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Florence"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Florence</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Florence Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Florence Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Florence Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Florence Customers Say About Our Pond Cleaning</h2>
