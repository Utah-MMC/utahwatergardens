...
const Pond-cleaningLaGrangePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning La Grange | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in La Grange. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, la grange pond cleaning, pond cleaning la grange"
        canonical="https://utahwatergardens.com/pond-cleaning-la-grange"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services La Grange",
          "description": "Professional pond cleaning services in La Grange",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in La Grange"
        subtitle="Professional pond services for Pond Cleaning Services in La Grange and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in La Grange"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in La Grange</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Grange Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Grange Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Grange Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Grange Customers Say About Our Pond Cleaning</h2>
