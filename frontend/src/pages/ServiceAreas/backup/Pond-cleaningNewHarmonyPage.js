...
const Pond-cleaningNewHarmonyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning New Harmony | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in New Harmony. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, new harmony pond cleaning, pond cleaning new harmony"
        canonical="https://utahwatergardens.com/pond-cleaning-new-harmony"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services New Harmony",
          "description": "Professional pond cleaning services in New Harmony",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in New Harmony"
        subtitle="Professional pond services for Pond Cleaning Services in New Harmony and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in New Harmony"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in New Harmony</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Harmony Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Harmony Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Harmony Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Harmony Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningNewHarmonyPage;