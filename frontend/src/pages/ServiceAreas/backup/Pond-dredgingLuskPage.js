...
const Pond-dredgingLuskPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lusk | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lusk. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lusk pond dredging, pond dredging lusk"
        canonical="https://utahwatergardens.com/pond-dredging-lusk"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lusk",
          "description": "Professional pond dredging services in Lusk",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lusk"
        subtitle="Professional pond services for Pond Dredging Services in Lusk and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lusk"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lusk</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lusk Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lusk Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lusk Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lusk Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLuskPage;