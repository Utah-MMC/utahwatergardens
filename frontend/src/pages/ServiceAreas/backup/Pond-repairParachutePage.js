...
const Pond-repairParachutePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Parachute | Professional Pond Repair Services"
        description="Expert pond repair services in Parachute. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, parachute pond repair, pond repair parachute"
        canonical="https://utahwatergardens.com/pond-repair-parachute"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Parachute",
          "description": "Professional pond repair services in Parachute",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Parachute"
        subtitle="Professional pond services for Pond Repair Services in Parachute and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Parachute"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Parachute</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parachute Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parachute Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parachute Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parachute Customers Say About Our Pond Repair</h2>
...
export default Pond-repairParachutePage;