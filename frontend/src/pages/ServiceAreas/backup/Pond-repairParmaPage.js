...
const Pond-repairParmaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Parma | Professional Pond Repair Services"
        description="Expert pond repair services in Parma. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, parma pond repair, pond repair parma"
        canonical="https://utahwatergardens.com/pond-repair-parma"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Parma",
          "description": "Professional pond repair services in Parma",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Parma"
        subtitle="Professional pond services for Pond Repair Services in Parma and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Parma"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Parma</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parma Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parma Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parma Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parma Customers Say About Our Pond Repair</h2>
...
export default Pond-repairParmaPage;