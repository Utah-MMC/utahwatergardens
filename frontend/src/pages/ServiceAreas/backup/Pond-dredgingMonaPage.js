...
const Pond-dredgingMonaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Mona | Professional Pond Dredging Services"
        description="Expert pond dredging services in Mona. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, mona pond dredging, pond dredging mona"
        canonical="https://utahwatergardens.com/pond-dredging-mona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Mona",
          "description": "Professional pond dredging services in Mona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Mona"
        subtitle="Professional pond services for Pond Dredging Services in Mona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Mona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Mona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mona Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mona Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mona Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mona Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMonaPage;