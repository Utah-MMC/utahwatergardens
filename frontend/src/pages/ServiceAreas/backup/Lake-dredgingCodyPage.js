...
const Lake-dredgingCodyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Cody | Professional Lake Dredging Services"
        description="Expert lake dredging services in Cody. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, cody lake dredging, lake dredging cody"
        canonical="https://utahwatergardens.com/lake-dredging-cody"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Cody",
          "description": "Professional lake dredging services in Cody",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Cody"
        subtitle="Professional pond services for Lake Dredging Services in Cody and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Cody"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Cody</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cody Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cody Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cody Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cody Customers Say About Our Lake Dredging</h2>
