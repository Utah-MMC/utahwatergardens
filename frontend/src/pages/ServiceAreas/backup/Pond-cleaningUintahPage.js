...
const Pond-cleaningUintahPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Uintah | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Uintah. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, uintah pond cleaning, pond cleaning uintah"
        canonical="https://utahwatergardens.com/pond-cleaning-uintah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Uintah",
          "description": "Professional pond cleaning services in Uintah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Uintah"
        subtitle="Professional pond services for Pond Cleaning Services in Uintah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Uintah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Uintah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Uintah Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Uintah Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Uintah Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Uintah Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningUintahPage;