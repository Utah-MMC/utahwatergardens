...
const Pond-repairCarlinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Carlin | Professional Pond Repair Services"
        description="Expert pond repair services in Carlin. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, carlin pond repair, pond repair carlin"
        canonical="https://utahwatergardens.com/pond-repair-carlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Carlin",
          "description": "Professional pond repair services in Carlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Carlin"
        subtitle="Professional pond services for Pond Repair Services in Carlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Carlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Carlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carlin Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carlin Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carlin Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carlin Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCarlinPage;