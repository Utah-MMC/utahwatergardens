...
const Pond-maintenanceRooseveltPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Roosevelt | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Roosevelt. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, roosevelt pond maintenance, pond maintenance roosevelt"
        canonical="https://utahwatergardens.com/pond-maintenance-roosevelt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Roosevelt",
          "description": "Professional pond maintenance services in Roosevelt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Roosevelt"
        subtitle="Professional pond services for Pond Maintenance Services in Roosevelt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Roosevelt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Roosevelt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Roosevelt Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Roosevelt Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Roosevelt Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Roosevelt Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceRooseveltPage;