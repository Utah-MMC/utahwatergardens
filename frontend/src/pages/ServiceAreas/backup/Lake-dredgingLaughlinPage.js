...
const Lake-dredgingLaughlinPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Laughlin | Professional Lake Dredging Services"
        description="Expert lake dredging services in Laughlin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, laughlin lake dredging, lake dredging laughlin"
        canonical="https://utahwatergardens.com/lake-dredging-laughlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Laughlin",
          "description": "Professional lake dredging services in Laughlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Laughlin"
        subtitle="Professional pond services for Lake Dredging Services in Laughlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Laughlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Laughlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Laughlin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Laughlin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Laughlin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Laughlin Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingLaughlinPage;