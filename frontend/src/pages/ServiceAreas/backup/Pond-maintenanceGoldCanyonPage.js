...
const Pond-maintenanceGoldCanyonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Gold Canyon | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Gold Canyon. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, gold canyon pond maintenance, pond maintenance gold canyon"
        canonical="https://utahwatergardens.com/pond-maintenance-gold-canyon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Gold Canyon",
          "description": "Professional pond maintenance services in Gold Canyon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Gold Canyon"
        subtitle="Professional pond services for Pond Maintenance Services in Gold Canyon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Gold Canyon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Gold Canyon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gold Canyon Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gold Canyon Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gold Canyon Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gold Canyon Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceGoldCanyonPage;