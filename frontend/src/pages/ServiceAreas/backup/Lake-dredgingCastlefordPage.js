...
const Lake-dredgingCastlefordPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Castleford | Professional Lake Dredging Services"
        description="Expert lake dredging services in Castleford. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, castleford lake dredging, lake dredging castleford"
        canonical="https://utahwatergardens.com/lake-dredging-castleford"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Castleford",
          "description": "Professional lake dredging services in Castleford",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Castleford"
        subtitle="Professional pond services for Lake Dredging Services in Castleford and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Castleford"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Castleford</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Castleford Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Castleford Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Castleford Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Castleford Customers Say About Our Lake Dredging</h2>
