...
const Pond-dredgingElkoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Elko | Professional Pond Dredging Services"
        description="Expert pond dredging services in Elko. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, elko pond dredging, pond dredging elko"
        canonical="https://utahwatergardens.com/pond-dredging-elko"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Elko",
          "description": "Professional pond dredging services in Elko",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Elko"
        subtitle="Professional pond services for Pond Dredging Services in Elko and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Elko"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Elko</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elko Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elko Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elko Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elko Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingElkoPage;