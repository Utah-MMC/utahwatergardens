...
const Pond-dredgingDanielPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Daniel | Professional Pond Dredging Services"
        description="Expert pond dredging services in Daniel. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, daniel pond dredging, pond dredging daniel"
        canonical="https://utahwatergardens.com/pond-dredging-daniel"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Daniel",
          "description": "Professional pond dredging services in Daniel",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Daniel"
        subtitle="Professional pond services for Pond Dredging Services in Daniel and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Daniel"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Daniel</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Daniel Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Daniel Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Daniel Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Daniel Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingDanielPage;