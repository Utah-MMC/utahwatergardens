...
const Lake-dredgingBuhlPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Buhl | Professional Lake Dredging Services"
        description="Expert lake dredging services in Buhl. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, buhl lake dredging, lake dredging buhl"
        canonical="https://utahwatergardens.com/lake-dredging-buhl"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Buhl",
          "description": "Professional lake dredging services in Buhl",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Buhl"
        subtitle="Professional pond services for Lake Dredging Services in Buhl and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Buhl"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Buhl</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Buhl Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Buhl Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Buhl Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Buhl Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingBuhlPage;