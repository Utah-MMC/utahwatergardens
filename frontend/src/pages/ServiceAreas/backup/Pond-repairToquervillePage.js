...
const Pond-repairToquervillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Toquerville | Professional Pond Repair Services"
        description="Expert pond repair services in Toquerville. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, toquerville pond repair, pond repair toquerville"
        canonical="https://utahwatergardens.com/pond-repair-toquerville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Toquerville",
          "description": "Professional pond repair services in Toquerville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Toquerville"
        subtitle="Professional pond services for Pond Repair Services in Toquerville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Toquerville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Toquerville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Toquerville Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Toquerville Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Toquerville Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Toquerville Customers Say About Our Pond Repair</h2>
...
export default Pond-repairToquervillePage;