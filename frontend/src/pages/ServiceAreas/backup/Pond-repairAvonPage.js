...
const Pond-repairAvonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Avon | Professional Pond Repair Services"
        description="Expert pond repair services in Avon. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, avon pond repair, pond repair avon"
        canonical="https://utahwatergardens.com/pond-repair-avon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Avon",
          "description": "Professional pond repair services in Avon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Avon"
        subtitle="Professional pond services for Pond Repair Services in Avon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Avon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Avon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Avon Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Avon Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Avon Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Avon Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAvonPage;