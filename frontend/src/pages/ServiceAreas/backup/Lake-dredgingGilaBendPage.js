...
const Lake-dredgingGilaBendPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Gila Bend | Professional Lake Dredging Services"
        description="Expert lake dredging services in Gila Bend. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, gila bend lake dredging, lake dredging gila bend"
        canonical="https://utahwatergardens.com/lake-dredging-gila-bend"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Gila Bend",
          "description": "Professional lake dredging services in Gila Bend",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Gila Bend"
        subtitle="Professional pond services for Lake Dredging Services in Gila Bend and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Gila Bend"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Gila Bend</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gila Bend Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gila Bend Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gila Bend Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gila Bend Customers Say About Our Lake Dredging</h2>
