...
const Pond-repairSunrisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Sunrise | Professional Pond Repair Services"
        description="Expert pond repair services in Sunrise. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, sunrise pond repair, pond repair sunrise"
        canonical="https://utahwatergardens.com/pond-repair-sunrise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Sunrise",
          "description": "Professional pond repair services in Sunrise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Sunrise"
        subtitle="Professional pond services for Pond Repair Services in Sunrise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Sunrise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Sunrise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunrise Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunrise Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunrise Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunrise Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSunrisePage;