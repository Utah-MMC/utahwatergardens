...
const Pond-cleaningManvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Manville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Manville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, manville pond cleaning, pond cleaning manville"
        canonical="https://utahwatergardens.com/pond-cleaning-manville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Manville",
          "description": "Professional pond cleaning services in Manville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Manville"
        subtitle="Professional pond services for Pond Cleaning Services in Manville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Manville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Manville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Manville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Manville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Manville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Manville Customers Say About Our Pond Cleaning</h2>
