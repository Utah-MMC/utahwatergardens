...
const Pond-cleaningMendonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Mendon | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Mendon. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, mendon pond cleaning, pond cleaning mendon"
        canonical="https://utahwatergardens.com/pond-cleaning-mendon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Mendon",
          "description": "Professional pond cleaning services in Mendon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Mendon"
        subtitle="Professional pond services for Pond Cleaning Services in Mendon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Mendon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Mendon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mendon Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mendon Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mendon Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mendon Customers Say About Our Pond Cleaning</h2>
