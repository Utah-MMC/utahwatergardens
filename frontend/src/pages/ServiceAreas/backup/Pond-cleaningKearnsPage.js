...
const Pond-cleaningKearnsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Kearns | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Kearns. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, kearns pond cleaning, pond cleaning kearns"
        canonical="https://utahwatergardens.com/pond-cleaning-kearns"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Kearns",
          "description": "Professional pond cleaning services in Kearns",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Kearns"
        subtitle="Professional pond services for Pond Cleaning Services in Kearns and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Kearns"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Kearns</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kearns Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kearns Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kearns Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kearns Customers Say About Our Pond Cleaning</h2>
