...
const Pond-dredgingPayettePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Payette | Professional Pond Dredging Services"
        description="Expert pond dredging services in Payette. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, payette pond dredging, pond dredging payette"
        canonical="https://utahwatergardens.com/pond-dredging-payette"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Payette",
          "description": "Professional pond dredging services in Payette",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Payette"
        subtitle="Professional pond services for Pond Dredging Services in Payette and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Payette"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Payette</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Payette Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Payette Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Payette Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Payette Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPayettePage;