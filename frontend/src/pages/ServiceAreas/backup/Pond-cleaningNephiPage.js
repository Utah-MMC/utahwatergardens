...
const Pond-cleaningNephiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Nephi | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Nephi. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, nephi pond cleaning, pond cleaning nephi"
        canonical="https://utahwatergardens.com/pond-cleaning-nephi"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Nephi",
          "description": "Professional pond cleaning services in Nephi",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Nephi"
        subtitle="Professional pond services for Pond Cleaning Services in Nephi and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Nephi"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Nephi</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nephi Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nephi Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nephi Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nephi Customers Say About Our Pond Cleaning</h2>
