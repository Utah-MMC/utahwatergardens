...
const Lake-dredgingMillvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Millville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Millville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, millville lake dredging, lake dredging millville"
        canonical="https://utahwatergardens.com/lake-dredging-millville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Millville",
          "description": "Professional lake dredging services in Millville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Millville"
        subtitle="Professional pond services for Lake Dredging Services in Millville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Millville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Millville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Millville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Millville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Millville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Millville Customers Say About Our Lake Dredging</h2>
