...
const Pond-dredgingWestValleyCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging West Valley City | Professional Pond Dredging Services"
        description="Expert pond dredging services in West Valley City. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, west valley city pond dredging, pond dredging west valley city"
        canonical="https://utahwatergardens.com/pond-dredging-west-valley-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services West Valley City",
          "description": "Professional pond dredging services in West Valley City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in West Valley City"
        subtitle="Professional pond services for Pond Dredging Services in West Valley City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in West Valley City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in West Valley City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Valley City Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Valley City Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Valley City Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Valley City Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWestValleyCityPage;