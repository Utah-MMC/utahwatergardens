...
const Pond-cleaningCentralPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Central | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Central. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, central pond cleaning, pond cleaning central"
        canonical="https://utahwatergardens.com/pond-cleaning-central"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Central",
          "description": "Professional pond cleaning services in Central",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Central"
        subtitle="Professional pond services for Pond Cleaning Services in Central and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Central"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Central</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Central Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Central Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Central Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Central Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCentralPage;