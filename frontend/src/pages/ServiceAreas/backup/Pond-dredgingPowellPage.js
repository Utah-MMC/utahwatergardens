...
const Pond-dredgingPowellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Powell | Professional Pond Dredging Services"
        description="Expert pond dredging services in Powell. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, powell pond dredging, pond dredging powell"
        canonical="https://utahwatergardens.com/pond-dredging-powell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Powell",
          "description": "Professional pond dredging services in Powell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Powell"
        subtitle="Professional pond services for Pond Dredging Services in Powell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Powell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Powell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Powell Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Powell Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Powell Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Powell Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPowellPage;