...
const Pond-cleaningMenanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Menan | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Menan. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, menan pond cleaning, pond cleaning menan"
        canonical="https://utahwatergardens.com/pond-cleaning-menan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Menan",
          "description": "Professional pond cleaning services in Menan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Menan"
        subtitle="Professional pond services for Pond Cleaning Services in Menan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Menan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Menan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Menan Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Menan Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Menan Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Menan Customers Say About Our Pond Cleaning</h2>
