...
const Lake-dredgingMountainViewPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mountain View | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mountain View. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mountain view lake dredging, lake dredging mountain view"
        canonical="https://utahwatergardens.com/lake-dredging-mountain-view"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mountain View",
          "description": "Professional lake dredging services in Mountain View",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mountain View"
        subtitle="Professional pond services for Lake Dredging Services in Mountain View and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mountain View"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mountain View</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mountain View Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mountain View Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mountain View Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mountain View Customers Say About Our Lake Dredging</h2>
