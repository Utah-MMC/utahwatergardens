...
const Pond-repairAmalgaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Amalga | Professional Pond Repair Services"
        description="Expert pond repair services in Amalga. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, amalga pond repair, pond repair amalga"
        canonical="https://utahwatergardens.com/pond-repair-amalga"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Amalga",
          "description": "Professional pond repair services in Amalga",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Amalga"
        subtitle="Professional pond services for Pond Repair Services in Amalga and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Amalga"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Amalga</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Amalga Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Amalga Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Amalga Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Amalga Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAmalgaPage;