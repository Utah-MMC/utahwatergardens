...
const Pond-constructionLasVegasPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Las Vegas | Professional Pond Construction Services"
        description="Expert pond construction services in Las Vegas. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, las vegas pond construction, pond construction las vegas"
        canonical="https://utahwatergardens.com/pond-construction-las-vegas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Las Vegas",
          "description": "Professional pond construction services in Las Vegas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Las Vegas"
        subtitle="Professional pond services for Pond Construction Services in Las Vegas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Las Vegas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Las Vegas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Las Vegas Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Las Vegas Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Las Vegas Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Las Vegas Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionLasVegasPage;