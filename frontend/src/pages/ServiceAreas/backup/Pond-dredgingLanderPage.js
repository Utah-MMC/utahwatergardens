...
const Pond-dredgingLanderPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lander | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lander. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lander pond dredging, pond dredging lander"
        canonical="https://utahwatergardens.com/pond-dredging-lander"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lander",
          "description": "Professional pond dredging services in Lander",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lander"
        subtitle="Professional pond services for Pond Dredging Services in Lander and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lander"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lander</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lander Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lander Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lander Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lander Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLanderPage;