...
const Pond-cleaningGoodyearPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Goodyear | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Goodyear. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, goodyear pond cleaning, pond cleaning goodyear"
        canonical="https://utahwatergardens.com/pond-cleaning-goodyear"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Goodyear",
          "description": "Professional pond cleaning services in Goodyear",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Goodyear"
        subtitle="Professional pond services for Pond Cleaning Services in Goodyear and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Goodyear"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Goodyear</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goodyear Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goodyear Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goodyear Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goodyear Customers Say About Our Pond Cleaning</h2>
