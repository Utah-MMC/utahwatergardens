...
const Pond-cleaningKeelinePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Keeline | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Keeline. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, keeline pond cleaning, pond cleaning keeline"
        canonical="https://utahwatergardens.com/pond-cleaning-keeline"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Keeline",
          "description": "Professional pond cleaning services in Keeline",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Keeline"
        subtitle="Professional pond services for Pond Cleaning Services in Keeline and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Keeline"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Keeline</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Keeline Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Keeline Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Keeline Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Keeline Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningKeelinePage;