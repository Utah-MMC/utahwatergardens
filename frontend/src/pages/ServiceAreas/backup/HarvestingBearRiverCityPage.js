...
const HarvestingBearRiverCityPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Bear River City | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Bear River City. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, bear river city aquatic plant harvesting, aquatic plant harvesting bear river city"
        canonical="https://utahwatergardens.com/harvesting-bear-river-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Bear River City",
          "description": "Professional aquatic plant harvesting services in Bear River City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Bear River City"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Bear River City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Bear River City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Bear River City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bear River City Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bear River City Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bear River City Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bear River City Customers Say About Our Aquatic Plant Harvesting</h2>
