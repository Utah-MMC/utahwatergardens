...
const Pond-repairParadisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Paradise | Professional Pond Repair Services"
        description="Expert pond repair services in Paradise. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, paradise pond repair, pond repair paradise"
        canonical="https://utahwatergardens.com/pond-repair-paradise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Paradise",
          "description": "Professional pond repair services in Paradise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Paradise"
        subtitle="Professional pond services for Pond Repair Services in Paradise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Paradise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Paradise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paradise Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paradise Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paradise Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paradise Customers Say About Our Pond Repair</h2>
...
export default Pond-repairParadisePage;