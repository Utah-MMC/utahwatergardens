...
const Pond-cleaningAuroraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Aurora | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Aurora. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, aurora pond cleaning, pond cleaning aurora"
        canonical="https://utahwatergardens.com/pond-cleaning-aurora"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Aurora",
          "description": "Professional pond cleaning services in Aurora",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Aurora"
        subtitle="Professional pond services for Pond Cleaning Services in Aurora and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Aurora"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Aurora</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aurora Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aurora Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aurora Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aurora Customers Say About Our Pond Cleaning</h2>
