...
const Pond-cleaningNodePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Node | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Node. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, node pond cleaning, pond cleaning node"
        canonical="https://utahwatergardens.com/pond-cleaning-node"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Node",
          "description": "Professional pond cleaning services in Node",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Node"
        subtitle="Professional pond services for Pond Cleaning Services in Node and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Node"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Node</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Node Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Node Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Node Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Node Customers Say About Our Pond Cleaning</h2>
