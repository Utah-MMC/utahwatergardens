...
const Pond-repairOphirPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Ophir | Professional Pond Repair Services"
        description="Expert pond repair services in Ophir. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, ophir pond repair, pond repair ophir"
        canonical="https://utahwatergardens.com/pond-repair-ophir"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Ophir",
          "description": "Professional pond repair services in Ophir",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Ophir"
        subtitle="Professional pond services for Pond Repair Services in Ophir and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Ophir"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Ophir</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ophir Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ophir Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ophir Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ophir Customers Say About Our Pond Repair</h2>
...
export default Pond-repairOphirPage;