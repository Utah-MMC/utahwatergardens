...
const Pond-cleaningHuntsvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Huntsville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Huntsville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, huntsville pond cleaning, pond cleaning huntsville"
        canonical="https://utahwatergardens.com/pond-cleaning-huntsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Huntsville",
          "description": "Professional pond cleaning services in Huntsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Huntsville"
        subtitle="Professional pond services for Pond Cleaning Services in Huntsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Huntsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Huntsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntsville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntsville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntsville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntsville Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningHuntsvillePage;