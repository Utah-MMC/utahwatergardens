...
const Pond-repairNodePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Node | Professional Pond Repair Services"
        description="Expert pond repair services in Node. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, node pond repair, pond repair node"
        canonical="https://utahwatergardens.com/pond-repair-node"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Node",
          "description": "Professional pond repair services in Node",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Node"
        subtitle="Professional pond services for Pond Repair Services in Node and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Node"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Node</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Node Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Node Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Node Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Node Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNodePage;