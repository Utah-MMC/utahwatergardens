...
const Pond-constructionBoulderCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Boulder City | Professional Pond Construction Services"
        description="Expert pond construction services in Boulder City. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, boulder city pond construction, pond construction boulder city"
        canonical="https://utahwatergardens.com/pond-construction-boulder-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Boulder City",
          "description": "Professional pond construction services in Boulder City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Boulder City"
        subtitle="Professional pond services for Pond Construction Services in Boulder City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Boulder City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Boulder City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boulder City Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boulder City Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boulder City Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boulder City Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionBoulderCityPage;