...
const Pond-constructionAnthemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Anthem | Professional Pond Construction Services"
        description="Expert pond construction services in Anthem. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, anthem pond construction, pond construction anthem"
        canonical="https://utahwatergardens.com/pond-construction-anthem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Anthem",
          "description": "Professional pond construction services in Anthem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Anthem"
        subtitle="Professional pond services for Pond Construction Services in Anthem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Anthem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Anthem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Anthem Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Anthem Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Anthem Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Anthem Customers Say About Our Pond Construction</h2>
