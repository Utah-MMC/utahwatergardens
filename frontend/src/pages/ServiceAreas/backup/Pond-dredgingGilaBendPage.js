...
const Pond-dredgingGilaBendPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Gila Bend | Professional Pond Dredging Services"
        description="Expert pond dredging services in Gila Bend. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, gila bend pond dredging, pond dredging gila bend"
        canonical="https://utahwatergardens.com/pond-dredging-gila-bend"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Gila Bend",
          "description": "Professional pond dredging services in Gila Bend",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Gila Bend"
        subtitle="Professional pond services for Pond Dredging Services in Gila Bend and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Gila Bend"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Gila Bend</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gila Bend Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gila Bend Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gila Bend Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gila Bend Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingGilaBendPage;