...
const Pond-repairShoshoniPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Shoshoni | Professional Pond Repair Services"
        description="Expert pond repair services in Shoshoni. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, shoshoni pond repair, pond repair shoshoni"
        canonical="https://utahwatergardens.com/pond-repair-shoshoni"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Shoshoni",
          "description": "Professional pond repair services in Shoshoni",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Shoshoni"
        subtitle="Professional pond services for Pond Repair Services in Shoshoni and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Shoshoni"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Shoshoni</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Shoshoni Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Shoshoni Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Shoshoni Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Shoshoni Customers Say About Our Pond Repair</h2>
...
export default Pond-repairShoshoniPage;