...
const Pond-dredgingSunrisePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Sunrise | Professional Pond Dredging Services"
        description="Expert pond dredging services in Sunrise. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, sunrise pond dredging, pond dredging sunrise"
        canonical="https://utahwatergardens.com/pond-dredging-sunrise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Sunrise",
          "description": "Professional pond dredging services in Sunrise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Sunrise"
        subtitle="Professional pond services for Pond Dredging Services in Sunrise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Sunrise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Sunrise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunrise Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunrise Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunrise Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunrise Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSunrisePage;