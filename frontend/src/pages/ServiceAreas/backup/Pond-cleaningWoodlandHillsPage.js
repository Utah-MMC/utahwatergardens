...
const Pond-cleaningWoodlandHillsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Woodland Hills | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Woodland Hills. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, woodland hills pond cleaning, pond cleaning woodland hills"
        canonical="https://utahwatergardens.com/pond-cleaning-woodland-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Woodland Hills",
          "description": "Professional pond cleaning services in Woodland Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Woodland Hills"
        subtitle="Professional pond services for Pond Cleaning Services in Woodland Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Woodland Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Woodland Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Woodland Hills Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Woodland Hills Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Woodland Hills Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Woodland Hills Customers Say About Our Pond Cleaning</h2>
