...
const Lake-dredgingSwanValleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Swan Valley | Professional Lake Dredging Services"
        description="Expert lake dredging services in Swan Valley. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, swan valley lake dredging, lake dredging swan valley"
        canonical="https://utahwatergardens.com/lake-dredging-swan-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Swan Valley",
          "description": "Professional lake dredging services in Swan Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Swan Valley"
        subtitle="Professional pond services for Lake Dredging Services in Swan Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Swan Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Swan Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Swan Valley Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Swan Valley Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Swan Valley Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Swan Valley Customers Say About Our Lake Dredging</h2>
