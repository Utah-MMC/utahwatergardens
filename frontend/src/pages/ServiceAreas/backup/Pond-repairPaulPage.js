...
const Pond-repairPaulPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Paul | Professional Pond Repair Services"
        description="Expert pond repair services in Paul. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, paul pond repair, pond repair paul"
        canonical="https://utahwatergardens.com/pond-repair-paul"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Paul",
          "description": "Professional pond repair services in Paul",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Paul"
        subtitle="Professional pond services for Pond Repair Services in Paul and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Paul"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Paul</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paul Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paul Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paul Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paul Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPaulPage;