...
const Lake-dredgingKemmererPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Kemmerer | Professional Lake Dredging Services"
        description="Expert lake dredging services in Kemmerer. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, kemmerer lake dredging, lake dredging kemmerer"
        canonical="https://utahwatergardens.com/lake-dredging-kemmerer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Kemmerer",
          "description": "Professional lake dredging services in Kemmerer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Kemmerer"
        subtitle="Professional pond services for Lake Dredging Services in Kemmerer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Kemmerer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Kemmerer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kemmerer Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kemmerer Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kemmerer Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kemmerer Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingKemmererPage;