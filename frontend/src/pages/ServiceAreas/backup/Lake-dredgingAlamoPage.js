...
const Lake-dredgingAlamoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Alamo | Professional Lake Dredging Services"
        description="Expert lake dredging services in Alamo. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, alamo lake dredging, lake dredging alamo"
        canonical="https://utahwatergardens.com/lake-dredging-alamo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Alamo",
          "description": "Professional lake dredging services in Alamo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Alamo"
        subtitle="Professional pond services for Lake Dredging Services in Alamo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Alamo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Alamo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alamo Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alamo Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alamo Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alamo Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAlamoPage;