...
const Pond-maintenanceMountCharlestonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Mount Charleston | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Mount Charleston. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, mount charleston pond maintenance, pond maintenance mount charleston"
        canonical="https://utahwatergardens.com/pond-maintenance-mount-charleston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Mount Charleston",
          "description": "Professional pond maintenance services in Mount Charleston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Mount Charleston"
        subtitle="Professional pond services for Pond Maintenance Services in Mount Charleston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Mount Charleston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Mount Charleston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mount Charleston Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mount Charleston Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mount Charleston Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mount Charleston Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceMountCharlestonPage;