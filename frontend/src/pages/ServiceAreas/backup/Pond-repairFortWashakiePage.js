...
const Pond-repairFortWashakiePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Fort Washakie | Professional Pond Repair Services"
        description="Expert pond repair services in Fort Washakie. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, fort washakie pond repair, pond repair fort washakie"
        canonical="https://utahwatergardens.com/pond-repair-fort-washakie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Fort Washakie",
          "description": "Professional pond repair services in Fort Washakie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Fort Washakie"
        subtitle="Professional pond services for Pond Repair Services in Fort Washakie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Fort Washakie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Fort Washakie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fort Washakie Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fort Washakie Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fort Washakie Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fort Washakie Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFortWashakiePage;