...
const Pond-cleaningStocktonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Stockton | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Stockton. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, stockton pond cleaning, pond cleaning stockton"
        canonical="https://utahwatergardens.com/pond-cleaning-stockton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Stockton",
          "description": "Professional pond cleaning services in Stockton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Stockton"
        subtitle="Professional pond services for Pond Cleaning Services in Stockton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Stockton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Stockton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Stockton Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Stockton Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Stockton Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Stockton Customers Say About Our Pond Cleaning</h2>
