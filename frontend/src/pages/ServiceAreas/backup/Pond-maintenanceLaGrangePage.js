...
const Pond-maintenanceLaGrangePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance La Grange | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in La Grange. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, la grange pond maintenance, pond maintenance la grange"
        canonical="https://utahwatergardens.com/pond-maintenance-la-grange"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services La Grange",
          "description": "Professional pond maintenance services in La Grange",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in La Grange"
        subtitle="Professional pond services for Pond Maintenance Services in La Grange and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in La Grange"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in La Grange</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Grange Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Grange Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Grange Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Grange Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceLaGrangePage;