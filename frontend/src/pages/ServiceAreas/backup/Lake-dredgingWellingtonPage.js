...
const Lake-dredgingWellingtonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Wellington | Professional Lake Dredging Services"
        description="Expert lake dredging services in Wellington. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, wellington lake dredging, lake dredging wellington"
        canonical="https://utahwatergardens.com/lake-dredging-wellington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Wellington",
          "description": "Professional lake dredging services in Wellington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Wellington"
        subtitle="Professional pond services for Lake Dredging Services in Wellington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Wellington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Wellington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wellington Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wellington Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wellington Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wellington Customers Say About Our Lake Dredging</h2>
