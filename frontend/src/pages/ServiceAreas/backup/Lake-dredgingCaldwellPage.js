...
const Lake-dredgingCaldwellPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Caldwell | Professional Lake Dredging Services"
        description="Expert lake dredging services in Caldwell. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, caldwell lake dredging, lake dredging caldwell"
        canonical="https://utahwatergardens.com/lake-dredging-caldwell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Caldwell",
          "description": "Professional lake dredging services in Caldwell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Caldwell"
        subtitle="Professional pond services for Lake Dredging Services in Caldwell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Caldwell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Caldwell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Caldwell Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Caldwell Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Caldwell Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Caldwell Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingCaldwellPage;