...
const Pond-constructionMorelandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Moreland | Professional Pond Construction Services"
        description="Expert pond construction services in Moreland. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, moreland pond construction, pond construction moreland"
        canonical="https://utahwatergardens.com/pond-construction-moreland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Moreland",
          "description": "Professional pond construction services in Moreland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Moreland"
        subtitle="Professional pond services for Pond Construction Services in Moreland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Moreland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Moreland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moreland Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moreland Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moreland Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moreland Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionMorelandPage;