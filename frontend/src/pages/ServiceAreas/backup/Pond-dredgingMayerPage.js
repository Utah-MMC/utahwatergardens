...
const Pond-dredgingMayerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Mayer | Professional Pond Dredging Services"
        description="Expert pond dredging services in Mayer. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, mayer pond dredging, pond dredging mayer"
        canonical="https://utahwatergardens.com/pond-dredging-mayer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Mayer",
          "description": "Professional pond dredging services in Mayer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Mayer"
        subtitle="Professional pond services for Pond Dredging Services in Mayer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Mayer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Mayer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mayer Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mayer Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mayer Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mayer Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMayerPage;