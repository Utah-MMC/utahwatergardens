...
const Lake-dredgingJeremyRanchPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Jeremy Ranch | Professional Lake Dredging Services"
        description="Expert lake dredging services in Jeremy Ranch. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, jeremy ranch lake dredging, lake dredging jeremy ranch"
        canonical="https://utahwatergardens.com/lake-dredging-jeremy-ranch"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Jeremy Ranch",
          "description": "Professional lake dredging services in Jeremy Ranch",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Jeremy Ranch"
        subtitle="Professional pond services for Lake Dredging Services in Jeremy Ranch and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Jeremy Ranch"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Jeremy Ranch</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jeremy Ranch Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jeremy Ranch Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jeremy Ranch Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jeremy Ranch Customers Say About Our Lake Dredging</h2>
