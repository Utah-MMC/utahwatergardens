...
const Pond-cleaningHooperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Hooper | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Hooper. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, hooper pond cleaning, pond cleaning hooper"
        canonical="https://utahwatergardens.com/pond-cleaning-hooper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Hooper",
          "description": "Professional pond cleaning services in Hooper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Hooper"
        subtitle="Professional pond services for Pond Cleaning Services in Hooper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Hooper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Hooper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hooper Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hooper Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hooper Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hooper Customers Say About Our Pond Cleaning</h2>
