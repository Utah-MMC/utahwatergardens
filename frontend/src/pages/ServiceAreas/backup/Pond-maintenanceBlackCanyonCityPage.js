...
const Pond-maintenanceBlackCanyonCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Black Canyon City | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Black Canyon City. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, black canyon city pond maintenance, pond maintenance black canyon city"
        canonical="https://utahwatergardens.com/pond-maintenance-black-canyon-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Black Canyon City",
          "description": "Professional pond maintenance services in Black Canyon City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Black Canyon City"
        subtitle="Professional pond services for Pond Maintenance Services in Black Canyon City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Black Canyon City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Black Canyon City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Black Canyon City Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Black Canyon City Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Black Canyon City Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Black Canyon City Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceBlackCanyonCityPage;