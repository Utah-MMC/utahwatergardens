...
const Pond-dredgingRedstonePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Redstone | Professional Pond Dredging Services"
        description="Expert pond dredging services in Redstone. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, redstone pond dredging, pond dredging redstone"
        canonical="https://utahwatergardens.com/pond-dredging-redstone"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Redstone",
          "description": "Professional pond dredging services in Redstone",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Redstone"
        subtitle="Professional pond services for Pond Dredging Services in Redstone and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Redstone"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Redstone</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Redstone Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Redstone Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Redstone Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Redstone Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingRedstonePage;