...
const Pond-constructionGlendalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Glendale | Professional Pond Construction Services"
        description="Expert pond construction services in Glendale. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, glendale pond construction, pond construction glendale"
        canonical="https://utahwatergardens.com/pond-construction-glendale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Glendale",
          "description": "Professional pond construction services in Glendale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Glendale"
        subtitle="Professional pond services for Pond Construction Services in Glendale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Glendale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Glendale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glendale Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glendale Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glendale Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glendale Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionGlendalePage;