...
const Pond-maintenanceMountainViewPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Mountain View | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Mountain View. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, mountain view pond maintenance, pond maintenance mountain view"
        canonical="https://utahwatergardens.com/pond-maintenance-mountain-view"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Mountain View",
          "description": "Professional pond maintenance services in Mountain View",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Mountain View"
        subtitle="Professional pond services for Pond Maintenance Services in Mountain View and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Mountain View"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Mountain View</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mountain View Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mountain View Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mountain View Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mountain View Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceMountainViewPage;