...
const Pond-cleaningParowanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Parowan | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Parowan. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, parowan pond cleaning, pond cleaning parowan"
        canonical="https://utahwatergardens.com/pond-cleaning-parowan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Parowan",
          "description": "Professional pond cleaning services in Parowan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Parowan"
        subtitle="Professional pond services for Pond Cleaning Services in Parowan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Parowan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Parowan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parowan Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parowan Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parowan Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parowan Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningParowanPage;