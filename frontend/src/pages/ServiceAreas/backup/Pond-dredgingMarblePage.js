...
const Pond-dredgingMarblePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Marble | Professional Pond Dredging Services"
        description="Expert pond dredging services in Marble. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, marble pond dredging, pond dredging marble"
        canonical="https://utahwatergardens.com/pond-dredging-marble"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Marble",
          "description": "Professional pond dredging services in Marble",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Marble"
        subtitle="Professional pond services for Pond Dredging Services in Marble and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Marble"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Marble</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marble Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marble Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marble Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marble Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMarblePage;