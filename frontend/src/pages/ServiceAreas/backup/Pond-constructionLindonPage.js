...
const Pond-constructionLindonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Lindon | Professional Pond Construction Services"
        description="Expert pond construction services in Lindon. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, lindon pond construction, pond construction lindon"
        canonical="https://utahwatergardens.com/pond-construction-lindon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Lindon",
          "description": "Professional pond construction services in Lindon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Lindon"
        subtitle="Professional pond services for Pond Construction Services in Lindon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Lindon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Lindon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lindon Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lindon Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lindon Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lindon Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionLindonPage;