...
const Pond-repairSouthWeberPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair South Weber | Professional Pond Repair Services"
        description="Expert pond repair services in South Weber. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, south weber pond repair, pond repair south weber"
        canonical="https://utahwatergardens.com/pond-repair-south-weber"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services South Weber",
          "description": "Professional pond repair services in South Weber",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in South Weber"
        subtitle="Professional pond services for Pond Repair Services in South Weber and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in South Weber"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in South Weber</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Weber Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Weber Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Weber Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Weber Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSouthWeberPage;