...
const Lake-dredgingFallonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Fallon | Professional Lake Dredging Services"
        description="Expert lake dredging services in Fallon. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, fallon lake dredging, lake dredging fallon"
        canonical="https://utahwatergardens.com/lake-dredging-fallon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Fallon",
          "description": "Professional lake dredging services in Fallon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Fallon"
        subtitle="Professional pond services for Lake Dredging Services in Fallon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Fallon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Fallon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fallon Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fallon Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fallon Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fallon Customers Say About Our Lake Dredging</h2>
