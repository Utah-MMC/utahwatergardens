...
const Pond-maintenanceCastleDalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Castle Dale | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Castle Dale. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, castle dale pond maintenance, pond maintenance castle dale"
        canonical="https://utahwatergardens.com/pond-maintenance-castle-dale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Castle Dale",
          "description": "Professional pond maintenance services in Castle Dale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Castle Dale"
        subtitle="Professional pond services for Pond Maintenance Services in Castle Dale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Castle Dale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Castle Dale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Castle Dale Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Castle Dale Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Castle Dale Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Castle Dale Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceCastleDalePage;