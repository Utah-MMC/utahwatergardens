...
const Pond-cleaningBrianHeadPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Brian Head | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Brian Head. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, brian head pond cleaning, pond cleaning brian head"
        canonical="https://utahwatergardens.com/pond-cleaning-brian-head"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Brian Head",
          "description": "Professional pond cleaning services in Brian Head",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Brian Head"
        subtitle="Professional pond services for Pond Cleaning Services in Brian Head and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Brian Head"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Brian Head</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Brian Head Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Brian Head Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Brian Head Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Brian Head Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningBrianHeadPage;