...
const Lake-dredgingSigurdPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sigurd | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sigurd. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sigurd lake dredging, lake dredging sigurd"
        canonical="https://utahwatergardens.com/lake-dredging-sigurd"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sigurd",
          "description": "Professional lake dredging services in Sigurd",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sigurd"
        subtitle="Professional pond services for Lake Dredging Services in Sigurd and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sigurd"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sigurd</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sigurd Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sigurd Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sigurd Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sigurd Customers Say About Our Lake Dredging</h2>
