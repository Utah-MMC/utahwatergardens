...
const Pond-maintenanceElMiragePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance El Mirage | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in El Mirage. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, el mirage pond maintenance, pond maintenance el mirage"
        canonical="https://utahwatergardens.com/pond-maintenance-el-mirage"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services El Mirage",
          "description": "Professional pond maintenance services in El Mirage",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in El Mirage"
        subtitle="Professional pond services for Pond Maintenance Services in El Mirage and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in El Mirage"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in El Mirage</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our El Mirage Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="El Mirage Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our El Mirage Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What El Mirage Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceElMiragePage;