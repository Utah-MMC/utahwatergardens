...
const Pond-dredgingVeyoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Veyo | Professional Pond Dredging Services"
        description="Expert pond dredging services in Veyo. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, veyo pond dredging, pond dredging veyo"
        canonical="https://utahwatergardens.com/pond-dredging-veyo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Veyo",
          "description": "Professional pond dredging services in Veyo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Veyo"
        subtitle="Professional pond services for Pond Dredging Services in Veyo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Veyo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Veyo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Veyo Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Veyo Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Veyo Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Veyo Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingVeyoPage;