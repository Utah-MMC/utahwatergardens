...
const Pond-cleaningWestWendoverPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning West Wendover | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in West Wendover. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, west wendover pond cleaning, pond cleaning west wendover"
        canonical="https://utahwatergardens.com/pond-cleaning-west-wendover"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services West Wendover",
          "description": "Professional pond cleaning services in West Wendover",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in West Wendover"
        subtitle="Professional pond services for Pond Cleaning Services in West Wendover and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in West Wendover"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in West Wendover</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Wendover Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Wendover Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Wendover Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Wendover Customers Say About Our Pond Cleaning</h2>
