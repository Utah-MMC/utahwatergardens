...
const Lake-dredgingLaytonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Layton | Professional Lake Dredging Services"
        description="Expert lake dredging services in Layton. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, layton lake dredging, lake dredging layton"
        canonical="https://utahwatergardens.com/lake-dredging-layton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Layton",
          "description": "Professional lake dredging services in Layton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Layton"
        subtitle="Professional pond services for Lake Dredging Services in Layton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Layton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Layton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Layton Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Layton Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Layton Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Layton Customers Say About Our Lake Dredging</h2>
