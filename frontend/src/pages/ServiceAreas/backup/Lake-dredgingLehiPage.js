...
const Lake-dredgingLehiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lehi | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lehi. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lehi lake dredging, lake dredging lehi"
        canonical="https://utahwatergardens.com/lake-dredging-lehi"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lehi",
          "description": "Professional lake dredging services in Lehi",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lehi"
        subtitle="Professional pond services for Lake Dredging Services in Lehi and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lehi"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lehi</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lehi Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lehi Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lehi Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lehi Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingLehiPage;