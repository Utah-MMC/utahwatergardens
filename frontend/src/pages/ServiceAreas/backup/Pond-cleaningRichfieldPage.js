...
const Pond-cleaningRichfieldPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Richfield | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Richfield. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, richfield pond cleaning, pond cleaning richfield"
        canonical="https://utahwatergardens.com/pond-cleaning-richfield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Richfield",
          "description": "Professional pond cleaning services in Richfield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Richfield"
        subtitle="Professional pond services for Pond Cleaning Services in Richfield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Richfield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Richfield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Richfield Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Richfield Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Richfield Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Richfield Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningRichfieldPage;