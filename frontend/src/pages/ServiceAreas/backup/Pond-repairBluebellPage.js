...
const Pond-repairBluebellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Bluebell | Professional Pond Repair Services"
        description="Expert pond repair services in Bluebell. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, bluebell pond repair, pond repair bluebell"
        canonical="https://utahwatergardens.com/pond-repair-bluebell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Bluebell",
          "description": "Professional pond repair services in Bluebell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Bluebell"
        subtitle="Professional pond services for Pond Repair Services in Bluebell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Bluebell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Bluebell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bluebell Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bluebell Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bluebell Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bluebell Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBluebellPage;