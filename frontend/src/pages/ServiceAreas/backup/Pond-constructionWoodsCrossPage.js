...
const Pond-constructionWoodsCrossPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Woods Cross | Professional Pond Construction Services"
        description="Expert pond construction services in Woods Cross. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, woods cross pond construction, pond construction woods cross"
        canonical="https://utahwatergardens.com/pond-construction-woods-cross"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Woods Cross",
          "description": "Professional pond construction services in Woods Cross",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Woods Cross"
        subtitle="Professional pond services for Pond Construction Services in Woods Cross and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Woods Cross"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Woods Cross</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Woods Cross Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Woods Cross Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Woods Cross Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Woods Cross Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionWoodsCrossPage;