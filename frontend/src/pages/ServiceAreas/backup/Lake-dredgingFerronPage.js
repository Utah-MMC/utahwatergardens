...
const Lake-dredgingFerronPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Ferron | Professional Lake Dredging Services"
        description="Expert lake dredging services in Ferron. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, ferron lake dredging, lake dredging ferron"
        canonical="https://utahwatergardens.com/lake-dredging-ferron"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Ferron",
          "description": "Professional lake dredging services in Ferron",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Ferron"
        subtitle="Professional pond services for Lake Dredging Services in Ferron and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Ferron"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Ferron</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ferron Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ferron Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ferron Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ferron Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingFerronPage;