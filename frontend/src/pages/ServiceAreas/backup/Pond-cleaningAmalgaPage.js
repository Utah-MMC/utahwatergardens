...
const Pond-cleaningAmalgaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Amalga | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Amalga. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, amalga pond cleaning, pond cleaning amalga"
        canonical="https://utahwatergardens.com/pond-cleaning-amalga"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Amalga",
          "description": "Professional pond cleaning services in Amalga",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Amalga"
        subtitle="Professional pond services for Pond Cleaning Services in Amalga and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Amalga"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Amalga</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Amalga Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Amalga Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Amalga Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Amalga Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAmalgaPage;