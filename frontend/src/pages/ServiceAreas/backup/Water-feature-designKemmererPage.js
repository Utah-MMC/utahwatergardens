...
const Water-feature-designKemmererPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Kemmerer | Professional Water Feature Design Services"
        description="Expert water feature design services in Kemmerer. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, kemmerer water feature design, water feature design kemmerer"
        canonical="https://utahwatergardens.com/water-feature-design-kemmerer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Kemmerer",
          "description": "Professional water feature design services in Kemmerer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Kemmerer"
        subtitle="Professional pond services for Water Feature Design Services in Kemmerer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Kemmerer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Kemmerer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kemmerer Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kemmerer Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kemmerer Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kemmerer Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designKemmererPage;