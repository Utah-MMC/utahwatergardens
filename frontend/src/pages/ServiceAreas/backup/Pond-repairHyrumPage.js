...
const Pond-repairHyrumPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Hyrum | Professional Pond Repair Services"
        description="Expert pond repair services in Hyrum. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, hyrum pond repair, pond repair hyrum"
        canonical="https://utahwatergardens.com/pond-repair-hyrum"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Hyrum",
          "description": "Professional pond repair services in Hyrum",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Hyrum"
        subtitle="Professional pond services for Pond Repair Services in Hyrum and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Hyrum"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Hyrum</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hyrum Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hyrum Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hyrum Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hyrum Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHyrumPage;