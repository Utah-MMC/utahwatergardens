...
const Pond-repairHomedalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Homedale | Professional Pond Repair Services"
        description="Expert pond repair services in Homedale. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, homedale pond repair, pond repair homedale"
        canonical="https://utahwatergardens.com/pond-repair-homedale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Homedale",
          "description": "Professional pond repair services in Homedale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Homedale"
        subtitle="Professional pond services for Pond Repair Services in Homedale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Homedale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Homedale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Homedale Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Homedale Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Homedale Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Homedale Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHomedalePage;