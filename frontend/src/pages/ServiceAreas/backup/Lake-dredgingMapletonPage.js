...
const Lake-dredgingMapletonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mapleton | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mapleton. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mapleton lake dredging, lake dredging mapleton"
        canonical="https://utahwatergardens.com/lake-dredging-mapleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mapleton",
          "description": "Professional lake dredging services in Mapleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mapleton"
        subtitle="Professional pond services for Lake Dredging Services in Mapleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mapleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mapleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mapleton Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mapleton Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mapleton Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mapleton Customers Say About Our Lake Dredging</h2>
