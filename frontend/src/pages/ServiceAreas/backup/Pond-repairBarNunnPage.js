...
const Pond-repairBarNunnPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Bar Nunn | Professional Pond Repair Services"
        description="Expert pond repair services in Bar Nunn. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, bar nunn pond repair, pond repair bar nunn"
        canonical="https://utahwatergardens.com/pond-repair-bar-nunn"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Bar Nunn",
          "description": "Professional pond repair services in Bar Nunn",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Bar Nunn"
        subtitle="Professional pond services for Pond Repair Services in Bar Nunn and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Bar Nunn"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Bar Nunn</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bar Nunn Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bar Nunn Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bar Nunn Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bar Nunn Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBarNunnPage;