...
const Lake-dredgingMurrayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Murray | Professional Lake Dredging Services"
        description="Expert lake dredging services in Murray. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, murray lake dredging, lake dredging murray"
        canonical="https://utahwatergardens.com/lake-dredging-murray"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Murray",
          "description": "Professional lake dredging services in Murray",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Murray"
        subtitle="Professional pond services for Lake Dredging Services in Murray and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Murray"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Murray</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Murray Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Murray Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Murray Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Murray Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMurrayPage;