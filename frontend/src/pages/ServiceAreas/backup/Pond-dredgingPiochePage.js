...
const Pond-dredgingPiochePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Pioche | Professional Pond Dredging Services"
        description="Expert pond dredging services in Pioche. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, pioche pond dredging, pond dredging pioche"
        canonical="https://utahwatergardens.com/pond-dredging-pioche"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Pioche",
          "description": "Professional pond dredging services in Pioche",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Pioche"
        subtitle="Professional pond services for Pond Dredging Services in Pioche and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Pioche"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Pioche</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pioche Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pioche Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pioche Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pioche Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPiochePage;