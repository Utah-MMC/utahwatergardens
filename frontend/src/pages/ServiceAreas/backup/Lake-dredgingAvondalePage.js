...
const Lake-dredgingAvondalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Avondale | Professional Lake Dredging Services"
        description="Expert lake dredging services in Avondale. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, avondale lake dredging, lake dredging avondale"
        canonical="https://utahwatergardens.com/lake-dredging-avondale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Avondale",
          "description": "Professional lake dredging services in Avondale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Avondale"
        subtitle="Professional pond services for Lake Dredging Services in Avondale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Avondale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Avondale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Avondale Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Avondale Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Avondale Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Avondale Customers Say About Our Lake Dredging</h2>
