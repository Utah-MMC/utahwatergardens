...
const Lake-dredgingBlueDiamondPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Blue Diamond | Professional Lake Dredging Services"
        description="Expert lake dredging services in Blue Diamond. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, blue diamond lake dredging, lake dredging blue diamond"
        canonical="https://utahwatergardens.com/lake-dredging-blue-diamond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Blue Diamond",
          "description": "Professional lake dredging services in Blue Diamond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Blue Diamond"
        subtitle="Professional pond services for Lake Dredging Services in Blue Diamond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Blue Diamond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Blue Diamond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Blue Diamond Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Blue Diamond Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Blue Diamond Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Blue Diamond Customers Say About Our Lake Dredging</h2>
