...
const Pond-dredgingBrianHeadPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Brian Head | Professional Pond Dredging Services"
        description="Expert pond dredging services in Brian Head. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, brian head pond dredging, pond dredging brian head"
        canonical="https://utahwatergardens.com/pond-dredging-brian-head"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Brian Head",
          "description": "Professional pond dredging services in Brian Head",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Brian Head"
        subtitle="Professional pond services for Pond Dredging Services in Brian Head and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Brian Head"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Brian Head</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Brian Head Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Brian Head Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Brian Head Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Brian Head Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBrianHeadPage;