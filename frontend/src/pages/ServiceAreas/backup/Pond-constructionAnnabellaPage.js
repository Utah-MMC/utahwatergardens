...
const Pond-constructionAnnabellaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Annabella | Professional Pond Construction Services"
        description="Expert pond construction services in Annabella. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, annabella pond construction, pond construction annabella"
        canonical="https://utahwatergardens.com/pond-construction-annabella"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Annabella",
          "description": "Professional pond construction services in Annabella",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Annabella"
        subtitle="Professional pond services for Pond Construction Services in Annabella and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Annabella"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Annabella</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Annabella Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Annabella Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Annabella Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Annabella Customers Say About Our Pond Construction</h2>
