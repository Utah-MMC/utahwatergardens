...
const Pond-cleaningWapitiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Wapiti | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Wapiti. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, wapiti pond cleaning, pond cleaning wapiti"
        canonical="https://utahwatergardens.com/pond-cleaning-wapiti"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Wapiti",
          "description": "Professional pond cleaning services in Wapiti",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Wapiti"
        subtitle="Professional pond services for Pond Cleaning Services in Wapiti and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Wapiti"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Wapiti</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wapiti Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wapiti Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wapiti Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wapiti Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningWapitiPage;