...
const Pond-repairMenanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Menan | Professional Pond Repair Services"
        description="Expert pond repair services in Menan. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, menan pond repair, pond repair menan"
        canonical="https://utahwatergardens.com/pond-repair-menan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Menan",
          "description": "Professional pond repair services in Menan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Menan"
        subtitle="Professional pond services for Pond Repair Services in Menan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Menan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Menan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Menan Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Menan Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Menan Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Menan Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMenanPage;