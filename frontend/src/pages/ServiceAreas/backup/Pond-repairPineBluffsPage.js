...
const Pond-repairPineBluffsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Pine Bluffs | Professional Pond Repair Services"
        description="Expert pond repair services in Pine Bluffs. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, pine bluffs pond repair, pond repair pine bluffs"
        canonical="https://utahwatergardens.com/pond-repair-pine-bluffs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Pine Bluffs",
          "description": "Professional pond repair services in Pine Bluffs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Pine Bluffs"
        subtitle="Professional pond services for Pond Repair Services in Pine Bluffs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Pine Bluffs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Pine Bluffs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pine Bluffs Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pine Bluffs Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pine Bluffs Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pine Bluffs Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPineBluffsPage;