...
const Pond-dredgingLevanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Levan | Professional Pond Dredging Services"
        description="Expert pond dredging services in Levan. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, levan pond dredging, pond dredging levan"
        canonical="https://utahwatergardens.com/pond-dredging-levan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Levan",
          "description": "Professional pond dredging services in Levan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Levan"
        subtitle="Professional pond services for Pond Dredging Services in Levan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Levan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Levan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Levan Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Levan Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Levan Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Levan Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLevanPage;