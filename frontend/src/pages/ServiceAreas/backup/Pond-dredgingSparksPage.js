...
const Pond-dredgingSparksPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Sparks | Professional Pond Dredging Services"
        description="Expert pond dredging services in Sparks. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, sparks pond dredging, pond dredging sparks"
        canonical="https://utahwatergardens.com/pond-dredging-sparks"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Sparks",
          "description": "Professional pond dredging services in Sparks",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Sparks"
        subtitle="Professional pond services for Pond Dredging Services in Sparks and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Sparks"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Sparks</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sparks Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sparks Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sparks Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sparks Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSparksPage;