...
const Pond-repairSunsetPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Sunset | Professional Pond Repair Services"
        description="Expert pond repair services in Sunset. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, sunset pond repair, pond repair sunset"
        canonical="https://utahwatergardens.com/pond-repair-sunset"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Sunset",
          "description": "Professional pond repair services in Sunset",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Sunset"
        subtitle="Professional pond services for Pond Repair Services in Sunset and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Sunset"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Sunset</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunset Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunset Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunset Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunset Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSunsetPage;