...
const Pond-repairFirthPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Firth | Professional Pond Repair Services"
        description="Expert pond repair services in Firth. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, firth pond repair, pond repair firth"
        canonical="https://utahwatergardens.com/pond-repair-firth"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Firth",
          "description": "Professional pond repair services in Firth",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Firth"
        subtitle="Professional pond services for Pond Repair Services in Firth and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Firth"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Firth</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Firth Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Firth Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Firth Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Firth Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFirthPage;