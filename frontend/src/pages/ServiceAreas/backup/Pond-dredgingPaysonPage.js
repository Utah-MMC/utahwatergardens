...
const Pond-dredgingPaysonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Payson | Professional Pond Dredging Services"
        description="Expert pond dredging services in Payson. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, payson pond dredging, pond dredging payson"
        canonical="https://utahwatergardens.com/pond-dredging-payson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Payson",
          "description": "Professional pond dredging services in Payson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Payson"
        subtitle="Professional pond services for Pond Dredging Services in Payson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Payson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Payson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Payson Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Payson Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Payson Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Payson Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPaysonPage;