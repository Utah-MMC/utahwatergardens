...
const Pond-cleaningProvidencePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Providence | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Providence. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, providence pond cleaning, pond cleaning providence"
        canonical="https://utahwatergardens.com/pond-cleaning-providence"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Providence",
          "description": "Professional pond cleaning services in Providence",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Providence"
        subtitle="Professional pond services for Pond Cleaning Services in Providence and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Providence"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Providence</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Providence Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Providence Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Providence Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Providence Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningProvidencePage;