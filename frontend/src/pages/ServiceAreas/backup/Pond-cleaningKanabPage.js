...
const Pond-cleaningKanabPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Kanab | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Kanab. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, kanab pond cleaning, pond cleaning kanab"
        canonical="https://utahwatergardens.com/pond-cleaning-kanab"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Kanab",
          "description": "Professional pond cleaning services in Kanab",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Kanab"
        subtitle="Professional pond services for Pond Cleaning Services in Kanab and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Kanab"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Kanab</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kanab Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kanab Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kanab Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kanab Customers Say About Our Pond Cleaning</h2>
