...
const HarvestingSunCityWestPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Sun City West | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Sun City West. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, sun city west aquatic plant harvesting, aquatic plant harvesting sun city west"
        canonical="https://utahwatergardens.com/harvesting-sun-city-west"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Sun City West",
          "description": "Professional aquatic plant harvesting services in Sun City West",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Sun City West"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Sun City West and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Sun City West"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Sun City West</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sun City West Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sun City West Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sun City West Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sun City West Customers Say About Our Aquatic Plant Harvesting</h2>
