...
const Pond-dredgingClawsonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Clawson | Professional Pond Dredging Services"
        description="Expert pond dredging services in Clawson. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, clawson pond dredging, pond dredging clawson"
        canonical="https://utahwatergardens.com/pond-dredging-clawson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Clawson",
          "description": "Professional pond dredging services in Clawson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Clawson"
        subtitle="Professional pond services for Pond Dredging Services in Clawson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Clawson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Clawson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clawson Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clawson Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clawson Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clawson Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingClawsonPage;