...
const Pond-dredgingTetoniaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Tetonia | Professional Pond Dredging Services"
        description="Expert pond dredging services in Tetonia. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, tetonia pond dredging, pond dredging tetonia"
        canonical="https://utahwatergardens.com/pond-dredging-tetonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Tetonia",
          "description": "Professional pond dredging services in Tetonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Tetonia"
        subtitle="Professional pond services for Pond Dredging Services in Tetonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Tetonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Tetonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tetonia Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tetonia Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tetonia Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tetonia Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingTetoniaPage;