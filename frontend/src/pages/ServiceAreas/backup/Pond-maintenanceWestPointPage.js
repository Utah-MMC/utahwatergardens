...
const Pond-maintenanceWestPointPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance West Point | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in West Point. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, west point pond maintenance, pond maintenance west point"
        canonical="https://utahwatergardens.com/pond-maintenance-west-point"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services West Point",
          "description": "Professional pond maintenance services in West Point",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in West Point"
        subtitle="Professional pond services for Pond Maintenance Services in West Point and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in West Point"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in West Point</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Point Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Point Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Point Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Point Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceWestPointPage;