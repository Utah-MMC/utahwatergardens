...
const Pond-dredgingHotchkissPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hotchkiss | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hotchkiss. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hotchkiss pond dredging, pond dredging hotchkiss"
        canonical="https://utahwatergardens.com/pond-dredging-hotchkiss"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hotchkiss",
          "description": "Professional pond dredging services in Hotchkiss",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hotchkiss"
        subtitle="Professional pond services for Pond Dredging Services in Hotchkiss and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hotchkiss"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hotchkiss</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hotchkiss Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hotchkiss Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hotchkiss Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hotchkiss Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHotchkissPage;