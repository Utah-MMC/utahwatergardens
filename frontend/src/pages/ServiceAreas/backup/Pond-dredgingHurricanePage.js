...
const Pond-dredgingHurricanePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hurricane | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hurricane. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hurricane pond dredging, pond dredging hurricane"
        canonical="https://utahwatergardens.com/pond-dredging-hurricane"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hurricane",
          "description": "Professional pond dredging services in Hurricane",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hurricane"
        subtitle="Professional pond services for Pond Dredging Services in Hurricane and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hurricane"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hurricane</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hurricane Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hurricane Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hurricane Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hurricane Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHurricanePage;