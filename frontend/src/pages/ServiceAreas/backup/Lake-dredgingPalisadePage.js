...
const Lake-dredgingPalisadePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Palisade | Professional Lake Dredging Services"
        description="Expert lake dredging services in Palisade. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, palisade lake dredging, lake dredging palisade"
        canonical="https://utahwatergardens.com/lake-dredging-palisade"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Palisade",
          "description": "Professional lake dredging services in Palisade",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Palisade"
        subtitle="Professional pond services for Lake Dredging Services in Palisade and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Palisade"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Palisade</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Palisade Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Palisade Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Palisade Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Palisade Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingPalisadePage;