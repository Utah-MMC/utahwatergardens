...
const Pond-cleaningFortLaramiePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Fort Laramie | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Fort Laramie. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, fort laramie pond cleaning, pond cleaning fort laramie"
        canonical="https://utahwatergardens.com/pond-cleaning-fort-laramie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Fort Laramie",
          "description": "Professional pond cleaning services in Fort Laramie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Fort Laramie"
        subtitle="Professional pond services for Pond Cleaning Services in Fort Laramie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Fort Laramie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Fort Laramie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fort Laramie Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fort Laramie Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fort Laramie Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fort Laramie Customers Say About Our Pond Cleaning</h2>
