...
const Lake-dredgingParmaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Parma | Professional Lake Dredging Services"
        description="Expert lake dredging services in Parma. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, parma lake dredging, lake dredging parma"
        canonical="https://utahwatergardens.com/lake-dredging-parma"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Parma",
          "description": "Professional lake dredging services in Parma",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Parma"
        subtitle="Professional pond services for Lake Dredging Services in Parma and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Parma"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Parma</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parma Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parma Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parma Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parma Customers Say About Our Lake Dredging</h2>
