...
const Pond-dredgingGreybullPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Greybull | Professional Pond Dredging Services"
        description="Expert pond dredging services in Greybull. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, greybull pond dredging, pond dredging greybull"
        canonical="https://utahwatergardens.com/pond-dredging-greybull"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Greybull",
          "description": "Professional pond dredging services in Greybull",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Greybull"
        subtitle="Professional pond services for Pond Dredging Services in Greybull and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Greybull"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Greybull</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Greybull Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Greybull Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Greybull Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Greybull Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingGreybullPage;