...
const Lake-dredgingLanceCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lance Creek | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lance Creek. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lance creek lake dredging, lake dredging lance creek"
        canonical="https://utahwatergardens.com/lake-dredging-lance-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lance Creek",
          "description": "Professional lake dredging services in Lance Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lance Creek"
        subtitle="Professional pond services for Lake Dredging Services in Lance Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lance Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lance Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lance Creek Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lance Creek Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lance Creek Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lance Creek Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingLanceCreekPage;