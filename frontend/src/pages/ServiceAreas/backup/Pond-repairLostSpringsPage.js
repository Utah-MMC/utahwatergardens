...
const Pond-repairLostSpringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lost Springs | Professional Pond Repair Services"
        description="Expert pond repair services in Lost Springs. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lost springs pond repair, pond repair lost springs"
        canonical="https://utahwatergardens.com/pond-repair-lost-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lost Springs",
          "description": "Professional pond repair services in Lost Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lost Springs"
        subtitle="Professional pond services for Pond Repair Services in Lost Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lost Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lost Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lost Springs Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lost Springs Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lost Springs Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lost Springs Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLostSpringsPage;