...
const Pond-repairKimberlyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Kimberly | Professional Pond Repair Services"
        description="Expert pond repair services in Kimberly. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, kimberly pond repair, pond repair kimberly"
        canonical="https://utahwatergardens.com/pond-repair-kimberly"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Kimberly",
          "description": "Professional pond repair services in Kimberly",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Kimberly"
        subtitle="Professional pond services for Pond Repair Services in Kimberly and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Kimberly"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Kimberly</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kimberly Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kimberly Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kimberly Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kimberly Customers Say About Our Pond Repair</h2>
...
export default Pond-repairKimberlyPage;