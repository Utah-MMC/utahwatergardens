...
const Pond-cleaningRedstonePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Redstone | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Redstone. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, redstone pond cleaning, pond cleaning redstone"
        canonical="https://utahwatergardens.com/pond-cleaning-redstone"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Redstone",
          "description": "Professional pond cleaning services in Redstone",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Redstone"
        subtitle="Professional pond services for Pond Cleaning Services in Redstone and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Redstone"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Redstone</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Redstone Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Redstone Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Redstone Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Redstone Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningRedstonePage;