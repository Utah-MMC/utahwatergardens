...
const Pond-repairHooperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Hooper | Professional Pond Repair Services"
        description="Expert pond repair services in Hooper. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, hooper pond repair, pond repair hooper"
        canonical="https://utahwatergardens.com/pond-repair-hooper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Hooper",
          "description": "Professional pond repair services in Hooper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Hooper"
        subtitle="Professional pond services for Pond Repair Services in Hooper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Hooper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Hooper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hooper Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hooper Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hooper Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hooper Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHooperPage;