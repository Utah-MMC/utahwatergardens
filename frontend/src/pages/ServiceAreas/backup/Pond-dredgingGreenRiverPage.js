...
const Pond-dredgingGreenRiverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Green River | Professional Pond Dredging Services"
        description="Expert pond dredging services in Green River. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, green river pond dredging, pond dredging green river"
        canonical="https://utahwatergardens.com/pond-dredging-green-river"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Green River",
          "description": "Professional pond dredging services in Green River",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Green River"
        subtitle="Professional pond services for Pond Dredging Services in Green River and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Green River"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Green River</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Green River Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Green River Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Green River Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Green River Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingGreenRiverPage;