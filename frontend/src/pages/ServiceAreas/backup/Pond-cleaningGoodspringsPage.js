...
const Pond-cleaningGoodspringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Goodsprings | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Goodsprings. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, goodsprings pond cleaning, pond cleaning goodsprings"
        canonical="https://utahwatergardens.com/pond-cleaning-goodsprings"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Goodsprings",
          "description": "Professional pond cleaning services in Goodsprings",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Goodsprings"
        subtitle="Professional pond services for Pond Cleaning Services in Goodsprings and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Goodsprings"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Goodsprings</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goodsprings Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goodsprings Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goodsprings Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goodsprings Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningGoodspringsPage;