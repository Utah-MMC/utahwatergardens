...
const Lake-dredgingSunrisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sunrise | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sunrise. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sunrise lake dredging, lake dredging sunrise"
        canonical="https://utahwatergardens.com/lake-dredging-sunrise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sunrise",
          "description": "Professional lake dredging services in Sunrise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sunrise"
        subtitle="Professional pond services for Lake Dredging Services in Sunrise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sunrise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sunrise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunrise Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunrise Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunrise Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunrise Customers Say About Our Lake Dredging</h2>
