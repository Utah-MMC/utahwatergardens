...
const Pond-maintenanceWestHavenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance West Haven | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in West Haven. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, west haven pond maintenance, pond maintenance west haven"
        canonical="https://utahwatergardens.com/pond-maintenance-west-haven"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services West Haven",
          "description": "Professional pond maintenance services in West Haven",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in West Haven"
        subtitle="Professional pond services for Pond Maintenance Services in West Haven and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in West Haven"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in West Haven</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Haven Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Haven Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Haven Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Haven Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceWestHavenPage;