...
const Pond-constructionPinedalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Pinedale | Professional Pond Construction Services"
        description="Expert pond construction services in Pinedale. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, pinedale pond construction, pond construction pinedale"
        canonical="https://utahwatergardens.com/pond-construction-pinedale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Pinedale",
          "description": "Professional pond construction services in Pinedale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Pinedale"
        subtitle="Professional pond services for Pond Construction Services in Pinedale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Pinedale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Pinedale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pinedale Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pinedale Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pinedale Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pinedale Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionPinedalePage;