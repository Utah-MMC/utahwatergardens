...
const Pond-maintenanceGreatBasinNationalParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Great Basin National Park | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Great Basin National Park. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, great basin national park pond maintenance, pond maintenance great basin national park"
        canonical="https://utahwatergardens.com/pond-maintenance-great-basin-national-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Great Basin National Park",
          "description": "Professional pond maintenance services in Great Basin National Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Great Basin National Park"
        subtitle="Professional pond services for Pond Maintenance Services in Great Basin National Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Great Basin National Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Great Basin National Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Great Basin National Park Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Great Basin National Park Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Great Basin National Park Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Great Basin National Park Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceGreatBasinNationalParkPage;