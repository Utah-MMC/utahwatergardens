...
const Pond-dredgingNuclaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Nucla | Professional Pond Dredging Services"
        description="Expert pond dredging services in Nucla. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, nucla pond dredging, pond dredging nucla"
        canonical="https://utahwatergardens.com/pond-dredging-nucla"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Nucla",
          "description": "Professional pond dredging services in Nucla",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Nucla"
        subtitle="Professional pond services for Pond Dredging Services in Nucla and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Nucla"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Nucla</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nucla Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nucla Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nucla Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nucla Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNuclaPage;