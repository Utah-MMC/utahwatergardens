...
const Pond-cleaningHideoutPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Hideout | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Hideout. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, hideout pond cleaning, pond cleaning hideout"
        canonical="https://utahwatergardens.com/pond-cleaning-hideout"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Hideout",
          "description": "Professional pond cleaning services in Hideout",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Hideout"
        subtitle="Professional pond services for Pond Cleaning Services in Hideout and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Hideout"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Hideout</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hideout Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hideout Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hideout Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hideout Customers Say About Our Pond Cleaning</h2>
