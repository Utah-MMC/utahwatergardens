...
const Pond-repairKeelinePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Keeline | Professional Pond Repair Services"
        description="Expert pond repair services in Keeline. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, keeline pond repair, pond repair keeline"
        canonical="https://utahwatergardens.com/pond-repair-keeline"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Keeline",
          "description": "Professional pond repair services in Keeline",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Keeline"
        subtitle="Professional pond services for Pond Repair Services in Keeline and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Keeline"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Keeline</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Keeline Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Keeline Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Keeline Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Keeline Customers Say About Our Pond Repair</h2>
...
export default Pond-repairKeelinePage;