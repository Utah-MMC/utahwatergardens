...
const Lake-dredgingProvidencePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Providence | Professional Lake Dredging Services"
        description="Expert lake dredging services in Providence. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, providence lake dredging, lake dredging providence"
        canonical="https://utahwatergardens.com/lake-dredging-providence"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Providence",
          "description": "Professional lake dredging services in Providence",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Providence"
        subtitle="Professional pond services for Lake Dredging Services in Providence and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Providence"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Providence</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Providence Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Providence Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Providence Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Providence Customers Say About Our Lake Dredging</h2>
