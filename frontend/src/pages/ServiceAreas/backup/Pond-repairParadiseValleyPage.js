...
const Pond-repairParadiseValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Paradise Valley | Professional Pond Repair Services"
        description="Expert pond repair services in Paradise Valley. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, paradise valley pond repair, pond repair paradise valley"
        canonical="https://utahwatergardens.com/pond-repair-paradise-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Paradise Valley",
          "description": "Professional pond repair services in Paradise Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Paradise Valley"
        subtitle="Professional pond services for Pond Repair Services in Paradise Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Paradise Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Paradise Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paradise Valley Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paradise Valley Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paradise Valley Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paradise Valley Customers Say About Our Pond Repair</h2>
...
export default Pond-repairParadiseValleyPage;