...
const Pond-constructionMidwayPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Midway | Professional Pond Construction Services"
        description="Expert pond construction services in Midway. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, midway pond construction, pond construction midway"
        canonical="https://utahwatergardens.com/pond-construction-midway"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Midway",
          "description": "Professional pond construction services in Midway",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Midway"
        subtitle="Professional pond services for Pond Construction Services in Midway and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Midway"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Midway</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Midway Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Midway Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Midway Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Midway Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionMidwayPage;