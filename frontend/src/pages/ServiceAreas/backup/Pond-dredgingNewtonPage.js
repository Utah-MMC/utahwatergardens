...
const Pond-dredgingNewtonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Newton | Professional Pond Dredging Services"
        description="Expert pond dredging services in Newton. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, newton pond dredging, pond dredging newton"
        canonical="https://utahwatergardens.com/pond-dredging-newton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Newton",
          "description": "Professional pond dredging services in Newton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Newton"
        subtitle="Professional pond services for Pond Dredging Services in Newton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Newton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Newton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Newton Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Newton Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Newton Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Newton Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNewtonPage;