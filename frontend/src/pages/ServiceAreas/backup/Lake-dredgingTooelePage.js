...
const Lake-dredgingTooelePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Tooele | Professional Lake Dredging Services"
        description="Expert lake dredging services in Tooele. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, tooele lake dredging, lake dredging tooele"
        canonical="https://utahwatergardens.com/lake-dredging-tooele"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Tooele",
          "description": "Professional lake dredging services in Tooele",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Tooele"
        subtitle="Professional pond services for Lake Dredging Services in Tooele and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Tooele"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Tooele</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tooele Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tooele Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tooele Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tooele Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingTooelePage;