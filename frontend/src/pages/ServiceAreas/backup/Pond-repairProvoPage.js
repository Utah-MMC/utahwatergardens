...
const Pond-repairProvoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Provo | Professional Pond Repair Services"
        description="Expert pond repair services in Provo. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, provo pond repair, pond repair provo"
        canonical="https://utahwatergardens.com/pond-repair-provo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Provo",
          "description": "Professional pond repair services in Provo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Provo"
        subtitle="Professional pond services for Pond Repair Services in Provo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Provo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Provo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Provo Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Provo Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Provo Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Provo Customers Say About Our Pond Repair</h2>
...
export default Pond-repairProvoPage;