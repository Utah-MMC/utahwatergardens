...
const Pond-repairNaturitaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Naturita | Professional Pond Repair Services"
        description="Expert pond repair services in Naturita. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, naturita pond repair, pond repair naturita"
        canonical="https://utahwatergardens.com/pond-repair-naturita"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Naturita",
          "description": "Professional pond repair services in Naturita",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Naturita"
        subtitle="Professional pond services for Pond Repair Services in Naturita and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Naturita"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Naturita</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Naturita Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Naturita Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Naturita Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Naturita Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNaturitaPage;