...
const Pond-cleaningHansenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Hansen | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Hansen. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, hansen pond cleaning, pond cleaning hansen"
        canonical="https://utahwatergardens.com/pond-cleaning-hansen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Hansen",
          "description": "Professional pond cleaning services in Hansen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Hansen"
        subtitle="Professional pond services for Pond Cleaning Services in Hansen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Hansen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Hansen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hansen Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hansen Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hansen Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hansen Customers Say About Our Pond Cleaning</h2>
