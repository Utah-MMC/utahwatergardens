...
const Lake-dredgingSpringvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Springville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Springville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, springville lake dredging, lake dredging springville"
        canonical="https://utahwatergardens.com/lake-dredging-springville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Springville",
          "description": "Professional lake dredging services in Springville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Springville"
        subtitle="Professional pond services for Lake Dredging Services in Springville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Springville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Springville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Springville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Springville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Springville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Springville Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSpringvillePage;