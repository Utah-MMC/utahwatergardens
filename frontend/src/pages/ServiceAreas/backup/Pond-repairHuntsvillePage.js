...
const Pond-repairHuntsvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Huntsville | Professional Pond Repair Services"
        description="Expert pond repair services in Huntsville. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, huntsville pond repair, pond repair huntsville"
        canonical="https://utahwatergardens.com/pond-repair-huntsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Huntsville",
          "description": "Professional pond repair services in Huntsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Huntsville"
        subtitle="Professional pond services for Pond Repair Services in Huntsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Huntsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Huntsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntsville Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntsville Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntsville Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntsville Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHuntsvillePage;