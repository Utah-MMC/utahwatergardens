...
const Pond-cleaningEthetePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Ethete | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Ethete. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, ethete pond cleaning, pond cleaning ethete"
        canonical="https://utahwatergardens.com/pond-cleaning-ethete"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Ethete",
          "description": "Professional pond cleaning services in Ethete",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Ethete"
        subtitle="Professional pond services for Pond Cleaning Services in Ethete and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Ethete"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Ethete</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ethete Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ethete Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ethete Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ethete Customers Say About Our Pond Cleaning</h2>
