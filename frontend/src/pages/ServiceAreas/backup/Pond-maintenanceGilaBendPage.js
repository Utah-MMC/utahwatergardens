...
const Pond-maintenanceGilaBendPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Gila Bend | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Gila Bend. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, gila bend pond maintenance, pond maintenance gila bend"
        canonical="https://utahwatergardens.com/pond-maintenance-gila-bend"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Gila Bend",
          "description": "Professional pond maintenance services in Gila Bend",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Gila Bend"
        subtitle="Professional pond services for Pond Maintenance Services in Gila Bend and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Gila Bend"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Gila Bend</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gila Bend Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gila Bend Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gila Bend Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gila Bend Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceGilaBendPage;