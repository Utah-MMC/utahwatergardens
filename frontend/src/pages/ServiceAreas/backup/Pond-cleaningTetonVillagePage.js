...
const Pond-cleaningTetonVillagePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Teton Village | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Teton Village. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, teton village pond cleaning, pond cleaning teton village"
        canonical="https://utahwatergardens.com/pond-cleaning-teton-village"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Teton Village",
          "description": "Professional pond cleaning services in Teton Village",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Teton Village"
        subtitle="Professional pond services for Pond Cleaning Services in Teton Village and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Teton Village"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Teton Village</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Teton Village Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Teton Village Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Teton Village Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Teton Village Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningTetonVillagePage;