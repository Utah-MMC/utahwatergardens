...
const Pond-cleaningWorlandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Worland | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Worland. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, worland pond cleaning, pond cleaning worland"
        canonical="https://utahwatergardens.com/pond-cleaning-worland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Worland",
          "description": "Professional pond cleaning services in Worland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Worland"
        subtitle="Professional pond services for Pond Cleaning Services in Worland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Worland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Worland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Worland Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Worland Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Worland Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Worland Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningWorlandPage;