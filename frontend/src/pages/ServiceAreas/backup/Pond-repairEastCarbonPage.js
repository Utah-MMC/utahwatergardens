...
const Pond-repairEastCarbonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair East Carbon | Professional Pond Repair Services"
        description="Expert pond repair services in East Carbon. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, east carbon pond repair, pond repair east carbon"
        canonical="https://utahwatergardens.com/pond-repair-east-carbon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services East Carbon",
          "description": "Professional pond repair services in East Carbon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in East Carbon"
        subtitle="Professional pond services for Pond Repair Services in East Carbon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in East Carbon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in East Carbon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our East Carbon Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="East Carbon Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our East Carbon Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What East Carbon Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEastCarbonPage;