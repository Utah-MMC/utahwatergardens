...
const Pond-repairHolladayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Holladay | Professional Pond Repair Services"
        description="Expert pond repair services in Holladay. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, holladay pond repair, pond repair holladay"
        canonical="https://utahwatergardens.com/pond-repair-holladay"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Holladay",
          "description": "Professional pond repair services in Holladay",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Holladay"
        subtitle="Professional pond services for Pond Repair Services in Holladay and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Holladay"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Holladay</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Holladay Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Holladay Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Holladay Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Holladay Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHolladayPage;