...
const Pond-repairBrighamCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Brigham City | Professional Pond Repair Services"
        description="Expert pond repair services in Brigham City. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, brigham city pond repair, pond repair brigham city"
        canonical="https://utahwatergardens.com/pond-repair-brigham-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Brigham City",
          "description": "Professional pond repair services in Brigham City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Brigham City"
        subtitle="Professional pond services for Pond Repair Services in Brigham City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Brigham City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Brigham City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Brigham City Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Brigham City Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Brigham City Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Brigham City Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBrighamCityPage;