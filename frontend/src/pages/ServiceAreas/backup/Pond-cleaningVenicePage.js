...
const Pond-cleaningVenicePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Venice | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Venice. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, venice pond cleaning, pond cleaning venice"
        canonical="https://utahwatergardens.com/pond-cleaning-venice"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Venice",
          "description": "Professional pond cleaning services in Venice",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Venice"
        subtitle="Professional pond services for Pond Cleaning Services in Venice and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Venice"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Venice</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Venice Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Venice Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Venice Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Venice Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningVenicePage;