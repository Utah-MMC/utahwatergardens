...
const Pond-cleaningStarPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Star | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Star. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, star pond cleaning, pond cleaning star"
        canonical="https://utahwatergardens.com/pond-cleaning-star"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Star",
          "description": "Professional pond cleaning services in Star",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Star"
        subtitle="Professional pond services for Pond Cleaning Services in Star and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Star"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Star</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Star Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Star Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Star Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Star Customers Say About Our Pond Cleaning</h2>
