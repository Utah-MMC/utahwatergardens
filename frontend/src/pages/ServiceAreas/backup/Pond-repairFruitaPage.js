...
const Pond-repairFruitaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Fruita | Professional Pond Repair Services"
        description="Expert pond repair services in Fruita. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, fruita pond repair, pond repair fruita"
        canonical="https://utahwatergardens.com/pond-repair-fruita"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Fruita",
          "description": "Professional pond repair services in Fruita",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Fruita"
        subtitle="Professional pond services for Pond Repair Services in Fruita and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Fruita"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Fruita</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruita Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruita Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruita Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruita Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFruitaPage;