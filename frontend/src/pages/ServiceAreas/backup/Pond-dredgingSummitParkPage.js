...
const Pond-dredgingSummitParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Summit Park | Professional Pond Dredging Services"
        description="Expert pond dredging services in Summit Park. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, summit park pond dredging, pond dredging summit park"
        canonical="https://utahwatergardens.com/pond-dredging-summit-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Summit Park",
          "description": "Professional pond dredging services in Summit Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Summit Park"
        subtitle="Professional pond services for Pond Dredging Services in Summit Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Summit Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Summit Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Summit Park Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Summit Park Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Summit Park Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Summit Park Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSummitParkPage;