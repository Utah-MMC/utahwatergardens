...
const Pond-cleaningShelleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Shelley | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Shelley. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, shelley pond cleaning, pond cleaning shelley"
        canonical="https://utahwatergardens.com/pond-cleaning-shelley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Shelley",
          "description": "Professional pond cleaning services in Shelley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Shelley"
        subtitle="Professional pond services for Pond Cleaning Services in Shelley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Shelley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Shelley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Shelley Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Shelley Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Shelley Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Shelley Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningShelleyPage;