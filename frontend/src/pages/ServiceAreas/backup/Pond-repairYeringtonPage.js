...
const Pond-repairYeringtonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Yerington | Professional Pond Repair Services"
        description="Expert pond repair services in Yerington. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, yerington pond repair, pond repair yerington"
        canonical="https://utahwatergardens.com/pond-repair-yerington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Yerington",
          "description": "Professional pond repair services in Yerington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Yerington"
        subtitle="Professional pond services for Pond Repair Services in Yerington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Yerington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Yerington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Yerington Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Yerington Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Yerington Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Yerington Customers Say About Our Pond Repair</h2>
...
export default Pond-repairYeringtonPage;