...
const HarvestingMountCarmelPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Mount Carmel | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Mount Carmel. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, mount carmel aquatic plant harvesting, aquatic plant harvesting mount carmel"
        canonical="https://utahwatergardens.com/harvesting-mount-carmel"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Mount Carmel",
          "description": "Professional aquatic plant harvesting services in Mount Carmel",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Mount Carmel"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Mount Carmel and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Mount Carmel"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Mount Carmel</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mount Carmel Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mount Carmel Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mount Carmel Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mount Carmel Customers Say About Our Aquatic Plant Harvesting</h2>
