...
const Pond-cleaningSandyValleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Sandy Valley | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Sandy Valley. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, sandy valley pond cleaning, pond cleaning sandy valley"
        canonical="https://utahwatergardens.com/pond-cleaning-sandy-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Sandy Valley",
          "description": "Professional pond cleaning services in Sandy Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Sandy Valley"
        subtitle="Professional pond services for Pond Cleaning Services in Sandy Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Sandy Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Sandy Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sandy Valley Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sandy Valley Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sandy Valley Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sandy Valley Customers Say About Our Pond Cleaning</h2>
