...
const Pond-repairAltamontPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Altamont | Professional Pond Repair Services"
        description="Expert pond repair services in Altamont. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, altamont pond repair, pond repair altamont"
        canonical="https://utahwatergardens.com/pond-repair-altamont"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Altamont",
          "description": "Professional pond repair services in Altamont",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Altamont"
        subtitle="Professional pond services for Pond Repair Services in Altamont and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Altamont"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Altamont</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Altamont Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Altamont Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Altamont Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Altamont Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAltamontPage;