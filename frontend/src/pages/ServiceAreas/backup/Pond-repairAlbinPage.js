...
const Pond-repairAlbinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Albin | Professional Pond Repair Services"
        description="Expert pond repair services in Albin. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, albin pond repair, pond repair albin"
        canonical="https://utahwatergardens.com/pond-repair-albin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Albin",
          "description": "Professional pond repair services in Albin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Albin"
        subtitle="Professional pond services for Pond Repair Services in Albin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Albin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Albin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Albin Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Albin Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Albin Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Albin Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAlbinPage;