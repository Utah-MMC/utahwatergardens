...
const Lake-dredgingMonroePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Monroe | Professional Lake Dredging Services"
        description="Expert lake dredging services in Monroe. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, monroe lake dredging, lake dredging monroe"
        canonical="https://utahwatergardens.com/lake-dredging-monroe"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Monroe",
          "description": "Professional lake dredging services in Monroe",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Monroe"
        subtitle="Professional pond services for Lake Dredging Services in Monroe and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Monroe"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Monroe</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Monroe Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Monroe Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Monroe Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Monroe Customers Say About Our Lake Dredging</h2>
