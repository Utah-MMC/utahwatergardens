...
const Pond-repairLewistonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lewiston | Professional Pond Repair Services"
        description="Expert pond repair services in Lewiston. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lewiston pond repair, pond repair lewiston"
        canonical="https://utahwatergardens.com/pond-repair-lewiston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lewiston",
          "description": "Professional pond repair services in Lewiston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lewiston"
        subtitle="Professional pond services for Pond Repair Services in Lewiston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lewiston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lewiston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lewiston Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lewiston Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lewiston Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lewiston Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLewistonPage;