...
const Pond-cleaningRicoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Rico | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Rico. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, rico pond cleaning, pond cleaning rico"
        canonical="https://utahwatergardens.com/pond-cleaning-rico"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Rico",
          "description": "Professional pond cleaning services in Rico",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Rico"
        subtitle="Professional pond services for Pond Cleaning Services in Rico and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Rico"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Rico</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rico Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rico Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rico Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rico Customers Say About Our Pond Cleaning</h2>
