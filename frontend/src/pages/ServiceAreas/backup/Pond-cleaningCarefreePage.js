...
const Pond-cleaningCarefreePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Carefree | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Carefree. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, carefree pond cleaning, pond cleaning carefree"
        canonical="https://utahwatergardens.com/pond-cleaning-carefree"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Carefree",
          "description": "Professional pond cleaning services in Carefree",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Carefree"
        subtitle="Professional pond services for Pond Cleaning Services in Carefree and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Carefree"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Carefree</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carefree Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carefree Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carefree Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carefree Customers Say About Our Pond Cleaning</h2>
