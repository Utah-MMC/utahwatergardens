...
const Pond-repairLindonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lindon | Professional Pond Repair Services"
        description="Expert pond repair services in Lindon. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lindon pond repair, pond repair lindon"
        canonical="https://utahwatergardens.com/pond-repair-lindon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lindon",
          "description": "Professional pond repair services in Lindon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lindon"
        subtitle="Professional pond services for Pond Repair Services in Lindon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lindon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lindon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lindon Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lindon Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lindon Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lindon Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLindonPage;