...
const Lake-dredgingEaglePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Eagle | Professional Lake Dredging Services"
        description="Expert lake dredging services in Eagle. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, eagle lake dredging, lake dredging eagle"
        canonical="https://utahwatergardens.com/lake-dredging-eagle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Eagle",
          "description": "Professional lake dredging services in Eagle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Eagle"
        subtitle="Professional pond services for Lake Dredging Services in Eagle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Eagle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Eagle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eagle Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eagle Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eagle Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eagle Customers Say About Our Lake Dredging</h2>
