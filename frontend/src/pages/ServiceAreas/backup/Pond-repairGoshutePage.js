...
const Pond-repairGoshutePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Goshute | Professional Pond Repair Services"
        description="Expert pond repair services in Goshute. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, goshute pond repair, pond repair goshute"
        canonical="https://utahwatergardens.com/pond-repair-goshute"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Goshute",
          "description": "Professional pond repair services in Goshute",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Goshute"
        subtitle="Professional pond services for Pond Repair Services in Goshute and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Goshute"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Goshute</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goshute Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goshute Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goshute Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goshute Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGoshutePage;