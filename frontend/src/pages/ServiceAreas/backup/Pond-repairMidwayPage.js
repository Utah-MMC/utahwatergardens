...
const Pond-repairMidwayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Midway | Professional Pond Repair Services"
        description="Expert pond repair services in Midway. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, midway pond repair, pond repair midway"
        canonical="https://utahwatergardens.com/pond-repair-midway"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Midway",
          "description": "Professional pond repair services in Midway",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Midway"
        subtitle="Professional pond services for Pond Repair Services in Midway and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Midway"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Midway</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Midway Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Midway Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Midway Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Midway Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMidwayPage;