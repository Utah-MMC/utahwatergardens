...
const Lake-dredgingMorelandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Moreland | Professional Lake Dredging Services"
        description="Expert lake dredging services in Moreland. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, moreland lake dredging, lake dredging moreland"
        canonical="https://utahwatergardens.com/lake-dredging-moreland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Moreland",
          "description": "Professional lake dredging services in Moreland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Moreland"
        subtitle="Professional pond services for Lake Dredging Services in Moreland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Moreland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Moreland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moreland Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moreland Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moreland Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moreland Customers Say About Our Lake Dredging</h2>
