...
const Lake-dredgingVineyardPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Vineyard | Professional Lake Dredging Services"
        description="Expert lake dredging services in Vineyard. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, vineyard lake dredging, lake dredging vineyard"
        canonical="https://utahwatergardens.com/lake-dredging-vineyard"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Vineyard",
          "description": "Professional lake dredging services in Vineyard",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Vineyard"
        subtitle="Professional pond services for Lake Dredging Services in Vineyard and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Vineyard"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Vineyard</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vineyard Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vineyard Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vineyard Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vineyard Customers Say About Our Lake Dredging</h2>
