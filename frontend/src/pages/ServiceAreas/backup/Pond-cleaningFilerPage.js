...
const Pond-cleaningFilerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Filer | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Filer. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, filer pond cleaning, pond cleaning filer"
        canonical="https://utahwatergardens.com/pond-cleaning-filer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Filer",
          "description": "Professional pond cleaning services in Filer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Filer"
        subtitle="Professional pond services for Pond Cleaning Services in Filer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Filer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Filer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Filer Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Filer Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Filer Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Filer Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningFilerPage;