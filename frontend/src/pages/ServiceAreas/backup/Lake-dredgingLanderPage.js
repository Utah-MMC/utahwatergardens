...
const Lake-dredgingLanderPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lander | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lander. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lander lake dredging, lake dredging lander"
        canonical="https://utahwatergardens.com/lake-dredging-lander"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lander",
          "description": "Professional lake dredging services in Lander",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lander"
        subtitle="Professional pond services for Lake Dredging Services in Lander and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lander"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lander</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lander Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lander Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lander Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lander Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingLanderPage;