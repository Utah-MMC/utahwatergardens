...
const Pond-constructionElMiragePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction El Mirage | Professional Pond Construction Services"
        description="Expert pond construction services in El Mirage. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, el mirage pond construction, pond construction el mirage"
        canonical="https://utahwatergardens.com/pond-construction-el-mirage"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services El Mirage",
          "description": "Professional pond construction services in El Mirage",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in El Mirage"
        subtitle="Professional pond services for Pond Construction Services in El Mirage and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in El Mirage"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in El Mirage</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our El Mirage Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="El Mirage Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our El Mirage Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What El Mirage Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionElMiragePage;