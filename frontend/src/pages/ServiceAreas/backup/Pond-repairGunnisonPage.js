...
const Pond-repairGunnisonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Gunnison | Professional Pond Repair Services"
        description="Expert pond repair services in Gunnison. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, gunnison pond repair, pond repair gunnison"
        canonical="https://utahwatergardens.com/pond-repair-gunnison"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Gunnison",
          "description": "Professional pond repair services in Gunnison",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Gunnison"
        subtitle="Professional pond services for Pond Repair Services in Gunnison and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Gunnison"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Gunnison</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gunnison Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gunnison Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gunnison Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gunnison Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGunnisonPage;