...
const Pond-maintenanceUintahPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Uintah | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Uintah. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, uintah pond maintenance, pond maintenance uintah"
        canonical="https://utahwatergardens.com/pond-maintenance-uintah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Uintah",
          "description": "Professional pond maintenance services in Uintah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Uintah"
        subtitle="Professional pond services for Pond Maintenance Services in Uintah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Uintah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Uintah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Uintah Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Uintah Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Uintah Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Uintah Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceUintahPage;