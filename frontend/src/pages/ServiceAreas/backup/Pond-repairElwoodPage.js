...
const Pond-repairElwoodPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Elwood | Professional Pond Repair Services"
        description="Expert pond repair services in Elwood. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, elwood pond repair, pond repair elwood"
        canonical="https://utahwatergardens.com/pond-repair-elwood"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Elwood",
          "description": "Professional pond repair services in Elwood",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Elwood"
        subtitle="Professional pond services for Pond Repair Services in Elwood and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Elwood"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Elwood</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elwood Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elwood Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elwood Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elwood Customers Say About Our Pond Repair</h2>
...
export default Pond-repairElwoodPage;