...
const Pond-cleaningChandlerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Chandler | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Chandler. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, chandler pond cleaning, pond cleaning chandler"
        canonical="https://utahwatergardens.com/pond-cleaning-chandler"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Chandler",
          "description": "Professional pond cleaning services in Chandler",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Chandler"
        subtitle="Professional pond services for Pond Cleaning Services in Chandler and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Chandler"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Chandler</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Chandler Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Chandler Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Chandler Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Chandler Customers Say About Our Pond Cleaning</h2>
