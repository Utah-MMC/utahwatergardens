...
const Pond-repairAmericanForkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair American Fork | Professional Pond Repair Services"
        description="Expert pond repair services in American Fork. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, american fork pond repair, pond repair american fork"
        canonical="https://utahwatergardens.com/pond-repair-american-fork"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services American Fork",
          "description": "Professional pond repair services in American Fork",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in American Fork"
        subtitle="Professional pond services for Pond Repair Services in American Fork and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in American Fork"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in American Fork</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our American Fork Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="American Fork Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our American Fork Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What American Fork Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAmericanForkPage;