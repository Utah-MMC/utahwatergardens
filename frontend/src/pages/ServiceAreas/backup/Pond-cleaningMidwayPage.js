...
const Pond-cleaningMidwayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Midway | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Midway. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, midway pond cleaning, pond cleaning midway"
        canonical="https://utahwatergardens.com/pond-cleaning-midway"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Midway",
          "description": "Professional pond cleaning services in Midway",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Midway"
        subtitle="Professional pond services for Pond Cleaning Services in Midway and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Midway"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Midway</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Midway Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Midway Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Midway Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Midway Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMidwayPage;