...
const Lake-dredgingFreedomPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Freedom | Professional Lake Dredging Services"
        description="Expert lake dredging services in Freedom. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, freedom lake dredging, lake dredging freedom"
        canonical="https://utahwatergardens.com/lake-dredging-freedom"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Freedom",
          "description": "Professional lake dredging services in Freedom",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Freedom"
        subtitle="Professional pond services for Lake Dredging Services in Freedom and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Freedom"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Freedom</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Freedom Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Freedom Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Freedom Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Freedom Customers Say About Our Lake Dredging</h2>
