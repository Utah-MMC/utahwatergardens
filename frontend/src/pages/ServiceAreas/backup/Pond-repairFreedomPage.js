...
const Pond-repairFreedomPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Freedom | Professional Pond Repair Services"
        description="Expert pond repair services in Freedom. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, freedom pond repair, pond repair freedom"
        canonical="https://utahwatergardens.com/pond-repair-freedom"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Freedom",
          "description": "Professional pond repair services in Freedom",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Freedom"
        subtitle="Professional pond services for Pond Repair Services in Freedom and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Freedom"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Freedom</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Freedom Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Freedom Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Freedom Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Freedom Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFreedomPage;