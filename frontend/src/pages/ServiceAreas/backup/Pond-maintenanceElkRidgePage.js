...
const Pond-maintenanceElkRidgePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Elk Ridge | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Elk Ridge. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, elk ridge pond maintenance, pond maintenance elk ridge"
        canonical="https://utahwatergardens.com/pond-maintenance-elk-ridge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Elk Ridge",
          "description": "Professional pond maintenance services in Elk Ridge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Elk Ridge"
        subtitle="Professional pond services for Pond Maintenance Services in Elk Ridge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Elk Ridge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Elk Ridge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elk Ridge Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elk Ridge Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elk Ridge Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elk Ridge Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceElkRidgePage;