...
const Pond-repairGrantsvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Grantsville | Professional Pond Repair Services"
        description="Expert pond repair services in Grantsville. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, grantsville pond repair, pond repair grantsville"
        canonical="https://utahwatergardens.com/pond-repair-grantsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Grantsville",
          "description": "Professional pond repair services in Grantsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Grantsville"
        subtitle="Professional pond services for Pond Repair Services in Grantsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Grantsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Grantsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Grantsville Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Grantsville Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Grantsville Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Grantsville Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGrantsvillePage;