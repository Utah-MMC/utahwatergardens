...
const Pond-cleaningVineyardPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Vineyard | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Vineyard. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, vineyard pond cleaning, pond cleaning vineyard"
        canonical="https://utahwatergardens.com/pond-cleaning-vineyard"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Vineyard",
          "description": "Professional pond cleaning services in Vineyard",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Vineyard"
        subtitle="Professional pond services for Pond Cleaning Services in Vineyard and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Vineyard"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Vineyard</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vineyard Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vineyard Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vineyard Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vineyard Customers Say About Our Pond Cleaning</h2>
