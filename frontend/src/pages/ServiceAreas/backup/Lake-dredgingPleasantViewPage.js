...
const Lake-dredgingPleasantViewPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Pleasant View | Professional Lake Dredging Services"
        description="Expert lake dredging services in Pleasant View. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, pleasant view lake dredging, lake dredging pleasant view"
        canonical="https://utahwatergardens.com/lake-dredging-pleasant-view"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Pleasant View",
          "description": "Professional lake dredging services in Pleasant View",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Pleasant View"
        subtitle="Professional pond services for Lake Dredging Services in Pleasant View and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Pleasant View"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Pleasant View</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pleasant View Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pleasant View Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pleasant View Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pleasant View Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingPleasantViewPage;