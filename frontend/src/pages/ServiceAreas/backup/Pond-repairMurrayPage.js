...
const Pond-repairMurrayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Murray | Professional Pond Repair Services"
        description="Expert pond repair services in Murray. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, murray pond repair, pond repair murray"
        canonical="https://utahwatergardens.com/pond-repair-murray"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Murray",
          "description": "Professional pond repair services in Murray",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Murray"
        subtitle="Professional pond services for Pond Repair Services in Murray and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Murray"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Murray</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Murray Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Murray Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Murray Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Murray Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMurrayPage;