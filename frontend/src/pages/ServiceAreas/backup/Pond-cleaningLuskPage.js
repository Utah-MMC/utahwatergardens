...
const Pond-cleaningLuskPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lusk | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lusk. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lusk pond cleaning, pond cleaning lusk"
        canonical="https://utahwatergardens.com/pond-cleaning-lusk"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lusk",
          "description": "Professional pond cleaning services in Lusk",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lusk"
        subtitle="Professional pond services for Pond Cleaning Services in Lusk and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lusk"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lusk</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lusk Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lusk Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lusk Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lusk Customers Say About Our Pond Cleaning</h2>
