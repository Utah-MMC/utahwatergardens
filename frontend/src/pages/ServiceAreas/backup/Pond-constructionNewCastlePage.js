...
const Pond-constructionNewCastlePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction New Castle | Professional Pond Construction Services"
        description="Expert pond construction services in New Castle. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, new castle pond construction, pond construction new castle"
        canonical="https://utahwatergardens.com/pond-construction-new-castle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services New Castle",
          "description": "Professional pond construction services in New Castle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in New Castle"
        subtitle="Professional pond services for Pond Construction Services in New Castle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in New Castle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in New Castle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Castle Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Castle Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Castle Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Castle Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionNewCastlePage;