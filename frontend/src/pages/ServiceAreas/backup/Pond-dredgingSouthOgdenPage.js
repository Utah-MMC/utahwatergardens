...
const Pond-dredgingSouthOgdenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging South Ogden | Professional Pond Dredging Services"
        description="Expert pond dredging services in South Ogden. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, south ogden pond dredging, pond dredging south ogden"
        canonical="https://utahwatergardens.com/pond-dredging-south-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services South Ogden",
          "description": "Professional pond dredging services in South Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in South Ogden"
        subtitle="Professional pond services for Pond Dredging Services in South Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in South Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in South Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Ogden Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Ogden Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Ogden Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Ogden Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSouthOgdenPage;