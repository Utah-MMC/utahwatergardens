...
const Lake-dredgingSummerlinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Summerlin | Professional Lake Dredging Services"
        description="Expert lake dredging services in Summerlin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, summerlin lake dredging, lake dredging summerlin"
        canonical="https://utahwatergardens.com/lake-dredging-summerlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Summerlin",
          "description": "Professional lake dredging services in Summerlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Summerlin"
        subtitle="Professional pond services for Lake Dredging Services in Summerlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Summerlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Summerlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Summerlin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Summerlin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Summerlin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Summerlin Customers Say About Our Lake Dredging</h2>
