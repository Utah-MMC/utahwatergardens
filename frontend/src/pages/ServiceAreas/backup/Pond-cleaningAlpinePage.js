...
const Pond-cleaningAlpinePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Alpine | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Alpine. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, alpine pond cleaning, pond cleaning alpine"
        canonical="https://utahwatergardens.com/pond-cleaning-alpine"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Alpine",
          "description": "Professional pond cleaning services in Alpine",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Alpine"
        subtitle="Professional pond services for Pond Cleaning Services in Alpine and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Alpine"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Alpine</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alpine Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alpine Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alpine Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alpine Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAlpinePage;