...
const Pond-cleaningRooseveltPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Roosevelt | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Roosevelt. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, roosevelt pond cleaning, pond cleaning roosevelt"
        canonical="https://utahwatergardens.com/pond-cleaning-roosevelt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Roosevelt",
          "description": "Professional pond cleaning services in Roosevelt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Roosevelt"
        subtitle="Professional pond services for Pond Cleaning Services in Roosevelt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Roosevelt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Roosevelt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Roosevelt Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Roosevelt Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Roosevelt Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Roosevelt Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningRooseveltPage;