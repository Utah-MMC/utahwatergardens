...
const Lake-dredgingSiltPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Silt | Professional Lake Dredging Services"
        description="Expert lake dredging services in Silt. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, silt lake dredging, lake dredging silt"
        canonical="https://utahwatergardens.com/lake-dredging-silt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Silt",
          "description": "Professional lake dredging services in Silt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Silt"
        subtitle="Professional pond services for Lake Dredging Services in Silt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Silt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Silt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Silt Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Silt Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Silt Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Silt Customers Say About Our Lake Dredging</h2>
