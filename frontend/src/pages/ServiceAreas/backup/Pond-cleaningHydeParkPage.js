...
const Pond-cleaningHydeParkPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Hyde Park | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Hyde Park. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, hyde park pond cleaning, pond cleaning hyde park"
        canonical="https://utahwatergardens.com/pond-cleaning-hyde-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Hyde Park",
          "description": "Professional pond cleaning services in Hyde Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Hyde Park"
        subtitle="Professional pond services for Pond Cleaning Services in Hyde Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Hyde Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Hyde Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hyde Park Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hyde Park Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hyde Park Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hyde Park Customers Say About Our Pond Cleaning</h2>
