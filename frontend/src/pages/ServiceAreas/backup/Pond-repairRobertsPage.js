...
const Pond-repairRobertsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Roberts | Professional Pond Repair Services"
        description="Expert pond repair services in Roberts. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, roberts pond repair, pond repair roberts"
        canonical="https://utahwatergardens.com/pond-repair-roberts"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Roberts",
          "description": "Professional pond repair services in Roberts",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Roberts"
        subtitle="Professional pond services for Pond Repair Services in Roberts and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Roberts"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Roberts</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Roberts Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Roberts Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Roberts Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Roberts Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRobertsPage;