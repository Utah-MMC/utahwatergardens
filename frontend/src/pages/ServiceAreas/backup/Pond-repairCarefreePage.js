...
const Pond-repairCarefreePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Carefree | Professional Pond Repair Services"
        description="Expert pond repair services in Carefree. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, carefree pond repair, pond repair carefree"
        canonical="https://utahwatergardens.com/pond-repair-carefree"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Carefree",
          "description": "Professional pond repair services in Carefree",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Carefree"
        subtitle="Professional pond services for Pond Repair Services in Carefree and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Carefree"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Carefree</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carefree Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carefree Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carefree Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carefree Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCarefreePage;