...
const Pond-constructionGlenwoodSpringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Glenwood Springs | Professional Pond Construction Services"
        description="Expert pond construction services in Glenwood Springs. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, glenwood springs pond construction, pond construction glenwood springs"
        canonical="https://utahwatergardens.com/pond-construction-glenwood-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Glenwood Springs",
          "description": "Professional pond construction services in Glenwood Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Glenwood Springs"
        subtitle="Professional pond services for Pond Construction Services in Glenwood Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Glenwood Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Glenwood Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glenwood Springs Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glenwood Springs Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glenwood Springs Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glenwood Springs Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionGlenwoodSpringsPage;