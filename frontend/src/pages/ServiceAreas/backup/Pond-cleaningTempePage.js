...
const Pond-cleaningTempePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Tempe | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Tempe. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, tempe pond cleaning, pond cleaning tempe"
        canonical="https://utahwatergardens.com/pond-cleaning-tempe"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Tempe",
          "description": "Professional pond cleaning services in Tempe",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Tempe"
        subtitle="Professional pond services for Pond Cleaning Services in Tempe and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Tempe"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Tempe</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tempe Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tempe Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tempe Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tempe Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningTempePage;