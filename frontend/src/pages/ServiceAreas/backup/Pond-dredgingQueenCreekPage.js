...
const Pond-dredgingQueenCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Queen Creek | Professional Pond Dredging Services"
        description="Expert pond dredging services in Queen Creek. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, queen creek pond dredging, pond dredging queen creek"
        canonical="https://utahwatergardens.com/pond-dredging-queen-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Queen Creek",
          "description": "Professional pond dredging services in Queen Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Queen Creek"
        subtitle="Professional pond services for Pond Dredging Services in Queen Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Queen Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Queen Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Queen Creek Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Queen Creek Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Queen Creek Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Queen Creek Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingQueenCreekPage;