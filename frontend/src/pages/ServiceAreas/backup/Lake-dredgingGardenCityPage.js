...
const Lake-dredgingGardenCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Garden City | Professional Lake Dredging Services"
        description="Expert lake dredging services in Garden City. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, garden city lake dredging, lake dredging garden city"
        canonical="https://utahwatergardens.com/lake-dredging-garden-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Garden City",
          "description": "Professional lake dredging services in Garden City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Garden City"
        subtitle="Professional pond services for Lake Dredging Services in Garden City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Garden City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Garden City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Garden City Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Garden City Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Garden City Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Garden City Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingGardenCityPage;