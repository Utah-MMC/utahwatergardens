...
const Pond-dredgingPineBluffsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Pine Bluffs | Professional Pond Dredging Services"
        description="Expert pond dredging services in Pine Bluffs. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, pine bluffs pond dredging, pond dredging pine bluffs"
        canonical="https://utahwatergardens.com/pond-dredging-pine-bluffs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Pine Bluffs",
          "description": "Professional pond dredging services in Pine Bluffs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Pine Bluffs"
        subtitle="Professional pond services for Pond Dredging Services in Pine Bluffs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Pine Bluffs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Pine Bluffs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pine Bluffs Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pine Bluffs Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pine Bluffs Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pine Bluffs Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPineBluffsPage;