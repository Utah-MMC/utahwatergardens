...
const Pond-dredgingEnochPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Enoch | Professional Pond Dredging Services"
        description="Expert pond dredging services in Enoch. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, enoch pond dredging, pond dredging enoch"
        canonical="https://utahwatergardens.com/pond-dredging-enoch"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Enoch",
          "description": "Professional pond dredging services in Enoch",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Enoch"
        subtitle="Professional pond services for Pond Dredging Services in Enoch and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Enoch"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Enoch</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Enoch Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Enoch Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Enoch Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Enoch Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingEnochPage;