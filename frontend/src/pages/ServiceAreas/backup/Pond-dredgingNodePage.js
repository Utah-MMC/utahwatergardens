...
const Pond-dredgingNodePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Node | Professional Pond Dredging Services"
        description="Expert pond dredging services in Node. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, node pond dredging, pond dredging node"
        canonical="https://utahwatergardens.com/pond-dredging-node"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Node",
          "description": "Professional pond dredging services in Node",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Node"
        subtitle="Professional pond services for Pond Dredging Services in Node and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Node"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Node</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Node Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Node Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Node Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Node Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNodePage;