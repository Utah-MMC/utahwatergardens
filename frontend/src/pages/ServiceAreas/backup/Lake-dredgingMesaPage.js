...
const Lake-dredgingMesaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mesa | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mesa. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mesa lake dredging, lake dredging mesa"
        canonical="https://utahwatergardens.com/lake-dredging-mesa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mesa",
          "description": "Professional lake dredging services in Mesa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mesa"
        subtitle="Professional pond services for Lake Dredging Services in Mesa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mesa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mesa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mesa Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mesa Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mesa Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mesa Customers Say About Our Lake Dredging</h2>
