...
const Lake-dredgingStarPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Star | Professional Lake Dredging Services"
        description="Expert lake dredging services in Star. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, star lake dredging, lake dredging star"
        canonical="https://utahwatergardens.com/lake-dredging-star"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Star",
          "description": "Professional lake dredging services in Star",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Star"
        subtitle="Professional pond services for Lake Dredging Services in Star and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Star"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Star</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Star Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Star Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Star Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Star Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingStarPage;