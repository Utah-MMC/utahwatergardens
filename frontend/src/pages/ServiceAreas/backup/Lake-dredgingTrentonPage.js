...
const Lake-dredgingTrentonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Trenton | Professional Lake Dredging Services"
        description="Expert lake dredging services in Trenton. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, trenton lake dredging, lake dredging trenton"
        canonical="https://utahwatergardens.com/lake-dredging-trenton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Trenton",
          "description": "Professional lake dredging services in Trenton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Trenton"
        subtitle="Professional pond services for Lake Dredging Services in Trenton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Trenton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Trenton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Trenton Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Trenton Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Trenton Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Trenton Customers Say About Our Lake Dredging</h2>
