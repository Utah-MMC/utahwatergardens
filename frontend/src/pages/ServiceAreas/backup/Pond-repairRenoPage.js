...
const Pond-repairRenoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Reno | Professional Pond Repair Services"
        description="Expert pond repair services in Reno. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, reno pond repair, pond repair reno"
        canonical="https://utahwatergardens.com/pond-repair-reno"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Reno",
          "description": "Professional pond repair services in Reno",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Reno"
        subtitle="Professional pond services for Pond Repair Services in Reno and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Reno"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Reno</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Reno Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Reno Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Reno Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Reno Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRenoPage;