...
const Pond-cleaningSunsetPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Sunset | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Sunset. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, sunset pond cleaning, pond cleaning sunset"
        canonical="https://utahwatergardens.com/pond-cleaning-sunset"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Sunset",
          "description": "Professional pond cleaning services in Sunset",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Sunset"
        subtitle="Professional pond services for Pond Cleaning Services in Sunset and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Sunset"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Sunset</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunset Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunset Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunset Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunset Customers Say About Our Pond Cleaning</h2>
