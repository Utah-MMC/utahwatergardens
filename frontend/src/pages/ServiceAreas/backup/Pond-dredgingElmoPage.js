...
const Pond-dredgingElmoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Elmo | Professional Pond Dredging Services"
        description="Expert pond dredging services in Elmo. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, elmo pond dredging, pond dredging elmo"
        canonical="https://utahwatergardens.com/pond-dredging-elmo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Elmo",
          "description": "Professional pond dredging services in Elmo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Elmo"
        subtitle="Professional pond services for Pond Dredging Services in Elmo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Elmo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Elmo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elmo Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elmo Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elmo Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elmo Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingElmoPage;