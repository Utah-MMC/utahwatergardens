...
const Pond-maintenanceCaveCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Cave Creek | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Cave Creek. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, cave creek pond maintenance, pond maintenance cave creek"
        canonical="https://utahwatergardens.com/pond-maintenance-cave-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Cave Creek",
          "description": "Professional pond maintenance services in Cave Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Cave Creek"
        subtitle="Professional pond services for Pond Maintenance Services in Cave Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Cave Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Cave Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cave Creek Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cave Creek Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cave Creek Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cave Creek Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceCaveCreekPage;