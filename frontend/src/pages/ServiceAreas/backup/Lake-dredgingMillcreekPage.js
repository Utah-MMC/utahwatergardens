...
const Lake-dredgingMillcreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Millcreek | Professional Lake Dredging Services"
        description="Expert lake dredging services in Millcreek. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, millcreek lake dredging, lake dredging millcreek"
        canonical="https://utahwatergardens.com/lake-dredging-millcreek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Millcreek",
          "description": "Professional lake dredging services in Millcreek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Millcreek"
        subtitle="Professional pond services for Lake Dredging Services in Millcreek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Millcreek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Millcreek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Millcreek Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Millcreek Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Millcreek Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Millcreek Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMillcreekPage;