...
const Pond-constructionSummitParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Summit Park | Professional Pond Construction Services"
        description="Expert pond construction services in Summit Park. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, summit park pond construction, pond construction summit park"
        canonical="https://utahwatergardens.com/pond-construction-summit-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Summit Park",
          "description": "Professional pond construction services in Summit Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Summit Park"
        subtitle="Professional pond services for Pond Construction Services in Summit Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Summit Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Summit Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Summit Park Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Summit Park Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Summit Park Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Summit Park Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSummitParkPage;