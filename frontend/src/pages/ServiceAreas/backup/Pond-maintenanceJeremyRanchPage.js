...
const Pond-maintenanceJeremyRanchPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Jeremy Ranch | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Jeremy Ranch. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, jeremy ranch pond maintenance, pond maintenance jeremy ranch"
        canonical="https://utahwatergardens.com/pond-maintenance-jeremy-ranch"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Jeremy Ranch",
          "description": "Professional pond maintenance services in Jeremy Ranch",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Jeremy Ranch"
        subtitle="Professional pond services for Pond Maintenance Services in Jeremy Ranch and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Jeremy Ranch"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Jeremy Ranch</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jeremy Ranch Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jeremy Ranch Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jeremy Ranch Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jeremy Ranch Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceJeremyRanchPage;