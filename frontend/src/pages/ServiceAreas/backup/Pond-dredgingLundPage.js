...
const Pond-dredgingLundPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lund | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lund. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lund pond dredging, pond dredging lund"
        canonical="https://utahwatergardens.com/pond-dredging-lund"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lund",
          "description": "Professional pond dredging services in Lund",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lund"
        subtitle="Professional pond services for Pond Dredging Services in Lund and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lund"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lund</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lund Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lund Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lund Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lund Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLundPage;