...
const Pond-repairPricePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Price | Professional Pond Repair Services"
        description="Expert pond repair services in Price. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, price pond repair, pond repair price"
        canonical="https://utahwatergardens.com/pond-repair-price"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Price",
          "description": "Professional pond repair services in Price",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Price"
        subtitle="Professional pond services for Pond Repair Services in Price and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Price"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Price</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Price Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Price Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Price Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Price Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPricePage;