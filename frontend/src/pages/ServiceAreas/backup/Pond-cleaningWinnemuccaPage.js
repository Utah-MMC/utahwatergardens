...
const Pond-cleaningWinnemuccaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Winnemucca | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Winnemucca. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, winnemucca pond cleaning, pond cleaning winnemucca"
        canonical="https://utahwatergardens.com/pond-cleaning-winnemucca"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Winnemucca",
          "description": "Professional pond cleaning services in Winnemucca",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Winnemucca"
        subtitle="Professional pond services for Pond Cleaning Services in Winnemucca and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Winnemucca"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Winnemucca</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Winnemucca Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Winnemucca Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Winnemucca Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Winnemucca Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningWinnemuccaPage;