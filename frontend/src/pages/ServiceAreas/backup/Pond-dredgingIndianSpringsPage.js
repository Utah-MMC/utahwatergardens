...
const Pond-dredgingIndianSpringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Indian Springs | Professional Pond Dredging Services"
        description="Expert pond dredging services in Indian Springs. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, indian springs pond dredging, pond dredging indian springs"
        canonical="https://utahwatergardens.com/pond-dredging-indian-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Indian Springs",
          "description": "Professional pond dredging services in Indian Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Indian Springs"
        subtitle="Professional pond services for Pond Dredging Services in Indian Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Indian Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Indian Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Indian Springs Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Indian Springs Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Indian Springs Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Indian Springs Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingIndianSpringsPage;