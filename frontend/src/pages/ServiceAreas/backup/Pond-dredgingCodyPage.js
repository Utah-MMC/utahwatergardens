...
const Pond-dredgingCodyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Cody | Professional Pond Dredging Services"
        description="Expert pond dredging services in Cody. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, cody pond dredging, pond dredging cody"
        canonical="https://utahwatergardens.com/pond-dredging-cody"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Cody",
          "description": "Professional pond dredging services in Cody",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Cody"
        subtitle="Professional pond services for Pond Dredging Services in Cody and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Cody"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Cody</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cody Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cody Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cody Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cody Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCodyPage;