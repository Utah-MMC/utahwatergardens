...
const Pond-dredgingGunnisonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Gunnison | Professional Pond Dredging Services"
        description="Expert pond dredging services in Gunnison. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, gunnison pond dredging, pond dredging gunnison"
        canonical="https://utahwatergardens.com/pond-dredging-gunnison"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Gunnison",
          "description": "Professional pond dredging services in Gunnison",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Gunnison"
        subtitle="Professional pond services for Pond Dredging Services in Gunnison and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Gunnison"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Gunnison</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gunnison Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gunnison Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gunnison Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gunnison Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingGunnisonPage;