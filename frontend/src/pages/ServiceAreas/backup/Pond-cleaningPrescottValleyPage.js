...
const Pond-cleaningPrescottValleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Prescott Valley | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Prescott Valley. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, prescott valley pond cleaning, pond cleaning prescott valley"
        canonical="https://utahwatergardens.com/pond-cleaning-prescott-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Prescott Valley",
          "description": "Professional pond cleaning services in Prescott Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Prescott Valley"
        subtitle="Professional pond services for Pond Cleaning Services in Prescott Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Prescott Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Prescott Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Prescott Valley Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Prescott Valley Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Prescott Valley Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Prescott Valley Customers Say About Our Pond Cleaning</h2>
