...
const Lake-dredgingSouthJordanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging South Jordan | Professional Lake Dredging Services"
        description="Expert lake dredging services in South Jordan. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, south jordan lake dredging, lake dredging south jordan"
        canonical="https://utahwatergardens.com/lake-dredging-south-jordan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services South Jordan",
          "description": "Professional lake dredging services in South Jordan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in South Jordan"
        subtitle="Professional pond services for Lake Dredging Services in South Jordan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in South Jordan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in South Jordan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Jordan Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Jordan Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Jordan Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Jordan Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSouthJordanPage;