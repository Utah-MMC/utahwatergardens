...
const Pond-cleaningTerraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Terra | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Terra. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, terra pond cleaning, pond cleaning terra"
        canonical="https://utahwatergardens.com/pond-cleaning-terra"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Terra",
          "description": "Professional pond cleaning services in Terra",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Terra"
        subtitle="Professional pond services for Pond Cleaning Services in Terra and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Terra"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Terra</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Terra Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Terra Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Terra Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Terra Customers Say About Our Pond Cleaning</h2>
