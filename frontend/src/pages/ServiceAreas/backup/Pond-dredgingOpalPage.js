...
const Pond-dredgingOpalPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Opal | Professional Pond Dredging Services"
        description="Expert pond dredging services in Opal. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, opal pond dredging, pond dredging opal"
        canonical="https://utahwatergardens.com/pond-dredging-opal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Opal",
          "description": "Professional pond dredging services in Opal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Opal"
        subtitle="Professional pond services for Pond Dredging Services in Opal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Opal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Opal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Opal Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Opal Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Opal Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Opal Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingOpalPage;