...
const Pond-dredgingVanTassellPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Van Tassell | Professional Pond Dredging Services"
        description="Expert pond dredging services in Van Tassell. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, van tassell pond dredging, pond dredging van tassell"
        canonical="https://utahwatergardens.com/pond-dredging-van-tassell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Van Tassell",
          "description": "Professional pond dredging services in Van Tassell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Van Tassell"
        subtitle="Professional pond services for Pond Dredging Services in Van Tassell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Van Tassell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Van Tassell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Van Tassell Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Van Tassell Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Van Tassell Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Van Tassell Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingVanTassellPage;