...
const Water-feature-designDouglasPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Douglas | Professional Water Feature Design Services"
        description="Expert water feature design services in Douglas. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, douglas water feature design, water feature design douglas"
        canonical="https://utahwatergardens.com/water-feature-design-douglas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Douglas",
          "description": "Professional water feature design services in Douglas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Douglas"
        subtitle="Professional pond services for Water Feature Design Services in Douglas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Douglas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Douglas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Douglas Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Douglas Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Douglas Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Douglas Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designDouglasPage;