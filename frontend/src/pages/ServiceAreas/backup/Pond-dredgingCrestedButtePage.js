...
const Pond-dredgingCrestedButtePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Crested Butte | Professional Pond Dredging Services"
        description="Expert pond dredging services in Crested Butte. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, crested butte pond dredging, pond dredging crested butte"
        canonical="https://utahwatergardens.com/pond-dredging-crested-butte"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Crested Butte",
          "description": "Professional pond dredging services in Crested Butte",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Crested Butte"
        subtitle="Professional pond services for Pond Dredging Services in Crested Butte and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Crested Butte"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Crested Butte</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crested Butte Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crested Butte Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crested Butte Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crested Butte Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCrestedButtePage;