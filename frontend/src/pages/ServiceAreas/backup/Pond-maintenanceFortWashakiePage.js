...
const Pond-maintenanceFortWashakiePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Fort Washakie | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Fort Washakie. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, fort washakie pond maintenance, pond maintenance fort washakie"
        canonical="https://utahwatergardens.com/pond-maintenance-fort-washakie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Fort Washakie",
          "description": "Professional pond maintenance services in Fort Washakie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Fort Washakie"
        subtitle="Professional pond services for Pond Maintenance Services in Fort Washakie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Fort Washakie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Fort Washakie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fort Washakie Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fort Washakie Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fort Washakie Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fort Washakie Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceFortWashakiePage;