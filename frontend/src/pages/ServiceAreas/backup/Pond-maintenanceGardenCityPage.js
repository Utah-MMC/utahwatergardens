...
const Pond-maintenanceGardenCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Garden City | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Garden City. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, garden city pond maintenance, pond maintenance garden city"
        canonical="https://utahwatergardens.com/pond-maintenance-garden-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Garden City",
          "description": "Professional pond maintenance services in Garden City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Garden City"
        subtitle="Professional pond services for Pond Maintenance Services in Garden City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Garden City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Garden City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Garden City Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Garden City Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Garden City Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Garden City Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceGardenCityPage;