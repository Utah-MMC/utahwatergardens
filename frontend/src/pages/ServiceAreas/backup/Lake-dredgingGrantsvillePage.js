...
const Lake-dredgingGrantsvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Grantsville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Grantsville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, grantsville lake dredging, lake dredging grantsville"
        canonical="https://utahwatergardens.com/lake-dredging-grantsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Grantsville",
          "description": "Professional lake dredging services in Grantsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Grantsville"
        subtitle="Professional pond services for Lake Dredging Services in Grantsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Grantsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Grantsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Grantsville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Grantsville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Grantsville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Grantsville Customers Say About Our Lake Dredging</h2>
