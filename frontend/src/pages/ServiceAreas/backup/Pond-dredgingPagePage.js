...
const Pond-dredgingPagePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Page | Professional Pond Dredging Services"
        description="Expert pond dredging services in Page. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, page pond dredging, pond dredging page"
        canonical="https://utahwatergardens.com/pond-dredging-page"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Page",
          "description": "Professional pond dredging services in Page",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Page"
        subtitle="Professional pond services for Pond Dredging Services in Page and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Page"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Page</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Page Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Page Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Page Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Page Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPagePage;