...
const Lake-dredgingYoderPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Yoder | Professional Lake Dredging Services"
        description="Expert lake dredging services in Yoder. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, yoder lake dredging, lake dredging yoder"
        canonical="https://utahwatergardens.com/lake-dredging-yoder"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Yoder",
          "description": "Professional lake dredging services in Yoder",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Yoder"
        subtitle="Professional pond services for Lake Dredging Services in Yoder and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Yoder"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Yoder</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Yoder Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Yoder Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Yoder Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Yoder Customers Say About Our Lake Dredging</h2>
