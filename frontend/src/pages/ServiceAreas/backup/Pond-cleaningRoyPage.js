...
const Pond-cleaningRoyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Roy | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Roy. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, roy pond cleaning, pond cleaning roy"
        canonical="https://utahwatergardens.com/pond-cleaning-roy"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Roy",
          "description": "Professional pond cleaning services in Roy",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Roy"
        subtitle="Professional pond services for Pond Cleaning Services in Roy and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Roy"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Roy</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Roy Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Roy Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Roy Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Roy Customers Say About Our Pond Cleaning</h2>
