...
const Pond-repairMarblePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Marble | Professional Pond Repair Services"
        description="Expert pond repair services in Marble. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, marble pond repair, pond repair marble"
        canonical="https://utahwatergardens.com/pond-repair-marble"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Marble",
          "description": "Professional pond repair services in Marble",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Marble"
        subtitle="Professional pond services for Pond Repair Services in Marble and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Marble"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Marble</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marble Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marble Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marble Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marble Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMarblePage;