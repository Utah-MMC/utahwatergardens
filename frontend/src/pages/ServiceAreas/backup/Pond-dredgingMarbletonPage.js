...
const Pond-dredgingMarbletonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Marbleton | Professional Pond Dredging Services"
        description="Expert pond dredging services in Marbleton. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, marbleton pond dredging, pond dredging marbleton"
        canonical="https://utahwatergardens.com/pond-dredging-marbleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Marbleton",
          "description": "Professional pond dredging services in Marbleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Marbleton"
        subtitle="Professional pond services for Pond Dredging Services in Marbleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Marbleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Marbleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marbleton Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marbleton Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marbleton Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marbleton Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMarbletonPage;