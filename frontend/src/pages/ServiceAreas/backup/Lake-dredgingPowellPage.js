...
const Lake-dredgingPowellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Powell | Professional Lake Dredging Services"
        description="Expert lake dredging services in Powell. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, powell lake dredging, lake dredging powell"
        canonical="https://utahwatergardens.com/lake-dredging-powell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Powell",
          "description": "Professional lake dredging services in Powell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Powell"
        subtitle="Professional pond services for Lake Dredging Services in Powell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Powell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Powell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Powell Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Powell Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Powell Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Powell Customers Say About Our Lake Dredging</h2>
