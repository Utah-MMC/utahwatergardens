...
const Lake-dredgingLundPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lund | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lund. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lund lake dredging, lake dredging lund"
        canonical="https://utahwatergardens.com/lake-dredging-lund"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lund",
          "description": "Professional lake dredging services in Lund",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lund"
        subtitle="Professional pond services for Lake Dredging Services in Lund and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lund"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lund</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lund Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lund Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lund Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lund Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingLundPage;