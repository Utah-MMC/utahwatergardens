...
const Lake-dredgingRigbyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Rigby | Professional Lake Dredging Services"
        description="Expert lake dredging services in Rigby. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, rigby lake dredging, lake dredging rigby"
        canonical="https://utahwatergardens.com/lake-dredging-rigby"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Rigby",
          "description": "Professional lake dredging services in Rigby",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Rigby"
        subtitle="Professional pond services for Lake Dredging Services in Rigby and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Rigby"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Rigby</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rigby Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rigby Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rigby Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rigby Customers Say About Our Lake Dredging</h2>
