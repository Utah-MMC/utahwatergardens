...
const Pond-cleaningMontrosePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Montrose | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Montrose. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, montrose pond cleaning, pond cleaning montrose"
        canonical="https://utahwatergardens.com/pond-cleaning-montrose"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Montrose",
          "description": "Professional pond cleaning services in Montrose",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Montrose"
        subtitle="Professional pond services for Pond Cleaning Services in Montrose and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Montrose"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Montrose</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Montrose Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Montrose Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Montrose Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Montrose Customers Say About Our Pond Cleaning</h2>
