...
const Pond-cleaningStansburyParkPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Stansbury Park | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Stansbury Park. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, stansbury park pond cleaning, pond cleaning stansbury park"
        canonical="https://utahwatergardens.com/pond-cleaning-stansbury-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Stansbury Park",
          "description": "Professional pond cleaning services in Stansbury Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Stansbury Park"
        subtitle="Professional pond services for Pond Cleaning Services in Stansbury Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Stansbury Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Stansbury Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Stansbury Park Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Stansbury Park Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Stansbury Park Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Stansbury Park Customers Say About Our Pond Cleaning</h2>
