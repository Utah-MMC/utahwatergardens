...
const Pond-repairUintahPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Uintah | Professional Pond Repair Services"
        description="Expert pond repair services in Uintah. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, uintah pond repair, pond repair uintah"
        canonical="https://utahwatergardens.com/pond-repair-uintah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Uintah",
          "description": "Professional pond repair services in Uintah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Uintah"
        subtitle="Professional pond services for Pond Repair Services in Uintah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Uintah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Uintah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Uintah Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Uintah Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Uintah Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Uintah Customers Say About Our Pond Repair</h2>
...
export default Pond-repairUintahPage;