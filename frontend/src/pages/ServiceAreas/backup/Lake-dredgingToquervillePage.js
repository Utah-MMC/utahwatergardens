...
const Lake-dredgingToquervillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Toquerville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Toquerville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, toquerville lake dredging, lake dredging toquerville"
        canonical="https://utahwatergardens.com/lake-dredging-toquerville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Toquerville",
          "description": "Professional lake dredging services in Toquerville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Toquerville"
        subtitle="Professional pond services for Lake Dredging Services in Toquerville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Toquerville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Toquerville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Toquerville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Toquerville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Toquerville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Toquerville Customers Say About Our Lake Dredging</h2>
