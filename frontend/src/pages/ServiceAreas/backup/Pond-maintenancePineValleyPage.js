...
const Pond-maintenancePineValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Pine Valley | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Pine Valley. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, pine valley pond maintenance, pond maintenance pine valley"
        canonical="https://utahwatergardens.com/pond-maintenance-pine-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Pine Valley",
          "description": "Professional pond maintenance services in Pine Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Pine Valley"
        subtitle="Professional pond services for Pond Maintenance Services in Pine Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Pine Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Pine Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pine Valley Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pine Valley Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pine Valley Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pine Valley Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenancePineValleyPage;