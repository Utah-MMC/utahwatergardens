...
const Pond-repairSnowvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Snowville | Professional Pond Repair Services"
        description="Expert pond repair services in Snowville. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, snowville pond repair, pond repair snowville"
        canonical="https://utahwatergardens.com/pond-repair-snowville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Snowville",
          "description": "Professional pond repair services in Snowville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Snowville"
        subtitle="Professional pond services for Pond Repair Services in Snowville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Snowville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Snowville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Snowville Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Snowville Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Snowville Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Snowville Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSnowvillePage;