...
const Pond-repairHowellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Howell | Professional Pond Repair Services"
        description="Expert pond repair services in Howell. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, howell pond repair, pond repair howell"
        canonical="https://utahwatergardens.com/pond-repair-howell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Howell",
          "description": "Professional pond repair services in Howell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Howell"
        subtitle="Professional pond services for Pond Repair Services in Howell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Howell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Howell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Howell Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Howell Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Howell Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Howell Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHowellPage;