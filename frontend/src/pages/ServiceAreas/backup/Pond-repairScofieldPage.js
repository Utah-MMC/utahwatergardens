...
const Pond-repairScofieldPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Scofield | Professional Pond Repair Services"
        description="Expert pond repair services in Scofield. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, scofield pond repair, pond repair scofield"
        canonical="https://utahwatergardens.com/pond-repair-scofield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Scofield",
          "description": "Professional pond repair services in Scofield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Scofield"
        subtitle="Professional pond services for Pond Repair Services in Scofield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Scofield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Scofield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Scofield Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Scofield Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Scofield Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Scofield Customers Say About Our Pond Repair</h2>
...
export default Pond-repairScofieldPage;