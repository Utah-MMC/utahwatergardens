...
const Pond-dredgingCorinnePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Corinne | Professional Pond Dredging Services"
        description="Expert pond dredging services in Corinne. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, corinne pond dredging, pond dredging corinne"
        canonical="https://utahwatergardens.com/pond-dredging-corinne"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Corinne",
          "description": "Professional pond dredging services in Corinne",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Corinne"
        subtitle="Professional pond services for Pond Dredging Services in Corinne and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Corinne"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Corinne</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Corinne Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Corinne Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Corinne Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Corinne Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCorinnePage;