...
const Pond-dredgingFarrWestPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Farr West | Professional Pond Dredging Services"
        description="Expert pond dredging services in Farr West. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, farr west pond dredging, pond dredging farr west"
        canonical="https://utahwatergardens.com/pond-dredging-farr-west"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Farr West",
          "description": "Professional pond dredging services in Farr West",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Farr West"
        subtitle="Professional pond services for Pond Dredging Services in Farr West and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Farr West"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Farr West</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farr West Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farr West Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farr West Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farr West Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFarrWestPage;