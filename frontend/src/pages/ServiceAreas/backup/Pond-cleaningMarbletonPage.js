...
const Pond-cleaningMarbletonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Marbleton | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Marbleton. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, marbleton pond cleaning, pond cleaning marbleton"
        canonical="https://utahwatergardens.com/pond-cleaning-marbleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Marbleton",
          "description": "Professional pond cleaning services in Marbleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Marbleton"
        subtitle="Professional pond services for Pond Cleaning Services in Marbleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Marbleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Marbleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marbleton Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marbleton Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marbleton Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marbleton Customers Say About Our Pond Cleaning</h2>
