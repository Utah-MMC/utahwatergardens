...
const Pond-repairSpringLakePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Spring Lake | Professional Pond Repair Services"
        description="Expert pond repair services in Spring Lake. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, spring lake pond repair, pond repair spring lake"
        canonical="https://utahwatergardens.com/pond-repair-spring-lake"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Spring Lake",
          "description": "Professional pond repair services in Spring Lake",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Spring Lake"
        subtitle="Professional pond services for Pond Repair Services in Spring Lake and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Spring Lake"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Spring Lake</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spring Lake Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spring Lake Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spring Lake Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spring Lake Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSpringLakePage;