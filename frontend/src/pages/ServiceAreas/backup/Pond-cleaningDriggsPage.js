...
const Pond-cleaningDriggsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Driggs | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Driggs. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, driggs pond cleaning, pond cleaning driggs"
        canonical="https://utahwatergardens.com/pond-cleaning-driggs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Driggs",
          "description": "Professional pond cleaning services in Driggs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Driggs"
        subtitle="Professional pond services for Pond Cleaning Services in Driggs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Driggs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Driggs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Driggs Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Driggs Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Driggs Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Driggs Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDriggsPage;