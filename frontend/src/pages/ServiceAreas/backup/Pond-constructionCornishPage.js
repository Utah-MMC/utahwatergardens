...
const Pond-constructionCornishPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Cornish | Professional Pond Construction Services"
        description="Expert pond construction services in Cornish. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, cornish pond construction, pond construction cornish"
        canonical="https://utahwatergardens.com/pond-construction-cornish"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Cornish",
          "description": "Professional pond construction services in Cornish",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Cornish"
        subtitle="Professional pond services for Pond Construction Services in Cornish and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Cornish"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Cornish</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cornish Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cornish Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cornish Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cornish Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionCornishPage;