...
const Pond-dredgingWorlandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Worland | Professional Pond Dredging Services"
        description="Expert pond dredging services in Worland. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, worland pond dredging, pond dredging worland"
        canonical="https://utahwatergardens.com/pond-dredging-worland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Worland",
          "description": "Professional pond dredging services in Worland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Worland"
        subtitle="Professional pond services for Pond Dredging Services in Worland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Worland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Worland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Worland Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Worland Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Worland Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Worland Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWorlandPage;