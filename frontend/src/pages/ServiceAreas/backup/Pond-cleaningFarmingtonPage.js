...
const Pond-cleaningFarmingtonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Farmington | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Farmington. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, farmington pond cleaning, pond cleaning farmington"
        canonical="https://utahwatergardens.com/pond-cleaning-farmington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Farmington",
          "description": "Professional pond cleaning services in Farmington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Farmington"
        subtitle="Professional pond services for Pond Cleaning Services in Farmington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Farmington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Farmington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farmington Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farmington Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farmington Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farmington Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningFarmingtonPage;