...
const Pond-constructionVernalPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Vernal | Professional Pond Construction Services"
        description="Expert pond construction services in Vernal. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, vernal pond construction, pond construction vernal"
        canonical="https://utahwatergardens.com/pond-construction-vernal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Vernal",
          "description": "Professional pond construction services in Vernal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Vernal"
        subtitle="Professional pond services for Pond Construction Services in Vernal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Vernal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Vernal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vernal Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vernal Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vernal Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vernal Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionVernalPage;