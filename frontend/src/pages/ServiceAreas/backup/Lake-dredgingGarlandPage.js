...
const Lake-dredgingGarlandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Garland | Professional Lake Dredging Services"
        description="Expert lake dredging services in Garland. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, garland lake dredging, lake dredging garland"
        canonical="https://utahwatergardens.com/lake-dredging-garland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Garland",
          "description": "Professional lake dredging services in Garland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Garland"
        subtitle="Professional pond services for Lake Dredging Services in Garland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Garland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Garland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Garland Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Garland Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Garland Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Garland Customers Say About Our Lake Dredging</h2>
