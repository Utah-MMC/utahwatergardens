...
const Pond-cleaningCastleDalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Castle Dale | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Castle Dale. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, castle dale pond cleaning, pond cleaning castle dale"
        canonical="https://utahwatergardens.com/pond-cleaning-castle-dale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Castle Dale",
          "description": "Professional pond cleaning services in Castle Dale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Castle Dale"
        subtitle="Professional pond services for Pond Cleaning Services in Castle Dale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Castle Dale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Castle Dale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Castle Dale Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Castle Dale Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Castle Dale Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Castle Dale Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCastleDalePage;