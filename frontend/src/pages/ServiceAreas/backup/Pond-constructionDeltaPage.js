...
const Pond-constructionDeltaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Delta | Professional Pond Construction Services"
        description="Expert pond construction services in Delta. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, delta pond construction, pond construction delta"
        canonical="https://utahwatergardens.com/pond-construction-delta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Delta",
          "description": "Professional pond construction services in Delta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Delta"
        subtitle="Professional pond services for Pond Construction Services in Delta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Delta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Delta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Delta Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Delta Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Delta Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Delta Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionDeltaPage;