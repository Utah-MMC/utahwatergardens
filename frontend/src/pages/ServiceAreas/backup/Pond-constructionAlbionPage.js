...
const Pond-constructionAlbionPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Albion | Professional Pond Construction Services"
        description="Expert pond construction services in Albion. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, albion pond construction, pond construction albion"
        canonical="https://utahwatergardens.com/pond-construction-albion"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Albion",
          "description": "Professional pond construction services in Albion",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Albion"
        subtitle="Professional pond services for Pond Construction Services in Albion and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Albion"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Albion</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Albion Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Albion Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Albion Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Albion Customers Say About Our Pond Construction</h2>
