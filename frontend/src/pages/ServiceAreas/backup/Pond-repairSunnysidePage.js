...
const Pond-repairSunnysidePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Sunnyside | Professional Pond Repair Services"
        description="Expert pond repair services in Sunnyside. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, sunnyside pond repair, pond repair sunnyside"
        canonical="https://utahwatergardens.com/pond-repair-sunnyside"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Sunnyside",
          "description": "Professional pond repair services in Sunnyside",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Sunnyside"
        subtitle="Professional pond services for Pond Repair Services in Sunnyside and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Sunnyside"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Sunnyside</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunnyside Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunnyside Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunnyside Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunnyside Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSunnysidePage;