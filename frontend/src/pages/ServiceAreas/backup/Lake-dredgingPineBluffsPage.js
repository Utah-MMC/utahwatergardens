...
const Lake-dredgingPineBluffsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Pine Bluffs | Professional Lake Dredging Services"
        description="Expert lake dredging services in Pine Bluffs. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, pine bluffs lake dredging, lake dredging pine bluffs"
        canonical="https://utahwatergardens.com/lake-dredging-pine-bluffs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Pine Bluffs",
          "description": "Professional lake dredging services in Pine Bluffs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Pine Bluffs"
        subtitle="Professional pond services for Lake Dredging Services in Pine Bluffs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Pine Bluffs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Pine Bluffs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pine Bluffs Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pine Bluffs Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pine Bluffs Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pine Bluffs Customers Say About Our Lake Dredging</h2>
