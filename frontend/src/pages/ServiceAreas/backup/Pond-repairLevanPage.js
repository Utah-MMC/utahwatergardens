...
const Pond-repairLevanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Levan | Professional Pond Repair Services"
        description="Expert pond repair services in Levan. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, levan pond repair, pond repair levan"
        canonical="https://utahwatergardens.com/pond-repair-levan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Levan",
          "description": "Professional pond repair services in Levan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Levan"
        subtitle="Professional pond services for Pond Repair Services in Levan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Levan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Levan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Levan Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Levan Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Levan Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Levan Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLevanPage;