...
const Lake-dredgingAspenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Aspen | Professional Lake Dredging Services"
        description="Expert lake dredging services in Aspen. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, aspen lake dredging, lake dredging aspen"
        canonical="https://utahwatergardens.com/lake-dredging-aspen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Aspen",
          "description": "Professional lake dredging services in Aspen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Aspen"
        subtitle="Professional pond services for Lake Dredging Services in Aspen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Aspen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Aspen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aspen Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aspen Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aspen Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aspen Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAspenPage;