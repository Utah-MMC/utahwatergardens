...
const Pond-dredgingFernleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Fernley | Professional Pond Dredging Services"
        description="Expert pond dredging services in Fernley. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, fernley pond dredging, pond dredging fernley"
        canonical="https://utahwatergardens.com/pond-dredging-fernley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Fernley",
          "description": "Professional pond dredging services in Fernley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Fernley"
        subtitle="Professional pond services for Pond Dredging Services in Fernley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Fernley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Fernley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fernley Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fernley Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fernley Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fernley Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFernleyPage;