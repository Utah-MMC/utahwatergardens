...
const Pond-cleaningCornishPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Cornish | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Cornish. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, cornish pond cleaning, pond cleaning cornish"
        canonical="https://utahwatergardens.com/pond-cleaning-cornish"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Cornish",
          "description": "Professional pond cleaning services in Cornish",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Cornish"
        subtitle="Professional pond services for Pond Cleaning Services in Cornish and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Cornish"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Cornish</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cornish Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cornish Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cornish Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cornish Customers Say About Our Pond Cleaning</h2>
