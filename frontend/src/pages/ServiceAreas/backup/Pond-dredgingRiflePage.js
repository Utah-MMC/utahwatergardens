...
const Pond-dredgingRiflePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Rifle | Professional Pond Dredging Services"
        description="Expert pond dredging services in Rifle. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, rifle pond dredging, pond dredging rifle"
        canonical="https://utahwatergardens.com/pond-dredging-rifle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Rifle",
          "description": "Professional pond dredging services in Rifle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Rifle"
        subtitle="Professional pond services for Pond Dredging Services in Rifle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Rifle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Rifle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rifle Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rifle Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rifle Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rifle Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingRiflePage;