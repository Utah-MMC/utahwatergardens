...
const Pond-cleaningClarkstonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Clarkston | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Clarkston. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, clarkston pond cleaning, pond cleaning clarkston"
        canonical="https://utahwatergardens.com/pond-cleaning-clarkston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Clarkston",
          "description": "Professional pond cleaning services in Clarkston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Clarkston"
        subtitle="Professional pond services for Pond Cleaning Services in Clarkston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Clarkston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Clarkston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clarkston Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clarkston Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clarkston Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clarkston Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningClarkstonPage;