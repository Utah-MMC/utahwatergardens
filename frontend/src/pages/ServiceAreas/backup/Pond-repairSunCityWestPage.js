...
const Pond-repairSunCityWestPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Sun City West | Professional Pond Repair Services"
        description="Expert pond repair services in Sun City West. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, sun city west pond repair, pond repair sun city west"
        canonical="https://utahwatergardens.com/pond-repair-sun-city-west"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Sun City West",
          "description": "Professional pond repair services in Sun City West",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Sun City West"
        subtitle="Professional pond services for Pond Repair Services in Sun City West and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Sun City West"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Sun City West</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sun City West Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sun City West Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sun City West Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sun City West Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSunCityWestPage;