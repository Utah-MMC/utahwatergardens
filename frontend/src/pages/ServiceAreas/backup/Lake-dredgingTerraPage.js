...
const Lake-dredgingTerraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Terra | Professional Lake Dredging Services"
        description="Expert lake dredging services in Terra. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, terra lake dredging, lake dredging terra"
        canonical="https://utahwatergardens.com/lake-dredging-terra"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Terra",
          "description": "Professional lake dredging services in Terra",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Terra"
        subtitle="Professional pond services for Lake Dredging Services in Terra and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Terra"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Terra</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Terra Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Terra Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Terra Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Terra Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingTerraPage;