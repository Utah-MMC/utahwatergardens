...
const Pond-repairVineyardPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Vineyard | Professional Pond Repair Services"
        description="Expert pond repair services in Vineyard. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, vineyard pond repair, pond repair vineyard"
        canonical="https://utahwatergardens.com/pond-repair-vineyard"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Vineyard",
          "description": "Professional pond repair services in Vineyard",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Vineyard"
        subtitle="Professional pond services for Pond Repair Services in Vineyard and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Vineyard"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Vineyard</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vineyard Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vineyard Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vineyard Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vineyard Customers Say About Our Pond Repair</h2>
...
export default Pond-repairVineyardPage;