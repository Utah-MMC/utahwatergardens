...
const Pond-constructionWanshipPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Wanship | Professional Pond Construction Services"
        description="Expert pond construction services in Wanship. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, wanship pond construction, pond construction wanship"
        canonical="https://utahwatergardens.com/pond-construction-wanship"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Wanship",
          "description": "Professional pond construction services in Wanship",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Wanship"
        subtitle="Professional pond services for Pond Construction Services in Wanship and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Wanship"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Wanship</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wanship Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wanship Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wanship Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wanship Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionWanshipPage;