...
const Pond-dredgingNewPlymouthPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging New Plymouth | Professional Pond Dredging Services"
        description="Expert pond dredging services in New Plymouth. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, new plymouth pond dredging, pond dredging new plymouth"
        canonical="https://utahwatergardens.com/pond-dredging-new-plymouth"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services New Plymouth",
          "description": "Professional pond dredging services in New Plymouth",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in New Plymouth"
        subtitle="Professional pond services for Pond Dredging Services in New Plymouth and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in New Plymouth"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in New Plymouth</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Plymouth Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Plymouth Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Plymouth Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Plymouth Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNewPlymouthPage;