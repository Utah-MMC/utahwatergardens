...
const Pond-repairLoganPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Logan | Professional Pond Repair Services"
        description="Expert pond repair services in Logan. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, logan pond repair, pond repair logan"
        canonical="https://utahwatergardens.com/pond-repair-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Logan",
          "description": "Professional pond repair services in Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Logan"
        subtitle="Professional pond services for Pond Repair Services in Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Logan Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Logan Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Logan Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Logan Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLoganPage;