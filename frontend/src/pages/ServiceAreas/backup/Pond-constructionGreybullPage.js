...
const Pond-constructionGreybullPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Greybull | Professional Pond Construction Services"
        description="Expert pond construction services in Greybull. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, greybull pond construction, pond construction greybull"
        canonical="https://utahwatergardens.com/pond-construction-greybull"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Greybull",
          "description": "Professional pond construction services in Greybull",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Greybull"
        subtitle="Professional pond services for Pond Construction Services in Greybull and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Greybull"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Greybull</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Greybull Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Greybull Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Greybull Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Greybull Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionGreybullPage;