...
const Pond-constructionWestJordanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction West Jordan | Professional Pond Construction Services"
        description="Expert pond construction services in West Jordan. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, west jordan pond construction, pond construction west jordan"
        canonical="https://utahwatergardens.com/pond-construction-west-jordan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services West Jordan",
          "description": "Professional pond construction services in West Jordan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in West Jordan"
        subtitle="Professional pond services for Pond Construction Services in West Jordan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in West Jordan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in West Jordan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Jordan Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Jordan Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Jordan Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Jordan Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionWestJordanPage;