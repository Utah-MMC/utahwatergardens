...
const Lake-dredgingParowanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Parowan | Professional Lake Dredging Services"
        description="Expert lake dredging services in Parowan. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, parowan lake dredging, lake dredging parowan"
        canonical="https://utahwatergardens.com/lake-dredging-parowan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Parowan",
          "description": "Professional lake dredging services in Parowan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Parowan"
        subtitle="Professional pond services for Lake Dredging Services in Parowan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Parowan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Parowan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parowan Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parowan Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parowan Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parowan Customers Say About Our Lake Dredging</h2>
