...
const Pond-repairKnollsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Knolls | Professional Pond Repair Services"
        description="Expert pond repair services in Knolls. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, knolls pond repair, pond repair knolls"
        canonical="https://utahwatergardens.com/pond-repair-knolls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Knolls",
          "description": "Professional pond repair services in Knolls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Knolls"
        subtitle="Professional pond services for Pond Repair Services in Knolls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Knolls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Knolls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Knolls Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Knolls Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Knolls Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Knolls Customers Say About Our Pond Repair</h2>
...
export default Pond-repairKnollsPage;