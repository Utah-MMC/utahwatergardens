...
const Lake-dredgingLaVerkinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging La Verkin | Professional Lake Dredging Services"
        description="Expert lake dredging services in La Verkin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, la verkin lake dredging, lake dredging la verkin"
        canonical="https://utahwatergardens.com/lake-dredging-la-verkin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services La Verkin",
          "description": "Professional lake dredging services in La Verkin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in La Verkin"
        subtitle="Professional pond services for Lake Dredging Services in La Verkin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in La Verkin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in La Verkin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Verkin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Verkin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Verkin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Verkin Customers Say About Our Lake Dredging</h2>
