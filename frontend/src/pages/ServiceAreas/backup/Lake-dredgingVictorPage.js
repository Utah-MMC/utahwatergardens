...
const Lake-dredgingVictorPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Victor | Professional Lake Dredging Services"
        description="Expert lake dredging services in Victor. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, victor lake dredging, lake dredging victor"
        canonical="https://utahwatergardens.com/lake-dredging-victor"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Victor",
          "description": "Professional lake dredging services in Victor",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Victor"
        subtitle="Professional pond services for Lake Dredging Services in Victor and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Victor"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Victor</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Victor Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Victor Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Victor Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Victor Customers Say About Our Lake Dredging</h2>
