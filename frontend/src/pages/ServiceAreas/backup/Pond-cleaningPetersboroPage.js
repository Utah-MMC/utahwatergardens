...
const Pond-cleaningPetersboroPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Petersboro | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Petersboro. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, petersboro pond cleaning, pond cleaning petersboro"
        canonical="https://utahwatergardens.com/pond-cleaning-petersboro"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Petersboro",
          "description": "Professional pond cleaning services in Petersboro",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Petersboro"
        subtitle="Professional pond services for Pond Cleaning Services in Petersboro and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Petersboro"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Petersboro</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Petersboro Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Petersboro Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Petersboro Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Petersboro Customers Say About Our Pond Cleaning</h2>
