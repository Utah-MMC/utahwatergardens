...
const Pond-cleaningPaoniaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Paonia | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Paonia. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, paonia pond cleaning, pond cleaning paonia"
        canonical="https://utahwatergardens.com/pond-cleaning-paonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Paonia",
          "description": "Professional pond cleaning services in Paonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Paonia"
        subtitle="Professional pond services for Pond Cleaning Services in Paonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Paonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Paonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paonia Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paonia Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paonia Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paonia Customers Say About Our Pond Cleaning</h2>
