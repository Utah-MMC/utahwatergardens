...
const Pond-cleaningHighlandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Highland | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Highland. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, highland pond cleaning, pond cleaning highland"
        canonical="https://utahwatergardens.com/pond-cleaning-highland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Highland",
          "description": "Professional pond cleaning services in Highland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Highland"
        subtitle="Professional pond services for Pond Cleaning Services in Highland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Highland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Highland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Highland Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Highland Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Highland Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Highland Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningHighlandPage;