...
const Pond-repairCharlestonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Charleston | Professional Pond Repair Services"
        description="Expert pond repair services in Charleston. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, charleston pond repair, pond repair charleston"
        canonical="https://utahwatergardens.com/pond-repair-charleston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Charleston",
          "description": "Professional pond repair services in Charleston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Charleston"
        subtitle="Professional pond services for Pond Repair Services in Charleston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Charleston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Charleston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Charleston Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Charleston Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Charleston Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Charleston Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCharlestonPage;