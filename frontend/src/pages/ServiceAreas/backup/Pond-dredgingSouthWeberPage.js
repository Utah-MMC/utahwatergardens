...
const Pond-dredgingSouthWeberPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging South Weber | Professional Pond Dredging Services"
        description="Expert pond dredging services in South Weber. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, south weber pond dredging, pond dredging south weber"
        canonical="https://utahwatergardens.com/pond-dredging-south-weber"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services South Weber",
          "description": "Professional pond dredging services in South Weber",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in South Weber"
        subtitle="Professional pond services for Pond Dredging Services in South Weber and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in South Weber"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in South Weber</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Weber Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Weber Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Weber Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Weber Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSouthWeberPage;