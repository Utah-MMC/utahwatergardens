...
const Lake-dredgingNorthLoganPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging North Logan | Professional Lake Dredging Services"
        description="Expert lake dredging services in North Logan. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, north logan lake dredging, lake dredging north logan"
        canonical="https://utahwatergardens.com/lake-dredging-north-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services North Logan",
          "description": "Professional lake dredging services in North Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in North Logan"
        subtitle="Professional pond services for Lake Dredging Services in North Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in North Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in North Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Logan Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Logan Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Logan Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Logan Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingNorthLoganPage;