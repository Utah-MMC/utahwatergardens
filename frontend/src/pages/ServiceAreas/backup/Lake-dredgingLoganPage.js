...
const Lake-dredgingLoganPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Logan | Professional Lake Dredging Services"
        description="Expert lake dredging services in Logan. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, logan lake dredging, lake dredging logan"
        canonical="https://utahwatergardens.com/lake-dredging-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Logan",
          "description": "Professional lake dredging services in Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Logan"
        subtitle="Professional pond services for Lake Dredging Services in Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Logan Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Logan Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Logan Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Logan Customers Say About Our Lake Dredging</h2>
