...
const Pond-dredgingHydeParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hyde Park | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hyde Park. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hyde park pond dredging, pond dredging hyde park"
        canonical="https://utahwatergardens.com/pond-dredging-hyde-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hyde Park",
          "description": "Professional pond dredging services in Hyde Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hyde Park"
        subtitle="Professional pond services for Pond Dredging Services in Hyde Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hyde Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hyde Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hyde Park Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hyde Park Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hyde Park Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hyde Park Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHydeParkPage;