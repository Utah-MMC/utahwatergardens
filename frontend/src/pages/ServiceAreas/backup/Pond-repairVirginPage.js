...
const Pond-repairVirginPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Virgin | Professional Pond Repair Services"
        description="Expert pond repair services in Virgin. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, virgin pond repair, pond repair virgin"
        canonical="https://utahwatergardens.com/pond-repair-virgin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Virgin",
          "description": "Professional pond repair services in Virgin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Virgin"
        subtitle="Professional pond services for Pond Repair Services in Virgin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Virgin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Virgin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Virgin Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Virgin Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Virgin Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Virgin Customers Say About Our Pond Repair</h2>
...
export default Pond-repairVirginPage;