...
const Lake-dredgingLakeShorePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lake Shore | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lake Shore. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lake shore lake dredging, lake dredging lake shore"
        canonical="https://utahwatergardens.com/lake-dredging-lake-shore"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lake Shore",
          "description": "Professional lake dredging services in Lake Shore",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lake Shore"
        subtitle="Professional pond services for Lake Dredging Services in Lake Shore and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lake Shore"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lake Shore</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lake Shore Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lake Shore Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lake Shore Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lake Shore Customers Say About Our Lake Dredging</h2>
