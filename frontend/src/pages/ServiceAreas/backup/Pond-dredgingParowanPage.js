...
const Pond-dredgingParowanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Parowan | Professional Pond Dredging Services"
        description="Expert pond dredging services in Parowan. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, parowan pond dredging, pond dredging parowan"
        canonical="https://utahwatergardens.com/pond-dredging-parowan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Parowan",
          "description": "Professional pond dredging services in Parowan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Parowan"
        subtitle="Professional pond services for Pond Dredging Services in Parowan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Parowan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Parowan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parowan Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parowan Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parowan Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parowan Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingParowanPage;