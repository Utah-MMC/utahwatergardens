...
const Pond-repairProvidencePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Providence | Professional Pond Repair Services"
        description="Expert pond repair services in Providence. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, providence pond repair, pond repair providence"
        canonical="https://utahwatergardens.com/pond-repair-providence"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Providence",
          "description": "Professional pond repair services in Providence",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Providence"
        subtitle="Professional pond services for Pond Repair Services in Providence and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Providence"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Providence</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Providence Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Providence Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Providence Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Providence Customers Say About Our Pond Repair</h2>
...
export default Pond-repairProvidencePage;