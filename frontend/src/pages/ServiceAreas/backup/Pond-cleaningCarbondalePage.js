...
const Pond-cleaningCarbondalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Carbondale | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Carbondale. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, carbondale pond cleaning, pond cleaning carbondale"
        canonical="https://utahwatergardens.com/pond-cleaning-carbondale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Carbondale",
          "description": "Professional pond cleaning services in Carbondale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Carbondale"
        subtitle="Professional pond services for Pond Cleaning Services in Carbondale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Carbondale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Carbondale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carbondale Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carbondale Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carbondale Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carbondale Customers Say About Our Pond Cleaning</h2>
