...
const Pond-constructionQueenCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Queen Creek | Professional Pond Construction Services"
        description="Expert pond construction services in Queen Creek. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, queen creek pond construction, pond construction queen creek"
        canonical="https://utahwatergardens.com/pond-construction-queen-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Queen Creek",
          "description": "Professional pond construction services in Queen Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Queen Creek"
        subtitle="Professional pond services for Pond Construction Services in Queen Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Queen Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Queen Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Queen Creek Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Queen Creek Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Queen Creek Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Queen Creek Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionQueenCreekPage;