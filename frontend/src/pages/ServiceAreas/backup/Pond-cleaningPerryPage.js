...
const Pond-cleaningPerryPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Perry | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Perry. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, perry pond cleaning, pond cleaning perry"
        canonical="https://utahwatergardens.com/pond-cleaning-perry"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Perry",
          "description": "Professional pond cleaning services in Perry",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Perry"
        subtitle="Professional pond services for Pond Cleaning Services in Perry and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Perry"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Perry</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Perry Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Perry Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Perry Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Perry Customers Say About Our Pond Cleaning</h2>
