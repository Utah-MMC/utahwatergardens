...
const Pond-repairDouglasPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Douglas | Professional Pond Repair Services"
        description="Expert pond repair services in Douglas. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, douglas pond repair, pond repair douglas"
        canonical="https://utahwatergardens.com/pond-repair-douglas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Douglas",
          "description": "Professional pond repair services in Douglas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Douglas"
        subtitle="Professional pond services for Pond Repair Services in Douglas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Douglas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Douglas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Douglas Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Douglas Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Douglas Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Douglas Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDouglasPage;