...
const Pond-dredgingSpanishForkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Spanish Fork | Professional Pond Dredging Services"
        description="Expert pond dredging services in Spanish Fork. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, spanish fork pond dredging, pond dredging spanish fork"
        canonical="https://utahwatergardens.com/pond-dredging-spanish-fork"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Spanish Fork",
          "description": "Professional pond dredging services in Spanish Fork",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Spanish Fork"
        subtitle="Professional pond services for Pond Dredging Services in Spanish Fork and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Spanish Fork"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Spanish Fork</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spanish Fork Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spanish Fork Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spanish Fork Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spanish Fork Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSpanishForkPage;