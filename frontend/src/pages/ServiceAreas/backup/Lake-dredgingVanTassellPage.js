...
const Lake-dredgingVanTassellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Van Tassell | Professional Lake Dredging Services"
        description="Expert lake dredging services in Van Tassell. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, van tassell lake dredging, lake dredging van tassell"
        canonical="https://utahwatergardens.com/lake-dredging-van-tassell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Van Tassell",
          "description": "Professional lake dredging services in Van Tassell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Van Tassell"
        subtitle="Professional pond services for Lake Dredging Services in Van Tassell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Van Tassell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Van Tassell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Van Tassell Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Van Tassell Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Van Tassell Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Van Tassell Customers Say About Our Lake Dredging</h2>
