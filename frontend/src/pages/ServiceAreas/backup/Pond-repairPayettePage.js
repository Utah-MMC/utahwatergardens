...
const Pond-repairPayettePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Payette | Professional Pond Repair Services"
        description="Expert pond repair services in Payette. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, payette pond repair, pond repair payette"
        canonical="https://utahwatergardens.com/pond-repair-payette"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Payette",
          "description": "Professional pond repair services in Payette",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Payette"
        subtitle="Professional pond services for Pond Repair Services in Payette and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Payette"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Payette</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Payette Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Payette Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Payette Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Payette Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPayettePage;