...
const Pond-repairAltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Alta | Professional Pond Repair Services"
        description="Expert pond repair services in Alta. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, alta pond repair, pond repair alta"
        canonical="https://utahwatergardens.com/pond-repair-alta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Alta",
          "description": "Professional pond repair services in Alta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Alta"
        subtitle="Professional pond services for Pond Repair Services in Alta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Alta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Alta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alta Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alta Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alta Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alta Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAltaPage;