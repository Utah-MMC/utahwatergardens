...
const Pond-cleaningLoganPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Logan | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Logan. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, logan pond cleaning, pond cleaning logan"
        canonical="https://utahwatergardens.com/pond-cleaning-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Logan",
          "description": "Professional pond cleaning services in Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Logan"
        subtitle="Professional pond services for Pond Cleaning Services in Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Logan Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Logan Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Logan Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Logan Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLoganPage;