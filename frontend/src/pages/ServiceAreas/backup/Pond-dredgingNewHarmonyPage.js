...
const Pond-dredgingNewHarmonyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging New Harmony | Professional Pond Dredging Services"
        description="Expert pond dredging services in New Harmony. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, new harmony pond dredging, pond dredging new harmony"
        canonical="https://utahwatergardens.com/pond-dredging-new-harmony"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services New Harmony",
          "description": "Professional pond dredging services in New Harmony",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in New Harmony"
        subtitle="Professional pond services for Pond Dredging Services in New Harmony and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in New Harmony"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in New Harmony</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Harmony Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Harmony Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Harmony Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Harmony Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNewHarmonyPage;