...
const HarvestingProvoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Provo | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Provo. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, provo aquatic plant harvesting, aquatic plant harvesting provo"
        canonical="https://utahwatergardens.com/harvesting-provo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Provo",
          "description": "Professional aquatic plant harvesting services in Provo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Provo"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Provo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Provo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Provo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Provo Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Provo Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Provo Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Provo Customers Say About Our Aquatic Plant Harvesting</h2>
