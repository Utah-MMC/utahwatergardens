...
const Lake-dredgingFieldingPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Fielding | Professional Lake Dredging Services"
        description="Expert lake dredging services in Fielding. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, fielding lake dredging, lake dredging fielding"
        canonical="https://utahwatergardens.com/lake-dredging-fielding"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Fielding",
          "description": "Professional lake dredging services in Fielding",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Fielding"
        subtitle="Professional pond services for Lake Dredging Services in Fielding and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Fielding"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Fielding</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fielding Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fielding Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fielding Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fielding Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingFieldingPage;