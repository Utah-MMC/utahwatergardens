...
const Pond-cleaningHazeltonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Hazelton | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Hazelton. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, hazelton pond cleaning, pond cleaning hazelton"
        canonical="https://utahwatergardens.com/pond-cleaning-hazelton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Hazelton",
          "description": "Professional pond cleaning services in Hazelton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Hazelton"
        subtitle="Professional pond services for Pond Cleaning Services in Hazelton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Hazelton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Hazelton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hazelton Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hazelton Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hazelton Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hazelton Customers Say About Our Pond Cleaning</h2>
