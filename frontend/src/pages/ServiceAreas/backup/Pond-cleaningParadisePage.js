...
const Pond-cleaningParadisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Paradise | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Paradise. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, paradise pond cleaning, pond cleaning paradise"
        canonical="https://utahwatergardens.com/pond-cleaning-paradise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Paradise",
          "description": "Professional pond cleaning services in Paradise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Paradise"
        subtitle="Professional pond services for Pond Cleaning Services in Paradise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Paradise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Paradise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paradise Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paradise Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paradise Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paradise Customers Say About Our Pond Cleaning</h2>
