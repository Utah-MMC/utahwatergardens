...
const Lake-dredgingDeltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Delta | Professional Lake Dredging Services"
        description="Expert lake dredging services in Delta. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, delta lake dredging, lake dredging delta"
        canonical="https://utahwatergardens.com/lake-dredging-delta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Delta",
          "description": "Professional lake dredging services in Delta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Delta"
        subtitle="Professional pond services for Lake Dredging Services in Delta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Delta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Delta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Delta Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Delta Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Delta Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Delta Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingDeltaPage;