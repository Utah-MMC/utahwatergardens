...
const Pond-dredgingBakerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Baker | Professional Pond Dredging Services"
        description="Expert pond dredging services in Baker. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, baker pond dredging, pond dredging baker"
        canonical="https://utahwatergardens.com/pond-dredging-baker"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Baker",
          "description": "Professional pond dredging services in Baker",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Baker"
        subtitle="Professional pond services for Pond Dredging Services in Baker and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Baker"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Baker</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Baker Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Baker Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Baker Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Baker Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBakerPage;