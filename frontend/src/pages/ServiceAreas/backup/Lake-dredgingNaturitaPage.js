...
const Lake-dredgingNaturitaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Naturita | Professional Lake Dredging Services"
        description="Expert lake dredging services in Naturita. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, naturita lake dredging, lake dredging naturita"
        canonical="https://utahwatergardens.com/lake-dredging-naturita"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Naturita",
          "description": "Professional lake dredging services in Naturita",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Naturita"
        subtitle="Professional pond services for Lake Dredging Services in Naturita and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Naturita"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Naturita</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Naturita Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Naturita Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Naturita Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Naturita Customers Say About Our Lake Dredging</h2>
