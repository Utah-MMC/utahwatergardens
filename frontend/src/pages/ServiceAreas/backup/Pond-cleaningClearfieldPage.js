...
const Pond-cleaningClearfieldPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Clearfield | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Clearfield. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, clearfield pond cleaning, pond cleaning clearfield"
        canonical="https://utahwatergardens.com/pond-cleaning-clearfield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Clearfield",
          "description": "Professional pond cleaning services in Clearfield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Clearfield"
        subtitle="Professional pond services for Pond Cleaning Services in Clearfield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Clearfield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Clearfield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clearfield Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clearfield Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clearfield Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clearfield Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningClearfieldPage;