...
const Pond-cleaningLibertyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Liberty | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Liberty. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, liberty pond cleaning, pond cleaning liberty"
        canonical="https://utahwatergardens.com/pond-cleaning-liberty"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Liberty",
          "description": "Professional pond cleaning services in Liberty",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Liberty"
        subtitle="Professional pond services for Pond Cleaning Services in Liberty and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Liberty"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Liberty</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Liberty Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Liberty Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Liberty Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Liberty Customers Say About Our Pond Cleaning</h2>
