...
const Pond-repairTremontonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Tremonton | Professional Pond Repair Services"
        description="Expert pond repair services in Tremonton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, tremonton pond repair, pond repair tremonton"
        canonical="https://utahwatergardens.com/pond-repair-tremonton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Tremonton",
          "description": "Professional pond repair services in Tremonton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Tremonton"
        subtitle="Professional pond services for Pond Repair Services in Tremonton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Tremonton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Tremonton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tremonton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tremonton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tremonton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tremonton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTremontonPage;