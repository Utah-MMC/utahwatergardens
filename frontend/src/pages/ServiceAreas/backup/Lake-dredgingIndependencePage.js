...
const Lake-dredgingIndependencePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Independence | Professional Lake Dredging Services"
        description="Expert lake dredging services in Independence. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, independence lake dredging, lake dredging independence"
        canonical="https://utahwatergardens.com/lake-dredging-independence"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Independence",
          "description": "Professional lake dredging services in Independence",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Independence"
        subtitle="Professional pond services for Lake Dredging Services in Independence and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Independence"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Independence</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Independence Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Independence Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Independence Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Independence Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingIndependencePage;