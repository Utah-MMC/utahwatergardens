...
const Lake-dredgingKnollsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Knolls | Professional Lake Dredging Services"
        description="Expert lake dredging services in Knolls. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, knolls lake dredging, lake dredging knolls"
        canonical="https://utahwatergardens.com/lake-dredging-knolls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Knolls",
          "description": "Professional lake dredging services in Knolls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Knolls"
        subtitle="Professional pond services for Lake Dredging Services in Knolls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Knolls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Knolls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Knolls Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Knolls Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Knolls Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Knolls Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingKnollsPage;