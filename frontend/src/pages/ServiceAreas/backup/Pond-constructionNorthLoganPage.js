...
const Pond-constructionNorthLoganPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction North Logan | Professional Pond Construction Services"
        description="Expert pond construction services in North Logan. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, north logan pond construction, pond construction north logan"
        canonical="https://utahwatergardens.com/pond-construction-north-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services North Logan",
          "description": "Professional pond construction services in North Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in North Logan"
        subtitle="Professional pond services for Pond Construction Services in North Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in North Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in North Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Logan Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Logan Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Logan Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Logan Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionNorthLoganPage;