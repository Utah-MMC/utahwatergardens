...
const Pond-repairBrianHeadPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Brian Head | Professional Pond Repair Services"
        description="Expert pond repair services in Brian Head. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, brian head pond repair, pond repair brian head"
        canonical="https://utahwatergardens.com/pond-repair-brian-head"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Brian Head",
          "description": "Professional pond repair services in Brian Head",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Brian Head"
        subtitle="Professional pond services for Pond Repair Services in Brian Head and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Brian Head"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Brian Head</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Brian Head Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Brian Head Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Brian Head Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Brian Head Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBrianHeadPage;