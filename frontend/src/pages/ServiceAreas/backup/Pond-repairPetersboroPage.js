...
const Pond-repairPetersboroPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Petersboro | Professional Pond Repair Services"
        description="Expert pond repair services in Petersboro. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, petersboro pond repair, pond repair petersboro"
        canonical="https://utahwatergardens.com/pond-repair-petersboro"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Petersboro",
          "description": "Professional pond repair services in Petersboro",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Petersboro"
        subtitle="Professional pond services for Pond Repair Services in Petersboro and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Petersboro"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Petersboro</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Petersboro Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Petersboro Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Petersboro Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Petersboro Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPetersboroPage;