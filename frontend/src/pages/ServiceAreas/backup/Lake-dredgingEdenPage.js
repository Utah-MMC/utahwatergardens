...
const Lake-dredgingEdenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Eden | Professional Lake Dredging Services"
        description="Expert lake dredging services in Eden. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, eden lake dredging, lake dredging eden"
        canonical="https://utahwatergardens.com/lake-dredging-eden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Eden",
          "description": "Professional lake dredging services in Eden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Eden"
        subtitle="Professional pond services for Lake Dredging Services in Eden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Eden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Eden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eden Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eden Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eden Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eden Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingEdenPage;