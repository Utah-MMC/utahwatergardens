...
const Pond-repairBothwellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Bothwell | Professional Pond Repair Services"
        description="Expert pond repair services in Bothwell. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, bothwell pond repair, pond repair bothwell"
        canonical="https://utahwatergardens.com/pond-repair-bothwell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Bothwell",
          "description": "Professional pond repair services in Bothwell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Bothwell"
        subtitle="Professional pond services for Pond Repair Services in Bothwell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Bothwell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Bothwell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bothwell Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bothwell Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bothwell Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bothwell Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBothwellPage;