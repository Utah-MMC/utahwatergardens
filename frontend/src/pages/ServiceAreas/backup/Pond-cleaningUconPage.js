...
const Pond-cleaningUconPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Ucon | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Ucon. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, ucon pond cleaning, pond cleaning ucon"
        canonical="https://utahwatergardens.com/pond-cleaning-ucon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Ucon",
          "description": "Professional pond cleaning services in Ucon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Ucon"
        subtitle="Professional pond services for Pond Cleaning Services in Ucon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Ucon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Ucon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ucon Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ucon Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ucon Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ucon Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningUconPage;