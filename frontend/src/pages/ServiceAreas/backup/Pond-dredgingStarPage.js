...
const Pond-dredgingStarPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Star | Professional Pond Dredging Services"
        description="Expert pond dredging services in Star. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, star pond dredging, pond dredging star"
        canonical="https://utahwatergardens.com/pond-dredging-star"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Star",
          "description": "Professional pond dredging services in Star",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Star"
        subtitle="Professional pond services for Pond Dredging Services in Star and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Star"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Star</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Star Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Star Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Star Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Star Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingStarPage;