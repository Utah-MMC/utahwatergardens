...
const Pond-dredgingCrystalPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Crystal | Professional Pond Dredging Services"
        description="Expert pond dredging services in Crystal. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, crystal pond dredging, pond dredging crystal"
        canonical="https://utahwatergardens.com/pond-dredging-crystal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Crystal",
          "description": "Professional pond dredging services in Crystal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Crystal"
        subtitle="Professional pond services for Pond Dredging Services in Crystal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Crystal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Crystal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crystal Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crystal Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crystal Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crystal Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCrystalPage;