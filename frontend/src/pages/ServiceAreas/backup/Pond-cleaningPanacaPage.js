...
const Pond-cleaningPanacaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Panaca | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Panaca. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, panaca pond cleaning, pond cleaning panaca"
        canonical="https://utahwatergardens.com/pond-cleaning-panaca"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Panaca",
          "description": "Professional pond cleaning services in Panaca",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Panaca"
        subtitle="Professional pond services for Pond Cleaning Services in Panaca and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Panaca"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Panaca</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Panaca Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Panaca Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Panaca Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Panaca Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningPanacaPage;