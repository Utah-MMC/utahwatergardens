...
const Lake-dredgingMendonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mendon | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mendon. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mendon lake dredging, lake dredging mendon"
        canonical="https://utahwatergardens.com/lake-dredging-mendon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mendon",
          "description": "Professional lake dredging services in Mendon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mendon"
        subtitle="Professional pond services for Lake Dredging Services in Mendon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mendon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mendon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mendon Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mendon Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mendon Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mendon Customers Say About Our Lake Dredging</h2>
