...
const Pond-repairPeoriaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Peoria | Professional Pond Repair Services"
        description="Expert pond repair services in Peoria. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, peoria pond repair, pond repair peoria"
        canonical="https://utahwatergardens.com/pond-repair-peoria"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Peoria",
          "description": "Professional pond repair services in Peoria",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Peoria"
        subtitle="Professional pond services for Pond Repair Services in Peoria and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Peoria"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Peoria</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Peoria Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Peoria Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Peoria Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Peoria Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPeoriaPage;