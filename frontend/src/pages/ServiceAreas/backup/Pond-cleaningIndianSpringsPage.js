...
const Pond-cleaningIndianSpringsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Indian Springs | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Indian Springs. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, indian springs pond cleaning, pond cleaning indian springs"
        canonical="https://utahwatergardens.com/pond-cleaning-indian-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Indian Springs",
          "description": "Professional pond cleaning services in Indian Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Indian Springs"
        subtitle="Professional pond services for Pond Cleaning Services in Indian Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Indian Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Indian Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Indian Springs Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Indian Springs Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Indian Springs Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Indian Springs Customers Say About Our Pond Cleaning</h2>
