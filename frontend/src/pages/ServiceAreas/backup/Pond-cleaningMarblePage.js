...
const Pond-cleaningMarblePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Marble | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Marble. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, marble pond cleaning, pond cleaning marble"
        canonical="https://utahwatergardens.com/pond-cleaning-marble"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Marble",
          "description": "Professional pond cleaning services in Marble",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Marble"
        subtitle="Professional pond services for Pond Cleaning Services in Marble and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Marble"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Marble</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marble Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marble Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marble Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marble Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMarblePage;