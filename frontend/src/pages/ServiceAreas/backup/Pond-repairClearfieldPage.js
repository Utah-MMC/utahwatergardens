...
const Pond-repairClearfieldPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Clearfield | Professional Pond Repair Services"
        description="Expert pond repair services in Clearfield. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, clearfield pond repair, pond repair clearfield"
        canonical="https://utahwatergardens.com/pond-repair-clearfield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Clearfield",
          "description": "Professional pond repair services in Clearfield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Clearfield"
        subtitle="Professional pond services for Pond Repair Services in Clearfield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Clearfield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Clearfield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clearfield Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clearfield Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clearfield Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clearfield Customers Say About Our Pond Repair</h2>
...
export default Pond-repairClearfieldPage;