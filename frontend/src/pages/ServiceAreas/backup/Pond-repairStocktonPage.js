...
const Pond-repairStocktonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Stockton | Professional Pond Repair Services"
        description="Expert pond repair services in Stockton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, stockton pond repair, pond repair stockton"
        canonical="https://utahwatergardens.com/pond-repair-stockton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Stockton",
          "description": "Professional pond repair services in Stockton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Stockton"
        subtitle="Professional pond services for Pond Repair Services in Stockton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Stockton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Stockton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Stockton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Stockton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Stockton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Stockton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairStocktonPage;