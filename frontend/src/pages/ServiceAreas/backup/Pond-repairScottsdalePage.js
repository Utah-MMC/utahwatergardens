...
const Pond-repairScottsdalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Scottsdale | Professional Pond Repair Services"
        description="Expert pond repair services in Scottsdale. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, scottsdale pond repair, pond repair scottsdale"
        canonical="https://utahwatergardens.com/pond-repair-scottsdale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Scottsdale",
          "description": "Professional pond repair services in Scottsdale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Scottsdale"
        subtitle="Professional pond services for Pond Repair Services in Scottsdale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Scottsdale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Scottsdale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Scottsdale Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Scottsdale Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Scottsdale Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Scottsdale Customers Say About Our Pond Repair</h2>
...
export default Pond-repairScottsdalePage;