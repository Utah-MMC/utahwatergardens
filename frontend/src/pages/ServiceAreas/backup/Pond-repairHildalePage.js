...
const Pond-repairHildalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Hildale | Professional Pond Repair Services"
        description="Expert pond repair services in Hildale. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, hildale pond repair, pond repair hildale"
        canonical="https://utahwatergardens.com/pond-repair-hildale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Hildale",
          "description": "Professional pond repair services in Hildale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Hildale"
        subtitle="Professional pond services for Pond Repair Services in Hildale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Hildale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Hildale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hildale Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hildale Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hildale Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hildale Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHildalePage;