...
const Pond-repairMapletonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Mapleton | Professional Pond Repair Services"
        description="Expert pond repair services in Mapleton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, mapleton pond repair, pond repair mapleton"
        canonical="https://utahwatergardens.com/pond-repair-mapleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Mapleton",
          "description": "Professional pond repair services in Mapleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Mapleton"
        subtitle="Professional pond services for Pond Repair Services in Mapleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Mapleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Mapleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mapleton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mapleton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mapleton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mapleton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMapletonPage;