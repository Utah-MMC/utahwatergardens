...
const Pond-dredgingBluffdalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Bluffdale | Professional Pond Dredging Services"
        description="Expert pond dredging services in Bluffdale. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, bluffdale pond dredging, pond dredging bluffdale"
        canonical="https://utahwatergardens.com/pond-dredging-bluffdale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Bluffdale",
          "description": "Professional pond dredging services in Bluffdale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Bluffdale"
        subtitle="Professional pond services for Pond Dredging Services in Bluffdale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Bluffdale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Bluffdale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bluffdale Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bluffdale Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bluffdale Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bluffdale Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBluffdalePage;