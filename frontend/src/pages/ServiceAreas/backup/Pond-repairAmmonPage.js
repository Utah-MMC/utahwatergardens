...
const Pond-repairAmmonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Ammon | Professional Pond Repair Services"
        description="Expert pond repair services in Ammon. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, ammon pond repair, pond repair ammon"
        canonical="https://utahwatergardens.com/pond-repair-ammon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Ammon",
          "description": "Professional pond repair services in Ammon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Ammon"
        subtitle="Professional pond services for Pond Repair Services in Ammon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Ammon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Ammon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ammon Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ammon Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ammon Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ammon Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAmmonPage;