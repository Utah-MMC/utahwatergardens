...
const Pond-dredgingTooelePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Tooele | Professional Pond Dredging Services"
        description="Expert pond dredging services in Tooele. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, tooele pond dredging, pond dredging tooele"
        canonical="https://utahwatergardens.com/pond-dredging-tooele"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Tooele",
          "description": "Professional pond dredging services in Tooele",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Tooele"
        subtitle="Professional pond services for Pond Dredging Services in Tooele and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Tooele"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Tooele</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tooele Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tooele Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tooele Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tooele Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingTooelePage;