...
const Pond-dredgingEdenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Eden | Professional Pond Dredging Services"
        description="Expert pond dredging services in Eden. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, eden pond dredging, pond dredging eden"
        canonical="https://utahwatergardens.com/pond-dredging-eden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Eden",
          "description": "Professional pond dredging services in Eden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Eden"
        subtitle="Professional pond services for Pond Dredging Services in Eden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Eden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Eden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eden Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eden Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eden Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eden Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingEdenPage;