...
const Lake-dredgingPalmyraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Palmyra | Professional Lake Dredging Services"
        description="Expert lake dredging services in Palmyra. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, palmyra lake dredging, lake dredging palmyra"
        canonical="https://utahwatergardens.com/lake-dredging-palmyra"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Palmyra",
          "description": "Professional lake dredging services in Palmyra",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Palmyra"
        subtitle="Professional pond services for Lake Dredging Services in Palmyra and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Palmyra"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Palmyra</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Palmyra Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Palmyra Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Palmyra Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Palmyra Customers Say About Our Lake Dredging</h2>
