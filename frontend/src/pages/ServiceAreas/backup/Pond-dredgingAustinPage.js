...
const Pond-dredgingAustinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Austin | Professional Pond Dredging Services"
        description="Expert pond dredging services in Austin. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, austin pond dredging, pond dredging austin"
        canonical="https://utahwatergardens.com/pond-dredging-austin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Austin",
          "description": "Professional pond dredging services in Austin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Austin"
        subtitle="Professional pond services for Pond Dredging Services in Austin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Austin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Austin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Austin Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Austin Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Austin Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Austin Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAustinPage;