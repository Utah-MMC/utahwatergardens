...
const Pond-cleaningMountCarmelPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Mount Carmel | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Mount Carmel. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, mount carmel pond cleaning, pond cleaning mount carmel"
        canonical="https://utahwatergardens.com/pond-cleaning-mount-carmel"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Mount Carmel",
          "description": "Professional pond cleaning services in Mount Carmel",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Mount Carmel"
        subtitle="Professional pond services for Pond Cleaning Services in Mount Carmel and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Mount Carmel"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Mount Carmel</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mount Carmel Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mount Carmel Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mount Carmel Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mount Carmel Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMountCarmelPage;