...
const Pond-cleaningGunnisonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Gunnison | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Gunnison. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, gunnison pond cleaning, pond cleaning gunnison"
        canonical="https://utahwatergardens.com/pond-cleaning-gunnison"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Gunnison",
          "description": "Professional pond cleaning services in Gunnison",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Gunnison"
        subtitle="Professional pond services for Pond Cleaning Services in Gunnison and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Gunnison"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Gunnison</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gunnison Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gunnison Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gunnison Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gunnison Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningGunnisonPage;