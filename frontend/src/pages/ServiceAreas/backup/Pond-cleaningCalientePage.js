...
const Pond-cleaningCalientePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Caliente | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Caliente. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, caliente pond cleaning, pond cleaning caliente"
        canonical="https://utahwatergardens.com/pond-cleaning-caliente"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Caliente",
          "description": "Professional pond cleaning services in Caliente",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Caliente"
        subtitle="Professional pond services for Pond Cleaning Services in Caliente and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Caliente"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Caliente</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Caliente Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Caliente Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Caliente Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Caliente Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCalientePage;