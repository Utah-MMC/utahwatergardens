...
const Lake-dredgingVeyoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Veyo | Professional Lake Dredging Services"
        description="Expert lake dredging services in Veyo. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, veyo lake dredging, lake dredging veyo"
        canonical="https://utahwatergardens.com/lake-dredging-veyo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Veyo",
          "description": "Professional lake dredging services in Veyo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Veyo"
        subtitle="Professional pond services for Lake Dredging Services in Veyo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Veyo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Veyo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Veyo Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Veyo Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Veyo Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Veyo Customers Say About Our Lake Dredging</h2>
