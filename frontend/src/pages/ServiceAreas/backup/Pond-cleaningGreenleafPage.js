...
const Pond-cleaningGreenleafPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Greenleaf | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Greenleaf. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, greenleaf pond cleaning, pond cleaning greenleaf"
        canonical="https://utahwatergardens.com/pond-cleaning-greenleaf"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Greenleaf",
          "description": "Professional pond cleaning services in Greenleaf",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Greenleaf"
        subtitle="Professional pond services for Pond Cleaning Services in Greenleaf and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Greenleaf"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Greenleaf</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Greenleaf Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Greenleaf Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Greenleaf Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Greenleaf Customers Say About Our Pond Cleaning</h2>
