...
const Pond-constructionAltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Alta | Professional Pond Construction Services"
        description="Expert pond construction services in Alta. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, alta pond construction, pond construction alta"
        canonical="https://utahwatergardens.com/pond-construction-alta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Alta",
          "description": "Professional pond construction services in Alta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Alta"
        subtitle="Professional pond services for Pond Construction Services in Alta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Alta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Alta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alta Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alta Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alta Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alta Customers Say About Our Pond Construction</h2>
