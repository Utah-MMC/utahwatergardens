...
const Lake-dredgingLymanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lyman | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lyman. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lyman lake dredging, lake dredging lyman"
        canonical="https://utahwatergardens.com/lake-dredging-lyman"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lyman",
          "description": "Professional lake dredging services in Lyman",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lyman"
        subtitle="Professional pond services for Lake Dredging Services in Lyman and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lyman"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lyman</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lyman Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lyman Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lyman Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lyman Customers Say About Our Lake Dredging</h2>
