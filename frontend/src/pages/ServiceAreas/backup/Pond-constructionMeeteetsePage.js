...
const Pond-constructionMeeteetsePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Meeteetse | Professional Pond Construction Services"
        description="Expert pond construction services in Meeteetse. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, meeteetse pond construction, pond construction meeteetse"
        canonical="https://utahwatergardens.com/pond-construction-meeteetse"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Meeteetse",
          "description": "Professional pond construction services in Meeteetse",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Meeteetse"
        subtitle="Professional pond services for Pond Construction Services in Meeteetse and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Meeteetse"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Meeteetse</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Meeteetse Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Meeteetse Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Meeteetse Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Meeteetse Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionMeeteetsePage;