...
const Pond-cleaningSunnysidePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Sunnyside | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Sunnyside. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, sunnyside pond cleaning, pond cleaning sunnyside"
        canonical="https://utahwatergardens.com/pond-cleaning-sunnyside"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Sunnyside",
          "description": "Professional pond cleaning services in Sunnyside",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Sunnyside"
        subtitle="Professional pond services for Pond Cleaning Services in Sunnyside and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Sunnyside"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Sunnyside</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunnyside Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunnyside Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunnyside Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunnyside Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSunnysidePage;