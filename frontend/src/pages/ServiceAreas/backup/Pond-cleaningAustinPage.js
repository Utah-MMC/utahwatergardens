...
const Pond-cleaningAustinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Austin | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Austin. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, austin pond cleaning, pond cleaning austin"
        canonical="https://utahwatergardens.com/pond-cleaning-austin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Austin",
          "description": "Professional pond cleaning services in Austin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Austin"
        subtitle="Professional pond services for Pond Cleaning Services in Austin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Austin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Austin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Austin Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Austin Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Austin Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Austin Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAustinPage;