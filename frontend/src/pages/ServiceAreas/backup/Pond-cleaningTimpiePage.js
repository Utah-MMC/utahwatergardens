...
const Pond-cleaningTimpiePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Timpie | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Timpie. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, timpie pond cleaning, pond cleaning timpie"
        canonical="https://utahwatergardens.com/pond-cleaning-timpie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Timpie",
          "description": "Professional pond cleaning services in Timpie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Timpie"
        subtitle="Professional pond services for Pond Cleaning Services in Timpie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Timpie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Timpie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Timpie Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Timpie Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Timpie Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Timpie Customers Say About Our Pond Cleaning</h2>
