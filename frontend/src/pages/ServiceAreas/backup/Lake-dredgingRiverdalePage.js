...
const Lake-dredgingRiverdalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Riverdale | Professional Lake Dredging Services"
        description="Expert lake dredging services in Riverdale. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, riverdale lake dredging, lake dredging riverdale"
        canonical="https://utahwatergardens.com/lake-dredging-riverdale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Riverdale",
          "description": "Professional lake dredging services in Riverdale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Riverdale"
        subtitle="Professional pond services for Lake Dredging Services in Riverdale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Riverdale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Riverdale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Riverdale Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Riverdale Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Riverdale Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Riverdale Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingRiverdalePage;