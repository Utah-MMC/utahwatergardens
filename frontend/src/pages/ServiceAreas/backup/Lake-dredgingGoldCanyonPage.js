...
const Lake-dredgingGoldCanyonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Gold Canyon | Professional Lake Dredging Services"
        description="Expert lake dredging services in Gold Canyon. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, gold canyon lake dredging, lake dredging gold canyon"
        canonical="https://utahwatergardens.com/lake-dredging-gold-canyon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Gold Canyon",
          "description": "Professional lake dredging services in Gold Canyon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Gold Canyon"
        subtitle="Professional pond services for Lake Dredging Services in Gold Canyon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Gold Canyon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Gold Canyon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gold Canyon Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gold Canyon Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gold Canyon Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gold Canyon Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingGoldCanyonPage;