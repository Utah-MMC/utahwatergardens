...
const Pond-cleaningQueenCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Queen Creek | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Queen Creek. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, queen creek pond cleaning, pond cleaning queen creek"
        canonical="https://utahwatergardens.com/pond-cleaning-queen-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Queen Creek",
          "description": "Professional pond cleaning services in Queen Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Queen Creek"
        subtitle="Professional pond services for Pond Cleaning Services in Queen Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Queen Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Queen Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Queen Creek Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Queen Creek Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Queen Creek Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Queen Creek Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningQueenCreekPage;