...
const Pond-repairPahrumpPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Pahrump | Professional Pond Repair Services"
        description="Expert pond repair services in Pahrump. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, pahrump pond repair, pond repair pahrump"
        canonical="https://utahwatergardens.com/pond-repair-pahrump"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Pahrump",
          "description": "Professional pond repair services in Pahrump",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Pahrump"
        subtitle="Professional pond services for Pond Repair Services in Pahrump and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Pahrump"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Pahrump</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pahrump Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pahrump Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pahrump Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pahrump Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPahrumpPage;