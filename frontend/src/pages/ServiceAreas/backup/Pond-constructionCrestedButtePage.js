...
const Pond-constructionCrestedButtePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Crested Butte | Professional Pond Construction Services"
        description="Expert pond construction services in Crested Butte. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, crested butte pond construction, pond construction crested butte"
        canonical="https://utahwatergardens.com/pond-construction-crested-butte"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Crested Butte",
          "description": "Professional pond construction services in Crested Butte",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Crested Butte"
        subtitle="Professional pond services for Pond Construction Services in Crested Butte and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Crested Butte"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Crested Butte</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crested Butte Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crested Butte Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crested Butte Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crested Butte Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionCrestedButtePage;