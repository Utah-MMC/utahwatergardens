...
const Lake-dredgingSunnysidePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sunnyside | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sunnyside. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sunnyside lake dredging, lake dredging sunnyside"
        canonical="https://utahwatergardens.com/lake-dredging-sunnyside"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sunnyside",
          "description": "Professional lake dredging services in Sunnyside",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sunnyside"
        subtitle="Professional pond services for Lake Dredging Services in Sunnyside and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sunnyside"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sunnyside</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunnyside Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunnyside Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunnyside Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunnyside Customers Say About Our Lake Dredging</h2>
