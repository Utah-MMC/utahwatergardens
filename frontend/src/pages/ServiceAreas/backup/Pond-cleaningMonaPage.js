...
const Pond-cleaningMonaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Mona | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Mona. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, mona pond cleaning, pond cleaning mona"
        canonical="https://utahwatergardens.com/pond-cleaning-mona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Mona",
          "description": "Professional pond cleaning services in Mona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Mona"
        subtitle="Professional pond services for Pond Cleaning Services in Mona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Mona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Mona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mona Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mona Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mona Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mona Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMonaPage;