...
const Lake-dredgingJayEmPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Jay Em | Professional Lake Dredging Services"
        description="Expert lake dredging services in Jay Em. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, jay em lake dredging, lake dredging jay em"
        canonical="https://utahwatergardens.com/lake-dredging-jay-em"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Jay Em",
          "description": "Professional lake dredging services in Jay Em",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Jay Em"
        subtitle="Professional pond services for Lake Dredging Services in Jay Em and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Jay Em"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Jay Em</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jay Em Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jay Em Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jay Em Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jay Em Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingJayEmPage;