...
const Lake-dredgingCordesLakesPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Cordes Lakes | Professional Lake Dredging Services"
        description="Expert lake dredging services in Cordes Lakes. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, cordes lakes lake dredging, lake dredging cordes lakes"
        canonical="https://utahwatergardens.com/lake-dredging-cordes-lakes"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Cordes Lakes",
          "description": "Professional lake dredging services in Cordes Lakes",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Cordes Lakes"
        subtitle="Professional pond services for Lake Dredging Services in Cordes Lakes and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Cordes Lakes"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Cordes Lakes</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cordes Lakes Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cordes Lakes Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cordes Lakes Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cordes Lakes Customers Say About Our Lake Dredging</h2>
