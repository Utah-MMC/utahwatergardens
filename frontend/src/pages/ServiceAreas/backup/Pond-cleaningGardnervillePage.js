...
const Pond-cleaningGardnervillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Gardnerville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Gardnerville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, gardnerville pond cleaning, pond cleaning gardnerville"
        canonical="https://utahwatergardens.com/pond-cleaning-gardnerville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Gardnerville",
          "description": "Professional pond cleaning services in Gardnerville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Gardnerville"
        subtitle="Professional pond services for Pond Cleaning Services in Gardnerville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Gardnerville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Gardnerville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gardnerville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gardnerville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gardnerville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gardnerville Customers Say About Our Pond Cleaning</h2>
