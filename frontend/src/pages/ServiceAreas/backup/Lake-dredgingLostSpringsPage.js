...
const Lake-dredgingLostSpringsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lost Springs | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lost Springs. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lost springs lake dredging, lake dredging lost springs"
        canonical="https://utahwatergardens.com/lake-dredging-lost-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lost Springs",
          "description": "Professional lake dredging services in Lost Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lost Springs"
        subtitle="Professional pond services for Lake Dredging Services in Lost Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lost Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lost Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lost Springs Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lost Springs Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lost Springs Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lost Springs Customers Say About Our Lake Dredging</h2>
