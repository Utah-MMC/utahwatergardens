...
const Pond-repairDeerMountainPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Deer Mountain | Professional Pond Repair Services"
        description="Expert pond repair services in Deer Mountain. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, deer mountain pond repair, pond repair deer mountain"
        canonical="https://utahwatergardens.com/pond-repair-deer-mountain"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Deer Mountain",
          "description": "Professional pond repair services in Deer Mountain",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Deer Mountain"
        subtitle="Professional pond services for Pond Repair Services in Deer Mountain and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Deer Mountain"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Deer Mountain</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Deer Mountain Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Deer Mountain Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Deer Mountain Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Deer Mountain Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDeerMountainPage;