...
const Pond-dredgingBigPineyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Big Piney | Professional Pond Dredging Services"
        description="Expert pond dredging services in Big Piney. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, big piney pond dredging, pond dredging big piney"
        canonical="https://utahwatergardens.com/pond-dredging-big-piney"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Big Piney",
          "description": "Professional pond dredging services in Big Piney",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Big Piney"
        subtitle="Professional pond services for Pond Dredging Services in Big Piney and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Big Piney"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Big Piney</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Big Piney Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Big Piney Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Big Piney Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Big Piney Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBigPineyPage;