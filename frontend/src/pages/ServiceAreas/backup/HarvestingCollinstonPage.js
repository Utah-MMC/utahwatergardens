...
const HarvestingCollinstonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Collinston | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Collinston. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, collinston aquatic plant harvesting, aquatic plant harvesting collinston"
        canonical="https://utahwatergardens.com/harvesting-collinston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Collinston",
          "description": "Professional aquatic plant harvesting services in Collinston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Collinston"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Collinston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Collinston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Collinston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Collinston Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Collinston Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Collinston Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Collinston Customers Say About Our Aquatic Plant Harvesting</h2>
