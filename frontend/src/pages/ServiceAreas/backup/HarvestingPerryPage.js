...
const HarvestingPerryPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Perry | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Perry. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, perry aquatic plant harvesting, aquatic plant harvesting perry"
        canonical="https://utahwatergardens.com/harvesting-perry"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Perry",
          "description": "Professional aquatic plant harvesting services in Perry",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Perry"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Perry and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Perry"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Perry</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Perry Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Perry Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Perry Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Perry Customers Say About Our Aquatic Plant Harvesting</h2>
