...
const Pond-repairOntarioPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Ontario | Professional Pond Repair Services"
        description="Expert pond repair services in Ontario. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, ontario pond repair, pond repair ontario"
        canonical="https://utahwatergardens.com/pond-repair-ontario"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Ontario",
          "description": "Professional pond repair services in Ontario",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Ontario"
        subtitle="Professional pond services for Pond Repair Services in Ontario and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Ontario"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Ontario</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ontario Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ontario Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ontario Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ontario Customers Say About Our Pond Repair</h2>
...
export default Pond-repairOntarioPage;