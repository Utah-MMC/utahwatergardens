...
const Pond-repairBigPineyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Big Piney | Professional Pond Repair Services"
        description="Expert pond repair services in Big Piney. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, big piney pond repair, pond repair big piney"
        canonical="https://utahwatergardens.com/pond-repair-big-piney"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Big Piney",
          "description": "Professional pond repair services in Big Piney",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Big Piney"
        subtitle="Professional pond services for Pond Repair Services in Big Piney and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Big Piney"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Big Piney</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Big Piney Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Big Piney Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Big Piney Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Big Piney Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBigPineyPage;