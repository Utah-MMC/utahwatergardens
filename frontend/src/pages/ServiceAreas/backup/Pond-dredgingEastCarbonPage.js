...
const Pond-dredgingEastCarbonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging East Carbon | Professional Pond Dredging Services"
        description="Expert pond dredging services in East Carbon. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, east carbon pond dredging, pond dredging east carbon"
        canonical="https://utahwatergardens.com/pond-dredging-east-carbon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services East Carbon",
          "description": "Professional pond dredging services in East Carbon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in East Carbon"
        subtitle="Professional pond services for Pond Dredging Services in East Carbon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in East Carbon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in East Carbon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our East Carbon Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="East Carbon Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our East Carbon Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What East Carbon Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingEastCarbonPage;