...
const Pond-constructionMountainViewPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Mountain View | Professional Pond Construction Services"
        description="Expert pond construction services in Mountain View. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, mountain view pond construction, pond construction mountain view"
        canonical="https://utahwatergardens.com/pond-construction-mountain-view"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Mountain View",
          "description": "Professional pond construction services in Mountain View",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Mountain View"
        subtitle="Professional pond services for Pond Construction Services in Mountain View and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Mountain View"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Mountain View</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mountain View Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mountain View Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mountain View Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mountain View Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionMountainViewPage;