...
const Pond-repairTetoniaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Tetonia | Professional Pond Repair Services"
        description="Expert pond repair services in Tetonia. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, tetonia pond repair, pond repair tetonia"
        canonical="https://utahwatergardens.com/pond-repair-tetonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Tetonia",
          "description": "Professional pond repair services in Tetonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Tetonia"
        subtitle="Professional pond services for Pond Repair Services in Tetonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Tetonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Tetonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tetonia Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tetonia Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tetonia Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tetonia Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTetoniaPage;