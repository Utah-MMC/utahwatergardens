...
const Pond-repairBuhlPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Buhl | Professional Pond Repair Services"
        description="Expert pond repair services in Buhl. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, buhl pond repair, pond repair buhl"
        canonical="https://utahwatergardens.com/pond-repair-buhl"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Buhl",
          "description": "Professional pond repair services in Buhl",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Buhl"
        subtitle="Professional pond services for Pond Repair Services in Buhl and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Buhl"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Buhl</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Buhl Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Buhl Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Buhl Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Buhl Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBuhlPage;