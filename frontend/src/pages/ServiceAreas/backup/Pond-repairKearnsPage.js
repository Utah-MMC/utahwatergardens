...
const Pond-repairKearnsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Kearns | Professional Pond Repair Services"
        description="Expert pond repair services in Kearns. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, kearns pond repair, pond repair kearns"
        canonical="https://utahwatergardens.com/pond-repair-kearns"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Kearns",
          "description": "Professional pond repair services in Kearns",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Kearns"
        subtitle="Professional pond services for Pond Repair Services in Kearns and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Kearns"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Kearns</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kearns Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kearns Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kearns Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kearns Customers Say About Our Pond Repair</h2>
...
export default Pond-repairKearnsPage;