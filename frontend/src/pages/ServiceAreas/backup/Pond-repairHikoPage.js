...
const Pond-repairHikoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Hiko | Professional Pond Repair Services"
        description="Expert pond repair services in Hiko. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, hiko pond repair, pond repair hiko"
        canonical="https://utahwatergardens.com/pond-repair-hiko"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Hiko",
          "description": "Professional pond repair services in Hiko",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Hiko"
        subtitle="Professional pond services for Pond Repair Services in Hiko and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Hiko"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Hiko</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hiko Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hiko Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hiko Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hiko Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHikoPage;