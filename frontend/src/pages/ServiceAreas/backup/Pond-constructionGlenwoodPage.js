...
const Pond-constructionGlenwoodPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Glenwood | Professional Pond Construction Services"
        description="Expert pond construction services in Glenwood. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, glenwood pond construction, pond construction glenwood"
        canonical="https://utahwatergardens.com/pond-construction-glenwood"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Glenwood",
          "description": "Professional pond construction services in Glenwood",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Glenwood"
        subtitle="Professional pond services for Pond Construction Services in Glenwood and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Glenwood"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Glenwood</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glenwood Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glenwood Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glenwood Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glenwood Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionGlenwoodPage;