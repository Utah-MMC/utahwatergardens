...
const Lake-dredgingAlbinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Albin | Professional Lake Dredging Services"
        description="Expert lake dredging services in Albin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, albin lake dredging, lake dredging albin"
        canonical="https://utahwatergardens.com/lake-dredging-albin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Albin",
          "description": "Professional lake dredging services in Albin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Albin"
        subtitle="Professional pond services for Lake Dredging Services in Albin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Albin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Albin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Albin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Albin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Albin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Albin Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAlbinPage;