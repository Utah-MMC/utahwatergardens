...
const Pond-cleaningLindonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lindon | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lindon. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lindon pond cleaning, pond cleaning lindon"
        canonical="https://utahwatergardens.com/pond-cleaning-lindon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lindon",
          "description": "Professional pond cleaning services in Lindon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lindon"
        subtitle="Professional pond services for Pond Cleaning Services in Lindon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lindon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lindon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lindon Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lindon Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lindon Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lindon Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLindonPage;