...
const Pond-dredgingNorthLoganPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging North Logan | Professional Pond Dredging Services"
        description="Expert pond dredging services in North Logan. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, north logan pond dredging, pond dredging north logan"
        canonical="https://utahwatergardens.com/pond-dredging-north-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services North Logan",
          "description": "Professional pond dredging services in North Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in North Logan"
        subtitle="Professional pond services for Pond Dredging Services in North Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in North Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in North Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Logan Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Logan Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Logan Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Logan Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNorthLoganPage;