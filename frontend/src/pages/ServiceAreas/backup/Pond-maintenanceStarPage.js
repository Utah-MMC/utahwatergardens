...
const Pond-maintenanceStarPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Star | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Star. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, star pond maintenance, pond maintenance star"
        canonical="https://utahwatergardens.com/pond-maintenance-star"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Star",
          "description": "Professional pond maintenance services in Star",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Star"
        subtitle="Professional pond services for Pond Maintenance Services in Star and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Star"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Star</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Star Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Star Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Star Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Star Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceStarPage;