...
const Water-feature-designElkRidgePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Elk Ridge | Professional Water Feature Design Services"
        description="Expert water feature design services in Elk Ridge. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, elk ridge water feature design, water feature design elk ridge"
        canonical="https://utahwatergardens.com/water-feature-design-elk-ridge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Elk Ridge",
          "description": "Professional water feature design services in Elk Ridge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Elk Ridge"
        subtitle="Professional pond services for Water Feature Design Services in Elk Ridge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Elk Ridge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Elk Ridge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elk Ridge Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elk Ridge Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elk Ridge Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elk Ridge Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designElkRidgePage;