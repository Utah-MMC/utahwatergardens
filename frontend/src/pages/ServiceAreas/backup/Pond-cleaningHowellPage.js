...
const Pond-cleaningHowellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Howell | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Howell. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, howell pond cleaning, pond cleaning howell"
        canonical="https://utahwatergardens.com/pond-cleaning-howell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Howell",
          "description": "Professional pond cleaning services in Howell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Howell"
        subtitle="Professional pond services for Pond Cleaning Services in Howell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Howell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Howell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Howell Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Howell Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Howell Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Howell Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningHowellPage;