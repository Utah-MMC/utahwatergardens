...
const Pond-repairOrdervillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Orderville | Professional Pond Repair Services"
        description="Expert pond repair services in Orderville. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, orderville pond repair, pond repair orderville"
        canonical="https://utahwatergardens.com/pond-repair-orderville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Orderville",
          "description": "Professional pond repair services in Orderville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Orderville"
        subtitle="Professional pond services for Pond Repair Services in Orderville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Orderville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Orderville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Orderville Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Orderville Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Orderville Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Orderville Customers Say About Our Pond Repair</h2>
...
export default Pond-repairOrdervillePage;