...
const Lake-dredgingDeweyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Dewey | Professional Lake Dredging Services"
        description="Expert lake dredging services in Dewey. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, dewey lake dredging, lake dredging dewey"
        canonical="https://utahwatergardens.com/lake-dredging-dewey"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Dewey",
          "description": "Professional lake dredging services in Dewey",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Dewey"
        subtitle="Professional pond services for Lake Dredging Services in Dewey and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Dewey"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Dewey</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dewey Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dewey Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dewey Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dewey Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingDeweyPage;