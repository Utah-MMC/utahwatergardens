...
const Pond-dredgingCollinstonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Collinston | Professional Pond Dredging Services"
        description="Expert pond dredging services in Collinston. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, collinston pond dredging, pond dredging collinston"
        canonical="https://utahwatergardens.com/pond-dredging-collinston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Collinston",
          "description": "Professional pond dredging services in Collinston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Collinston"
        subtitle="Professional pond services for Pond Dredging Services in Collinston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Collinston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Collinston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Collinston Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Collinston Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Collinston Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Collinston Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCollinstonPage;