...
const Pond-dredgingAltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Alta | Professional Pond Dredging Services"
        description="Expert pond dredging services in Alta. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, alta pond dredging, pond dredging alta"
        canonical="https://utahwatergardens.com/pond-dredging-alta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Alta",
          "description": "Professional pond dredging services in Alta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Alta"
        subtitle="Professional pond services for Pond Dredging Services in Alta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Alta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Alta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alta Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alta Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alta Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alta Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAltaPage;