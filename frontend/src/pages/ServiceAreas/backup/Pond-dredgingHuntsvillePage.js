...
const Pond-dredgingHuntsvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Huntsville | Professional Pond Dredging Services"
        description="Expert pond dredging services in Huntsville. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, huntsville pond dredging, pond dredging huntsville"
        canonical="https://utahwatergardens.com/pond-dredging-huntsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Huntsville",
          "description": "Professional pond dredging services in Huntsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Huntsville"
        subtitle="Professional pond services for Pond Dredging Services in Huntsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Huntsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Huntsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntsville Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntsville Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntsville Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntsville Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHuntsvillePage;