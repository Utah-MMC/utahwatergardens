...
const Pond-dredgingClearfieldPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Clearfield | Professional Pond Dredging Services"
        description="Expert pond dredging services in Clearfield. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, clearfield pond dredging, pond dredging clearfield"
        canonical="https://utahwatergardens.com/pond-dredging-clearfield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Clearfield",
          "description": "Professional pond dredging services in Clearfield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Clearfield"
        subtitle="Professional pond services for Pond Dredging Services in Clearfield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Clearfield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Clearfield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clearfield Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clearfield Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clearfield Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clearfield Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingClearfieldPage;