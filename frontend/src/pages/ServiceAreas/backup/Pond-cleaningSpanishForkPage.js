...
const Pond-cleaningSpanishForkPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Spanish Fork | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Spanish Fork. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, spanish fork pond cleaning, pond cleaning spanish fork"
        canonical="https://utahwatergardens.com/pond-cleaning-spanish-fork"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Spanish Fork",
          "description": "Professional pond cleaning services in Spanish Fork",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Spanish Fork"
        subtitle="Professional pond services for Pond Cleaning Services in Spanish Fork and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Spanish Fork"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Spanish Fork</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spanish Fork Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spanish Fork Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spanish Fork Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spanish Fork Customers Say About Our Pond Cleaning</h2>
