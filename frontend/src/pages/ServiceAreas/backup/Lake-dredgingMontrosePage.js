...
const Lake-dredgingMontrosePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Montrose | Professional Lake Dredging Services"
        description="Expert lake dredging services in Montrose. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, montrose lake dredging, lake dredging montrose"
        canonical="https://utahwatergardens.com/lake-dredging-montrose"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Montrose",
          "description": "Professional lake dredging services in Montrose",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Montrose"
        subtitle="Professional pond services for Lake Dredging Services in Montrose and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Montrose"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Montrose</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Montrose Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Montrose Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Montrose Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Montrose Customers Say About Our Lake Dredging</h2>
