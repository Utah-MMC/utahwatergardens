...
const Pond-repairVenicePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Venice | Professional Pond Repair Services"
        description="Expert pond repair services in Venice. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, venice pond repair, pond repair venice"
        canonical="https://utahwatergardens.com/pond-repair-venice"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Venice",
          "description": "Professional pond repair services in Venice",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Venice"
        subtitle="Professional pond services for Pond Repair Services in Venice and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Venice"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Venice</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Venice Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Venice Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Venice Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Venice Customers Say About Our Pond Repair</h2>
...
export default Pond-repairVenicePage;