...
const Pond-dredgingWoodsCrossPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Woods Cross | Professional Pond Dredging Services"
        description="Expert pond dredging services in Woods Cross. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, woods cross pond dredging, pond dredging woods cross"
        canonical="https://utahwatergardens.com/pond-dredging-woods-cross"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Woods Cross",
          "description": "Professional pond dredging services in Woods Cross",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Woods Cross"
        subtitle="Professional pond services for Pond Dredging Services in Woods Cross and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Woods Cross"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Woods Cross</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Woods Cross Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Woods Cross Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Woods Cross Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Woods Cross Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWoodsCrossPage;