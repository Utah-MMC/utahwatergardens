...
const Pond-repairSummitParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Summit Park | Professional Pond Repair Services"
        description="Expert pond repair services in Summit Park. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, summit park pond repair, pond repair summit park"
        canonical="https://utahwatergardens.com/pond-repair-summit-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Summit Park",
          "description": "Professional pond repair services in Summit Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Summit Park"
        subtitle="Professional pond services for Pond Repair Services in Summit Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Summit Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Summit Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Summit Park Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Summit Park Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Summit Park Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Summit Park Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSummitParkPage;