...
const Pond-cleaningPlymouthPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Plymouth | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Plymouth. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, plymouth pond cleaning, pond cleaning plymouth"
        canonical="https://utahwatergardens.com/pond-cleaning-plymouth"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Plymouth",
          "description": "Professional pond cleaning services in Plymouth",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Plymouth"
        subtitle="Professional pond services for Pond Cleaning Services in Plymouth and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Plymouth"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Plymouth</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Plymouth Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Plymouth Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Plymouth Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Plymouth Customers Say About Our Pond Cleaning</h2>
