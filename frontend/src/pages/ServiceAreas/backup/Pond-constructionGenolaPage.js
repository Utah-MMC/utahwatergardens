...
const Pond-constructionGenolaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Genola | Professional Pond Construction Services"
        description="Expert pond construction services in Genola. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, genola pond construction, pond construction genola"
        canonical="https://utahwatergardens.com/pond-construction-genola"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Genola",
          "description": "Professional pond construction services in Genola",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Genola"
        subtitle="Professional pond services for Pond Construction Services in Genola and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Genola"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Genola</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Genola Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Genola Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Genola Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Genola Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionGenolaPage;