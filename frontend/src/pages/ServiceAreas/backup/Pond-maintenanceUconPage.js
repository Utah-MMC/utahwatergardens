...
const Pond-maintenanceUconPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Ucon | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Ucon. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, ucon pond maintenance, pond maintenance ucon"
        canonical="https://utahwatergardens.com/pond-maintenance-ucon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Ucon",
          "description": "Professional pond maintenance services in Ucon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Ucon"
        subtitle="Professional pond services for Pond Maintenance Services in Ucon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Ucon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Ucon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ucon Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ucon Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ucon Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ucon Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceUconPage;