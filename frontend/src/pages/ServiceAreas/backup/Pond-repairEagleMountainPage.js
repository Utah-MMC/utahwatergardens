...
const Pond-repairEagleMountainPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Eagle Mountain | Professional Pond Repair Services"
        description="Expert pond repair services in Eagle Mountain. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, eagle mountain pond repair, pond repair eagle mountain"
        canonical="https://utahwatergardens.com/pond-repair-eagle-mountain"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Eagle Mountain",
          "description": "Professional pond repair services in Eagle Mountain",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Eagle Mountain"
        subtitle="Professional pond services for Pond Repair Services in Eagle Mountain and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Eagle Mountain"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Eagle Mountain</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eagle Mountain Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eagle Mountain Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eagle Mountain Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eagle Mountain Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEagleMountainPage;