...
const Pond-cleaningPowellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Powell | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Powell. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, powell pond cleaning, pond cleaning powell"
        canonical="https://utahwatergardens.com/pond-cleaning-powell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Powell",
          "description": "Professional pond cleaning services in Powell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Powell"
        subtitle="Professional pond services for Pond Cleaning Services in Powell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Powell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Powell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Powell Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Powell Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Powell Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Powell Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningPowellPage;