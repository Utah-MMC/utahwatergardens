...
const Pond-repairGlendalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Glendale | Professional Pond Repair Services"
        description="Expert pond repair services in Glendale. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, glendale pond repair, pond repair glendale"
        canonical="https://utahwatergardens.com/pond-repair-glendale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Glendale",
          "description": "Professional pond repair services in Glendale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Glendale"
        subtitle="Professional pond services for Pond Repair Services in Glendale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Glendale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Glendale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glendale Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glendale Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glendale Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glendale Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGlendalePage;