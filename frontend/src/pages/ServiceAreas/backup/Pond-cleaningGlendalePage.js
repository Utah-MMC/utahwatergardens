...
const Pond-cleaningGlendalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Glendale | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Glendale. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, glendale pond cleaning, pond cleaning glendale"
        canonical="https://utahwatergardens.com/pond-cleaning-glendale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Glendale",
          "description": "Professional pond cleaning services in Glendale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Glendale"
        subtitle="Professional pond services for Pond Cleaning Services in Glendale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Glendale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Glendale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glendale Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glendale Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glendale Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glendale Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningGlendalePage;