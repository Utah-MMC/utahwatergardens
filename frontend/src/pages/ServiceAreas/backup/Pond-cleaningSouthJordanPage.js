...
const Pond-cleaningSouthJordanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning South Jordan | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in South Jordan. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, south jordan pond cleaning, pond cleaning south jordan"
        canonical="https://utahwatergardens.com/pond-cleaning-south-jordan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services South Jordan",
          "description": "Professional pond cleaning services in South Jordan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in South Jordan"
        subtitle="Professional pond services for Pond Cleaning Services in South Jordan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in South Jordan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in South Jordan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Jordan Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Jordan Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Jordan Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Jordan Customers Say About Our Pond Cleaning</h2>
