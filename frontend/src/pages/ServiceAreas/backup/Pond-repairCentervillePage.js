...
const Pond-repairCentervillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Centerville | Professional Pond Repair Services"
        description="Expert pond repair services in Centerville. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, centerville pond repair, pond repair centerville"
        canonical="https://utahwatergardens.com/pond-repair-centerville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Centerville",
          "description": "Professional pond repair services in Centerville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Centerville"
        subtitle="Professional pond services for Pond Repair Services in Centerville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Centerville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Centerville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Centerville Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Centerville Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Centerville Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Centerville Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCentervillePage;