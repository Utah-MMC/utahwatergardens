...
const Lake-dredgingLitchfieldParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Litchfield Park | Professional Lake Dredging Services"
        description="Expert lake dredging services in Litchfield Park. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, litchfield park lake dredging, lake dredging litchfield park"
        canonical="https://utahwatergardens.com/lake-dredging-litchfield-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Litchfield Park",
          "description": "Professional lake dredging services in Litchfield Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Litchfield Park"
        subtitle="Professional pond services for Lake Dredging Services in Litchfield Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Litchfield Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Litchfield Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Litchfield Park Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Litchfield Park Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Litchfield Park Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Litchfield Park Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingLitchfieldParkPage;