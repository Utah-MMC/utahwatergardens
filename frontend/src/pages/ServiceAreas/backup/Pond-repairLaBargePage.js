...
const Pond-repairLaBargePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair La Barge | Professional Pond Repair Services"
        description="Expert pond repair services in La Barge. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, la barge pond repair, pond repair la barge"
        canonical="https://utahwatergardens.com/pond-repair-la-barge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services La Barge",
          "description": "Professional pond repair services in La Barge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in La Barge"
        subtitle="Professional pond services for Pond Repair Services in La Barge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in La Barge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in La Barge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Barge Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Barge Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Barge Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Barge Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLaBargePage;