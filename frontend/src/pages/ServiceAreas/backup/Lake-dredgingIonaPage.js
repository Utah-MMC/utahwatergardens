...
const Lake-dredgingIonaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Iona | Professional Lake Dredging Services"
        description="Expert lake dredging services in Iona. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, iona lake dredging, lake dredging iona"
        canonical="https://utahwatergardens.com/lake-dredging-iona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Iona",
          "description": "Professional lake dredging services in Iona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Iona"
        subtitle="Professional pond services for Lake Dredging Services in Iona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Iona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Iona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Iona Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Iona Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Iona Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Iona Customers Say About Our Lake Dredging</h2>
