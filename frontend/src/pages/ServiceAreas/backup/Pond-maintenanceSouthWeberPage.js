...
const Pond-maintenanceSouthWeberPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance South Weber | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in South Weber. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, south weber pond maintenance, pond maintenance south weber"
        canonical="https://utahwatergardens.com/pond-maintenance-south-weber"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services South Weber",
          "description": "Professional pond maintenance services in South Weber",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in South Weber"
        subtitle="Professional pond services for Pond Maintenance Services in South Weber and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in South Weber"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in South Weber</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Weber Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Weber Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Weber Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Weber Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSouthWeberPage;