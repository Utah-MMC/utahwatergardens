...
const HarvestingHyrumPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Hyrum | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Hyrum. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, hyrum aquatic plant harvesting, aquatic plant harvesting hyrum"
        canonical="https://utahwatergardens.com/harvesting-hyrum"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Hyrum",
          "description": "Professional aquatic plant harvesting services in Hyrum",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Hyrum"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Hyrum and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Hyrum"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Hyrum</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hyrum Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hyrum Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hyrum Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hyrum Customers Say About Our Aquatic Plant Harvesting</h2>
