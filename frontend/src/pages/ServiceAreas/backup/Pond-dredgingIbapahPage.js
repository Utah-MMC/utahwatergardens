...
const Pond-dredgingIbapahPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Ibapah | Professional Pond Dredging Services"
        description="Expert pond dredging services in Ibapah. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, ibapah pond dredging, pond dredging ibapah"
        canonical="https://utahwatergardens.com/pond-dredging-ibapah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Ibapah",
          "description": "Professional pond dredging services in Ibapah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Ibapah"
        subtitle="Professional pond services for Pond Dredging Services in Ibapah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Ibapah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Ibapah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ibapah Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ibapah Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ibapah Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ibapah Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingIbapahPage;