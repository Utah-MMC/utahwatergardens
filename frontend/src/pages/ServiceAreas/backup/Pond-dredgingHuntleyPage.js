...
const Pond-dredgingHuntleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Huntley | Professional Pond Dredging Services"
        description="Expert pond dredging services in Huntley. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, huntley pond dredging, pond dredging huntley"
        canonical="https://utahwatergardens.com/pond-dredging-huntley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Huntley",
          "description": "Professional pond dredging services in Huntley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Huntley"
        subtitle="Professional pond services for Pond Dredging Services in Huntley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Huntley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Huntley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntley Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntley Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntley Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntley Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHuntleyPage;