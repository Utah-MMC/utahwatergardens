...
const Pond-dredgingEmeryPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Emery | Professional Pond Dredging Services"
        description="Expert pond dredging services in Emery. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, emery pond dredging, pond dredging emery"
        canonical="https://utahwatergardens.com/pond-dredging-emery"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Emery",
          "description": "Professional pond dredging services in Emery",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Emery"
        subtitle="Professional pond services for Pond Dredging Services in Emery and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Emery"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Emery</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Emery Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Emery Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Emery Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Emery Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingEmeryPage;