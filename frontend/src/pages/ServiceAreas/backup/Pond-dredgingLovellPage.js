...
const Pond-dredgingLovellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lovell | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lovell. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lovell pond dredging, pond dredging lovell"
        canonical="https://utahwatergardens.com/pond-dredging-lovell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lovell",
          "description": "Professional pond dredging services in Lovell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lovell"
        subtitle="Professional pond services for Pond Dredging Services in Lovell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lovell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lovell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lovell Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lovell Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lovell Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lovell Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLovellPage;