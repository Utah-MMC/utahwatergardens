...
const Pond-constructionGreenRiverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Green River | Professional Pond Construction Services"
        description="Expert pond construction services in Green River. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, green river pond construction, pond construction green river"
        canonical="https://utahwatergardens.com/pond-construction-green-river"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Green River",
          "description": "Professional pond construction services in Green River",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Green River"
        subtitle="Professional pond services for Pond Construction Services in Green River and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Green River"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Green River</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Green River Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Green River Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Green River Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Green River Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionGreenRiverPage;