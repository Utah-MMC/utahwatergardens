...
const Lake-dredgingBenjaminPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Benjamin | Professional Lake Dredging Services"
        description="Expert lake dredging services in Benjamin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, benjamin lake dredging, lake dredging benjamin"
        canonical="https://utahwatergardens.com/lake-dredging-benjamin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Benjamin",
          "description": "Professional lake dredging services in Benjamin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Benjamin"
        subtitle="Professional pond services for Lake Dredging Services in Benjamin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Benjamin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Benjamin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Benjamin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Benjamin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Benjamin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Benjamin Customers Say About Our Lake Dredging</h2>
