...
const Pond-maintenanceHuntingtonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Huntington | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Huntington. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, huntington pond maintenance, pond maintenance huntington"
        canonical="https://utahwatergardens.com/pond-maintenance-huntington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Huntington",
          "description": "Professional pond maintenance services in Huntington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Huntington"
        subtitle="Professional pond services for Pond Maintenance Services in Huntington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Huntington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Huntington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntington Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntington Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntington Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntington Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceHuntingtonPage;