...
const Pond-dredgingKellyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Kelly | Professional Pond Dredging Services"
        description="Expert pond dredging services in Kelly. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, kelly pond dredging, pond dredging kelly"
        canonical="https://utahwatergardens.com/pond-dredging-kelly"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Kelly",
          "description": "Professional pond dredging services in Kelly",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Kelly"
        subtitle="Professional pond services for Pond Dredging Services in Kelly and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Kelly"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Kelly</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kelly Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kelly Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kelly Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kelly Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingKellyPage;