...
const Pond-dredgingPeoriaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Peoria | Professional Pond Dredging Services"
        description="Expert pond dredging services in Peoria. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, peoria pond dredging, pond dredging peoria"
        canonical="https://utahwatergardens.com/pond-dredging-peoria"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Peoria",
          "description": "Professional pond dredging services in Peoria",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Peoria"
        subtitle="Professional pond services for Pond Dredging Services in Peoria and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Peoria"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Peoria</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Peoria Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Peoria Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Peoria Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Peoria Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPeoriaPage;