...
const Pond-cleaningEmmettPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Emmett | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Emmett. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, emmett pond cleaning, pond cleaning emmett"
        canonical="https://utahwatergardens.com/pond-cleaning-emmett"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Emmett",
          "description": "Professional pond cleaning services in Emmett",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Emmett"
        subtitle="Professional pond services for Pond Cleaning Services in Emmett and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Emmett"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Emmett</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Emmett Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Emmett Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Emmett Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Emmett Customers Say About Our Pond Cleaning</h2>
