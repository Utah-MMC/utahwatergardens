...
const Pond-cleaningFruitaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Fruita | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Fruita. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, fruita pond cleaning, pond cleaning fruita"
        canonical="https://utahwatergardens.com/pond-cleaning-fruita"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Fruita",
          "description": "Professional pond cleaning services in Fruita",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Fruita"
        subtitle="Professional pond services for Pond Cleaning Services in Fruita and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Fruita"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Fruita</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruita Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruita Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruita Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruita Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningFruitaPage;