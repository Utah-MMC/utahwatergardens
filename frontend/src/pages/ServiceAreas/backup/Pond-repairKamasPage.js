...
const Pond-repairKamasPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Kamas | Professional Pond Repair Services"
        description="Expert pond repair services in Kamas. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, kamas pond repair, pond repair kamas"
        canonical="https://utahwatergardens.com/pond-repair-kamas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Kamas",
          "description": "Professional pond repair services in Kamas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Kamas"
        subtitle="Professional pond services for Pond Repair Services in Kamas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Kamas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Kamas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kamas Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kamas Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kamas Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kamas Customers Say About Our Pond Repair</h2>
...
export default Pond-repairKamasPage;