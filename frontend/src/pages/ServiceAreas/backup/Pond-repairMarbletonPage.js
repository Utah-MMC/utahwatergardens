...
const Pond-repairMarbletonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Marbleton | Professional Pond Repair Services"
        description="Expert pond repair services in Marbleton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, marbleton pond repair, pond repair marbleton"
        canonical="https://utahwatergardens.com/pond-repair-marbleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Marbleton",
          "description": "Professional pond repair services in Marbleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Marbleton"
        subtitle="Professional pond services for Pond Repair Services in Marbleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Marbleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Marbleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marbleton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marbleton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marbleton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marbleton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMarbletonPage;