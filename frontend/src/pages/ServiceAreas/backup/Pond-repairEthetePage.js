...
const Pond-repairEthetePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Ethete | Professional Pond Repair Services"
        description="Expert pond repair services in Ethete. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, ethete pond repair, pond repair ethete"
        canonical="https://utahwatergardens.com/pond-repair-ethete"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Ethete",
          "description": "Professional pond repair services in Ethete",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Ethete"
        subtitle="Professional pond services for Pond Repair Services in Ethete and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Ethete"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Ethete</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ethete Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ethete Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ethete Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ethete Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEthetePage;