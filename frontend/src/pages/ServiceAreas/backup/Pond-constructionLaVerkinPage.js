...
const Pond-constructionLaVerkinPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction La Verkin | Professional Pond Construction Services"
        description="Expert pond construction services in La Verkin. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, la verkin pond construction, pond construction la verkin"
        canonical="https://utahwatergardens.com/pond-construction-la-verkin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services La Verkin",
          "description": "Professional pond construction services in La Verkin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in La Verkin"
        subtitle="Professional pond services for Pond Construction Services in La Verkin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in La Verkin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in La Verkin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Verkin Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Verkin Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Verkin Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Verkin Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionLaVerkinPage;