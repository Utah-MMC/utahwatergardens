...
const Pond-cleaningRiflePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Rifle | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Rifle. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, rifle pond cleaning, pond cleaning rifle"
        canonical="https://utahwatergardens.com/pond-cleaning-rifle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Rifle",
          "description": "Professional pond cleaning services in Rifle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Rifle"
        subtitle="Professional pond services for Pond Cleaning Services in Rifle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Rifle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Rifle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rifle Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rifle Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rifle Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rifle Customers Say About Our Pond Cleaning</h2>
