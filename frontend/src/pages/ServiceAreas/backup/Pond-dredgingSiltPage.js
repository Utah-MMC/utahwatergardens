...
const Pond-dredgingSiltPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Silt | Professional Pond Dredging Services"
        description="Expert pond dredging services in Silt. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, silt pond dredging, pond dredging silt"
        canonical="https://utahwatergardens.com/pond-dredging-silt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Silt",
          "description": "Professional pond dredging services in Silt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Silt"
        subtitle="Professional pond services for Pond Dredging Services in Silt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Silt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Silt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Silt Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Silt Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Silt Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Silt Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSiltPage;