...
const Lake-dredgingEnterprisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Enterprise | Professional Lake Dredging Services"
        description="Expert lake dredging services in Enterprise. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, enterprise lake dredging, lake dredging enterprise"
        canonical="https://utahwatergardens.com/lake-dredging-enterprise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Enterprise",
          "description": "Professional lake dredging services in Enterprise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Enterprise"
        subtitle="Professional pond services for Lake Dredging Services in Enterprise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Enterprise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Enterprise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Enterprise Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Enterprise Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Enterprise Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Enterprise Customers Say About Our Lake Dredging</h2>
