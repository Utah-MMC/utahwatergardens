...
const Lake-dredgingKeelinePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Keeline | Professional Lake Dredging Services"
        description="Expert lake dredging services in Keeline. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, keeline lake dredging, lake dredging keeline"
        canonical="https://utahwatergardens.com/lake-dredging-keeline"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Keeline",
          "description": "Professional lake dredging services in Keeline",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Keeline"
        subtitle="Professional pond services for Lake Dredging Services in Keeline and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Keeline"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Keeline</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Keeline Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Keeline Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Keeline Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Keeline Customers Say About Our Lake Dredging</h2>
