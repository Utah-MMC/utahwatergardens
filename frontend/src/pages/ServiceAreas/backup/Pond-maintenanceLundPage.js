...
const Pond-maintenanceLundPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Lund | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Lund. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, lund pond maintenance, pond maintenance lund"
        canonical="https://utahwatergardens.com/pond-maintenance-lund"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Lund",
          "description": "Professional pond maintenance services in Lund",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Lund"
        subtitle="Professional pond services for Pond Maintenance Services in Lund and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Lund"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Lund</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lund Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lund Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lund Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lund Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceLundPage;