...
const Lake-dredgingNibleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Nibley | Professional Lake Dredging Services"
        description="Expert lake dredging services in Nibley. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, nibley lake dredging, lake dredging nibley"
        canonical="https://utahwatergardens.com/lake-dredging-nibley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Nibley",
          "description": "Professional lake dredging services in Nibley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Nibley"
        subtitle="Professional pond services for Lake Dredging Services in Nibley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Nibley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Nibley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nibley Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nibley Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nibley Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nibley Customers Say About Our Lake Dredging</h2>
