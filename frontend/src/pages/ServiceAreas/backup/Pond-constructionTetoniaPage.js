...
const Pond-constructionTetoniaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Tetonia | Professional Pond Construction Services"
        description="Expert pond construction services in Tetonia. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, tetonia pond construction, pond construction tetonia"
        canonical="https://utahwatergardens.com/pond-construction-tetonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Tetonia",
          "description": "Professional pond construction services in Tetonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Tetonia"
        subtitle="Professional pond services for Pond Construction Services in Tetonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Tetonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Tetonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tetonia Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tetonia Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tetonia Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tetonia Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionTetoniaPage;