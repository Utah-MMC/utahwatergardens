...
const Pond-constructionLakeShorePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Lake Shore | Professional Pond Construction Services"
        description="Expert pond construction services in Lake Shore. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, lake shore pond construction, pond construction lake shore"
        canonical="https://utahwatergardens.com/pond-construction-lake-shore"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Lake Shore",
          "description": "Professional pond construction services in Lake Shore",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Lake Shore"
        subtitle="Professional pond services for Pond Construction Services in Lake Shore and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Lake Shore"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Lake Shore</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lake Shore Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lake Shore Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lake Shore Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lake Shore Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionLakeShorePage;