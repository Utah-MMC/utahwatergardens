...
const Pond-repairMountainVillagePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Mountain Village | Professional Pond Repair Services"
        description="Expert pond repair services in Mountain Village. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, mountain village pond repair, pond repair mountain village"
        canonical="https://utahwatergardens.com/pond-repair-mountain-village"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Mountain Village",
          "description": "Professional pond repair services in Mountain Village",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Mountain Village"
        subtitle="Professional pond services for Pond Repair Services in Mountain Village and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Mountain Village"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Mountain Village</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mountain Village Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mountain Village Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mountain Village Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mountain Village Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMountainVillagePage;