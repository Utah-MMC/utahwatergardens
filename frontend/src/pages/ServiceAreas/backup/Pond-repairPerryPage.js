...
const Pond-repairPerryPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Perry | Professional Pond Repair Services"
        description="Expert pond repair services in Perry. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, perry pond repair, pond repair perry"
        canonical="https://utahwatergardens.com/pond-repair-perry"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Perry",
          "description": "Professional pond repair services in Perry",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Perry"
        subtitle="Professional pond services for Pond Repair Services in Perry and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Perry"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Perry</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Perry Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Perry Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Perry Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Perry Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPerryPage;