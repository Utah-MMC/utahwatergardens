...
const Pond-repairTollesonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Tolleson | Professional Pond Repair Services"
        description="Expert pond repair services in Tolleson. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, tolleson pond repair, pond repair tolleson"
        canonical="https://utahwatergardens.com/pond-repair-tolleson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Tolleson",
          "description": "Professional pond repair services in Tolleson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Tolleson"
        subtitle="Professional pond services for Pond Repair Services in Tolleson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Tolleson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Tolleson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tolleson Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tolleson Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tolleson Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tolleson Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTollesonPage;