...
const Pond-repairFortLaramiePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Fort Laramie | Professional Pond Repair Services"
        description="Expert pond repair services in Fort Laramie. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, fort laramie pond repair, pond repair fort laramie"
        canonical="https://utahwatergardens.com/pond-repair-fort-laramie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Fort Laramie",
          "description": "Professional pond repair services in Fort Laramie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Fort Laramie"
        subtitle="Professional pond services for Pond Repair Services in Fort Laramie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Fort Laramie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Fort Laramie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fort Laramie Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fort Laramie Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fort Laramie Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fort Laramie Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFortLaramiePage;