...
const Pond-repairLovellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lovell | Professional Pond Repair Services"
        description="Expert pond repair services in Lovell. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lovell pond repair, pond repair lovell"
        canonical="https://utahwatergardens.com/pond-repair-lovell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lovell",
          "description": "Professional pond repair services in Lovell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lovell"
        subtitle="Professional pond services for Pond Repair Services in Lovell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lovell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lovell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lovell Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lovell Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lovell Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lovell Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLovellPage;