...
const Pond-cleaningProvoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Provo | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Provo. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, provo pond cleaning, pond cleaning provo"
        canonical="https://utahwatergardens.com/pond-cleaning-provo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Provo",
          "description": "Professional pond cleaning services in Provo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Provo"
        subtitle="Professional pond services for Pond Cleaning Services in Provo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Provo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Provo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Provo Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Provo Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Provo Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Provo Customers Say About Our Pond Cleaning</h2>
