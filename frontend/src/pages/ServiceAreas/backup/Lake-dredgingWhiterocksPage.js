...
const Lake-dredgingWhiterocksPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Whiterocks | Professional Lake Dredging Services"
        description="Expert lake dredging services in Whiterocks. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, whiterocks lake dredging, lake dredging whiterocks"
        canonical="https://utahwatergardens.com/lake-dredging-whiterocks"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Whiterocks",
          "description": "Professional lake dredging services in Whiterocks",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Whiterocks"
        subtitle="Professional pond services for Lake Dredging Services in Whiterocks and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Whiterocks"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Whiterocks</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Whiterocks Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Whiterocks Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Whiterocks Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Whiterocks Customers Say About Our Lake Dredging</h2>
