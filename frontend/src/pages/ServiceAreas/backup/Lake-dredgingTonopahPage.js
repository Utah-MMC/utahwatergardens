...
const Lake-dredgingTonopahPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Tonopah | Professional Lake Dredging Services"
        description="Expert lake dredging services in Tonopah. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, tonopah lake dredging, lake dredging tonopah"
        canonical="https://utahwatergardens.com/lake-dredging-tonopah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Tonopah",
          "description": "Professional lake dredging services in Tonopah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Tonopah"
        subtitle="Professional pond services for Lake Dredging Services in Tonopah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Tonopah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Tonopah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tonopah Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tonopah Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tonopah Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tonopah Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingTonopahPage;