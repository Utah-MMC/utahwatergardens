...
const Pond-constructionSandyValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Sandy Valley | Professional Pond Construction Services"
        description="Expert pond construction services in Sandy Valley. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, sandy valley pond construction, pond construction sandy valley"
        canonical="https://utahwatergardens.com/pond-construction-sandy-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Sandy Valley",
          "description": "Professional pond construction services in Sandy Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Sandy Valley"
        subtitle="Professional pond services for Pond Construction Services in Sandy Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Sandy Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Sandy Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sandy Valley Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sandy Valley Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sandy Valley Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sandy Valley Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSandyValleyPage;