...
const Pond-cleaningEnochPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Enoch | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Enoch. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, enoch pond cleaning, pond cleaning enoch"
        canonical="https://utahwatergardens.com/pond-cleaning-enoch"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Enoch",
          "description": "Professional pond cleaning services in Enoch",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Enoch"
        subtitle="Professional pond services for Pond Cleaning Services in Enoch and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Enoch"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Enoch</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Enoch Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Enoch Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Enoch Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Enoch Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningEnochPage;