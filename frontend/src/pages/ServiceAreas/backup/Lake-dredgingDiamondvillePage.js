...
const Lake-dredgingDiamondvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Diamondville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Diamondville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, diamondville lake dredging, lake dredging diamondville"
        canonical="https://utahwatergardens.com/lake-dredging-diamondville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Diamondville",
          "description": "Professional lake dredging services in Diamondville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Diamondville"
        subtitle="Professional pond services for Lake Dredging Services in Diamondville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Diamondville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Diamondville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Diamondville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Diamondville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Diamondville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Diamondville Customers Say About Our Lake Dredging</h2>
