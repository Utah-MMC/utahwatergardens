...
const Pond-repairGarlandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Garland | Professional Pond Repair Services"
        description="Expert pond repair services in Garland. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, garland pond repair, pond repair garland"
        canonical="https://utahwatergardens.com/pond-repair-garland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Garland",
          "description": "Professional pond repair services in Garland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Garland"
        subtitle="Professional pond services for Pond Repair Services in Garland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Garland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Garland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Garland Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Garland Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Garland Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Garland Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGarlandPage;