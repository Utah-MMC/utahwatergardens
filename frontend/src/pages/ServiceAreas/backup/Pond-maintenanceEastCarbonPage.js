...
const Pond-maintenanceEastCarbonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance East Carbon | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in East Carbon. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, east carbon pond maintenance, pond maintenance east carbon"
        canonical="https://utahwatergardens.com/pond-maintenance-east-carbon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services East Carbon",
          "description": "Professional pond maintenance services in East Carbon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in East Carbon"
        subtitle="Professional pond services for Pond Maintenance Services in East Carbon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in East Carbon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in East Carbon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our East Carbon Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="East Carbon Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our East Carbon Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What East Carbon Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceEastCarbonPage;