...
const Pond-cleaningBlueDiamondPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Blue Diamond | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Blue Diamond. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, blue diamond pond cleaning, pond cleaning blue diamond"
        canonical="https://utahwatergardens.com/pond-cleaning-blue-diamond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Blue Diamond",
          "description": "Professional pond cleaning services in Blue Diamond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Blue Diamond"
        subtitle="Professional pond services for Pond Cleaning Services in Blue Diamond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Blue Diamond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Blue Diamond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Blue Diamond Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Blue Diamond Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Blue Diamond Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Blue Diamond Customers Say About Our Pond Cleaning</h2>
