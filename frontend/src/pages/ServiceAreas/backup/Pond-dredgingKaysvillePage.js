...
const Pond-dredgingKaysvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Kaysville | Professional Pond Dredging Services"
        description="Expert pond dredging services in Kaysville. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, kaysville pond dredging, pond dredging kaysville"
        canonical="https://utahwatergardens.com/pond-dredging-kaysville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Kaysville",
          "description": "Professional pond dredging services in Kaysville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Kaysville"
        subtitle="Professional pond services for Pond Dredging Services in Kaysville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Kaysville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Kaysville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kaysville Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kaysville Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kaysville Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kaysville Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingKaysvillePage;