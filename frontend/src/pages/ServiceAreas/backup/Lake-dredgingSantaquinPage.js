...
const Lake-dredgingSantaquinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Santaquin | Professional Lake Dredging Services"
        description="Expert lake dredging services in Santaquin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, santaquin lake dredging, lake dredging santaquin"
        canonical="https://utahwatergardens.com/lake-dredging-santaquin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Santaquin",
          "description": "Professional lake dredging services in Santaquin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Santaquin"
        subtitle="Professional pond services for Lake Dredging Services in Santaquin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Santaquin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Santaquin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Santaquin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Santaquin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Santaquin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Santaquin Customers Say About Our Lake Dredging</h2>
