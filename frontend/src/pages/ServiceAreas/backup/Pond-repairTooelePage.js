...
const Pond-repairTooelePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Tooele | Professional Pond Repair Services"
        description="Expert pond repair services in Tooele. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, tooele pond repair, pond repair tooele"
        canonical="https://utahwatergardens.com/pond-repair-tooele"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Tooele",
          "description": "Professional pond repair services in Tooele",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Tooele"
        subtitle="Professional pond services for Pond Repair Services in Tooele and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Tooele"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Tooele</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tooele Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tooele Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tooele Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tooele Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTooelePage;