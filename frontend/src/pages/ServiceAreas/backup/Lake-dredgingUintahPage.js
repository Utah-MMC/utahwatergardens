...
const Lake-dredgingUintahPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Uintah | Professional Lake Dredging Services"
        description="Expert lake dredging services in Uintah. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, uintah lake dredging, lake dredging uintah"
        canonical="https://utahwatergardens.com/lake-dredging-uintah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Uintah",
          "description": "Professional lake dredging services in Uintah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Uintah"
        subtitle="Professional pond services for Lake Dredging Services in Uintah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Uintah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Uintah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Uintah Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Uintah Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Uintah Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Uintah Customers Say About Our Lake Dredging</h2>
