...
const Pond-repairMarsingPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Marsing | Professional Pond Repair Services"
        description="Expert pond repair services in Marsing. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, marsing pond repair, pond repair marsing"
        canonical="https://utahwatergardens.com/pond-repair-marsing"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Marsing",
          "description": "Professional pond repair services in Marsing",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Marsing"
        subtitle="Professional pond services for Pond Repair Services in Marsing and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Marsing"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Marsing</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marsing Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marsing Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marsing Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marsing Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMarsingPage;