...
const Pond-cleaningRobertsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Roberts | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Roberts. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, roberts pond cleaning, pond cleaning roberts"
        canonical="https://utahwatergardens.com/pond-cleaning-roberts"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Roberts",
          "description": "Professional pond cleaning services in Roberts",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Roberts"
        subtitle="Professional pond services for Pond Cleaning Services in Roberts and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Roberts"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Roberts</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Roberts Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Roberts Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Roberts Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Roberts Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningRobertsPage;