...
const Pond-cleaningCallaoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Callao | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Callao. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, callao pond cleaning, pond cleaning callao"
        canonical="https://utahwatergardens.com/pond-cleaning-callao"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Callao",
          "description": "Professional pond cleaning services in Callao",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Callao"
        subtitle="Professional pond services for Pond Cleaning Services in Callao and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Callao"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Callao</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Callao Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Callao Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Callao Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Callao Customers Say About Our Pond Cleaning</h2>
