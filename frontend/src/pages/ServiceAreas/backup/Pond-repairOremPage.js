...
const Pond-repairOremPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Orem | Professional Pond Repair Services"
        description="Expert pond repair services in Orem. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, orem pond repair, pond repair orem"
        canonical="https://utahwatergardens.com/pond-repair-orem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Orem",
          "description": "Professional pond repair services in Orem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Orem"
        subtitle="Professional pond services for Pond Repair Services in Orem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Orem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Orem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Orem Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Orem Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Orem Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Orem Customers Say About Our Pond Repair</h2>
...
export default Pond-repairOremPage;