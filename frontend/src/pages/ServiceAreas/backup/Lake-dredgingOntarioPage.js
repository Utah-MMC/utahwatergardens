...
const Lake-dredgingOntarioPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Ontario | Professional Lake Dredging Services"
        description="Expert lake dredging services in Ontario. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, ontario lake dredging, lake dredging ontario"
        canonical="https://utahwatergardens.com/lake-dredging-ontario"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Ontario",
          "description": "Professional lake dredging services in Ontario",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Ontario"
        subtitle="Professional pond services for Lake Dredging Services in Ontario and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Ontario"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Ontario</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ontario Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ontario Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ontario Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ontario Customers Say About Our Lake Dredging</h2>
