...
const Pond-repairNorwoodPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Norwood | Professional Pond Repair Services"
        description="Expert pond repair services in Norwood. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, norwood pond repair, pond repair norwood"
        canonical="https://utahwatergardens.com/pond-repair-norwood"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Norwood",
          "description": "Professional pond repair services in Norwood",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Norwood"
        subtitle="Professional pond services for Pond Repair Services in Norwood and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Norwood"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Norwood</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Norwood Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Norwood Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Norwood Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Norwood Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNorwoodPage;