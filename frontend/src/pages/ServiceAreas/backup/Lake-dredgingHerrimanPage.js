...
const Lake-dredgingHerrimanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Herriman | Professional Lake Dredging Services"
        description="Expert lake dredging services in Herriman. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, herriman lake dredging, lake dredging herriman"
        canonical="https://utahwatergardens.com/lake-dredging-herriman"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Herriman",
          "description": "Professional lake dredging services in Herriman",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Herriman"
        subtitle="Professional pond services for Lake Dredging Services in Herriman and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Herriman"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Herriman</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Herriman Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Herriman Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Herriman Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Herriman Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingHerrimanPage;