...
const Pond-dredgingVernalPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Vernal | Professional Pond Dredging Services"
        description="Expert pond dredging services in Vernal. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, vernal pond dredging, pond dredging vernal"
        canonical="https://utahwatergardens.com/pond-dredging-vernal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Vernal",
          "description": "Professional pond dredging services in Vernal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Vernal"
        subtitle="Professional pond services for Pond Dredging Services in Vernal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Vernal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Vernal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vernal Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vernal Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vernal Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vernal Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingVernalPage;