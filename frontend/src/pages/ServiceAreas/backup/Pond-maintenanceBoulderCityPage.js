...
const Pond-maintenanceBoulderCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Boulder City | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Boulder City. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, boulder city pond maintenance, pond maintenance boulder city"
        canonical="https://utahwatergardens.com/pond-maintenance-boulder-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Boulder City",
          "description": "Professional pond maintenance services in Boulder City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Boulder City"
        subtitle="Professional pond services for Pond Maintenance Services in Boulder City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Boulder City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Boulder City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boulder City Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boulder City Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boulder City Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boulder City Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceBoulderCityPage;