...
const Pond-repairTonopahPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Tonopah | Professional Pond Repair Services"
        description="Expert pond repair services in Tonopah. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, tonopah pond repair, pond repair tonopah"
        canonical="https://utahwatergardens.com/pond-repair-tonopah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Tonopah",
          "description": "Professional pond repair services in Tonopah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Tonopah"
        subtitle="Professional pond services for Pond Repair Services in Tonopah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Tonopah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Tonopah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tonopah Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tonopah Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tonopah Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tonopah Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTonopahPage;