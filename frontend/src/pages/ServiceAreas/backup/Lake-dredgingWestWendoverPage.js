...
const Lake-dredgingWestWendoverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging West Wendover | Professional Lake Dredging Services"
        description="Expert lake dredging services in West Wendover. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, west wendover lake dredging, lake dredging west wendover"
        canonical="https://utahwatergardens.com/lake-dredging-west-wendover"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services West Wendover",
          "description": "Professional lake dredging services in West Wendover",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in West Wendover"
        subtitle="Professional pond services for Lake Dredging Services in West Wendover and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in West Wendover"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in West Wendover</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Wendover Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Wendover Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Wendover Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Wendover Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingWestWendoverPage;