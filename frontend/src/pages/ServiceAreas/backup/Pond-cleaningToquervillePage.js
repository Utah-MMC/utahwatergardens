...
const Pond-cleaningToquervillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Toquerville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Toquerville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, toquerville pond cleaning, pond cleaning toquerville"
        canonical="https://utahwatergardens.com/pond-cleaning-toquerville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Toquerville",
          "description": "Professional pond cleaning services in Toquerville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Toquerville"
        subtitle="Professional pond services for Pond Cleaning Services in Toquerville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Toquerville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Toquerville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Toquerville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Toquerville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Toquerville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Toquerville Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningToquervillePage;