...
const Lake-dredgingSpanishForkPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Spanish Fork | Professional Lake Dredging Services"
        description="Expert lake dredging services in Spanish Fork. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, spanish fork lake dredging, lake dredging spanish fork"
        canonical="https://utahwatergardens.com/lake-dredging-spanish-fork"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Spanish Fork",
          "description": "Professional lake dredging services in Spanish Fork",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Spanish Fork"
        subtitle="Professional pond services for Lake Dredging Services in Spanish Fork and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Spanish Fork"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Spanish Fork</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spanish Fork Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spanish Fork Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spanish Fork Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spanish Fork Customers Say About Our Lake Dredging</h2>
