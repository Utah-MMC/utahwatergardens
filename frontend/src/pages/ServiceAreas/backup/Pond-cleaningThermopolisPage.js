...
const Pond-cleaningThermopolisPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Thermopolis | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Thermopolis. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, thermopolis pond cleaning, pond cleaning thermopolis"
        canonical="https://utahwatergardens.com/pond-cleaning-thermopolis"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Thermopolis",
          "description": "Professional pond cleaning services in Thermopolis",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Thermopolis"
        subtitle="Professional pond services for Pond Cleaning Services in Thermopolis and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Thermopolis"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Thermopolis</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Thermopolis Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Thermopolis Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Thermopolis Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Thermopolis Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningThermopolisPage;