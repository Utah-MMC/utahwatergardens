...
const Pond-repairHagermanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Hagerman | Professional Pond Repair Services"
        description="Expert pond repair services in Hagerman. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, hagerman pond repair, pond repair hagerman"
        canonical="https://utahwatergardens.com/pond-repair-hagerman"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Hagerman",
          "description": "Professional pond repair services in Hagerman",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Hagerman"
        subtitle="Professional pond services for Pond Repair Services in Hagerman and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Hagerman"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Hagerman</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hagerman Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hagerman Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hagerman Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hagerman Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHagermanPage;