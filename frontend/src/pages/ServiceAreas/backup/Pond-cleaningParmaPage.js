...
const Pond-cleaningParmaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Parma | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Parma. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, parma pond cleaning, pond cleaning parma"
        canonical="https://utahwatergardens.com/pond-cleaning-parma"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Parma",
          "description": "Professional pond cleaning services in Parma",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Parma"
        subtitle="Professional pond services for Pond Cleaning Services in Parma and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Parma"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Parma</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parma Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parma Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parma Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parma Customers Say About Our Pond Cleaning</h2>
