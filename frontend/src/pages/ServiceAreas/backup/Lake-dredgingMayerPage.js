...
const Lake-dredgingMayerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mayer | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mayer. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mayer lake dredging, lake dredging mayer"
        canonical="https://utahwatergardens.com/lake-dredging-mayer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mayer",
          "description": "Professional lake dredging services in Mayer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mayer"
        subtitle="Professional pond services for Lake Dredging Services in Mayer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mayer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mayer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mayer Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mayer Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mayer Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mayer Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMayerPage;