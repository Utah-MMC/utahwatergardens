...
const Pond-dredgingPerryPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Perry | Professional Pond Dredging Services"
        description="Expert pond dredging services in Perry. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, perry pond dredging, pond dredging perry"
        canonical="https://utahwatergardens.com/pond-dredging-perry"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Perry",
          "description": "Professional pond dredging services in Perry",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Perry"
        subtitle="Professional pond services for Pond Dredging Services in Perry and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Perry"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Perry</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Perry Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Perry Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Perry Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Perry Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPerryPage;