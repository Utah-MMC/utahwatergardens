...
const Pond-dredgingGlendalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Glendale | Professional Pond Dredging Services"
        description="Expert pond dredging services in Glendale. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, glendale pond dredging, pond dredging glendale"
        canonical="https://utahwatergardens.com/pond-dredging-glendale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Glendale",
          "description": "Professional pond dredging services in Glendale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Glendale"
        subtitle="Professional pond services for Pond Dredging Services in Glendale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Glendale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Glendale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glendale Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glendale Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glendale Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glendale Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingGlendalePage;