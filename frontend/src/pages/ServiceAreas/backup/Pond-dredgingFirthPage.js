...
const Pond-dredgingFirthPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Firth | Professional Pond Dredging Services"
        description="Expert pond dredging services in Firth. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, firth pond dredging, pond dredging firth"
        canonical="https://utahwatergardens.com/pond-dredging-firth"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Firth",
          "description": "Professional pond dredging services in Firth",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Firth"
        subtitle="Professional pond services for Pond Dredging Services in Firth and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Firth"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Firth</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Firth Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Firth Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Firth Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Firth Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFirthPage;