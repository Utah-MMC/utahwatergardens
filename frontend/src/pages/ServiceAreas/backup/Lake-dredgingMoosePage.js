...
const Lake-dredgingMoosePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Moose | Professional Lake Dredging Services"
        description="Expert lake dredging services in Moose. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, moose lake dredging, lake dredging moose"
        canonical="https://utahwatergardens.com/lake-dredging-moose"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Moose",
          "description": "Professional lake dredging services in Moose",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Moose"
        subtitle="Professional pond services for Lake Dredging Services in Moose and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Moose"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Moose</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moose Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moose Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moose Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moose Customers Say About Our Lake Dredging</h2>
