...
const Lake-dredgingBuckeyePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Buckeye | Professional Lake Dredging Services"
        description="Expert lake dredging services in Buckeye. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, buckeye lake dredging, lake dredging buckeye"
        canonical="https://utahwatergardens.com/lake-dredging-buckeye"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Buckeye",
          "description": "Professional lake dredging services in Buckeye",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Buckeye"
        subtitle="Professional pond services for Lake Dredging Services in Buckeye and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Buckeye"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Buckeye</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Buckeye Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Buckeye Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Buckeye Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Buckeye Customers Say About Our Lake Dredging</h2>
