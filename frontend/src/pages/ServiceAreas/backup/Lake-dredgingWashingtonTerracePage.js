...
const Lake-dredgingWashingtonTerracePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Washington Terrace | Professional Lake Dredging Services"
        description="Expert lake dredging services in Washington Terrace. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, washington terrace lake dredging, lake dredging washington terrace"
        canonical="https://utahwatergardens.com/lake-dredging-washington-terrace"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Washington Terrace",
          "description": "Professional lake dredging services in Washington Terrace",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Washington Terrace"
        subtitle="Professional pond services for Lake Dredging Services in Washington Terrace and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Washington Terrace"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Washington Terrace</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Washington Terrace Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Washington Terrace Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Washington Terrace Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Washington Terrace Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingWashingtonTerracePage;