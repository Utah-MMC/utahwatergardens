...
const Pond-cleaningMarsingPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Marsing | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Marsing. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, marsing pond cleaning, pond cleaning marsing"
        canonical="https://utahwatergardens.com/pond-cleaning-marsing"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Marsing",
          "description": "Professional pond cleaning services in Marsing",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Marsing"
        subtitle="Professional pond services for Pond Cleaning Services in Marsing and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Marsing"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Marsing</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marsing Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marsing Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marsing Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marsing Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMarsingPage;