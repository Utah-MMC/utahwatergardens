...
const Pond-cleaningVeyoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Veyo | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Veyo. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, veyo pond cleaning, pond cleaning veyo"
        canonical="https://utahwatergardens.com/pond-cleaning-veyo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Veyo",
          "description": "Professional pond cleaning services in Veyo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Veyo"
        subtitle="Professional pond services for Pond Cleaning Services in Veyo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Veyo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Veyo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Veyo Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Veyo Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Veyo Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Veyo Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningVeyoPage;