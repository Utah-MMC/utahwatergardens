...
const Pond-repairNuclaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Nucla | Professional Pond Repair Services"
        description="Expert pond repair services in Nucla. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, nucla pond repair, pond repair nucla"
        canonical="https://utahwatergardens.com/pond-repair-nucla"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Nucla",
          "description": "Professional pond repair services in Nucla",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Nucla"
        subtitle="Professional pond services for Pond Repair Services in Nucla and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Nucla"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Nucla</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nucla Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nucla Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nucla Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nucla Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNuclaPage;