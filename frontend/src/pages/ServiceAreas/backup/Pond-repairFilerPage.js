...
const Pond-repairFilerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Filer | Professional Pond Repair Services"
        description="Expert pond repair services in Filer. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, filer pond repair, pond repair filer"
        canonical="https://utahwatergardens.com/pond-repair-filer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Filer",
          "description": "Professional pond repair services in Filer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Filer"
        subtitle="Professional pond services for Pond Repair Services in Filer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Filer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Filer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Filer Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Filer Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Filer Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Filer Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFilerPage;