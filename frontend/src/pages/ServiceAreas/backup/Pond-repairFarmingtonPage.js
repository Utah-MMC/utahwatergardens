...
const Pond-repairFarmingtonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Farmington | Professional Pond Repair Services"
        description="Expert pond repair services in Farmington. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, farmington pond repair, pond repair farmington"
        canonical="https://utahwatergardens.com/pond-repair-farmington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Farmington",
          "description": "Professional pond repair services in Farmington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Farmington"
        subtitle="Professional pond services for Pond Repair Services in Farmington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Farmington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Farmington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farmington Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farmington Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farmington Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farmington Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFarmingtonPage;