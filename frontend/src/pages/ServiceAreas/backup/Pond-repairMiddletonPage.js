...
const Pond-repairMiddletonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Middleton | Professional Pond Repair Services"
        description="Expert pond repair services in Middleton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, middleton pond repair, pond repair middleton"
        canonical="https://utahwatergardens.com/pond-repair-middleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Middleton",
          "description": "Professional pond repair services in Middleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Middleton"
        subtitle="Professional pond services for Pond Repair Services in Middleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Middleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Middleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Middleton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Middleton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Middleton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Middleton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMiddletonPage;