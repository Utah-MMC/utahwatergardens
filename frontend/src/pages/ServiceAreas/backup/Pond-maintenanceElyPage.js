...
const Pond-maintenanceElyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Ely | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Ely. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, ely pond maintenance, pond maintenance ely"
        canonical="https://utahwatergardens.com/pond-maintenance-ely"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Ely",
          "description": "Professional pond maintenance services in Ely",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Ely"
        subtitle="Professional pond services for Pond Maintenance Services in Ely and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Ely"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Ely</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ely Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ely Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ely Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ely Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceElyPage;