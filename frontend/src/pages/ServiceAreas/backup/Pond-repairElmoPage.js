...
const Pond-repairElmoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Elmo | Professional Pond Repair Services"
        description="Expert pond repair services in Elmo. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, elmo pond repair, pond repair elmo"
        canonical="https://utahwatergardens.com/pond-repair-elmo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Elmo",
          "description": "Professional pond repair services in Elmo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Elmo"
        subtitle="Professional pond services for Pond Repair Services in Elmo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Elmo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Elmo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elmo Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elmo Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elmo Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elmo Customers Say About Our Pond Repair</h2>
...
export default Pond-repairElmoPage;