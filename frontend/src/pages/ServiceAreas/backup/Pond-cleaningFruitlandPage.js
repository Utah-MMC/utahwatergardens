...
const Pond-cleaningFruitlandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Fruitland | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Fruitland. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, fruitland pond cleaning, pond cleaning fruitland"
        canonical="https://utahwatergardens.com/pond-cleaning-fruitland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Fruitland",
          "description": "Professional pond cleaning services in Fruitland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Fruitland"
        subtitle="Professional pond services for Pond Cleaning Services in Fruitland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Fruitland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Fruitland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruitland Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruitland Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruitland Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruitland Customers Say About Our Pond Cleaning</h2>
