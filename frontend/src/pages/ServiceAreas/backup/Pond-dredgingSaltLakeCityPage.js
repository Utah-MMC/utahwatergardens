...
const Pond-dredgingSaltLakeCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Salt Lake City | Professional Pond Dredging Services"
        description="Expert pond dredging services in Salt Lake City. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, salt lake city pond dredging, pond dredging salt lake city"
        canonical="https://utahwatergardens.com/pond-dredging-salt-lake-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Salt Lake City",
          "description": "Professional pond dredging services in Salt Lake City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Salt Lake City"
        subtitle="Professional pond services for Pond Dredging Services in Salt Lake City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Salt Lake City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Salt Lake City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Salt Lake City Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Salt Lake City Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Salt Lake City Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Salt Lake City Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSaltLakeCityPage;