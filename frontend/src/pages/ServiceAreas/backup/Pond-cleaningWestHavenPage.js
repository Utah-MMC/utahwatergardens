...
const Pond-cleaningWestHavenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning West Haven | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in West Haven. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, west haven pond cleaning, pond cleaning west haven"
        canonical="https://utahwatergardens.com/pond-cleaning-west-haven"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services West Haven",
          "description": "Professional pond cleaning services in West Haven",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in West Haven"
        subtitle="Professional pond services for Pond Cleaning Services in West Haven and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in West Haven"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in West Haven</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Haven Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Haven Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Haven Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Haven Customers Say About Our Pond Cleaning</h2>
