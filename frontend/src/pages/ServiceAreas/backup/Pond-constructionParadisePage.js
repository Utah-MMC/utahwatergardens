...
const Pond-constructionParadisePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Paradise | Professional Pond Construction Services"
        description="Expert pond construction services in Paradise. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, paradise pond construction, pond construction paradise"
        canonical="https://utahwatergardens.com/pond-construction-paradise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Paradise",
          "description": "Professional pond construction services in Paradise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Paradise"
        subtitle="Professional pond services for Pond Construction Services in Paradise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Paradise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Paradise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paradise Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paradise Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paradise Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paradise Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionParadisePage;