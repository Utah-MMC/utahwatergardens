...
const Pond-repairWorlandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Worland | Professional Pond Repair Services"
        description="Expert pond repair services in Worland. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, worland pond repair, pond repair worland"
        canonical="https://utahwatergardens.com/pond-repair-worland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Worland",
          "description": "Professional pond repair services in Worland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Worland"
        subtitle="Professional pond services for Pond Repair Services in Worland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Worland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Worland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Worland Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Worland Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Worland Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Worland Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWorlandPage;