...
const Water-feature-designEagleMountainPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Eagle Mountain | Professional Water Feature Design Services"
        description="Expert water feature design services in Eagle Mountain. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, eagle mountain water feature design, water feature design eagle mountain"
        canonical="https://utahwatergardens.com/water-feature-design-eagle-mountain"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Eagle Mountain",
          "description": "Professional water feature design services in Eagle Mountain",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Eagle Mountain"
        subtitle="Professional pond services for Water Feature Design Services in Eagle Mountain and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Eagle Mountain"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Eagle Mountain</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eagle Mountain Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eagle Mountain Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eagle Mountain Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eagle Mountain Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designEagleMountainPage;