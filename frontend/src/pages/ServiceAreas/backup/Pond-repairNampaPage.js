...
const Pond-repairNampaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Nampa | Professional Pond Repair Services"
        description="Expert pond repair services in Nampa. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, nampa pond repair, pond repair nampa"
        canonical="https://utahwatergardens.com/pond-repair-nampa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Nampa",
          "description": "Professional pond repair services in Nampa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Nampa"
        subtitle="Professional pond services for Pond Repair Services in Nampa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Nampa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Nampa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nampa Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nampa Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nampa Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nampa Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNampaPage;