...
const Pond-cleaningSantaClaraPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Santa Clara | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Santa Clara. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, santa clara pond cleaning, pond cleaning santa clara"
        canonical="https://utahwatergardens.com/pond-cleaning-santa-clara"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Santa Clara",
          "description": "Professional pond cleaning services in Santa Clara",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Santa Clara"
        subtitle="Professional pond services for Pond Cleaning Services in Santa Clara and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Santa Clara"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Santa Clara</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Santa Clara Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Santa Clara Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Santa Clara Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Santa Clara Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSantaClaraPage;