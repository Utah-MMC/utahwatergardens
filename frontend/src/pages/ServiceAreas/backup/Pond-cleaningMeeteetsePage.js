...
const Pond-cleaningMeeteetsePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Meeteetse | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Meeteetse. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, meeteetse pond cleaning, pond cleaning meeteetse"
        canonical="https://utahwatergardens.com/pond-cleaning-meeteetse"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Meeteetse",
          "description": "Professional pond cleaning services in Meeteetse",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Meeteetse"
        subtitle="Professional pond services for Pond Cleaning Services in Meeteetse and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Meeteetse"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Meeteetse</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Meeteetse Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Meeteetse Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Meeteetse Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Meeteetse Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMeeteetsePage;