...
const Lake-dredgingTempePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Tempe | Professional Lake Dredging Services"
        description="Expert lake dredging services in Tempe. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, tempe lake dredging, lake dredging tempe"
        canonical="https://utahwatergardens.com/lake-dredging-tempe"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Tempe",
          "description": "Professional lake dredging services in Tempe",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Tempe"
        subtitle="Professional pond services for Lake Dredging Services in Tempe and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Tempe"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Tempe</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tempe Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tempe Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tempe Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tempe Customers Say About Our Lake Dredging</h2>
