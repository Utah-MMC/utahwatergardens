...
const Pond-cleaningMantuaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Mantua | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Mantua. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, mantua pond cleaning, pond cleaning mantua"
        canonical="https://utahwatergardens.com/pond-cleaning-mantua"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Mantua",
          "description": "Professional pond cleaning services in Mantua",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Mantua"
        subtitle="Professional pond services for Pond Cleaning Services in Mantua and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Mantua"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Mantua</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mantua Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mantua Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mantua Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mantua Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMantuaPage;