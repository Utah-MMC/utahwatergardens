...
const Pond-cleaningPinedalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Pinedale | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Pinedale. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, pinedale pond cleaning, pond cleaning pinedale"
        canonical="https://utahwatergardens.com/pond-cleaning-pinedale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Pinedale",
          "description": "Professional pond cleaning services in Pinedale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Pinedale"
        subtitle="Professional pond services for Pond Cleaning Services in Pinedale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Pinedale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Pinedale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pinedale Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pinedale Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pinedale Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pinedale Customers Say About Our Pond Cleaning</h2>
