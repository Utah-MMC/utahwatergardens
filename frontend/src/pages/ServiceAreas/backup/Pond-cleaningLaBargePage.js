...
const Pond-cleaningLaBargePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning La Barge | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in La Barge. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, la barge pond cleaning, pond cleaning la barge"
        canonical="https://utahwatergardens.com/pond-cleaning-la-barge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services La Barge",
          "description": "Professional pond cleaning services in La Barge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in La Barge"
        subtitle="Professional pond services for Pond Cleaning Services in La Barge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in La Barge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in La Barge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Barge Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Barge Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Barge Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Barge Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLaBargePage;