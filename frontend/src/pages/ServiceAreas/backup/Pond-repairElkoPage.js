...
const Pond-repairElkoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Elko | Professional Pond Repair Services"
        description="Expert pond repair services in Elko. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, elko pond repair, pond repair elko"
        canonical="https://utahwatergardens.com/pond-repair-elko"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Elko",
          "description": "Professional pond repair services in Elko",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Elko"
        subtitle="Professional pond services for Pond Repair Services in Elko and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Elko"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Elko</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elko Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elko Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elko Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elko Customers Say About Our Pond Repair</h2>
...
export default Pond-repairElkoPage;