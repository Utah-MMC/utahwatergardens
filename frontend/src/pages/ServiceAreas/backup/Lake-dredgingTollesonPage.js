...
const Lake-dredgingTollesonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Tolleson | Professional Lake Dredging Services"
        description="Expert lake dredging services in Tolleson. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, tolleson lake dredging, lake dredging tolleson"
        canonical="https://utahwatergardens.com/lake-dredging-tolleson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Tolleson",
          "description": "Professional lake dredging services in Tolleson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Tolleson"
        subtitle="Professional pond services for Lake Dredging Services in Tolleson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Tolleson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Tolleson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tolleson Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tolleson Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tolleson Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tolleson Customers Say About Our Lake Dredging</h2>
