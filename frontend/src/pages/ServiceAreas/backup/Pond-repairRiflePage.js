...
const Pond-repairRiflePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Rifle | Professional Pond Repair Services"
        description="Expert pond repair services in Rifle. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, rifle pond repair, pond repair rifle"
        canonical="https://utahwatergardens.com/pond-repair-rifle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Rifle",
          "description": "Professional pond repair services in Rifle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Rifle"
        subtitle="Professional pond services for Pond Repair Services in Rifle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Rifle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Rifle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rifle Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rifle Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rifle Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rifle Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRiflePage;