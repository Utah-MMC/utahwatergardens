...
const Pond-dredgingCottonwoodHeightsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Cottonwood Heights | Professional Pond Dredging Services"
        description="Expert pond dredging services in Cottonwood Heights. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, cottonwood heights pond dredging, pond dredging cottonwood heights"
        canonical="https://utahwatergardens.com/pond-dredging-cottonwood-heights"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Cottonwood Heights",
          "description": "Professional pond dredging services in Cottonwood Heights",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Cottonwood Heights"
        subtitle="Professional pond services for Pond Dredging Services in Cottonwood Heights and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Cottonwood Heights"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Cottonwood Heights</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cottonwood Heights Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cottonwood Heights Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cottonwood Heights Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cottonwood Heights Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCottonwoodHeightsPage;