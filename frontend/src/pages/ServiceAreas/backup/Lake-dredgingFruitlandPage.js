...
const Lake-dredgingFruitlandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Fruitland | Professional Lake Dredging Services"
        description="Expert lake dredging services in Fruitland. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, fruitland lake dredging, lake dredging fruitland"
        canonical="https://utahwatergardens.com/lake-dredging-fruitland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Fruitland",
          "description": "Professional lake dredging services in Fruitland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Fruitland"
        subtitle="Professional pond services for Lake Dredging Services in Fruitland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Fruitland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Fruitland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruitland Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruitland Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruitland Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruitland Customers Say About Our Lake Dredging</h2>
