...
const Lake-dredgingNewHarmonyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging New Harmony | Professional Lake Dredging Services"
        description="Expert lake dredging services in New Harmony. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, new harmony lake dredging, lake dredging new harmony"
        canonical="https://utahwatergardens.com/lake-dredging-new-harmony"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services New Harmony",
          "description": "Professional lake dredging services in New Harmony",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in New Harmony"
        subtitle="Professional pond services for Lake Dredging Services in New Harmony and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in New Harmony"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in New Harmony</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Harmony Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Harmony Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Harmony Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Harmony Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingNewHarmonyPage;