...
const Pond-cleaningDouglasPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Douglas | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Douglas. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, douglas pond cleaning, pond cleaning douglas"
        canonical="https://utahwatergardens.com/pond-cleaning-douglas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Douglas",
          "description": "Professional pond cleaning services in Douglas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Douglas"
        subtitle="Professional pond services for Pond Cleaning Services in Douglas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Douglas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Douglas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Douglas Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Douglas Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Douglas Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Douglas Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDouglasPage;