...
const Pond-cleaningSalemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Salem | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Salem. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, salem pond cleaning, pond cleaning salem"
        canonical="https://utahwatergardens.com/pond-cleaning-salem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Salem",
          "description": "Professional pond cleaning services in Salem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Salem"
        subtitle="Professional pond services for Pond Cleaning Services in Salem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Salem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Salem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Salem Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Salem Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Salem Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Salem Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSalemPage;