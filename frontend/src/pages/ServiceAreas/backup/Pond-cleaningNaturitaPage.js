...
const Pond-cleaningNaturitaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Naturita | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Naturita. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, naturita pond cleaning, pond cleaning naturita"
        canonical="https://utahwatergardens.com/pond-cleaning-naturita"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Naturita",
          "description": "Professional pond cleaning services in Naturita",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Naturita"
        subtitle="Professional pond services for Pond Cleaning Services in Naturita and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Naturita"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Naturita</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Naturita Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Naturita Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Naturita Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Naturita Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningNaturitaPage;