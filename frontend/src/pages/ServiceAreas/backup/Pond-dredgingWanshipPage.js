...
const Pond-dredgingWanshipPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Wanship | Professional Pond Dredging Services"
        description="Expert pond dredging services in Wanship. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, wanship pond dredging, pond dredging wanship"
        canonical="https://utahwatergardens.com/pond-dredging-wanship"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Wanship",
          "description": "Professional pond dredging services in Wanship",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Wanship"
        subtitle="Professional pond services for Pond Dredging Services in Wanship and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Wanship"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Wanship</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wanship Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wanship Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wanship Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wanship Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWanshipPage;