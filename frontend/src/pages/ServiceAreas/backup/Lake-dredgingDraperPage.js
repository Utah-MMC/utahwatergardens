...
const Lake-dredgingDraperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Draper | Professional Lake Dredging Services"
        description="Expert lake dredging services in Draper. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, draper lake dredging, lake dredging draper"
        canonical="https://utahwatergardens.com/lake-dredging-draper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Draper",
          "description": "Professional lake dredging services in Draper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Draper"
        subtitle="Professional pond services for Lake Dredging Services in Draper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Draper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Draper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Draper Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Draper Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Draper Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Draper Customers Say About Our Lake Dredging</h2>
