...
const Lake-dredgingSunCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sun City | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sun City. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sun city lake dredging, lake dredging sun city"
        canonical="https://utahwatergardens.com/lake-dredging-sun-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sun City",
          "description": "Professional lake dredging services in Sun City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sun City"
        subtitle="Professional pond services for Lake Dredging Services in Sun City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sun City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sun City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sun City Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sun City Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sun City Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sun City Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSunCityPage;