...
const Pond-repairClarkPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Clark | Professional Pond Repair Services"
        description="Expert pond repair services in Clark. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, clark pond repair, pond repair clark"
        canonical="https://utahwatergardens.com/pond-repair-clark"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Clark",
          "description": "Professional pond repair services in Clark",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Clark"
        subtitle="Professional pond services for Pond Repair Services in Clark and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Clark"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Clark</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clark Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clark Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clark Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clark Customers Say About Our Pond Repair</h2>
...
export default Pond-repairClarkPage;