...
const Pond-repairKanabPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Kanab | Professional Pond Repair Services"
        description="Expert pond repair services in Kanab. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, kanab pond repair, pond repair kanab"
        canonical="https://utahwatergardens.com/pond-repair-kanab"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Kanab",
          "description": "Professional pond repair services in Kanab",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Kanab"
        subtitle="Professional pond services for Pond Repair Services in Kanab and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Kanab"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Kanab</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kanab Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kanab Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kanab Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kanab Customers Say About Our Pond Repair</h2>
...
export default Pond-repairKanabPage;