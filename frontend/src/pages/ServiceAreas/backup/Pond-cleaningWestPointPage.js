...
const Pond-cleaningWestPointPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning West Point | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in West Point. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, west point pond cleaning, pond cleaning west point"
        canonical="https://utahwatergardens.com/pond-cleaning-west-point"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services West Point",
          "description": "Professional pond cleaning services in West Point",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in West Point"
        subtitle="Professional pond services for Pond Cleaning Services in West Point and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in West Point"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in West Point</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Point Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Point Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Point Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Point Customers Say About Our Pond Cleaning</h2>
