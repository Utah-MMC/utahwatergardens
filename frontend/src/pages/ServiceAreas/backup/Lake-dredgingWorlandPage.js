...
const Lake-dredgingWorlandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Worland | Professional Lake Dredging Services"
        description="Expert lake dredging services in Worland. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, worland lake dredging, lake dredging worland"
        canonical="https://utahwatergardens.com/lake-dredging-worland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Worland",
          "description": "Professional lake dredging services in Worland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Worland"
        subtitle="Professional pond services for Lake Dredging Services in Worland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Worland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Worland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Worland Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Worland Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Worland Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Worland Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingWorlandPage;