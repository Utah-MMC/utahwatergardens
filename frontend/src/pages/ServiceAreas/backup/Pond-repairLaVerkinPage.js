...
const Pond-repairLaVerkinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair La Verkin | Professional Pond Repair Services"
        description="Expert pond repair services in La Verkin. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, la verkin pond repair, pond repair la verkin"
        canonical="https://utahwatergardens.com/pond-repair-la-verkin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services La Verkin",
          "description": "Professional pond repair services in La Verkin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in La Verkin"
        subtitle="Professional pond services for Pond Repair Services in La Verkin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in La Verkin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in La Verkin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Verkin Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Verkin Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Verkin Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Verkin Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLaVerkinPage;