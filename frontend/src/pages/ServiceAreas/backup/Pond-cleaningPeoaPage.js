...
const Pond-cleaningPeoaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Peoa | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Peoa. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, peoa pond cleaning, pond cleaning peoa"
        canonical="https://utahwatergardens.com/pond-cleaning-peoa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Peoa",
          "description": "Professional pond cleaning services in Peoa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Peoa"
        subtitle="Professional pond services for Pond Cleaning Services in Peoa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Peoa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Peoa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Peoa Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Peoa Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Peoa Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Peoa Customers Say About Our Pond Cleaning</h2>
