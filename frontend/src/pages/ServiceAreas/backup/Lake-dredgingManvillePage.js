...
const Lake-dredgingManvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Manville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Manville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, manville lake dredging, lake dredging manville"
        canonical="https://utahwatergardens.com/lake-dredging-manville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Manville",
          "description": "Professional lake dredging services in Manville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Manville"
        subtitle="Professional pond services for Lake Dredging Services in Manville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Manville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Manville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Manville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Manville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Manville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Manville Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingManvillePage;