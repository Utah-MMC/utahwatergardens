...
const Pond-dredgingRivertonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Riverton | Professional Pond Dredging Services"
        description="Expert pond dredging services in Riverton. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, riverton pond dredging, pond dredging riverton"
        canonical="https://utahwatergardens.com/pond-dredging-riverton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Riverton",
          "description": "Professional pond dredging services in Riverton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Riverton"
        subtitle="Professional pond services for Pond Dredging Services in Riverton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Riverton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Riverton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Riverton Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Riverton Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Riverton Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Riverton Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingRivertonPage;