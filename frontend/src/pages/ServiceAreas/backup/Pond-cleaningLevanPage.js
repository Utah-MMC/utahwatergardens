...
const Pond-cleaningLevanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Levan | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Levan. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, levan pond cleaning, pond cleaning levan"
        canonical="https://utahwatergardens.com/pond-cleaning-levan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Levan",
          "description": "Professional pond cleaning services in Levan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Levan"
        subtitle="Professional pond services for Pond Cleaning Services in Levan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Levan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Levan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Levan Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Levan Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Levan Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Levan Customers Say About Our Pond Cleaning</h2>
