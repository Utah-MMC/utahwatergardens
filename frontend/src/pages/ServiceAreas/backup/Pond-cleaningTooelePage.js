...
const Pond-cleaningTooelePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Tooele | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Tooele. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, tooele pond cleaning, pond cleaning tooele"
        canonical="https://utahwatergardens.com/pond-cleaning-tooele"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Tooele",
          "description": "Professional pond cleaning services in Tooele",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Tooele"
        subtitle="Professional pond services for Pond Cleaning Services in Tooele and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Tooele"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Tooele</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tooele Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tooele Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tooele Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tooele Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningTooelePage;