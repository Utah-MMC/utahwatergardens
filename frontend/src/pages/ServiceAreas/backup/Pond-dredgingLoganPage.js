...
const Pond-dredgingLoganPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Logan | Professional Pond Dredging Services"
        description="Expert pond dredging services in Logan. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, logan pond dredging, pond dredging logan"
        canonical="https://utahwatergardens.com/pond-dredging-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Logan",
          "description": "Professional pond dredging services in Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Logan"
        subtitle="Professional pond services for Pond Dredging Services in Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Logan Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Logan Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Logan Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Logan Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLoganPage;