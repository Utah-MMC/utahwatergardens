...
const Pond-dredgingJeromePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Jerome | Professional Pond Dredging Services"
        description="Expert pond dredging services in Jerome. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, jerome pond dredging, pond dredging jerome"
        canonical="https://utahwatergardens.com/pond-dredging-jerome"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Jerome",
          "description": "Professional pond dredging services in Jerome",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Jerome"
        subtitle="Professional pond services for Pond Dredging Services in Jerome and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Jerome"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Jerome</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jerome Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jerome Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jerome Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jerome Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingJeromePage;