...
const Pond-cleaningMesquitePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Mesquite | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Mesquite. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, mesquite pond cleaning, pond cleaning mesquite"
        canonical="https://utahwatergardens.com/pond-cleaning-mesquite"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Mesquite",
          "description": "Professional pond cleaning services in Mesquite",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Mesquite"
        subtitle="Professional pond services for Pond Cleaning Services in Mesquite and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Mesquite"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Mesquite</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mesquite Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mesquite Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mesquite Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mesquite Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMesquitePage;