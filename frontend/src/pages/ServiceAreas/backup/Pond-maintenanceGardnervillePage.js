...
const Pond-maintenanceGardnervillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Gardnerville | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Gardnerville. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, gardnerville pond maintenance, pond maintenance gardnerville"
        canonical="https://utahwatergardens.com/pond-maintenance-gardnerville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Gardnerville",
          "description": "Professional pond maintenance services in Gardnerville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Gardnerville"
        subtitle="Professional pond services for Pond Maintenance Services in Gardnerville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Gardnerville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Gardnerville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gardnerville Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gardnerville Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gardnerville Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gardnerville Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceGardnervillePage;