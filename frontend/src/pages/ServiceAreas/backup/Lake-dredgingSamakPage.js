...
const Lake-dredgingSamakPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Samak | Professional Lake Dredging Services"
        description="Expert lake dredging services in Samak. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, samak lake dredging, lake dredging samak"
        canonical="https://utahwatergardens.com/lake-dredging-samak"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Samak",
          "description": "Professional lake dredging services in Samak",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Samak"
        subtitle="Professional pond services for Lake Dredging Services in Samak and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Samak"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Samak</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Samak Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Samak Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Samak Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Samak Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSamakPage;