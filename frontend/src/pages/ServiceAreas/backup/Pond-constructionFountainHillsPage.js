...
const Pond-constructionFountainHillsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Fountain Hills | Professional Pond Construction Services"
        description="Expert pond construction services in Fountain Hills. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, fountain hills pond construction, pond construction fountain hills"
        canonical="https://utahwatergardens.com/pond-construction-fountain-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Fountain Hills",
          "description": "Professional pond construction services in Fountain Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Fountain Hills"
        subtitle="Professional pond services for Pond Construction Services in Fountain Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Fountain Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Fountain Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fountain Hills Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fountain Hills Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fountain Hills Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fountain Hills Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionFountainHillsPage;