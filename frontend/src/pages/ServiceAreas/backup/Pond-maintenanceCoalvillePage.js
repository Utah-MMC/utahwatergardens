...
const Pond-maintenanceCoalvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Coalville | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Coalville. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, coalville pond maintenance, pond maintenance coalville"
        canonical="https://utahwatergardens.com/pond-maintenance-coalville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Coalville",
          "description": "Professional pond maintenance services in Coalville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Coalville"
        subtitle="Professional pond services for Pond Maintenance Services in Coalville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Coalville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Coalville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Coalville Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Coalville Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Coalville Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Coalville Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceCoalvillePage;