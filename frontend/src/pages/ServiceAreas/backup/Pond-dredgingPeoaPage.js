...
const Pond-dredgingPeoaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Peoa | Professional Pond Dredging Services"
        description="Expert pond dredging services in Peoa. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, peoa pond dredging, pond dredging peoa"
        canonical="https://utahwatergardens.com/pond-dredging-peoa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Peoa",
          "description": "Professional pond dredging services in Peoa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Peoa"
        subtitle="Professional pond services for Pond Dredging Services in Peoa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Peoa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Peoa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Peoa Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Peoa Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Peoa Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Peoa Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPeoaPage;