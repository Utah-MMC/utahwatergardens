...
const Pond-cleaningSouthSaltLakePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning South Salt Lake | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in South Salt Lake. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, south salt lake pond cleaning, pond cleaning south salt lake"
        canonical="https://utahwatergardens.com/pond-cleaning-south-salt-lake"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services South Salt Lake",
          "description": "Professional pond cleaning services in South Salt Lake",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in South Salt Lake"
        subtitle="Professional pond services for Pond Cleaning Services in South Salt Lake and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in South Salt Lake"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in South Salt Lake</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Salt Lake Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Salt Lake Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Salt Lake Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Salt Lake Customers Say About Our Pond Cleaning</h2>
