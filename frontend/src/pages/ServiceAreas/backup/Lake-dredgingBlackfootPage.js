...
const Lake-dredgingBlackfootPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Blackfoot | Professional Lake Dredging Services"
        description="Expert lake dredging services in Blackfoot. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, blackfoot lake dredging, lake dredging blackfoot"
        canonical="https://utahwatergardens.com/lake-dredging-blackfoot"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Blackfoot",
          "description": "Professional lake dredging services in Blackfoot",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Blackfoot"
        subtitle="Professional pond services for Lake Dredging Services in Blackfoot and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Blackfoot"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Blackfoot</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Blackfoot Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Blackfoot Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Blackfoot Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Blackfoot Customers Say About Our Lake Dredging</h2>
