...
const Pond-repairCaldwellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Caldwell | Professional Pond Repair Services"
        description="Expert pond repair services in Caldwell. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, caldwell pond repair, pond repair caldwell"
        canonical="https://utahwatergardens.com/pond-repair-caldwell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Caldwell",
          "description": "Professional pond repair services in Caldwell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Caldwell"
        subtitle="Professional pond services for Pond Repair Services in Caldwell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Caldwell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Caldwell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Caldwell Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Caldwell Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Caldwell Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Caldwell Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCaldwellPage;