...
const Pond-cleaningCentervillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Centerville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Centerville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, centerville pond cleaning, pond cleaning centerville"
        canonical="https://utahwatergardens.com/pond-cleaning-centerville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Centerville",
          "description": "Professional pond cleaning services in Centerville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Centerville"
        subtitle="Professional pond services for Pond Cleaning Services in Centerville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Centerville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Centerville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Centerville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Centerville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Centerville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Centerville Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCentervillePage;