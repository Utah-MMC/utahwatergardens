...
const Pond-maintenanceNorthLoganPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance North Logan | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in North Logan. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, north logan pond maintenance, pond maintenance north logan"
        canonical="https://utahwatergardens.com/pond-maintenance-north-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services North Logan",
          "description": "Professional pond maintenance services in North Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in North Logan"
        subtitle="Professional pond services for Pond Maintenance Services in North Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in North Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in North Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Logan Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Logan Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Logan Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Logan Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceNorthLoganPage;