...
const Pond-dredgingWapitiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Wapiti | Professional Pond Dredging Services"
        description="Expert pond dredging services in Wapiti. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, wapiti pond dredging, pond dredging wapiti"
        canonical="https://utahwatergardens.com/pond-dredging-wapiti"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Wapiti",
          "description": "Professional pond dredging services in Wapiti",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Wapiti"
        subtitle="Professional pond services for Pond Dredging Services in Wapiti and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Wapiti"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Wapiti</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wapiti Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wapiti Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wapiti Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wapiti Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWapitiPage;