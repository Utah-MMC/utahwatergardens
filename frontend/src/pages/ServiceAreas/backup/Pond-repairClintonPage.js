...
const Pond-repairClintonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Clinton | Professional Pond Repair Services"
        description="Expert pond repair services in Clinton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, clinton pond repair, pond repair clinton"
        canonical="https://utahwatergardens.com/pond-repair-clinton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Clinton",
          "description": "Professional pond repair services in Clinton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Clinton"
        subtitle="Professional pond services for Pond Repair Services in Clinton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Clinton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Clinton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clinton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clinton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clinton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clinton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairClintonPage;