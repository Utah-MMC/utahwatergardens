...
const Pond-maintenanceEagleMountainPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Eagle Mountain | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Eagle Mountain. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, eagle mountain pond maintenance, pond maintenance eagle mountain"
        canonical="https://utahwatergardens.com/pond-maintenance-eagle-mountain"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Eagle Mountain",
          "description": "Professional pond maintenance services in Eagle Mountain",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Eagle Mountain"
        subtitle="Professional pond services for Pond Maintenance Services in Eagle Mountain and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Eagle Mountain"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Eagle Mountain</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eagle Mountain Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eagle Mountain Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eagle Mountain Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eagle Mountain Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceEagleMountainPage;