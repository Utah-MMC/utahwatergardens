...
const Pond-dredgingSevierPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Sevier | Professional Pond Dredging Services"
        description="Expert pond dredging services in Sevier. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, sevier pond dredging, pond dredging sevier"
        canonical="https://utahwatergardens.com/pond-dredging-sevier"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Sevier",
          "description": "Professional pond dredging services in Sevier",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Sevier"
        subtitle="Professional pond services for Pond Dredging Services in Sevier and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Sevier"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Sevier</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sevier Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sevier Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sevier Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sevier Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSevierPage;