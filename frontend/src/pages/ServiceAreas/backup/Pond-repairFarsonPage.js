...
const Pond-repairFarsonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Farson | Professional Pond Repair Services"
        description="Expert pond repair services in Farson. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, farson pond repair, pond repair farson"
        canonical="https://utahwatergardens.com/pond-repair-farson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Farson",
          "description": "Professional pond repair services in Farson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Farson"
        subtitle="Professional pond services for Pond Repair Services in Farson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Farson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Farson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farson Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farson Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farson Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farson Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFarsonPage;