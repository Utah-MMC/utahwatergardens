...
const Pond-dredgingEaglePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Eagle | Professional Pond Dredging Services"
        description="Expert pond dredging services in Eagle. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, eagle pond dredging, pond dredging eagle"
        canonical="https://utahwatergardens.com/pond-dredging-eagle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Eagle",
          "description": "Professional pond dredging services in Eagle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Eagle"
        subtitle="Professional pond services for Pond Dredging Services in Eagle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Eagle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Eagle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eagle Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eagle Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eagle Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eagle Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingEaglePage;