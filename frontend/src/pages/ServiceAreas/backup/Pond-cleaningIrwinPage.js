...
const Pond-cleaningIrwinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Irwin | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Irwin. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, irwin pond cleaning, pond cleaning irwin"
        canonical="https://utahwatergardens.com/pond-cleaning-irwin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Irwin",
          "description": "Professional pond cleaning services in Irwin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Irwin"
        subtitle="Professional pond services for Pond Cleaning Services in Irwin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Irwin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Irwin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Irwin Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Irwin Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Irwin Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Irwin Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningIrwinPage;