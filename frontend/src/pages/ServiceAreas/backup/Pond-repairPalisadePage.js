...
const Pond-repairPalisadePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Palisade | Professional Pond Repair Services"
        description="Expert pond repair services in Palisade. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, palisade pond repair, pond repair palisade"
        canonical="https://utahwatergardens.com/pond-repair-palisade"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Palisade",
          "description": "Professional pond repair services in Palisade",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Palisade"
        subtitle="Professional pond services for Pond Repair Services in Palisade and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Palisade"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Palisade</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Palisade Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Palisade Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Palisade Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Palisade Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPalisadePage;