...
const Pond-dredgingAlbionPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Albion | Professional Pond Dredging Services"
        description="Expert pond dredging services in Albion. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, albion pond dredging, pond dredging albion"
        canonical="https://utahwatergardens.com/pond-dredging-albion"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Albion",
          "description": "Professional pond dredging services in Albion",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Albion"
        subtitle="Professional pond services for Pond Dredging Services in Albion and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Albion"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Albion</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Albion Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Albion Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Albion Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Albion Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAlbionPage;