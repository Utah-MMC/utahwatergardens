...
const Pond-cleaningCaldwellPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Caldwell | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Caldwell. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, caldwell pond cleaning, pond cleaning caldwell"
        canonical="https://utahwatergardens.com/pond-cleaning-caldwell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Caldwell",
          "description": "Professional pond cleaning services in Caldwell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Caldwell"
        subtitle="Professional pond services for Pond Cleaning Services in Caldwell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Caldwell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Caldwell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Caldwell Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Caldwell Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Caldwell Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Caldwell Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCaldwellPage;