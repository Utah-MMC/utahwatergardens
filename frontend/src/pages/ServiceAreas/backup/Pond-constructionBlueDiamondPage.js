...
const Pond-constructionBlueDiamondPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Blue Diamond | Professional Pond Construction Services"
        description="Expert pond construction services in Blue Diamond. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, blue diamond pond construction, pond construction blue diamond"
        canonical="https://utahwatergardens.com/pond-construction-blue-diamond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Blue Diamond",
          "description": "Professional pond construction services in Blue Diamond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Blue Diamond"
        subtitle="Professional pond services for Pond Construction Services in Blue Diamond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Blue Diamond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Blue Diamond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Blue Diamond Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Blue Diamond Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Blue Diamond Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Blue Diamond Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionBlueDiamondPage;