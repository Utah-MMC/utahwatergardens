...
const Pond-repairHighlandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Highland | Professional Pond Repair Services"
        description="Expert pond repair services in Highland. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, highland pond repair, pond repair highland"
        canonical="https://utahwatergardens.com/pond-repair-highland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Highland",
          "description": "Professional pond repair services in Highland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Highland"
        subtitle="Professional pond services for Pond Repair Services in Highland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Highland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Highland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Highland Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Highland Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Highland Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Highland Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHighlandPage;