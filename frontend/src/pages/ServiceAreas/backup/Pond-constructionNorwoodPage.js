...
const Pond-constructionNorwoodPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Norwood | Professional Pond Construction Services"
        description="Expert pond construction services in Norwood. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, norwood pond construction, pond construction norwood"
        canonical="https://utahwatergardens.com/pond-construction-norwood"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Norwood",
          "description": "Professional pond construction services in Norwood",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Norwood"
        subtitle="Professional pond services for Pond Construction Services in Norwood and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Norwood"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Norwood</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Norwood Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Norwood Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Norwood Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Norwood Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionNorwoodPage;