...
const Pond-constructionYeringtonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Yerington | Professional Pond Construction Services"
        description="Expert pond construction services in Yerington. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, yerington pond construction, pond construction yerington"
        canonical="https://utahwatergardens.com/pond-construction-yerington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Yerington",
          "description": "Professional pond construction services in Yerington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Yerington"
        subtitle="Professional pond services for Pond Construction Services in Yerington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Yerington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Yerington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Yerington Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Yerington Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Yerington Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Yerington Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionYeringtonPage;