...
const Pond-cleaningCrawfordPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Crawford | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Crawford. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, crawford pond cleaning, pond cleaning crawford"
        canonical="https://utahwatergardens.com/pond-cleaning-crawford"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Crawford",
          "description": "Professional pond cleaning services in Crawford",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Crawford"
        subtitle="Professional pond services for Pond Cleaning Services in Crawford and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Crawford"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Crawford</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crawford Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crawford Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crawford Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crawford Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCrawfordPage;