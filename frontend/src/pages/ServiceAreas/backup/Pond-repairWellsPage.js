...
const Pond-repairWellsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Wells | Professional Pond Repair Services"
        description="Expert pond repair services in Wells. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, wells pond repair, pond repair wells"
        canonical="https://utahwatergardens.com/pond-repair-wells"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Wells",
          "description": "Professional pond repair services in Wells",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Wells"
        subtitle="Professional pond services for Pond Repair Services in Wells and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Wells"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Wells</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wells Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wells Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wells Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wells Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWellsPage;