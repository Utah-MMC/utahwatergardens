...
const Pond-cleaningLundPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lund | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lund. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lund pond cleaning, pond cleaning lund"
        canonical="https://utahwatergardens.com/pond-cleaning-lund"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lund",
          "description": "Professional pond cleaning services in Lund",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lund"
        subtitle="Professional pond services for Pond Cleaning Services in Lund and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lund"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lund</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lund Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lund Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lund Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lund Customers Say About Our Pond Cleaning</h2>
