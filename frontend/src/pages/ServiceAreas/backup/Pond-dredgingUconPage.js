...
const Pond-dredgingUconPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Ucon | Professional Pond Dredging Services"
        description="Expert pond dredging services in Ucon. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, ucon pond dredging, pond dredging ucon"
        canonical="https://utahwatergardens.com/pond-dredging-ucon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Ucon",
          "description": "Professional pond dredging services in Ucon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Ucon"
        subtitle="Professional pond services for Pond Dredging Services in Ucon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Ucon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Ucon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ucon Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ucon Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ucon Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ucon Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingUconPage;