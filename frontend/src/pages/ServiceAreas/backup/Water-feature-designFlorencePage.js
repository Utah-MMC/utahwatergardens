...
const Water-feature-designFlorencePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Florence | Professional Water Feature Design Services"
        description="Expert water feature design services in Florence. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, florence water feature design, water feature design florence"
        canonical="https://utahwatergardens.com/water-feature-design-florence"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Florence",
          "description": "Professional water feature design services in Florence",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Florence"
        subtitle="Professional pond services for Water Feature Design Services in Florence and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Florence"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Florence</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Florence Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Florence Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Florence Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Florence Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designFlorencePage;