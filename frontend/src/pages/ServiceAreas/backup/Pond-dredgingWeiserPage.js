...
const Pond-dredgingWeiserPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Weiser | Professional Pond Dredging Services"
        description="Expert pond dredging services in Weiser. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, weiser pond dredging, pond dredging weiser"
        canonical="https://utahwatergardens.com/pond-dredging-weiser"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Weiser",
          "description": "Professional pond dredging services in Weiser",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Weiser"
        subtitle="Professional pond services for Pond Dredging Services in Weiser and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Weiser"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Weiser</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Weiser Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Weiser Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Weiser Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Weiser Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWeiserPage;