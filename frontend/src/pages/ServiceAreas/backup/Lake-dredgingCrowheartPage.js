...
const Lake-dredgingCrowheartPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Crowheart | Professional Lake Dredging Services"
        description="Expert lake dredging services in Crowheart. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, crowheart lake dredging, lake dredging crowheart"
        canonical="https://utahwatergardens.com/lake-dredging-crowheart"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Crowheart",
          "description": "Professional lake dredging services in Crowheart",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Crowheart"
        subtitle="Professional pond services for Lake Dredging Services in Crowheart and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Crowheart"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Crowheart</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crowheart Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crowheart Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crowheart Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crowheart Customers Say About Our Lake Dredging</h2>
