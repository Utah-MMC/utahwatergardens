...
const Pond-cleaningYoderPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Yoder | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Yoder. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, yoder pond cleaning, pond cleaning yoder"
        canonical="https://utahwatergardens.com/pond-cleaning-yoder"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Yoder",
          "description": "Professional pond cleaning services in Yoder",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Yoder"
        subtitle="Professional pond services for Pond Cleaning Services in Yoder and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Yoder"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Yoder</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Yoder Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Yoder Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Yoder Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Yoder Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningYoderPage;