...
const Pond-cleaningEchoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Echo | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Echo. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, echo pond cleaning, pond cleaning echo"
        canonical="https://utahwatergardens.com/pond-cleaning-echo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Echo",
          "description": "Professional pond cleaning services in Echo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Echo"
        subtitle="Professional pond services for Pond Cleaning Services in Echo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Echo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Echo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Echo Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Echo Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Echo Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Echo Customers Say About Our Pond Cleaning</h2>
