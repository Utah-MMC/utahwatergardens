...
const Pond-dredgingOrangevillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Orangeville | Professional Pond Dredging Services"
        description="Expert pond dredging services in Orangeville. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, orangeville pond dredging, pond dredging orangeville"
        canonical="https://utahwatergardens.com/pond-dredging-orangeville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Orangeville",
          "description": "Professional pond dredging services in Orangeville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Orangeville"
        subtitle="Professional pond services for Pond Dredging Services in Orangeville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Orangeville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Orangeville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Orangeville Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Orangeville Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Orangeville Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Orangeville Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingOrangevillePage;