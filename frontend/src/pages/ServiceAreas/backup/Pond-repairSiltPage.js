...
const Pond-repairSiltPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Silt | Professional Pond Repair Services"
        description="Expert pond repair services in Silt. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, silt pond repair, pond repair silt"
        canonical="https://utahwatergardens.com/pond-repair-silt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Silt",
          "description": "Professional pond repair services in Silt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Silt"
        subtitle="Professional pond services for Pond Repair Services in Silt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Silt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Silt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Silt Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Silt Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Silt Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Silt Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSiltPage;