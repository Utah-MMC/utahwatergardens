...
const Pond-dredgingWellsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Wells | Professional Pond Dredging Services"
        description="Expert pond dredging services in Wells. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, wells pond dredging, pond dredging wells"
        canonical="https://utahwatergardens.com/pond-dredging-wells"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Wells",
          "description": "Professional pond dredging services in Wells",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Wells"
        subtitle="Professional pond services for Pond Dredging Services in Wells and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Wells"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Wells</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wells Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wells Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wells Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wells Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWellsPage;