...
const Pond-repairFerronPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Ferron | Professional Pond Repair Services"
        description="Expert pond repair services in Ferron. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, ferron pond repair, pond repair ferron"
        canonical="https://utahwatergardens.com/pond-repair-ferron"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Ferron",
          "description": "Professional pond repair services in Ferron",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Ferron"
        subtitle="Professional pond services for Pond Repair Services in Ferron and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Ferron"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Ferron</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ferron Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ferron Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ferron Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ferron Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFerronPage;