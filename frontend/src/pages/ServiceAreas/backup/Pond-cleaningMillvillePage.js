...
const Pond-cleaningMillvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Millville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Millville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, millville pond cleaning, pond cleaning millville"
        canonical="https://utahwatergardens.com/pond-cleaning-millville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Millville",
          "description": "Professional pond cleaning services in Millville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Millville"
        subtitle="Professional pond services for Pond Cleaning Services in Millville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Millville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Millville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Millville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Millville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Millville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Millville Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMillvillePage;