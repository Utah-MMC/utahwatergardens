...
const Pond-dredgingMountCharlestonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Mount Charleston | Professional Pond Dredging Services"
        description="Expert pond dredging services in Mount Charleston. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, mount charleston pond dredging, pond dredging mount charleston"
        canonical="https://utahwatergardens.com/pond-dredging-mount-charleston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Mount Charleston",
          "description": "Professional pond dredging services in Mount Charleston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Mount Charleston"
        subtitle="Professional pond services for Pond Dredging Services in Mount Charleston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Mount Charleston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Mount Charleston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mount Charleston Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mount Charleston Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mount Charleston Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mount Charleston Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMountCharlestonPage;