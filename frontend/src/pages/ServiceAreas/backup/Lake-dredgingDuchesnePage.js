...
const Lake-dredgingDuchesnePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Duchesne | Professional Lake Dredging Services"
        description="Expert lake dredging services in Duchesne. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, duchesne lake dredging, lake dredging duchesne"
        canonical="https://utahwatergardens.com/lake-dredging-duchesne"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Duchesne",
          "description": "Professional lake dredging services in Duchesne",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Duchesne"
        subtitle="Professional pond services for Lake Dredging Services in Duchesne and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Duchesne"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Duchesne</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Duchesne Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Duchesne Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Duchesne Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Duchesne Customers Say About Our Lake Dredging</h2>
