...
const Lake-dredgingClarkPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Clark | Professional Lake Dredging Services"
        description="Expert lake dredging services in Clark. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, clark lake dredging, lake dredging clark"
        canonical="https://utahwatergardens.com/lake-dredging-clark"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Clark",
          "description": "Professional lake dredging services in Clark",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Clark"
        subtitle="Professional pond services for Lake Dredging Services in Clark and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Clark"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Clark</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clark Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clark Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clark Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clark Customers Say About Our Lake Dredging</h2>
