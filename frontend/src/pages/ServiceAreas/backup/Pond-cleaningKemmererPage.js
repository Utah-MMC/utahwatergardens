...
const Pond-cleaningKemmererPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Kemmerer | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Kemmerer. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, kemmerer pond cleaning, pond cleaning kemmerer"
        canonical="https://utahwatergardens.com/pond-cleaning-kemmerer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Kemmerer",
          "description": "Professional pond cleaning services in Kemmerer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Kemmerer"
        subtitle="Professional pond services for Pond Cleaning Services in Kemmerer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Kemmerer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Kemmerer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kemmerer Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kemmerer Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kemmerer Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kemmerer Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningKemmererPage;