...
const Pond-cleaningClarkPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Clark | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Clark. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, clark pond cleaning, pond cleaning clark"
        canonical="https://utahwatergardens.com/pond-cleaning-clark"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Clark",
          "description": "Professional pond cleaning services in Clark",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Clark"
        subtitle="Professional pond services for Pond Cleaning Services in Clark and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Clark"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Clark</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clark Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clark Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clark Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clark Customers Say About Our Pond Cleaning</h2>
