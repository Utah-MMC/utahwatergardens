...
const Pond-repairTabionaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Tabiona | Professional Pond Repair Services"
        description="Expert pond repair services in Tabiona. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, tabiona pond repair, pond repair tabiona"
        canonical="https://utahwatergardens.com/pond-repair-tabiona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Tabiona",
          "description": "Professional pond repair services in Tabiona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Tabiona"
        subtitle="Professional pond services for Pond Repair Services in Tabiona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Tabiona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Tabiona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tabiona Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tabiona Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tabiona Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tabiona Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTabionaPage;