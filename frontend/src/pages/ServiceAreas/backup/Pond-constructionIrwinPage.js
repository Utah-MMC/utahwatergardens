...
const Pond-constructionIrwinPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Irwin | Professional Pond Construction Services"
        description="Expert pond construction services in Irwin. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, irwin pond construction, pond construction irwin"
        canonical="https://utahwatergardens.com/pond-construction-irwin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Irwin",
          "description": "Professional pond construction services in Irwin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Irwin"
        subtitle="Professional pond services for Pond Construction Services in Irwin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Irwin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Irwin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Irwin Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Irwin Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Irwin Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Irwin Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionIrwinPage;