...
const Lake-dredgingBasaltPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Basalt | Professional Lake Dredging Services"
        description="Expert lake dredging services in Basalt. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, basalt lake dredging, lake dredging basalt"
        canonical="https://utahwatergardens.com/lake-dredging-basalt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Basalt",
          "description": "Professional lake dredging services in Basalt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Basalt"
        subtitle="Professional pond services for Lake Dredging Services in Basalt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Basalt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Basalt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Basalt Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Basalt Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Basalt Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Basalt Customers Say About Our Lake Dredging</h2>
