...
const Pond-constructionGoldCanyonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Gold Canyon | Professional Pond Construction Services"
        description="Expert pond construction services in Gold Canyon. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, gold canyon pond construction, pond construction gold canyon"
        canonical="https://utahwatergardens.com/pond-construction-gold-canyon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Gold Canyon",
          "description": "Professional pond construction services in Gold Canyon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Gold Canyon"
        subtitle="Professional pond services for Pond Construction Services in Gold Canyon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Gold Canyon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Gold Canyon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gold Canyon Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gold Canyon Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gold Canyon Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gold Canyon Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionGoldCanyonPage;