...
const Pond-dredgingShawneePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Shawnee | Professional Pond Dredging Services"
        description="Expert pond dredging services in Shawnee. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, shawnee pond dredging, pond dredging shawnee"
        canonical="https://utahwatergardens.com/pond-dredging-shawnee"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Shawnee",
          "description": "Professional pond dredging services in Shawnee",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Shawnee"
        subtitle="Professional pond services for Pond Dredging Services in Shawnee and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Shawnee"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Shawnee</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Shawnee Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Shawnee Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Shawnee Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Shawnee Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingShawneePage;