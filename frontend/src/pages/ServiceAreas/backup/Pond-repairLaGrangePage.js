...
const Pond-repairLaGrangePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair La Grange | Professional Pond Repair Services"
        description="Expert pond repair services in La Grange. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, la grange pond repair, pond repair la grange"
        canonical="https://utahwatergardens.com/pond-repair-la-grange"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services La Grange",
          "description": "Professional pond repair services in La Grange",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in La Grange"
        subtitle="Professional pond services for Pond Repair Services in La Grange and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in La Grange"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in La Grange</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Grange Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Grange Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Grange Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Grange Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLaGrangePage;