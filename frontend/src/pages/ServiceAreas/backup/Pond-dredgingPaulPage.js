...
const Pond-dredgingPaulPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Paul | Professional Pond Dredging Services"
        description="Expert pond dredging services in Paul. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, paul pond dredging, pond dredging paul"
        canonical="https://utahwatergardens.com/pond-dredging-paul"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Paul",
          "description": "Professional pond dredging services in Paul",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Paul"
        subtitle="Professional pond services for Pond Dredging Services in Paul and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Paul"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Paul</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paul Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paul Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paul Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paul Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPaulPage;