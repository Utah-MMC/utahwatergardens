...
const Pond-maintenanceHawkSpringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Hawk Springs | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Hawk Springs. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, hawk springs pond maintenance, pond maintenance hawk springs"
        canonical="https://utahwatergardens.com/pond-maintenance-hawk-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Hawk Springs",
          "description": "Professional pond maintenance services in Hawk Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Hawk Springs"
        subtitle="Professional pond services for Pond Maintenance Services in Hawk Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Hawk Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Hawk Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hawk Springs Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hawk Springs Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hawk Springs Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hawk Springs Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceHawkSpringsPage;