...
const Pond-dredgingEurekaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Eureka | Professional Pond Dredging Services"
        description="Expert pond dredging services in Eureka. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, eureka pond dredging, pond dredging eureka"
        canonical="https://utahwatergardens.com/pond-dredging-eureka"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Eureka",
          "description": "Professional pond dredging services in Eureka",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Eureka"
        subtitle="Professional pond services for Pond Dredging Services in Eureka and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Eureka"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Eureka</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eureka Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eureka Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eureka Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eureka Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingEurekaPage;