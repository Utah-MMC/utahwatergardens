...
const Pond-repairBasaltPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Basalt | Professional Pond Repair Services"
        description="Expert pond repair services in Basalt. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, basalt pond repair, pond repair basalt"
        canonical="https://utahwatergardens.com/pond-repair-basalt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Basalt",
          "description": "Professional pond repair services in Basalt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Basalt"
        subtitle="Professional pond services for Pond Repair Services in Basalt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Basalt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Basalt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Basalt Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Basalt Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Basalt Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Basalt Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBasaltPage;