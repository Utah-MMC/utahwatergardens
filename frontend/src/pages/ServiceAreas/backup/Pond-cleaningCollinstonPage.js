...
const Pond-cleaningCollinstonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Collinston | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Collinston. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, collinston pond cleaning, pond cleaning collinston"
        canonical="https://utahwatergardens.com/pond-cleaning-collinston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Collinston",
          "description": "Professional pond cleaning services in Collinston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Collinston"
        subtitle="Professional pond services for Pond Cleaning Services in Collinston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Collinston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Collinston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Collinston Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Collinston Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Collinston Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Collinston Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCollinstonPage;