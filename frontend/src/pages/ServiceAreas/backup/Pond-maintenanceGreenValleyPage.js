...
const Pond-maintenanceGreenValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Green Valley | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Green Valley. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, green valley pond maintenance, pond maintenance green valley"
        canonical="https://utahwatergardens.com/pond-maintenance-green-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Green Valley",
          "description": "Professional pond maintenance services in Green Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Green Valley"
        subtitle="Professional pond services for Pond Maintenance Services in Green Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Green Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Green Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Green Valley Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Green Valley Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Green Valley Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Green Valley Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceGreenValleyPage;