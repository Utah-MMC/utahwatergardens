...
const Pond-dredgingLinglePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lingle | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lingle. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lingle pond dredging, pond dredging lingle"
        canonical="https://utahwatergardens.com/pond-dredging-lingle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lingle",
          "description": "Professional pond dredging services in Lingle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lingle"
        subtitle="Professional pond services for Pond Dredging Services in Lingle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lingle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lingle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lingle Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lingle Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lingle Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lingle Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLinglePage;