...
const Lake-dredgingCarsonCityPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Carson City | Professional Lake Dredging Services"
        description="Expert lake dredging services in Carson City. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, carson city lake dredging, lake dredging carson city"
        canonical="https://utahwatergardens.com/lake-dredging-carson-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Carson City",
          "description": "Professional lake dredging services in Carson City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Carson City"
        subtitle="Professional pond services for Lake Dredging Services in Carson City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Carson City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Carson City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carson City Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carson City Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carson City Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carson City Customers Say About Our Lake Dredging</h2>
