...
const Lake-dredgingFarrWestPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Farr West | Professional Lake Dredging Services"
        description="Expert lake dredging services in Farr West. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, farr west lake dredging, lake dredging farr west"
        canonical="https://utahwatergardens.com/lake-dredging-farr-west"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Farr West",
          "description": "Professional lake dredging services in Farr West",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Farr West"
        subtitle="Professional pond services for Lake Dredging Services in Farr West and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Farr West"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Farr West</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farr West Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farr West Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farr West Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farr West Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingFarrWestPage;