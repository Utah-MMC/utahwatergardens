...
const Pond-dredgingMesquitePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Mesquite | Professional Pond Dredging Services"
        description="Expert pond dredging services in Mesquite. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, mesquite pond dredging, pond dredging mesquite"
        canonical="https://utahwatergardens.com/pond-dredging-mesquite"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Mesquite",
          "description": "Professional pond dredging services in Mesquite",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Mesquite"
        subtitle="Professional pond services for Pond Dredging Services in Mesquite and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Mesquite"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Mesquite</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mesquite Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mesquite Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mesquite Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mesquite Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMesquitePage;