...
const Pond-maintenanceBarNunnPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Bar Nunn | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Bar Nunn. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, bar nunn pond maintenance, pond maintenance bar nunn"
        canonical="https://utahwatergardens.com/pond-maintenance-bar-nunn"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Bar Nunn",
          "description": "Professional pond maintenance services in Bar Nunn",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Bar Nunn"
        subtitle="Professional pond services for Pond Maintenance Services in Bar Nunn and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Bar Nunn"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Bar Nunn</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bar Nunn Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bar Nunn Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bar Nunn Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bar Nunn Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceBarNunnPage;