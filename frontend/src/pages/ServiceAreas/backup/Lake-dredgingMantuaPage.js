...
const Lake-dredgingMantuaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mantua | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mantua. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mantua lake dredging, lake dredging mantua"
        canonical="https://utahwatergardens.com/lake-dredging-mantua"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mantua",
          "description": "Professional lake dredging services in Mantua",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mantua"
        subtitle="Professional pond services for Lake Dredging Services in Mantua and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mantua"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mantua</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mantua Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mantua Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mantua Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mantua Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMantuaPage;