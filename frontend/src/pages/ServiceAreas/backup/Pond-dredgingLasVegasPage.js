...
const Pond-dredgingLasVegasPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Las Vegas | Professional Pond Dredging Services"
        description="Expert pond dredging services in Las Vegas. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, las vegas pond dredging, pond dredging las vegas"
        canonical="https://utahwatergardens.com/pond-dredging-las-vegas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Las Vegas",
          "description": "Professional pond dredging services in Las Vegas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Las Vegas"
        subtitle="Professional pond services for Pond Dredging Services in Las Vegas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Las Vegas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Las Vegas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Las Vegas Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Las Vegas Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Las Vegas Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Las Vegas Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLasVegasPage;