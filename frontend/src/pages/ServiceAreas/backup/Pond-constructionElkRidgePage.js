...
const Pond-constructionElkRidgePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Elk Ridge | Professional Pond Construction Services"
        description="Expert pond construction services in Elk Ridge. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, elk ridge pond construction, pond construction elk ridge"
        canonical="https://utahwatergardens.com/pond-construction-elk-ridge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Elk Ridge",
          "description": "Professional pond construction services in Elk Ridge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Elk Ridge"
        subtitle="Professional pond services for Pond Construction Services in Elk Ridge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Elk Ridge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Elk Ridge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elk Ridge Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elk Ridge Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elk Ridge Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elk Ridge Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionElkRidgePage;