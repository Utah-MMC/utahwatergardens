...
const Lake-dredgingLuskPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lusk | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lusk. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lusk lake dredging, lake dredging lusk"
        canonical="https://utahwatergardens.com/lake-dredging-lusk"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lusk",
          "description": "Professional lake dredging services in Lusk",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lusk"
        subtitle="Professional pond services for Lake Dredging Services in Lusk and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lusk"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lusk</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lusk Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lusk Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lusk Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lusk Customers Say About Our Lake Dredging</h2>
