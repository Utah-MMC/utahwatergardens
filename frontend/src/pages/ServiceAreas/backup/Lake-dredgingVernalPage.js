...
const Lake-dredgingVernalPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Vernal | Professional Lake Dredging Services"
        description="Expert lake dredging services in Vernal. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, vernal lake dredging, lake dredging vernal"
        canonical="https://utahwatergardens.com/lake-dredging-vernal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Vernal",
          "description": "Professional lake dredging services in Vernal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Vernal"
        subtitle="Professional pond services for Lake Dredging Services in Vernal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Vernal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Vernal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vernal Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vernal Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vernal Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vernal Customers Say About Our Lake Dredging</h2>
