...
const Pond-dredgingNampaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Nampa | Professional Pond Dredging Services"
        description="Expert pond dredging services in Nampa. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, nampa pond dredging, pond dredging nampa"
        canonical="https://utahwatergardens.com/pond-dredging-nampa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Nampa",
          "description": "Professional pond dredging services in Nampa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Nampa"
        subtitle="Professional pond services for Pond Dredging Services in Nampa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Nampa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Nampa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nampa Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nampa Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nampa Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nampa Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNampaPage;