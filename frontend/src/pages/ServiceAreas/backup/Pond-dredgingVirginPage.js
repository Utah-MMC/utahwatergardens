...
const Pond-dredgingVirginPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Virgin | Professional Pond Dredging Services"
        description="Expert pond dredging services in Virgin. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, virgin pond dredging, pond dredging virgin"
        canonical="https://utahwatergardens.com/pond-dredging-virgin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Virgin",
          "description": "Professional pond dredging services in Virgin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Virgin"
        subtitle="Professional pond services for Pond Dredging Services in Virgin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Virgin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Virgin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Virgin Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Virgin Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Virgin Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Virgin Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingVirginPage;