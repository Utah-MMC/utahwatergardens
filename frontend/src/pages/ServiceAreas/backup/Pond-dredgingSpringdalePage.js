...
const Pond-dredgingSpringdalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Springdale | Professional Pond Dredging Services"
        description="Expert pond dredging services in Springdale. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, springdale pond dredging, pond dredging springdale"
        canonical="https://utahwatergardens.com/pond-dredging-springdale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Springdale",
          "description": "Professional pond dredging services in Springdale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Springdale"
        subtitle="Professional pond services for Pond Dredging Services in Springdale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Springdale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Springdale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Springdale Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Springdale Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Springdale Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Springdale Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSpringdalePage;