...
const Pond-maintenanceKamasPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Kamas | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Kamas. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, kamas pond maintenance, pond maintenance kamas"
        canonical="https://utahwatergardens.com/pond-maintenance-kamas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Kamas",
          "description": "Professional pond maintenance services in Kamas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Kamas"
        subtitle="Professional pond services for Pond Maintenance Services in Kamas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Kamas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Kamas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kamas Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kamas Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kamas Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kamas Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceKamasPage;