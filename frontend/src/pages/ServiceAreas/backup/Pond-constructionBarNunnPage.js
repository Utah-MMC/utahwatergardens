...
const Pond-constructionBarNunnPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Bar Nunn | Professional Pond Construction Services"
        description="Expert pond construction services in Bar Nunn. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, bar nunn pond construction, pond construction bar nunn"
        canonical="https://utahwatergardens.com/pond-construction-bar-nunn"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Bar Nunn",
          "description": "Professional pond construction services in Bar Nunn",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Bar Nunn"
        subtitle="Professional pond services for Pond Construction Services in Bar Nunn and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Bar Nunn"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Bar Nunn</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bar Nunn Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bar Nunn Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bar Nunn Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bar Nunn Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionBarNunnPage;