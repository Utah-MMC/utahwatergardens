...
const Pond-dredgingRoyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Roy | Professional Pond Dredging Services"
        description="Expert pond dredging services in Roy. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, roy pond dredging, pond dredging roy"
        canonical="https://utahwatergardens.com/pond-dredging-roy"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Roy",
          "description": "Professional pond dredging services in Roy",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Roy"
        subtitle="Professional pond services for Pond Dredging Services in Roy and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Roy"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Roy</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Roy Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Roy Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Roy Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Roy Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingRoyPage;