...
const Lake-dredgingLevanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Levan | Professional Lake Dredging Services"
        description="Expert lake dredging services in Levan. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, levan lake dredging, lake dredging levan"
        canonical="https://utahwatergardens.com/lake-dredging-levan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Levan",
          "description": "Professional lake dredging services in Levan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Levan"
        subtitle="Professional pond services for Lake Dredging Services in Levan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Levan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Levan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Levan Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Levan Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Levan Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Levan Customers Say About Our Lake Dredging</h2>
