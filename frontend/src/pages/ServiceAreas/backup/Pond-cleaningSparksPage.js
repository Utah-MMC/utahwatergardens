...
const Pond-cleaningSparksPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Sparks | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Sparks. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, sparks pond cleaning, pond cleaning sparks"
        canonical="https://utahwatergardens.com/pond-cleaning-sparks"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Sparks",
          "description": "Professional pond cleaning services in Sparks",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Sparks"
        subtitle="Professional pond services for Pond Cleaning Services in Sparks and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Sparks"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Sparks</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sparks Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sparks Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sparks Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sparks Customers Say About Our Pond Cleaning</h2>
