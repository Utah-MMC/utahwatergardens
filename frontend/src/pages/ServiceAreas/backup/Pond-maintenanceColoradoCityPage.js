...
const Pond-maintenanceColoradoCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Colorado City | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Colorado City. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, colorado city pond maintenance, pond maintenance colorado city"
        canonical="https://utahwatergardens.com/pond-maintenance-colorado-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Colorado City",
          "description": "Professional pond maintenance services in Colorado City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Colorado City"
        subtitle="Professional pond services for Pond Maintenance Services in Colorado City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Colorado City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Colorado City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Colorado City Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Colorado City Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Colorado City Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Colorado City Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceColoradoCityPage;