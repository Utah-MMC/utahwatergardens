...
const Pond-dredgingAlbinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Albin | Professional Pond Dredging Services"
        description="Expert pond dredging services in Albin. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, albin pond dredging, pond dredging albin"
        canonical="https://utahwatergardens.com/pond-dredging-albin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Albin",
          "description": "Professional pond dredging services in Albin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Albin"
        subtitle="Professional pond services for Pond Dredging Services in Albin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Albin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Albin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Albin Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Albin Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Albin Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Albin Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAlbinPage;