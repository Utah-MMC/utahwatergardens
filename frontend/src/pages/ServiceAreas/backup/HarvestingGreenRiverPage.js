...
const HarvestingGreenRiverPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Green River | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Green River. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, green river aquatic plant harvesting, aquatic plant harvesting green river"
        canonical="https://utahwatergardens.com/harvesting-green-river"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Green River",
          "description": "Professional aquatic plant harvesting services in Green River",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Green River"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Green River and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Green River"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Green River</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Green River Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Green River Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Green River Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Green River Customers Say About Our Aquatic Plant Harvesting</h2>
