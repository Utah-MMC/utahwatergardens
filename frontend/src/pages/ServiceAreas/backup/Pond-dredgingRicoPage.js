...
const Pond-dredgingRicoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Rico | Professional Pond Dredging Services"
        description="Expert pond dredging services in Rico. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, rico pond dredging, pond dredging rico"
        canonical="https://utahwatergardens.com/pond-dredging-rico"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Rico",
          "description": "Professional pond dredging services in Rico",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Rico"
        subtitle="Professional pond services for Pond Dredging Services in Rico and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Rico"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Rico</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rico Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rico Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rico Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rico Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingRicoPage;