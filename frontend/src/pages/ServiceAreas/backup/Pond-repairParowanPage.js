...
const Pond-repairParowanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Parowan | Professional Pond Repair Services"
        description="Expert pond repair services in Parowan. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, parowan pond repair, pond repair parowan"
        canonical="https://utahwatergardens.com/pond-repair-parowan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Parowan",
          "description": "Professional pond repair services in Parowan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Parowan"
        subtitle="Professional pond services for Pond Repair Services in Parowan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Parowan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Parowan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parowan Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parowan Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parowan Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parowan Customers Say About Our Pond Repair</h2>
...
export default Pond-repairParowanPage;