...
const Pond-dredgingSandyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Sandy | Professional Pond Dredging Services"
        description="Expert pond dredging services in Sandy. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, sandy pond dredging, pond dredging sandy"
        canonical="https://utahwatergardens.com/pond-dredging-sandy"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Sandy",
          "description": "Professional pond dredging services in Sandy",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Sandy"
        subtitle="Professional pond services for Pond Dredging Services in Sandy and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Sandy"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Sandy</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sandy Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sandy Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sandy Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sandy Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSandyPage;