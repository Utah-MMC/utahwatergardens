...
const Lake-dredgingVirginPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Virgin | Professional Lake Dredging Services"
        description="Expert lake dredging services in Virgin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, virgin lake dredging, lake dredging virgin"
        canonical="https://utahwatergardens.com/lake-dredging-virgin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Virgin",
          "description": "Professional lake dredging services in Virgin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Virgin"
        subtitle="Professional pond services for Lake Dredging Services in Virgin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Virgin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Virgin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Virgin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Virgin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Virgin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Virgin Customers Say About Our Lake Dredging</h2>
