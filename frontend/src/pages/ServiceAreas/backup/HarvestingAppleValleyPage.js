...
const HarvestingAppleValleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Apple Valley | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Apple Valley. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, apple valley aquatic plant harvesting, aquatic plant harvesting apple valley"
        canonical="https://utahwatergardens.com/harvesting-apple-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Apple Valley",
          "description": "Professional aquatic plant harvesting services in Apple Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Apple Valley"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Apple Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Apple Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Apple Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Apple Valley Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Apple Valley Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Apple Valley Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Apple Valley Customers Say About Our Aquatic Plant Harvesting</h2>
