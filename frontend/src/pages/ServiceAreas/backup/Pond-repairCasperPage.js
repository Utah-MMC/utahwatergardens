...
const Pond-repairCasperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Casper | Professional Pond Repair Services"
        description="Expert pond repair services in Casper. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, casper pond repair, pond repair casper"
        canonical="https://utahwatergardens.com/pond-repair-casper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Casper",
          "description": "Professional pond repair services in Casper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Casper"
        subtitle="Professional pond services for Pond Repair Services in Casper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Casper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Casper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Casper Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Casper Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Casper Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Casper Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCasperPage;