...
const Pond-repairCrowheartPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Crowheart | Professional Pond Repair Services"
        description="Expert pond repair services in Crowheart. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, crowheart pond repair, pond repair crowheart"
        canonical="https://utahwatergardens.com/pond-repair-crowheart"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Crowheart",
          "description": "Professional pond repair services in Crowheart",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Crowheart"
        subtitle="Professional pond services for Pond Repair Services in Crowheart and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Crowheart"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Crowheart</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crowheart Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crowheart Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crowheart Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crowheart Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCrowheartPage;