...
const Lake-dredgingAvonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Avon | Professional Lake Dredging Services"
        description="Expert lake dredging services in Avon. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, avon lake dredging, lake dredging avon"
        canonical="https://utahwatergardens.com/lake-dredging-avon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Avon",
          "description": "Professional lake dredging services in Avon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Avon"
        subtitle="Professional pond services for Lake Dredging Services in Avon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Avon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Avon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Avon Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Avon Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Avon Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Avon Customers Say About Our Lake Dredging</h2>
