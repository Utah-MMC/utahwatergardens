...
const Lake-dredgingFortWashakiePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Fort Washakie | Professional Lake Dredging Services"
        description="Expert lake dredging services in Fort Washakie. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, fort washakie lake dredging, lake dredging fort washakie"
        canonical="https://utahwatergardens.com/lake-dredging-fort-washakie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Fort Washakie",
          "description": "Professional lake dredging services in Fort Washakie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Fort Washakie"
        subtitle="Professional pond services for Lake Dredging Services in Fort Washakie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Fort Washakie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Fort Washakie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fort Washakie Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fort Washakie Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fort Washakie Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fort Washakie Customers Say About Our Lake Dredging</h2>
