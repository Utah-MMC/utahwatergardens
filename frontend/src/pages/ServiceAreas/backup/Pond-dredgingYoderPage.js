...
const Pond-dredgingYoderPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Yoder | Professional Pond Dredging Services"
        description="Expert pond dredging services in Yoder. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, yoder pond dredging, pond dredging yoder"
        canonical="https://utahwatergardens.com/pond-dredging-yoder"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Yoder",
          "description": "Professional pond dredging services in Yoder",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Yoder"
        subtitle="Professional pond services for Pond Dredging Services in Yoder and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Yoder"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Yoder</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Yoder Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Yoder Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Yoder Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Yoder Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingYoderPage;