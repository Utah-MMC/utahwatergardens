...
const Pond-dredgingHansenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hansen | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hansen. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hansen pond dredging, pond dredging hansen"
        canonical="https://utahwatergardens.com/pond-dredging-hansen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hansen",
          "description": "Professional pond dredging services in Hansen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hansen"
        subtitle="Professional pond services for Pond Dredging Services in Hansen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hansen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hansen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hansen Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hansen Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hansen Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hansen Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHansenPage;