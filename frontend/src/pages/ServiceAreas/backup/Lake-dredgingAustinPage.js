...
const Lake-dredgingAustinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Austin | Professional Lake Dredging Services"
        description="Expert lake dredging services in Austin. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, austin lake dredging, lake dredging austin"
        canonical="https://utahwatergardens.com/lake-dredging-austin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Austin",
          "description": "Professional lake dredging services in Austin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Austin"
        subtitle="Professional pond services for Lake Dredging Services in Austin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Austin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Austin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Austin Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Austin Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Austin Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Austin Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAustinPage;