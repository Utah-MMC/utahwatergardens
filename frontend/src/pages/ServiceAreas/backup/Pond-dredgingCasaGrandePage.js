...
const Pond-dredgingCasaGrandePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Casa Grande | Professional Pond Dredging Services"
        description="Expert pond dredging services in Casa Grande. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, casa grande pond dredging, pond dredging casa grande"
        canonical="https://utahwatergardens.com/pond-dredging-casa-grande"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Casa Grande",
          "description": "Professional pond dredging services in Casa Grande",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Casa Grande"
        subtitle="Professional pond services for Pond Dredging Services in Casa Grande and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Casa Grande"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Casa Grande</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Casa Grande Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Casa Grande Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Casa Grande Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Casa Grande Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCasaGrandePage;