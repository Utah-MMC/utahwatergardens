...
const Pond-repairDammeronValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Dammeron Valley | Professional Pond Repair Services"
        description="Expert pond repair services in Dammeron Valley. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, dammeron valley pond repair, pond repair dammeron valley"
        canonical="https://utahwatergardens.com/pond-repair-dammeron-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Dammeron Valley",
          "description": "Professional pond repair services in Dammeron Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Dammeron Valley"
        subtitle="Professional pond services for Pond Repair Services in Dammeron Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Dammeron Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Dammeron Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dammeron Valley Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dammeron Valley Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dammeron Valley Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dammeron Valley Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDammeronValleyPage;