...
const Pond-cleaningDeweyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Dewey | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Dewey. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, dewey pond cleaning, pond cleaning dewey"
        canonical="https://utahwatergardens.com/pond-cleaning-dewey"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Dewey",
          "description": "Professional pond cleaning services in Dewey",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Dewey"
        subtitle="Professional pond services for Pond Cleaning Services in Dewey and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Dewey"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Dewey</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dewey Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dewey Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dewey Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dewey Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDeweyPage;