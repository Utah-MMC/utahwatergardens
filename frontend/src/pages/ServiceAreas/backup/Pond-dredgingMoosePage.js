...
const Pond-dredgingMoosePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Moose | Professional Pond Dredging Services"
        description="Expert pond dredging services in Moose. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, moose pond dredging, pond dredging moose"
        canonical="https://utahwatergardens.com/pond-dredging-moose"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Moose",
          "description": "Professional pond dredging services in Moose",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Moose"
        subtitle="Professional pond services for Pond Dredging Services in Moose and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Moose"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Moose</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moose Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moose Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moose Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moose Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMoosePage;