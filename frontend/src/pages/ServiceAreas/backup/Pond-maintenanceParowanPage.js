...
const Pond-maintenanceParowanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Parowan | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Parowan. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, parowan pond maintenance, pond maintenance parowan"
        canonical="https://utahwatergardens.com/pond-maintenance-parowan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Parowan",
          "description": "Professional pond maintenance services in Parowan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Parowan"
        subtitle="Professional pond services for Pond Maintenance Services in Parowan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Parowan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Parowan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parowan Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parowan Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parowan Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parowan Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceParowanPage;