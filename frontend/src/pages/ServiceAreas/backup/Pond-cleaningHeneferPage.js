...
const Pond-cleaningHeneferPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Henefer | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Henefer. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, henefer pond cleaning, pond cleaning henefer"
        canonical="https://utahwatergardens.com/pond-cleaning-henefer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Henefer",
          "description": "Professional pond cleaning services in Henefer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Henefer"
        subtitle="Professional pond services for Pond Cleaning Services in Henefer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Henefer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Henefer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Henefer Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Henefer Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Henefer Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Henefer Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningHeneferPage;