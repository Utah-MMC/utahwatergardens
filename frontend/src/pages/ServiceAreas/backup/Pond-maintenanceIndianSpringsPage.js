...
const Pond-maintenanceIndianSpringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Indian Springs | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Indian Springs. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, indian springs pond maintenance, pond maintenance indian springs"
        canonical="https://utahwatergardens.com/pond-maintenance-indian-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Indian Springs",
          "description": "Professional pond maintenance services in Indian Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Indian Springs"
        subtitle="Professional pond services for Pond Maintenance Services in Indian Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Indian Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Indian Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Indian Springs Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Indian Springs Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Indian Springs Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Indian Springs Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceIndianSpringsPage;