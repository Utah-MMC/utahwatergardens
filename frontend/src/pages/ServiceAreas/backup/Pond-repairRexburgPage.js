...
const Pond-repairRexburgPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Rexburg | Professional Pond Repair Services"
        description="Expert pond repair services in Rexburg. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, rexburg pond repair, pond repair rexburg"
        canonical="https://utahwatergardens.com/pond-repair-rexburg"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Rexburg",
          "description": "Professional pond repair services in Rexburg",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Rexburg"
        subtitle="Professional pond services for Pond Repair Services in Rexburg and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Rexburg"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Rexburg</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rexburg Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rexburg Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rexburg Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rexburg Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRexburgPage;