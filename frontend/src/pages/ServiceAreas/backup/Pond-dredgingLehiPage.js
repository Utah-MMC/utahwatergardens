...
const Pond-dredgingLehiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lehi | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lehi. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lehi pond dredging, pond dredging lehi"
        canonical="https://utahwatergardens.com/pond-dredging-lehi"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lehi",
          "description": "Professional pond dredging services in Lehi",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lehi"
        subtitle="Professional pond services for Pond Dredging Services in Lehi and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lehi"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lehi</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lehi Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lehi Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lehi Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lehi Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLehiPage;