...
const Pond-dredgingPrescottValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Prescott Valley | Professional Pond Dredging Services"
        description="Expert pond dredging services in Prescott Valley. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, prescott valley pond dredging, pond dredging prescott valley"
        canonical="https://utahwatergardens.com/pond-dredging-prescott-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Prescott Valley",
          "description": "Professional pond dredging services in Prescott Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Prescott Valley"
        subtitle="Professional pond services for Pond Dredging Services in Prescott Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Prescott Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Prescott Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Prescott Valley Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Prescott Valley Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Prescott Valley Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Prescott Valley Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPrescottValleyPage;