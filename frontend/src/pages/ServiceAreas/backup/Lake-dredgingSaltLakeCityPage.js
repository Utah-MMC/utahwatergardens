...
const Lake-dredgingSaltLakeCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Salt Lake City | Professional Lake Dredging Services"
        description="Expert lake dredging services in Salt Lake City. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, salt lake city lake dredging, lake dredging salt lake city"
        canonical="https://utahwatergardens.com/lake-dredging-salt-lake-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Salt Lake City",
          "description": "Professional lake dredging services in Salt Lake City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Salt Lake City"
        subtitle="Professional pond services for Lake Dredging Services in Salt Lake City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Salt Lake City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Salt Lake City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Salt Lake City Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Salt Lake City Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Salt Lake City Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Salt Lake City Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSaltLakeCityPage;