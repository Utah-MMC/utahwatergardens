...
const Water-feature-designSaltLakeCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Salt Lake City | Professional Water Feature Design Services"
        description="Expert water feature design services in Salt Lake City. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, salt lake city water feature design, water feature design salt lake city"
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Professional water feature design services in Salt Lake City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        ...
        subtitle="Professional pond services for Water Feature Design Services in Salt Lake City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Salt Lake City"
...
export default Water-feature-designSaltLakeCityPage;