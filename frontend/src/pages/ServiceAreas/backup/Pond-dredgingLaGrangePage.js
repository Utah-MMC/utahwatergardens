...
const Pond-dredgingLaGrangePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging La Grange | Professional Pond Dredging Services"
        description="Expert pond dredging services in La Grange. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, la grange pond dredging, pond dredging la grange"
        canonical="https://utahwatergardens.com/pond-dredging-la-grange"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services La Grange",
          "description": "Professional pond dredging services in La Grange",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in La Grange"
        subtitle="Professional pond services for Pond Dredging Services in La Grange and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in La Grange"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in La Grange</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Grange Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Grange Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Grange Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Grange Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLaGrangePage;