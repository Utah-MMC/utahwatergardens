...
const Pond-repairCentralPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Central | Professional Pond Repair Services"
        description="Expert pond repair services in Central. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, central pond repair, pond repair central"
        canonical="https://utahwatergardens.com/pond-repair-central"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Central",
          "description": "Professional pond repair services in Central",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Central"
        subtitle="Professional pond services for Pond Repair Services in Central and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Central"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Central</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Central Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Central Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Central Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Central Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCentralPage;