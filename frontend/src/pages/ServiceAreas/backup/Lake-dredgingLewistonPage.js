...
const Lake-dredgingLewistonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lewiston | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lewiston. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lewiston lake dredging, lake dredging lewiston"
        canonical="https://utahwatergardens.com/lake-dredging-lewiston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lewiston",
          "description": "Professional lake dredging services in Lewiston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lewiston"
        subtitle="Professional pond services for Lake Dredging Services in Lewiston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lewiston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lewiston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lewiston Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lewiston Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lewiston Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lewiston Customers Say About Our Lake Dredging</h2>
