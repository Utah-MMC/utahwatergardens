...
const Pond-cleaningBlackfootPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Blackfoot | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Blackfoot. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, blackfoot pond cleaning, pond cleaning blackfoot"
        canonical="https://utahwatergardens.com/pond-cleaning-blackfoot"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Blackfoot",
          "description": "Professional pond cleaning services in Blackfoot",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Blackfoot"
        subtitle="Professional pond services for Pond Cleaning Services in Blackfoot and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Blackfoot"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Blackfoot</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Blackfoot Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Blackfoot Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Blackfoot Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Blackfoot Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningBlackfootPage;