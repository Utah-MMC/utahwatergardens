...
const Pond-constructionNampaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Nampa | Professional Pond Construction Services"
        description="Expert pond construction services in Nampa. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, nampa pond construction, pond construction nampa"
        canonical="https://utahwatergardens.com/pond-construction-nampa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Nampa",
          "description": "Professional pond construction services in Nampa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Nampa"
        subtitle="Professional pond services for Pond Construction Services in Nampa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Nampa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Nampa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nampa Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nampa Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nampa Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nampa Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionNampaPage;