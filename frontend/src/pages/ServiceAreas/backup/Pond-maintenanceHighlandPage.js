...
const Pond-maintenanceHighlandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Highland | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Highland. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, highland pond maintenance, pond maintenance highland"
        canonical="https://utahwatergardens.com/pond-maintenance-highland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Highland",
          "description": "Professional pond maintenance services in Highland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Highland"
        subtitle="Professional pond services for Pond Maintenance Services in Highland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Highland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Highland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Highland Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Highland Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Highland Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Highland Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceHighlandPage;