...
const Lake-dredgingSurprisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Surprise | Professional Lake Dredging Services"
        description="Expert lake dredging services in Surprise. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, surprise lake dredging, lake dredging surprise"
        canonical="https://utahwatergardens.com/lake-dredging-surprise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Surprise",
          "description": "Professional lake dredging services in Surprise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Surprise"
        subtitle="Professional pond services for Lake Dredging Services in Surprise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Surprise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Surprise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Surprise Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Surprise Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Surprise Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Surprise Customers Say About Our Lake Dredging</h2>
