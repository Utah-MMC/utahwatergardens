...
const Lake-dredgingCasperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Casper | Professional Lake Dredging Services"
        description="Expert lake dredging services in Casper. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, casper lake dredging, lake dredging casper"
        canonical="https://utahwatergardens.com/lake-dredging-casper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Casper",
          "description": "Professional lake dredging services in Casper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Casper"
        subtitle="Professional pond services for Lake Dredging Services in Casper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Casper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Casper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Casper Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Casper Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Casper Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Casper Customers Say About Our Lake Dredging</h2>
