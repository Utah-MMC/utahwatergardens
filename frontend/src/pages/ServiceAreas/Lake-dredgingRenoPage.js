...
const Lake-dredgingRenoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Reno | Professional Lake Dredging Services"
        description="Expert lake dredging services in Reno. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, reno lake dredging, lake dredging reno"
        canonical="https://utahwatergardens.com/lake-dredging-reno"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Reno",
          "description": "Professional lake dredging services in Reno",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Reno"
        subtitle="Professional pond services for Lake Dredging Services in Reno and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Reno"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Reno</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Reno Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Reno Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Reno Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Reno Customers Say About Our Lake Dredging</h2>
