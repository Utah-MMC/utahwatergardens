...
const Pond-maintenanceTwinFallsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Twin Falls | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Twin Falls. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, twin falls pond maintenance, pond maintenance twin falls"
        canonical="https://utahwatergardens.com/pond-maintenance-twin-falls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Twin Falls",
          "description": "Professional pond maintenance services in Twin Falls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Twin Falls"
        subtitle="Professional pond services for Pond Maintenance Services in Twin Falls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Twin Falls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Twin Falls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Twin Falls Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Twin Falls Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Twin Falls Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Twin Falls Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceTwinFallsPage;