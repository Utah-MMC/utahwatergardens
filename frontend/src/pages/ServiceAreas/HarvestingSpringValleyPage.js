...
const HarvestingSpringValleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Spring Valley | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Spring Valley. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, spring valley aquatic plant harvesting, aquatic plant harvesting spring valley"
        canonical="https://utahwatergardens.com/harvesting-spring-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Spring Valley",
          "description": "Professional aquatic plant harvesting services in Spring Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Spring Valley"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Spring Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Spring Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Spring Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spring Valley Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spring Valley Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spring Valley Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spring Valley Customers Say About Our Aquatic Plant Harvesting</h2>
