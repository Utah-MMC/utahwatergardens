...
const Pond-dredgingPaoniaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Paonia | Professional Pond Dredging Services"
        description="Expert pond dredging services in Paonia. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, paonia pond dredging, pond dredging paonia"
        canonical="https://utahwatergardens.com/pond-dredging-paonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Paonia",
          "description": "Professional pond dredging services in Paonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Paonia"
        subtitle="Professional pond services for Pond Dredging Services in Paonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Paonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Paonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paonia Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paonia Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paonia Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paonia Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPaoniaPage;