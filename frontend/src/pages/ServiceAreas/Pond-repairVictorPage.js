...
const Pond-repairVictorPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Victor | Professional Pond Repair Services"
        description="Expert pond repair services in Victor. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, victor pond repair, pond repair victor"
        canonical="https://utahwatergardens.com/pond-repair-victor"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Victor",
          "description": "Professional pond repair services in Victor",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Victor"
        subtitle="Professional pond services for Pond Repair Services in Victor and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Victor"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Victor</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Victor Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Victor Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Victor Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Victor Customers Say About Our Pond Repair</h2>
...
export default Pond-repairVictorPage;