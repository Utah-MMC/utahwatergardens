...
const Pond-dredgingNeolaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Neola | Professional Pond Dredging Services"
        description="Expert pond dredging services in Neola. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, neola pond dredging, pond dredging neola"
        canonical="https://utahwatergardens.com/pond-dredging-neola"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Neola",
          "description": "Professional pond dredging services in Neola",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Neola"
        subtitle="Professional pond services for Pond Dredging Services in Neola and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Neola"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Neola</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Neola Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Neola Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Neola Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Neola Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNeolaPage;