...
const Lake-dredgingHyrumPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Hyrum | Professional Lake Dredging Services"
        description="Expert lake dredging services in Hyrum. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, hyrum lake dredging, lake dredging hyrum"
        canonical="https://utahwatergardens.com/lake-dredging-hyrum"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Hyrum",
          "description": "Professional lake dredging services in Hyrum",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Hyrum"
        subtitle="Professional pond services for Lake Dredging Services in Hyrum and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Hyrum"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Hyrum</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hyrum Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hyrum Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hyrum Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hyrum Customers Say About Our Lake Dredging</h2>
