...
const Pond-dredgingFrancisPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Francis | Professional Pond Dredging Services"
        description="Expert pond dredging services in Francis. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, francis pond dredging, pond dredging francis"
        canonical="https://utahwatergardens.com/pond-dredging-francis"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Francis",
          "description": "Professional pond dredging services in Francis",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Francis"
        subtitle="Professional pond services for Pond Dredging Services in Francis and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Francis"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Francis</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Francis Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Francis Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Francis Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Francis Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFrancisPage;