...
const Pond-cleaningRexburgPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Rexburg | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Rexburg. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, rexburg pond cleaning, pond cleaning rexburg"
        canonical="https://utahwatergardens.com/pond-cleaning-rexburg"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Rexburg",
          "description": "Professional pond cleaning services in Rexburg",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Rexburg"
        subtitle="Professional pond services for Pond Cleaning Services in Rexburg and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Rexburg"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Rexburg</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rexburg Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rexburg Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rexburg Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rexburg Customers Say About Our Pond Cleaning</h2>
