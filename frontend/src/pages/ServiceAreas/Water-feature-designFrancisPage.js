...
const Water-feature-designFrancisPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Francis | Professional Water Feature Design Services"
        description="Expert water feature design services in Francis. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, francis water feature design, water feature design francis"
        canonical="https://utahwatergardens.com/water-feature-design-francis"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Francis",
          "description": "Professional water feature design services in Francis",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Francis"
        subtitle="Professional pond services for Water Feature Design Services in Francis and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Francis"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Francis</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Francis Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Francis Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Francis Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Francis Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designFrancisPage;