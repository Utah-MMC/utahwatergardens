...
const Pond-constructionClarkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Clark | Professional Pond Construction Services"
        description="Expert pond construction services in Clark. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, clark pond construction, pond construction clark"
        canonical="https://utahwatergardens.com/pond-construction-clark"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Clark",
          "description": "Professional pond construction services in Clark",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Clark"
        subtitle="Professional pond services for Pond Construction Services in Clark and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Clark"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Clark</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clark Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clark Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clark Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clark Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionClarkPage;