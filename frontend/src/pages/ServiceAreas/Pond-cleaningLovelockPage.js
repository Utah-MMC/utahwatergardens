...
const Pond-cleaningLovelockPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lovelock | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lovelock. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lovelock pond cleaning, pond cleaning lovelock"
        canonical="https://utahwatergardens.com/pond-cleaning-lovelock"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lovelock",
          "description": "Professional pond cleaning services in Lovelock",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lovelock"
        subtitle="Professional pond services for Pond Cleaning Services in Lovelock and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lovelock"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lovelock</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lovelock Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lovelock Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lovelock Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lovelock Customers Say About Our Pond Cleaning</h2>
