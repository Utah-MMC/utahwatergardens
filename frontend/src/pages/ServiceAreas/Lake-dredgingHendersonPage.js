...
const Lake-dredgingHendersonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Henderson | Professional Lake Dredging Services"
        description="Expert lake dredging services in Henderson. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, henderson lake dredging, lake dredging henderson"
        canonical="https://utahwatergardens.com/lake-dredging-henderson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Henderson",
          "description": "Professional lake dredging services in Henderson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Henderson"
        subtitle="Professional pond services for Lake Dredging Services in Henderson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Henderson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Henderson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Henderson Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Henderson Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Henderson Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Henderson Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingHendersonPage;