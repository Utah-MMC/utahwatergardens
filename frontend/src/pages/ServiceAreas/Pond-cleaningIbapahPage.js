...
const Pond-cleaningIbapahPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Ibapah | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Ibapah. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, ibapah pond cleaning, pond cleaning ibapah"
        canonical="https://utahwatergardens.com/pond-cleaning-ibapah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Ibapah",
          "description": "Professional pond cleaning services in Ibapah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Ibapah"
        subtitle="Professional pond services for Pond Cleaning Services in Ibapah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Ibapah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Ibapah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ibapah Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ibapah Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ibapah Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ibapah Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningIbapahPage;