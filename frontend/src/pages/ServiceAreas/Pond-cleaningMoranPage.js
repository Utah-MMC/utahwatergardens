...
const Pond-cleaningMoranPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Moran | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Moran. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, moran pond cleaning, pond cleaning moran"
        canonical="https://utahwatergardens.com/pond-cleaning-moran"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Moran",
          "description": "Professional pond cleaning services in Moran",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Moran"
        subtitle="Professional pond services for Pond Cleaning Services in Moran and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Moran"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Moran</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moran Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moran Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moran Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moran Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningMoranPage;