...
const Pond-repairPanacaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Panaca | Professional Pond Repair Services"
        description="Expert pond repair services in Panaca. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, panaca pond repair, pond repair panaca"
        canonical="https://utahwatergardens.com/pond-repair-panaca"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Panaca",
          "description": "Professional pond repair services in Panaca",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Panaca"
        subtitle="Professional pond services for Pond Repair Services in Panaca and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Panaca"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Panaca</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Panaca Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Panaca Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Panaca Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Panaca Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPanacaPage;