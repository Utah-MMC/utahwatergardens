...
const Pond-cleaningBakerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Baker | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Baker. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, baker pond cleaning, pond cleaning baker"
        canonical="https://utahwatergardens.com/pond-cleaning-baker"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Baker",
          "description": "Professional pond cleaning services in Baker",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Baker"
        subtitle="Professional pond services for Pond Cleaning Services in Baker and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Baker"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Baker</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Baker Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Baker Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Baker Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Baker Customers Say About Our Pond Cleaning</h2>
