...
const Pond-cleaningNewtonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Newton | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Newton. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, newton pond cleaning, pond cleaning newton"
        canonical="https://utahwatergardens.com/pond-cleaning-newton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Newton",
          "description": "Professional pond cleaning services in Newton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Newton"
        subtitle="Professional pond services for Pond Cleaning Services in Newton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Newton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Newton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Newton Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Newton Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Newton Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Newton Customers Say About Our Pond Cleaning</h2>
