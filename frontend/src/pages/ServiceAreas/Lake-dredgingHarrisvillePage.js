...
const Lake-dredgingHarrisvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Harrisville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Harrisville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, harrisville lake dredging, lake dredging harrisville"
        canonical="https://utahwatergardens.com/lake-dredging-harrisville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Harrisville",
          "description": "Professional lake dredging services in Harrisville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Harrisville"
        subtitle="Professional pond services for Lake Dredging Services in Harrisville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Harrisville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Harrisville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Harrisville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Harrisville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Harrisville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Harrisville Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingHarrisvillePage;