...
const Lake-dredgingPeoriaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Peoria | Professional Lake Dredging Services"
        description="Expert lake dredging services in Peoria. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, peoria lake dredging, lake dredging peoria"
        canonical="https://utahwatergardens.com/lake-dredging-peoria"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Peoria",
          "description": "Professional lake dredging services in Peoria",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Peoria"
        subtitle="Professional pond services for Lake Dredging Services in Peoria and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Peoria"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Peoria</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Peoria Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Peoria Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Peoria Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Peoria Customers Say About Our Lake Dredging</h2>
