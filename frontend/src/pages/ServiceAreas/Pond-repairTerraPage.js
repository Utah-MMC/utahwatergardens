...
const Pond-repairTerraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Terra | Professional Pond Repair Services"
        description="Expert pond repair services in Terra. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, terra pond repair, pond repair terra"
        canonical="https://utahwatergardens.com/pond-repair-terra"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Terra",
          "description": "Professional pond repair services in Terra",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Terra"
        subtitle="Professional pond services for Pond Repair Services in Terra and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Terra"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Terra</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Terra Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Terra Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Terra Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Terra Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTerraPage;