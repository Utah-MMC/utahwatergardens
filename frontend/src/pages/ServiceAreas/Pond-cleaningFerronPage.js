...
const Pond-cleaningFerronPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Ferron | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Ferron. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, ferron pond cleaning, pond cleaning ferron"
        canonical="https://utahwatergardens.com/pond-cleaning-ferron"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Ferron",
          "description": "Professional pond cleaning services in Ferron",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Ferron"
        subtitle="Professional pond services for Pond Cleaning Services in Ferron and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Ferron"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Ferron</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ferron Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ferron Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ferron Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ferron Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningFerronPage;