...
const Pond-dredgingWheatlandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Wheatland | Professional Pond Dredging Services"
        description="Expert pond dredging services in Wheatland. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, wheatland pond dredging, pond dredging wheatland"
        canonical="https://utahwatergardens.com/pond-dredging-wheatland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Wheatland",
          "description": "Professional pond dredging services in Wheatland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Wheatland"
        subtitle="Professional pond services for Pond Dredging Services in Wheatland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Wheatland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Wheatland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wheatland Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wheatland Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wheatland Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wheatland Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWheatlandPage;