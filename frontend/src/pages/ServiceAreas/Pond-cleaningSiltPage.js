...
const Pond-cleaningSiltPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Silt | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Silt. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, silt pond cleaning, pond cleaning silt"
        canonical="https://utahwatergardens.com/pond-cleaning-silt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Silt",
          "description": "Professional pond cleaning services in Silt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Silt"
        subtitle="Professional pond services for Pond Cleaning Services in Silt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Silt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Silt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Silt Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Silt Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Silt Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Silt Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSiltPage;