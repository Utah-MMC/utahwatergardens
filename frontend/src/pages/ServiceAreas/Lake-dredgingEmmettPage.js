...
const Lake-dredgingEmmettPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Emmett | Professional Lake Dredging Services"
        description="Expert lake dredging services in Emmett. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, emmett lake dredging, lake dredging emmett"
        canonical="https://utahwatergardens.com/lake-dredging-emmett"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Emmett",
          "description": "Professional lake dredging services in Emmett",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Emmett"
        subtitle="Professional pond services for Lake Dredging Services in Emmett and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Emmett"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Emmett</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Emmett Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Emmett Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Emmett Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Emmett Customers Say About Our Lake Dredging</h2>
