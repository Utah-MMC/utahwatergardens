...
const Pond-maintenanceTrentonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Trenton | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Trenton. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, trenton pond maintenance, pond maintenance trenton"
        canonical="https://utahwatergardens.com/pond-maintenance-trenton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Trenton",
          "description": "Professional pond maintenance services in Trenton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Trenton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Trenton Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Trenton Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Trenton Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Trenton Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceTrentonPage;