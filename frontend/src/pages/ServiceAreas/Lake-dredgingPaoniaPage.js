...
const Lake-dredgingPaoniaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Paonia | Professional Lake Dredging Services"
        description="Expert lake dredging services in Paonia. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, paonia lake dredging, lake dredging paonia"
        canonical="https://utahwatergardens.com/lake-dredging-paonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Paonia",
          "description": "Professional lake dredging services in Paonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Paonia"
        subtitle="Professional pond services for Lake Dredging Services in Paonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Paonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Paonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paonia Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paonia Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paonia Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paonia Customers Say About Our Lake Dredging</h2>
