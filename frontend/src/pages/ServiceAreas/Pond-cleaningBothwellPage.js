...
const Pond-cleaningBothwellPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Bothwell | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Bothwell. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, bothwell pond cleaning, pond cleaning bothwell"
        canonical="https://utahwatergardens.com/pond-cleaning-bothwell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Bothwell",
          "description": "Professional pond cleaning services in Bothwell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Bothwell"
        subtitle="Professional pond services for Pond Cleaning Services in Bothwell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Bothwell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Bothwell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bothwell Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bothwell Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bothwell Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bothwell Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningBothwellPage;