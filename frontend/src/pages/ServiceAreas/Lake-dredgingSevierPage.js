...
const Lake-dredgingSevierPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sevier | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sevier. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sevier lake dredging, lake dredging sevier"
        canonical="https://utahwatergardens.com/lake-dredging-sevier"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sevier",
          "description": "Professional lake dredging services in Sevier",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sevier"
        subtitle="Professional pond services for Lake Dredging Services in Sevier and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sevier"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sevier</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sevier Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sevier Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sevier Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sevier Customers Say About Our Lake Dredging</h2>
