...
const Pond-repairIonaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Iona | Professional Pond Repair Services"
        description="Expert pond repair services in Iona. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, iona pond repair, pond repair iona"
        canonical="https://utahwatergardens.com/pond-repair-iona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Iona",
          "description": "Professional pond repair services in Iona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Iona"
        subtitle="Professional pond services for Pond Repair Services in Iona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Iona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Iona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Iona Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Iona Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Iona Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Iona Customers Say About Our Pond Repair</h2>
...
export default Pond-repairIonaPage;