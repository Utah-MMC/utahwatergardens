...
const Pond-repairCliftonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Clifton | Professional Pond Repair Services"
        description="Expert pond repair services in Clifton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, clifton pond repair, pond repair clifton"
        canonical="https://utahwatergardens.com/pond-repair-clifton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Clifton",
          "description": "Professional pond repair services in Clifton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Clifton"
        subtitle="Professional pond services for Pond Repair Services in Clifton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Clifton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Clifton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clifton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clifton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clifton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clifton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCliftonPage;