...
const Pond-repairPagePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Page | Professional Pond Repair Services"
        description="Expert pond repair services in Page. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, page pond repair, pond repair page"
        canonical="https://utahwatergardens.com/pond-repair-page"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Page",
          "description": "Professional pond repair services in Page",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Page"
        subtitle="Professional pond services for Pond Repair Services in Page and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Page"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Page</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Page Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Page Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Page Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Page Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPagePage;