...
const Pond-dredgingHawkSpringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hawk Springs | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hawk Springs. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hawk springs pond dredging, pond dredging hawk springs"
        canonical="https://utahwatergardens.com/pond-dredging-hawk-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hawk Springs",
          "description": "Professional pond dredging services in Hawk Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hawk Springs"
        subtitle="Professional pond services for Pond Dredging Services in Hawk Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hawk Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hawk Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hawk Springs Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hawk Springs Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hawk Springs Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hawk Springs Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHawkSpringsPage;