...
const Pond-cleaningEdenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Eden | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Eden. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, eden pond cleaning, pond cleaning eden"
        canonical="https://utahwatergardens.com/pond-cleaning-eden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Eden",
          "description": "Professional pond cleaning services in Eden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Eden"
        subtitle="Professional pond services for Pond Cleaning Services in Eden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Eden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Eden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eden Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eden Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eden Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eden Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningEdenPage;