...
const Lake-dredgingPhoenixPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Phoenix | Professional Lake Dredging Services"
        description="Expert lake dredging services in Phoenix. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, phoenix lake dredging, lake dredging phoenix"
        canonical="https://utahwatergardens.com/lake-dredging-phoenix"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Phoenix",
          "description": "Professional lake dredging services in Phoenix",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Phoenix"
        subtitle="Professional pond services for Lake Dredging Services in Phoenix and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Phoenix"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Phoenix</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Phoenix Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Phoenix Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Phoenix Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Phoenix Customers Say About Our Lake Dredging</h2>
