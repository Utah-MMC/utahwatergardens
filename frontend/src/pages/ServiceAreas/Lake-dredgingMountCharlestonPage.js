...
const Lake-dredgingMountCharlestonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mount Charleston | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mount Charleston. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mount charleston lake dredging, lake dredging mount charleston"
        canonical="https://utahwatergardens.com/lake-dredging-mount-charleston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mount Charleston",
          "description": "Professional lake dredging services in Mount Charleston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mount Charleston"
        subtitle="Professional pond services for Lake Dredging Services in Mount Charleston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mount Charleston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mount Charleston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mount Charleston Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mount Charleston Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mount Charleston Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mount Charleston Customers Say About Our Lake Dredging</h2>
