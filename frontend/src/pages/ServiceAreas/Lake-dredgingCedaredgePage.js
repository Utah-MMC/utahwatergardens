...
const Lake-dredgingCedaredgePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Cedaredge | Professional Lake Dredging Services"
        description="Expert lake dredging services in Cedaredge. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, cedaredge lake dredging, lake dredging cedaredge"
        canonical="https://utahwatergardens.com/lake-dredging-cedaredge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Cedaredge",
          "description": "Professional lake dredging services in Cedaredge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Cedaredge"
        subtitle="Professional pond services for Lake Dredging Services in Cedaredge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Cedaredge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Cedaredge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cedaredge Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cedaredge Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cedaredge Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cedaredge Customers Say About Our Lake Dredging</h2>
