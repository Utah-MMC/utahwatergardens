...
const Pond-dredgingFerronPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Ferron | Professional Pond Dredging Services"
        description="Expert pond dredging services in Ferron. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, ferron pond dredging, pond dredging ferron"
        canonical="https://utahwatergardens.com/pond-dredging-ferron"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Ferron",
          "description": "Professional pond dredging services in Ferron",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Ferron"
        subtitle="Professional pond services for Pond Dredging Services in Ferron and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Ferron"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Ferron</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ferron Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ferron Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ferron Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ferron Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFerronPage;