...
const Pond-repairAlamoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Alamo | Professional Pond Repair Services"
        description="Expert pond repair services in Alamo. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, alamo pond repair, pond repair alamo"
        canonical="https://utahwatergardens.com/pond-repair-alamo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Alamo",
          "description": "Professional pond repair services in Alamo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Alamo"
        subtitle="Professional pond services for Pond Repair Services in Alamo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Alamo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Alamo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alamo Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alamo Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alamo Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alamo Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAlamoPage;