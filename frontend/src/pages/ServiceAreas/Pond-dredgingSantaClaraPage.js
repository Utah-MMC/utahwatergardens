...
const Pond-dredgingSantaClaraPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Santa Clara | Professional Pond Dredging Services"
        description="Expert pond dredging services in Santa Clara. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, santa clara pond dredging, pond dredging santa clara"
        canonical="https://utahwatergardens.com/pond-dredging-santa-clara"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Santa Clara",
          "description": "Professional pond dredging services in Santa Clara",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Santa Clara"
        subtitle="Professional pond services for Pond Dredging Services in Santa Clara and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Santa Clara"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Santa Clara</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Santa Clara Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Santa Clara Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Santa Clara Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Santa Clara Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSantaClaraPage;