...
const Pond-cleaningNorthLasVegasPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning North Las Vegas | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in North Las Vegas. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, north las vegas pond cleaning, pond cleaning north las vegas"
        canonical="https://utahwatergardens.com/pond-cleaning-north-las-vegas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services North Las Vegas",
          "description": "Professional pond cleaning services in North Las Vegas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in North Las Vegas"
        subtitle="Professional pond services for Pond Cleaning Services in North Las Vegas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in North Las Vegas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in North Las Vegas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Las Vegas Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Las Vegas Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Las Vegas Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Las Vegas Customers Say About Our Pond Cleaning</h2>
