...
const Pond-repairFredoniaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Fredonia | Professional Pond Repair Services"
        description="Expert pond repair services in Fredonia. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, fredonia pond repair, pond repair fredonia"
        canonical="https://utahwatergardens.com/pond-repair-fredonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Fredonia",
          "description": "Professional pond repair services in Fredonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Fredonia"
        subtitle="Professional pond services for Pond Repair Services in Fredonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Fredonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Fredonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fredonia Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fredonia Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fredonia Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fredonia Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFredoniaPage;