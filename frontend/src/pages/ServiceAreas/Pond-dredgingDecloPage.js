...
const Pond-dredgingDecloPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Declo | Professional Pond Dredging Services"
        description="Expert pond dredging services in Declo. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, declo pond dredging, pond dredging declo"
        canonical="https://utahwatergardens.com/pond-dredging-declo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Declo",
          "description": "Professional pond dredging services in Declo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Declo"
        subtitle="Professional pond services for Pond Dredging Services in Declo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Declo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Declo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Declo Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Declo Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Declo Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Declo Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingDecloPage;