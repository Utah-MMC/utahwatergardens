...
const Pond-repairSamakPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Samak | Professional Pond Repair Services"
        description="Expert pond repair services in Samak. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, samak pond repair, pond repair samak"
        canonical="https://utahwatergardens.com/pond-repair-samak"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Samak",
          "description": "Professional pond repair services in Samak",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Samak"
        subtitle="Professional pond services for Pond Repair Services in Samak and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Samak"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Samak</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Samak Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Samak Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Samak Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Samak Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSamakPage;