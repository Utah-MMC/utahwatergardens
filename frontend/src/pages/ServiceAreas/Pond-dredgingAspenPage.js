...
const Pond-dredgingAspenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Aspen | Professional Pond Dredging Services"
        description="Expert pond dredging services in Aspen. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, aspen pond dredging, pond dredging aspen"
        canonical="https://utahwatergardens.com/pond-dredging-aspen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Aspen",
          "description": "Professional pond dredging services in Aspen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Aspen"
        subtitle="Professional pond services for Pond Dredging Services in Aspen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Aspen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Aspen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aspen Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aspen Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aspen Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aspen Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAspenPage;