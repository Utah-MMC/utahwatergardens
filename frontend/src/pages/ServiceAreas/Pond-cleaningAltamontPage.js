...
const Pond-cleaningAltamontPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Altamont | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Altamont. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, altamont pond cleaning, pond cleaning altamont"
        canonical="https://utahwatergardens.com/pond-cleaning-altamont"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Altamont",
          "description": "Professional pond cleaning services in Altamont",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Altamont"
        subtitle="Professional pond services for Pond Cleaning Services in Altamont and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Altamont"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Altamont</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Altamont Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Altamont Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Altamont Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Altamont Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAltamontPage;