...
const Pond-cleaningSmithfieldPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Smithfield | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Smithfield. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, smithfield pond cleaning, pond cleaning smithfield"
        canonical="https://utahwatergardens.com/pond-cleaning-smithfield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Smithfield",
          "description": "Professional pond cleaning services in Smithfield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Smithfield"
        subtitle="Professional pond services for Pond Cleaning Services in Smithfield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Smithfield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Smithfield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Smithfield Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Smithfield Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Smithfield Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Smithfield Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSmithfieldPage;