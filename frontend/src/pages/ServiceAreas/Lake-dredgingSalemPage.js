...
const Lake-dredgingSalemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Salem | Professional Lake Dredging Services"
        description="Expert lake dredging services in Salem. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, salem lake dredging, lake dredging salem"
        canonical="https://utahwatergardens.com/lake-dredging-salem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Salem",
          "description": "Professional lake dredging services in Salem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Salem"
        subtitle="Professional pond services for Lake Dredging Services in Salem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Salem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Salem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Salem Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Salem Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Salem Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Salem Customers Say About Our Lake Dredging</h2>
