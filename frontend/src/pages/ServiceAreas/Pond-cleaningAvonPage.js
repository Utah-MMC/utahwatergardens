...
const Pond-cleaningAvonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Avon | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Avon. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, avon pond cleaning, pond cleaning avon"
        canonical="https://utahwatergardens.com/pond-cleaning-avon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Avon",
          "description": "Professional pond cleaning services in Avon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Avon"
        subtitle="Professional pond services for Pond Cleaning Services in Avon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Avon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Avon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Avon Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Avon Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Avon Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Avon Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAvonPage;