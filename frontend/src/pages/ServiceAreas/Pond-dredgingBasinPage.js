...
const Pond-dredgingBasinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Basin | Professional Pond Dredging Services"
        description="Expert pond dredging services in Basin. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, basin pond dredging, pond dredging basin"
        canonical="https://utahwatergardens.com/pond-dredging-basin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Basin",
          "description": "Professional pond dredging services in Basin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Basin"
        subtitle="Professional pond services for Pond Dredging Services in Basin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Basin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Basin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Basin Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Basin Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Basin Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Basin Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBasinPage;