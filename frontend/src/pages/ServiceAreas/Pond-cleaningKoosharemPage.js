...
const Pond-cleaningKoosharemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Koosharem | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Koosharem. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, koosharem pond cleaning, pond cleaning koosharem"
        canonical="https://utahwatergardens.com/pond-cleaning-koosharem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Koosharem",
          "description": "Professional pond cleaning services in Koosharem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Koosharem"
        subtitle="Professional pond services for Pond Cleaning Services in Koosharem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Koosharem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Koosharem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Koosharem Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Koosharem Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Koosharem Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Koosharem Customers Say About Our Pond Cleaning</h2>
