...
const Pond-repairCaveCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Cave Creek | Professional Pond Repair Services"
        description="Expert pond repair services in Cave Creek. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, cave creek pond repair, pond repair cave creek"
        canonical="https://utahwatergardens.com/pond-repair-cave-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Cave Creek",
          "description": "Professional pond repair services in Cave Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Cave Creek"
        subtitle="Professional pond services for Pond Repair Services in Cave Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Cave Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Cave Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cave Creek Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cave Creek Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cave Creek Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cave Creek Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCaveCreekPage;