...
const Lake-dredgingEurekaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Eureka | Professional Lake Dredging Services"
        description="Expert lake dredging services in Eureka. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, eureka lake dredging, lake dredging eureka"
        canonical="https://utahwatergardens.com/lake-dredging-eureka"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Eureka",
          "description": "Professional lake dredging services in Eureka",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Eureka"
        subtitle="Professional pond services for Lake Dredging Services in Eureka and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Eureka"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Eureka</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eureka Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eureka Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eureka Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eureka Customers Say About Our Lake Dredging</h2>
