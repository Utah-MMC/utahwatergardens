...
const Water-feature-designWellsvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Wellsville | Professional Water Feature Design Services"
        description="Expert water feature design services in Wellsville. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, wellsville water feature design, water feature design wellsville"
        canonical="https://utahwatergardens.com/water-feature-design-wellsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Wellsville",
          "description": "Professional water feature design services in Wellsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Wellsville"
        subtitle="Professional pond services for Water Feature Design Services in Wellsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Wellsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Wellsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wellsville Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wellsville Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wellsville Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wellsville Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designWellsvillePage;