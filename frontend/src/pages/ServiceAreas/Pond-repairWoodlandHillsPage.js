...
const Pond-repairWoodlandHillsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Woodland Hills | Professional Pond Repair Services"
        description="Expert pond repair services in Woodland Hills. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, woodland hills pond repair, pond repair woodland hills"
        canonical="https://utahwatergardens.com/pond-repair-woodland-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Woodland Hills",
          "description": "Professional pond repair services in Woodland Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Woodland Hills"
        subtitle="Professional pond services for Pond Repair Services in Woodland Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Woodland Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Woodland Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Woodland Hills Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Woodland Hills Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Woodland Hills Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Woodland Hills Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWoodlandHillsPage;