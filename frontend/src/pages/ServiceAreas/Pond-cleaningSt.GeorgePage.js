...
const Pond-cleaningSt.GeorgePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning St. George | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in St. George. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, st. george pond cleaning, pond cleaning st. george"
        canonical="https://utahwatergardens.com/pond-cleaning-st.-george"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services St. George",
          "description": "Professional pond cleaning services in St. George",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in St. George"
        subtitle="Professional pond services for Pond Cleaning Services in St. George and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in St. George"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in St. George</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. George Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. George Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. George Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. George Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSt.GeorgePage;