...
const Lake-dredgingBattleMountainPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Battle Mountain | Professional Lake Dredging Services"
        description="Expert lake dredging services in Battle Mountain. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, battle mountain lake dredging, lake dredging battle mountain"
        canonical="https://utahwatergardens.com/lake-dredging-battle-mountain"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Battle Mountain",
          "description": "Professional lake dredging services in Battle Mountain",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Battle Mountain"
        subtitle="Professional pond services for Lake Dredging Services in Battle Mountain and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Battle Mountain"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Battle Mountain</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Battle Mountain Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Battle Mountain Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Battle Mountain Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Battle Mountain Customers Say About Our Lake Dredging</h2>
