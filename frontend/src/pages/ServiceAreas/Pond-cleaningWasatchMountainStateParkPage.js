...
const Pond-cleaningWasatchMountainStateParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Wasatch Mountain State Park | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Wasatch Mountain State Park. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, wasatch mountain state park pond cleaning, pond cleaning wasatch mountain state park"
        canonical="https://utahwatergardens.com/pond-cleaning-wasatch-mountain-state-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Wasatch Mountain State Park",
          "description": "Professional pond cleaning services in Wasatch Mountain State Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Wasatch Mountain State Park"
        subtitle="Professional pond services for Pond Cleaning Services in Wasatch Mountain State Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Wasatch Mountain State Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Wasatch Mountain State Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wasatch Mountain State Park Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wasatch Mountain State Park Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wasatch Mountain State Park Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wasatch Mountain State Park Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningWasatchMountainStateParkPage;