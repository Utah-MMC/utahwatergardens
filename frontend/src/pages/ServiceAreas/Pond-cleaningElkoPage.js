...
const Pond-cleaningElkoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Elko | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Elko. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, elko pond cleaning, pond cleaning elko"
        canonical="https://utahwatergardens.com/pond-cleaning-elko"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Elko",
          "description": "Professional pond cleaning services in Elko",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Elko"
        subtitle="Professional pond services for Pond Cleaning Services in Elko and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Elko"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Elko</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elko Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elko Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elko Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elko Customers Say About Our Pond Cleaning</h2>
