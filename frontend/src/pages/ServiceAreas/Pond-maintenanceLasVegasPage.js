...
const Pond-maintenanceLasVegasPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Las Vegas | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Las Vegas. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, las vegas pond maintenance, pond maintenance las vegas"
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Professional pond maintenance services in Las Vegas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        ...
        <div className="container">
          ...
          <section className="testimonials-section">
            <h2>What Las Vegas Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceLasVegasPage;