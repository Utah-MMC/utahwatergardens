...
const Pond-repairMendonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Mendon | Professional Pond Repair Services"
        description="Expert pond repair services in Mendon. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, mendon pond repair, pond repair mendon"
        canonical="https://utahwatergardens.com/pond-repair-mendon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Mendon",
          "description": "Professional pond repair services in Mendon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Mendon"
        subtitle="Professional pond services for Pond Repair Services in Mendon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Mendon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Mendon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mendon Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mendon Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mendon Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mendon Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMendonPage;