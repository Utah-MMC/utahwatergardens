...
const Lake-dredgingCornishPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Cornish | Professional Lake Dredging Services"
        description="Expert lake dredging services in Cornish. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, cornish lake dredging, lake dredging cornish"
        canonical="https://utahwatergardens.com/lake-dredging-cornish"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Cornish",
          "description": "Professional lake dredging services in Cornish",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Cornish"
        subtitle="Professional pond services for Lake Dredging Services in Cornish and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Cornish"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Cornish</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cornish Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cornish Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cornish Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cornish Customers Say About Our Lake Dredging</h2>
