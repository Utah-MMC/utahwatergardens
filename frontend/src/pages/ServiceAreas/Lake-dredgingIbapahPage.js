...
const Lake-dredgingIbapahPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Ibapah | Professional Lake Dredging Services"
        description="Expert lake dredging services in Ibapah. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, ibapah lake dredging, lake dredging ibapah"
        canonical="https://utahwatergardens.com/lake-dredging-ibapah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Ibapah",
          "description": "Professional lake dredging services in Ibapah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Ibapah"
        subtitle="Professional pond services for Lake Dredging Services in Ibapah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Ibapah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Ibapah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ibapah Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ibapah Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ibapah Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ibapah Customers Say About Our Lake Dredging</h2>
