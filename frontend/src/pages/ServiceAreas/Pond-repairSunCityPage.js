...
const Pond-repairSunCityPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Sun City | Professional Pond Repair Services"
        description="Expert pond repair services in Sun City. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, sun city pond repair, pond repair sun city"
        canonical="https://utahwatergardens.com/pond-repair-sun-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Sun City",
          "description": "Professional pond repair services in Sun City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Sun City"
        subtitle="Professional pond services for Pond Repair Services in Sun City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Sun City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Sun City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sun City Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sun City Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sun City Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sun City Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSunCityPage;