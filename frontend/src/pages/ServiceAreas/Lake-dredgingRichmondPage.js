...
const Lake-dredgingRichmondPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Richmond | Professional Lake Dredging Services"
        description="Expert lake dredging services in Richmond. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, richmond lake dredging, lake dredging richmond"
        canonical="https://utahwatergardens.com/lake-dredging-richmond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Richmond",
          "description": "Professional lake dredging services in Richmond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Richmond"
        subtitle="Professional pond services for Lake Dredging Services in Richmond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Richmond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Richmond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Richmond Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Richmond Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Richmond Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Richmond Customers Say About Our Lake Dredging</h2>
