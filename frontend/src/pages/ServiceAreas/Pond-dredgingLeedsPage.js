...
const Pond-dredgingLeedsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Leeds | Professional Pond Dredging Services"
        description="Expert pond dredging services in Leeds. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, leeds pond dredging, pond dredging leeds"
        canonical="https://utahwatergardens.com/pond-dredging-leeds"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Leeds",
          "description": "Professional pond dredging services in Leeds",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Leeds"
        subtitle="Professional pond services for Pond Dredging Services in Leeds and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Leeds"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Leeds</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Leeds Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Leeds Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Leeds Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Leeds Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLeedsPage;