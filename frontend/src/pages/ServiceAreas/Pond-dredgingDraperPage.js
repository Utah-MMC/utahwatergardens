...
const Pond-dredgingDraperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Draper | Professional Pond Dredging Services"
        description="Expert pond dredging services in Draper. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, draper pond dredging, pond dredging draper"
        canonical="https://utahwatergardens.com/pond-dredging-draper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Draper",
          "description": "Professional pond dredging services in Draper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Draper"
        subtitle="Professional pond services for Pond Dredging Services in Draper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Draper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Draper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Draper Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Draper Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Draper Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Draper Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingDraperPage;