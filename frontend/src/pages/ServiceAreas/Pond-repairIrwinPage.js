...
const Pond-repairIrwinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Irwin | Professional Pond Repair Services"
        description="Expert pond repair services in Irwin. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, irwin pond repair, pond repair irwin"
        canonical="https://utahwatergardens.com/pond-repair-irwin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Irwin",
          "description": "Professional pond repair services in Irwin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Irwin"
        subtitle="Professional pond services for Pond Repair Services in Irwin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Irwin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Irwin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Irwin Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Irwin Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Irwin Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Irwin Customers Say About Our Pond Repair</h2>
...
export default Pond-repairIrwinPage;