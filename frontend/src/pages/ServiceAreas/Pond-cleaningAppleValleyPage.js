...
const Pond-cleaningAppleValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Apple Valley | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Apple Valley. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, apple valley pond cleaning, pond cleaning apple valley"
        canonical="https://utahwatergardens.com/pond-cleaning-apple-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Apple Valley",
          "description": "Professional pond cleaning services in Apple Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Apple Valley"
        subtitle="Professional pond services for Pond Cleaning Services in Apple Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Apple Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Apple Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Apple Valley Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Apple Valley Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Apple Valley Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Apple Valley Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAppleValleyPage;