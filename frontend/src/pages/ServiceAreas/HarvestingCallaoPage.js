...
const HarvestingCallaoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Callao | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Callao. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, callao aquatic plant harvesting, aquatic plant harvesting callao"
        canonical="https://utahwatergardens.com/harvesting-callao"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Callao",
          "description": "Professional aquatic plant harvesting services in Callao",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Callao"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Callao and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Callao"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Callao</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Callao Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Callao Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Callao Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Callao Customers Say About Our Aquatic Plant Harvesting</h2>
