...
const Lake-dredgingOgdenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Ogden | Professional Lake Dredging Services"
        description="Expert lake dredging services in Ogden. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, ogden lake dredging, lake dredging ogden"
        canonical="https://utahwatergardens.com/lake-dredging-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Ogden",
          "description": "Professional lake dredging services in Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Ogden"
        subtitle="Professional pond services for Lake Dredging Services in Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ogden Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ogden Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ogden Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ogden Customers Say About Our Lake Dredging</h2>
