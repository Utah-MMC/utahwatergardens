...
const Lake-dredgingTabionaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Tabiona | Professional Lake Dredging Services"
        description="Expert lake dredging services in Tabiona. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, tabiona lake dredging, lake dredging tabiona"
        canonical="https://utahwatergardens.com/lake-dredging-tabiona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Tabiona",
          "description": "Professional lake dredging services in Tabiona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Tabiona"
        subtitle="Professional pond services for Lake Dredging Services in Tabiona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Tabiona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Tabiona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tabiona Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tabiona Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tabiona Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tabiona Customers Say About Our Lake Dredging</h2>
