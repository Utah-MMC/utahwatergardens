...
const Pond-cleaningCodyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Cody | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Cody. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, cody pond cleaning, pond cleaning cody"
        canonical="https://utahwatergardens.com/pond-cleaning-cody"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Cody",
          "description": "Professional pond cleaning services in Cody",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Cody"
        subtitle="Professional pond services for Pond Cleaning Services in Cody and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Cody"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Cody</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cody Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cody Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cody Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cody Customers Say About Our Pond Cleaning</h2>
