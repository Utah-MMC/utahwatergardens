...
const Pond-maintenanceSnowmassVillagePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Snowmass Village | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Snowmass Village. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, snowmass village pond maintenance, pond maintenance snowmass village"
        canonical="https://utahwatergardens.com/pond-maintenance-snowmass-village"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Snowmass Village",
          "description": "Professional pond maintenance services in Snowmass Village",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Snowmass Village"
        subtitle="Professional pond services for Pond Maintenance Services in Snowmass Village and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Snowmass Village"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Snowmass Village</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Snowmass Village Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Snowmass Village Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Snowmass Village Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Snowmass Village Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSnowmassVillagePage;