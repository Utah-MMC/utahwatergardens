...
const Pond-repairAvondalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Avondale | Professional Pond Repair Services"
        description="Expert pond repair services in Avondale. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, avondale pond repair, pond repair avondale"
        canonical="https://utahwatergardens.com/pond-repair-avondale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Avondale",
          "description": "Professional pond repair services in Avondale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Avondale"
        subtitle="Professional pond services for Pond Repair Services in Avondale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Avondale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Avondale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Avondale Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Avondale Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Avondale Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Avondale Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAvondalePage;