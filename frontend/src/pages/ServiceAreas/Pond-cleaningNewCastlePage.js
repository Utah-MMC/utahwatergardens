...
const Pond-cleaningNewCastlePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning New Castle | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in New Castle. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, new castle pond cleaning, pond cleaning new castle"
        canonical="https://utahwatergardens.com/pond-cleaning-new-castle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services New Castle",
          "description": "Professional pond cleaning services in New Castle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in New Castle"
        subtitle="Professional pond services for Pond Cleaning Services in New Castle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in New Castle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in New Castle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Castle Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Castle Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Castle Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Castle Customers Say About Our Pond Cleaning</h2>
