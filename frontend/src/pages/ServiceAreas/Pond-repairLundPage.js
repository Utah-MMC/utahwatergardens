...
const Pond-repairLundPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lund | Professional Pond Repair Services"
        description="Expert pond repair services in Lund. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lund pond repair, pond repair lund"
        canonical="https://utahwatergardens.com/pond-repair-lund"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lund",
          "description": "Professional pond repair services in Lund",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lund"
        subtitle="Professional pond services for Pond Repair Services in Lund and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lund"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lund</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lund Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lund Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lund Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lund Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLundPage;