...
const Lake-dredgingRiflePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Rifle | Professional Lake Dredging Services"
        description="Expert lake dredging services in Rifle. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, rifle lake dredging, lake dredging rifle"
        canonical="https://utahwatergardens.com/lake-dredging-rifle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Rifle",
          "description": "Professional lake dredging services in Rifle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Rifle"
        subtitle="Professional pond services for Lake Dredging Services in Rifle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Rifle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Rifle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rifle Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rifle Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rifle Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rifle Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingRiflePage;