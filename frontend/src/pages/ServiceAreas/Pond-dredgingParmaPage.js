...
const Pond-dredgingParmaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Parma | Professional Pond Dredging Services"
        description="Expert pond dredging services in Parma. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, parma pond dredging, pond dredging parma"
        canonical="https://utahwatergardens.com/pond-dredging-parma"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Parma",
          "description": "Professional pond dredging services in Parma",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Parma"
        subtitle="Professional pond services for Pond Dredging Services in Parma and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Parma"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Parma</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parma Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parma Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parma Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parma Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingParmaPage;