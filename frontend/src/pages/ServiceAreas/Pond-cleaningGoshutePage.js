...
const Pond-cleaningGoshutePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Goshute | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Goshute. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, goshute pond cleaning, pond cleaning goshute"
        canonical="https://utahwatergardens.com/pond-cleaning-goshute"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Goshute",
          "description": "Professional pond cleaning services in Goshute",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Goshute"
        subtitle="Professional pond services for Pond Cleaning Services in Goshute and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Goshute"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Goshute</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goshute Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goshute Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goshute Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goshute Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningGoshutePage;