...
const Pond-cleaningSalinaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Salina | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Salina. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, salina pond cleaning, pond cleaning salina"
        canonical="https://utahwatergardens.com/pond-cleaning-salina"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Salina",
          "description": "Professional pond cleaning services in Salina",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Salina"
        subtitle="Professional pond services for Pond Cleaning Services in Salina and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Salina"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Salina</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Salina Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Salina Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Salina Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Salina Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSalinaPage;