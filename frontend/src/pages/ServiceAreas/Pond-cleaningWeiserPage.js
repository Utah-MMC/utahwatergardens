...
const Pond-cleaningWeiserPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Weiser | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Weiser. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, weiser pond cleaning, pond cleaning weiser"
        canonical="https://utahwatergardens.com/pond-cleaning-weiser"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Weiser",
          "description": "Professional pond cleaning services in Weiser",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Weiser"
        subtitle="Professional pond services for Pond Cleaning Services in Weiser and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Weiser"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Weiser</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Weiser Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Weiser Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Weiser Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Weiser Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningWeiserPage;