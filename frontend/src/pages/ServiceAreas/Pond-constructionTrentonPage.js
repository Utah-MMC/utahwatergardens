...
const Pond-constructionTrentonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Trenton | Professional Pond Construction Services"
        description="Expert pond construction services in Trenton. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, trenton pond construction, pond construction trenton"
        canonical="https://utahwatergardens.com/pond-construction-trenton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Trenton",
          "description": "Professional pond construction services in Trenton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Trenton"
        subtitle="Professional pond services for Pond Construction Services in Trenton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Trenton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Trenton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Trenton Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Trenton Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Trenton Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Trenton Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionTrentonPage;