...
const Lake-dredgingElmoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Elmo | Professional Lake Dredging Services"
        description="Expert lake dredging services in Elmo. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, elmo lake dredging, lake dredging elmo"
        canonical="https://utahwatergardens.com/lake-dredging-elmo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Elmo",
          "description": "Professional lake dredging services in Elmo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Elmo"
        subtitle="Professional pond services for Lake Dredging Services in Elmo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Elmo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Elmo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elmo Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elmo Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elmo Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elmo Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingElmoPage;