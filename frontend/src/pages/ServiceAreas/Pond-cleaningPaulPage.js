...
const Pond-cleaningPaulPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Paul | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Paul. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, paul pond cleaning, pond cleaning paul"
        canonical="https://utahwatergardens.com/pond-cleaning-paul"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Paul",
          "description": "Professional pond cleaning services in Paul",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Paul"
        subtitle="Professional pond services for Pond Cleaning Services in Paul and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Paul"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Paul</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paul Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paul Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paul Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paul Customers Say About Our Pond Cleaning</h2>
