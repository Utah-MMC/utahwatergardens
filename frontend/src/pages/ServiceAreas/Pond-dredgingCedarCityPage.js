...
const Pond-dredgingCedarCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Cedar City | Professional Pond Dredging Services"
        description="Expert pond dredging services in Cedar City. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, cedar city pond dredging, pond dredging cedar city"
        canonical="https://utahwatergardens.com/pond-dredging-cedar-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Cedar City",
          "description": "Professional pond dredging services in Cedar City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Cedar City"
        subtitle="Professional pond services for Pond Dredging Services in Cedar City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Cedar City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Cedar City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cedar City Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cedar City Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cedar City Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cedar City Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCedarCityPage;