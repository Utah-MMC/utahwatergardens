...
const Pond-cleaningPagePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Page | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Page. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, page pond cleaning, pond cleaning page"
        canonical="https://utahwatergardens.com/pond-cleaning-page"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Page",
          "description": "Professional pond cleaning services in Page",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Page"
        subtitle="Professional pond services for Pond Cleaning Services in Page and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Page"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Page</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Page Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Page Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Page Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Page Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningPagePage;