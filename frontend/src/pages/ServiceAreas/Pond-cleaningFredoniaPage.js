...
const Pond-cleaningFredoniaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Fredonia | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Fredonia. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, fredonia pond cleaning, pond cleaning fredonia"
        canonical="https://utahwatergardens.com/pond-cleaning-fredonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Fredonia",
          "description": "Professional pond cleaning services in Fredonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Fredonia"
        subtitle="Professional pond services for Pond Cleaning Services in Fredonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Fredonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Fredonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fredonia Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fredonia Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fredonia Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fredonia Customers Say About Our Pond Cleaning</h2>
