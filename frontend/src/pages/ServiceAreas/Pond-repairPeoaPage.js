...
const Pond-repairPeoaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Peoa | Professional Pond Repair Services"
        description="Expert pond repair services in Peoa. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, peoa pond repair, pond repair peoa"
        canonical="https://utahwatergardens.com/pond-repair-peoa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Peoa",
          "description": "Professional pond repair services in Peoa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Peoa"
        subtitle="Professional pond services for Pond Repair Services in Peoa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Peoa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Peoa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Peoa Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Peoa Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Peoa Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Peoa Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPeoaPage;