...
const Lake-dredgingRupertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Rupert | Professional Lake Dredging Services"
        description="Expert lake dredging services in Rupert. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, rupert lake dredging, lake dredging rupert"
        canonical="https://utahwatergardens.com/lake-dredging-rupert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Rupert",
          "description": "Professional lake dredging services in Rupert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Rupert"
        subtitle="Professional pond services for Lake Dredging Services in Rupert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Rupert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Rupert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rupert Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rupert Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rupert Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rupert Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingRupertPage;