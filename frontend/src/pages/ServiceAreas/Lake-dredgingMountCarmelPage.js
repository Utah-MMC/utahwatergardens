...
const Lake-dredgingMountCarmelPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mount Carmel | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mount Carmel. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mount carmel lake dredging, lake dredging mount carmel"
        canonical="https://utahwatergardens.com/lake-dredging-mount-carmel"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mount Carmel",
          "description": "Professional lake dredging services in Mount Carmel",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mount Carmel"
        subtitle="Professional pond services for Lake Dredging Services in Mount Carmel and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mount Carmel"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mount Carmel</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mount Carmel Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mount Carmel Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mount Carmel Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mount Carmel Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMountCarmelPage;