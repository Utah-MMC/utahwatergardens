  ...
  return (
    <div className="service-area-page">
      <PageHero 
        ...
        subtitle="Professional pond services for Grantsville and surrounding Tooele County areas"
      ...
      <div className="container">
        ...
        >
          <h2>Ready to Get Started in Grantsville?</h2>
          <p>Contact us today for a free consultation and quote on your Grantsville pond project.</p>
