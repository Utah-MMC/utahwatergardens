...
const Pond-repairLaytonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Layton | Professional Pond Repair Services"
        description="Expert pond repair services in Layton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, layton pond repair, pond repair layton"
        canonical="https://utahwatergardens.com/pond-repair-layton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Layton",
          "description": "Professional pond repair services in Layton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Layton"
        subtitle="Professional pond services for Pond Repair Services in Layton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Layton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Layton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Layton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Layton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Layton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Layton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLaytonPage;