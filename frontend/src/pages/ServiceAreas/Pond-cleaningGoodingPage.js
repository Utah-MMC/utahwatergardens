...
const Pond-cleaningGoodingPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Gooding | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Gooding. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, gooding pond cleaning, pond cleaning gooding"
        canonical="https://utahwatergardens.com/pond-cleaning-gooding"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Gooding",
          "description": "Professional pond cleaning services in Gooding",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Gooding"
        subtitle="Professional pond services for Pond Cleaning Services in Gooding and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Gooding"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Gooding</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gooding Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gooding Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gooding Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gooding Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningGoodingPage;