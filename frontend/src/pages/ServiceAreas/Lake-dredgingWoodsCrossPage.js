...
const Lake-dredgingWoodsCrossPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Woods Cross | Professional Lake Dredging Services"
        description="Expert lake dredging services in Woods Cross. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, woods cross lake dredging, lake dredging woods cross"
        canonical="https://utahwatergardens.com/lake-dredging-woods-cross"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Woods Cross",
          "description": "Professional lake dredging services in Woods Cross",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Woods Cross"
        subtitle="Professional pond services for Lake Dredging Services in Woods Cross and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Woods Cross"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Woods Cross</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Woods Cross Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Woods Cross Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Woods Cross Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Woods Cross Customers Say About Our Lake Dredging</h2>
