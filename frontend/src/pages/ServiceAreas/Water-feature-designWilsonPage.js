...
const Water-feature-designWilsonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Wilson | Professional Water Feature Design Services"
        description="Expert water feature design services in Wilson. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, wilson water feature design, water feature design wilson"
        canonical="https://utahwatergardens.com/water-feature-design-wilson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Wilson",
          "description": "Professional water feature design services in Wilson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Wilson"
        subtitle="Professional pond services for Water Feature Design Services in Wilson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Wilson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Wilson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wilson Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wilson Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wilson Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wilson Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designWilsonPage;