...
const Pond-cleaningGilbertPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Gilbert | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Gilbert. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, gilbert pond cleaning, pond cleaning gilbert"
        canonical="https://utahwatergardens.com/pond-cleaning-gilbert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Gilbert",
          "description": "Professional pond cleaning services in Gilbert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Gilbert"
        subtitle="Professional pond services for Pond Cleaning Services in Gilbert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Gilbert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Gilbert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gilbert Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gilbert Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gilbert Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gilbert Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningGilbertPage;