...
const Pond-repairVanTassellPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Van Tassell | Professional Pond Repair Services"
        description="Expert pond repair services in Van Tassell. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, van tassell pond repair, pond repair van tassell"
        canonical="https://utahwatergardens.com/pond-repair-van-tassell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Van Tassell",
          "description": "Professional pond repair services in Van Tassell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Van Tassell"
        subtitle="Professional pond services for Pond Repair Services in Van Tassell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Van Tassell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Van Tassell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Van Tassell Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Van Tassell Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Van Tassell Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Van Tassell Customers Say About Our Pond Repair</h2>
...
export default Pond-repairVanTassellPage;