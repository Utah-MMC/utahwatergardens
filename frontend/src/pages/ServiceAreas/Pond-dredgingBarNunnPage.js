...
const Pond-dredgingBarNunnPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Bar Nunn | Professional Pond Dredging Services"
        description="Expert pond dredging services in Bar Nunn. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, bar nunn pond dredging, pond dredging bar nunn"
        canonical="https://utahwatergardens.com/pond-dredging-bar-nunn"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Bar Nunn",
          "description": "Professional pond dredging services in Bar Nunn",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Bar Nunn"
        subtitle="Professional pond services for Pond Dredging Services in Bar Nunn and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Bar Nunn"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Bar Nunn</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bar Nunn Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bar Nunn Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bar Nunn Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bar Nunn Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBarNunnPage;