...
const Pond-dredgingMantuaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Mantua | Professional Pond Dredging Services"
        description="Expert pond dredging services in Mantua. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, mantua pond dredging, pond dredging mantua"
        canonical="https://utahwatergardens.com/pond-dredging-mantua"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Mantua",
          "description": "Professional pond dredging services in Mantua",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Mantua"
        subtitle="Professional pond services for Pond Dredging Services in Mantua and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Mantua"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Mantua</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mantua Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mantua Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mantua Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mantua Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMantuaPage;