...
const Pond-cleaningMayerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Mayer | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Mayer. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, mayer pond cleaning, pond cleaning mayer"
        canonical="https://utahwatergardens.com/pond-cleaning-mayer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Mayer",
          "description": "Professional pond cleaning services in Mayer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Mayer"
        subtitle="Professional pond services for Pond Cleaning Services in Mayer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Mayer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Mayer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mayer Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mayer Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mayer Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mayer Customers Say About Our Pond Cleaning</h2>
