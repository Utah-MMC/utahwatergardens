...
const Pond-cleaningVernonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Vernon | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Vernon. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, vernon pond cleaning, pond cleaning vernon"
        canonical="https://utahwatergardens.com/pond-cleaning-vernon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Vernon",
          "description": "Professional pond cleaning services in Vernon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Vernon"
        subtitle="Professional pond services for Pond Cleaning Services in Vernon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Vernon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Vernon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vernon Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vernon Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vernon Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vernon Customers Say About Our Pond Cleaning</h2>
