...
const Pond-dredgingKanabPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Kanab | Professional Pond Dredging Services"
        description="Expert pond dredging services in Kanab. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, kanab pond dredging, pond dredging kanab"
        canonical="https://utahwatergardens.com/pond-dredging-kanab"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Kanab",
          "description": "Professional pond dredging services in Kanab",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Kanab"
        subtitle="Professional pond services for Pond Dredging Services in Kanab and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Kanab"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Kanab</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kanab Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kanab Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kanab Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kanab Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingKanabPage;