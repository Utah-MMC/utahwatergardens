...
const Pond-cleaningIvinsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Ivins | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Ivins. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, ivins pond cleaning, pond cleaning ivins"
        canonical="https://utahwatergardens.com/pond-cleaning-ivins"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Ivins",
          "description": "Professional pond cleaning services in Ivins",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Ivins"
        subtitle="Professional pond services for Pond Cleaning Services in Ivins and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Ivins"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Ivins</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ivins Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ivins Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ivins Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ivins Customers Say About Our Pond Cleaning</h2>
