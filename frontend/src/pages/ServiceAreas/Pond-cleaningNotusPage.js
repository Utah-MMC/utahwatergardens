...
const Pond-cleaningNotusPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Notus | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Notus. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, notus pond cleaning, pond cleaning notus"
        canonical="https://utahwatergardens.com/pond-cleaning-notus"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Notus",
          "description": "Professional pond cleaning services in Notus",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Notus"
        subtitle="Professional pond services for Pond Cleaning Services in Notus and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Notus"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Notus</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Notus Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Notus Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Notus Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Notus Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningNotusPage;