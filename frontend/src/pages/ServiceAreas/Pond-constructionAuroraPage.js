...
const Pond-constructionAuroraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Aurora | Professional Pond Construction Services"
        description="Expert pond construction services in Aurora. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, aurora pond construction, pond construction aurora"
        canonical="https://utahwatergardens.com/pond-construction-aurora"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Aurora",
          "description": "Professional pond construction services in Aurora",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Aurora"
        subtitle="Professional pond services for Pond Construction Services in Aurora and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Aurora"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Aurora</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aurora Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aurora Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aurora Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aurora Customers Say About Our Pond Construction</h2>
