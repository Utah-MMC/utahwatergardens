...
const Pond-dredgingMaltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Malta | Professional Pond Dredging Services"
        description="Expert pond dredging services in Malta. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, malta pond dredging, pond dredging malta"
        canonical="https://utahwatergardens.com/pond-dredging-malta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Malta",
          "description": "Professional pond dredging services in Malta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Malta"
        subtitle="Professional pond services for Pond Dredging Services in Malta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Malta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Malta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Malta Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Malta Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Malta Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Malta Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMaltaPage;