...
const Pond-repairLaughlinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Laughlin | Professional Pond Repair Services"
        description="Expert pond repair services in Laughlin. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, laughlin pond repair, pond repair laughlin"
        canonical="https://utahwatergardens.com/pond-repair-laughlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Laughlin",
          "description": "Professional pond repair services in Laughlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Laughlin"
        subtitle="Professional pond services for Pond Repair Services in Laughlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Laughlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Laughlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Laughlin Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Laughlin Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Laughlin Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Laughlin Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLaughlinPage;