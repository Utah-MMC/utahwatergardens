...
const Pond-cleaningDammeronValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Dammeron Valley | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Dammeron Valley. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, dammeron valley pond cleaning, pond cleaning dammeron valley"
        canonical="https://utahwatergardens.com/pond-cleaning-dammeron-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Dammeron Valley",
          "description": "Professional pond cleaning services in Dammeron Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Dammeron Valley"
        subtitle="Professional pond services for Pond Cleaning Services in Dammeron Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Dammeron Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Dammeron Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dammeron Valley Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dammeron Valley Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dammeron Valley Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dammeron Valley Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDammeronValleyPage;