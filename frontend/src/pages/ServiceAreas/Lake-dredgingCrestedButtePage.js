...
const Lake-dredgingCrestedButtePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Crested Butte | Professional Lake Dredging Services"
        description="Expert lake dredging services in Crested Butte. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, crested butte lake dredging, lake dredging crested butte"
        canonical="https://utahwatergardens.com/lake-dredging-crested-butte"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Crested Butte",
          "description": "Professional lake dredging services in Crested Butte",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Crested Butte"
        subtitle="Professional pond services for Lake Dredging Services in Crested Butte and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Crested Butte"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Crested Butte</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crested Butte Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crested Butte Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crested Butte Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crested Butte Customers Say About Our Lake Dredging</h2>
