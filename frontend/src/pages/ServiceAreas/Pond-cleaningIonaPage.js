...
const Pond-cleaningIonaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Iona | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Iona. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, iona pond cleaning, pond cleaning iona"
        canonical="https://utahwatergardens.com/pond-cleaning-iona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Iona",
          "description": "Professional pond cleaning services in Iona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Iona"
        subtitle="Professional pond services for Pond Cleaning Services in Iona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Iona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Iona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Iona Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Iona Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Iona Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Iona Customers Say About Our Pond Cleaning</h2>
