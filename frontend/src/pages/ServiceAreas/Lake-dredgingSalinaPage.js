...
const Lake-dredgingSalinaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Salina | Professional Lake Dredging Services"
        description="Expert lake dredging services in Salina. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, salina lake dredging, lake dredging salina"
        canonical="https://utahwatergardens.com/lake-dredging-salina"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Salina",
          "description": "Professional lake dredging services in Salina",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Salina"
        subtitle="Professional pond services for Lake Dredging Services in Salina and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Salina"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Salina</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Salina Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Salina Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Salina Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Salina Customers Say About Our Lake Dredging</h2>
