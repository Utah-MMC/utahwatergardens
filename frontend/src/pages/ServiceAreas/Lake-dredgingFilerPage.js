...
const Lake-dredgingFilerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Filer | Professional Lake Dredging Services"
        description="Expert lake dredging services in Filer. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, filer lake dredging, lake dredging filer"
        canonical="https://utahwatergardens.com/lake-dredging-filer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Filer",
          "description": "Professional lake dredging services in Filer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Filer"
        subtitle="Professional pond services for Lake Dredging Services in Filer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Filer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Filer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Filer Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Filer Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Filer Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Filer Customers Say About Our Lake Dredging</h2>
