...
const Pond-cleaningKamasPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Kamas | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Kamas. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, kamas pond cleaning, pond cleaning kamas"
        canonical="https://utahwatergardens.com/pond-cleaning-kamas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Kamas",
          "description": "Professional pond cleaning services in Kamas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Kamas"
        subtitle="Professional pond services for Pond Cleaning Services in Kamas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Kamas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Kamas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kamas Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kamas Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kamas Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kamas Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningKamasPage;