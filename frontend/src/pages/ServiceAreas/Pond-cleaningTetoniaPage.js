...
const Pond-cleaningTetoniaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Tetonia | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Tetonia. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, tetonia pond cleaning, pond cleaning tetonia"
        canonical="https://utahwatergardens.com/pond-cleaning-tetonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Tetonia",
          "description": "Professional pond cleaning services in Tetonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Tetonia"
        subtitle="Professional pond services for Pond Cleaning Services in Tetonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Tetonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Tetonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tetonia Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tetonia Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tetonia Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tetonia Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningTetoniaPage;