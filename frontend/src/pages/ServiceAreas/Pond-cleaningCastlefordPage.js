...
const Pond-cleaningCastlefordPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Castleford | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Castleford. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, castleford pond cleaning, pond cleaning castleford"
        canonical="https://utahwatergardens.com/pond-cleaning-castleford"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Castleford",
          "description": "Professional pond cleaning services in Castleford",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Castleford"
        subtitle="Professional pond services for Pond Cleaning Services in Castleford and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Castleford"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Castleford</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Castleford Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Castleford Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Castleford Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Castleford Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCastlefordPage;