...
const Pond-cleaningHolladayPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Holladay | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Holladay. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, holladay pond cleaning, pond cleaning holladay"
        canonical="https://utahwatergardens.com/pond-cleaning-holladay"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Holladay",
          "description": "Professional pond cleaning services in Holladay",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Holladay"
        subtitle="Professional pond services for Pond Cleaning Services in Holladay and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Holladay"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Holladay</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Holladay Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Holladay Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Holladay Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Holladay Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningHolladayPage;