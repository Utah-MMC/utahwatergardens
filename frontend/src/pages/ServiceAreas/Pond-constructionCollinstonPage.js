...
const Pond-constructionCollinstonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Collinston | Professional Pond Construction Services"
        description="Expert pond construction services in Collinston. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, collinston pond construction, pond construction collinston"
        canonical="https://utahwatergardens.com/pond-construction-collinston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Collinston",
          "description": "Professional pond construction services in Collinston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Collinston"
        subtitle="Professional pond services for Pond Construction Services in Collinston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Collinston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Collinston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Collinston Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Collinston Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Collinston Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Collinston Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionCollinstonPage;