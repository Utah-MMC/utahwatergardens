...
const Pond-cleaningElMiragePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning El Mirage | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in El Mirage. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, el mirage pond cleaning, pond cleaning el mirage"
        canonical="https://utahwatergardens.com/pond-cleaning-el-mirage"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services El Mirage",
          "description": "Professional pond cleaning services in El Mirage",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in El Mirage"
        subtitle="Professional pond services for Pond Cleaning Services in El Mirage and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in El Mirage"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in El Mirage</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our El Mirage Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="El Mirage Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our El Mirage Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What El Mirage Customers Say About Our Pond Cleaning</h2>
