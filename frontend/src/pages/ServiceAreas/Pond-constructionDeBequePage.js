...
const Pond-constructionDeBequePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction De Beque | Professional Pond Construction Services"
        description="Expert pond construction services in De Beque. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, de beque pond construction, pond construction de beque"
        canonical="https://utahwatergardens.com/pond-construction-de-beque"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services De Beque",
          "description": "Professional pond construction services in De Beque",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in De Beque"
        subtitle="Professional pond services for Pond Construction Services in De Beque and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in De Beque"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in De Beque</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our De Beque Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="De Beque Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our De Beque Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What De Beque Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionDeBequePage;