...
const Pond-cleaningSandyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Sandy | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Sandy. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, sandy pond cleaning, pond cleaning sandy"
        canonical="https://utahwatergardens.com/pond-cleaning-sandy"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Sandy",
          "description": "Professional pond cleaning services in Sandy",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Sandy"
        subtitle="Professional pond services for Pond Cleaning Services in Sandy and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Sandy"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Sandy</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sandy Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sandy Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sandy Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sandy Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSandyPage;