...
const Lake-dredgingBigPineyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Big Piney | Professional Lake Dredging Services"
        description="Expert lake dredging services in Big Piney. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, big piney lake dredging, lake dredging big piney"
        canonical="https://utahwatergardens.com/lake-dredging-big-piney"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Big Piney",
          "description": "Professional lake dredging services in Big Piney",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Big Piney"
        subtitle="Professional pond services for Lake Dredging Services in Big Piney and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Big Piney"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Big Piney</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Big Piney Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Big Piney Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Big Piney Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Big Piney Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingBigPineyPage;