...
const Pond-dredgingWashingtonTerracePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Washington Terrace | Professional Pond Dredging Services"
        description="Expert pond dredging services in Washington Terrace. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, washington terrace pond dredging, pond dredging washington terrace"
        canonical="https://utahwatergardens.com/pond-dredging-washington-terrace"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Washington Terrace",
          "description": "Professional pond dredging services in Washington Terrace",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Washington Terrace"
        subtitle="Professional pond services for Pond Dredging Services in Washington Terrace and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Washington Terrace"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Washington Terrace</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Washington Terrace Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Washington Terrace Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Washington Terrace Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Washington Terrace Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWashingtonTerracePage;