...
const Pond-cleaningHikoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Hiko | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Hiko. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, hiko pond cleaning, pond cleaning hiko"
        canonical="https://utahwatergardens.com/pond-cleaning-hiko"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Hiko",
          "description": "Professional pond cleaning services in Hiko",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Hiko"
        subtitle="Professional pond services for Pond Cleaning Services in Hiko and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Hiko"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Hiko</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hiko Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hiko Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hiko Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hiko Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningHikoPage;