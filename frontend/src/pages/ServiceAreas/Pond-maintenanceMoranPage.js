...
const Pond-maintenanceMoranPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Moran | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Moran. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, moran pond maintenance, pond maintenance moran"
        canonical="https://utahwatergardens.com/pond-maintenance-moran"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Moran",
          "description": "Professional pond maintenance services in Moran",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Moran"
        subtitle="Professional pond services for Pond Maintenance Services in Moran and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Moran"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Moran</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moran Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moran Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moran Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moran Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceMoranPage;