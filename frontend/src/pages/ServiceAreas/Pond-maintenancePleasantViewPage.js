...
const Pond-maintenancePleasantViewPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Pleasant View | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Pleasant View. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, pleasant view pond maintenance, pond maintenance pleasant view"
        canonical="https://utahwatergardens.com/pond-maintenance-pleasant-view"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Pleasant View",
          "description": "Professional pond maintenance services in Pleasant View",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Pleasant View"
        subtitle="Professional pond services for Pond Maintenance Services in Pleasant View and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Pleasant View"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Pleasant View</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pleasant View Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pleasant View Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pleasant View Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pleasant View Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenancePleasantViewPage;