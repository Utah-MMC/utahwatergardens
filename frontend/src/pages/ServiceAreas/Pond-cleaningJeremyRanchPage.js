...
const Pond-cleaningJeremyRanchPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Jeremy Ranch | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Jeremy Ranch. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, jeremy ranch pond cleaning, pond cleaning jeremy ranch"
        canonical="https://utahwatergardens.com/pond-cleaning-jeremy-ranch"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Jeremy Ranch",
          "description": "Professional pond cleaning services in Jeremy Ranch",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Jeremy Ranch"
        subtitle="Professional pond services for Pond Cleaning Services in Jeremy Ranch and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Jeremy Ranch"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Jeremy Ranch</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jeremy Ranch Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jeremy Ranch Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jeremy Ranch Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jeremy Ranch Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningJeremyRanchPage;