...
const Pond-cleaningRupertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Rupert | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Rupert. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, rupert pond cleaning, pond cleaning rupert"
        canonical="https://utahwatergardens.com/pond-cleaning-rupert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Rupert",
          "description": "Professional pond cleaning services in Rupert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Rupert"
        subtitle="Professional pond services for Pond Cleaning Services in Rupert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Rupert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Rupert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rupert Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rupert Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rupert Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rupert Customers Say About Our Pond Cleaning</h2>
