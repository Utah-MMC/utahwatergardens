...
const Pond-cleaningFlagstaffPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Flagstaff | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Flagstaff. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, flagstaff pond cleaning, pond cleaning flagstaff"
        canonical="https://utahwatergardens.com/pond-cleaning-flagstaff"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Flagstaff",
          "description": "Professional pond cleaning services in Flagstaff",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Flagstaff"
        subtitle="Professional pond services for Pond Cleaning Services in Flagstaff and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Flagstaff"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Flagstaff</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Flagstaff Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Flagstaff Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Flagstaff Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Flagstaff Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningFlagstaffPage;