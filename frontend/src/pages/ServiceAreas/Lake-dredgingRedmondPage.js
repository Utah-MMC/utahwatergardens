...
const Lake-dredgingRedmondPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Redmond | Professional Lake Dredging Services"
        description="Expert lake dredging services in Redmond. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, redmond lake dredging, lake dredging redmond"
        canonical="https://utahwatergardens.com/lake-dredging-redmond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Redmond",
          "description": "Professional lake dredging services in Redmond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Redmond"
        subtitle="Professional pond services for Lake Dredging Services in Redmond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Redmond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Redmond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Redmond Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Redmond Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Redmond Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Redmond Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingRedmondPage;