...
const Lake-dredgingCentralPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Central | Professional Lake Dredging Services"
        description="Expert lake dredging services in Central. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, central lake dredging, lake dredging central"
        canonical="https://utahwatergardens.com/lake-dredging-central"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Central",
          "description": "Professional lake dredging services in Central",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Central"
        subtitle="Professional pond services for Lake Dredging Services in Central and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Central"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Central</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Central Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Central Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Central Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Central Customers Say About Our Lake Dredging</h2>
