...
const Pond-maintenanceBlueDiamondPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Blue Diamond | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Blue Diamond. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, blue diamond pond maintenance, pond maintenance blue diamond"
        canonical="https://utahwatergardens.com/pond-maintenance-blue-diamond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Blue Diamond",
          "description": "Professional pond maintenance services in Blue Diamond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Blue Diamond"
        subtitle="Professional pond services for Pond Maintenance Services in Blue Diamond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Blue Diamond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Blue Diamond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Blue Diamond Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Blue Diamond Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Blue Diamond Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Blue Diamond Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceBlueDiamondPage;