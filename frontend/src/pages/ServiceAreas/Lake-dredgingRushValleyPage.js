...
const Lake-dredgingRushValleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Rush Valley | Professional Lake Dredging Services"
        description="Expert lake dredging services in Rush Valley. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, rush valley lake dredging, lake dredging rush valley"
        canonical="https://utahwatergardens.com/lake-dredging-rush-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Rush Valley",
          "description": "Professional lake dredging services in Rush Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Rush Valley"
        subtitle="Professional pond services for Lake Dredging Services in Rush Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Rush Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Rush Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rush Valley Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rush Valley Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rush Valley Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rush Valley Customers Say About Our Lake Dredging</h2>
