...
const Pond-repairWeiserPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Weiser | Professional Pond Repair Services"
        description="Expert pond repair services in Weiser. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, weiser pond repair, pond repair weiser"
        canonical="https://utahwatergardens.com/pond-repair-weiser"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Weiser",
          "description": "Professional pond repair services in Weiser",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Weiser"
        subtitle="Professional pond services for Pond Repair Services in Weiser and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Weiser"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Weiser</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Weiser Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Weiser Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Weiser Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Weiser Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWeiserPage;