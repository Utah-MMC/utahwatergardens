...
const Pond-constructionSpringvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Springville | Professional Pond Construction Services"
        description="Expert pond construction services in Springville. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, springville pond construction, pond construction springville"
        canonical="https://utahwatergardens.com/pond-construction-springville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Springville",
          "description": "Professional pond construction services in Springville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Springville"
        subtitle="Professional pond services for Pond Construction Services in Springville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Springville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Springville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Springville Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Springville Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Springville Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Springville Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSpringvillePage;