...
const Pond-dredgingMagnaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Magna | Professional Pond Dredging Services"
        description="Expert pond dredging services in Magna. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, magna pond dredging, pond dredging magna"
        canonical="https://utahwatergardens.com/pond-dredging-magna"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Magna",
          "description": "Professional pond dredging services in Magna",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Magna"
        subtitle="Professional pond services for Pond Dredging Services in Magna and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Magna"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Magna</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Magna Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Magna Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Magna Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Magna Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMagnaPage;