...
const Pond-repairQueenCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Queen Creek | Professional Pond Repair Services"
        description="Expert pond repair services in Queen Creek. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, queen creek pond repair, pond repair queen creek"
        canonical="https://utahwatergardens.com/pond-repair-queen-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Queen Creek",
          "description": "Professional pond repair services in Queen Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Queen Creek"
        subtitle="Professional pond services for Pond Repair Services in Queen Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Queen Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Queen Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Queen Creek Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Queen Creek Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Queen Creek Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Queen Creek Customers Say About Our Pond Repair</h2>
...
export default Pond-repairQueenCreekPage;