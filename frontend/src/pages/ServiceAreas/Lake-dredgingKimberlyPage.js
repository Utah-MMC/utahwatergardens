...
const Lake-dredgingKimberlyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Kimberly | Professional Lake Dredging Services"
        description="Expert lake dredging services in Kimberly. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, kimberly lake dredging, lake dredging kimberly"
        canonical="https://utahwatergardens.com/lake-dredging-kimberly"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Kimberly",
          "description": "Professional lake dredging services in Kimberly",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Kimberly"
        subtitle="Professional pond services for Lake Dredging Services in Kimberly and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Kimberly"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Kimberly</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kimberly Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kimberly Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kimberly Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kimberly Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingKimberlyPage;