...
const Pond-dredgingHyrumPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hyrum | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hyrum. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hyrum pond dredging, pond dredging hyrum"
        canonical="https://utahwatergardens.com/pond-dredging-hyrum"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hyrum",
          "description": "Professional pond dredging services in Hyrum",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hyrum"
        subtitle="Professional pond services for Pond Dredging Services in Hyrum and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hyrum"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hyrum</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hyrum Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hyrum Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hyrum Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hyrum Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHyrumPage;