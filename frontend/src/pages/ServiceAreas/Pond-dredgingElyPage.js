...
const Pond-dredgingElyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Ely | Professional Pond Dredging Services"
        description="Expert pond dredging services in Ely. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, ely pond dredging, pond dredging ely"
        canonical="https://utahwatergardens.com/pond-dredging-ely"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Ely",
          "description": "Professional pond dredging services in Ely",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Ely"
        subtitle="Professional pond services for Pond Dredging Services in Ely and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Ely"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Ely</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ely Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ely Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ely Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ely Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingElyPage;