...
const Pond-dredgingWestJordanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging West Jordan | Professional Pond Dredging Services"
        description="Expert pond dredging services in West Jordan. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, west jordan pond dredging, pond dredging west jordan"
        canonical="https://utahwatergardens.com/pond-dredging-west-jordan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services West Jordan",
          "description": "Professional pond dredging services in West Jordan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in West Jordan"
        subtitle="Professional pond services for Pond Dredging Services in West Jordan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in West Jordan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in West Jordan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Jordan Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Jordan Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Jordan Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Jordan Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWestJordanPage;