...
const Pond-dredgingScofieldPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Scofield | Professional Pond Dredging Services"
        description="Expert pond dredging services in Scofield. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, scofield pond dredging, pond dredging scofield"
        canonical="https://utahwatergardens.com/pond-dredging-scofield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Scofield",
          "description": "Professional pond dredging services in Scofield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Scofield"
        subtitle="Professional pond services for Pond Dredging Services in Scofield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Scofield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Scofield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Scofield Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Scofield Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Scofield Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Scofield Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingScofieldPage;