...
const Pond-dredgingLitchfieldParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Litchfield Park | Professional Pond Dredging Services"
        description="Expert pond dredging services in Litchfield Park. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, litchfield park pond dredging, pond dredging litchfield park"
        canonical="https://utahwatergardens.com/pond-dredging-litchfield-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Litchfield Park",
          "description": "Professional pond dredging services in Litchfield Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Litchfield Park"
        subtitle="Professional pond services for Pond Dredging Services in Litchfield Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Litchfield Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Litchfield Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Litchfield Park Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Litchfield Park Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Litchfield Park Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Litchfield Park Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLitchfieldParkPage;