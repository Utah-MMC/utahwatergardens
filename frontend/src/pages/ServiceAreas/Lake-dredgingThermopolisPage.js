...
const Lake-dredgingThermopolisPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Thermopolis | Professional Lake Dredging Services"
        description="Expert lake dredging services in Thermopolis. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, thermopolis lake dredging, lake dredging thermopolis"
        canonical="https://utahwatergardens.com/lake-dredging-thermopolis"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Thermopolis",
          "description": "Professional lake dredging services in Thermopolis",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Thermopolis"
        subtitle="Professional pond services for Lake Dredging Services in Thermopolis and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Thermopolis"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Thermopolis</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Thermopolis Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Thermopolis Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Thermopolis Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Thermopolis Customers Say About Our Lake Dredging</h2>
