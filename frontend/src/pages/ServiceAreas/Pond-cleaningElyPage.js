...
const Pond-cleaningElyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Ely | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Ely. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, ely pond cleaning, pond cleaning ely"
        canonical="https://utahwatergardens.com/pond-cleaning-ely"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Ely",
          "description": "Professional pond cleaning services in Ely",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Ely"
        subtitle="Professional pond services for Pond Cleaning Services in Ely and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Ely"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Ely</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ely Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ely Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ely Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ely Customers Say About Our Pond Cleaning</h2>
