...
const Lake-dredgingHawkSpringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Hawk Springs | Professional Lake Dredging Services"
        description="Expert lake dredging services in Hawk Springs. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, hawk springs lake dredging, lake dredging hawk springs"
        canonical="https://utahwatergardens.com/lake-dredging-hawk-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Hawk Springs",
          "description": "Professional lake dredging services in Hawk Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Hawk Springs"
        subtitle="Professional pond services for Lake Dredging Services in Hawk Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Hawk Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Hawk Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hawk Springs Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hawk Springs Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hawk Springs Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hawk Springs Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingHawkSpringsPage;