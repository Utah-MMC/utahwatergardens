...
const Pond-repairOpalPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Opal | Professional Pond Repair Services"
        description="Expert pond repair services in Opal. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, opal pond repair, pond repair opal"
        canonical="https://utahwatergardens.com/pond-repair-opal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Opal",
          "description": "Professional pond repair services in Opal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Opal"
        subtitle="Professional pond services for Pond Repair Services in Opal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Opal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Opal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Opal Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Opal Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Opal Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Opal Customers Say About Our Pond Repair</h2>
...
export default Pond-repairOpalPage;