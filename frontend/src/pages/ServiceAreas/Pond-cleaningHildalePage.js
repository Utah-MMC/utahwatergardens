...
const Pond-cleaningHildalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Hildale | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Hildale. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, hildale pond cleaning, pond cleaning hildale"
        canonical="https://utahwatergardens.com/pond-cleaning-hildale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Hildale",
          "description": "Professional pond cleaning services in Hildale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Hildale"
        subtitle="Professional pond services for Pond Cleaning Services in Hildale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Hildale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Hildale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hildale Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hildale Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hildale Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hildale Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningHildalePage;