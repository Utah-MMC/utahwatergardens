...
const Pond-dredgingJayEmPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Jay Em | Professional Pond Dredging Services"
        description="Expert pond dredging services in Jay Em. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, jay em pond dredging, pond dredging jay em"
        canonical="https://utahwatergardens.com/pond-dredging-jay-em"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Jay Em",
          "description": "Professional pond dredging services in Jay Em",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Jay Em"
        subtitle="Professional pond services for Pond Dredging Services in Jay Em and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Jay Em"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Jay Em</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jay Em Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jay Em Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jay Em Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jay Em Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingJayEmPage;