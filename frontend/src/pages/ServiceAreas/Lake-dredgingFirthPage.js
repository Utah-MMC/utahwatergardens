...
const Lake-dredgingFirthPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Firth | Professional Lake Dredging Services"
        description="Expert lake dredging services in Firth. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, firth lake dredging, lake dredging firth"
        canonical="https://utahwatergardens.com/lake-dredging-firth"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Firth",
          "description": "Professional lake dredging services in Firth",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Firth"
        subtitle="Professional pond services for Lake Dredging Services in Firth and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Firth"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Firth</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Firth Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Firth Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Firth Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Firth Customers Say About Our Lake Dredging</h2>
