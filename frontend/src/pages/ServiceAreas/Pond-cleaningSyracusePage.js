...
const Pond-cleaningSyracusePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Syracuse | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Syracuse. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, syracuse pond cleaning, pond cleaning syracuse"
        canonical="https://utahwatergardens.com/pond-cleaning-syracuse"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Syracuse",
          "description": "Professional pond cleaning services in Syracuse",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Syracuse"
        subtitle="Professional pond services for Pond Cleaning Services in Syracuse and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Syracuse"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Syracuse</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Syracuse Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Syracuse Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Syracuse Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Syracuse Customers Say About Our Pond Cleaning</h2>
