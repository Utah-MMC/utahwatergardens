...
const Pond-dredgingGoldCanyonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Gold Canyon | Professional Pond Dredging Services"
        description="Expert pond dredging services in Gold Canyon. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, gold canyon pond dredging, pond dredging gold canyon"
        canonical="https://utahwatergardens.com/pond-dredging-gold-canyon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Gold Canyon",
          "description": "Professional pond dredging services in Gold Canyon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Gold Canyon"
        subtitle="Professional pond services for Pond Dredging Services in Gold Canyon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Gold Canyon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Gold Canyon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gold Canyon Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gold Canyon Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gold Canyon Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gold Canyon Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingGoldCanyonPage;