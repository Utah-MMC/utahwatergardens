...
const Pond-cleaningPenrosePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Penrose | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Penrose. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, penrose pond cleaning, pond cleaning penrose"
        canonical="https://utahwatergardens.com/pond-cleaning-penrose"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Penrose",
          "description": "Professional pond cleaning services in Penrose",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Penrose"
        subtitle="Professional pond services for Pond Cleaning Services in Penrose and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Penrose"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Penrose</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Penrose Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Penrose Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Penrose Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Penrose Customers Say About Our Pond Cleaning</h2>
