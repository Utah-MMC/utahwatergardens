...
const Pond-repairGrandJunctionPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Grand Junction | Professional Pond Repair Services"
        description="Expert pond repair services in Grand Junction. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, grand junction pond repair, pond repair grand junction"
        canonical="https://utahwatergardens.com/pond-repair-grand-junction"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Grand Junction",
          "description": "Professional pond repair services in Grand Junction",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Grand Junction"
        subtitle="Professional pond services for Pond Repair Services in Grand Junction and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Grand Junction"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Grand Junction</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Grand Junction Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Grand Junction Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Grand Junction Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Grand Junction Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGrandJunctionPage;