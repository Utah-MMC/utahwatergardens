...
const Pond-repairBurleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Burley | Professional Pond Repair Services"
        description="Expert pond repair services in Burley. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, burley pond repair, pond repair burley"
        canonical="https://utahwatergardens.com/pond-repair-burley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Burley",
          "description": "Professional pond repair services in Burley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Burley"
        subtitle="Professional pond services for Pond Repair Services in Burley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Burley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Burley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Burley Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Burley Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Burley Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Burley Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBurleyPage;