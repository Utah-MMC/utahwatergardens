...
const Pond-dredgingDriggsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Driggs | Professional Pond Dredging Services"
        description="Expert pond dredging services in Driggs. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, driggs pond dredging, pond dredging driggs"
        canonical="https://utahwatergardens.com/pond-dredging-driggs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Driggs",
          "description": "Professional pond dredging services in Driggs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Driggs"
        subtitle="Professional pond services for Pond Dredging Services in Driggs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Driggs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Driggs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Driggs Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Driggs Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Driggs Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Driggs Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingDriggsPage;