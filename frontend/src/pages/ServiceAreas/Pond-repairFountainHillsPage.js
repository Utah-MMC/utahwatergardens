...
const Pond-repairFountainHillsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Fountain Hills | Professional Pond Repair Services"
        description="Expert pond repair services in Fountain Hills. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, fountain hills pond repair, pond repair fountain hills"
        canonical="https://utahwatergardens.com/pond-repair-fountain-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Fountain Hills",
          "description": "Professional pond repair services in Fountain Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Fountain Hills"
        subtitle="Professional pond services for Pond Repair Services in Fountain Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Fountain Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Fountain Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fountain Hills Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fountain Hills Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fountain Hills Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fountain Hills Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFountainHillsPage;