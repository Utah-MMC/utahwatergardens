...
const Pond-cleaningRigbyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Rigby | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Rigby. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, rigby pond cleaning, pond cleaning rigby"
        canonical="https://utahwatergardens.com/pond-cleaning-rigby"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Rigby",
          "description": "Professional pond cleaning services in Rigby",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Rigby"
        subtitle="Professional pond services for Pond Cleaning Services in Rigby and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Rigby"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Rigby</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rigby Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rigby Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rigby Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rigby Customers Say About Our Pond Cleaning</h2>
