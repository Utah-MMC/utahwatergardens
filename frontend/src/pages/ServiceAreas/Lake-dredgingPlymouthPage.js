...
const Lake-dredgingPlymouthPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Plymouth | Professional Lake Dredging Services"
        description="Expert lake dredging services in Plymouth. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, plymouth lake dredging, lake dredging plymouth"
        canonical="https://utahwatergardens.com/lake-dredging-plymouth"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Plymouth",
          "description": "Professional lake dredging services in Plymouth",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Plymouth"
        subtitle="Professional pond services for Lake Dredging Services in Plymouth and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Plymouth"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Plymouth</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Plymouth Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Plymouth Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Plymouth Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Plymouth Customers Say About Our Lake Dredging</h2>
