...
const Pond-dredgingLostSpringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lost Springs | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lost Springs. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lost springs pond dredging, pond dredging lost springs"
        canonical="https://utahwatergardens.com/pond-dredging-lost-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lost Springs",
          "description": "Professional pond dredging services in Lost Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lost Springs"
        subtitle="Professional pond services for Pond Dredging Services in Lost Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lost Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lost Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lost Springs Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lost Springs Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lost Springs Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lost Springs Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLostSpringsPage;