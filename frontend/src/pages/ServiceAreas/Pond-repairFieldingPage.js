...
const Pond-repairFieldingPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Fielding | Professional Pond Repair Services"
        description="Expert pond repair services in Fielding. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, fielding pond repair, pond repair fielding"
        canonical="https://utahwatergardens.com/pond-repair-fielding"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Fielding",
          "description": "Professional pond repair services in Fielding",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Fielding"
        subtitle="Professional pond services for Pond Repair Services in Fielding and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Fielding"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Fielding</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fielding Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fielding Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fielding Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fielding Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFieldingPage;