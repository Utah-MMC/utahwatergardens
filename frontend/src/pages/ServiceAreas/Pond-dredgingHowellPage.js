...
const Pond-dredgingHowellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Howell | Professional Pond Dredging Services"
        description="Expert pond dredging services in Howell. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, howell pond dredging, pond dredging howell"
        canonical="https://utahwatergardens.com/pond-dredging-howell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Howell",
          "description": "Professional pond dredging services in Howell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Howell"
        subtitle="Professional pond services for Pond Dredging Services in Howell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Howell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Howell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Howell Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Howell Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Howell Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Howell Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHowellPage;