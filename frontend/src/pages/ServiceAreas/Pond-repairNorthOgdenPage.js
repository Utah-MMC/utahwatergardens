...
const Pond-repairNorthOgdenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair North Ogden | Professional Pond Repair Services"
        description="Expert pond repair services in North Ogden. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, north ogden pond repair, pond repair north ogden"
        canonical="https://utahwatergardens.com/pond-repair-north-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services North Ogden",
          "description": "Professional pond repair services in North Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in North Ogden"
        subtitle="Professional pond services for Pond Repair Services in North Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in North Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in North Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Ogden Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Ogden Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Ogden Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Ogden Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNorthOgdenPage;