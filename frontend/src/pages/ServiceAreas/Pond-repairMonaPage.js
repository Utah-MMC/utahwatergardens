...
const Pond-repairMonaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Mona | Professional Pond Repair Services"
        description="Expert pond repair services in Mona. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, mona pond repair, pond repair mona"
        canonical="https://utahwatergardens.com/pond-repair-mona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Mona",
          "description": "Professional pond repair services in Mona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Mona"
        subtitle="Professional pond services for Pond Repair Services in Mona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Mona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Mona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mona Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mona Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mona Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mona Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMonaPage;