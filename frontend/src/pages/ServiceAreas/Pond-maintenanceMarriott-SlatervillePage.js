...
const Pond-maintenanceMarriott-SlatervillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Marriott-Slaterville | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Marriott-Slaterville. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, marriott-slaterville pond maintenance, pond maintenance marriott-slaterville"
        canonical="https://utahwatergardens.com/pond-maintenance-marriott-slaterville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Marriott-Slaterville",
          "description": "Professional pond maintenance services in Marriott-Slaterville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Marriott-Slaterville"
        subtitle="Professional pond services for Pond Maintenance Services in Marriott-Slaterville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Marriott-Slaterville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Marriott-Slaterville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marriott-Slaterville Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marriott-Slaterville Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marriott-Slaterville Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marriott-Slaterville Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceMarriott-SlatervillePage;