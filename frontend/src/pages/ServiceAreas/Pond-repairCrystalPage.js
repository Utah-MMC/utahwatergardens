...
const Pond-repairCrystalPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Crystal | Professional Pond Repair Services"
        description="Expert pond repair services in Crystal. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, crystal pond repair, pond repair crystal"
        canonical="https://utahwatergardens.com/pond-repair-crystal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Crystal",
          "description": "Professional pond repair services in Crystal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Crystal"
        subtitle="Professional pond services for Pond Repair Services in Crystal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Crystal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Crystal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crystal Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crystal Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crystal Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crystal Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCrystalPage;