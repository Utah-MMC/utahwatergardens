...
const Lake-dredgingFruitaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Fruita | Professional Lake Dredging Services"
        description="Expert lake dredging services in Fruita. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, fruita lake dredging, lake dredging fruita"
        canonical="https://utahwatergardens.com/lake-dredging-fruita"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Fruita",
          "description": "Professional lake dredging services in Fruita",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Fruita"
        subtitle="Professional pond services for Lake Dredging Services in Fruita and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Fruita"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Fruita</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruita Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruita Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruita Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruita Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingFruitaPage;