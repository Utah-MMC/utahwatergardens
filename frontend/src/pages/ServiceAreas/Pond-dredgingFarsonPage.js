...
const Pond-dredgingFarsonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Farson | Professional Pond Dredging Services"
        description="Expert pond dredging services in Farson. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, farson pond dredging, pond dredging farson"
        canonical="https://utahwatergardens.com/pond-dredging-farson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Farson",
          "description": "Professional pond dredging services in Farson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Farson"
        subtitle="Professional pond services for Pond Dredging Services in Farson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Farson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Farson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farson Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farson Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farson Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farson Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFarsonPage;