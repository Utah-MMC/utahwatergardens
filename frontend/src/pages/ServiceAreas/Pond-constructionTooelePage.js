...
const Pond-constructionTooelePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Tooele | Professional Pond Construction Services"
        description="Expert pond construction services in Tooele. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, tooele pond construction, pond construction tooele"
        canonical="https://utahwatergardens.com/pond-construction-tooele"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Tooele",
          "description": "Professional pond construction services in Tooele",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Tooele"
        subtitle="Professional pond services for Pond Construction Services in Tooele and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Tooele"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Tooele</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tooele Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tooele Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tooele Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tooele Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionTooelePage;