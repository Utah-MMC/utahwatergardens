...
const Pond-cleaningWilsonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Wilson | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Wilson. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, wilson pond cleaning, pond cleaning wilson"
        canonical="https://utahwatergardens.com/pond-cleaning-wilson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Wilson",
          "description": "Professional pond cleaning services in Wilson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Wilson"
        subtitle="Professional pond services for Pond Cleaning Services in Wilson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Wilson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Wilson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wilson Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wilson Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wilson Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wilson Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningWilsonPage;