...
const Pond-cleaningAlbinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Albin | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Albin. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, albin pond cleaning, pond cleaning albin"
        canonical="https://utahwatergardens.com/pond-cleaning-albin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Albin",
          "description": "Professional pond cleaning services in Albin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Albin"
        subtitle="Professional pond services for Pond Cleaning Services in Albin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Albin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Albin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Albin Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Albin Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Albin Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Albin Customers Say About Our Pond Cleaning</h2>
