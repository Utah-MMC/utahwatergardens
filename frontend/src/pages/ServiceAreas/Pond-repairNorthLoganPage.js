...
const Pond-repairNorthLoganPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair North Logan | Professional Pond Repair Services"
        description="Expert pond repair services in North Logan. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, north logan pond repair, pond repair north logan"
        canonical="https://utahwatergardens.com/pond-repair-north-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services North Logan",
          "description": "Professional pond repair services in North Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in North Logan"
        subtitle="Professional pond services for Pond Repair Services in North Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in North Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in North Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Logan Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Logan Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Logan Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Logan Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNorthLoganPage;