...
const Lake-dredgingTetonVillagePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Teton Village | Professional Lake Dredging Services"
        description="Expert lake dredging services in Teton Village. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, teton village lake dredging, lake dredging teton village"
        canonical="https://utahwatergardens.com/lake-dredging-teton-village"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Teton Village",
          "description": "Professional lake dredging services in Teton Village",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Teton Village"
        subtitle="Professional pond services for Lake Dredging Services in Teton Village and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Teton Village"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Teton Village</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Teton Village Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Teton Village Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Teton Village Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Teton Village Customers Say About Our Lake Dredging</h2>
