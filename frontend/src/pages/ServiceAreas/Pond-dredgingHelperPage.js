...
const Pond-dredgingHelperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Helper | Professional Pond Dredging Services"
        description="Expert pond dredging services in Helper. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, helper pond dredging, pond dredging helper"
        canonical="https://utahwatergardens.com/pond-dredging-helper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Helper",
          "description": "Professional pond dredging services in Helper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Helper"
        subtitle="Professional pond services for Pond Dredging Services in Helper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Helper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Helper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Helper Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Helper Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Helper Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Helper Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHelperPage;