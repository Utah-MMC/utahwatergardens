...
const Pond-dredgingCaldwellPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Caldwell | Professional Pond Dredging Services"
        description="Expert pond dredging services in Caldwell. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, caldwell pond dredging, pond dredging caldwell"
        canonical="https://utahwatergardens.com/pond-dredging-caldwell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Caldwell",
          "description": "Professional pond dredging services in Caldwell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Caldwell"
        subtitle="Professional pond services for Pond Dredging Services in Caldwell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Caldwell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Caldwell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Caldwell Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Caldwell Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Caldwell Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Caldwell Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCaldwellPage;