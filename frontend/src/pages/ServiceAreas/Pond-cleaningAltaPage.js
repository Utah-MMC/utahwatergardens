...
const Pond-cleaningAltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Alta | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Alta. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, alta pond cleaning, pond cleaning alta"
        canonical="https://utahwatergardens.com/pond-cleaning-alta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Alta",
          "description": "Professional pond cleaning services in Alta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Alta"
        subtitle="Professional pond services for Pond Cleaning Services in Alta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Alta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Alta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alta Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alta Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alta Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alta Customers Say About Our Pond Cleaning</h2>
