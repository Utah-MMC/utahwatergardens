...
const Pond-repairGenolaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Genola | Professional Pond Repair Services"
        description="Expert pond repair services in Genola. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, genola pond repair, pond repair genola"
        canonical="https://utahwatergardens.com/pond-repair-genola"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Genola",
          "description": "Professional pond repair services in Genola",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Genola"
        subtitle="Professional pond services for Pond Repair Services in Genola and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Genola"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Genola</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Genola Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Genola Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Genola Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Genola Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGenolaPage;