...
const Pond-cleaningMesaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Mesa | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Mesa. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, mesa pond cleaning, pond cleaning mesa"
        canonical="https://utahwatergardens.com/pond-cleaning-mesa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Mesa",
          "description": "Professional pond cleaning services in Mesa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Mesa"
        subtitle="Professional pond services for Pond Cleaning Services in Mesa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Mesa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Mesa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mesa Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mesa Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mesa Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mesa Customers Say About Our Pond Cleaning</h2>
