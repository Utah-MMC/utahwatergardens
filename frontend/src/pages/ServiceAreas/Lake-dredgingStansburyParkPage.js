...
const Lake-dredgingStansburyParkPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Stansbury Park | Professional Lake Dredging Services"
        description="Expert lake dredging services in Stansbury Park. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, stansbury park lake dredging, lake dredging stansbury park"
        canonical="https://utahwatergardens.com/lake-dredging-stansbury-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Stansbury Park",
          "description": "Professional lake dredging services in Stansbury Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Stansbury Park"
        subtitle="Professional pond services for Lake Dredging Services in Stansbury Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Stansbury Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Stansbury Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Stansbury Park Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Stansbury Park Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Stansbury Park Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Stansbury Park Customers Say About Our Lake Dredging</h2>
