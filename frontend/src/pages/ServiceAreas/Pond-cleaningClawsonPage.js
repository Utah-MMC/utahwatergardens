...
const Pond-cleaningClawsonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Clawson | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Clawson. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, clawson pond cleaning, pond cleaning clawson"
        canonical="https://utahwatergardens.com/pond-cleaning-clawson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Clawson",
          "description": "Professional pond cleaning services in Clawson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Clawson"
        subtitle="Professional pond services for Pond Cleaning Services in Clawson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Clawson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Clawson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clawson Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clawson Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clawson Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clawson Customers Say About Our Pond Cleaning</h2>
