...
const Pond-dredgingWilsonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Wilson | Professional Pond Dredging Services"
        description="Expert pond dredging services in Wilson. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, wilson pond dredging, pond dredging wilson"
        canonical="https://utahwatergardens.com/pond-dredging-wilson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Wilson",
          "description": "Professional pond dredging services in Wilson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Wilson"
        subtitle="Professional pond services for Pond Dredging Services in Wilson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Wilson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Wilson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wilson Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wilson Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wilson Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wilson Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWilsonPage;