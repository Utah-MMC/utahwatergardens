...
const Lake-dredgingCoalvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Coalville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Coalville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, coalville lake dredging, lake dredging coalville"
        canonical="https://utahwatergardens.com/lake-dredging-coalville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Coalville",
          "description": "Professional lake dredging services in Coalville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Coalville"
        subtitle="Professional pond services for Lake Dredging Services in Coalville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Coalville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Coalville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Coalville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Coalville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Coalville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Coalville Customers Say About Our Lake Dredging</h2>
