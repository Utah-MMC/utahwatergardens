...
const Lake-dredgingBoisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Boise | Professional Lake Dredging Services"
        description="Expert lake dredging services in Boise. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, boise lake dredging, lake dredging boise"
        canonical="https://utahwatergardens.com/lake-dredging-boise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Boise",
          "description": "Professional lake dredging services in Boise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Boise"
        subtitle="Professional pond services for Lake Dredging Services in Boise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Boise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Boise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boise Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boise Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boise Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boise Customers Say About Our Lake Dredging</h2>
