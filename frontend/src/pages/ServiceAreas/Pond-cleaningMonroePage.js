...
const Pond-cleaningMonroePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Monroe | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Monroe. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, monroe pond cleaning, pond cleaning monroe"
        canonical="https://utahwatergardens.com/pond-cleaning-monroe"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Monroe",
          "description": "Professional pond cleaning services in Monroe",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Monroe"
        subtitle="Professional pond services for Pond Cleaning Services in Monroe and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Monroe"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Monroe</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Monroe Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Monroe Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Monroe Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Monroe Customers Say About Our Pond Cleaning</h2>
