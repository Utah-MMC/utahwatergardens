...
const Pond-constructionClearfieldPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Clearfield | Professional Pond Construction Services"
        description="Expert pond construction services in Clearfield. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, clearfield pond construction, pond construction clearfield"
        canonical="https://utahwatergardens.com/pond-construction-clearfield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Clearfield",
          "description": "Professional pond construction services in Clearfield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Clearfield"
        subtitle="Professional pond services for Pond Construction Services in Clearfield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Clearfield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Clearfield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clearfield Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clearfield Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clearfield Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clearfield Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionClearfieldPage;