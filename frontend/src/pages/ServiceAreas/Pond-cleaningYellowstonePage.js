...
const Pond-cleaningYellowstonePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Yellowstone | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Yellowstone. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, yellowstone pond cleaning, pond cleaning yellowstone"
        canonical="https://utahwatergardens.com/pond-cleaning-yellowstone"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Yellowstone",
          "description": "Professional pond cleaning services in Yellowstone",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Yellowstone"
        subtitle="Professional pond services for Pond Cleaning Services in Yellowstone and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Yellowstone"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Yellowstone</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Yellowstone Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Yellowstone Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Yellowstone Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Yellowstone Customers Say About Our Pond Cleaning</h2>
