...
const Lake-dredgingRexburgPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Rexburg | Professional Lake Dredging Services"
        description="Expert lake dredging services in Rexburg. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, rexburg lake dredging, lake dredging rexburg"
        canonical="https://utahwatergardens.com/lake-dredging-rexburg"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Rexburg",
          "description": "Professional lake dredging services in Rexburg",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Rexburg"
        subtitle="Professional pond services for Lake Dredging Services in Rexburg and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Rexburg"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Rexburg</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rexburg Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rexburg Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rexburg Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rexburg Customers Say About Our Lake Dredging</h2>
