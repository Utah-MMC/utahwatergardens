...
const Pond-repairCarbondalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Carbondale | Professional Pond Repair Services"
        description="Expert pond repair services in Carbondale. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, carbondale pond repair, pond repair carbondale"
        canonical="https://utahwatergardens.com/pond-repair-carbondale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Carbondale",
          "description": "Professional pond repair services in Carbondale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Carbondale"
        subtitle="Professional pond services for Pond Repair Services in Carbondale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Carbondale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Carbondale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carbondale Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carbondale Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carbondale Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carbondale Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCarbondalePage;