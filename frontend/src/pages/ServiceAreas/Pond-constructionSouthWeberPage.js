...
const Pond-constructionSouthWeberPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction South Weber | Professional Pond Construction Services"
        description="Expert pond construction services in South Weber. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, south weber pond construction, pond construction south weber"
        canonical="https://utahwatergardens.com/pond-construction-south-weber"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services South Weber",
          "description": "Professional pond construction services in South Weber",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in South Weber"
        subtitle="Professional pond services for Pond Construction Services in South Weber and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in South Weber"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in South Weber</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Weber Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Weber Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Weber Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Weber Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSouthWeberPage;