...
const Pond-dredgingSt.StephensPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging St. Stephens | Professional Pond Dredging Services"
        description="Expert pond dredging services in St. Stephens. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, st. stephens pond dredging, pond dredging st. stephens"
        canonical="https://utahwatergardens.com/pond-dredging-st.-stephens"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services St. Stephens",
          "description": "Professional pond dredging services in St. Stephens",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in St. Stephens"
        subtitle="Professional pond services for Pond Dredging Services in St. Stephens and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in St. Stephens"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in St. Stephens</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. Stephens Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. Stephens Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. Stephens Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. Stephens Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSt.StephensPage;