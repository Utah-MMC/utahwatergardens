...
const Lake-dredgingCrystalPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Crystal | Professional Lake Dredging Services"
        description="Expert lake dredging services in Crystal. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, crystal lake dredging, lake dredging crystal"
        canonical="https://utahwatergardens.com/lake-dredging-crystal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Crystal",
          "description": "Professional lake dredging services in Crystal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Crystal"
        subtitle="Professional pond services for Lake Dredging Services in Crystal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Crystal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Crystal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crystal Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crystal Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crystal Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crystal Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingCrystalPage;