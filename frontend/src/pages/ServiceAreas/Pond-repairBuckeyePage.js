...
const Pond-repairBuckeyePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Buckeye | Professional Pond Repair Services"
        description="Expert pond repair services in Buckeye. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, buckeye pond repair, pond repair buckeye"
        canonical="https://utahwatergardens.com/pond-repair-buckeye"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Buckeye",
          "description": "Professional pond repair services in Buckeye",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Buckeye"
        subtitle="Professional pond services for Pond Repair Services in Buckeye and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Buckeye"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Buckeye</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Buckeye Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Buckeye Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Buckeye Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Buckeye Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBuckeyePage;