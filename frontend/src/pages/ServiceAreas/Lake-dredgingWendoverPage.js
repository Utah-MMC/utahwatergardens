...
const Lake-dredgingWendoverPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Wendover | Professional Lake Dredging Services"
        description="Expert lake dredging services in Wendover. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, wendover lake dredging, lake dredging wendover"
        canonical="https://utahwatergardens.com/lake-dredging-wendover"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Wendover",
          "description": "Professional lake dredging services in Wendover",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Wendover"
        subtitle="Professional pond services for Lake Dredging Services in Wendover and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Wendover"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Wendover</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wendover Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wendover Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wendover Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wendover Customers Say About Our Lake Dredging</h2>
