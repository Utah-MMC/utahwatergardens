...
const Pond-repairHartvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Hartville | Professional Pond Repair Services"
        description="Expert pond repair services in Hartville. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, hartville pond repair, pond repair hartville"
        canonical="https://utahwatergardens.com/pond-repair-hartville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Hartville",
          "description": "Professional pond repair services in Hartville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Hartville"
        subtitle="Professional pond services for Pond Repair Services in Hartville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Hartville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Hartville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hartville Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hartville Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hartville Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hartville Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHartvillePage;