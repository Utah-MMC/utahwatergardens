...
const Pond-repairWasatchMountainStateParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Wasatch Mountain State Park | Professional Pond Repair Services"
        description="Expert pond repair services in Wasatch Mountain State Park. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, wasatch mountain state park pond repair, pond repair wasatch mountain state park"
        canonical="https://utahwatergardens.com/pond-repair-wasatch-mountain-state-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Wasatch Mountain State Park",
          "description": "Professional pond repair services in Wasatch Mountain State Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Wasatch Mountain State Park"
        subtitle="Professional pond services for Pond Repair Services in Wasatch Mountain State Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Wasatch Mountain State Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Wasatch Mountain State Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wasatch Mountain State Park Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wasatch Mountain State Park Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wasatch Mountain State Park Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wasatch Mountain State Park Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWasatchMountainStateParkPage;