...
const Pond-dredgingMytonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Myton | Professional Pond Dredging Services"
        description="Expert pond dredging services in Myton. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, myton pond dredging, pond dredging myton"
        canonical="https://utahwatergardens.com/pond-dredging-myton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Myton",
          "description": "Professional pond dredging services in Myton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Myton"
        subtitle="Professional pond services for Pond Dredging Services in Myton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Myton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Myton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Myton Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Myton Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Myton Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Myton Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMytonPage;