...
const Pond-cleaningVernalPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Vernal | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Vernal. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, vernal pond cleaning, pond cleaning vernal"
        canonical="https://utahwatergardens.com/pond-cleaning-vernal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Vernal",
          "description": "Professional pond cleaning services in Vernal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Vernal"
        subtitle="Professional pond services for Pond Cleaning Services in Vernal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Vernal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Vernal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vernal Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vernal Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vernal Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vernal Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningVernalPage;