...
const Pond-cleaningCedarHillsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Cedar Hills | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Cedar Hills. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, cedar hills pond cleaning, pond cleaning cedar hills"
        canonical="https://utahwatergardens.com/pond-cleaning-cedar-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Cedar Hills",
          "description": "Professional pond cleaning services in Cedar Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Cedar Hills"
        subtitle="Professional pond services for Pond Cleaning Services in Cedar Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Cedar Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Cedar Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cedar Hills Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cedar Hills Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cedar Hills Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cedar Hills Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCedarHillsPage;