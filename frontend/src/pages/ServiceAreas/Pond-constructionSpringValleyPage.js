...
const Pond-constructionSpringValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Spring Valley | Professional Pond Construction Services"
        description="Expert pond construction services in Spring Valley. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, spring valley pond construction, pond construction spring valley"
        canonical="https://utahwatergardens.com/pond-construction-spring-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Spring Valley",
          "description": "Professional pond construction services in Spring Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Spring Valley"
        subtitle="Professional pond services for Pond Construction Services in Spring Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Spring Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Spring Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spring Valley Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spring Valley Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spring Valley Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spring Valley Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSpringValleyPage;