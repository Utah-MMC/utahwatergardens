...
const Pond-dredgingMidwayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Midway | Professional Pond Dredging Services"
        description="Expert pond dredging services in Midway. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, midway pond dredging, pond dredging midway"
        canonical="https://utahwatergardens.com/pond-dredging-midway"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Midway",
          "description": "Professional pond dredging services in Midway",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Midway"
        subtitle="Professional pond services for Pond Dredging Services in Midway and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Midway"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Midway</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Midway Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Midway Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Midway Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Midway Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMidwayPage;