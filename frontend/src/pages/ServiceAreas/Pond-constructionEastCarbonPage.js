...
const Pond-constructionEastCarbonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction East Carbon | Professional Pond Construction Services"
        description="Expert pond construction services in East Carbon. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, east carbon pond construction, pond construction east carbon"
        canonical="https://utahwatergardens.com/pond-construction-east-carbon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services East Carbon",
          "description": "Professional pond construction services in East Carbon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in East Carbon"
        subtitle="Professional pond services for Pond Construction Services in East Carbon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in East Carbon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in East Carbon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our East Carbon Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="East Carbon Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our East Carbon Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What East Carbon Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionEastCarbonPage;