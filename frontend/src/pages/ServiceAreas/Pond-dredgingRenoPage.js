...
const Pond-dredgingRenoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Reno | Professional Pond Dredging Services"
        description="Expert pond dredging services in Reno. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, reno pond dredging, pond dredging reno"
        canonical="https://utahwatergardens.com/pond-dredging-reno"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Reno",
          "description": "Professional pond dredging services in Reno",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Reno"
        subtitle="Professional pond services for Pond Dredging Services in Reno and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Reno"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Reno</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Reno Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Reno Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Reno Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Reno Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingRenoPage;