...
const Pond-cleaningAlbionPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Albion | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Albion. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, albion pond cleaning, pond cleaning albion"
        canonical="https://utahwatergardens.com/pond-cleaning-albion"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Albion",
          "description": "Professional pond cleaning services in Albion",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Albion"
        subtitle="Professional pond services for Pond Cleaning Services in Albion and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Albion"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Albion</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Albion Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Albion Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Albion Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Albion Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAlbionPage;