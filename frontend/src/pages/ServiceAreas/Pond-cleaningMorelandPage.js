...
const Pond-cleaningMorelandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Moreland | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Moreland. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, moreland pond cleaning, pond cleaning moreland"
        canonical="https://utahwatergardens.com/pond-cleaning-moreland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Moreland",
          "description": "Professional pond cleaning services in Moreland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Moreland"
        subtitle="Professional pond services for Pond Cleaning Services in Moreland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Moreland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Moreland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moreland Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moreland Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moreland Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moreland Customers Say About Our Pond Cleaning</h2>
