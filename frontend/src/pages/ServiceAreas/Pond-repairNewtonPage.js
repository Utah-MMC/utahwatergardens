...
const Pond-repairNewtonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Newton | Professional Pond Repair Services"
        description="Expert pond repair services in Newton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, newton pond repair, pond repair newton"
        canonical="https://utahwatergardens.com/pond-repair-newton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Newton",
          "description": "Professional pond repair services in Newton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Newton"
        subtitle="Professional pond services for Pond Repair Services in Newton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Newton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Newton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Newton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Newton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Newton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Newton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNewtonPage;