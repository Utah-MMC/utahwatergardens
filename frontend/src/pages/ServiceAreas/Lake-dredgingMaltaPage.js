...
const Lake-dredgingMaltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Malta | Professional Lake Dredging Services"
        description="Expert lake dredging services in Malta. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, malta lake dredging, lake dredging malta"
        canonical="https://utahwatergardens.com/lake-dredging-malta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Malta",
          "description": "Professional lake dredging services in Malta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Malta"
        subtitle="Professional pond services for Lake Dredging Services in Malta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Malta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Malta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Malta Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Malta Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Malta Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Malta Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMaltaPage;