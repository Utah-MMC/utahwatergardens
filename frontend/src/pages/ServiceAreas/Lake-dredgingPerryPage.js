...
const Lake-dredgingPerryPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Perry | Professional Lake Dredging Services"
        description="Expert lake dredging services in Perry. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, perry lake dredging, lake dredging perry"
        canonical="https://utahwatergardens.com/lake-dredging-perry"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Perry",
          "description": "Professional lake dredging services in Perry",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Perry"
        subtitle="Professional pond services for Lake Dredging Services in Perry and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Perry"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Perry</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Perry Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Perry Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Perry Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Perry Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingPerryPage;