...
const Pond-repairDuchesnePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Duchesne | Professional Pond Repair Services"
        description="Expert pond repair services in Duchesne. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, duchesne pond repair, pond repair duchesne"
        canonical="https://utahwatergardens.com/pond-repair-duchesne"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Duchesne",
          "description": "Professional pond repair services in Duchesne",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Duchesne"
        subtitle="Professional pond services for Pond Repair Services in Duchesne and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Duchesne"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Duchesne</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Duchesne Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Duchesne Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Duchesne Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Duchesne Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDuchesnePage;