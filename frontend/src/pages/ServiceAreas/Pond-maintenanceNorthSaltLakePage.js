...
const Pond-maintenanceNorthSaltLakePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance North Salt Lake | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in North Salt Lake. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, north salt lake pond maintenance, pond maintenance north salt lake"
        canonical="https://utahwatergardens.com/pond-maintenance-north-salt-lake"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services North Salt Lake",
          "description": "Professional pond maintenance services in North Salt Lake",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in North Salt Lake"
        subtitle="Professional pond services for Pond Maintenance Services in North Salt Lake and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in North Salt Lake"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in North Salt Lake</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Salt Lake Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Salt Lake Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Salt Lake Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Salt Lake Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceNorthSaltLakePage;