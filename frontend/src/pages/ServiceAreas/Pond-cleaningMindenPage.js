...
const Pond-cleaningMindenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Minden | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Minden. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, minden pond cleaning, pond cleaning minden"
        canonical="https://utahwatergardens.com/pond-cleaning-minden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Minden",
          "description": "Professional pond cleaning services in Minden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Minden"
        subtitle="Professional pond services for Pond Cleaning Services in Minden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Minden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Minden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Minden Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Minden Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Minden Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Minden Customers Say About Our Pond Cleaning</h2>
