...
const Pond-cleaningShawneePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Shawnee | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Shawnee. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, shawnee pond cleaning, pond cleaning shawnee"
        canonical="https://utahwatergardens.com/pond-cleaning-shawnee"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Shawnee",
          "description": "Professional pond cleaning services in Shawnee",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Shawnee"
        subtitle="Professional pond services for Pond Cleaning Services in Shawnee and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Shawnee"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Shawnee</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Shawnee Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Shawnee Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Shawnee Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Shawnee Customers Say About Our Pond Cleaning</h2>
