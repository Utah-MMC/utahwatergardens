...
const Lake-dredgingCasaGrandePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Casa Grande | Professional Lake Dredging Services"
        description="Expert lake dredging services in Casa Grande. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, casa grande lake dredging, lake dredging casa grande"
        canonical="https://utahwatergardens.com/lake-dredging-casa-grande"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Casa Grande",
          "description": "Professional lake dredging services in Casa Grande",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Casa Grande"
        subtitle="Professional pond services for Lake Dredging Services in Casa Grande and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Casa Grande"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Casa Grande</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Casa Grande Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Casa Grande Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Casa Grande Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Casa Grande Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingCasaGrandePage;