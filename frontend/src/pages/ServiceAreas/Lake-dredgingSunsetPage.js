...
const Lake-dredgingSunsetPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sunset | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sunset. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sunset lake dredging, lake dredging sunset"
        canonical="https://utahwatergardens.com/lake-dredging-sunset"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sunset",
          "description": "Professional lake dredging services in Sunset",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sunset"
        subtitle="Professional pond services for Lake Dredging Services in Sunset and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sunset"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sunset</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunset Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunset Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunset Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunset Customers Say About Our Lake Dredging</h2>
