...
const Lake-dredgingSouthWeberPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging South Weber | Professional Lake Dredging Services"
        description="Expert lake dredging services in South Weber. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, south weber lake dredging, lake dredging south weber"
        canonical="https://utahwatergardens.com/lake-dredging-south-weber"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services South Weber",
          "description": "Professional lake dredging services in South Weber",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in South Weber"
        subtitle="Professional pond services for Lake Dredging Services in South Weber and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in South Weber"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in South Weber</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Weber Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Weber Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Weber Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Weber Customers Say About Our Lake Dredging</h2>
