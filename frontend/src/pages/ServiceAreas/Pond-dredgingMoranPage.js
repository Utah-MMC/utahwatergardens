...
const Pond-dredgingMoranPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Moran | Professional Pond Dredging Services"
        description="Expert pond dredging services in Moran. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, moran pond dredging, pond dredging moran"
        canonical="https://utahwatergardens.com/pond-dredging-moran"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Moran",
          "description": "Professional pond dredging services in Moran",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Moran"
        subtitle="Professional pond services for Pond Dredging Services in Moran and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Moran"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Moran</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moran Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moran Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moran Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moran Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMoranPage;