...
const Lake-dredgingKaysvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Kaysville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Kaysville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, kaysville lake dredging, lake dredging kaysville"
        canonical="https://utahwatergardens.com/lake-dredging-kaysville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Kaysville",
          "description": "Professional lake dredging services in Kaysville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Kaysville"
        subtitle="Professional pond services for Lake Dredging Services in Kaysville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Kaysville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Kaysville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kaysville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kaysville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kaysville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kaysville Customers Say About Our Lake Dredging</h2>
