...
const Pond-cleaningFirthPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Firth | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Firth. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, firth pond cleaning, pond cleaning firth"
        canonical="https://utahwatergardens.com/pond-cleaning-firth"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Firth",
          "description": "Professional pond cleaning services in Firth",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Firth"
        subtitle="Professional pond services for Pond Cleaning Services in Firth and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Firth"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Firth</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Firth Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Firth Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Firth Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Firth Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningFirthPage;