...
const Pond-dredgingTempePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Tempe | Professional Pond Dredging Services"
        description="Expert pond dredging services in Tempe. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, tempe pond dredging, pond dredging tempe"
        canonical="https://utahwatergardens.com/pond-dredging-tempe"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Tempe",
          "description": "Professional pond dredging services in Tempe",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Tempe"
        subtitle="Professional pond services for Pond Dredging Services in Tempe and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Tempe"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Tempe</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tempe Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tempe Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tempe Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tempe Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingTempePage;