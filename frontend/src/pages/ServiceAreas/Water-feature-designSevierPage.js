...
const Water-feature-designSevierPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Sevier | Professional Water Feature Design Services"
        description="Expert water feature design services in Sevier. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, sevier water feature design, water feature design sevier"
        canonical="https://utahwatergardens.com/water-feature-design-sevier"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Sevier",
          "description": "Professional water feature design services in Sevier",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Sevier"
        subtitle="Professional pond services for Water Feature Design Services in Sevier and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Sevier"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Sevier</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sevier Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sevier Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sevier Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sevier Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designSevierPage;