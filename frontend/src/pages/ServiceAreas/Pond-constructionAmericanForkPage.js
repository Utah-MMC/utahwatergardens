...
const Pond-constructionAmericanForkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction American Fork | Professional Pond Construction Services"
        description="Expert pond construction services in American Fork. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, american fork pond construction, pond construction american fork"
        canonical="https://utahwatergardens.com/pond-construction-american-fork"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services American Fork",
          "description": "Professional pond construction services in American Fork",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in American Fork"
        subtitle="Professional pond services for Pond Construction Services in American Fork and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in American Fork"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in American Fork</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our American Fork Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="American Fork Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our American Fork Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What American Fork Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionAmericanForkPage;