...
const Lake-dredgingHowellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Howell | Professional Lake Dredging Services"
        description="Expert lake dredging services in Howell. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, howell lake dredging, lake dredging howell"
        canonical="https://utahwatergardens.com/lake-dredging-howell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Howell",
          "description": "Professional lake dredging services in Howell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Howell"
        subtitle="Professional pond services for Lake Dredging Services in Howell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Howell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Howell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Howell Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Howell Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Howell Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Howell Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingHowellPage;