...
const Pond-repairKemmererPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Kemmerer | Professional Pond Repair Services"
        description="Expert pond repair services in Kemmerer. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, kemmerer pond repair, pond repair kemmerer"
        canonical="https://utahwatergardens.com/pond-repair-kemmerer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Kemmerer",
          "description": "Professional pond repair services in Kemmerer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Kemmerer"
        subtitle="Professional pond services for Pond Repair Services in Kemmerer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Kemmerer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Kemmerer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kemmerer Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kemmerer Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kemmerer Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kemmerer Customers Say About Our Pond Repair</h2>
...
export default Pond-repairKemmererPage;