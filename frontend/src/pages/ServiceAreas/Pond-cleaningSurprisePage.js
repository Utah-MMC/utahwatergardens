...
const Pond-cleaningSurprisePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Surprise | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Surprise. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, surprise pond cleaning, pond cleaning surprise"
        canonical="https://utahwatergardens.com/pond-cleaning-surprise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Surprise",
          "description": "Professional pond cleaning services in Surprise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Surprise"
        subtitle="Professional pond services for Pond Cleaning Services in Surprise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Surprise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Surprise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Surprise Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Surprise Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Surprise Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Surprise Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSurprisePage;