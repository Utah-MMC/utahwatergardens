...
const Pond-maintenanceCasaGrandePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Casa Grande | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Casa Grande. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, casa grande pond maintenance, pond maintenance casa grande"
        canonical="https://utahwatergardens.com/pond-maintenance-casa-grande"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Casa Grande",
          "description": "Professional pond maintenance services in Casa Grande",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Casa Grande"
        subtitle="Professional pond services for Pond Maintenance Services in Casa Grande and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Casa Grande"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Casa Grande</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Casa Grande Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Casa Grande Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Casa Grande Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Casa Grande Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceCasaGrandePage;