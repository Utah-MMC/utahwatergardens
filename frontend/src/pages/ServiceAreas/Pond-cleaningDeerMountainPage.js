...
const Pond-cleaningDeerMountainPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Deer Mountain | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Deer Mountain. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, deer mountain pond cleaning, pond cleaning deer mountain"
        canonical="https://utahwatergardens.com/pond-cleaning-deer-mountain"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Deer Mountain",
          "description": "Professional pond cleaning services in Deer Mountain",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Deer Mountain"
        subtitle="Professional pond services for Pond Cleaning Services in Deer Mountain and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Deer Mountain"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Deer Mountain</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Deer Mountain Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Deer Mountain Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Deer Mountain Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Deer Mountain Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDeerMountainPage;