...
const Lake-dredgingOremPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Orem | Professional Lake Dredging Services"
        description="Expert lake dredging services in Orem. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, orem lake dredging, lake dredging orem"
        canonical="https://utahwatergardens.com/lake-dredging-orem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Orem",
          "description": "Professional lake dredging services in Orem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Orem"
        subtitle="Professional pond services for Lake Dredging Services in Orem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Orem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Orem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Orem Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Orem Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Orem Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Orem Customers Say About Our Lake Dredging</h2>
