...
const Pond-maintenanceGunnisonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Gunnison | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Gunnison. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, gunnison pond maintenance, pond maintenance gunnison"
        canonical="https://utahwatergardens.com/pond-maintenance-gunnison"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Gunnison",
          "description": "Professional pond maintenance services in Gunnison",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Gunnison"
        subtitle="Professional pond services for Pond Maintenance Services in Gunnison and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Gunnison"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Gunnison</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gunnison Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gunnison Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gunnison Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gunnison Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceGunnisonPage;