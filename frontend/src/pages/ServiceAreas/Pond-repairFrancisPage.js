...
const Pond-repairFrancisPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Francis | Professional Pond Repair Services"
        description="Expert pond repair services in Francis. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, francis pond repair, pond repair francis"
        canonical="https://utahwatergardens.com/pond-repair-francis"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Francis",
          "description": "Professional pond repair services in Francis",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Francis"
        subtitle="Professional pond services for Pond Repair Services in Francis and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Francis"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Francis</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Francis Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Francis Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Francis Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Francis Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFrancisPage;