...
const Pond-dredgingNorthOgdenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging North Ogden | Professional Pond Dredging Services"
        description="Expert pond dredging services in North Ogden. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, north ogden pond dredging, pond dredging north ogden"
        canonical="https://utahwatergardens.com/pond-dredging-north-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services North Ogden",
          "description": "Professional pond dredging services in North Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in North Ogden"
        subtitle="Professional pond services for Pond Dredging Services in North Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in North Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in North Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Ogden Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Ogden Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Ogden Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Ogden Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNorthOgdenPage;