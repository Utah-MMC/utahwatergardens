...
const Pond-dredgingHomedalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Homedale | Professional Pond Dredging Services"
        description="Expert pond dredging services in Homedale. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, homedale pond dredging, pond dredging homedale"
        canonical="https://utahwatergardens.com/pond-dredging-homedale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Homedale",
          "description": "Professional pond dredging services in Homedale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Homedale"
        subtitle="Professional pond services for Pond Dredging Services in Homedale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Homedale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Homedale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Homedale Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Homedale Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Homedale Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Homedale Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHomedalePage;