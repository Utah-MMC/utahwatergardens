...
const Pond-repairPenrosePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Penrose | Professional Pond Repair Services"
        description="Expert pond repair services in Penrose. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, penrose pond repair, pond repair penrose"
        canonical="https://utahwatergardens.com/pond-repair-penrose"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Penrose",
          "description": "Professional pond repair services in Penrose",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Penrose"
        subtitle="Professional pond services for Pond Repair Services in Penrose and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Penrose"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Penrose</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Penrose Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Penrose Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Penrose Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Penrose Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPenrosePage;