...
const Pond-constructionCordesLakesPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Cordes Lakes | Professional Pond Construction Services"
        description="Expert pond construction services in Cordes Lakes. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, cordes lakes pond construction, pond construction cordes lakes"
        canonical="https://utahwatergardens.com/pond-construction-cordes-lakes"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Cordes Lakes",
          "description": "Professional pond construction services in Cordes Lakes",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Cordes Lakes"
        subtitle="Professional pond services for Pond Construction Services in Cordes Lakes and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Cordes Lakes"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Cordes Lakes</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cordes Lakes Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cordes Lakes Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cordes Lakes Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cordes Lakes Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionCordesLakesPage;