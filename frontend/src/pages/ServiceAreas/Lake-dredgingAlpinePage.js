...
const Lake-dredgingAlpinePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Alpine | Professional Lake Dredging Services"
        description="Expert lake dredging services in Alpine. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, alpine lake dredging, lake dredging alpine"
        canonical="https://utahwatergardens.com/lake-dredging-alpine"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Alpine",
          "description": "Professional lake dredging services in Alpine",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Alpine"
        subtitle="Professional pond services for Lake Dredging Services in Alpine and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Alpine"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Alpine</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alpine Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alpine Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alpine Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alpine Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAlpinePage;