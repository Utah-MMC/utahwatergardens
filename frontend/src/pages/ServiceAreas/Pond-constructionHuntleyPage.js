...
const Pond-constructionHuntleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Huntley | Professional Pond Construction Services"
        description="Expert pond construction services in Huntley. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, huntley pond construction, pond construction huntley"
        canonical="https://utahwatergardens.com/pond-construction-huntley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Huntley",
          "description": "Professional pond construction services in Huntley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Huntley"
        subtitle="Professional pond services for Pond Construction Services in Huntley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Huntley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Huntley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntley Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntley Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntley Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntley Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionHuntleyPage;