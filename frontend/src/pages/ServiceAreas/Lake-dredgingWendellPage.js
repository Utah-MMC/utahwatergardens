...
const Lake-dredgingWendellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Wendell | Professional Lake Dredging Services"
        description="Expert lake dredging services in Wendell. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, wendell lake dredging, lake dredging wendell"
        canonical="https://utahwatergardens.com/lake-dredging-wendell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Wendell",
          "description": "Professional lake dredging services in Wendell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Wendell"
        subtitle="Professional pond services for Lake Dredging Services in Wendell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Wendell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Wendell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wendell Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wendell Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wendell Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wendell Customers Say About Our Lake Dredging</h2>
