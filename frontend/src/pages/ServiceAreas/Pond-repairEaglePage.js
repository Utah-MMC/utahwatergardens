...
const Pond-repairEaglePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Eagle | Professional Pond Repair Services"
        description="Expert pond repair services in Eagle. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, eagle pond repair, pond repair eagle"
        canonical="https://utahwatergardens.com/pond-repair-eagle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Eagle",
          "description": "Professional pond repair services in Eagle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Eagle"
        subtitle="Professional pond services for Pond Repair Services in Eagle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Eagle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Eagle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eagle Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eagle Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eagle Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eagle Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEaglePage;