...
const Pond-maintenanceJayEmPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Jay Em | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Jay Em. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, jay em pond maintenance, pond maintenance jay em"
        canonical="https://utahwatergardens.com/pond-maintenance-jay-em"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Jay Em",
          "description": "Professional pond maintenance services in Jay Em",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Jay Em"
        subtitle="Professional pond services for Pond Maintenance Services in Jay Em and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Jay Em"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Jay Em</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jay Em Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jay Em Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jay Em Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jay Em Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceJayEmPage;