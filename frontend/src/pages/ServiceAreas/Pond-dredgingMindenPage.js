...
const Pond-dredgingMindenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Minden | Professional Pond Dredging Services"
        description="Expert pond dredging services in Minden. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, minden pond dredging, pond dredging minden"
        canonical="https://utahwatergardens.com/pond-dredging-minden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Minden",
          "description": "Professional pond dredging services in Minden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Minden"
        subtitle="Professional pond services for Pond Dredging Services in Minden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Minden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Minden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Minden Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Minden Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Minden Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Minden Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMindenPage;