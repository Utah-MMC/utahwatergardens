...
const Pond-cleaningFallonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Fallon | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Fallon. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, fallon pond cleaning, pond cleaning fallon"
        canonical="https://utahwatergardens.com/pond-cleaning-fallon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Fallon",
          "description": "Professional pond cleaning services in Fallon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Fallon"
        subtitle="Professional pond services for Pond Cleaning Services in Fallon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Fallon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Fallon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fallon Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fallon Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fallon Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fallon Customers Say About Our Pond Cleaning</h2>
