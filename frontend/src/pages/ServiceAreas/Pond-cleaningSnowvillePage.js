...
const Pond-cleaningSnowvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Snowville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Snowville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, snowville pond cleaning, pond cleaning snowville"
        canonical="https://utahwatergardens.com/pond-cleaning-snowville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Snowville",
          "description": "Professional pond cleaning services in Snowville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Snowville"
        subtitle="Professional pond services for Pond Cleaning Services in Snowville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Snowville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Snowville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Snowville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Snowville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Snowville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Snowville Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSnowvillePage;