...
const Pond-cleaningSt.StephensPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning St. Stephens | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in St. Stephens. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, st. stephens pond cleaning, pond cleaning st. stephens"
        canonical="https://utahwatergardens.com/pond-cleaning-st.-stephens"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services St. Stephens",
          "description": "Professional pond cleaning services in St. Stephens",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in St. Stephens"
        subtitle="Professional pond services for Pond Cleaning Services in St. Stephens and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in St. Stephens"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in St. Stephens</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. Stephens Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. Stephens Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. Stephens Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. Stephens Customers Say About Our Pond Cleaning</h2>
