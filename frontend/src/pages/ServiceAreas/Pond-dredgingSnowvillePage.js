...
const Pond-dredgingSnowvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Snowville | Professional Pond Dredging Services"
        description="Expert pond dredging services in Snowville. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, snowville pond dredging, pond dredging snowville"
        canonical="https://utahwatergardens.com/pond-dredging-snowville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Snowville",
          "description": "Professional pond dredging services in Snowville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Snowville"
        subtitle="Professional pond services for Pond Dredging Services in Snowville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Snowville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Snowville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Snowville Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Snowville Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Snowville Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Snowville Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSnowvillePage;