...
const Lake-dredgingHotchkissPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Hotchkiss | Professional Lake Dredging Services"
        description="Expert lake dredging services in Hotchkiss. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, hotchkiss lake dredging, lake dredging hotchkiss"
        canonical="https://utahwatergardens.com/lake-dredging-hotchkiss"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Hotchkiss",
          "description": "Professional lake dredging services in Hotchkiss",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Hotchkiss"
        subtitle="Professional pond services for Lake Dredging Services in Hotchkiss and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Hotchkiss"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Hotchkiss</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hotchkiss Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hotchkiss Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hotchkiss Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hotchkiss Customers Say About Our Lake Dredging</h2>
