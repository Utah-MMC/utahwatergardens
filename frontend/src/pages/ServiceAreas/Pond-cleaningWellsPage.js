...
const Pond-cleaningWellsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Wells | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Wells. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, wells pond cleaning, pond cleaning wells"
        canonical="https://utahwatergardens.com/pond-cleaning-wells"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Wells",
          "description": "Professional pond cleaning services in Wells",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Wells"
        subtitle="Professional pond services for Pond Cleaning Services in Wells and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Wells"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Wells</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wells Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wells Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wells Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wells Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningWellsPage;