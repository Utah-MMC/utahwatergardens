...
const Pond-maintenanceSt.StephensPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance St. Stephens | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in St. Stephens. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, st. stephens pond maintenance, pond maintenance st. stephens"
        canonical="https://utahwatergardens.com/pond-maintenance-st.-stephens"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services St. Stephens",
          "description": "Professional pond maintenance services in St. Stephens",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in St. Stephens"
        subtitle="Professional pond services for Pond Maintenance Services in St. Stephens and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in St. Stephens"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in St. Stephens</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. Stephens Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. Stephens Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. Stephens Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. Stephens Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSt.StephensPage;