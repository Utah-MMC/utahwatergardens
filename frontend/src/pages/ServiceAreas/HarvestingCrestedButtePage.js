...
const HarvestingCrestedButtePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Crested Butte | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Crested Butte. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, crested butte aquatic plant harvesting, aquatic plant harvesting crested butte"
        canonical="https://utahwatergardens.com/harvesting-crested-butte"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Crested Butte",
          "description": "Professional aquatic plant harvesting services in Crested Butte",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Crested Butte"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Crested Butte and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Crested Butte"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Crested Butte</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crested Butte Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crested Butte Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crested Butte Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crested Butte Customers Say About Our Aquatic Plant Harvesting</h2>
