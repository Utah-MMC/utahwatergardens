...
const Lake-dredgingMenanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Menan | Professional Lake Dredging Services"
        description="Expert lake dredging services in Menan. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, menan lake dredging, lake dredging menan"
        canonical="https://utahwatergardens.com/lake-dredging-menan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Menan",
          "description": "Professional lake dredging services in Menan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Menan"
        subtitle="Professional pond services for Lake Dredging Services in Menan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Menan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Menan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Menan Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Menan Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Menan Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Menan Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMenanPage;