...
const Pond-cleaningDugwayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Dugway | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Dugway. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, dugway pond cleaning, pond cleaning dugway"
        canonical="https://utahwatergardens.com/pond-cleaning-dugway"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Dugway",
          "description": "Professional pond cleaning services in Dugway",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Dugway"
        subtitle="Professional pond services for Pond Cleaning Services in Dugway and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Dugway"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Dugway</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dugway Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dugway Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dugway Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dugway Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDugwayPage;