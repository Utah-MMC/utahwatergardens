...
const Pond-constructionSt.GeorgePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction St. George | Professional Pond Construction Services"
        description="Expert pond construction services in St. George. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, st. george pond construction, pond construction st. george"
        canonical="https://utahwatergardens.com/pond-construction-st.-george"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services St. George",
          "description": "Professional pond construction services in St. George",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in St. George"
        subtitle="Professional pond services for Pond Construction Services in St. George and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in St. George"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in St. George</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. George Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. George Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. George Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. George Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSt.GeorgePage;