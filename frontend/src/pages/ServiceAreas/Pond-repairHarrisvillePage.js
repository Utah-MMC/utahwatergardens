...
const Pond-repairHarrisvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Harrisville | Professional Pond Repair Services"
        description="Expert pond repair services in Harrisville. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, harrisville pond repair, pond repair harrisville"
        canonical="https://utahwatergardens.com/pond-repair-harrisville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Harrisville",
          "description": "Professional pond repair services in Harrisville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Harrisville"
        subtitle="Professional pond services for Pond Repair Services in Harrisville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Harrisville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Harrisville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Harrisville Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Harrisville Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Harrisville Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Harrisville Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHarrisvillePage;