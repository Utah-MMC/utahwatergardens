...
const Pond-repairHeyburnPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Heyburn | Professional Pond Repair Services"
        description="Expert pond repair services in Heyburn. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, heyburn pond repair, pond repair heyburn"
        canonical="https://utahwatergardens.com/pond-repair-heyburn"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Heyburn",
          "description": "Professional pond repair services in Heyburn",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Heyburn"
        subtitle="Professional pond services for Pond Repair Services in Heyburn and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Heyburn"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Heyburn</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Heyburn Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Heyburn Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Heyburn Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Heyburn Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHeyburnPage;