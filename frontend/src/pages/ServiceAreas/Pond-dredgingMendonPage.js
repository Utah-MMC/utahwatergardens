...
const Pond-dredgingMendonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Mendon | Professional Pond Dredging Services"
        description="Expert pond dredging services in Mendon. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, mendon pond dredging, pond dredging mendon"
        canonical="https://utahwatergardens.com/pond-dredging-mendon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Mendon",
          "description": "Professional pond dredging services in Mendon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Mendon"
        subtitle="Professional pond services for Pond Dredging Services in Mendon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Mendon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Mendon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mendon Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mendon Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mendon Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mendon Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMendonPage;