...
const Lake-dredgingGlenrockPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Glenrock | Professional Lake Dredging Services"
        description="Expert lake dredging services in Glenrock. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, glenrock lake dredging, lake dredging glenrock"
        canonical="https://utahwatergardens.com/lake-dredging-glenrock"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Glenrock",
          "description": "Professional lake dredging services in Glenrock",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Glenrock"
        subtitle="Professional pond services for Lake Dredging Services in Glenrock and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Glenrock"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Glenrock</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glenrock Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glenrock Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glenrock Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glenrock Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingGlenrockPage;