...
const Pond-cleaningMeridianPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Meridian | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Meridian. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, meridian pond cleaning, pond cleaning meridian"
        canonical="https://utahwatergardens.com/pond-cleaning-meridian"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Meridian",
          "description": "Professional pond cleaning services in Meridian",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Meridian"
        subtitle="Professional pond services for Pond Cleaning Services in Meridian and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Meridian"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Meridian</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Meridian Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Meridian Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Meridian Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Meridian Customers Say About Our Pond Cleaning</h2>
