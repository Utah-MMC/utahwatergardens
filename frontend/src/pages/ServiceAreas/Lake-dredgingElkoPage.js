...
const Lake-dredgingElkoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Elko | Professional Lake Dredging Services"
        description="Expert lake dredging services in Elko. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, elko lake dredging, lake dredging elko"
        canonical="https://utahwatergardens.com/lake-dredging-elko"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Elko",
          "description": "Professional lake dredging services in Elko",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Elko"
        subtitle="Professional pond services for Lake Dredging Services in Elko and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Elko"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Elko</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elko Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elko Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elko Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elko Customers Say About Our Lake Dredging</h2>
