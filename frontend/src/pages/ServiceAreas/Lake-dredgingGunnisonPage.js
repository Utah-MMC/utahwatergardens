...
const Lake-dredgingGunnisonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Gunnison | Professional Lake Dredging Services"
        description="Expert lake dredging services in Gunnison. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, gunnison lake dredging, lake dredging gunnison"
        canonical="https://utahwatergardens.com/lake-dredging-gunnison"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Gunnison",
          "description": "Professional lake dredging services in Gunnison",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Gunnison"
        subtitle="Professional pond services for Lake Dredging Services in Gunnison and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Gunnison"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Gunnison</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gunnison Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gunnison Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gunnison Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gunnison Customers Say About Our Lake Dredging</h2>
