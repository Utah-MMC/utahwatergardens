...
const Pond-cleaningVirginPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Virgin | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Virgin. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, virgin pond cleaning, pond cleaning virgin"
        canonical="https://utahwatergardens.com/pond-cleaning-virgin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Virgin",
          "description": "Professional pond cleaning services in Virgin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Virgin"
        subtitle="Professional pond services for Pond Cleaning Services in Virgin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Virgin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Virgin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Virgin Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Virgin Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Virgin Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Virgin Customers Say About Our Pond Cleaning</h2>
