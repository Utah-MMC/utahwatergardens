...
const Lake-dredgingBurrvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Burrville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Burrville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, burrville lake dredging, lake dredging burrville"
        canonical="https://utahwatergardens.com/lake-dredging-burrville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Burrville",
          "description": "Professional lake dredging services in Burrville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Burrville"
        subtitle="Professional pond services for Lake Dredging Services in Burrville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Burrville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Burrville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Burrville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Burrville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Burrville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Burrville Customers Say About Our Lake Dredging</h2>
