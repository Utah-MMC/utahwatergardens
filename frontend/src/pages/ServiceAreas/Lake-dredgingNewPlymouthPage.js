...
const Lake-dredgingNewPlymouthPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging New Plymouth | Professional Lake Dredging Services"
        description="Expert lake dredging services in New Plymouth. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, new plymouth lake dredging, lake dredging new plymouth"
        canonical="https://utahwatergardens.com/lake-dredging-new-plymouth"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services New Plymouth",
          "description": "Professional lake dredging services in New Plymouth",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in New Plymouth"
        subtitle="Professional pond services for Lake Dredging Services in New Plymouth and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in New Plymouth"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in New Plymouth</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Plymouth Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Plymouth Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Plymouth Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Plymouth Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingNewPlymouthPage;