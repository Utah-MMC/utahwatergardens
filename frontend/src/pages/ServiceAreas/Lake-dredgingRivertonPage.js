...
const Lake-dredgingRivertonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Riverton | Professional Lake Dredging Services"
        description="Expert lake dredging services in Riverton. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, riverton lake dredging, lake dredging riverton"
        canonical="https://utahwatergardens.com/lake-dredging-riverton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Riverton",
          "description": "Professional lake dredging services in Riverton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Riverton"
        subtitle="Professional pond services for Lake Dredging Services in Riverton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Riverton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Riverton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Riverton Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Riverton Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Riverton Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Riverton Customers Say About Our Lake Dredging</h2>
