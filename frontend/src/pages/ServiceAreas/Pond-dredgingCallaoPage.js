...
const Pond-dredgingCallaoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Callao | Professional Pond Dredging Services"
        description="Expert pond dredging services in Callao. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, callao pond dredging, pond dredging callao"
        canonical="https://utahwatergardens.com/pond-dredging-callao"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Callao",
          "description": "Professional pond dredging services in Callao",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Callao"
        subtitle="Professional pond services for Pond Dredging Services in Callao and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Callao"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Callao</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Callao Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Callao Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Callao Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Callao Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCallaoPage;