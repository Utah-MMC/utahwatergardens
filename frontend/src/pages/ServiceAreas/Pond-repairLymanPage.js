...
const Pond-repairLymanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lyman | Professional Pond Repair Services"
        description="Expert pond repair services in Lyman. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lyman pond repair, pond repair lyman"
        canonical="https://utahwatergardens.com/pond-repair-lyman"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lyman",
          "description": "Professional pond repair services in Lyman",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lyman"
        subtitle="Professional pond services for Pond Repair Services in Lyman and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lyman"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lyman</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lyman Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lyman Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lyman Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lyman Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLymanPage;