...
const Lake-dredgingGoodyearPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Goodyear | Professional Lake Dredging Services"
        description="Expert lake dredging services in Goodyear. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, goodyear lake dredging, lake dredging goodyear"
        canonical="https://utahwatergardens.com/lake-dredging-goodyear"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Goodyear",
          "description": "Professional lake dredging services in Goodyear",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Goodyear"
        subtitle="Professional pond services for Lake Dredging Services in Goodyear and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Goodyear"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Goodyear</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goodyear Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goodyear Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goodyear Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goodyear Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingGoodyearPage;