...
const Lake-dredgingFrancisPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Francis | Professional Lake Dredging Services"
        description="Expert lake dredging services in Francis. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, francis lake dredging, lake dredging francis"
        canonical="https://utahwatergardens.com/lake-dredging-francis"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Francis",
          "description": "Professional lake dredging services in Francis",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Francis"
        subtitle="Professional pond services for Lake Dredging Services in Francis and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Francis"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Francis</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Francis Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Francis Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Francis Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Francis Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingFrancisPage;