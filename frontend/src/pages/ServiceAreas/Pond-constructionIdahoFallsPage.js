...
const Pond-constructionIdahoFallsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Idaho Falls | Professional Pond Construction Services"
        description="Expert pond construction services in Idaho Falls. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, idaho falls pond construction, pond construction idaho falls"
        canonical="https://utahwatergardens.com/pond-construction-idaho-falls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Idaho Falls",
          "description": "Professional pond construction services in Idaho Falls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Idaho Falls"
        subtitle="Professional pond services for Pond Construction Services in Idaho Falls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Idaho Falls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Idaho Falls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Idaho Falls Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Idaho Falls Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Idaho Falls Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Idaho Falls Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionIdahoFallsPage;