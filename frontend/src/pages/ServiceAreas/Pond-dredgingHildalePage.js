...
const Pond-dredgingHildalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hildale | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hildale. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hildale pond dredging, pond dredging hildale"
        canonical="https://utahwatergardens.com/pond-dredging-hildale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hildale",
          "description": "Professional pond dredging services in Hildale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hildale"
        subtitle="Professional pond services for Pond Dredging Services in Hildale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hildale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hildale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hildale Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hildale Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hildale Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hildale Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHildalePage;