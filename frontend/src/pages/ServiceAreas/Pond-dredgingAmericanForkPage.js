...
const Pond-dredgingAmericanForkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging American Fork | Professional Pond Dredging Services"
        description="Expert pond dredging services in American Fork. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, american fork pond dredging, pond dredging american fork"
        canonical="https://utahwatergardens.com/pond-dredging-american-fork"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services American Fork",
          "description": "Professional pond dredging services in American Fork",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in American Fork"
        subtitle="Professional pond services for Pond Dredging Services in American Fork and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in American Fork"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in American Fork</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our American Fork Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="American Fork Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our American Fork Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What American Fork Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAmericanForkPage;