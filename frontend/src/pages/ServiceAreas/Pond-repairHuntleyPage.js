...
const Pond-repairHuntleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Huntley | Professional Pond Repair Services"
        description="Expert pond repair services in Huntley. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, huntley pond repair, pond repair huntley"
        canonical="https://utahwatergardens.com/pond-repair-huntley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Huntley",
          "description": "Professional pond repair services in Huntley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Huntley"
        subtitle="Professional pond services for Pond Repair Services in Huntley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Huntley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Huntley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntley Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntley Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntley Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntley Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHuntleyPage;