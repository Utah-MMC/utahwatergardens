...
const Pond-repairElMiragePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair El Mirage | Professional Pond Repair Services"
        description="Expert pond repair services in El Mirage. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, el mirage pond repair, pond repair el mirage"
        canonical="https://utahwatergardens.com/pond-repair-el-mirage"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services El Mirage",
          "description": "Professional pond repair services in El Mirage",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in El Mirage"
        subtitle="Professional pond services for Pond Repair Services in El Mirage and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in El Mirage"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in El Mirage</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our El Mirage Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="El Mirage Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our El Mirage Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What El Mirage Customers Say About Our Pond Repair</h2>
...
export default Pond-repairElMiragePage;