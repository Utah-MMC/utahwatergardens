...
const Lake-dredgingFortLaramiePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Fort Laramie | Professional Lake Dredging Services"
        description="Expert lake dredging services in Fort Laramie. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, fort laramie lake dredging, lake dredging fort laramie"
        canonical="https://utahwatergardens.com/lake-dredging-fort-laramie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Fort Laramie",
          "description": "Professional lake dredging services in Fort Laramie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Fort Laramie"
        subtitle="Professional pond services for Lake Dredging Services in Fort Laramie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Fort Laramie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Fort Laramie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fort Laramie Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fort Laramie Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fort Laramie Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fort Laramie Customers Say About Our Lake Dredging</h2>
