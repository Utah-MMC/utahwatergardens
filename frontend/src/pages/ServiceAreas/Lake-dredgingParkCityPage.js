...
const Lake-dredgingParkCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Park City | Professional Lake Dredging Services"
        description="Expert lake dredging services in Park City. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, park city lake dredging, lake dredging park city"
        canonical="https://utahwatergardens.com/lake-dredging-park-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Park City",
          "description": "Professional lake dredging services in Park City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Park City"
        subtitle="Professional pond services for Lake Dredging Services in Park City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Park City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Park City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Park City Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Park City Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Park City Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Park City Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingParkCityPage;