...
const Pond-constructionSaltLakeCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Salt Lake City | Professional Pond Construction Services"
        description="Expert pond construction services in Salt Lake City. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, salt lake city pond construction, pond construction salt lake city"
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Professional pond construction services in Salt Lake City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        ...
        <div className="container">
          ...
          <section className="testimonials-section">
            <h2>What Salt Lake City Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSaltLakeCityPage;