...
const Pond-dredgingBoulderCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Boulder City | Professional Pond Dredging Services"
        description="Expert pond dredging services in Boulder City. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, boulder city pond dredging, pond dredging boulder city"
        canonical="https://utahwatergardens.com/pond-dredging-boulder-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Boulder City",
          "description": "Professional pond dredging services in Boulder City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Boulder City"
        subtitle="Professional pond services for Pond Dredging Services in Boulder City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Boulder City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Boulder City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boulder City Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boulder City Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boulder City Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boulder City Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBoulderCityPage;