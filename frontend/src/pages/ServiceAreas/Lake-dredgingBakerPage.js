...
const Lake-dredgingBakerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Baker | Professional Lake Dredging Services"
        description="Expert lake dredging services in Baker. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, baker lake dredging, lake dredging baker"
        canonical="https://utahwatergardens.com/lake-dredging-baker"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Baker",
          "description": "Professional lake dredging services in Baker",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Baker"
        subtitle="Professional pond services for Lake Dredging Services in Baker and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Baker"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Baker</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Baker Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Baker Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Baker Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Baker Customers Say About Our Lake Dredging</h2>
