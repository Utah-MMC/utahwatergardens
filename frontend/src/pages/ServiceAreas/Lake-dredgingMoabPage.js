...
const Lake-dredgingMoabPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Moab | Professional Lake Dredging Services"
        description="Expert lake dredging services in Moab. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, moab lake dredging, lake dredging moab"
        canonical="https://utahwatergardens.com/lake-dredging-moab"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Moab",
          "description": "Professional lake dredging services in Moab",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Moab"
        subtitle="Professional pond services for Lake Dredging Services in Moab and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Moab"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Moab</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moab Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moab Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moab Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moab Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMoabPage;