...
const Pond-cleaningJayEmPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Jay Em | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Jay Em. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, jay em pond cleaning, pond cleaning jay em"
        canonical="https://utahwatergardens.com/pond-cleaning-jay-em"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Jay Em",
          "description": "Professional pond cleaning services in Jay Em",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Jay Em"
        subtitle="Professional pond services for Pond Cleaning Services in Jay Em and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Jay Em"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Jay Em</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jay Em Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jay Em Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jay Em Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jay Em Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningJayEmPage;