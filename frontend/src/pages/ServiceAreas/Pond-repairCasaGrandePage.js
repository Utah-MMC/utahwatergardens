...
const Pond-repairCasaGrandePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Casa Grande | Professional Pond Repair Services"
        description="Expert pond repair services in Casa Grande. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, casa grande pond repair, pond repair casa grande"
        canonical="https://utahwatergardens.com/pond-repair-casa-grande"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Casa Grande",
          "description": "Professional pond repair services in Casa Grande",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Casa Grande"
        subtitle="Professional pond services for Pond Repair Services in Casa Grande and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Casa Grande"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Casa Grande</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Casa Grande Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Casa Grande Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Casa Grande Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Casa Grande Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCasaGrandePage;