...
const HarvestingParowanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Parowan | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Parowan. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, parowan aquatic plant harvesting, aquatic plant harvesting parowan"
        canonical="https://utahwatergardens.com/harvesting-parowan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Parowan",
          "description": "Professional aquatic plant harvesting services in Parowan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Parowan"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Parowan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Parowan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Parowan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parowan Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parowan Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parowan Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parowan Customers Say About Our Aquatic Plant Harvesting</h2>
