...
const Pond-repairLovelockPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lovelock | Professional Pond Repair Services"
        description="Expert pond repair services in Lovelock. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lovelock pond repair, pond repair lovelock"
        canonical="https://utahwatergardens.com/pond-repair-lovelock"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lovelock",
          "description": "Professional pond repair services in Lovelock",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lovelock"
        subtitle="Professional pond services for Pond Repair Services in Lovelock and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lovelock"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lovelock</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lovelock Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lovelock Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lovelock Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lovelock Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLovelockPage;