...
const Pond-repairHelperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Helper | Professional Pond Repair Services"
        description="Expert pond repair services in Helper. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, helper pond repair, pond repair helper"
        canonical="https://utahwatergardens.com/pond-repair-helper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Helper",
          "description": "Professional pond repair services in Helper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Helper"
        subtitle="Professional pond services for Pond Repair Services in Helper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Helper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Helper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Helper Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Helper Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Helper Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Helper Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHelperPage;