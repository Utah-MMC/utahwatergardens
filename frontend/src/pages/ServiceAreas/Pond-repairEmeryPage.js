...
const Pond-repairEmeryPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Emery | Professional Pond Repair Services"
        description="Expert pond repair services in Emery. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, emery pond repair, pond repair emery"
        canonical="https://utahwatergardens.com/pond-repair-emery"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Emery",
          "description": "Professional pond repair services in Emery",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Emery"
        subtitle="Professional pond services for Pond Repair Services in Emery and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Emery"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Emery</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Emery Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Emery Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Emery Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Emery Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEmeryPage;