...
const Pond-dredgingTetonVillagePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Teton Village | Professional Pond Dredging Services"
        description="Expert pond dredging services in Teton Village. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, teton village pond dredging, pond dredging teton village"
        canonical="https://utahwatergardens.com/pond-dredging-teton-village"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Teton Village",
          "description": "Professional pond dredging services in Teton Village",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Teton Village"
        subtitle="Professional pond services for Pond Dredging Services in Teton Village and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Teton Village"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Teton Village</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Teton Village Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Teton Village Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Teton Village Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Teton Village Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingTetonVillagePage;