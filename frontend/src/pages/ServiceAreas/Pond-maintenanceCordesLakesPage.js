...
const Pond-maintenanceCordesLakesPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Cordes Lakes | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Cordes Lakes. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, cordes lakes pond maintenance, pond maintenance cordes lakes"
        canonical="https://utahwatergardens.com/pond-maintenance-cordes-lakes"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Cordes Lakes",
          "description": "Professional pond maintenance services in Cordes Lakes",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Cordes Lakes"
        subtitle="Professional pond services for Pond Maintenance Services in Cordes Lakes and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Cordes Lakes"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Cordes Lakes</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cordes Lakes Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cordes Lakes Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cordes Lakes Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cordes Lakes Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceCordesLakesPage;