...
const Lake-dredgingOphirPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Ophir | Professional Lake Dredging Services"
        description="Expert lake dredging services in Ophir. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, ophir lake dredging, lake dredging ophir"
        canonical="https://utahwatergardens.com/lake-dredging-ophir"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Ophir",
          "description": "Professional lake dredging services in Ophir",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Ophir"
        subtitle="Professional pond services for Lake Dredging Services in Ophir and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Ophir"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Ophir</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ophir Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ophir Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ophir Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ophir Customers Say About Our Lake Dredging</h2>
