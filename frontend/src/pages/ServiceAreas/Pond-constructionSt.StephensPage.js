...
const Pond-constructionSt.StephensPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction St. Stephens | Professional Pond Construction Services"
        description="Expert pond construction services in St. Stephens. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, st. stephens pond construction, pond construction st. stephens"
        canonical="https://utahwatergardens.com/pond-construction-st.-stephens"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services St. Stephens",
          "description": "Professional pond construction services in St. Stephens",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in St. Stephens"
        subtitle="Professional pond services for Pond Construction Services in St. Stephens and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in St. Stephens"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in St. Stephens</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. Stephens Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. Stephens Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. Stephens Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. Stephens Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSt.StephensPage;