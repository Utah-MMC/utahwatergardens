...
const Pond-cleaningGenolaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Genola | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Genola. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, genola pond cleaning, pond cleaning genola"
        canonical="https://utahwatergardens.com/pond-cleaning-genola"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Genola",
          "description": "Professional pond cleaning services in Genola",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Genola"
        subtitle="Professional pond services for Pond Cleaning Services in Genola and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Genola"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Genola</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Genola Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Genola Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Genola Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Genola Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningGenolaPage;