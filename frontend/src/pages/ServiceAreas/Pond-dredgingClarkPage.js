...
const Pond-dredgingClarkPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Clark | Professional Pond Dredging Services"
        description="Expert pond dredging services in Clark. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, clark pond dredging, pond dredging clark"
        canonical="https://utahwatergardens.com/pond-dredging-clark"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Clark",
          "description": "Professional pond dredging services in Clark",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Clark"
        subtitle="Professional pond services for Pond Dredging Services in Clark and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Clark"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Clark</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clark Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clark Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clark Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clark Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingClarkPage;