...
const Pond-dredgingFlorencePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Florence | Professional Pond Dredging Services"
        description="Expert pond dredging services in Florence. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, florence pond dredging, pond dredging florence"
        canonical="https://utahwatergardens.com/pond-dredging-florence"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Florence",
          "description": "Professional pond dredging services in Florence",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Florence"
        subtitle="Professional pond services for Pond Dredging Services in Florence and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Florence"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Florence</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Florence Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Florence Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Florence Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Florence Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFlorencePage;