...
const Lake-dredgingPiochePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Pioche | Professional Lake Dredging Services"
        description="Expert lake dredging services in Pioche. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, pioche lake dredging, lake dredging pioche"
        canonical="https://utahwatergardens.com/lake-dredging-pioche"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Pioche",
          "description": "Professional lake dredging services in Pioche",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Pioche"
        subtitle="Professional pond services for Lake Dredging Services in Pioche and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Pioche"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Pioche</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pioche Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pioche Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pioche Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pioche Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingPiochePage;