...
const Pond-dredgingSummerlinPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Summerlin | Professional Pond Dredging Services"
        description="Expert pond dredging services in Summerlin. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, summerlin pond dredging, pond dredging summerlin"
        canonical="https://utahwatergardens.com/pond-dredging-summerlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Summerlin",
          "description": "Professional pond dredging services in Summerlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Summerlin"
        subtitle="Professional pond services for Pond Dredging Services in Summerlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Summerlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Summerlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Summerlin Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Summerlin Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Summerlin Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Summerlin Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSummerlinPage;