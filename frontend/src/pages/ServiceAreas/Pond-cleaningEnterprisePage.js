...
const Pond-cleaningEnterprisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Enterprise | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Enterprise. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, enterprise pond cleaning, pond cleaning enterprise"
        canonical="https://utahwatergardens.com/pond-cleaning-enterprise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Enterprise",
          "description": "Professional pond cleaning services in Enterprise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Enterprise"
        subtitle="Professional pond services for Pond Cleaning Services in Enterprise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Enterprise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Enterprise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Enterprise Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Enterprise Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Enterprise Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Enterprise Customers Say About Our Pond Cleaning</h2>
