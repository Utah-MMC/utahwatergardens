...
const Pond-cleaningJordanellePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Jordanelle | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Jordanelle. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, jordanelle pond cleaning, pond cleaning jordanelle"
        canonical="https://utahwatergardens.com/pond-cleaning-jordanelle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Jordanelle",
          "description": "Professional pond cleaning services in Jordanelle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Jordanelle"
        subtitle="Professional pond services for Pond Cleaning Services in Jordanelle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Jordanelle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Jordanelle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jordanelle Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jordanelle Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jordanelle Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jordanelle Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningJordanellePage;