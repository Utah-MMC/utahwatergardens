...
const Pond-repairRichfieldPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Richfield | Professional Pond Repair Services"
        description="Expert pond repair services in Richfield. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, richfield pond repair, pond repair richfield"
        canonical="https://utahwatergardens.com/pond-repair-richfield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Richfield",
          "description": "Professional pond repair services in Richfield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Richfield"
        subtitle="Professional pond services for Pond Repair Services in Richfield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Richfield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Richfield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Richfield Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Richfield Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Richfield Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Richfield Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRichfieldPage;