...
const Lake-dredgingUconPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Ucon | Professional Lake Dredging Services"
        description="Expert lake dredging services in Ucon. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, ucon lake dredging, lake dredging ucon"
        canonical="https://utahwatergardens.com/lake-dredging-ucon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Ucon",
          "description": "Professional lake dredging services in Ucon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Ucon"
        subtitle="Professional pond services for Lake Dredging Services in Ucon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Ucon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Ucon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ucon Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ucon Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ucon Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ucon Customers Say About Our Lake Dredging</h2>
