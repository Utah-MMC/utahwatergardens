...
const Pond-dredgingPricePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Price | Professional Pond Dredging Services"
        description="Expert pond dredging services in Price. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, price pond dredging, pond dredging price"
        canonical="https://utahwatergardens.com/pond-dredging-price"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Price",
          "description": "Professional pond dredging services in Price",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Price"
        subtitle="Professional pond services for Pond Dredging Services in Price and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Price"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Price</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Price Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Price Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Price Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Price Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPricePage;