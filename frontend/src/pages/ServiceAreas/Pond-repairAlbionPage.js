...
const Pond-repairAlbionPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Albion | Professional Pond Repair Services"
        description="Expert pond repair services in Albion. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, albion pond repair, pond repair albion"
        canonical="https://utahwatergardens.com/pond-repair-albion"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Albion",
          "description": "Professional pond repair services in Albion",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Albion"
        subtitle="Professional pond services for Pond Repair Services in Albion and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Albion"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Albion</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Albion Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Albion Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Albion Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Albion Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAlbionPage;