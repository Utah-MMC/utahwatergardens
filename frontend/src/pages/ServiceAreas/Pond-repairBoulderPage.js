...
const Pond-repairBoulderPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Boulder | Professional Pond Repair Services"
        description="Expert pond repair services in Boulder. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, boulder pond repair, pond repair boulder"
        canonical="https://utahwatergardens.com/pond-repair-boulder"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Boulder",
          "description": "Professional pond repair services in Boulder",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Boulder"
        subtitle="Professional pond services for Pond Repair Services in Boulder and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Boulder"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Boulder</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boulder Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boulder Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boulder Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boulder Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBoulderPage;