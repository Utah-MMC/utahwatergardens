...
const Pond-repairManvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Manville | Professional Pond Repair Services"
        description="Expert pond repair services in Manville. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, manville pond repair, pond repair manville"
        canonical="https://utahwatergardens.com/pond-repair-manville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Manville",
          "description": "Professional pond repair services in Manville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Manville"
        subtitle="Professional pond services for Pond Repair Services in Manville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Manville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Manville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Manville Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Manville Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Manville Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Manville Customers Say About Our Pond Repair</h2>
...
export default Pond-repairManvillePage;