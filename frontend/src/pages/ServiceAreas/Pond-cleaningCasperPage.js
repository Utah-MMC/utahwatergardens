...
const Pond-cleaningCasperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Casper | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Casper. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, casper pond cleaning, pond cleaning casper"
        canonical="https://utahwatergardens.com/pond-cleaning-casper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Casper",
          "description": "Professional pond cleaning services in Casper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Casper"
        subtitle="Professional pond services for Pond Cleaning Services in Casper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Casper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Casper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Casper Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Casper Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Casper Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Casper Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCasperPage;