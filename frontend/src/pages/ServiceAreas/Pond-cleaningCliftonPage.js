...
const Pond-cleaningCliftonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Clifton | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Clifton. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, clifton pond cleaning, pond cleaning clifton"
        canonical="https://utahwatergardens.com/pond-cleaning-clifton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Clifton",
          "description": "Professional pond cleaning services in Clifton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Clifton"
        subtitle="Professional pond services for Pond Cleaning Services in Clifton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Clifton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Clifton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clifton Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clifton Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clifton Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clifton Customers Say About Our Pond Cleaning</h2>
