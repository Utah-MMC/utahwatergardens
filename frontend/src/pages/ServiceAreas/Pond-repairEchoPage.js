...
const Pond-repairEchoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Echo | Professional Pond Repair Services"
        description="Expert pond repair services in Echo. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, echo pond repair, pond repair echo"
        canonical="https://utahwatergardens.com/pond-repair-echo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Echo",
          "description": "Professional pond repair services in Echo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Echo"
        subtitle="Professional pond services for Pond Repair Services in Echo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Echo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Echo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Echo Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Echo Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Echo Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Echo Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEchoPage;