...
const Pond-maintenanceAmericanForkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance American Fork | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in American Fork. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, american fork pond maintenance, pond maintenance american fork"
        canonical="https://utahwatergardens.com/pond-maintenance-american-fork"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services American Fork",
          "description": "Professional pond maintenance services in American Fork",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in American Fork"
        subtitle="Professional pond services for Pond Maintenance Services in American Fork and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in American Fork"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in American Fork</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our American Fork Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="American Fork Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our American Fork Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What American Fork Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceAmericanForkPage;