...
const Pond-repairCottonwoodHeightsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Cottonwood Heights | Professional Pond Repair Services"
        description="Expert pond repair services in Cottonwood Heights. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, cottonwood heights pond repair, pond repair cottonwood heights"
        canonical="https://utahwatergardens.com/pond-repair-cottonwood-heights"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Cottonwood Heights",
          "description": "Professional pond repair services in Cottonwood Heights",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Cottonwood Heights"
        subtitle="Professional pond services for Pond Repair Services in Cottonwood Heights and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Cottonwood Heights"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Cottonwood Heights</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cottonwood Heights Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cottonwood Heights Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cottonwood Heights Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cottonwood Heights Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCottonwoodHeightsPage;