...
const Water-feature-designDeweyvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Deweyville | Professional Water Feature Design Services"
        description="Expert water feature design services in Deweyville. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, deweyville water feature design, water feature design deweyville"
        canonical="https://utahwatergardens.com/water-feature-design-deweyville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Deweyville",
          "description": "Professional water feature design services in Deweyville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Deweyville"
        subtitle="Professional pond services for Water Feature Design Services in Deweyville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Deweyville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Deweyville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Deweyville Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Deweyville Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Deweyville Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Deweyville Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designDeweyvillePage;