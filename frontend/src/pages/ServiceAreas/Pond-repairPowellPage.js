...
const Pond-repairPowellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Powell | Professional Pond Repair Services"
        description="Expert pond repair services in Powell. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, powell pond repair, pond repair powell"
        canonical="https://utahwatergardens.com/pond-repair-powell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Powell",
          "description": "Professional pond repair services in Powell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Powell"
        subtitle="Professional pond services for Pond Repair Services in Powell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Powell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Powell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Powell Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Powell Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Powell Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Powell Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPowellPage;