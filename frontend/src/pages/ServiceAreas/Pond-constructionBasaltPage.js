...
const Pond-constructionBasaltPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Basalt | Professional Pond Construction Services"
        description="Expert pond construction services in Basalt. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, basalt pond construction, pond construction basalt"
        canonical="https://utahwatergardens.com/pond-construction-basalt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Basalt",
          "description": "Professional pond construction services in Basalt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Basalt"
        subtitle="Professional pond services for Pond Construction Services in Basalt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Basalt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Basalt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Basalt Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Basalt Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Basalt Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Basalt Customers Say About Our Pond Construction</h2>
