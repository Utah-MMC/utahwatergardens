...
const Lake-dredgingEastCarbonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging East Carbon | Professional Lake Dredging Services"
        description="Expert lake dredging services in East Carbon. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, east carbon lake dredging, lake dredging east carbon"
        canonical="https://utahwatergardens.com/lake-dredging-east-carbon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services East Carbon",
          "description": "Professional lake dredging services in East Carbon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in East Carbon"
        subtitle="Professional pond services for Lake Dredging Services in East Carbon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in East Carbon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in East Carbon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our East Carbon Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="East Carbon Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our East Carbon Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What East Carbon Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingEastCarbonPage;