...
const Pond-repairWillardPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Willard | Professional Pond Repair Services"
        description="Expert pond repair services in Willard. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, willard pond repair, pond repair willard"
        canonical="https://utahwatergardens.com/pond-repair-willard"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Willard",
          "description": "Professional pond repair services in Willard",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Willard"
        subtitle="Professional pond services for Pond Repair Services in Willard and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Willard"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Willard</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Willard Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Willard Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Willard Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Willard Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWillardPage;