...
const Lake-dredgingBearRiverCityPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Bear River City | Professional Lake Dredging Services"
        description="Expert lake dredging services in Bear River City. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, bear river city lake dredging, lake dredging bear river city"
        canonical="https://utahwatergardens.com/lake-dredging-bear-river-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Bear River City",
          "description": "Professional lake dredging services in Bear River City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Bear River City"
        subtitle="Professional pond services for Lake Dredging Services in Bear River City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Bear River City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Bear River City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bear River City Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bear River City Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bear River City Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bear River City Customers Say About Our Lake Dredging</h2>
