...
const Pond-dredgingMoabPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Moab | Professional Pond Dredging Services"
        description="Expert pond dredging services in Moab. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, moab pond dredging, pond dredging moab"
        canonical="https://utahwatergardens.com/pond-dredging-moab"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Moab",
          "description": "Professional pond dredging services in Moab",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Moab"
        subtitle="Professional pond services for Pond Dredging Services in Moab and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Moab"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Moab</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moab Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moab Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moab Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moab Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMoabPage;