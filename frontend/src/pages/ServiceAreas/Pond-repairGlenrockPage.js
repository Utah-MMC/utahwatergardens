...
const Pond-repairGlenrockPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Glenrock | Professional Pond Repair Services"
        description="Expert pond repair services in Glenrock. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, glenrock pond repair, pond repair glenrock"
        canonical="https://utahwatergardens.com/pond-repair-glenrock"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Glenrock",
          "description": "Professional pond repair services in Glenrock",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Glenrock"
        subtitle="Professional pond services for Pond Repair Services in Glenrock and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Glenrock"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Glenrock</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glenrock Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glenrock Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glenrock Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glenrock Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGlenrockPage;