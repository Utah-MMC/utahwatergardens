...
const Pond-repairDuboisPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Dubois | Professional Pond Repair Services"
        description="Expert pond repair services in Dubois. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, dubois pond repair, pond repair dubois"
        canonical="https://utahwatergardens.com/pond-repair-dubois"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Dubois",
          "description": "Professional pond repair services in Dubois",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Dubois"
        subtitle="Professional pond services for Pond Repair Services in Dubois and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Dubois"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Dubois</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dubois Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dubois Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dubois Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dubois Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDuboisPage;