...
const Pond-cleaningIndependencePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Independence | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Independence. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, independence pond cleaning, pond cleaning independence"
        canonical="https://utahwatergardens.com/pond-cleaning-independence"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Independence",
          "description": "Professional pond cleaning services in Independence",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Independence"
        subtitle="Professional pond services for Pond Cleaning Services in Independence and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Independence"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Independence</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Independence Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Independence Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Independence Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Independence Customers Say About Our Pond Cleaning</h2>
