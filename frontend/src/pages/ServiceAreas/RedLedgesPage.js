  ...
  return (
    <div className="service-area-page">
      <PageHero 
        ...
        subtitle="Professional pond services for Red Ledges luxury community in Heber City, Utah"
        backgroundImage="/images/pond-services-hero.jpg"
        backgroundImageAlt="Professional pond services in Red Ledges, Heber City Utah"
      />
      ...
      <div className="container">
        ...
        >
          <h2>Ready to Get Started in Red Ledges?</h2>
          <p>Contact us today for a free consultation and quote on your Red Ledges luxury pond project.</p>
