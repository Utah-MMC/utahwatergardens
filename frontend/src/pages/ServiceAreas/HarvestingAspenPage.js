...
const HarvestingAspenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Aspen | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Aspen. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, aspen aquatic plant harvesting, aquatic plant harvesting aspen"
        canonical="https://utahwatergardens.com/harvesting-aspen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Aspen",
          "description": "Professional aquatic plant harvesting services in Aspen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Aspen"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Aspen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Aspen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Aspen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aspen Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aspen Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aspen Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aspen Customers Say About Our Aquatic Plant Harvesting</h2>
