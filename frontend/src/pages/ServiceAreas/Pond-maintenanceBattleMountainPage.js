...
const Pond-maintenanceBattleMountainPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Battle Mountain | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Battle Mountain. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, battle mountain pond maintenance, pond maintenance battle mountain"
        canonical="https://utahwatergardens.com/pond-maintenance-battle-mountain"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Battle Mountain",
          "description": "Professional pond maintenance services in Battle Mountain",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Battle Mountain"
        subtitle="Professional pond services for Pond Maintenance Services in Battle Mountain and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Battle Mountain"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Battle Mountain</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Battle Mountain Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Battle Mountain Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Battle Mountain Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Battle Mountain Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceBattleMountainPage;