...
const Pond-repairWestJordanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair West Jordan | Professional Pond Repair Services"
        description="Expert pond repair services in West Jordan. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, west jordan pond repair, pond repair west jordan"
        canonical="https://utahwatergardens.com/pond-repair-west-jordan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services West Jordan",
          "description": "Professional pond repair services in West Jordan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in West Jordan"
        subtitle="Professional pond services for Pond Repair Services in West Jordan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in West Jordan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in West Jordan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Jordan Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Jordan Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Jordan Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Jordan Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWestJordanPage;