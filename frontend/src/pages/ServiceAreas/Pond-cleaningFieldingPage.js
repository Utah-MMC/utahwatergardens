...
const Pond-cleaningFieldingPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Fielding | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Fielding. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, fielding pond cleaning, pond cleaning fielding"
        canonical="https://utahwatergardens.com/pond-cleaning-fielding"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Fielding",
          "description": "Professional pond cleaning services in Fielding",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Fielding"
        subtitle="Professional pond services for Pond Cleaning Services in Fielding and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Fielding"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Fielding</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fielding Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fielding Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fielding Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fielding Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningFieldingPage;