...
const Lake-dredgingSparksPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sparks | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sparks. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sparks lake dredging, lake dredging sparks"
        canonical="https://utahwatergardens.com/lake-dredging-sparks"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sparks",
          "description": "Professional lake dredging services in Sparks",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sparks"
        subtitle="Professional pond services for Lake Dredging Services in Sparks and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sparks"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sparks</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sparks Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sparks Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sparks Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sparks Customers Say About Our Lake Dredging</h2>
