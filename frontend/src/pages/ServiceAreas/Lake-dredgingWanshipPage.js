...
const Lake-dredgingWanshipPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Wanship | Professional Lake Dredging Services"
        description="Expert lake dredging services in Wanship. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, wanship lake dredging, lake dredging wanship"
        canonical="https://utahwatergardens.com/lake-dredging-wanship"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Wanship",
          "description": "Professional lake dredging services in Wanship",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Wanship"
        subtitle="Professional pond services for Lake Dredging Services in Wanship and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Wanship"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Wanship</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wanship Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wanship Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wanship Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wanship Customers Say About Our Lake Dredging</h2>
