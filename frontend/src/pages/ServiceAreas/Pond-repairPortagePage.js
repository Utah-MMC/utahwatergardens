...
const Pond-repairPortagePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Portage | Professional Pond Repair Services"
        description="Expert pond repair services in Portage. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, portage pond repair, pond repair portage"
        canonical="https://utahwatergardens.com/pond-repair-portage"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Portage",
          "description": "Professional pond repair services in Portage",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Portage"
        subtitle="Professional pond services for Pond Repair Services in Portage and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Portage"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Portage</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Portage Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Portage Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Portage Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Portage Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPortagePage;