...
const Lake-dredgingAmalgaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Amalga | Professional Lake Dredging Services"
        description="Expert lake dredging services in Amalga. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, amalga lake dredging, lake dredging amalga"
        canonical="https://utahwatergardens.com/lake-dredging-amalga"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Amalga",
          "description": "Professional lake dredging services in Amalga",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Amalga"
        subtitle="Professional pond services for Lake Dredging Services in Amalga and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Amalga"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Amalga</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Amalga Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Amalga Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Amalga Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Amalga Customers Say About Our Lake Dredging</h2>
