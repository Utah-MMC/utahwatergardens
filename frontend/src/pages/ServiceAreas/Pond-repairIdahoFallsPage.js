...
const Pond-repairIdahoFallsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Idaho Falls | Professional Pond Repair Services"
        description="Expert pond repair services in Idaho Falls. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, idaho falls pond repair, pond repair idaho falls"
        canonical="https://utahwatergardens.com/pond-repair-idaho-falls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Idaho Falls",
          "description": "Professional pond repair services in Idaho Falls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Idaho Falls"
        subtitle="Professional pond services for Pond Repair Services in Idaho Falls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Idaho Falls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Idaho Falls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Idaho Falls Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Idaho Falls Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Idaho Falls Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Idaho Falls Customers Say About Our Pond Repair</h2>
...
export default Pond-repairIdahoFallsPage;