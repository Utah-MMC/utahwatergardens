...
const Pond-cleaningLostSpringsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lost Springs | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lost Springs. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lost springs pond cleaning, pond cleaning lost springs"
        canonical="https://utahwatergardens.com/pond-cleaning-lost-springs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lost Springs",
          "description": "Professional pond cleaning services in Lost Springs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lost Springs"
        subtitle="Professional pond services for Pond Cleaning Services in Lost Springs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lost Springs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lost Springs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lost Springs Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lost Springs Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lost Springs Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lost Springs Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLostSpringsPage;