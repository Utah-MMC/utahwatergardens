...
const Pond-repairJeremyRanchPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Jeremy Ranch | Professional Pond Repair Services"
        description="Expert pond repair services in Jeremy Ranch. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, jeremy ranch pond repair, pond repair jeremy ranch"
        canonical="https://utahwatergardens.com/pond-repair-jeremy-ranch"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Jeremy Ranch",
          "description": "Professional pond repair services in Jeremy Ranch",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Jeremy Ranch"
        subtitle="Professional pond services for Pond Repair Services in Jeremy Ranch and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Jeremy Ranch"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Jeremy Ranch</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jeremy Ranch Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jeremy Ranch Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jeremy Ranch Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jeremy Ranch Customers Say About Our Pond Repair</h2>
...
export default Pond-repairJeremyRanchPage;