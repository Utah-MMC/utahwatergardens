...
const Pond-cleaningBurleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Burley | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Burley. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, burley pond cleaning, pond cleaning burley"
        canonical="https://utahwatergardens.com/pond-cleaning-burley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Burley",
          "description": "Professional pond cleaning services in Burley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Burley"
        subtitle="Professional pond services for Pond Cleaning Services in Burley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Burley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Burley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Burley Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Burley Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Burley Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Burley Customers Say About Our Pond Cleaning</h2>
