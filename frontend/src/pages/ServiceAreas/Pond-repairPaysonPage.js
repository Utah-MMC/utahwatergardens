...
const Pond-repairPaysonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Payson | Professional Pond Repair Services"
        description="Expert pond repair services in Payson. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, payson pond repair, pond repair payson"
        canonical="https://utahwatergardens.com/pond-repair-payson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Payson",
          "description": "Professional pond repair services in Payson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Payson"
        subtitle="Professional pond services for Pond Repair Services in Payson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Payson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Payson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Payson Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Payson Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Payson Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Payson Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPaysonPage;