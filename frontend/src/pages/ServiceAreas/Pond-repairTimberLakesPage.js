...
const Pond-repairTimberLakesPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Timber Lakes | Professional Pond Repair Services"
        description="Expert pond repair services in Timber Lakes. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, timber lakes pond repair, pond repair timber lakes"
        canonical="https://utahwatergardens.com/pond-repair-timber-lakes"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Timber Lakes",
          "description": "Professional pond repair services in Timber Lakes",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Timber Lakes"
        subtitle="Professional pond services for Pond Repair Services in Timber Lakes and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Timber Lakes"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Timber Lakes</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Timber Lakes Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Timber Lakes Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Timber Lakes Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Timber Lakes Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTimberLakesPage;