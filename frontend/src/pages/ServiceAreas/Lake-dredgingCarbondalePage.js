...
const Lake-dredgingCarbondalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Carbondale | Professional Lake Dredging Services"
        description="Expert lake dredging services in Carbondale. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, carbondale lake dredging, lake dredging carbondale"
        canonical="https://utahwatergardens.com/lake-dredging-carbondale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Carbondale",
          "description": "Professional lake dredging services in Carbondale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Carbondale"
        subtitle="Professional pond services for Lake Dredging Services in Carbondale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Carbondale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Carbondale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carbondale Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carbondale Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carbondale Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carbondale Customers Say About Our Lake Dredging</h2>
