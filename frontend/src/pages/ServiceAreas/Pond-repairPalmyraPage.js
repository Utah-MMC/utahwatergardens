...
const Pond-repairPalmyraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Palmyra | Professional Pond Repair Services"
        description="Expert pond repair services in Palmyra. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, palmyra pond repair, pond repair palmyra"
        canonical="https://utahwatergardens.com/pond-repair-palmyra"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Palmyra",
          "description": "Professional pond repair services in Palmyra",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Palmyra"
        subtitle="Professional pond services for Pond Repair Services in Palmyra and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Palmyra"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Palmyra</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Palmyra Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Palmyra Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Palmyra Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Palmyra Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPalmyraPage;