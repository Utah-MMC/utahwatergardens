...
const Pond-maintenanceSpringValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Spring Valley | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Spring Valley. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, spring valley pond maintenance, pond maintenance spring valley"
        canonical="https://utahwatergardens.com/pond-maintenance-spring-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Spring Valley",
          "description": "Professional pond maintenance services in Spring Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Spring Valley"
        subtitle="Professional pond services for Pond Maintenance Services in Spring Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Spring Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Spring Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spring Valley Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spring Valley Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spring Valley Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spring Valley Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSpringValleyPage;