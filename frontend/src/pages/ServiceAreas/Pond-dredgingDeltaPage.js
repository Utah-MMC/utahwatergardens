...
const Pond-dredgingDeltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Delta | Professional Pond Dredging Services"
        description="Expert pond dredging services in Delta. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, delta pond dredging, pond dredging delta"
        canonical="https://utahwatergardens.com/pond-dredging-delta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Delta",
          "description": "Professional pond dredging services in Delta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Delta"
        subtitle="Professional pond services for Pond Dredging Services in Delta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Delta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Delta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Delta Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Delta Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Delta Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Delta Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingDeltaPage;