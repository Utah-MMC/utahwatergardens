...
const Pond-maintenanceSiltPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Silt | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Silt. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, silt pond maintenance, pond maintenance silt"
        canonical="https://utahwatergardens.com/pond-maintenance-silt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Silt",
          "description": "Professional pond maintenance services in Silt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Silt"
        subtitle="Professional pond services for Pond Maintenance Services in Silt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Silt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Silt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Silt Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Silt Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Silt Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Silt Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSiltPage;