...
const Pond-cleaningHerrimanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Herriman | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Herriman. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, herriman pond cleaning, pond cleaning herriman"
        canonical="https://utahwatergardens.com/pond-cleaning-herriman"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Herriman",
          "description": "Professional pond cleaning services in Herriman",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Herriman"
        subtitle="Professional pond services for Pond Cleaning Services in Herriman and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Herriman"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Herriman</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Herriman Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Herriman Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Herriman Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Herriman Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningHerrimanPage;