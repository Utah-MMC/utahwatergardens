...
const Pond-repairGoodyearPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Goodyear | Professional Pond Repair Services"
        description="Expert pond repair services in Goodyear. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, goodyear pond repair, pond repair goodyear"
        canonical="https://utahwatergardens.com/pond-repair-goodyear"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Goodyear",
          "description": "Professional pond repair services in Goodyear",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Goodyear"
        subtitle="Professional pond services for Pond Repair Services in Goodyear and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Goodyear"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Goodyear</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goodyear Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goodyear Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goodyear Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goodyear Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGoodyearPage;