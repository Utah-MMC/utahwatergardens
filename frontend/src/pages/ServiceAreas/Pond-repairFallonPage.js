...
const Pond-repairFallonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Fallon | Professional Pond Repair Services"
        description="Expert pond repair services in Fallon. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, fallon pond repair, pond repair fallon"
        canonical="https://utahwatergardens.com/pond-repair-fallon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Fallon",
          "description": "Professional pond repair services in Fallon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Fallon"
        subtitle="Professional pond services for Pond Repair Services in Fallon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Fallon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Fallon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fallon Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fallon Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fallon Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fallon Customers Say About Our Pond Repair</h2>
...
export default Pond-repairFallonPage;