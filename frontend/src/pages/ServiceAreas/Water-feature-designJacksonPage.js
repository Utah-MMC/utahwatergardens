...
const Water-feature-designJacksonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Jackson | Professional Water Feature Design Services"
        description="Expert water feature design services in Jackson. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, jackson water feature design, water feature design jackson"
        canonical="https://utahwatergardens.com/water-feature-design-jackson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Jackson",
          "description": "Professional water feature design services in Jackson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Jackson"
        subtitle="Professional pond services for Water Feature Design Services in Jackson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Jackson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Jackson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jackson Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jackson Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jackson Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jackson Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designJacksonPage;