...
const Pond-repairBakerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Baker | Professional Pond Repair Services"
        description="Expert pond repair services in Baker. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, baker pond repair, pond repair baker"
        canonical="https://utahwatergardens.com/pond-repair-baker"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Baker",
          "description": "Professional pond repair services in Baker",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Baker"
        subtitle="Professional pond services for Pond Repair Services in Baker and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Baker"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Baker</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Baker Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Baker Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Baker Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Baker Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBakerPage;