...
const Pond-dredgingParachutePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Parachute | Professional Pond Dredging Services"
        description="Expert pond dredging services in Parachute. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, parachute pond dredging, pond dredging parachute"
        canonical="https://utahwatergardens.com/pond-dredging-parachute"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Parachute",
          "description": "Professional pond dredging services in Parachute",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Parachute"
        subtitle="Professional pond services for Pond Dredging Services in Parachute and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Parachute"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Parachute</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Parachute Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Parachute Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Parachute Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Parachute Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingParachutePage;