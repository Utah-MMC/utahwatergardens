...
const Pond-dredgingMountainViewPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Mountain View | Professional Pond Dredging Services"
        description="Expert pond dredging services in Mountain View. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, mountain view pond dredging, pond dredging mountain view"
        canonical="https://utahwatergardens.com/pond-dredging-mountain-view"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Mountain View",
          "description": "Professional pond dredging services in Mountain View",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Mountain View"
        subtitle="Professional pond services for Pond Dredging Services in Mountain View and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Mountain View"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Mountain View</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mountain View Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mountain View Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mountain View Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mountain View Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMountainViewPage;