...
const Pond-maintenanceProvoPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Provo | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Provo. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, provo pond maintenance, pond maintenance provo"
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Professional pond maintenance services in Provo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      />
        ...
        <div className="container">
          ...
          <section className="testimonials-section">
            <h2>What Provo Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceProvoPage;