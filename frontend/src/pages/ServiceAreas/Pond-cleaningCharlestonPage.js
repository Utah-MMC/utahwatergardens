...
const Pond-cleaningCharlestonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Charleston | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Charleston. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, charleston pond cleaning, pond cleaning charleston"
        canonical="https://utahwatergardens.com/pond-cleaning-charleston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Charleston",
          "description": "Professional pond cleaning services in Charleston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Charleston"
        subtitle="Professional pond services for Pond Cleaning Services in Charleston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Charleston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Charleston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Charleston Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Charleston Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Charleston Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Charleston Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningCharlestonPage;