...
const Lake-dredgingHagermanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Hagerman | Professional Lake Dredging Services"
        description="Expert lake dredging services in Hagerman. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, hagerman lake dredging, lake dredging hagerman"
        canonical="https://utahwatergardens.com/lake-dredging-hagerman"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Hagerman",
          "description": "Professional lake dredging services in Hagerman",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Hagerman"
        subtitle="Professional pond services for Lake Dredging Services in Hagerman and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Hagerman"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Hagerman</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hagerman Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hagerman Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hagerman Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hagerman Customers Say About Our Lake Dredging</h2>
