...
const Pond-maintenanceLaBargePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance La Barge | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in La Barge. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, la barge pond maintenance, pond maintenance la barge"
        canonical="https://utahwatergardens.com/pond-maintenance-la-barge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services La Barge",
          "description": "Professional pond maintenance services in La Barge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in La Barge"
        subtitle="Professional pond services for Pond Maintenance Services in La Barge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in La Barge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in La Barge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Barge Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Barge Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Barge Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Barge Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceLaBargePage;