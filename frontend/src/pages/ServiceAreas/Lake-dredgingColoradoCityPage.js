...
const Lake-dredgingColoradoCityPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Colorado City | Professional Lake Dredging Services"
        description="Expert lake dredging services in Colorado City. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, colorado city lake dredging, lake dredging colorado city"
        canonical="https://utahwatergardens.com/lake-dredging-colorado-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Colorado City",
          "description": "Professional lake dredging services in Colorado City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Colorado City"
        subtitle="Professional pond services for Lake Dredging Services in Colorado City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Colorado City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Colorado City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Colorado City Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Colorado City Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Colorado City Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Colorado City Customers Say About Our Lake Dredging</h2>
