...
const Pond-repairTelluridePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Telluride | Professional Pond Repair Services"
        description="Expert pond repair services in Telluride. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, telluride pond repair, pond repair telluride"
        canonical="https://utahwatergardens.com/pond-repair-telluride"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Telluride",
          "description": "Professional pond repair services in Telluride",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Telluride"
        subtitle="Professional pond services for Pond Repair Services in Telluride and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Telluride"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Telluride</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Telluride Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Telluride Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Telluride Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Telluride Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTelluridePage;