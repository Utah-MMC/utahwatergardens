...
const Pond-dredgingTimpiePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Timpie | Professional Pond Dredging Services"
        description="Expert pond dredging services in Timpie. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, timpie pond dredging, pond dredging timpie"
        canonical="https://utahwatergardens.com/pond-dredging-timpie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Timpie",
          "description": "Professional pond dredging services in Timpie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Timpie"
        subtitle="Professional pond services for Pond Dredging Services in Timpie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Timpie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Timpie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Timpie Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Timpie Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Timpie Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Timpie Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingTimpiePage;