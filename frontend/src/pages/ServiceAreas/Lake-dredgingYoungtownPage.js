...
const Lake-dredgingYoungtownPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Youngtown | Professional Lake Dredging Services"
        description="Expert lake dredging services in Youngtown. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, youngtown lake dredging, lake dredging youngtown"
        canonical="https://utahwatergardens.com/lake-dredging-youngtown"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Youngtown",
          "description": "Professional lake dredging services in Youngtown",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Youngtown"
        subtitle="Professional pond services for Lake Dredging Services in Youngtown and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Youngtown"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Youngtown</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Youngtown Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Youngtown Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Youngtown Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Youngtown Customers Say About Our Lake Dredging</h2>
