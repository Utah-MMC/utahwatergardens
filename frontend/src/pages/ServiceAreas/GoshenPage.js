  ...
  return (
    <div className="service-area-page">
      <PageHero 
        ...
        subtitle="Professional pond services for Goshen and surrounding Utah County areas"
      ...
      <div className="container">
        ...
        >
          <h2>Ready to Get Started in Goshen?</h2>
          <p>Contact us today for a free consultation and quote on your Goshen pond project.</p>
