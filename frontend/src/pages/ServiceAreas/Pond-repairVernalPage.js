...
const Pond-repairVernalPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Vernal | Professional Pond Repair Services"
        description="Expert pond repair services in Vernal. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, vernal pond repair, pond repair vernal"
        canonical="https://utahwatergardens.com/pond-repair-vernal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Vernal",
          "description": "Professional pond repair services in Vernal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Vernal"
        subtitle="Professional pond services for Pond Repair Services in Vernal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Vernal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Vernal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vernal Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vernal Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vernal Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vernal Customers Say About Our Pond Repair</h2>
...
export default Pond-repairVernalPage;