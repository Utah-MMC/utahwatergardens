...
const Lake-dredgingMiddletonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Middleton | Professional Lake Dredging Services"
        description="Expert lake dredging services in Middleton. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, middleton lake dredging, lake dredging middleton"
        canonical="https://utahwatergardens.com/lake-dredging-middleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Middleton",
          "description": "Professional lake dredging services in Middleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Middleton"
        subtitle="Professional pond services for Lake Dredging Services in Middleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Middleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Middleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Middleton Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Middleton Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Middleton Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Middleton Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMiddletonPage;