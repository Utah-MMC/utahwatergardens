...
const Lake-dredgingCollinstonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Collinston | Professional Lake Dredging Services"
        description="Expert lake dredging services in Collinston. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, collinston lake dredging, lake dredging collinston"
        canonical="https://utahwatergardens.com/lake-dredging-collinston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Collinston",
          "description": "Professional lake dredging services in Collinston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Collinston"
        subtitle="Professional pond services for Lake Dredging Services in Collinston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Collinston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Collinston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Collinston Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Collinston Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Collinston Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Collinston Customers Say About Our Lake Dredging</h2>
