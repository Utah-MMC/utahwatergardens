...
const Pond-maintenanceWellingtonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Wellington | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Wellington. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, wellington pond maintenance, pond maintenance wellington"
        canonical="https://utahwatergardens.com/pond-maintenance-wellington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Wellington",
          "description": "Professional pond maintenance services in Wellington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Wellington"
        subtitle="Professional pond services for Pond Maintenance Services in Wellington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Wellington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Wellington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wellington Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wellington Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wellington Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wellington Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceWellingtonPage;