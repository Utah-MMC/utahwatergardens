...
const Pond-maintenanceFreedomPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Freedom | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Freedom. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, freedom pond maintenance, pond maintenance freedom"
        canonical="https://utahwatergardens.com/pond-maintenance-freedom"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Freedom",
          "description": "Professional pond maintenance services in Freedom",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Freedom"
        subtitle="Professional pond services for Pond Maintenance Services in Freedom and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Freedom"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Freedom</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Freedom Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Freedom Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Freedom Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Freedom Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceFreedomPage;