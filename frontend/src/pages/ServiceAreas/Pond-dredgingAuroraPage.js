...
const Pond-dredgingAuroraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Aurora | Professional Pond Dredging Services"
        description="Expert pond dredging services in Aurora. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, aurora pond dredging, pond dredging aurora"
        canonical="https://utahwatergardens.com/pond-dredging-aurora"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Aurora",
          "description": "Professional pond dredging services in Aurora",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Aurora"
        subtitle="Professional pond services for Pond Dredging Services in Aurora and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Aurora"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Aurora</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aurora Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aurora Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aurora Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aurora Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAuroraPage;