...
const Pond-cleaningLinglePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lingle | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lingle. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lingle pond cleaning, pond cleaning lingle"
        canonical="https://utahwatergardens.com/pond-cleaning-lingle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lingle",
          "description": "Professional pond cleaning services in Lingle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lingle"
        subtitle="Professional pond services for Pond Cleaning Services in Lingle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lingle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lingle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lingle Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lingle Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lingle Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lingle Customers Say About Our Pond Cleaning</h2>
