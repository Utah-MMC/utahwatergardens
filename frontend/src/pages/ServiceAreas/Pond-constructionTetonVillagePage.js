...
const Pond-constructionTetonVillagePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Teton Village | Professional Pond Construction Services"
        description="Expert pond construction services in Teton Village. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, teton village pond construction, pond construction teton village"
        canonical="https://utahwatergardens.com/pond-construction-teton-village"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Teton Village",
          "description": "Professional pond construction services in Teton Village",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Teton Village"
        subtitle="Professional pond services for Pond Construction Services in Teton Village and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Teton Village"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Teton Village</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Teton Village Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Teton Village Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Teton Village Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Teton Village Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionTetonVillagePage;