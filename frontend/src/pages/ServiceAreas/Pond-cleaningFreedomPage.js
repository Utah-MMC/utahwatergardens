...
const Pond-cleaningFreedomPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Freedom | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Freedom. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, freedom pond cleaning, pond cleaning freedom"
        canonical="https://utahwatergardens.com/pond-cleaning-freedom"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Freedom",
          "description": "Professional pond cleaning services in Freedom",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Freedom"
        subtitle="Professional pond services for Pond Cleaning Services in Freedom and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Freedom"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Freedom</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Freedom Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Freedom Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Freedom Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Freedom Customers Say About Our Pond Cleaning</h2>
