...
const Pond-cleaningAmericanForkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning American Fork | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in American Fork. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, american fork pond cleaning, pond cleaning american fork"
        canonical="https://utahwatergardens.com/pond-cleaning-american-fork"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services American Fork",
          "description": "Professional pond cleaning services in American Fork",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in American Fork"
        subtitle="Professional pond services for Pond Cleaning Services in American Fork and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in American Fork"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in American Fork</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our American Fork Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="American Fork Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our American Fork Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What American Fork Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAmericanForkPage;