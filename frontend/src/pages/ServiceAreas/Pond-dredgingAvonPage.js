...
const Pond-dredgingAvonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Avon | Professional Pond Dredging Services"
        description="Expert pond dredging services in Avon. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, avon pond dredging, pond dredging avon"
        canonical="https://utahwatergardens.com/pond-dredging-avon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Avon",
          "description": "Professional pond dredging services in Avon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Avon"
        subtitle="Professional pond services for Pond Dredging Services in Avon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Avon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Avon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Avon Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Avon Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Avon Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Avon Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAvonPage;