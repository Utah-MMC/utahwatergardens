...
const Pond-repairTwinFallsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Twin Falls | Professional Pond Repair Services"
        description="Expert pond repair services in Twin Falls. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, twin falls pond repair, pond repair twin falls"
        canonical="https://utahwatergardens.com/pond-repair-twin-falls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Twin Falls",
          "description": "Professional pond repair services in Twin Falls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Twin Falls"
        subtitle="Professional pond services for Pond Repair Services in Twin Falls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Twin Falls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Twin Falls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Twin Falls Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Twin Falls Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Twin Falls Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Twin Falls Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTwinFallsPage;