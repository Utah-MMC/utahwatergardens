...
const Lake-dredgingPagePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Page | Professional Lake Dredging Services"
        description="Expert lake dredging services in Page. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, page lake dredging, lake dredging page"
        canonical="https://utahwatergardens.com/lake-dredging-page"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Page",
          "description": "Professional lake dredging services in Page",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Page"
        subtitle="Professional pond services for Lake Dredging Services in Page and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Page"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Page</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Page Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Page Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Page Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Page Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingPagePage;