...
const Pond-cleaningSaltLakeCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Salt Lake City | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Salt Lake City. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, salt lake city pond cleaning, pond cleaning salt lake city"
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Professional pond cleaning services in Salt Lake City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        ...
        <div className="container">
          ...
          <section className="testimonials-section">
            <h2>What Salt Lake City Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSaltLakeCityPage;