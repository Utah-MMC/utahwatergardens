...
const Pond-constructionDuboisPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Dubois | Professional Pond Construction Services"
        description="Expert pond construction services in Dubois. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, dubois pond construction, pond construction dubois"
        canonical="https://utahwatergardens.com/pond-construction-dubois"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Dubois",
          "description": "Professional pond construction services in Dubois",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Dubois"
        subtitle="Professional pond services for Pond Construction Services in Dubois and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Dubois"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Dubois</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dubois Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dubois Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dubois Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dubois Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionDuboisPage;