...
const Pond-maintenanceNorthOgdenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance North Ogden | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in North Ogden. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, north ogden pond maintenance, pond maintenance north ogden"
        canonical="https://utahwatergardens.com/pond-maintenance-north-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services North Ogden",
          "description": "Professional pond maintenance services in North Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in North Ogden"
        subtitle="Professional pond services for Pond Maintenance Services in North Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in North Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in North Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Ogden Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Ogden Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Ogden Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Ogden Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceNorthOgdenPage;