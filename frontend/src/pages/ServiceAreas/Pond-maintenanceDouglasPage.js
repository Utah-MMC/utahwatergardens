...
const Pond-maintenanceDouglasPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Douglas | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Douglas. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, douglas pond maintenance, pond maintenance douglas"
        canonical="https://utahwatergardens.com/pond-maintenance-douglas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Douglas",
          "description": "Professional pond maintenance services in Douglas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Douglas"
        subtitle="Professional pond services for Pond Maintenance Services in Douglas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Douglas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Douglas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Douglas Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Douglas Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Douglas Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Douglas Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceDouglasPage;