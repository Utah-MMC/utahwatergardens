...
const Pond-dredgingTerraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Terra | Professional Pond Dredging Services"
        description="Expert pond dredging services in Terra. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, terra pond dredging, pond dredging terra"
        canonical="https://utahwatergardens.com/pond-dredging-terra"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Terra",
          "description": "Professional pond dredging services in Terra",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Terra"
        subtitle="Professional pond services for Pond Dredging Services in Terra and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Terra"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Terra</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Terra Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Terra Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Terra Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Terra Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingTerraPage;