...
const Pond-dredgingAmalgaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Amalga | Professional Pond Dredging Services"
        description="Expert pond dredging services in Amalga. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, amalga pond dredging, pond dredging amalga"
        canonical="https://utahwatergardens.com/pond-dredging-amalga"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Amalga",
          "description": "Professional pond dredging services in Amalga",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Amalga"
        subtitle="Professional pond services for Pond Dredging Services in Amalga and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Amalga"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Amalga</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Amalga Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Amalga Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Amalga Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Amalga Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAmalgaPage;