...
const Pond-cleaningDecloPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Declo | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Declo. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, declo pond cleaning, pond cleaning declo"
        canonical="https://utahwatergardens.com/pond-cleaning-declo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Declo",
          "description": "Professional pond cleaning services in Declo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Declo"
        subtitle="Professional pond services for Pond Cleaning Services in Declo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Declo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Declo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Declo Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Declo Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Declo Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Declo Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDecloPage;