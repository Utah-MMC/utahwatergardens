...
const HarvestingPineBluffsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Pine Bluffs | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Pine Bluffs. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, pine bluffs aquatic plant harvesting, aquatic plant harvesting pine bluffs"
        canonical="https://utahwatergardens.com/harvesting-pine-bluffs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Pine Bluffs",
          "description": "Professional aquatic plant harvesting services in Pine Bluffs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Pine Bluffs"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Pine Bluffs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Pine Bluffs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Pine Bluffs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pine Bluffs Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pine Bluffs Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pine Bluffs Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pine Bluffs Customers Say About Our Aquatic Plant Harvesting</h2>
