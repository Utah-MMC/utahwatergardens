...
const Pond-cleaningLaytonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Layton | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Layton. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, layton pond cleaning, pond cleaning layton"
        canonical="https://utahwatergardens.com/pond-cleaning-layton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Layton",
          "description": "Professional pond cleaning services in Layton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Layton"
        subtitle="Professional pond services for Pond Cleaning Services in Layton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Layton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Layton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Layton Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Layton Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Layton Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Layton Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLaytonPage;