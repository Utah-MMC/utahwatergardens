...
const Pond-constructionFortLaramiePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Fort Laramie | Professional Pond Construction Services"
        description="Expert pond construction services in Fort Laramie. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, fort laramie pond construction, pond construction fort laramie"
        canonical="https://utahwatergardens.com/pond-construction-fort-laramie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Fort Laramie",
          "description": "Professional pond construction services in Fort Laramie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Fort Laramie"
        subtitle="Professional pond services for Pond Construction Services in Fort Laramie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Fort Laramie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Fort Laramie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fort Laramie Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fort Laramie Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fort Laramie Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fort Laramie Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionFortLaramiePage;