...
const Pond-maintenanceBrianHeadPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Brian Head | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Brian Head. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, brian head pond maintenance, pond maintenance brian head"
        canonical="https://utahwatergardens.com/pond-maintenance-brian-head"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Brian Head",
          "description": "Professional pond maintenance services in Brian Head",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Brian Head"
        subtitle="Professional pond services for Pond Maintenance Services in Brian Head and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Brian Head"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Brian Head</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Brian Head Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Brian Head Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Brian Head Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Brian Head Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceBrianHeadPage;