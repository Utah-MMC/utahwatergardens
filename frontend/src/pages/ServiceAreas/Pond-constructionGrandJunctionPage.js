...
const Pond-constructionGrandJunctionPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Grand Junction | Professional Pond Construction Services"
        description="Expert pond construction services in Grand Junction. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, grand junction pond construction, pond construction grand junction"
        canonical="https://utahwatergardens.com/pond-construction-grand-junction"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Grand Junction",
          "description": "Professional pond construction services in Grand Junction",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Grand Junction"
        subtitle="Professional pond services for Pond Construction Services in Grand Junction and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Grand Junction"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Grand Junction</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Grand Junction Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Grand Junction Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Grand Junction Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Grand Junction Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionGrandJunctionPage;