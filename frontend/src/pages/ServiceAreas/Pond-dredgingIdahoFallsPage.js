...
const Pond-dredgingIdahoFallsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Idaho Falls | Professional Pond Dredging Services"
        description="Expert pond dredging services in Idaho Falls. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, idaho falls pond dredging, pond dredging idaho falls"
        canonical="https://utahwatergardens.com/pond-dredging-idaho-falls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Idaho Falls",
          "description": "Professional pond dredging services in Idaho Falls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Idaho Falls"
        subtitle="Professional pond services for Pond Dredging Services in Idaho Falls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Idaho Falls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Idaho Falls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Idaho Falls Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Idaho Falls Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Idaho Falls Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Idaho Falls Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingIdahoFallsPage;