...
const Lake-dredgingSandyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sandy | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sandy. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sandy lake dredging, lake dredging sandy"
        canonical="https://utahwatergardens.com/lake-dredging-sandy"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sandy",
          "description": "Professional lake dredging services in Sandy",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sandy"
        subtitle="Professional pond services for Lake Dredging Services in Sandy and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sandy"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sandy</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sandy Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sandy Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sandy Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sandy Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSandyPage;