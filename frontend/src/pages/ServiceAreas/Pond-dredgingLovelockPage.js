...
const Pond-dredgingLovelockPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lovelock | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lovelock. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lovelock pond dredging, pond dredging lovelock"
        canonical="https://utahwatergardens.com/pond-dredging-lovelock"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lovelock",
          "description": "Professional pond dredging services in Lovelock",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lovelock"
        subtitle="Professional pond services for Pond Dredging Services in Lovelock and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lovelock"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lovelock</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lovelock Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lovelock Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lovelock Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lovelock Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLovelockPage;