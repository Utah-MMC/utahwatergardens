...
const Pond-constructionParkCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Park City | Professional Pond Construction Services"
        description="Expert pond construction services in Park City. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, park city pond construction, pond construction park city"
        canonical="https://utahwatergardens.com/pond-construction-park-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Park City",
          "description": "Professional pond construction services in Park City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Park City"
        subtitle="Professional pond services for Pond Construction Services in Park City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Park City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Park City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Park City Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Park City Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Park City Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Park City Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionParkCityPage;