...
const Lake-dredgingSt.StephensPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging St. Stephens | Professional Lake Dredging Services"
        description="Expert lake dredging services in St. Stephens. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, st. stephens lake dredging, lake dredging st. stephens"
        canonical="https://utahwatergardens.com/lake-dredging-st.-stephens"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services St. Stephens",
          "description": "Professional lake dredging services in St. Stephens",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in St. Stephens"
        subtitle="Professional pond services for Lake Dredging Services in St. Stephens and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in St. Stephens"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in St. Stephens</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. Stephens Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. Stephens Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. Stephens Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. Stephens Customers Say About Our Lake Dredging</h2>
