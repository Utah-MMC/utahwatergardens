...
const Lake-dredgingEchoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Echo | Professional Lake Dredging Services"
        description="Expert lake dredging services in Echo. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, echo lake dredging, lake dredging echo"
        canonical="https://utahwatergardens.com/lake-dredging-echo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Echo",
          "description": "Professional lake dredging services in Echo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Echo"
        subtitle="Professional pond services for Lake Dredging Services in Echo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Echo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Echo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Echo Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Echo Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Echo Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Echo Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingEchoPage;