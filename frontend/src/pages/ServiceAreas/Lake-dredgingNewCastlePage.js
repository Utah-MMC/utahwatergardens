...
const Lake-dredgingNewCastlePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging New Castle | Professional Lake Dredging Services"
        description="Expert lake dredging services in New Castle. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, new castle lake dredging, lake dredging new castle"
        canonical="https://utahwatergardens.com/lake-dredging-new-castle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services New Castle",
          "description": "Professional lake dredging services in New Castle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in New Castle"
        subtitle="Professional pond services for Lake Dredging Services in New Castle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in New Castle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in New Castle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Castle Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Castle Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Castle Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Castle Customers Say About Our Lake Dredging</h2>
