...
const Pond-cleaningMurrayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Murray | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Murray. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, murray pond cleaning, pond cleaning murray"
        canonical="https://utahwatergardens.com/pond-cleaning-murray"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Murray",
          "description": "Professional pond cleaning services in Murray",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Murray"
        subtitle="Professional pond services for Pond Cleaning Services in Murray and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Murray"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Murray</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Murray Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Murray Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Murray Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Murray Customers Say About Our Pond Cleaning</h2>
