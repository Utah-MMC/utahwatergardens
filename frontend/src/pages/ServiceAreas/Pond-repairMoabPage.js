...
const Pond-repairMoabPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Moab | Professional Pond Repair Services"
        description="Expert pond repair services in Moab. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, moab pond repair, pond repair moab"
        canonical="https://utahwatergardens.com/pond-repair-moab"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Moab",
          "description": "Professional pond repair services in Moab",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Moab"
        subtitle="Professional pond services for Pond Repair Services in Moab and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Moab"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Moab</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moab Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moab Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moab Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moab Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMoabPage;