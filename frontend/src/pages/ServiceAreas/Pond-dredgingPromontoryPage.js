...
const Pond-dredgingPromontoryPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Promontory | Professional Pond Dredging Services"
        description="Expert pond dredging services in Promontory. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, promontory pond dredging, pond dredging promontory"
        canonical="https://utahwatergardens.com/pond-dredging-promontory"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Promontory",
          "description": "Professional pond dredging services in Promontory",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Promontory"
        subtitle="Professional pond services for Pond Dredging Services in Promontory and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Promontory"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Promontory</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Promontory Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Promontory Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Promontory Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Promontory Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPromontoryPage;