...
const Pond-repairPhoenixPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Phoenix | Professional Pond Repair Services"
        description="Expert pond repair services in Phoenix. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, phoenix pond repair, pond repair phoenix"
        canonical="https://utahwatergardens.com/pond-repair-phoenix"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Phoenix",
          "description": "Professional pond repair services in Phoenix",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Phoenix"
        subtitle="Professional pond services for Pond Repair Services in Phoenix and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Phoenix"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Phoenix</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Phoenix Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Phoenix Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Phoenix Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Phoenix Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPhoenixPage;