...
const Pond-dredgingLaytonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Layton | Professional Pond Dredging Services"
        description="Expert pond dredging services in Layton. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, layton pond dredging, pond dredging layton"
        canonical="https://utahwatergardens.com/pond-dredging-layton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Layton",
          "description": "Professional pond dredging services in Layton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Layton"
        subtitle="Professional pond services for Pond Dredging Services in Layton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Layton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Layton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Layton Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Layton Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Layton Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Layton Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLaytonPage;