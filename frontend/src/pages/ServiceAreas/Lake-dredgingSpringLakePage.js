...
const Lake-dredgingSpringLakePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Spring Lake | Professional Lake Dredging Services"
        description="Expert lake dredging services in Spring Lake. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, spring lake lake dredging, lake dredging spring lake"
        canonical="https://utahwatergardens.com/lake-dredging-spring-lake"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Spring Lake",
          "description": "Professional lake dredging services in Spring Lake",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Spring Lake"
        subtitle="Professional pond services for Lake Dredging Services in Spring Lake and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Spring Lake"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Spring Lake</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spring Lake Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spring Lake Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spring Lake Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spring Lake Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSpringLakePage;