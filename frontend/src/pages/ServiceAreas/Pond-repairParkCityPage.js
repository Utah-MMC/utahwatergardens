...
const Pond-repairParkCityPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Park City | Professional Pond Repair Services"
        description="Expert pond repair services in Park City. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, park city pond repair, pond repair park city"
        canonical="https://utahwatergardens.com/pond-repair-park-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Park City",
          "description": "Professional pond repair services in Park City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Park City"
        subtitle="Professional pond services for Pond Repair Services in Park City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Park City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Park City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Park City Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Park City Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Park City Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Park City Customers Say About Our Pond Repair</h2>
...
export default Pond-repairParkCityPage;