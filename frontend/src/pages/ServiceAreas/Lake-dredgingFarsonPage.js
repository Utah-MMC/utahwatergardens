...
const Lake-dredgingFarsonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Farson | Professional Lake Dredging Services"
        description="Expert lake dredging services in Farson. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, farson lake dredging, lake dredging farson"
        canonical="https://utahwatergardens.com/lake-dredging-farson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Farson",
          "description": "Professional lake dredging services in Farson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Farson"
        subtitle="Professional pond services for Lake Dredging Services in Farson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Farson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Farson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farson Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farson Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farson Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farson Customers Say About Our Lake Dredging</h2>
