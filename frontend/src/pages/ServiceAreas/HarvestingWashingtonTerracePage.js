...
const HarvestingWashingtonTerracePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Washington Terrace | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Washington Terrace. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, washington terrace aquatic plant harvesting, aquatic plant harvesting washington terrace"
        canonical="https://utahwatergardens.com/harvesting-washington-terrace"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Washington Terrace",
          "description": "Professional aquatic plant harvesting services in Washington Terrace",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Washington Terrace"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Washington Terrace and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Washington Terrace"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Washington Terrace</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Washington Terrace Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Washington Terrace Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Washington Terrace Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Washington Terrace Customers Say About Our Aquatic Plant Harvesting</h2>
