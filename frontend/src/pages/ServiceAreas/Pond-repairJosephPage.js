...
const Pond-repairJosephPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Joseph | Professional Pond Repair Services"
        description="Expert pond repair services in Joseph. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, joseph pond repair, pond repair joseph"
        canonical="https://utahwatergardens.com/pond-repair-joseph"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Joseph",
          "description": "Professional pond repair services in Joseph",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Joseph"
        subtitle="Professional pond services for Pond Repair Services in Joseph and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Joseph"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Joseph</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Joseph Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Joseph Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Joseph Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Joseph Customers Say About Our Pond Repair</h2>
...
export default Pond-repairJosephPage;