...
const Lake-dredgingEthetePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Ethete | Professional Lake Dredging Services"
        description="Expert lake dredging services in Ethete. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, ethete lake dredging, lake dredging ethete"
        canonical="https://utahwatergardens.com/lake-dredging-ethete"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Ethete",
          "description": "Professional lake dredging services in Ethete",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Ethete"
        subtitle="Professional pond services for Lake Dredging Services in Ethete and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Ethete"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Ethete</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ethete Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ethete Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ethete Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ethete Customers Say About Our Lake Dredging</h2>
