...
const Lake-dredgingLeedsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Leeds | Professional Lake Dredging Services"
        description="Expert lake dredging services in Leeds. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, leeds lake dredging, lake dredging leeds"
        canonical="https://utahwatergardens.com/lake-dredging-leeds"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Leeds",
          "description": "Professional lake dredging services in Leeds",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Leeds"
        subtitle="Professional pond services for Lake Dredging Services in Leeds and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Leeds"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Leeds</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Leeds Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Leeds Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Leeds Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Leeds Customers Say About Our Lake Dredging</h2>
