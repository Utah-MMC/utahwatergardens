...
const Pond-repairGlenwoodPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Glenwood | Professional Pond Repair Services"
        description="Expert pond repair services in Glenwood. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, glenwood pond repair, pond repair glenwood"
        canonical="https://utahwatergardens.com/pond-repair-glenwood"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Glenwood",
          "description": "Professional pond repair services in Glenwood",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Glenwood"
        subtitle="Professional pond services for Pond Repair Services in Glenwood and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Glenwood"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Glenwood</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Glenwood Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Glenwood Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Glenwood Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Glenwood Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGlenwoodPage;