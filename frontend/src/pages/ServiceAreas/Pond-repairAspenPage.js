...
const Pond-repairAspenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Aspen | Professional Pond Repair Services"
        description="Expert pond repair services in Aspen. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, aspen pond repair, pond repair aspen"
        canonical="https://utahwatergardens.com/pond-repair-aspen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Aspen",
          "description": "Professional pond repair services in Aspen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Aspen"
        subtitle="Professional pond services for Pond Repair Services in Aspen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Aspen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Aspen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aspen Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aspen Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aspen Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aspen Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAspenPage;