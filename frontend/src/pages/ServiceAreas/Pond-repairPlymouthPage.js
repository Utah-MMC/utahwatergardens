...
const Pond-repairPlymouthPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Plymouth | Professional Pond Repair Services"
        description="Expert pond repair services in Plymouth. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, plymouth pond repair, pond repair plymouth"
        canonical="https://utahwatergardens.com/pond-repair-plymouth"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Plymouth",
          "description": "Professional pond repair services in Plymouth",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Plymouth"
        subtitle="Professional pond services for Pond Repair Services in Plymouth and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Plymouth"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Plymouth</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Plymouth Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Plymouth Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Plymouth Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Plymouth Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPlymouthPage;