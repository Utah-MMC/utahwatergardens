...
const Lake-dredgingElwoodPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Elwood | Professional Lake Dredging Services"
        description="Expert lake dredging services in Elwood. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, elwood lake dredging, lake dredging elwood"
        canonical="https://utahwatergardens.com/lake-dredging-elwood"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Elwood",
          "description": "Professional lake dredging services in Elwood",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Elwood"
        subtitle="Professional pond services for Lake Dredging Services in Elwood and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Elwood"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Elwood</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elwood Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elwood Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elwood Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elwood Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingElwoodPage;