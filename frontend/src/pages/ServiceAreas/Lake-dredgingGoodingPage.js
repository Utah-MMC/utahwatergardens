...
const Lake-dredgingGoodingPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Gooding | Professional Lake Dredging Services"
        description="Expert lake dredging services in Gooding. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, gooding lake dredging, lake dredging gooding"
        canonical="https://utahwatergardens.com/lake-dredging-gooding"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Gooding",
          "description": "Professional lake dredging services in Gooding",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Gooding"
        subtitle="Professional pond services for Lake Dredging Services in Gooding and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Gooding"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Gooding</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gooding Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gooding Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gooding Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gooding Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingGoodingPage;