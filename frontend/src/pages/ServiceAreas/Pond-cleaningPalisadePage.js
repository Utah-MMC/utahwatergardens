...
const Pond-cleaningPalisadePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Palisade | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Palisade. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, palisade pond cleaning, pond cleaning palisade"
        canonical="https://utahwatergardens.com/pond-cleaning-palisade"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Palisade",
          "description": "Professional pond cleaning services in Palisade",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Palisade"
        subtitle="Professional pond services for Pond Cleaning Services in Palisade and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Palisade"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Palisade</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Palisade Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Palisade Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Palisade Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Palisade Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningPalisadePage;