...
const Pond-cleaningBenjaminPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Benjamin | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Benjamin. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, benjamin pond cleaning, pond cleaning benjamin"
        canonical="https://utahwatergardens.com/pond-cleaning-benjamin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Benjamin",
          "description": "Professional pond cleaning services in Benjamin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Benjamin"
        subtitle="Professional pond services for Pond Cleaning Services in Benjamin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Benjamin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Benjamin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Benjamin Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Benjamin Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Benjamin Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Benjamin Customers Say About Our Pond Cleaning</h2>
