...
const Pond-cleaningOpalPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Opal | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Opal. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, opal pond cleaning, pond cleaning opal"
        canonical="https://utahwatergardens.com/pond-cleaning-opal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Opal",
          "description": "Professional pond cleaning services in Opal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Opal"
        subtitle="Professional pond services for Pond Cleaning Services in Opal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Opal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Opal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Opal Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Opal Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Opal Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Opal Customers Say About Our Pond Cleaning</h2>
