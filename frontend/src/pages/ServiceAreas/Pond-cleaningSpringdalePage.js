...
const Pond-cleaningSpringdalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Springdale | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Springdale. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, springdale pond cleaning, pond cleaning springdale"
        canonical="https://utahwatergardens.com/pond-cleaning-springdale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Springdale",
          "description": "Professional pond cleaning services in Springdale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Springdale"
        subtitle="Professional pond services for Pond Cleaning Services in Springdale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Springdale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Springdale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Springdale Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Springdale Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Springdale Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Springdale Customers Say About Our Pond Cleaning</h2>
