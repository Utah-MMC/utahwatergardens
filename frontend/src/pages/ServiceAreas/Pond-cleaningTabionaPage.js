...
const Pond-cleaningTabionaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Tabiona | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Tabiona. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, tabiona pond cleaning, pond cleaning tabiona"
        canonical="https://utahwatergardens.com/pond-cleaning-tabiona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Tabiona",
          "description": "Professional pond cleaning services in Tabiona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Tabiona"
        subtitle="Professional pond services for Pond Cleaning Services in Tabiona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Tabiona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Tabiona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tabiona Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tabiona Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tabiona Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tabiona Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningTabionaPage;