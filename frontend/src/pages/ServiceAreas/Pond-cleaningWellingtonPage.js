...
const Pond-cleaningWellingtonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Wellington | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Wellington. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, wellington pond cleaning, pond cleaning wellington"
        canonical="https://utahwatergardens.com/pond-cleaning-wellington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Wellington",
          "description": "Professional pond cleaning services in Wellington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Wellington"
        subtitle="Professional pond services for Pond Cleaning Services in Wellington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Wellington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Wellington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wellington Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wellington Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wellington Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wellington Customers Say About Our Pond Cleaning</h2>
