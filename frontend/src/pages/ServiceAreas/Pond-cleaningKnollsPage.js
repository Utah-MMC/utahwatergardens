...
const Pond-cleaningKnollsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Knolls | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Knolls. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, knolls pond cleaning, pond cleaning knolls"
        canonical="https://utahwatergardens.com/pond-cleaning-knolls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Knolls",
          "description": "Professional pond cleaning services in Knolls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Knolls"
        subtitle="Professional pond services for Pond Cleaning Services in Knolls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Knolls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Knolls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Knolls Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Knolls Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Knolls Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Knolls Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningKnollsPage;