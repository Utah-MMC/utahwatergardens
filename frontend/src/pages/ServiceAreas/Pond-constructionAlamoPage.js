...
const Pond-constructionAlamoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Alamo | Professional Pond Construction Services"
        description="Expert pond construction services in Alamo. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, alamo pond construction, pond construction alamo"
        canonical="https://utahwatergardens.com/pond-construction-alamo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Alamo",
          "description": "Professional pond construction services in Alamo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Alamo"
        subtitle="Professional pond services for Pond Construction Services in Alamo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Alamo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Alamo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alamo Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alamo Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alamo Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alamo Customers Say About Our Pond Construction</h2>
