...
const Pond-repairNewRiverPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair New River | Professional Pond Repair Services"
        description="Expert pond repair services in New River. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, new river pond repair, pond repair new river"
        canonical="https://utahwatergardens.com/pond-repair-new-river"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services New River",
          "description": "Professional pond repair services in New River",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in New River"
        subtitle="Professional pond services for Pond Repair Services in New River and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in New River"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in New River</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New River Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New River Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New River Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New River Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNewRiverPage;