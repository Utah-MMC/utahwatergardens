...
const Pond-dredgingLaughlinPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Laughlin | Professional Pond Dredging Services"
        description="Expert pond dredging services in Laughlin. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, laughlin pond dredging, pond dredging laughlin"
        canonical="https://utahwatergardens.com/pond-dredging-laughlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Laughlin",
          "description": "Professional pond dredging services in Laughlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Laughlin"
        subtitle="Professional pond services for Pond Dredging Services in Laughlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Laughlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Laughlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Laughlin Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Laughlin Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Laughlin Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Laughlin Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLaughlinPage;