...
const Pond-dredgingPleasantGrovePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Pleasant Grove | Professional Pond Dredging Services"
        description="Expert pond dredging services in Pleasant Grove. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, pleasant grove pond dredging, pond dredging pleasant grove"
        canonical="https://utahwatergardens.com/pond-dredging-pleasant-grove"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Pleasant Grove",
          "description": "Professional pond dredging services in Pleasant Grove",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Pleasant Grove"
        subtitle="Professional pond services for Pond Dredging Services in Pleasant Grove and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Pleasant Grove"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Pleasant Grove</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pleasant Grove Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pleasant Grove Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pleasant Grove Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pleasant Grove Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPleasantGrovePage;