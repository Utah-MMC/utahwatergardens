...
const Pond-repairPaoniaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Paonia | Professional Pond Repair Services"
        description="Expert pond repair services in Paonia. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, paonia pond repair, pond repair paonia"
        canonical="https://utahwatergardens.com/pond-repair-paonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Paonia",
          "description": "Professional pond repair services in Paonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Paonia"
        subtitle="Professional pond services for Pond Repair Services in Paonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Paonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Paonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paonia Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paonia Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paonia Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paonia Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPaoniaPage;