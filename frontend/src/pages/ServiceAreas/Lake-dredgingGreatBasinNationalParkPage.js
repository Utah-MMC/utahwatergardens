...
const Lake-dredgingGreatBasinNationalParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Great Basin National Park | Professional Lake Dredging Services"
        description="Expert lake dredging services in Great Basin National Park. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, great basin national park lake dredging, lake dredging great basin national park"
        canonical="https://utahwatergardens.com/lake-dredging-great-basin-national-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Great Basin National Park",
          "description": "Professional lake dredging services in Great Basin National Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Great Basin National Park"
        subtitle="Professional pond services for Lake Dredging Services in Great Basin National Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Great Basin National Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Great Basin National Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Great Basin National Park Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Great Basin National Park Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Great Basin National Park Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Great Basin National Park Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingGreatBasinNationalParkPage;