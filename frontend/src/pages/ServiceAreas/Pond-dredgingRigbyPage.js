...
const Pond-dredgingRigbyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Rigby | Professional Pond Dredging Services"
        description="Expert pond dredging services in Rigby. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, rigby pond dredging, pond dredging rigby"
        canonical="https://utahwatergardens.com/pond-dredging-rigby"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Rigby",
          "description": "Professional pond dredging services in Rigby",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Rigby"
        subtitle="Professional pond services for Pond Dredging Services in Rigby and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Rigby"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Rigby</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rigby Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rigby Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rigby Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rigby Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingRigbyPage;