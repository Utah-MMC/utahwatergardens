...
const Pond-cleaningBoulderPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Boulder | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Boulder. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, boulder pond cleaning, pond cleaning boulder"
        canonical="https://utahwatergardens.com/pond-cleaning-boulder"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Boulder",
          "description": "Professional pond cleaning services in Boulder",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Boulder"
        subtitle="Professional pond services for Pond Cleaning Services in Boulder and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Boulder"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Boulder</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boulder Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boulder Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boulder Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boulder Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningBoulderPage;