...
const Pond-cleaningNorwoodPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Norwood | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Norwood. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, norwood pond cleaning, pond cleaning norwood"
        canonical="https://utahwatergardens.com/pond-cleaning-norwood"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Norwood",
          "description": "Professional pond cleaning services in Norwood",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Norwood"
        subtitle="Professional pond services for Pond Cleaning Services in Norwood and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Norwood"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Norwood</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Norwood Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Norwood Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Norwood Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Norwood Customers Say About Our Pond Cleaning</h2>
