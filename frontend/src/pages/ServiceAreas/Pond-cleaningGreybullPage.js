...
const Pond-cleaningGreybullPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Greybull | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Greybull. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, greybull pond cleaning, pond cleaning greybull"
        canonical="https://utahwatergardens.com/pond-cleaning-greybull"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Greybull",
          "description": "Professional pond cleaning services in Greybull",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Greybull"
        subtitle="Professional pond services for Pond Cleaning Services in Greybull and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Greybull"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Greybull</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Greybull Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Greybull Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Greybull Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Greybull Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningGreybullPage;