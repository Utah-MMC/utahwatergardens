...
const Pond-dredgingWasatchMountainStateParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Wasatch Mountain State Park | Professional Pond Dredging Services"
        description="Expert pond dredging services in Wasatch Mountain State Park. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, wasatch mountain state park pond dredging, pond dredging wasatch mountain state park"
        canonical="https://utahwatergardens.com/pond-dredging-wasatch-mountain-state-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Wasatch Mountain State Park",
          "description": "Professional pond dredging services in Wasatch Mountain State Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Wasatch Mountain State Park"
        subtitle="Professional pond services for Pond Dredging Services in Wasatch Mountain State Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Wasatch Mountain State Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Wasatch Mountain State Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wasatch Mountain State Park Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wasatch Mountain State Park Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wasatch Mountain State Park Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wasatch Mountain State Park Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWasatchMountainStateParkPage;