...
const Lake-dredgingGoshenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Goshen | Professional Lake Dredging Services"
        description="Expert lake dredging services in Goshen. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, goshen lake dredging, lake dredging goshen"
        canonical="https://utahwatergardens.com/lake-dredging-goshen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Goshen",
          "description": "Professional lake dredging services in Goshen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Goshen"
        subtitle="Professional pond services for Lake Dredging Services in Goshen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Goshen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Goshen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goshen Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goshen Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goshen Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goshen Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingGoshenPage;