...
const Pond-cleaningElmoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Elmo | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Elmo. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, elmo pond cleaning, pond cleaning elmo"
        canonical="https://utahwatergardens.com/pond-cleaning-elmo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Elmo",
          "description": "Professional pond cleaning services in Elmo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Elmo"
        subtitle="Professional pond services for Pond Cleaning Services in Elmo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Elmo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Elmo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elmo Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elmo Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elmo Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elmo Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningElmoPage;