...
const Pond-dredgingSigurdPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Sigurd | Professional Pond Dredging Services"
        description="Expert pond dredging services in Sigurd. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, sigurd pond dredging, pond dredging sigurd"
        canonical="https://utahwatergardens.com/pond-dredging-sigurd"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Sigurd",
          "description": "Professional pond dredging services in Sigurd",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Sigurd"
        subtitle="Professional pond services for Pond Dredging Services in Sigurd and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Sigurd"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Sigurd</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sigurd Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sigurd Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sigurd Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sigurd Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSigurdPage;