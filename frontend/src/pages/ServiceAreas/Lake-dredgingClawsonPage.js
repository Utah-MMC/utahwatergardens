...
const Lake-dredgingClawsonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Clawson | Professional Lake Dredging Services"
        description="Expert lake dredging services in Clawson. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, clawson lake dredging, lake dredging clawson"
        canonical="https://utahwatergardens.com/lake-dredging-clawson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Clawson",
          "description": "Professional lake dredging services in Clawson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Clawson"
        subtitle="Professional pond services for Lake Dredging Services in Clawson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Clawson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Clawson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clawson Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clawson Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clawson Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clawson Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingClawsonPage;