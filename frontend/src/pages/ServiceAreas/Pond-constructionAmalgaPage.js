...
const Pond-constructionAmalgaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Amalga | Professional Pond Construction Services"
        description="Expert pond construction services in Amalga. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, amalga pond construction, pond construction amalga"
        canonical="https://utahwatergardens.com/pond-construction-amalga"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Amalga",
          "description": "Professional pond construction services in Amalga",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Amalga"
        subtitle="Professional pond services for Pond Construction Services in Amalga and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Amalga"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Amalga</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Amalga Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Amalga Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Amalga Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Amalga Customers Say About Our Pond Construction</h2>
