...
const Lake-dredgingWellsvillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Wellsville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Wellsville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, wellsville lake dredging, lake dredging wellsville"
        canonical="https://utahwatergardens.com/lake-dredging-wellsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Wellsville",
          "description": "Professional lake dredging services in Wellsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Wellsville"
        subtitle="Professional pond services for Lake Dredging Services in Wellsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Wellsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Wellsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wellsville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wellsville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wellsville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wellsville Customers Say About Our Lake Dredging</h2>
