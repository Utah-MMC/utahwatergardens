...
const HarvestingNorthLasVegasPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting North Las Vegas | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in North Las Vegas. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, north las vegas aquatic plant harvesting, aquatic plant harvesting north las vegas"
        canonical="https://utahwatergardens.com/harvesting-north-las-vegas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services North Las Vegas",
          "description": "Professional aquatic plant harvesting services in North Las Vegas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in North Las Vegas"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in North Las Vegas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in North Las Vegas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in North Las Vegas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Las Vegas Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Las Vegas Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Las Vegas Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Las Vegas Customers Say About Our Aquatic Plant Harvesting</h2>
