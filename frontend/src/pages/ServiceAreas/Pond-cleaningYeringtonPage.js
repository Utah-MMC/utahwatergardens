...
const Pond-cleaningYeringtonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Yerington | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Yerington. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, yerington pond cleaning, pond cleaning yerington"
        canonical="https://utahwatergardens.com/pond-cleaning-yerington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Yerington",
          "description": "Professional pond cleaning services in Yerington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Yerington"
        subtitle="Professional pond services for Pond Cleaning Services in Yerington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Yerington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Yerington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Yerington Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Yerington Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Yerington Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Yerington Customers Say About Our Pond Cleaning</h2>
