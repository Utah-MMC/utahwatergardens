...
const Pond-cleaningBluffdalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Bluffdale | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Bluffdale. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, bluffdale pond cleaning, pond cleaning bluffdale"
        canonical="https://utahwatergardens.com/pond-cleaning-bluffdale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Bluffdale",
          "description": "Professional pond cleaning services in Bluffdale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Bluffdale"
        subtitle="Professional pond services for Pond Cleaning Services in Bluffdale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Bluffdale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Bluffdale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bluffdale Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bluffdale Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bluffdale Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bluffdale Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningBluffdalePage;