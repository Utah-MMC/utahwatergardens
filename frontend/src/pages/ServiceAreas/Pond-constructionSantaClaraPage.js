...
const Pond-constructionSantaClaraPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Santa Clara | Professional Pond Construction Services"
        description="Expert pond construction services in Santa Clara. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, santa clara pond construction, pond construction santa clara"
        canonical="https://utahwatergardens.com/pond-construction-santa-clara"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Santa Clara",
          "description": "Professional pond construction services in Santa Clara",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Santa Clara"
        subtitle="Professional pond services for Pond Construction Services in Santa Clara and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Santa Clara"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Santa Clara</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Santa Clara Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Santa Clara Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Santa Clara Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Santa Clara Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSantaClaraPage;