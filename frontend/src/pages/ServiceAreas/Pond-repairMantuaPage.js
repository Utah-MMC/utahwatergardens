...
const Pond-repairMantuaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Mantua | Professional Pond Repair Services"
        description="Expert pond repair services in Mantua. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, mantua pond repair, pond repair mantua"
        canonical="https://utahwatergardens.com/pond-repair-mantua"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Mantua",
          "description": "Professional pond repair services in Mantua",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Mantua"
        subtitle="Professional pond services for Pond Repair Services in Mantua and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Mantua"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Mantua</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mantua Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mantua Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mantua Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mantua Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMantuaPage;