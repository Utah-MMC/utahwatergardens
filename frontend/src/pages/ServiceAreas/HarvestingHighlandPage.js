...
const HarvestingHighlandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Highland | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Highland. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, highland aquatic plant harvesting, aquatic plant harvesting highland"
        canonical="https://utahwatergardens.com/harvesting-highland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Highland",
          "description": "Professional aquatic plant harvesting services in Highland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Highland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Highland Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Highland Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Highland Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Highland Customers Say About Our Aquatic Plant Harvesting</h2>
...
export default HarvestingHighlandPage;