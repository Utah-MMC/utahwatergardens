...
const Pond-dredgingMonroePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Monroe | Professional Pond Dredging Services"
        description="Expert pond dredging services in Monroe. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, monroe pond dredging, pond dredging monroe"
        canonical="https://utahwatergardens.com/pond-dredging-monroe"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Monroe",
          "description": "Professional pond dredging services in Monroe",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Monroe"
        subtitle="Professional pond services for Pond Dredging Services in Monroe and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Monroe"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Monroe</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Monroe Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Monroe Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Monroe Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Monroe Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMonroePage;