...
const Pond-dredgingErdaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Erda | Professional Pond Dredging Services"
        description="Expert pond dredging services in Erda. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, erda pond dredging, pond dredging erda"
        canonical="https://utahwatergardens.com/pond-dredging-erda"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Erda",
          "description": "Professional pond dredging services in Erda",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Erda"
        subtitle="Professional pond services for Pond Dredging Services in Erda and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Erda"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Erda</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Erda Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Erda Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Erda Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Erda Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingErdaPage;