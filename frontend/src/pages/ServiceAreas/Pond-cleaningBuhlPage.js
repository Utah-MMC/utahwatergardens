...
const Pond-cleaningBuhlPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Buhl | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Buhl. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, buhl pond cleaning, pond cleaning buhl"
        canonical="https://utahwatergardens.com/pond-cleaning-buhl"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Buhl",
          "description": "Professional pond cleaning services in Buhl",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Buhl"
        subtitle="Professional pond services for Pond Cleaning Services in Buhl and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Buhl"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Buhl</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Buhl Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Buhl Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Buhl Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Buhl Customers Say About Our Pond Cleaning</h2>
