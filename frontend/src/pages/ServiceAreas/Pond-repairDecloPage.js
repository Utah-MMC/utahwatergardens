...
const Pond-repairDecloPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Declo | Professional Pond Repair Services"
        description="Expert pond repair services in Declo. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, declo pond repair, pond repair declo"
        canonical="https://utahwatergardens.com/pond-repair-declo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Declo",
          "description": "Professional pond repair services in Declo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Declo"
        subtitle="Professional pond services for Pond Repair Services in Declo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Declo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Declo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Declo Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Declo Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Declo Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Declo Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDecloPage;