...
const Pond-maintenanceLeedsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Leeds | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Leeds. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, leeds pond maintenance, pond maintenance leeds"
        canonical="https://utahwatergardens.com/pond-maintenance-leeds"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Leeds",
          "description": "Professional pond maintenance services in Leeds",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Leeds"
        subtitle="Professional pond services for Pond Maintenance Services in Leeds and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Leeds"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Leeds</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Leeds Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Leeds Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Leeds Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Leeds Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceLeedsPage;