...
const Pond-dredgingLakeShorePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lake Shore | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lake Shore. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lake shore pond dredging, pond dredging lake shore"
        canonical="https://utahwatergardens.com/pond-dredging-lake-shore"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lake Shore",
          "description": "Professional pond dredging services in Lake Shore",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lake Shore"
        subtitle="Professional pond services for Pond Dredging Services in Lake Shore and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lake Shore"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lake Shore</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lake Shore Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lake Shore Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lake Shore Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lake Shore Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLakeShorePage;