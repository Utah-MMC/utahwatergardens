...
const Lake-dredgingLovellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lovell | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lovell. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lovell lake dredging, lake dredging lovell"
        canonical="https://utahwatergardens.com/lake-dredging-lovell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lovell",
          "description": "Professional lake dredging services in Lovell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lovell"
        subtitle="Professional pond services for Lake Dredging Services in Lovell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lovell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lovell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lovell Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lovell Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lovell Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lovell Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingLovellPage;