...
const Pond-constructionHuntingtonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Huntington | Professional Pond Construction Services"
        description="Expert pond construction services in Huntington. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, huntington pond construction, pond construction huntington"
        canonical="https://utahwatergardens.com/pond-construction-huntington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Huntington",
          "description": "Professional pond construction services in Huntington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Huntington"
        subtitle="Professional pond services for Pond Construction Services in Huntington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Huntington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Huntington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntington Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntington Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntington Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntington Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionHuntingtonPage;