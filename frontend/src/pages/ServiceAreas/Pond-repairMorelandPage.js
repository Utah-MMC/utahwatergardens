...
const Pond-repairMorelandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Moreland | Professional Pond Repair Services"
        description="Expert pond repair services in Moreland. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, moreland pond repair, pond repair moreland"
        canonical="https://utahwatergardens.com/pond-repair-moreland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Moreland",
          "description": "Professional pond repair services in Moreland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Moreland"
        subtitle="Professional pond services for Pond Repair Services in Moreland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Moreland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Moreland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moreland Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moreland Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moreland Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moreland Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMorelandPage;