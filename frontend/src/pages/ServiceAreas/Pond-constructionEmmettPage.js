...
const Pond-constructionEmmettPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Emmett | Professional Pond Construction Services"
        description="Expert pond construction services in Emmett. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, emmett pond construction, pond construction emmett"
        canonical="https://utahwatergardens.com/pond-construction-emmett"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Emmett",
          "description": "Professional pond construction services in Emmett",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Emmett"
        subtitle="Professional pond services for Pond Construction Services in Emmett and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Emmett"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Emmett</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Emmett Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Emmett Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Emmett Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Emmett Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionEmmettPage;