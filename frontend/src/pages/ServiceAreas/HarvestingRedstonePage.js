...
const HarvestingRedstonePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Redstone | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Redstone. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, redstone aquatic plant harvesting, aquatic plant harvesting redstone"
        canonical="https://utahwatergardens.com/harvesting-redstone"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Redstone",
          "description": "Professional aquatic plant harvesting services in Redstone",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Redstone"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Redstone and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Redstone"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Redstone</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Redstone Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Redstone Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Redstone Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Redstone Customers Say About Our Aquatic Plant Harvesting</h2>
