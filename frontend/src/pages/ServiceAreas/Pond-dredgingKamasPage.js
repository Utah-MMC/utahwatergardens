...
const Pond-dredgingKamasPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Kamas | Professional Pond Dredging Services"
        description="Expert pond dredging services in Kamas. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, kamas pond dredging, pond dredging kamas"
        canonical="https://utahwatergardens.com/pond-dredging-kamas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Kamas",
          "description": "Professional pond dredging services in Kamas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Kamas"
        subtitle="Professional pond services for Pond Dredging Services in Kamas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Kamas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Kamas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kamas Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kamas Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kamas Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kamas Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingKamasPage;