...
const Pond-constructionMillcreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Millcreek | Professional Pond Construction Services"
        description="Expert pond construction services in Millcreek. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, millcreek pond construction, pond construction millcreek"
        canonical="https://utahwatergardens.com/pond-construction-millcreek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Millcreek",
          "description": "Professional pond construction services in Millcreek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Millcreek"
        subtitle="Professional pond services for Pond Construction Services in Millcreek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Millcreek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Millcreek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Millcreek Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Millcreek Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Millcreek Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Millcreek Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionMillcreekPage;