...
const Pond-constructionFredoniaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Fredonia | Professional Pond Construction Services"
        description="Expert pond construction services in Fredonia. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, fredonia pond construction, pond construction fredonia"
        canonical="https://utahwatergardens.com/pond-construction-fredonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Fredonia",
          "description": "Professional pond construction services in Fredonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Fredonia"
        subtitle="Professional pond services for Pond Construction Services in Fredonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Fredonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Fredonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fredonia Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fredonia Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fredonia Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fredonia Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionFredoniaPage;