...
const Pond-repairAlpinePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Alpine | Professional Pond Repair Services"
        description="Expert pond repair services in Alpine. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, alpine pond repair, pond repair alpine"
        canonical="https://utahwatergardens.com/pond-repair-alpine"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Alpine",
          "description": "Professional pond repair services in Alpine",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Alpine"
        subtitle="Professional pond services for Pond Repair Services in Alpine and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Alpine"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Alpine</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alpine Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alpine Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alpine Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alpine Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAlpinePage;