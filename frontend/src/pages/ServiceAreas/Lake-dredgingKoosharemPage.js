...
const Lake-dredgingKoosharemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Koosharem | Professional Lake Dredging Services"
        description="Expert lake dredging services in Koosharem. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, koosharem lake dredging, lake dredging koosharem"
        canonical="https://utahwatergardens.com/lake-dredging-koosharem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Koosharem",
          "description": "Professional lake dredging services in Koosharem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Koosharem"
        subtitle="Professional pond services for Lake Dredging Services in Koosharem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Koosharem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Koosharem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Koosharem Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Koosharem Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Koosharem Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Koosharem Customers Say About Our Lake Dredging</h2>
