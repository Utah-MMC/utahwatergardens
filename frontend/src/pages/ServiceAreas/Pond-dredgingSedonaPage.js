...
const Pond-dredgingSedonaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Sedona | Professional Pond Dredging Services"
        description="Expert pond dredging services in Sedona. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, sedona pond dredging, pond dredging sedona"
        canonical="https://utahwatergardens.com/pond-dredging-sedona"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Sedona",
          "description": "Professional pond dredging services in Sedona",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Sedona"
        subtitle="Professional pond services for Pond Dredging Services in Sedona and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Sedona"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Sedona</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sedona Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sedona Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sedona Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sedona Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSedonaPage;