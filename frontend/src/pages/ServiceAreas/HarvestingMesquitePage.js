...
const HarvestingMesquitePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Mesquite | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Mesquite. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, mesquite aquatic plant harvesting, aquatic plant harvesting mesquite"
        canonical="https://utahwatergardens.com/harvesting-mesquite"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Mesquite",
          "description": "Professional aquatic plant harvesting services in Mesquite",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Mesquite"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Mesquite and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Mesquite"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Mesquite</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mesquite Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mesquite Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mesquite Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mesquite Customers Say About Our Aquatic Plant Harvesting</h2>
