...
const Pond-cleaningEaglePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Eagle | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Eagle. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, eagle pond cleaning, pond cleaning eagle"
        canonical="https://utahwatergardens.com/pond-cleaning-eagle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Eagle",
          "description": "Professional pond cleaning services in Eagle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Eagle"
        subtitle="Professional pond services for Pond Cleaning Services in Eagle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Eagle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Eagle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eagle Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eagle Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eagle Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eagle Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningEaglePage;