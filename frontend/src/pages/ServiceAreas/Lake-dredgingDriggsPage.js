...
const Lake-dredgingDriggsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Driggs | Professional Lake Dredging Services"
        description="Expert lake dredging services in Driggs. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, driggs lake dredging, lake dredging driggs"
        canonical="https://utahwatergardens.com/lake-dredging-driggs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Driggs",
          "description": "Professional lake dredging services in Driggs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Driggs"
        subtitle="Professional pond services for Lake Dredging Services in Driggs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Driggs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Driggs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Driggs Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Driggs Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Driggs Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Driggs Customers Say About Our Lake Dredging</h2>
