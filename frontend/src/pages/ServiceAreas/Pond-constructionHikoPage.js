...
const Pond-constructionHikoPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Hiko | Professional Pond Construction Services"
        description="Expert pond construction services in Hiko. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, hiko pond construction, pond construction hiko"
        canonical="https://utahwatergardens.com/pond-construction-hiko"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Hiko",
          "description": "Professional pond construction services in Hiko",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Hiko"
        subtitle="Professional pond services for Pond Construction Services in Hiko and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Hiko"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Hiko</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hiko Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hiko Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hiko Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hiko Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionHikoPage;