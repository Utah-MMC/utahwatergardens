...
const Pond-repairEmmettPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Emmett | Professional Pond Repair Services"
        description="Expert pond repair services in Emmett. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, emmett pond repair, pond repair emmett"
        canonical="https://utahwatergardens.com/pond-repair-emmett"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Emmett",
          "description": "Professional pond repair services in Emmett",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Emmett"
        subtitle="Professional pond services for Pond Repair Services in Emmett and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Emmett"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Emmett</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Emmett Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Emmett Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Emmett Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Emmett Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEmmettPage;