...
const Pond-repairChubbuckPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Chubbuck | Professional Pond Repair Services"
        description="Expert pond repair services in Chubbuck. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, chubbuck pond repair, pond repair chubbuck"
        canonical="https://utahwatergardens.com/pond-repair-chubbuck"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Chubbuck",
          "description": "Professional pond repair services in Chubbuck",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Chubbuck"
        subtitle="Professional pond services for Pond Repair Services in Chubbuck and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Chubbuck"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Chubbuck</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Chubbuck Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Chubbuck Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Chubbuck Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Chubbuck Customers Say About Our Pond Repair</h2>
...
export default Pond-repairChubbuckPage;