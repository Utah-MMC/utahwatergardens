...
const Pond-repairMoranPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Moran | Professional Pond Repair Services"
        description="Expert pond repair services in Moran. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, moran pond repair, pond repair moran"
        canonical="https://utahwatergardens.com/pond-repair-moran"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Moran",
          "description": "Professional pond repair services in Moran",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Moran"
        subtitle="Professional pond services for Pond Repair Services in Moran and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Moran"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Moran</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moran Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moran Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moran Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moran Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMoranPage;