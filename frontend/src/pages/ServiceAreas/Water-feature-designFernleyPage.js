...
const Water-feature-designFernleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Fernley | Professional Water Feature Design Services"
        description="Expert water feature design services in Fernley. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, fernley water feature design, water feature design fernley"
        canonical="https://utahwatergardens.com/water-feature-design-fernley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Fernley",
          "description": "Professional water feature design services in Fernley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Fernley"
        subtitle="Professional pond services for Water Feature Design Services in Fernley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Fernley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Fernley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fernley Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fernley Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fernley Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fernley Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designFernleyPage;