...
const Pond-dredgingDugwayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Dugway | Professional Pond Dredging Services"
        description="Expert pond dredging services in Dugway. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, dugway pond dredging, pond dredging dugway"
        canonical="https://utahwatergardens.com/pond-dredging-dugway"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Dugway",
          "description": "Professional pond dredging services in Dugway",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Dugway"
        subtitle="Professional pond services for Pond Dredging Services in Dugway and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Dugway"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Dugway</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dugway Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dugway Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dugway Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dugway Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingDugwayPage;