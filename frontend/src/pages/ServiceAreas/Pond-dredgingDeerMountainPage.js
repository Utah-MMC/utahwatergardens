...
const Pond-dredgingDeerMountainPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Deer Mountain | Professional Pond Dredging Services"
        description="Expert pond dredging services in Deer Mountain. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, deer mountain pond dredging, pond dredging deer mountain"
        canonical="https://utahwatergardens.com/pond-dredging-deer-mountain"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Deer Mountain",
          "description": "Professional pond dredging services in Deer Mountain",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Deer Mountain"
        subtitle="Professional pond services for Pond Dredging Services in Deer Mountain and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Deer Mountain"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Deer Mountain</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Deer Mountain Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Deer Mountain Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Deer Mountain Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Deer Mountain Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingDeerMountainPage;