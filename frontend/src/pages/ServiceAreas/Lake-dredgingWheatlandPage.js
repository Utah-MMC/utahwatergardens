...
const Lake-dredgingWheatlandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Wheatland | Professional Lake Dredging Services"
        description="Expert lake dredging services in Wheatland. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, wheatland lake dredging, lake dredging wheatland"
        canonical="https://utahwatergardens.com/lake-dredging-wheatland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Wheatland",
          "description": "Professional lake dredging services in Wheatland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Wheatland"
        subtitle="Professional pond services for Lake Dredging Services in Wheatland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Wheatland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Wheatland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wheatland Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wheatland Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wheatland Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wheatland Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingWheatlandPage;