...
const Pond-repairHerrimanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Herriman | Professional Pond Repair Services"
        description="Expert pond repair services in Herriman. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, herriman pond repair, pond repair herriman"
        canonical="https://utahwatergardens.com/pond-repair-herriman"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Herriman",
          "description": "Professional pond repair services in Herriman",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Herriman"
        subtitle="Professional pond services for Pond Repair Services in Herriman and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Herriman"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Herriman</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Herriman Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Herriman Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Herriman Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Herriman Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHerrimanPage;