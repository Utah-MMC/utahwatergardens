...
const Pond-cleaningEvanstonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Evanston | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Evanston. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, evanston pond cleaning, pond cleaning evanston"
        canonical="https://utahwatergardens.com/pond-cleaning-evanston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Evanston",
          "description": "Professional pond cleaning services in Evanston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Evanston"
        subtitle="Professional pond services for Pond Cleaning Services in Evanston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Evanston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Evanston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Evanston Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Evanston Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Evanston Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Evanston Customers Say About Our Pond Cleaning</h2>
