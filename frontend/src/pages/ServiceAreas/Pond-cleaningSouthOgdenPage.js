...
const Pond-cleaningSouthOgdenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning South Ogden | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in South Ogden. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, south ogden pond cleaning, pond cleaning south ogden"
        canonical="https://utahwatergardens.com/pond-cleaning-south-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services South Ogden",
          "description": "Professional pond cleaning services in South Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in South Ogden"
        subtitle="Professional pond services for Pond Cleaning Services in South Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in South Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in South Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Ogden Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Ogden Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Ogden Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Ogden Customers Say About Our Pond Cleaning</h2>
