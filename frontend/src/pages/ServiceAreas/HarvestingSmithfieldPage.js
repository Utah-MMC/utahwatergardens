...
const HarvestingSmithfieldPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Smithfield | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Smithfield. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, smithfield aquatic plant harvesting, aquatic plant harvesting smithfield"
        canonical="https://utahwatergardens.com/harvesting-smithfield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Smithfield",
          "description": "Professional aquatic plant harvesting services in Smithfield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Smithfield"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Smithfield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Smithfield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Smithfield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Smithfield Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Smithfield Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Smithfield Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Smithfield Customers Say About Our Aquatic Plant Harvesting</h2>
