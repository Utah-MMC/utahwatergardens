...
const Pond-dredgingToquervillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Toquerville | Professional Pond Dredging Services"
        description="Expert pond dredging services in Toquerville. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, toquerville pond dredging, pond dredging toquerville"
        canonical="https://utahwatergardens.com/pond-dredging-toquerville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Toquerville",
          "description": "Professional pond dredging services in Toquerville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Toquerville"
        subtitle="Professional pond services for Pond Dredging Services in Toquerville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Toquerville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Toquerville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Toquerville Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Toquerville Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Toquerville Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Toquerville Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingToquervillePage;