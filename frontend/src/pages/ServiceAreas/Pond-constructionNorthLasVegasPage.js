...
const Pond-constructionNorthLasVegasPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction North Las Vegas | Professional Pond Construction Services"
        description="Expert pond construction services in North Las Vegas. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, north las vegas pond construction, pond construction north las vegas"
        canonical="https://utahwatergardens.com/pond-construction-north-las-vegas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services North Las Vegas",
          "description": "Professional pond construction services in North Las Vegas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in North Las Vegas"
        subtitle="Professional pond services for Pond Construction Services in North Las Vegas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in North Las Vegas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in North Las Vegas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Las Vegas Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Las Vegas Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Las Vegas Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Las Vegas Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionNorthLasVegasPage;