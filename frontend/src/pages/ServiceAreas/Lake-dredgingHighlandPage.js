...
const Lake-dredgingHighlandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Highland | Professional Lake Dredging Services"
        description="Expert lake dredging services in Highland. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, highland lake dredging, lake dredging highland"
        canonical="https://utahwatergardens.com/lake-dredging-highland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Highland",
          "description": "Professional lake dredging services in Highland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Highland"
        subtitle="Professional pond services for Lake Dredging Services in Highland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Highland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Highland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Highland Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Highland Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Highland Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Highland Customers Say About Our Lake Dredging</h2>
