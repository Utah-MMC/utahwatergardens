...
const Pond-repairWestWendoverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair West Wendover | Professional Pond Repair Services"
        description="Expert pond repair services in West Wendover. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, west wendover pond repair, pond repair west wendover"
        canonical="https://utahwatergardens.com/pond-repair-west-wendover"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services West Wendover",
          "description": "Professional pond repair services in West Wendover",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in West Wendover"
        subtitle="Professional pond services for Pond Repair Services in West Wendover and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in West Wendover"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in West Wendover</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Wendover Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Wendover Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Wendover Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Wendover Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWestWendoverPage;