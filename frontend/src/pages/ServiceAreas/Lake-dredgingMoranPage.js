...
const Lake-dredgingMoranPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Moran | Professional Lake Dredging Services"
        description="Expert lake dredging services in Moran. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, moran lake dredging, lake dredging moran"
        canonical="https://utahwatergardens.com/lake-dredging-moran"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Moran",
          "description": "Professional lake dredging services in Moran",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Moran"
        subtitle="Professional pond services for Lake Dredging Services in Moran and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Moran"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Moran</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moran Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moran Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moran Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moran Customers Say About Our Lake Dredging</h2>
