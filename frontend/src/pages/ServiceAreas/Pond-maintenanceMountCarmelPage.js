...
const Pond-maintenanceMountCarmelPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Mount Carmel | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Mount Carmel. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, mount carmel pond maintenance, pond maintenance mount carmel"
        canonical="https://utahwatergardens.com/pond-maintenance-mount-carmel"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Mount Carmel",
          "description": "Professional pond maintenance services in Mount Carmel",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Mount Carmel"
        subtitle="Professional pond services for Pond Maintenance Services in Mount Carmel and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Mount Carmel"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Mount Carmel</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mount Carmel Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mount Carmel Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mount Carmel Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mount Carmel Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceMountCarmelPage;