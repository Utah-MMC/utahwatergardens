...
const Pond-repairRoyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Roy | Professional Pond Repair Services"
        description="Expert pond repair services in Roy. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, roy pond repair, pond repair roy"
        canonical="https://utahwatergardens.com/pond-repair-roy"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Roy",
          "description": "Professional pond repair services in Roy",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Roy"
        subtitle="Professional pond services for Pond Repair Services in Roy and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Roy"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Roy</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Roy Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Roy Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Roy Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Roy Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRoyPage;