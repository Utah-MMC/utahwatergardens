...
const Pond-cleaningBattleMountainPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Battle Mountain | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Battle Mountain. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, battle mountain pond cleaning, pond cleaning battle mountain"
        canonical="https://utahwatergardens.com/pond-cleaning-battle-mountain"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Battle Mountain",
          "description": "Professional pond cleaning services in Battle Mountain",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Battle Mountain"
        subtitle="Professional pond services for Pond Cleaning Services in Battle Mountain and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Battle Mountain"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Battle Mountain</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Battle Mountain Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Battle Mountain Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Battle Mountain Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Battle Mountain Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningBattleMountainPage;