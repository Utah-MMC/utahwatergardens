...
const Lake-dredgingMesquitePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mesquite | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mesquite. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mesquite lake dredging, lake dredging mesquite"
        canonical="https://utahwatergardens.com/lake-dredging-mesquite"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mesquite",
          "description": "Professional lake dredging services in Mesquite",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mesquite"
        subtitle="Professional pond services for Lake Dredging Services in Mesquite and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mesquite"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mesquite</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mesquite Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mesquite Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mesquite Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mesquite Customers Say About Our Lake Dredging</h2>
