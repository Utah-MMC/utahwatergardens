...
const Pond-repairHazeltonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Hazelton | Professional Pond Repair Services"
        description="Expert pond repair services in Hazelton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, hazelton pond repair, pond repair hazelton"
        canonical="https://utahwatergardens.com/pond-repair-hazelton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Hazelton",
          "description": "Professional pond repair services in Hazelton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Hazelton"
        subtitle="Professional pond services for Pond Repair Services in Hazelton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Hazelton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Hazelton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hazelton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hazelton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hazelton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hazelton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHazeltonPage;