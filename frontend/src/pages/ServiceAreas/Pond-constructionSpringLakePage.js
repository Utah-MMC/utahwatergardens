...
const Pond-constructionSpringLakePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Spring Lake | Professional Pond Construction Services"
        description="Expert pond construction services in Spring Lake. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, spring lake pond construction, pond construction spring lake"
        canonical="https://utahwatergardens.com/pond-construction-spring-lake"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Spring Lake",
          "description": "Professional pond construction services in Spring Lake",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Spring Lake"
        subtitle="Professional pond services for Pond Construction Services in Spring Lake and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Spring Lake"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Spring Lake</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spring Lake Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spring Lake Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spring Lake Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spring Lake Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSpringLakePage;