...
const Pond-repairCodyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Cody | Professional Pond Repair Services"
        description="Expert pond repair services in Cody. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, cody pond repair, pond repair cody"
        canonical="https://utahwatergardens.com/pond-repair-cody"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Cody",
          "description": "Professional pond repair services in Cody",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Cody"
        subtitle="Professional pond services for Pond Repair Services in Cody and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Cody"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Cody</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cody Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cody Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cody Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cody Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCodyPage;