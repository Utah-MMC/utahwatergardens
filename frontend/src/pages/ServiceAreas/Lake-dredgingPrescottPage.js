...
const Lake-dredgingPrescottPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Prescott | Professional Lake Dredging Services"
        description="Expert lake dredging services in Prescott. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, prescott lake dredging, lake dredging prescott"
        canonical="https://utahwatergardens.com/lake-dredging-prescott"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Prescott",
          "description": "Professional lake dredging services in Prescott",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Prescott"
        subtitle="Professional pond services for Lake Dredging Services in Prescott and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Prescott"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Prescott</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Prescott Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Prescott Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Prescott Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Prescott Customers Say About Our Lake Dredging</h2>
