...
const Lake-dredgingIdahoFallsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Idaho Falls | Professional Lake Dredging Services"
        description="Expert lake dredging services in Idaho Falls. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, idaho falls lake dredging, lake dredging idaho falls"
        canonical="https://utahwatergardens.com/lake-dredging-idaho-falls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Idaho Falls",
          "description": "Professional lake dredging services in Idaho Falls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Idaho Falls"
        subtitle="Professional pond services for Lake Dredging Services in Idaho Falls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Idaho Falls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Idaho Falls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Idaho Falls Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Idaho Falls Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Idaho Falls Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Idaho Falls Customers Say About Our Lake Dredging</h2>
