...
const Lake-dredgingMidwayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Midway | Professional Lake Dredging Services"
        description="Expert lake dredging services in Midway. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, midway lake dredging, lake dredging midway"
        canonical="https://utahwatergardens.com/lake-dredging-midway"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Midway",
          "description": "Professional lake dredging services in Midway",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Midway"
        subtitle="Professional pond services for Lake Dredging Services in Midway and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Midway"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Midway</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Midway Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Midway Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Midway Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Midway Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMidwayPage;