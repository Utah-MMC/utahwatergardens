...
const Pond-cleaningEmeryPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Emery | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Emery. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, emery pond cleaning, pond cleaning emery"
        canonical="https://utahwatergardens.com/pond-cleaning-emery"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Emery",
          "description": "Professional pond cleaning services in Emery",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Emery"
        subtitle="Professional pond services for Pond Cleaning Services in Emery and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Emery"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Emery</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Emery Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Emery Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Emery Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Emery Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningEmeryPage;