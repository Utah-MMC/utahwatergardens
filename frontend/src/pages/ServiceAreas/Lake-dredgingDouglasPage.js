...
const Lake-dredgingDouglasPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Douglas | Professional Lake Dredging Services"
        description="Expert lake dredging services in Douglas. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, douglas lake dredging, lake dredging douglas"
        canonical="https://utahwatergardens.com/lake-dredging-douglas"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Douglas",
          "description": "Professional lake dredging services in Douglas",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Douglas"
        subtitle="Professional pond services for Lake Dredging Services in Douglas and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Douglas"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Douglas</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Douglas Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Douglas Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Douglas Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Douglas Customers Say About Our Lake Dredging</h2>
