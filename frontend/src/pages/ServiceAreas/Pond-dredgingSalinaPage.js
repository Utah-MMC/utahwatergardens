...
const Pond-dredgingSalinaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Salina | Professional Pond Dredging Services"
        description="Expert pond dredging services in Salina. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, salina pond dredging, pond dredging salina"
        canonical="https://utahwatergardens.com/pond-dredging-salina"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Salina",
          "description": "Professional pond dredging services in Salina",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Salina"
        subtitle="Professional pond services for Pond Dredging Services in Salina and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Salina"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Salina</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Salina Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Salina Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Salina Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Salina Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSalinaPage;