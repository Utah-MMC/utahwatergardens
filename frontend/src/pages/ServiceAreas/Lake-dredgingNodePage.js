...
const Lake-dredgingNodePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Node | Professional Lake Dredging Services"
        description="Expert lake dredging services in Node. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, node lake dredging, lake dredging node"
        canonical="https://utahwatergardens.com/lake-dredging-node"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Node",
          "description": "Professional lake dredging services in Node",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Node"
        subtitle="Professional pond services for Lake Dredging Services in Node and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Node"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Node</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Node Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Node Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Node Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Node Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingNodePage;