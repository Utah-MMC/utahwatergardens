...
const Lake-dredgingFredoniaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Fredonia | Professional Lake Dredging Services"
        description="Expert lake dredging services in Fredonia. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, fredonia lake dredging, lake dredging fredonia"
        canonical="https://utahwatergardens.com/lake-dredging-fredonia"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Fredonia",
          "description": "Professional lake dredging services in Fredonia",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Fredonia"
        subtitle="Professional pond services for Lake Dredging Services in Fredonia and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Fredonia"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Fredonia</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fredonia Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fredonia Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fredonia Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fredonia Customers Say About Our Lake Dredging</h2>
