...
const Pond-dredgingLindonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lindon | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lindon. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lindon pond dredging, pond dredging lindon"
        canonical="https://utahwatergardens.com/pond-dredging-lindon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lindon",
          "description": "Professional pond dredging services in Lindon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lindon"
        subtitle="Professional pond services for Pond Dredging Services in Lindon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lindon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lindon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lindon Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lindon Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lindon Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lindon Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLindonPage;