...
const Pond-cleaningHurricanePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Hurricane | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Hurricane. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, hurricane pond cleaning, pond cleaning hurricane"
        canonical="https://utahwatergardens.com/pond-cleaning-hurricane"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Hurricane",
          "description": "Professional pond cleaning services in Hurricane",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Hurricane"
        subtitle="Professional pond services for Pond Cleaning Services in Hurricane and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Hurricane"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Hurricane</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hurricane Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hurricane Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hurricane Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hurricane Customers Say About Our Pond Cleaning</h2>
