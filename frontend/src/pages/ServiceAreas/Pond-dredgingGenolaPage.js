...
const Pond-dredgingGenolaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Genola | Professional Pond Dredging Services"
        description="Expert pond dredging services in Genola. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, genola pond dredging, pond dredging genola"
        canonical="https://utahwatergardens.com/pond-dredging-genola"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Genola",
          "description": "Professional pond dredging services in Genola",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Genola"
        subtitle="Professional pond services for Pond Dredging Services in Genola and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Genola"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Genola</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Genola Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Genola Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Genola Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Genola Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingGenolaPage;