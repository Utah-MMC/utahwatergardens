  ...
  return (
    <div className="service-area-page">
      <PageHero 
        ...
        subtitle="Professional pond services for Manti and surrounding Sanpete County areas"
      ...
      <div className="container">
        ...
        >
          <h2>Ready to Get Started in Manti?</h2>
          <p>Contact us today for a free consultation and quote on your Manti pond project.</p>
