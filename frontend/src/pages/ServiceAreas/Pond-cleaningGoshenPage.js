...
const Pond-cleaningGoshenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Goshen | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Goshen. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, goshen pond cleaning, pond cleaning goshen"
        canonical="https://utahwatergardens.com/pond-cleaning-goshen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Goshen",
          "description": "Professional pond cleaning services in Goshen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Goshen"
        subtitle="Professional pond services for Pond Cleaning Services in Goshen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Goshen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Goshen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goshen Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goshen Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goshen Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goshen Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningGoshenPage;