...
const Pond-repairCornishPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Cornish | Professional Pond Repair Services"
        description="Expert pond repair services in Cornish. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, cornish pond repair, pond repair cornish"
        canonical="https://utahwatergardens.com/pond-repair-cornish"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Cornish",
          "description": "Professional pond repair services in Cornish",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Cornish"
        subtitle="Professional pond services for Pond Repair Services in Cornish and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Cornish"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Cornish</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cornish Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cornish Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cornish Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cornish Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCornishPage;