...
const Pond-dredgingAlmoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Almo | Professional Pond Dredging Services"
        description="Expert pond dredging services in Almo. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, almo pond dredging, pond dredging almo"
        canonical="https://utahwatergardens.com/pond-dredging-almo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Almo",
          "description": "Professional pond dredging services in Almo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Almo"
        subtitle="Professional pond services for Pond Dredging Services in Almo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Almo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Almo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Almo Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Almo Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Almo Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Almo Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAlmoPage;