...
const Pond-cleaningBarNunnPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Bar Nunn | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Bar Nunn. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, bar nunn pond cleaning, pond cleaning bar nunn"
        canonical="https://utahwatergardens.com/pond-cleaning-bar-nunn"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Bar Nunn",
          "description": "Professional pond cleaning services in Bar Nunn",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Bar Nunn"
        subtitle="Professional pond services for Pond Cleaning Services in Bar Nunn and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Bar Nunn"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Bar Nunn</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bar Nunn Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bar Nunn Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bar Nunn Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bar Nunn Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningBarNunnPage;