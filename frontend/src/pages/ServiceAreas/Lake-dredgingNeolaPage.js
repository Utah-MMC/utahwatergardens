...
const Lake-dredgingNeolaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Neola | Professional Lake Dredging Services"
        description="Expert lake dredging services in Neola. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, neola lake dredging, lake dredging neola"
        canonical="https://utahwatergardens.com/lake-dredging-neola"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Neola",
          "description": "Professional lake dredging services in Neola",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Neola"
        subtitle="Professional pond services for Lake Dredging Services in Neola and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Neola"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Neola</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Neola Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Neola Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Neola Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Neola Customers Say About Our Lake Dredging</h2>
