...
const Lake-dredgingGenolaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Genola | Professional Lake Dredging Services"
        description="Expert lake dredging services in Genola. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, genola lake dredging, lake dredging genola"
        canonical="https://utahwatergardens.com/lake-dredging-genola"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Genola",
          "description": "Professional lake dredging services in Genola",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Genola"
        subtitle="Professional pond services for Lake Dredging Services in Genola and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Genola"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Genola</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Genola Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Genola Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Genola Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Genola Customers Say About Our Lake Dredging</h2>
