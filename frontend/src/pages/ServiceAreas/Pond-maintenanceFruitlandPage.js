...
const Pond-maintenanceFruitlandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Fruitland | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Fruitland. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, fruitland pond maintenance, pond maintenance fruitland"
        canonical="https://utahwatergardens.com/pond-maintenance-fruitland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Fruitland",
          "description": "Professional pond maintenance services in Fruitland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Fruitland"
        subtitle="Professional pond services for Pond Maintenance Services in Fruitland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Fruitland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Fruitland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruitland Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruitland Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruitland Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruitland Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceFruitlandPage;