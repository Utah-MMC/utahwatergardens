...
const Lake-dredgingLinglePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lingle | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lingle. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lingle lake dredging, lake dredging lingle"
        canonical="https://utahwatergardens.com/lake-dredging-lingle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lingle",
          "description": "Professional lake dredging services in Lingle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lingle"
        subtitle="Professional pond services for Lake Dredging Services in Lingle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lingle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lingle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lingle Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lingle Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lingle Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lingle Customers Say About Our Lake Dredging</h2>
