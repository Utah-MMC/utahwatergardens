...
const Lake-dredgingPahrumpPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Pahrump | Professional Lake Dredging Services"
        description="Expert lake dredging services in Pahrump. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, pahrump lake dredging, lake dredging pahrump"
        canonical="https://utahwatergardens.com/lake-dredging-pahrump"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Pahrump",
          "description": "Professional lake dredging services in Pahrump",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Pahrump"
        subtitle="Professional pond services for Lake Dredging Services in Pahrump and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Pahrump"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Pahrump</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pahrump Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pahrump Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pahrump Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pahrump Customers Say About Our Lake Dredging</h2>
