...
const Pond-dredgingAnthemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Anthem | Professional Pond Dredging Services"
        description="Expert pond dredging services in Anthem. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, anthem pond dredging, pond dredging anthem"
        canonical="https://utahwatergardens.com/pond-dredging-anthem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Anthem",
          "description": "Professional pond dredging services in Anthem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Anthem"
        subtitle="Professional pond services for Pond Dredging Services in Anthem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Anthem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Anthem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Anthem Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Anthem Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Anthem Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Anthem Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAnthemPage;