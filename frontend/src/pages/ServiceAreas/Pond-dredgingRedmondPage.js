...
const Pond-dredgingRedmondPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Redmond | Professional Pond Dredging Services"
        description="Expert pond dredging services in Redmond. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, redmond pond dredging, pond dredging redmond"
        canonical="https://utahwatergardens.com/pond-dredging-redmond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Redmond",
          "description": "Professional pond dredging services in Redmond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Redmond"
        subtitle="Professional pond services for Pond Dredging Services in Redmond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Redmond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Redmond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Redmond Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Redmond Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Redmond Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Redmond Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingRedmondPage;