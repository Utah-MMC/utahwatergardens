...
const Pond-dredgingHoytsvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hoytsville | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hoytsville. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hoytsville pond dredging, pond dredging hoytsville"
        canonical="https://utahwatergardens.com/pond-dredging-hoytsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hoytsville",
          "description": "Professional pond dredging services in Hoytsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hoytsville"
        subtitle="Professional pond services for Pond Dredging Services in Hoytsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hoytsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hoytsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hoytsville Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hoytsville Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hoytsville Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hoytsville Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHoytsvillePage;