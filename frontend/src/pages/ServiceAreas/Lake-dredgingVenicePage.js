...
const Lake-dredgingVenicePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Venice | Professional Lake Dredging Services"
        description="Expert lake dredging services in Venice. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, venice lake dredging, lake dredging venice"
        canonical="https://utahwatergardens.com/lake-dredging-venice"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Venice",
          "description": "Professional lake dredging services in Venice",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Venice"
        subtitle="Professional pond services for Lake Dredging Services in Venice and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Venice"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Venice</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Venice Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Venice Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Venice Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Venice Customers Say About Our Lake Dredging</h2>
