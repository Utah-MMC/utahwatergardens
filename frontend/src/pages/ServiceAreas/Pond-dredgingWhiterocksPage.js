...
const Pond-dredgingWhiterocksPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Whiterocks | Professional Pond Dredging Services"
        description="Expert pond dredging services in Whiterocks. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, whiterocks pond dredging, pond dredging whiterocks"
        canonical="https://utahwatergardens.com/pond-dredging-whiterocks"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Whiterocks",
          "description": "Professional pond dredging services in Whiterocks",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Whiterocks"
        subtitle="Professional pond services for Pond Dredging Services in Whiterocks and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Whiterocks"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Whiterocks</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Whiterocks Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Whiterocks Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Whiterocks Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Whiterocks Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWhiterocksPage;