...
const Pond-dredgingVernonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Vernon | Professional Pond Dredging Services"
        description="Expert pond dredging services in Vernon. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, vernon pond dredging, pond dredging vernon"
        canonical="https://utahwatergardens.com/pond-dredging-vernon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Vernon",
          "description": "Professional pond dredging services in Vernon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Vernon"
        subtitle="Professional pond services for Pond Dredging Services in Vernon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Vernon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Vernon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Vernon Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Vernon Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Vernon Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Vernon Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingVernonPage;