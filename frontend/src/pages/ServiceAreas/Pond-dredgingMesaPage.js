...
const Pond-dredgingMesaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Mesa | Professional Pond Dredging Services"
        description="Expert pond dredging services in Mesa. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, mesa pond dredging, pond dredging mesa"
        canonical="https://utahwatergardens.com/pond-dredging-mesa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Mesa",
          "description": "Professional pond dredging services in Mesa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Mesa"
        subtitle="Professional pond services for Pond Dredging Services in Mesa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Mesa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Mesa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mesa Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mesa Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mesa Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mesa Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMesaPage;