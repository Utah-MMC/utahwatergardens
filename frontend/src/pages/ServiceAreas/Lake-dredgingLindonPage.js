...
const Lake-dredgingLindonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Lindon | Professional Lake Dredging Services"
        description="Expert lake dredging services in Lindon. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, lindon lake dredging, lake dredging lindon"
        canonical="https://utahwatergardens.com/lake-dredging-lindon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Lindon",
          "description": "Professional lake dredging services in Lindon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Lindon"
        subtitle="Professional pond services for Lake Dredging Services in Lindon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Lindon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Lindon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lindon Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lindon Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lindon Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lindon Customers Say About Our Lake Dredging</h2>
