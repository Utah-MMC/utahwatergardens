  ...
  return (
    <div className="service-area-page">
      <PageHero 
        ...
        subtitle="Professional pond services for North Ogden and surrounding Davis County areas"
      ...
      <div className="container">
        ...
        >
          <h2>Ready to Get Started in North Ogden?</h2>
          <p>Contact us today for a free consultation and quote on your North Ogden pond project.</p>
