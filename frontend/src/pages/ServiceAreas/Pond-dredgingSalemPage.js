...
const Pond-dredgingSalemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Salem | Professional Pond Dredging Services"
        description="Expert pond dredging services in Salem. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, salem pond dredging, pond dredging salem"
        canonical="https://utahwatergardens.com/pond-dredging-salem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Salem",
          "description": "Professional pond dredging services in Salem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Salem"
        subtitle="Professional pond services for Pond Dredging Services in Salem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Salem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Salem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Salem Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Salem Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Salem Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Salem Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSalemPage;