...
const Pond-repairTrentonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Trenton | Professional Pond Repair Services"
        description="Expert pond repair services in Trenton. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, trenton pond repair, pond repair trenton"
        canonical="https://utahwatergardens.com/pond-repair-trenton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Trenton",
          "description": "Professional pond repair services in Trenton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Trenton"
        subtitle="Professional pond services for Pond Repair Services in Trenton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Trenton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Trenton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Trenton Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Trenton Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Trenton Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Trenton Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTrentonPage;