...
const Lake-dredgingKanabPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Kanab | Professional Lake Dredging Services"
        description="Expert lake dredging services in Kanab. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, kanab lake dredging, lake dredging kanab"
        canonical="https://utahwatergardens.com/lake-dredging-kanab"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Kanab",
          "description": "Professional lake dredging services in Kanab",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Kanab"
        subtitle="Professional pond services for Lake Dredging Services in Kanab and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Kanab"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Kanab</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kanab Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kanab Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kanab Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kanab Customers Say About Our Lake Dredging</h2>
