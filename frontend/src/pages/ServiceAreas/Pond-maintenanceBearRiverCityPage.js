...
const Pond-maintenanceBearRiverCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Bear River City | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Bear River City. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, bear river city pond maintenance, pond maintenance bear river city"
        canonical="https://utahwatergardens.com/pond-maintenance-bear-river-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Bear River City",
          "description": "Professional pond maintenance services in Bear River City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Bear River City"
        subtitle="Professional pond services for Pond Maintenance Services in Bear River City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Bear River City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Bear River City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bear River City Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bear River City Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bear River City Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bear River City Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceBearRiverCityPage;