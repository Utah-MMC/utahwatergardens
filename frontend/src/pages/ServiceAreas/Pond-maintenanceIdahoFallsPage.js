...
const Pond-maintenanceIdahoFallsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Idaho Falls | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Idaho Falls. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, idaho falls pond maintenance, pond maintenance idaho falls"
        canonical="https://utahwatergardens.com/pond-maintenance-idaho-falls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Idaho Falls",
          "description": "Professional pond maintenance services in Idaho Falls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Idaho Falls"
        subtitle="Professional pond services for Pond Maintenance Services in Idaho Falls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Idaho Falls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Idaho Falls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Idaho Falls Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Idaho Falls Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Idaho Falls Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Idaho Falls Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceIdahoFallsPage;