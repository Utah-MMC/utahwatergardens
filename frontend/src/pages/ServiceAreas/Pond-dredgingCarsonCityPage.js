...
const Pond-dredgingCarsonCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Carson City | Professional Pond Dredging Services"
        description="Expert pond dredging services in Carson City. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, carson city pond dredging, pond dredging carson city"
        canonical="https://utahwatergardens.com/pond-dredging-carson-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Carson City",
          "description": "Professional pond dredging services in Carson City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Carson City"
        subtitle="Professional pond services for Pond Dredging Services in Carson City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Carson City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Carson City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carson City Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carson City Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carson City Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carson City Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCarsonCityPage;