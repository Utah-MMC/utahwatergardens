...
const Pond-repairCrawfordPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Crawford | Professional Pond Repair Services"
        description="Expert pond repair services in Crawford. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, crawford pond repair, pond repair crawford"
        canonical="https://utahwatergardens.com/pond-repair-crawford"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Crawford",
          "description": "Professional pond repair services in Crawford",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Crawford"
        subtitle="Professional pond services for Pond Repair Services in Crawford and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Crawford"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Crawford</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Crawford Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Crawford Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Crawford Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Crawford Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCrawfordPage;