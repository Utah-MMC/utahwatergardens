...
const Pond-maintenanceSilverCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Silver Creek | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Silver Creek. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, silver creek pond maintenance, pond maintenance silver creek"
        canonical="https://utahwatergardens.com/pond-maintenance-silver-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Silver Creek",
          "description": "Professional pond maintenance services in Silver Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Silver Creek"
        subtitle="Professional pond services for Pond Maintenance Services in Silver Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Silver Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Silver Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Silver Creek Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Silver Creek Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Silver Creek Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Silver Creek Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSilverCreekPage;