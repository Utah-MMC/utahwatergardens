...
const Pond-dredgingGoshutePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Goshute | Professional Pond Dredging Services"
        description="Expert pond dredging services in Goshute. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, goshute pond dredging, pond dredging goshute"
        canonical="https://utahwatergardens.com/pond-dredging-goshute"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Goshute",
          "description": "Professional pond dredging services in Goshute",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Goshute"
        subtitle="Professional pond services for Pond Dredging Services in Goshute and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Goshute"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Goshute</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Goshute Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Goshute Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Goshute Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Goshute Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingGoshutePage;