...
const Pond-cleaningGoldCanyonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Gold Canyon | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Gold Canyon. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, gold canyon pond cleaning, pond cleaning gold canyon"
        canonical="https://utahwatergardens.com/pond-cleaning-gold-canyon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Gold Canyon",
          "description": "Professional pond cleaning services in Gold Canyon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Gold Canyon"
        subtitle="Professional pond services for Pond Cleaning Services in Gold Canyon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Gold Canyon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Gold Canyon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gold Canyon Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gold Canyon Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gold Canyon Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gold Canyon Customers Say About Our Pond Cleaning</h2>
