...
const Pond-repairLanceCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lance Creek | Professional Pond Repair Services"
        description="Expert pond repair services in Lance Creek. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lance creek pond repair, pond repair lance creek"
        canonical="https://utahwatergardens.com/pond-repair-lance-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lance Creek",
          "description": "Professional pond repair services in Lance Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lance Creek"
        subtitle="Professional pond services for Pond Repair Services in Lance Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lance Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lance Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lance Creek Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lance Creek Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lance Creek Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lance Creek Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLanceCreekPage;