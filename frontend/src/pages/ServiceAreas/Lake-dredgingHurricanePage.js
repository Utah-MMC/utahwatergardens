...
const Lake-dredgingHurricanePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Hurricane | Professional Lake Dredging Services"
        description="Expert lake dredging services in Hurricane. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, hurricane lake dredging, lake dredging hurricane"
        canonical="https://utahwatergardens.com/lake-dredging-hurricane"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Hurricane",
          "description": "Professional lake dredging services in Hurricane",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Hurricane"
        subtitle="Professional pond services for Lake Dredging Services in Hurricane and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Hurricane"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Hurricane</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hurricane Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hurricane Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hurricane Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hurricane Customers Say About Our Lake Dredging</h2>
