...
const Pond-cleaningWendellPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Wendell | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Wendell. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, wendell pond cleaning, pond cleaning wendell"
        canonical="https://utahwatergardens.com/pond-cleaning-wendell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Wendell",
          "description": "Professional pond cleaning services in Wendell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Wendell"
        subtitle="Professional pond services for Pond Cleaning Services in Wendell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Wendell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Wendell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wendell Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wendell Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wendell Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wendell Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningWendellPage;