...
const Pond-cleaningScofieldPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Scofield | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Scofield. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, scofield pond cleaning, pond cleaning scofield"
        canonical="https://utahwatergardens.com/pond-cleaning-scofield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Scofield",
          "description": "Professional pond cleaning services in Scofield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Scofield"
        subtitle="Professional pond services for Pond Cleaning Services in Scofield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Scofield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Scofield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Scofield Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Scofield Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Scofield Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Scofield Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningScofieldPage;