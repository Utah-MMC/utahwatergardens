...
const Pond-cleaningCaveCreekPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Cave Creek | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Cave Creek. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, cave creek pond cleaning, pond cleaning cave creek"
        canonical="https://utahwatergardens.com/pond-cleaning-cave-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Cave Creek",
          "description": "Professional pond cleaning services in Cave Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Cave Creek"
        subtitle="Professional pond services for Pond Cleaning Services in Cave Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Cave Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Cave Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cave Creek Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cave Creek Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cave Creek Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cave Creek Customers Say About Our Pond Cleaning</h2>
