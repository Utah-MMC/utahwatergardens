...
const Pond-cleaningAlamoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Alamo | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Alamo. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, alamo pond cleaning, pond cleaning alamo"
        canonical="https://utahwatergardens.com/pond-cleaning-alamo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Alamo",
          "description": "Professional pond cleaning services in Alamo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Alamo"
        subtitle="Professional pond services for Pond Cleaning Services in Alamo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Alamo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Alamo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alamo Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alamo Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alamo Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alamo Customers Say About Our Pond Cleaning</h2>
