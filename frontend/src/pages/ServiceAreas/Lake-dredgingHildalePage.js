...
const Lake-dredgingHildalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Hildale | Professional Lake Dredging Services"
        description="Expert lake dredging services in Hildale. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, hildale lake dredging, lake dredging hildale"
        canonical="https://utahwatergardens.com/lake-dredging-hildale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Hildale",
          "description": "Professional lake dredging services in Hildale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Hildale"
        subtitle="Professional pond services for Lake Dredging Services in Hildale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Hildale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Hildale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hildale Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hildale Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hildale Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hildale Customers Say About Our Lake Dredging</h2>
