...
const Lake-dredgingCastleDalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Castle Dale | Professional Lake Dredging Services"
        description="Expert lake dredging services in Castle Dale. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, castle dale lake dredging, lake dredging castle dale"
        canonical="https://utahwatergardens.com/lake-dredging-castle-dale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Castle Dale",
          "description": "Professional lake dredging services in Castle Dale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Castle Dale"
        subtitle="Professional pond services for Lake Dredging Services in Castle Dale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Castle Dale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Castle Dale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Castle Dale Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Castle Dale Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Castle Dale Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Castle Dale Customers Say About Our Lake Dredging</h2>
