...
const Lake-dredgingFountainHillsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Fountain Hills | Professional Lake Dredging Services"
        description="Expert lake dredging services in Fountain Hills. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, fountain hills lake dredging, lake dredging fountain hills"
        canonical="https://utahwatergardens.com/lake-dredging-fountain-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Fountain Hills",
          "description": "Professional lake dredging services in Fountain Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Fountain Hills"
        subtitle="Professional pond services for Lake Dredging Services in Fountain Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Fountain Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Fountain Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fountain Hills Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fountain Hills Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fountain Hills Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fountain Hills Customers Say About Our Lake Dredging</h2>
