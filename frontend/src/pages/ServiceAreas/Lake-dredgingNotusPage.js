...
const Lake-dredgingNotusPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Notus | Professional Lake Dredging Services"
        description="Expert lake dredging services in Notus. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, notus lake dredging, lake dredging notus"
        canonical="https://utahwatergardens.com/lake-dredging-notus"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Notus",
          "description": "Professional lake dredging services in Notus",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Notus"
        subtitle="Professional pond services for Lake Dredging Services in Notus and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Notus"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Notus</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Notus Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Notus Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Notus Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Notus Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingNotusPage;