...
const Pond-dredgingDuboisPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Dubois | Professional Pond Dredging Services"
        description="Expert pond dredging services in Dubois. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, dubois pond dredging, pond dredging dubois"
        canonical="https://utahwatergardens.com/pond-dredging-dubois"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Dubois",
          "description": "Professional pond dredging services in Dubois",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Dubois"
        subtitle="Professional pond services for Pond Dredging Services in Dubois and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Dubois"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Dubois</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dubois Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dubois Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dubois Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dubois Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingDuboisPage;