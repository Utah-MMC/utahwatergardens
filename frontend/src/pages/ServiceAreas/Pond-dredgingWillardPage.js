...
const Pond-dredgingWillardPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Willard | Professional Pond Dredging Services"
        description="Expert pond dredging services in Willard. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, willard pond dredging, pond dredging willard"
        canonical="https://utahwatergardens.com/pond-dredging-willard"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Willard",
          "description": "Professional pond dredging services in Willard",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Willard"
        subtitle="Professional pond services for Pond Dredging Services in Willard and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Willard"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Willard</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Willard Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Willard Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Willard Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Willard Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWillardPage;