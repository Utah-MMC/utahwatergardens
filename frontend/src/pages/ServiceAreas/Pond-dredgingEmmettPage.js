...
const Pond-dredgingEmmettPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Emmett | Professional Pond Dredging Services"
        description="Expert pond dredging services in Emmett. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, emmett pond dredging, pond dredging emmett"
        canonical="https://utahwatergardens.com/pond-dredging-emmett"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Emmett",
          "description": "Professional pond dredging services in Emmett",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Emmett"
        subtitle="Professional pond services for Pond Dredging Services in Emmett and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Emmett"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Emmett</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Emmett Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Emmett Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Emmett Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Emmett Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingEmmettPage;