...
const Pond-cleaningLanderPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lander | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lander. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lander pond cleaning, pond cleaning lander"
        canonical="https://utahwatergardens.com/pond-cleaning-lander"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lander",
          "description": "Professional pond cleaning services in Lander",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lander"
        subtitle="Professional pond services for Pond Cleaning Services in Lander and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lander"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lander</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lander Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lander Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lander Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lander Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLanderPage;