...
const Lake-dredgingAltamontPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Altamont | Professional Lake Dredging Services"
        description="Expert lake dredging services in Altamont. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, altamont lake dredging, lake dredging altamont"
        canonical="https://utahwatergardens.com/lake-dredging-altamont"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Altamont",
          "description": "Professional lake dredging services in Altamont",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Altamont"
        subtitle="Professional pond services for Lake Dredging Services in Altamont and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Altamont"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Altamont</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Altamont Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Altamont Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Altamont Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Altamont Customers Say About Our Lake Dredging</h2>
