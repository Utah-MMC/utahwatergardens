...
const Pond-constructionFarrWestPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Farr West | Professional Pond Construction Services"
        description="Expert pond construction services in Farr West. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, farr west pond construction, pond construction farr west"
        canonical="https://utahwatergardens.com/pond-construction-farr-west"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Farr West",
          "description": "Professional pond construction services in Farr West",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Farr West"
        subtitle="Professional pond services for Pond Construction Services in Farr West and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Farr West"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Farr West</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farr West Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farr West Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farr West Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farr West Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionFarrWestPage;