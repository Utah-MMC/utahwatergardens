...
const Pond-maintenanceNuclaPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Nucla | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Nucla. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, nucla pond maintenance, pond maintenance nucla"
        canonical="https://utahwatergardens.com/pond-maintenance-nucla"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Nucla",
          "description": "Professional pond maintenance services in Nucla",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Nucla"
        subtitle="Professional pond services for Pond Maintenance Services in Nucla and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Nucla"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Nucla</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nucla Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nucla Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nucla Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nucla Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceNuclaPage;