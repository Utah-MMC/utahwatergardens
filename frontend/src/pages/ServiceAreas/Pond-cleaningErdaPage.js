...
const Pond-cleaningErdaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Erda | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Erda. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, erda pond cleaning, pond cleaning erda"
        canonical="https://utahwatergardens.com/pond-cleaning-erda"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Erda",
          "description": "Professional pond cleaning services in Erda",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Erda"
        subtitle="Professional pond services for Pond Cleaning Services in Erda and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Erda"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Erda</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Erda Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Erda Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Erda Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Erda Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningErdaPage;