...
const Pond-repairIvinsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Ivins | Professional Pond Repair Services"
        description="Expert pond repair services in Ivins. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, ivins pond repair, pond repair ivins"
        canonical="https://utahwatergardens.com/pond-repair-ivins"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Ivins",
          "description": "Professional pond repair services in Ivins",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Ivins"
        subtitle="Professional pond services for Pond Repair Services in Ivins and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Ivins"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Ivins</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ivins Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ivins Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ivins Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ivins Customers Say About Our Pond Repair</h2>
...
export default Pond-repairIvinsPage;