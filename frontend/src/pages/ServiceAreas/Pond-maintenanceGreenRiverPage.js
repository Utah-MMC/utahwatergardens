...
const Pond-maintenanceGreenRiverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Green River | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Green River. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, green river pond maintenance, pond maintenance green river"
        canonical="https://utahwatergardens.com/pond-maintenance-green-river"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Green River",
          "description": "Professional pond maintenance services in Green River",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Green River"
        subtitle="Professional pond services for Pond Maintenance Services in Green River and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Green River"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Green River</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Green River Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Green River Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Green River Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Green River Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceGreenRiverPage;