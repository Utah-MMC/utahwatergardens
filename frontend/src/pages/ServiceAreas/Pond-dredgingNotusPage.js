...
const Pond-dredgingNotusPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Notus | Professional Pond Dredging Services"
        description="Expert pond dredging services in Notus. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, notus pond dredging, pond dredging notus"
        canonical="https://utahwatergardens.com/pond-dredging-notus"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Notus",
          "description": "Professional pond dredging services in Notus",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Notus"
        subtitle="Professional pond services for Pond Dredging Services in Notus and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Notus"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Notus</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Notus Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Notus Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Notus Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Notus Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNotusPage;