...
const Lake-dredgingRicoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Rico | Professional Lake Dredging Services"
        description="Expert lake dredging services in Rico. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, rico lake dredging, lake dredging rico"
        canonical="https://utahwatergardens.com/lake-dredging-rico"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Rico",
          "description": "Professional lake dredging services in Rico",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Rico"
        subtitle="Professional pond services for Lake Dredging Services in Rico and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Rico"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Rico</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rico Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rico Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rico Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rico Customers Say About Our Lake Dredging</h2>
