...
const Pond-constructionBrianHeadPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Brian Head | Professional Pond Construction Services"
        description="Expert pond construction services in Brian Head. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, brian head pond construction, pond construction brian head"
        canonical="https://utahwatergardens.com/pond-construction-brian-head"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Brian Head",
          "description": "Professional pond construction services in Brian Head",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Brian Head"
        subtitle="Professional pond services for Pond Construction Services in Brian Head and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Brian Head"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Brian Head</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Brian Head Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Brian Head Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Brian Head Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Brian Head Customers Say About Our Pond Construction</h2>
