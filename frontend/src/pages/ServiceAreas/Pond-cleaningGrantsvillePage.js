...
const Pond-cleaningGrantsvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Grantsville | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Grantsville. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, grantsville pond cleaning, pond cleaning grantsville"
        canonical="https://utahwatergardens.com/pond-cleaning-grantsville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Grantsville",
          "description": "Professional pond cleaning services in Grantsville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Grantsville"
        subtitle="Professional pond services for Pond Cleaning Services in Grantsville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Grantsville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Grantsville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Grantsville Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Grantsville Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Grantsville Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Grantsville Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningGrantsvillePage;