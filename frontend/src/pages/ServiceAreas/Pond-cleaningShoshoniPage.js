...
const Pond-cleaningShoshoniPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Shoshoni | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Shoshoni. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, shoshoni pond cleaning, pond cleaning shoshoni"
        canonical="https://utahwatergardens.com/pond-cleaning-shoshoni"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Shoshoni",
          "description": "Professional pond cleaning services in Shoshoni",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Shoshoni"
        subtitle="Professional pond services for Pond Cleaning Services in Shoshoni and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Shoshoni"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Shoshoni</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Shoshoni Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Shoshoni Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Shoshoni Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Shoshoni Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningShoshoniPage;