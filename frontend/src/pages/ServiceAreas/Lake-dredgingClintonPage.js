...
const Lake-dredgingClintonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Clinton | Professional Lake Dredging Services"
        description="Expert lake dredging services in Clinton. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, clinton lake dredging, lake dredging clinton"
        canonical="https://utahwatergardens.com/lake-dredging-clinton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Clinton",
          "description": "Professional lake dredging services in Clinton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Clinton"
        subtitle="Professional pond services for Lake Dredging Services in Clinton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Clinton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Clinton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clinton Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clinton Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clinton Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clinton Customers Say About Our Lake Dredging</h2>
