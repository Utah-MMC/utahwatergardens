  ...
  return (
    <div className="service-area-page">
      <PageHero 
        ...
        subtitle="Professional pond services for Santa Clara and surrounding Washington County areas"
      ...
      <div className="container">
        ...
        >
          <h2>Ready to Get Started in Santa Clara?</h2>
          <p>Contact us today for a free consultation and quote on your Santa Clara pond project.</p>
