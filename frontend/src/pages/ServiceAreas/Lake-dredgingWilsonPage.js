...
const Lake-dredgingWilsonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Wilson | Professional Lake Dredging Services"
        description="Expert lake dredging services in Wilson. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, wilson lake dredging, lake dredging wilson"
        canonical="https://utahwatergardens.com/lake-dredging-wilson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Wilson",
          "description": "Professional lake dredging services in Wilson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Wilson"
        subtitle="Professional pond services for Lake Dredging Services in Wilson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Wilson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Wilson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wilson Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wilson Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wilson Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wilson Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingWilsonPage;