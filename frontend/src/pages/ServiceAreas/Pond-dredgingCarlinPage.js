...
const Pond-dredgingCarlinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Carlin | Professional Pond Dredging Services"
        description="Expert pond dredging services in Carlin. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, carlin pond dredging, pond dredging carlin"
        canonical="https://utahwatergardens.com/pond-dredging-carlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Carlin",
          "description": "Professional pond dredging services in Carlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Carlin"
        subtitle="Professional pond services for Pond Dredging Services in Carlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Carlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Carlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carlin Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carlin Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carlin Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carlin Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCarlinPage;