...
const Pond-repairLehiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Lehi | Professional Pond Repair Services"
        description="Expert pond repair services in Lehi. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, lehi pond repair, pond repair lehi"
        canonical="https://utahwatergardens.com/pond-repair-lehi"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Lehi",
          "description": "Professional pond repair services in Lehi",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Lehi"
        subtitle="Professional pond services for Pond Repair Services in Lehi and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Lehi"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Lehi</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lehi Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lehi Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lehi Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lehi Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLehiPage;