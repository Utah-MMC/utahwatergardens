...
const Pond-cleaningLehiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lehi | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lehi. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lehi pond cleaning, pond cleaning lehi"
        canonical="https://utahwatergardens.com/pond-cleaning-lehi"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lehi",
          "description": "Professional pond cleaning services in Lehi",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lehi"
        subtitle="Professional pond services for Pond Cleaning Services in Lehi and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lehi"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lehi</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lehi Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lehi Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lehi Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lehi Customers Say About Our Pond Cleaning</h2>
