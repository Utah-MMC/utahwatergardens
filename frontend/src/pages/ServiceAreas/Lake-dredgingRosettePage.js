...
const Lake-dredgingRosettePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Rosette | Professional Lake Dredging Services"
        description="Expert lake dredging services in Rosette. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, rosette lake dredging, lake dredging rosette"
        canonical="https://utahwatergardens.com/lake-dredging-rosette"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Rosette",
          "description": "Professional lake dredging services in Rosette",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Rosette"
        subtitle="Professional pond services for Lake Dredging Services in Rosette and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Rosette"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Rosette</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rosette Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rosette Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rosette Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rosette Customers Say About Our Lake Dredging</h2>
