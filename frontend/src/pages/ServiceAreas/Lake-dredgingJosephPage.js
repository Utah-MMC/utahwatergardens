...
const Lake-dredgingJosephPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Joseph | Professional Lake Dredging Services"
        description="Expert lake dredging services in Joseph. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, joseph lake dredging, lake dredging joseph"
        canonical="https://utahwatergardens.com/lake-dredging-joseph"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Joseph",
          "description": "Professional lake dredging services in Joseph",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Joseph"
        subtitle="Professional pond services for Lake Dredging Services in Joseph and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Joseph"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Joseph</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Joseph Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Joseph Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Joseph Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Joseph Customers Say About Our Lake Dredging</h2>
