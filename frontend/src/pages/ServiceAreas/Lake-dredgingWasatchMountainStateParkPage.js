...
const Lake-dredgingWasatchMountainStateParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Wasatch Mountain State Park | Professional Lake Dredging Services"
        description="Expert lake dredging services in Wasatch Mountain State Park. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, wasatch mountain state park lake dredging, lake dredging wasatch mountain state park"
        canonical="https://utahwatergardens.com/lake-dredging-wasatch-mountain-state-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Wasatch Mountain State Park",
          "description": "Professional lake dredging services in Wasatch Mountain State Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Wasatch Mountain State Park"
        subtitle="Professional pond services for Lake Dredging Services in Wasatch Mountain State Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Wasatch Mountain State Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Wasatch Mountain State Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wasatch Mountain State Park Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wasatch Mountain State Park Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wasatch Mountain State Park Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wasatch Mountain State Park Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingWasatchMountainStateParkPage;