...
const Pond-dredgingCliftonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Clifton | Professional Pond Dredging Services"
        description="Expert pond dredging services in Clifton. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, clifton pond dredging, pond dredging clifton"
        canonical="https://utahwatergardens.com/pond-dredging-clifton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Clifton",
          "description": "Professional pond dredging services in Clifton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Clifton"
        subtitle="Professional pond services for Pond Dredging Services in Clifton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Clifton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Clifton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clifton Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clifton Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clifton Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clifton Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCliftonPage;