...
const Pond-cleaningDuchesnePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Duchesne | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Duchesne. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, duchesne pond cleaning, pond cleaning duchesne"
        canonical="https://utahwatergardens.com/pond-cleaning-duchesne"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Duchesne",
          "description": "Professional pond cleaning services in Duchesne",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Duchesne"
        subtitle="Professional pond services for Pond Cleaning Services in Duchesne and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Duchesne"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Duchesne</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Duchesne Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Duchesne Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Duchesne Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Duchesne Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDuchesnePage;