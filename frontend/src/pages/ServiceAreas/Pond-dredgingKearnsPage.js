...
const Pond-dredgingKearnsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Kearns | Professional Pond Dredging Services"
        description="Expert pond dredging services in Kearns. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, kearns pond dredging, pond dredging kearns"
        canonical="https://utahwatergardens.com/pond-dredging-kearns"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Kearns",
          "description": "Professional pond dredging services in Kearns",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Kearns"
        subtitle="Professional pond services for Pond Dredging Services in Kearns and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Kearns"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Kearns</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kearns Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kearns Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kearns Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kearns Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingKearnsPage;