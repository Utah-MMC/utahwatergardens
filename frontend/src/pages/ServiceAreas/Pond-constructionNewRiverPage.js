...
const Pond-constructionNewRiverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction New River | Professional Pond Construction Services"
        description="Expert pond construction services in New River. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, new river pond construction, pond construction new river"
        canonical="https://utahwatergardens.com/pond-construction-new-river"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services New River",
          "description": "Professional pond construction services in New River",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in New River"
        subtitle="Professional pond services for Pond Construction Services in New River and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in New River"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in New River</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New River Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New River Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New River Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New River Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionNewRiverPage;