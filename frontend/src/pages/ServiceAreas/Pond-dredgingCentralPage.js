...
const Pond-dredgingCentralPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Central | Professional Pond Dredging Services"
        description="Expert pond dredging services in Central. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, central pond dredging, pond dredging central"
        canonical="https://utahwatergardens.com/pond-dredging-central"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Central",
          "description": "Professional pond dredging services in Central",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Central"
        subtitle="Professional pond services for Pond Dredging Services in Central and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Central"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Central</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Central Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Central Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Central Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Central Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCentralPage;