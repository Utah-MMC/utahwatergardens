...
const Water-feature-designLinglePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Lingle | Professional Water Feature Design Services"
        description="Expert water feature design services in Lingle. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, lingle water feature design, water feature design lingle"
        canonical="https://utahwatergardens.com/water-feature-design-lingle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Lingle",
          "description": "Professional water feature design services in Lingle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Lingle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lingle Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lingle Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lingle Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lingle Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designLinglePage;