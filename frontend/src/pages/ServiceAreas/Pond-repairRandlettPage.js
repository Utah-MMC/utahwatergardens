...
const Pond-repairRandlettPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Randlett | Professional Pond Repair Services"
        description="Expert pond repair services in Randlett. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, randlett pond repair, pond repair randlett"
        canonical="https://utahwatergardens.com/pond-repair-randlett"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Randlett",
          "description": "Professional pond repair services in Randlett",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Randlett"
        subtitle="Professional pond services for Pond Repair Services in Randlett and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Randlett"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Randlett</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Randlett Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Randlett Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Randlett Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Randlett Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRandlettPage;