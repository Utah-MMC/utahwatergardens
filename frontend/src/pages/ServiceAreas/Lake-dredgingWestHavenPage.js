...
const Lake-dredgingWestHavenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging West Haven | Professional Lake Dredging Services"
        description="Expert lake dredging services in West Haven. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, west haven lake dredging, lake dredging west haven"
        canonical="https://utahwatergardens.com/lake-dredging-west-haven"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services West Haven",
          "description": "Professional lake dredging services in West Haven",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in West Haven"
        subtitle="Professional pond services for Lake Dredging Services in West Haven and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in West Haven"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in West Haven</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Haven Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Haven Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Haven Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Haven Customers Say About Our Lake Dredging</h2>
