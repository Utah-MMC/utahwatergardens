...
const Pond-repairPrescottPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Prescott | Professional Pond Repair Services"
        description="Expert pond repair services in Prescott. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, prescott pond repair, pond repair prescott"
        canonical="https://utahwatergardens.com/pond-repair-prescott"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Prescott",
          "description": "Professional pond repair services in Prescott",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Prescott"
        subtitle="Professional pond services for Pond Repair Services in Prescott and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Prescott"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Prescott</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Prescott Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Prescott Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Prescott Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Prescott Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPrescottPage;