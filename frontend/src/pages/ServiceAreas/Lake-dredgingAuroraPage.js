...
const Lake-dredgingAuroraPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Aurora | Professional Lake Dredging Services"
        description="Expert lake dredging services in Aurora. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, aurora lake dredging, lake dredging aurora"
        canonical="https://utahwatergardens.com/lake-dredging-aurora"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Aurora",
          "description": "Professional lake dredging services in Aurora",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Aurora"
        subtitle="Professional pond services for Lake Dredging Services in Aurora and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Aurora"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Aurora</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aurora Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aurora Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aurora Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aurora Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAuroraPage;