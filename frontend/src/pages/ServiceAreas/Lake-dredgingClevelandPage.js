...
const Lake-dredgingClevelandPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Cleveland | Professional Lake Dredging Services"
        description="Expert lake dredging services in Cleveland. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, cleveland lake dredging, lake dredging cleveland"
        canonical="https://utahwatergardens.com/lake-dredging-cleveland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Cleveland",
          "description": "Professional lake dredging services in Cleveland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Cleveland"
        subtitle="Professional pond services for Lake Dredging Services in Cleveland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Cleveland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Cleveland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cleveland Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cleveland Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cleveland Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cleveland Customers Say About Our Lake Dredging</h2>
