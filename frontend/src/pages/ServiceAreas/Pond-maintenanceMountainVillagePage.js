...
const Pond-maintenanceMountainVillagePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Mountain Village | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Mountain Village. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, mountain village pond maintenance, pond maintenance mountain village"
        canonical="https://utahwatergardens.com/pond-maintenance-mountain-village"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Mountain Village",
          "description": "Professional pond maintenance services in Mountain Village",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Mountain Village"
        subtitle="Professional pond services for Pond Maintenance Services in Mountain Village and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Mountain Village"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Mountain Village</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mountain Village Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mountain Village Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mountain Village Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mountain Village Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceMountainVillagePage;