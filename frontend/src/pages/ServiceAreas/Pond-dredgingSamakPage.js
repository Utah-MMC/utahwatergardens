...
const Pond-dredgingSamakPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Samak | Professional Pond Dredging Services"
        description="Expert pond dredging services in Samak. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, samak pond dredging, pond dredging samak"
        canonical="https://utahwatergardens.com/pond-dredging-samak"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Samak",
          "description": "Professional pond dredging services in Samak",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Samak"
        subtitle="Professional pond services for Pond Dredging Services in Samak and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Samak"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Samak</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Samak Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Samak Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Samak Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Samak Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSamakPage;