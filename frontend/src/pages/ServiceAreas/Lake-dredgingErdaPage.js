...
const Lake-dredgingErdaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Erda | Professional Lake Dredging Services"
        description="Expert lake dredging services in Erda. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, erda lake dredging, lake dredging erda"
        canonical="https://utahwatergardens.com/lake-dredging-erda"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Erda",
          "description": "Professional lake dredging services in Erda",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Erda"
        subtitle="Professional pond services for Lake Dredging Services in Erda and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Erda"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Erda</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Erda Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Erda Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Erda Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Erda Customers Say About Our Lake Dredging</h2>
