...
const Pond-repairPinedalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Pinedale | Professional Pond Repair Services"
        description="Expert pond repair services in Pinedale. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, pinedale pond repair, pond repair pinedale"
        canonical="https://utahwatergardens.com/pond-repair-pinedale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Pinedale",
          "description": "Professional pond repair services in Pinedale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Pinedale"
        subtitle="Professional pond services for Pond Repair Services in Pinedale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Pinedale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Pinedale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pinedale Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pinedale Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pinedale Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pinedale Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPinedalePage;