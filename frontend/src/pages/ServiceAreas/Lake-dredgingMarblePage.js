...
const Lake-dredgingMarblePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Marble | Professional Lake Dredging Services"
        description="Expert lake dredging services in Marble. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, marble lake dredging, lake dredging marble"
        canonical="https://utahwatergardens.com/lake-dredging-marble"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Marble",
          "description": "Professional lake dredging services in Marble",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Marble"
        subtitle="Professional pond services for Lake Dredging Services in Marble and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Marble"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Marble</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marble Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marble Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marble Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marble Customers Say About Our Lake Dredging</h2>
