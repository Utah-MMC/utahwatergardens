...
const Pond-repairRedstonePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Redstone | Professional Pond Repair Services"
        description="Expert pond repair services in Redstone. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, redstone pond repair, pond repair redstone"
        canonical="https://utahwatergardens.com/pond-repair-redstone"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Redstone",
          "description": "Professional pond repair services in Redstone",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Redstone"
        subtitle="Professional pond services for Pond Repair Services in Redstone and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Redstone"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Redstone</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Redstone Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Redstone Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Redstone Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Redstone Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRedstonePage;