...
const Pond-repairKellyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Kelly | Professional Pond Repair Services"
        description="Expert pond repair services in Kelly. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, kelly pond repair, pond repair kelly"
        canonical="https://utahwatergardens.com/pond-repair-kelly"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Kelly",
          "description": "Professional pond repair services in Kelly",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Kelly"
        subtitle="Professional pond services for Pond Repair Services in Kelly and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Kelly"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Kelly</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kelly Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kelly Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kelly Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kelly Customers Say About Our Pond Repair</h2>
...
export default Pond-repairKellyPage;