...
const Lake-dredgingPricePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Price | Professional Lake Dredging Services"
        description="Expert lake dredging services in Price. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, price lake dredging, lake dredging price"
        canonical="https://utahwatergardens.com/lake-dredging-price"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Price",
          "description": "Professional lake dredging services in Price",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Price"
        subtitle="Professional pond services for Lake Dredging Services in Price and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Price"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Price</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Price Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Price Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Price Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Price Customers Say About Our Lake Dredging</h2>
