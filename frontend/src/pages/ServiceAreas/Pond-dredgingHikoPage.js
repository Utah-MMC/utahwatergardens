...
const Pond-dredgingHikoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hiko | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hiko. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hiko pond dredging, pond dredging hiko"
        canonical="https://utahwatergardens.com/pond-dredging-hiko"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hiko",
          "description": "Professional pond dredging services in Hiko",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hiko"
        subtitle="Professional pond services for Pond Dredging Services in Hiko and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hiko"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hiko</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hiko Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hiko Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hiko Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hiko Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHikoPage;