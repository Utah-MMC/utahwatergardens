...
const Pond-dredgingRushValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Rush Valley | Professional Pond Dredging Services"
        description="Expert pond dredging services in Rush Valley. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, rush valley pond dredging, pond dredging rush valley"
        canonical="https://utahwatergardens.com/pond-dredging-rush-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Rush Valley",
          "description": "Professional pond dredging services in Rush Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Rush Valley"
        subtitle="Professional pond services for Pond Dredging Services in Rush Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Rush Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Rush Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rush Valley Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rush Valley Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rush Valley Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rush Valley Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingRushValleyPage;