...
const Pond-repairShelleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Shelley | Professional Pond Repair Services"
        description="Expert pond repair services in Shelley. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, shelley pond repair, pond repair shelley"
        canonical="https://utahwatergardens.com/pond-repair-shelley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Shelley",
          "description": "Professional pond repair services in Shelley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Shelley"
        subtitle="Professional pond services for Pond Repair Services in Shelley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Shelley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Shelley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Shelley Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Shelley Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Shelley Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Shelley Customers Say About Our Pond Repair</h2>
...
export default Pond-repairShelleyPage;