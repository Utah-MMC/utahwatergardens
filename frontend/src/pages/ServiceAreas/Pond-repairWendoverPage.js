...
const Pond-repairWendoverPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Wendover | Professional Pond Repair Services"
        description="Expert pond repair services in Wendover. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, wendover pond repair, pond repair wendover"
        canonical="https://utahwatergardens.com/pond-repair-wendover"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Wendover",
          "description": "Professional pond repair services in Wendover",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Wendover"
        subtitle="Professional pond services for Pond Repair Services in Wendover and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Wendover"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Wendover</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wendover Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wendover Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wendover Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wendover Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWendoverPage;