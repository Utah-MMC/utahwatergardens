...
const Lake-dredgingTimpiePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Timpie | Professional Lake Dredging Services"
        description="Expert lake dredging services in Timpie. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, timpie lake dredging, lake dredging timpie"
        canonical="https://utahwatergardens.com/lake-dredging-timpie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Timpie",
          "description": "Professional lake dredging services in Timpie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Timpie"
        subtitle="Professional pond services for Lake Dredging Services in Timpie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Timpie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Timpie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Timpie Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Timpie Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Timpie Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Timpie Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingTimpiePage;