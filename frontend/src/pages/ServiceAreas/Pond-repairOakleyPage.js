...
const Pond-repairOakleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Oakley | Professional Pond Repair Services"
        description="Expert pond repair services in Oakley. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, oakley pond repair, pond repair oakley"
        canonical="https://utahwatergardens.com/pond-repair-oakley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Oakley",
          "description": "Professional pond repair services in Oakley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Oakley"
        subtitle="Professional pond services for Pond Repair Services in Oakley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Oakley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Oakley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Oakley Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Oakley Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Oakley Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Oakley Customers Say About Our Pond Repair</h2>
...
export default Pond-repairOakleyPage;