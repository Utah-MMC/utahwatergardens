...
const Pond-maintenanceApacheJunctionPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Apache Junction | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Apache Junction. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, apache junction pond maintenance, pond maintenance apache junction"
        canonical="https://utahwatergardens.com/pond-maintenance-apache-junction"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Apache Junction",
          "description": "Professional pond maintenance services in Apache Junction",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Apache Junction"
        subtitle="Professional pond services for Pond Maintenance Services in Apache Junction and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Apache Junction"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Apache Junction</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Apache Junction Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Apache Junction Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Apache Junction Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Apache Junction Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceApacheJunctionPage;