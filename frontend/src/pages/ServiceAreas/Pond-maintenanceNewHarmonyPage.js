...
const Pond-maintenanceNewHarmonyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance New Harmony | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in New Harmony. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, new harmony pond maintenance, pond maintenance new harmony"
        canonical="https://utahwatergardens.com/pond-maintenance-new-harmony"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services New Harmony",
          "description": "Professional pond maintenance services in New Harmony",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in New Harmony"
        subtitle="Professional pond services for Pond Maintenance Services in New Harmony and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in New Harmony"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in New Harmony</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Harmony Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Harmony Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Harmony Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Harmony Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceNewHarmonyPage;