...
const Lake-dredgingNorthOgdenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging North Ogden | Professional Lake Dredging Services"
        description="Expert lake dredging services in North Ogden. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, north ogden lake dredging, lake dredging north ogden"
        canonical="https://utahwatergardens.com/lake-dredging-north-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services North Ogden",
          "description": "Professional lake dredging services in North Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in North Ogden"
        subtitle="Professional pond services for Lake Dredging Services in North Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in North Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in North Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Ogden Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Ogden Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Ogden Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Ogden Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingNorthOgdenPage;