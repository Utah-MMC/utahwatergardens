...
const Pond-cleaningAspenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Aspen | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Aspen. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, aspen pond cleaning, pond cleaning aspen"
        canonical="https://utahwatergardens.com/pond-cleaning-aspen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Aspen",
          "description": "Professional pond cleaning services in Aspen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Aspen"
        subtitle="Professional pond services for Pond Cleaning Services in Aspen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Aspen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Aspen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Aspen Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Aspen Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Aspen Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Aspen Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAspenPage;