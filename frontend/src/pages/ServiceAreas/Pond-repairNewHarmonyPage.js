...
const Pond-repairNewHarmonyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair New Harmony | Professional Pond Repair Services"
        description="Expert pond repair services in New Harmony. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, new harmony pond repair, pond repair new harmony"
        canonical="https://utahwatergardens.com/pond-repair-new-harmony"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services New Harmony",
          "description": "Professional pond repair services in New Harmony",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in New Harmony"
        subtitle="Professional pond services for Pond Repair Services in New Harmony and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in New Harmony"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in New Harmony</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Harmony Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Harmony Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Harmony Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Harmony Customers Say About Our Pond Repair</h2>
...
export default Pond-repairNewHarmonyPage;