...
const Pond-cleaningEastCarbonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning East Carbon | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in East Carbon. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, east carbon pond cleaning, pond cleaning east carbon"
        canonical="https://utahwatergardens.com/pond-cleaning-east-carbon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services East Carbon",
          "description": "Professional pond cleaning services in East Carbon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in East Carbon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our East Carbon Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="East Carbon Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our East Carbon Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What East Carbon Customers Say About Our Pond Cleaning</h2>
