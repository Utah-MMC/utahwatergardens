...
const Pond-constructionHarrisvillePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Harrisville | Professional Pond Construction Services"
        description="Expert pond construction services in Harrisville. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, harrisville pond construction, pond construction harrisville"
        canonical="https://utahwatergardens.com/pond-construction-harrisville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Harrisville",
          "description": "Professional pond construction services in Harrisville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Harrisville"
        subtitle="Professional pond services for Pond Construction Services in Harrisville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Harrisville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Harrisville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Harrisville Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Harrisville Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Harrisville Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Harrisville Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionHarrisvillePage;