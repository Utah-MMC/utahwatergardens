...
const Pond-repairOgdenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Ogden | Professional Pond Repair Services"
        description="Expert pond repair services in Ogden. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, ogden pond repair, pond repair ogden"
        canonical="https://utahwatergardens.com/pond-repair-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Ogden",
          "description": "Professional pond repair services in Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Ogden"
        subtitle="Professional pond services for Pond Repair Services in Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ogden Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ogden Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ogden Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ogden Customers Say About Our Pond Repair</h2>
...
export default Pond-repairOgdenPage;