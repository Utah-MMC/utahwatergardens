...
const Lake-dredgingPleasantGrovePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Pleasant Grove | Professional Lake Dredging Services"
        description="Expert lake dredging services in Pleasant Grove. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, pleasant grove lake dredging, lake dredging pleasant grove"
        canonical="https://utahwatergardens.com/lake-dredging-pleasant-grove"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Pleasant Grove",
          "description": "Professional lake dredging services in Pleasant Grove",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Pleasant Grove"
        subtitle="Professional pond services for Lake Dredging Services in Pleasant Grove and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Pleasant Grove"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Pleasant Grove</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pleasant Grove Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pleasant Grove Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pleasant Grove Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pleasant Grove Customers Say About Our Lake Dredging</h2>
