...
const Pond-cleaningChubbuckPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Chubbuck | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Chubbuck. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, chubbuck pond cleaning, pond cleaning chubbuck"
        canonical="https://utahwatergardens.com/pond-cleaning-chubbuck"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Chubbuck",
          "description": "Professional pond cleaning services in Chubbuck",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Chubbuck"
        subtitle="Professional pond services for Pond Cleaning Services in Chubbuck and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Chubbuck"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Chubbuck</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Chubbuck Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Chubbuck Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Chubbuck Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Chubbuck Customers Say About Our Pond Cleaning</h2>
