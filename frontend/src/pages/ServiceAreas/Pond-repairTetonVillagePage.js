...
const Pond-repairTetonVillagePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Teton Village | Professional Pond Repair Services"
        description="Expert pond repair services in Teton Village. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, teton village pond repair, pond repair teton village"
        canonical="https://utahwatergardens.com/pond-repair-teton-village"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Teton Village",
          "description": "Professional pond repair services in Teton Village",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Teton Village"
        subtitle="Professional pond services for Pond Repair Services in Teton Village and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Teton Village"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Teton Village</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Teton Village Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Teton Village Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Teton Village Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Teton Village Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTetonVillagePage;