...
const Pond-repairLitchfieldParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Litchfield Park | Professional Pond Repair Services"
        description="Expert pond repair services in Litchfield Park. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, litchfield park pond repair, pond repair litchfield park"
        canonical="https://utahwatergardens.com/pond-repair-litchfield-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Litchfield Park",
          "description": "Professional pond repair services in Litchfield Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Litchfield Park"
        subtitle="Professional pond services for Pond Repair Services in Litchfield Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Litchfield Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Litchfield Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Litchfield Park Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Litchfield Park Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Litchfield Park Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Litchfield Park Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLitchfieldParkPage;