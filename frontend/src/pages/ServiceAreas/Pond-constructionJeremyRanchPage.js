...
const Pond-constructionJeremyRanchPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Jeremy Ranch | Professional Pond Construction Services"
        description="Expert pond construction services in Jeremy Ranch. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, jeremy ranch pond construction, pond construction jeremy ranch"
        canonical="https://utahwatergardens.com/pond-construction-jeremy-ranch"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Jeremy Ranch",
          "description": "Professional pond construction services in Jeremy Ranch",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Jeremy Ranch"
        subtitle="Professional pond services for Pond Construction Services in Jeremy Ranch and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Jeremy Ranch"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Jeremy Ranch</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jeremy Ranch Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jeremy Ranch Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jeremy Ranch Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jeremy Ranch Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionJeremyRanchPage;