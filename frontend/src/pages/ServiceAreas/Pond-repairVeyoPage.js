...
const Pond-repairVeyoPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Veyo | Professional Pond Repair Services"
        description="Expert pond repair services in Veyo. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, veyo pond repair, pond repair veyo"
        canonical="https://utahwatergardens.com/pond-repair-veyo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Veyo",
          "description": "Professional pond repair services in Veyo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Veyo"
        subtitle="Professional pond services for Pond Repair Services in Veyo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Veyo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Veyo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Veyo Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Veyo Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Veyo Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Veyo Customers Say About Our Pond Repair</h2>
...
export default Pond-repairVeyoPage;