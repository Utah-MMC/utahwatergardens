...
const Pond-constructionWestHavenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction West Haven | Professional Pond Construction Services"
        description="Expert pond construction services in West Haven. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, west haven pond construction, pond construction west haven"
        canonical="https://utahwatergardens.com/pond-construction-west-haven"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services West Haven",
          "description": "Professional pond construction services in West Haven",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in West Haven"
        subtitle="Professional pond services for Pond Construction Services in West Haven and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in West Haven"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in West Haven</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Haven Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Haven Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Haven Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Haven Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionWestHavenPage;