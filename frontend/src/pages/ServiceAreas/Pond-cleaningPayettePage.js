...
const Pond-cleaningPayettePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Payette | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Payette. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, payette pond cleaning, pond cleaning payette"
        canonical="https://utahwatergardens.com/pond-cleaning-payette"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Payette",
          "description": "Professional pond cleaning services in Payette",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Payette"
        subtitle="Professional pond services for Pond Cleaning Services in Payette and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Payette"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Payette</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Payette Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Payette Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Payette Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Payette Customers Say About Our Pond Cleaning</h2>
