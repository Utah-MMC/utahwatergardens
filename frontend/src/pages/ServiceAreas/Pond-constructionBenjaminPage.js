...
const Pond-constructionBenjaminPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Benjamin | Professional Pond Construction Services"
        description="Expert pond construction services in Benjamin. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, benjamin pond construction, pond construction benjamin"
        canonical="https://utahwatergardens.com/pond-construction-benjamin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Benjamin",
          "description": "Professional pond construction services in Benjamin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Benjamin"
        subtitle="Professional pond services for Pond Construction Services in Benjamin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Benjamin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Benjamin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Benjamin Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Benjamin Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Benjamin Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Benjamin Customers Say About Our Pond Construction</h2>
