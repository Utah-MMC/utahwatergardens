...
const Pond-cleaningBasinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Basin | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Basin. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, basin pond cleaning, pond cleaning basin"
        canonical="https://utahwatergardens.com/pond-cleaning-basin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Basin",
          "description": "Professional pond cleaning services in Basin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Basin"
        subtitle="Professional pond services for Pond Cleaning Services in Basin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Basin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Basin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Basin Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Basin Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Basin Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Basin Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningBasinPage;