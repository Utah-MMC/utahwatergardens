  ...
  return (
    <div className="service-area-page">
      <PageHero 
        ...
        subtitle="Professional pond services for Ogden and surrounding Davis County areas"
      ...
      <div className="container">
        ...
        >
          <h2>Ready to Get Started in Ogden?</h2>
          <p>Contact us today for a free consultation and quote on your Ogden pond project.</p>
