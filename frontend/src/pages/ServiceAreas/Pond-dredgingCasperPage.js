...
const Pond-dredgingCasperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Casper | Professional Pond Dredging Services"
        description="Expert pond dredging services in Casper. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, casper pond dredging, pond dredging casper"
        canonical="https://utahwatergardens.com/pond-dredging-casper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Casper",
          "description": "Professional pond dredging services in Casper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Casper"
        subtitle="Professional pond services for Pond Dredging Services in Casper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Casper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Casper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Casper Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Casper Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Casper Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Casper Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCasperPage;