...
const Water-feature-designPinedalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Water Feature Design Pinedale | Professional Water Feature Design Services"
        description="Expert water feature design services in Pinedale. Custom water feature design and installation services Licensed & insured. Call (801) 590-8516."
        keywords="water feature design, waterfall design, fountain design, custom water features, pinedale water feature design, water feature design pinedale"
        canonical="https://utahwatergardens.com/water-feature-design-pinedale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Water Feature Design Services Pinedale",
          "description": "Professional water feature design services in Pinedale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Water Feature Design Services in Pinedale"
        subtitle="Professional pond services for Water Feature Design Services in Pinedale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Water Feature Design Services in Pinedale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Water Feature Design in Pinedale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pinedale Water Feature Design?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3021.9346!2d-111.8910!3d40.7608!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8752f38c0c0c0c0c%3A0x0c0c0c0c0c0c0c0c!2sPinedale!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen=""
                  ...
                  title="Pinedale Water Feature Design Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pinedale Water Feature Design Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pinedale Customers Say About Our Water Feature Design</h2>
...
export default Water-feature-designPinedalePage;