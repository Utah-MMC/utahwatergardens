...
const Pond-cleaningHeyburnPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Heyburn | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Heyburn. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, heyburn pond cleaning, pond cleaning heyburn"
        canonical="https://utahwatergardens.com/pond-cleaning-heyburn"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Heyburn",
          "description": "Professional pond cleaning services in Heyburn",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Heyburn"
        subtitle="Professional pond services for Pond Cleaning Services in Heyburn and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Heyburn"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Heyburn</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Heyburn Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Heyburn Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Heyburn Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Heyburn Customers Say About Our Pond Cleaning</h2>
