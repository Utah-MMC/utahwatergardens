...
const Pond-cleaningPeoriaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Peoria | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Peoria. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, peoria pond cleaning, pond cleaning peoria"
        canonical="https://utahwatergardens.com/pond-cleaning-peoria"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Peoria",
          "description": "Professional pond cleaning services in Peoria",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Peoria"
        subtitle="Professional pond services for Pond Cleaning Services in Peoria and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Peoria"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Peoria</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Peoria Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Peoria Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Peoria Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Peoria Customers Say About Our Pond Cleaning</h2>
