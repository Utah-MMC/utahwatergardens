...
const Pond-constructionBrighamCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Brigham City | Professional Pond Construction Services"
        description="Expert pond construction services in Brigham City. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, brigham city pond construction, pond construction brigham city"
        canonical="https://utahwatergardens.com/pond-construction-brigham-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Brigham City",
          "description": "Professional pond construction services in Brigham City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Brigham City"
        subtitle="Professional pond services for Pond Construction Services in Brigham City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Brigham City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Brigham City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Brigham City Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Brigham City Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Brigham City Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Brigham City Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionBrighamCityPage;