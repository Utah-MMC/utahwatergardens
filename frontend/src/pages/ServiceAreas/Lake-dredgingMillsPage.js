...
const Lake-dredgingMillsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Mills | Professional Lake Dredging Services"
        description="Expert lake dredging services in Mills. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, mills lake dredging, lake dredging mills"
        canonical="https://utahwatergardens.com/lake-dredging-mills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Mills",
          "description": "Professional lake dredging services in Mills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Mills"
        subtitle="Professional pond services for Lake Dredging Services in Mills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Mills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Mills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mills Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mills Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mills Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mills Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMillsPage;