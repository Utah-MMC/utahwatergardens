...
const Lake-dredgingSouthSaltLakePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging South Salt Lake | Professional Lake Dredging Services"
        description="Expert lake dredging services in South Salt Lake. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, south salt lake lake dredging, lake dredging south salt lake"
        canonical="https://utahwatergardens.com/lake-dredging-south-salt-lake"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services South Salt Lake",
          "description": "Professional lake dredging services in South Salt Lake",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in South Salt Lake"
        subtitle="Professional pond services for Lake Dredging Services in South Salt Lake and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in South Salt Lake"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in South Salt Lake</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Salt Lake Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Salt Lake Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Salt Lake Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Salt Lake Customers Say About Our Lake Dredging</h2>
