...
const Pond-cleaningSigurdPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Sigurd | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Sigurd. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, sigurd pond cleaning, pond cleaning sigurd"
        canonical="https://utahwatergardens.com/pond-cleaning-sigurd"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Sigurd",
          "description": "Professional pond cleaning services in Sigurd",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Sigurd"
        subtitle="Professional pond services for Pond Cleaning Services in Sigurd and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Sigurd"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Sigurd</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sigurd Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sigurd Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sigurd Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sigurd Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSigurdPage;