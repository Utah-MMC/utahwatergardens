...
const Pond-dredgingWestWendoverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging West Wendover | Professional Pond Dredging Services"
        description="Expert pond dredging services in West Wendover. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, west wendover pond dredging, pond dredging west wendover"
        canonical="https://utahwatergardens.com/pond-dredging-west-wendover"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services West Wendover",
          "description": "Professional pond dredging services in West Wendover",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in West Wendover"
        subtitle="Professional pond services for Pond Dredging Services in West Wendover and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in West Wendover"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in West Wendover</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Wendover Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Wendover Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Wendover Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Wendover Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWestWendoverPage;