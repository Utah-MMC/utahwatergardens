...
const Lake-dredgingSunCityWestPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sun City West | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sun City West. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sun city west lake dredging, lake dredging sun city west"
        canonical="https://utahwatergardens.com/lake-dredging-sun-city-west"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sun City West",
          "description": "Professional lake dredging services in Sun City West",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sun City West"
        subtitle="Professional pond services for Lake Dredging Services in Sun City West and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sun City West"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sun City West</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sun City West Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sun City West Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sun City West Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sun City West Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSunCityWestPage;