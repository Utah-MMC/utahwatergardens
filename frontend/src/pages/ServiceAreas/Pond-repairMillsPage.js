...
const Pond-repairMillsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Mills | Professional Pond Repair Services"
        description="Expert pond repair services in Mills. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, mills pond repair, pond repair mills"
        canonical="https://utahwatergardens.com/pond-repair-mills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Mills",
          "description": "Professional pond repair services in Mills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Mills"
        subtitle="Professional pond services for Pond Repair Services in Mills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Mills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Mills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mills Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mills Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mills Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mills Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMillsPage;