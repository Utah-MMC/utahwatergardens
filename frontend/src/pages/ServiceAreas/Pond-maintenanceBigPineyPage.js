...
const Pond-maintenanceBigPineyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Big Piney | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Big Piney. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, big piney pond maintenance, pond maintenance big piney"
        canonical="https://utahwatergardens.com/pond-maintenance-big-piney"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Big Piney",
          "description": "Professional pond maintenance services in Big Piney",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Big Piney"
        subtitle="Professional pond services for Pond Maintenance Services in Big Piney and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Big Piney"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Big Piney</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Big Piney Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Big Piney Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Big Piney Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Big Piney Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceBigPineyPage;