...
const Pond-constructionSouthOgdenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction South Ogden | Professional Pond Construction Services"
        description="Expert pond construction services in South Ogden. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, south ogden pond construction, pond construction south ogden"
        canonical="https://utahwatergardens.com/pond-construction-south-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services South Ogden",
          "description": "Professional pond construction services in South Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in South Ogden"
        subtitle="Professional pond services for Pond Construction Services in South Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in South Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in South Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Ogden Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Ogden Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Ogden Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Ogden Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSouthOgdenPage;