...
const Lake-dredgingPaulPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Paul | Professional Lake Dredging Services"
        description="Expert lake dredging services in Paul. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, paul lake dredging, lake dredging paul"
        canonical="https://utahwatergardens.com/lake-dredging-paul"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Paul",
          "description": "Professional lake dredging services in Paul",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Paul"
        subtitle="Professional pond services for Lake Dredging Services in Paul and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Paul"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Paul</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paul Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paul Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paul Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paul Customers Say About Our Lake Dredging</h2>
