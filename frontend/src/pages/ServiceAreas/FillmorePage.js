...
const FillmorePage = () => {
  const services = [
    {
      ...
      description: 'Custom pond design and construction services for Fillmore properties',
      features: ['Custom Design', 'Professional Installation', 'Quality Materials', 'Local Expertise']
    },
    {
      name: 'Pond Maintenance & Care',
      description: 'Regular maintenance to keep your Fillmore pond healthy and beautiful',
    ...
    },
    {
      ...
      description: 'Repair and maintenance of pond equipment in Fillmore',
  ...
  const testimonials = [
    {
      text: "Utah Water Gardens created an amazing pond for our Fillmore home. Their expertise in central Utah's climate is impressive.",
      author: "Mark S., Fillmore"
    },
    {
      text: "Professional service and beautiful results. They understand what works in Fillmore's environment and deliver every time.",
      author: "Susan P., Fillmore"
    }
  ];
    ...
    <div className="service-area-page">
      ...
      <div className="container">
        <section className="location-overview">
          <h2>Pond Services in Fillmore</h2>
          <p>
            Utah Water Gardens proudly serves Fillmore and surrounding Millard County areas with comprehensive pond and water feature services. 
            Our local expertise in Fillmore's unique climate and water conditions ensures your pond thrives year-round in this beautiful historic community.
          </p>
          <div className="location-details">
            <div className="location-info">
              <h3>Why Choose Us for Fillmore Pond Services?</h3>
              <ul>
                <li>Local expertise in Fillmore's climate and water conditions</li>
                <li>Over 25 years of experience serving the Fillmore area</li>
                <li>Licensed and insured for all Fillmore projects</li>
            ...
            <div className="location-map">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3021.9346!2d-111.8910!3d40.7608!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8752f38c0c0c0c0c%3A0x0c0c0c0c0c0c0c0c!2sFillmore%2C%20UT!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus"
                width="100%"
                height="300"
                style={{ border: 0 }}
                allowFullScreen=""
        ...
        <section className="services-section">
          <h2>Our Fillmore Pond Services</h2>
        ...
        <section className="testimonials-section">
          <h2>What Fillmore Customers Say</h2>
        ...
        >
          <h2>Ready to Get Started in Fillmore?</h2>
          <p>Contact us today for a free consultation and quote on your Fillmore pond project.</p>
