...
const Lake-dredgingSandyValleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Sandy Valley | Professional Lake Dredging Services"
        description="Expert lake dredging services in Sandy Valley. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, sandy valley lake dredging, lake dredging sandy valley"
        canonical="https://utahwatergardens.com/lake-dredging-sandy-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Sandy Valley",
          "description": "Professional lake dredging services in Sandy Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Sandy Valley"
        subtitle="Professional pond services for Lake Dredging Services in Sandy Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Sandy Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Sandy Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sandy Valley Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sandy Valley Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sandy Valley Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sandy Valley Customers Say About Our Lake Dredging</h2>
