...
const Pond-cleaningAnthemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Anthem | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Anthem. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, anthem pond cleaning, pond cleaning anthem"
        canonical="https://utahwatergardens.com/pond-cleaning-anthem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Anthem",
          "description": "Professional pond cleaning services in Anthem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Anthem"
        subtitle="Professional pond services for Pond Cleaning Services in Anthem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Anthem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Anthem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Anthem Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Anthem Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Anthem Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Anthem Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningAnthemPage;