...
const Pond-maintenanceWestWendoverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance West Wendover | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in West Wendover. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, west wendover pond maintenance, pond maintenance west wendover"
        canonical="https://utahwatergardens.com/pond-maintenance-west-wendover"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services West Wendover",
          "description": "Professional pond maintenance services in West Wendover",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in West Wendover"
        subtitle="Professional pond services for Pond Maintenance Services in West Wendover and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in West Wendover"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in West Wendover</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Wendover Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Wendover Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Wendover Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Wendover Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceWestWendoverPage;