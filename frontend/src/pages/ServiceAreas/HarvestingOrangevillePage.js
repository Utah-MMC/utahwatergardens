...
const HarvestingOrangevillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Orangeville | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Orangeville. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, orangeville aquatic plant harvesting, aquatic plant harvesting orangeville"
        canonical="https://utahwatergardens.com/harvesting-orangeville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Orangeville",
          "description": "Professional aquatic plant harvesting services in Orangeville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Orangeville"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Orangeville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Orangeville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Orangeville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Orangeville Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Orangeville Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Orangeville Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Orangeville Customers Say About Our Aquatic Plant Harvesting</h2>
