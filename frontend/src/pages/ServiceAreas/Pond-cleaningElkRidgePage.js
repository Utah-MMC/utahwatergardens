...
const Pond-cleaningElkRidgePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Elk Ridge | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Elk Ridge. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, elk ridge pond cleaning, pond cleaning elk ridge"
        canonical="https://utahwatergardens.com/pond-cleaning-elk-ridge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Elk Ridge",
          "description": "Professional pond cleaning services in Elk Ridge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Elk Ridge"
        subtitle="Professional pond services for Pond Cleaning Services in Elk Ridge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Elk Ridge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Elk Ridge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elk Ridge Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elk Ridge Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elk Ridge Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elk Ridge Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningElkRidgePage;