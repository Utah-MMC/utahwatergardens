...
const Pond-cleaningLovellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lovell | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lovell. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lovell pond cleaning, pond cleaning lovell"
        canonical="https://utahwatergardens.com/pond-cleaning-lovell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lovell",
          "description": "Professional pond cleaning services in Lovell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lovell"
        subtitle="Professional pond services for Pond Cleaning Services in Lovell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lovell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lovell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lovell Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lovell Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lovell Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lovell Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLovellPage;