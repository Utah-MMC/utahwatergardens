...
const Pond-repairYoungtownPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Youngtown | Professional Pond Repair Services"
        description="Expert pond repair services in Youngtown. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, youngtown pond repair, pond repair youngtown"
        canonical="https://utahwatergardens.com/pond-repair-youngtown"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Youngtown",
          "description": "Professional pond repair services in Youngtown",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Youngtown"
        subtitle="Professional pond services for Pond Repair Services in Youngtown and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Youngtown"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Youngtown</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Youngtown Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Youngtown Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Youngtown Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Youngtown Customers Say About Our Pond Repair</h2>
...
export default Pond-repairYoungtownPage;