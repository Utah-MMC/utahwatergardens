...
const Pond-dredgingJacksonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Jackson | Professional Pond Dredging Services"
        description="Expert pond dredging services in Jackson. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, jackson pond dredging, pond dredging jackson"
        canonical="https://utahwatergardens.com/pond-dredging-jackson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Jackson",
          "description": "Professional pond dredging services in Jackson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Jackson"
        subtitle="Professional pond services for Pond Dredging Services in Jackson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Jackson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Jackson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jackson Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jackson Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jackson Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jackson Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingJacksonPage;