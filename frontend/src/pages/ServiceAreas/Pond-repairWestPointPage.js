...
const Pond-repairWestPointPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair West Point | Professional Pond Repair Services"
        description="Expert pond repair services in West Point. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, west point pond repair, pond repair west point"
        canonical="https://utahwatergardens.com/pond-repair-west-point"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services West Point",
          "description": "Professional pond repair services in West Point",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in West Point"
        subtitle="Professional pond services for Pond Repair Services in West Point and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in West Point"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in West Point</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Point Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Point Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Point Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Point Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWestPointPage;