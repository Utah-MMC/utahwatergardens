...
const Pond-cleaningSunrisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Sunrise | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Sunrise. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, sunrise pond cleaning, pond cleaning sunrise"
        canonical="https://utahwatergardens.com/pond-cleaning-sunrise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Sunrise",
          "description": "Professional pond cleaning services in Sunrise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Sunrise"
        subtitle="Professional pond services for Pond Cleaning Services in Sunrise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Sunrise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Sunrise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunrise Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunrise Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunrise Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunrise Customers Say About Our Pond Cleaning</h2>
