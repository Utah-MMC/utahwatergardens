...
const Pond-repairLeedsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Leeds | Professional Pond Repair Services"
        description="Expert pond repair services in Leeds. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, leeds pond repair, pond repair leeds"
        canonical="https://utahwatergardens.com/pond-repair-leeds"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Leeds",
          "description": "Professional pond repair services in Leeds",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Leeds"
        subtitle="Professional pond services for Pond Repair Services in Leeds and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Leeds"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Leeds</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Leeds Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Leeds Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Leeds Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Leeds Customers Say About Our Pond Repair</h2>
...
export default Pond-repairLeedsPage;