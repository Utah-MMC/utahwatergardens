...
const Pond-repairElyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Ely | Professional Pond Repair Services"
        description="Expert pond repair services in Ely. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, ely pond repair, pond repair ely"
        canonical="https://utahwatergardens.com/pond-repair-ely"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Ely",
          "description": "Professional pond repair services in Ely",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Ely"
        subtitle="Professional pond services for Pond Repair Services in Ely and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Ely"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Ely</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ely Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ely Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ely Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ely Customers Say About Our Pond Repair</h2>
...
export default Pond-repairElyPage;