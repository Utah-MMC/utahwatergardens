...
const Pond-repairDugwayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Dugway | Professional Pond Repair Services"
        description="Expert pond repair services in Dugway. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, dugway pond repair, pond repair dugway"
        canonical="https://utahwatergardens.com/pond-repair-dugway"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Dugway",
          "description": "Professional pond repair services in Dugway",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Dugway"
        subtitle="Professional pond services for Pond Repair Services in Dugway and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Dugway"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Dugway</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dugway Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dugway Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dugway Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dugway Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDugwayPage;