...
const Pond-cleaningGilaBendPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Gila Bend | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Gila Bend. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, gila bend pond cleaning, pond cleaning gila bend"
        canonical="https://utahwatergardens.com/pond-cleaning-gila-bend"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Gila Bend",
          "description": "Professional pond cleaning services in Gila Bend",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Gila Bend"
        subtitle="Professional pond services for Pond Cleaning Services in Gila Bend and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Gila Bend"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Gila Bend</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gila Bend Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gila Bend Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gila Bend Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gila Bend Customers Say About Our Pond Cleaning</h2>
