...
const Pond-cleaningParkCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Park City | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Park City. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, park city pond cleaning, pond cleaning park city"
        canonical="https://utahwatergardens.com/pond-cleaning-park-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Park City",
          "description": "Professional pond cleaning services in Park City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Park City"
        subtitle="Professional pond services for Pond Cleaning Services in Park City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Park City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Park City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Park City Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Park City Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Park City Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Park City Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningParkCityPage;