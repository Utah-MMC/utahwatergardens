...
const Lake-dredgingWapitiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Wapiti | Professional Lake Dredging Services"
        description="Expert lake dredging services in Wapiti. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, wapiti lake dredging, lake dredging wapiti"
        canonical="https://utahwatergardens.com/lake-dredging-wapiti"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Wapiti",
          "description": "Professional lake dredging services in Wapiti",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Wapiti"
        subtitle="Professional pond services for Lake Dredging Services in Wapiti and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Wapiti"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Wapiti</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wapiti Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wapiti Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wapiti Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wapiti Customers Say About Our Lake Dredging</h2>
