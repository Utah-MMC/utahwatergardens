...
const Pond-dredgingGardenCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Garden City | Professional Pond Dredging Services"
        description="Expert pond dredging services in Garden City. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, garden city pond dredging, pond dredging garden city"
        canonical="https://utahwatergardens.com/pond-dredging-garden-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Garden City",
          "description": "Professional pond dredging services in Garden City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Garden City"
        subtitle="Professional pond services for Pond Dredging Services in Garden City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Garden City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Garden City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Garden City Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Garden City Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Garden City Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Garden City Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingGardenCityPage;