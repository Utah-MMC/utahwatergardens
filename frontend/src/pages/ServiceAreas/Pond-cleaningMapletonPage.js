...
const Pond-cleaningMapletonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Mapleton | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Mapleton. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, mapleton pond cleaning, pond cleaning mapleton"
        canonical="https://utahwatergardens.com/pond-cleaning-mapleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Mapleton",
          "description": "Professional pond cleaning services in Mapleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Mapleton"
        subtitle="Professional pond services for Pond Cleaning Services in Mapleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Mapleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Mapleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mapleton Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mapleton Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mapleton Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mapleton Customers Say About Our Pond Cleaning</h2>
