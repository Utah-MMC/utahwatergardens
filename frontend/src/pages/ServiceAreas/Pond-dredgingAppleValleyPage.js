...
const Pond-dredgingAppleValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Apple Valley | Professional Pond Dredging Services"
        description="Expert pond dredging services in Apple Valley. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, apple valley pond dredging, pond dredging apple valley"
        canonical="https://utahwatergardens.com/pond-dredging-apple-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Apple Valley",
          "description": "Professional pond dredging services in Apple Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Apple Valley"
        subtitle="Professional pond services for Pond Dredging Services in Apple Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Apple Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Apple Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Apple Valley Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Apple Valley Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Apple Valley Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Apple Valley Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAppleValleyPage;