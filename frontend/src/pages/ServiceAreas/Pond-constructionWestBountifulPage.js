...
const Pond-constructionWestBountifulPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction West Bountiful | Professional Pond Construction Services"
        description="Expert pond construction services in West Bountiful. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, west bountiful pond construction, pond construction west bountiful"
        canonical="https://utahwatergardens.com/pond-construction-west-bountiful"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services West Bountiful",
          "description": "Professional pond construction services in West Bountiful",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in West Bountiful"
        subtitle="Professional pond services for Pond Construction Services in West Bountiful and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in West Bountiful"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in West Bountiful</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Bountiful Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Bountiful Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Bountiful Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Bountiful Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionWestBountifulPage;