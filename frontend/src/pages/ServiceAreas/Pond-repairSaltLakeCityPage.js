...
const Pond-repairSaltLakeCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Salt Lake City | Professional Pond Repair Services"
        description="Expert pond repair services in Salt Lake City. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, salt lake city pond repair, pond repair salt lake city"
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Professional pond repair services in Salt Lake City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        ...
        subtitle="Professional pond services for Pond Repair Services in Salt Lake City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Salt Lake City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="testimonials-section">
            <h2>What Salt Lake City Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSaltLakeCityPage;