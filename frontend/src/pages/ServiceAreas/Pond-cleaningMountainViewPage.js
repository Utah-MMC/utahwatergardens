...
const Pond-cleaningMountainViewPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Mountain View | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Mountain View. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, mountain view pond cleaning, pond cleaning mountain view"
        canonical="https://utahwatergardens.com/pond-cleaning-mountain-view"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Mountain View",
          "description": "Professional pond cleaning services in Mountain View",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Mountain View"
        subtitle="Professional pond services for Pond Cleaning Services in Mountain View and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Mountain View"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Mountain View</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mountain View Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mountain View Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mountain View Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mountain View Customers Say About Our Pond Cleaning</h2>
