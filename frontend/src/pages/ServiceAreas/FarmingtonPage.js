  ...
  return (
    <div className="service-area-page">
      <PageHero 
        ...
        subtitle="Professional pond services for Farmington and surrounding Davis County areas"
      ...
      <div className="container">
        ...
        >
          <h2>Ready to Get Started in Farmington?</h2>
          <p>Contact us today for a free consultation and quote on your Farmington pond project.</p>
