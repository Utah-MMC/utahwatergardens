...
const Pond-constructionMountCharlestonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Mount Charleston | Professional Pond Construction Services"
        description="Expert pond construction services in Mount Charleston. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, mount charleston pond construction, pond construction mount charleston"
        canonical="https://utahwatergardens.com/pond-construction-mount-charleston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Mount Charleston",
          "description": "Professional pond construction services in Mount Charleston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Mount Charleston"
        subtitle="Professional pond services for Pond Construction Services in Mount Charleston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Mount Charleston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Mount Charleston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mount Charleston Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mount Charleston Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mount Charleston Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mount Charleston Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionMountCharlestonPage;