...
const Lake-dredgingMarbletonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Marbleton | Professional Lake Dredging Services"
        description="Expert lake dredging services in Marbleton. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, marbleton lake dredging, lake dredging marbleton"
        canonical="https://utahwatergardens.com/lake-dredging-marbleton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Marbleton",
          "description": "Professional lake dredging services in Marbleton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Marbleton"
        subtitle="Professional pond services for Lake Dredging Services in Marbleton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Marbleton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Marbleton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Marbleton Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Marbleton Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Marbleton Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Marbleton Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingMarbletonPage;