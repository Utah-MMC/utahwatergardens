...
const Pond-repairMeridianPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Meridian | Professional Pond Repair Services"
        description="Expert pond repair services in Meridian. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, meridian pond repair, pond repair meridian"
        canonical="https://utahwatergardens.com/pond-repair-meridian"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Meridian",
          "description": "Professional pond repair services in Meridian",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Meridian"
        subtitle="Professional pond services for Pond Repair Services in Meridian and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Meridian"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Meridian</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Meridian Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Meridian Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Meridian Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Meridian Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMeridianPage;