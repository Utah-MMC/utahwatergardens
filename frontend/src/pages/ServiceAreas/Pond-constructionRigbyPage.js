...
const Pond-constructionRigbyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Rigby | Professional Pond Construction Services"
        description="Expert pond construction services in Rigby. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, rigby pond construction, pond construction rigby"
        canonical="https://utahwatergardens.com/pond-construction-rigby"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Rigby",
          "description": "Professional pond construction services in Rigby",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Rigby"
        subtitle="Professional pond services for Pond Construction Services in Rigby and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Rigby"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Rigby</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rigby Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rigby Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rigby Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rigby Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionRigbyPage;