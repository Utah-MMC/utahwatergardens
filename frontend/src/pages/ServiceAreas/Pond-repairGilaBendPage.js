...
const Pond-repairGilaBendPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Gila Bend | Professional Pond Repair Services"
        description="Expert pond repair services in Gila Bend. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, gila bend pond repair, pond repair gila bend"
        canonical="https://utahwatergardens.com/pond-repair-gila-bend"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Gila Bend",
          "description": "Professional pond repair services in Gila Bend",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Gila Bend"
        subtitle="Professional pond services for Pond Repair Services in Gila Bend and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Gila Bend"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Gila Bend</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Gila Bend Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Gila Bend Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Gila Bend Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Gila Bend Customers Say About Our Pond Repair</h2>
...
export default Pond-repairGilaBendPage;