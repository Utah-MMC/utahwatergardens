...
const Pond-maintenanceJeromePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Jerome | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Jerome. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, jerome pond maintenance, pond maintenance jerome"
        canonical="https://utahwatergardens.com/pond-maintenance-jerome"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Jerome",
          "description": "Professional pond maintenance services in Jerome",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Jerome"
        subtitle="Professional pond services for Pond Maintenance Services in Jerome and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Jerome"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Jerome</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jerome Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jerome Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jerome Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jerome Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceJeromePage;