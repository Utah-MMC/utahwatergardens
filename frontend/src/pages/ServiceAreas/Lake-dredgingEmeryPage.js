...
const Lake-dredgingEmeryPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Emery | Professional Lake Dredging Services"
        description="Expert lake dredging services in Emery. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, emery lake dredging, lake dredging emery"
        canonical="https://utahwatergardens.com/lake-dredging-emery"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Emery",
          "description": "Professional lake dredging services in Emery",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Emery"
        subtitle="Professional pond services for Lake Dredging Services in Emery and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Emery"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Emery</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Emery Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Emery Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Emery Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Emery Customers Say About Our Lake Dredging</h2>
