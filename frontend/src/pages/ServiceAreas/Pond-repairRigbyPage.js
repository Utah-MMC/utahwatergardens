...
const Pond-repairRigbyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Rigby | Professional Pond Repair Services"
        description="Expert pond repair services in Rigby. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, rigby pond repair, pond repair rigby"
        canonical="https://utahwatergardens.com/pond-repair-rigby"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Rigby",
          "description": "Professional pond repair services in Rigby",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Rigby"
        subtitle="Professional pond services for Pond Repair Services in Rigby and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Rigby"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Rigby</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rigby Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rigby Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rigby Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rigby Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRigbyPage;