...
const Pond-dredgingLymanPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Lyman | Professional Pond Dredging Services"
        description="Expert pond dredging services in Lyman. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, lyman pond dredging, pond dredging lyman"
        canonical="https://utahwatergardens.com/pond-dredging-lyman"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Lyman",
          "description": "Professional pond dredging services in Lyman",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Lyman"
        subtitle="Professional pond services for Pond Dredging Services in Lyman and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Lyman"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Lyman</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lyman Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lyman Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lyman Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lyman Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLymanPage;