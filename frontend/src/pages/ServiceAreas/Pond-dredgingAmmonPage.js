...
const Pond-dredgingAmmonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Ammon | Professional Pond Dredging Services"
        description="Expert pond dredging services in Ammon. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, ammon pond dredging, pond dredging ammon"
        canonical="https://utahwatergardens.com/pond-dredging-ammon"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Ammon",
          "description": "Professional pond dredging services in Ammon",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Ammon"
        subtitle="Professional pond services for Pond Dredging Services in Ammon and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Ammon"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Ammon</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ammon Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ammon Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ammon Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ammon Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingAmmonPage;