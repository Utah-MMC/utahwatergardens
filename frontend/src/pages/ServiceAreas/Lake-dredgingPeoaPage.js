...
const Lake-dredgingPeoaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Peoa | Professional Lake Dredging Services"
        description="Expert lake dredging services in Peoa. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, peoa lake dredging, lake dredging peoa"
        canonical="https://utahwatergardens.com/lake-dredging-peoa"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Peoa",
          "description": "Professional lake dredging services in Peoa",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Peoa"
        subtitle="Professional pond services for Lake Dredging Services in Peoa and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Peoa"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Peoa</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Peoa Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Peoa Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Peoa Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Peoa Customers Say About Our Lake Dredging</h2>
