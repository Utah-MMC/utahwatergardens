...
const Lake-dredgingHansenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Hansen | Professional Lake Dredging Services"
        description="Expert lake dredging services in Hansen. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, hansen lake dredging, lake dredging hansen"
        canonical="https://utahwatergardens.com/lake-dredging-hansen"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Hansen",
          "description": "Professional lake dredging services in Hansen",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Hansen"
        subtitle="Professional pond services for Lake Dredging Services in Hansen and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Hansen"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Hansen</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hansen Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hansen Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hansen Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hansen Customers Say About Our Lake Dredging</h2>
