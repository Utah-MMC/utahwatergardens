...
const Pond-dredgingVenicePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Venice | Professional Pond Dredging Services"
        description="Expert pond dredging services in Venice. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, venice pond dredging, pond dredging venice"
        canonical="https://utahwatergardens.com/pond-dredging-venice"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Venice",
          "description": "Professional pond dredging services in Venice",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Venice"
        subtitle="Professional pond services for Pond Dredging Services in Venice and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Venice"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Venice</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Venice Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Venice Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Venice Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Venice Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingVenicePage;