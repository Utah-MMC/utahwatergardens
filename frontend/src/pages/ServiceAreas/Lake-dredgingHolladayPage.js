...
const Lake-dredgingHolladayPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Holladay | Professional Lake Dredging Services"
        description="Expert lake dredging services in Holladay. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, holladay lake dredging, lake dredging holladay"
        canonical="https://utahwatergardens.com/lake-dredging-holladay"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Holladay",
          "description": "Professional lake dredging services in Holladay",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Holladay"
        subtitle="Professional pond services for Lake Dredging Services in Holladay and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Holladay"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Holladay</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Holladay Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Holladay Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Holladay Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Holladay Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingHolladayPage;