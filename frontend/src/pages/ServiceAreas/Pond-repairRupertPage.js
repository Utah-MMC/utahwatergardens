...
const Pond-repairRupertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Rupert | Professional Pond Repair Services"
        description="Expert pond repair services in Rupert. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, rupert pond repair, pond repair rupert"
        canonical="https://utahwatergardens.com/pond-repair-rupert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Rupert",
          "description": "Professional pond repair services in Rupert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Rupert"
        subtitle="Professional pond services for Pond Repair Services in Rupert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Rupert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Rupert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rupert Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rupert Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rupert Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rupert Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRupertPage;