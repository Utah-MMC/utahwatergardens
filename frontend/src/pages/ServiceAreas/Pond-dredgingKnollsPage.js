...
const Pond-dredgingKnollsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Knolls | Professional Pond Dredging Services"
        description="Expert pond dredging services in Knolls. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, knolls pond dredging, pond dredging knolls"
        canonical="https://utahwatergardens.com/pond-dredging-knolls"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Knolls",
          "description": "Professional pond dredging services in Knolls",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Knolls"
        subtitle="Professional pond services for Pond Dredging Services in Knolls and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Knolls"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Knolls</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Knolls Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Knolls Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Knolls Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Knolls Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingKnollsPage;