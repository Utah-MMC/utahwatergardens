...
const Lake-dredgingMindenPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Minden | Professional Lake Dredging Services"
        description="Expert lake dredging services in Minden. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, minden lake dredging, lake dredging minden"
        canonical="https://utahwatergardens.com/lake-dredging-minden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Minden",
          "description": "Professional lake dredging services in Minden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Minden"
        subtitle="Professional pond services for Lake Dredging Services in Minden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Minden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Minden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Minden Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Minden Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Minden Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Minden Customers Say About Our Lake Dredging</h2>
