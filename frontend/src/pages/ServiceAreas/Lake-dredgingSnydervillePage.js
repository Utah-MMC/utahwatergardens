...
const Lake-dredgingSnydervillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Snyderville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Snyderville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, snyderville lake dredging, lake dredging snyderville"
        canonical="https://utahwatergardens.com/lake-dredging-snyderville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Snyderville",
          "description": "Professional lake dredging services in Snyderville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Snyderville"
        subtitle="Professional pond services for Lake Dredging Services in Snyderville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Snyderville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Snyderville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Snyderville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Snyderville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Snyderville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Snyderville Customers Say About Our Lake Dredging</h2>
