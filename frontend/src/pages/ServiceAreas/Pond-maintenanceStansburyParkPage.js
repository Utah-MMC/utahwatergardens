...
const Pond-maintenanceStansburyParkPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Stansbury Park | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Stansbury Park. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, stansbury park pond maintenance, pond maintenance stansbury park"
        canonical="https://utahwatergardens.com/pond-maintenance-stansbury-park"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Stansbury Park",
          "description": "Professional pond maintenance services in Stansbury Park",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Stansbury Park"
        subtitle="Professional pond services for Pond Maintenance Services in Stansbury Park and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Stansbury Park"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Stansbury Park</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Stansbury Park Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Stansbury Park Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Stansbury Park Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Stansbury Park Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceStansburyParkPage;