...
const Pond-repairRichmondPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Richmond | Professional Pond Repair Services"
        description="Expert pond repair services in Richmond. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, richmond pond repair, pond repair richmond"
        canonical="https://utahwatergardens.com/pond-repair-richmond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Richmond",
          "description": "Professional pond repair services in Richmond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Richmond"
        subtitle="Professional pond services for Pond Repair Services in Richmond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Richmond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Richmond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Richmond Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Richmond Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Richmond Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Richmond Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRichmondPage;