...
const Pond-cleaningClevelandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Cleveland | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Cleveland. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, cleveland pond cleaning, pond cleaning cleveland"
        canonical="https://utahwatergardens.com/pond-cleaning-cleveland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Cleveland",
          "description": "Professional pond cleaning services in Cleveland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Cleveland"
        subtitle="Professional pond services for Pond Cleaning Services in Cleveland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Cleveland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Cleveland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cleveland Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cleveland Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cleveland Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cleveland Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningClevelandPage;