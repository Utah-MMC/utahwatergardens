...
const Lake-dredgingKunaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Kuna | Professional Lake Dredging Services"
        description="Expert lake dredging services in Kuna. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, kuna lake dredging, lake dredging kuna"
        canonical="https://utahwatergardens.com/lake-dredging-kuna"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Kuna",
          "description": "Professional lake dredging services in Kuna",
          "provider": {
            "@type": "LocalBusiness",
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Kuna</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kuna Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kuna Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kuna Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kuna Customers Say About Our Lake Dredging</h2>
