...
const Pond-cleaningHuntleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Huntley | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Huntley. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, huntley pond cleaning, pond cleaning huntley"
        canonical="https://utahwatergardens.com/pond-cleaning-huntley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Huntley",
          "description": "Professional pond cleaning services in Huntley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Huntley"
        subtitle="Professional pond services for Pond Cleaning Services in Huntley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Huntley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Huntley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntley Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntley Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntley Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntley Customers Say About Our Pond Cleaning</h2>
