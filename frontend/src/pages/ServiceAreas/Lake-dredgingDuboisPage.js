...
const Lake-dredgingDuboisPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Dubois | Professional Lake Dredging Services"
        description="Expert lake dredging services in Dubois. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, dubois lake dredging, lake dredging dubois"
        canonical="https://utahwatergardens.com/lake-dredging-dubois"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Dubois",
          "description": "Professional lake dredging services in Dubois",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Dubois"
        subtitle="Professional pond services for Lake Dredging Services in Dubois and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Dubois"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Dubois</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dubois Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dubois Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dubois Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dubois Customers Say About Our Lake Dredging</h2>
