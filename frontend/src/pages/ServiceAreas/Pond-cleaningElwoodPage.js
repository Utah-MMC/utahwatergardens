...
const Pond-cleaningElwoodPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Elwood | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Elwood. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, elwood pond cleaning, pond cleaning elwood"
        canonical="https://utahwatergardens.com/pond-cleaning-elwood"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Elwood",
          "description": "Professional pond cleaning services in Elwood",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Elwood"
        subtitle="Professional pond services for Pond Cleaning Services in Elwood and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Elwood"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Elwood</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elwood Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elwood Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elwood Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elwood Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningElwoodPage;