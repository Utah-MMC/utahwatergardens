...
const Pond-repairSantaClaraPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Santa Clara | Professional Pond Repair Services"
        description="Expert pond repair services in Santa Clara. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, santa clara pond repair, pond repair santa clara"
        canonical="https://utahwatergardens.com/pond-repair-santa-clara"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Santa Clara",
          "description": "Professional pond repair services in Santa Clara",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Santa Clara"
        subtitle="Professional pond services for Pond Repair Services in Santa Clara and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Santa Clara"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Santa Clara</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Santa Clara Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Santa Clara Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Santa Clara Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Santa Clara Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSantaClaraPage;