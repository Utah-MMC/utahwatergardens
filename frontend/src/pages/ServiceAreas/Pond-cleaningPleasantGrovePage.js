...
const Pond-cleaningPleasantGrovePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Pleasant Grove | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Pleasant Grove. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, pleasant grove pond cleaning, pond cleaning pleasant grove"
        canonical="https://utahwatergardens.com/pond-cleaning-pleasant-grove"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Pleasant Grove",
          "description": "Professional pond cleaning services in Pleasant Grove",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Pleasant Grove"
        subtitle="Professional pond services for Pond Cleaning Services in Pleasant Grove and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Pleasant Grove"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Pleasant Grove</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pleasant Grove Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pleasant Grove Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pleasant Grove Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pleasant Grove Customers Say About Our Pond Cleaning</h2>
