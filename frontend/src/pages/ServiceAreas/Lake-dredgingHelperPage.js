...
const Lake-dredgingHelperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Helper | Professional Lake Dredging Services"
        description="Expert lake dredging services in Helper. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, helper lake dredging, lake dredging helper"
        canonical="https://utahwatergardens.com/lake-dredging-helper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Helper",
          "description": "Professional lake dredging services in Helper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Helper"
        subtitle="Professional pond services for Lake Dredging Services in Helper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Helper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Helper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Helper Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Helper Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Helper Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Helper Customers Say About Our Lake Dredging</h2>
