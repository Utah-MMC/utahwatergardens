...
const Pond-repairAustinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Austin | Professional Pond Repair Services"
        description="Expert pond repair services in Austin. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, austin pond repair, pond repair austin"
        canonical="https://utahwatergardens.com/pond-repair-austin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Austin",
          "description": "Professional pond repair services in Austin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Austin"
        subtitle="Professional pond services for Pond Repair Services in Austin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Austin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Austin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Austin Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Austin Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Austin Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Austin Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAustinPage;