...
const Pond-cleaningLaVerkinPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning La Verkin | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in La Verkin. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, la verkin pond cleaning, pond cleaning la verkin"
        canonical="https://utahwatergardens.com/pond-cleaning-la-verkin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services La Verkin",
          "description": "Professional pond cleaning services in La Verkin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in La Verkin"
        subtitle="Professional pond services for Pond Cleaning Services in La Verkin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in La Verkin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in La Verkin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Verkin Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Verkin Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Verkin Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Verkin Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLaVerkinPage;