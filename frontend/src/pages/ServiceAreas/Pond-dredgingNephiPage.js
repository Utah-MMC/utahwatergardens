...
const Pond-dredgingNephiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Nephi | Professional Pond Dredging Services"
        description="Expert pond dredging services in Nephi. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, nephi pond dredging, pond dredging nephi"
        canonical="https://utahwatergardens.com/pond-dredging-nephi"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Nephi",
          "description": "Professional pond dredging services in Nephi",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Nephi"
        subtitle="Professional pond services for Pond Dredging Services in Nephi and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Nephi"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Nephi</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nephi Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nephi Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nephi Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nephi Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingNephiPage;