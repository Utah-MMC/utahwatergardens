...
const Lake-dredgingAltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Alta | Professional Lake Dredging Services"
        description="Expert lake dredging services in Alta. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, alta lake dredging, lake dredging alta"
        canonical="https://utahwatergardens.com/lake-dredging-alta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Alta",
          "description": "Professional lake dredging services in Alta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Alta"
        subtitle="Professional pond services for Lake Dredging Services in Alta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Alta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Alta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alta Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alta Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alta Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alta Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAltaPage;