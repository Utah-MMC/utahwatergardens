...
const Pond-cleaningFrancisPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Francis | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Francis. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, francis pond cleaning, pond cleaning francis"
        canonical="https://utahwatergardens.com/pond-cleaning-francis"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Francis",
          "description": "Professional pond cleaning services in Francis",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Francis"
        subtitle="Professional pond services for Pond Cleaning Services in Francis and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Francis"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Francis</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Francis Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Francis Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Francis Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Francis Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningFrancisPage;