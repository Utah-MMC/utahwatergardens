...
const Pond-dredgingSt.GeorgePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging St. George | Professional Pond Dredging Services"
        description="Expert pond dredging services in St. George. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, st. george pond dredging, pond dredging st. george"
        canonical="https://utahwatergardens.com/pond-dredging-st.-george"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services St. George",
          "description": "Professional pond dredging services in St. George",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in St. George"
        subtitle="Professional pond services for Pond Dredging Services in St. George and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in St. George"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in St. George</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. George Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. George Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. George Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. George Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSt.GeorgePage;