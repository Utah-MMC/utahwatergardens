...
const Pond-maintenanceSouthJordanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance South Jordan | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in South Jordan. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, south jordan pond maintenance, pond maintenance south jordan"
        canonical="https://utahwatergardens.com/pond-maintenance-south-jordan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services South Jordan",
          "description": "Professional pond maintenance services in South Jordan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in South Jordan"
        subtitle="Professional pond services for Pond Maintenance Services in South Jordan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in South Jordan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in South Jordan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Jordan Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Jordan Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Jordan Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Jordan Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSouthJordanPage;