...
const Pond-repairPrescottValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Prescott Valley | Professional Pond Repair Services"
        description="Expert pond repair services in Prescott Valley. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, prescott valley pond repair, pond repair prescott valley"
        canonical="https://utahwatergardens.com/pond-repair-prescott-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Prescott Valley",
          "description": "Professional pond repair services in Prescott Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Prescott Valley"
        subtitle="Professional pond services for Pond Repair Services in Prescott Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Prescott Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Prescott Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Prescott Valley Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Prescott Valley Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Prescott Valley Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Prescott Valley Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPrescottValleyPage;