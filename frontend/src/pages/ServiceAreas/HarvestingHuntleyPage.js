...
const HarvestingHuntleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Huntley | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Huntley. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, huntley aquatic plant harvesting, aquatic plant harvesting huntley"
        canonical="https://utahwatergardens.com/harvesting-huntley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Huntley",
          "description": "Professional aquatic plant harvesting services in Huntley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Huntley"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Huntley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Huntley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Huntley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Huntley Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Huntley Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Huntley Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Huntley Customers Say About Our Aquatic Plant Harvesting</h2>
