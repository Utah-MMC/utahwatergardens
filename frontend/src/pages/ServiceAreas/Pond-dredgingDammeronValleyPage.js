...
const Pond-dredgingDammeronValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Dammeron Valley | Professional Pond Dredging Services"
        description="Expert pond dredging services in Dammeron Valley. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, dammeron valley pond dredging, pond dredging dammeron valley"
        canonical="https://utahwatergardens.com/pond-dredging-dammeron-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Dammeron Valley",
          "description": "Professional pond dredging services in Dammeron Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Dammeron Valley"
        subtitle="Professional pond services for Pond Dredging Services in Dammeron Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Dammeron Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Dammeron Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dammeron Valley Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dammeron Valley Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dammeron Valley Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dammeron Valley Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingDammeronValleyPage;