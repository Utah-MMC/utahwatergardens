...
const Pond-repairCorinnePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Corinne | Professional Pond Repair Services"
        description="Expert pond repair services in Corinne. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, corinne pond repair, pond repair corinne"
        canonical="https://utahwatergardens.com/pond-repair-corinne"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Corinne",
          "description": "Professional pond repair services in Corinne",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Corinne"
        subtitle="Professional pond services for Pond Repair Services in Corinne and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Corinne"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Corinne</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Corinne Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Corinne Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Corinne Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Corinne Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCorinnePage;