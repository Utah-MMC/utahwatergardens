...
const Pond-repairEnochPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Enoch | Professional Pond Repair Services"
        description="Expert pond repair services in Enoch. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, enoch pond repair, pond repair enoch"
        canonical="https://utahwatergardens.com/pond-repair-enoch"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Enoch",
          "description": "Professional pond repair services in Enoch",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Enoch"
        subtitle="Professional pond services for Pond Repair Services in Enoch and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Enoch"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Enoch</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Enoch Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Enoch Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Enoch Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Enoch Customers Say About Our Pond Repair</h2>
...
export default Pond-repairEnochPage;