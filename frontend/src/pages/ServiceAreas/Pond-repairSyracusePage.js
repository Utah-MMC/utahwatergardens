...
const Pond-repairSyracusePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Syracuse | Professional Pond Repair Services"
        description="Expert pond repair services in Syracuse. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, syracuse pond repair, pond repair syracuse"
        canonical="https://utahwatergardens.com/pond-repair-syracuse"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Syracuse",
          "description": "Professional pond repair services in Syracuse",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Syracuse"
        subtitle="Professional pond services for Pond Repair Services in Syracuse and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Syracuse"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Syracuse</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Syracuse Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Syracuse Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Syracuse Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Syracuse Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSyracusePage;