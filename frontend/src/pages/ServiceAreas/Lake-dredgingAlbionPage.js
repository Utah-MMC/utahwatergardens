...
const Lake-dredgingAlbionPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Albion | Professional Lake Dredging Services"
        description="Expert lake dredging services in Albion. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, albion lake dredging, lake dredging albion"
        canonical="https://utahwatergardens.com/lake-dredging-albion"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Albion",
          "description": "Professional lake dredging services in Albion",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Albion"
        subtitle="Professional pond services for Lake Dredging Services in Albion and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Albion"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Albion</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Albion Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Albion Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Albion Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Albion Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingAlbionPage;