...
const Pond-repairPleasantViewPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Pleasant View | Professional Pond Repair Services"
        description="Expert pond repair services in Pleasant View. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, pleasant view pond repair, pond repair pleasant view"
        canonical="https://utahwatergardens.com/pond-repair-pleasant-view"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Pleasant View",
          "description": "Professional pond repair services in Pleasant View",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Pleasant View"
        subtitle="Professional pond services for Pond Repair Services in Pleasant View and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Pleasant View"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Pleasant View</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pleasant View Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pleasant View Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pleasant View Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pleasant View Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPleasantViewPage;