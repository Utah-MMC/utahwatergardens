...
const Pond-dredgingCarbondalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Carbondale | Professional Pond Dredging Services"
        description="Expert pond dredging services in Carbondale. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, carbondale pond dredging, pond dredging carbondale"
        canonical="https://utahwatergardens.com/pond-dredging-carbondale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Carbondale",
          "description": "Professional pond dredging services in Carbondale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Carbondale"
        subtitle="Professional pond services for Pond Dredging Services in Carbondale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Carbondale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Carbondale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carbondale Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carbondale Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carbondale Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carbondale Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingCarbondalePage;