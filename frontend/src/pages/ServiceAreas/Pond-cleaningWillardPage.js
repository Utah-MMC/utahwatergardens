...
const Pond-cleaningWillardPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Willard | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Willard. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, willard pond cleaning, pond cleaning willard"
        canonical="https://utahwatergardens.com/pond-cleaning-willard"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Willard",
          "description": "Professional pond cleaning services in Willard",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Willard"
        subtitle="Professional pond services for Pond Cleaning Services in Willard and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Willard"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Willard</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Willard Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Willard Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Willard Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Willard Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningWillardPage;