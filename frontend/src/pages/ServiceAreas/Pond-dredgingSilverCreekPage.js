...
const Pond-dredgingSilverCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Silver Creek | Professional Pond Dredging Services"
        description="Expert pond dredging services in Silver Creek. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, silver creek pond dredging, pond dredging silver creek"
        canonical="https://utahwatergardens.com/pond-dredging-silver-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Silver Creek",
          "description": "Professional pond dredging services in Silver Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Silver Creek"
        subtitle="Professional pond services for Pond Dredging Services in Silver Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Silver Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Silver Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Silver Creek Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Silver Creek Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Silver Creek Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Silver Creek Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSilverCreekPage;