...
const Pond-cleaningHelperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Helper | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Helper. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, helper pond cleaning, pond cleaning helper"
        canonical="https://utahwatergardens.com/pond-cleaning-helper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Helper",
          "description": "Professional pond cleaning services in Helper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Helper"
        subtitle="Professional pond services for Pond Cleaning Services in Helper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Helper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Helper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Helper Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Helper Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Helper Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Helper Customers Say About Our Pond Cleaning</h2>
