...
const Lake-dredgingHeneferPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Henefer | Professional Lake Dredging Services"
        description="Expert lake dredging services in Henefer. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, henefer lake dredging, lake dredging henefer"
        canonical="https://utahwatergardens.com/lake-dredging-henefer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Henefer",
          "description": "Professional lake dredging services in Henefer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Henefer"
        subtitle="Professional pond services for Lake Dredging Services in Henefer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Henefer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Henefer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Henefer Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Henefer Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Henefer Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Henefer Customers Say About Our Lake Dredging</h2>
