...
const Lake-dredgingHooperPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Hooper | Professional Lake Dredging Services"
        description="Expert lake dredging services in Hooper. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, hooper lake dredging, lake dredging hooper"
        canonical="https://utahwatergardens.com/lake-dredging-hooper"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Hooper",
          "description": "Professional lake dredging services in Hooper",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Hooper"
        subtitle="Professional pond services for Lake Dredging Services in Hooper and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Hooper"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Hooper</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hooper Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hooper Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hooper Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hooper Customers Say About Our Lake Dredging</h2>
