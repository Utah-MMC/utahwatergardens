...
const Pond-repairWapitiPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Wapiti | Professional Pond Repair Services"
        description="Expert pond repair services in Wapiti. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, wapiti pond repair, pond repair wapiti"
        canonical="https://utahwatergardens.com/pond-repair-wapiti"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Wapiti",
          "description": "Professional pond repair services in Wapiti",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Wapiti"
        subtitle="Professional pond services for Pond Repair Services in Wapiti and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Wapiti"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Wapiti</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wapiti Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wapiti Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wapiti Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wapiti Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWapitiPage;