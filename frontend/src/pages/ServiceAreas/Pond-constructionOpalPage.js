...
const Pond-constructionOpalPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Opal | Professional Pond Construction Services"
        description="Expert pond construction services in Opal. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, opal pond construction, pond construction opal"
        canonical="https://utahwatergardens.com/pond-construction-opal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Opal",
          "description": "Professional pond construction services in Opal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Opal"
        subtitle="Professional pond services for Pond Construction Services in Opal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Opal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Opal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Opal Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Opal Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Opal Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Opal Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionOpalPage;