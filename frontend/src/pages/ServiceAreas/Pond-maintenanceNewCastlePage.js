...
const Pond-maintenanceNewCastlePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance New Castle | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in New Castle. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, new castle pond maintenance, pond maintenance new castle"
        canonical="https://utahwatergardens.com/pond-maintenance-new-castle"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services New Castle",
          "description": "Professional pond maintenance services in New Castle",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in New Castle"
        subtitle="Professional pond services for Pond Maintenance Services in New Castle and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in New Castle"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in New Castle</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New Castle Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New Castle Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New Castle Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New Castle Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceNewCastlePage;