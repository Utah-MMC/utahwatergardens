...
const Pond-constructionStocktonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Stockton | Professional Pond Construction Services"
        description="Expert pond construction services in Stockton. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, stockton pond construction, pond construction stockton"
        canonical="https://utahwatergardens.com/pond-construction-stockton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Stockton",
          "description": "Professional pond construction services in Stockton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Stockton"
        subtitle="Professional pond services for Pond Construction Services in Stockton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Stockton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Stockton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Stockton Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Stockton Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Stockton Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Stockton Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionStocktonPage;