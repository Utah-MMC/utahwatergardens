...
const Pond-cleaningMoabPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Moab | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Moab. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, moab pond cleaning, pond cleaning moab"
        canonical="https://utahwatergardens.com/pond-cleaning-moab"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Moab",
          "description": "Professional pond cleaning services in Moab",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Moab"
        subtitle="Professional pond services for Pond Cleaning Services in Moab and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Moab"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Moab</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Moab Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Moab Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Moab Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Moab Customers Say About Our Pond Cleaning</h2>
