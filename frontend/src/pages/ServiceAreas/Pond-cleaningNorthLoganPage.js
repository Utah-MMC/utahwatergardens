...
const Pond-cleaningNorthLoganPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning North Logan | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in North Logan. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, north logan pond cleaning, pond cleaning north logan"
        canonical="https://utahwatergardens.com/pond-cleaning-north-logan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services North Logan",
          "description": "Professional pond cleaning services in North Logan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in North Logan"
        subtitle="Professional pond services for Pond Cleaning Services in North Logan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in North Logan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in North Logan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Logan Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Logan Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Logan Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Logan Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningNorthLoganPage;