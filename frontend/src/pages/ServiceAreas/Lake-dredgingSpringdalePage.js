...
const Lake-dredgingSpringdalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Springdale | Professional Lake Dredging Services"
        description="Expert lake dredging services in Springdale. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, springdale lake dredging, lake dredging springdale"
        canonical="https://utahwatergardens.com/lake-dredging-springdale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Springdale",
          "description": "Professional lake dredging services in Springdale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Springdale"
        subtitle="Professional pond services for Lake Dredging Services in Springdale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Springdale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Springdale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Springdale Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Springdale Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Springdale Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Springdale Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSpringdalePage;