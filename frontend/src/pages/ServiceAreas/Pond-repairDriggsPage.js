...
const Pond-repairDriggsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Driggs | Professional Pond Repair Services"
        description="Expert pond repair services in Driggs. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, driggs pond repair, pond repair driggs"
        canonical="https://utahwatergardens.com/pond-repair-driggs"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Driggs",
          "description": "Professional pond repair services in Driggs",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Driggs"
        subtitle="Professional pond services for Pond Repair Services in Driggs and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Driggs"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Driggs</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Driggs Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Driggs Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Driggs Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Driggs Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDriggsPage;