...
const Pond-dredgingFruitaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Fruita | Professional Pond Dredging Services"
        description="Expert pond dredging services in Fruita. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, fruita pond dredging, pond dredging fruita"
        canonical="https://utahwatergardens.com/pond-dredging-fruita"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Fruita",
          "description": "Professional pond dredging services in Fruita",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Fruita"
        subtitle="Professional pond services for Pond Dredging Services in Fruita and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Fruita"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Fruita</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruita Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruita Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruita Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruita Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingFruitaPage;