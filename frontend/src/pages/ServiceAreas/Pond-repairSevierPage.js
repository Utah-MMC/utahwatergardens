...
const Pond-repairSevierPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Sevier | Professional Pond Repair Services"
        description="Expert pond repair services in Sevier. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, sevier pond repair, pond repair sevier"
        canonical="https://utahwatergardens.com/pond-repair-sevier"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Sevier",
          "description": "Professional pond repair services in Sevier",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Sevier"
        subtitle="Professional pond services for Pond Repair Services in Sevier and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Sevier"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Sevier</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sevier Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sevier Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sevier Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sevier Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSevierPage;