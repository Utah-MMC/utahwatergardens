...
const Pond-dredgingMurrayPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Murray | Professional Pond Dredging Services"
        description="Expert pond dredging services in Murray. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, murray pond dredging, pond dredging murray"
        canonical="https://utahwatergardens.com/pond-dredging-murray"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Murray",
          "description": "Professional pond dredging services in Murray",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Murray"
        subtitle="Professional pond services for Pond Dredging Services in Murray and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Murray"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Murray</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Murray Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Murray Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Murray Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Murray Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingMurrayPage;