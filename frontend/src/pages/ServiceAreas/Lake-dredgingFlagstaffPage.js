...
const Lake-dredgingFlagstaffPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Flagstaff | Professional Lake Dredging Services"
        description="Expert lake dredging services in Flagstaff. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, flagstaff lake dredging, lake dredging flagstaff"
        canonical="https://utahwatergardens.com/lake-dredging-flagstaff"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Flagstaff",
          "description": "Professional lake dredging services in Flagstaff",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Flagstaff"
        subtitle="Professional pond services for Lake Dredging Services in Flagstaff and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Flagstaff"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Flagstaff</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Flagstaff Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Flagstaff Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Flagstaff Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Flagstaff Customers Say About Our Lake Dredging</h2>
