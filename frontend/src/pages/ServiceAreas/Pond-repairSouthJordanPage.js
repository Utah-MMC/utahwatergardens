...
const Pond-repairSouthJordanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair South Jordan | Professional Pond Repair Services"
        description="Expert pond repair services in South Jordan. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, south jordan pond repair, pond repair south jordan"
        canonical="https://utahwatergardens.com/pond-repair-south-jordan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services South Jordan",
          "description": "Professional pond repair services in South Jordan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in South Jordan"
        subtitle="Professional pond services for Pond Repair Services in South Jordan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in South Jordan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in South Jordan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Jordan Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Jordan Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Jordan Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Jordan Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSouthJordanPage;