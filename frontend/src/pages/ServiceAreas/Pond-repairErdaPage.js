...
const Pond-repairErdaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Erda | Professional Pond Repair Services"
        description="Expert pond repair services in Erda. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, erda pond repair, pond repair erda"
        canonical="https://utahwatergardens.com/pond-repair-erda"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Erda",
          "description": "Professional pond repair services in Erda",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Erda"
        subtitle="Professional pond services for Pond Repair Services in Erda and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Erda"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Erda</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Erda Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Erda Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Erda Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Erda Customers Say About Our Pond Repair</h2>
...
export default Pond-repairErdaPage;