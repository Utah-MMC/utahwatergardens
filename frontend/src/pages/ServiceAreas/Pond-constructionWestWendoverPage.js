...
const Pond-constructionWestWendoverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction West Wendover | Professional Pond Construction Services"
        description="Expert pond construction services in West Wendover. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, west wendover pond construction, pond construction west wendover"
        canonical="https://utahwatergardens.com/pond-construction-west-wendover"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services West Wendover",
          "description": "Professional pond construction services in West Wendover",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in West Wendover"
        subtitle="Professional pond services for Pond Construction Services in West Wendover and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in West Wendover"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in West Wendover</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Wendover Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Wendover Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Wendover Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Wendover Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionWestWendoverPage;