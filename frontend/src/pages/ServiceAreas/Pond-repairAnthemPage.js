...
const Pond-repairAnthemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Anthem | Professional Pond Repair Services"
        description="Expert pond repair services in Anthem. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, anthem pond repair, pond repair anthem"
        canonical="https://utahwatergardens.com/pond-repair-anthem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Anthem",
          "description": "Professional pond repair services in Anthem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Anthem"
        subtitle="Professional pond services for Pond Repair Services in Anthem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Anthem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Anthem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Anthem Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Anthem Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Anthem Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Anthem Customers Say About Our Pond Repair</h2>
...
export default Pond-repairAnthemPage;