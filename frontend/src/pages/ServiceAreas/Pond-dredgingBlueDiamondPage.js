...
const Pond-dredgingBlueDiamondPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Blue Diamond | Professional Pond Dredging Services"
        description="Expert pond dredging services in Blue Diamond. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, blue diamond pond dredging, pond dredging blue diamond"
        canonical="https://utahwatergardens.com/pond-dredging-blue-diamond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Blue Diamond",
          "description": "Professional pond dredging services in Blue Diamond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Blue Diamond"
        subtitle="Professional pond services for Pond Dredging Services in Blue Diamond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Blue Diamond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Blue Diamond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Blue Diamond Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Blue Diamond Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Blue Diamond Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Blue Diamond Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingBlueDiamondPage;