...
const Pond-dredgingIndependencePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Independence | Professional Pond Dredging Services"
        description="Expert pond dredging services in Independence. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, independence pond dredging, pond dredging independence"
        canonical="https://utahwatergardens.com/pond-dredging-independence"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Independence",
          "description": "Professional pond dredging services in Independence",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Independence"
        subtitle="Professional pond services for Pond Dredging Services in Independence and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Independence"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Independence</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Independence Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Independence Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Independence Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Independence Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingIndependencePage;