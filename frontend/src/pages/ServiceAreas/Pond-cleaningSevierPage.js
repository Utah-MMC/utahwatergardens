...
const Pond-cleaningSevierPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Sevier | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Sevier. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, sevier pond cleaning, pond cleaning sevier"
        canonical="https://utahwatergardens.com/pond-cleaning-sevier"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Sevier",
          "description": "Professional pond cleaning services in Sevier",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Sevier"
        subtitle="Professional pond services for Pond Cleaning Services in Sevier and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Sevier"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Sevier</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sevier Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sevier Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sevier Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sevier Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSevierPage;