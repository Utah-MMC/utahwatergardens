...
const Pond-cleaningPricePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Price | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Price. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, price pond cleaning, pond cleaning price"
        canonical="https://utahwatergardens.com/pond-cleaning-price"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Price",
          "description": "Professional pond cleaning services in Price",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Price"
        subtitle="Professional pond services for Pond Cleaning Services in Price and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Price"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Price</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Price Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Price Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Price Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Price Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningPricePage;