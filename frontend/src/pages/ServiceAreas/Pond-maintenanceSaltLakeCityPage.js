...
const Pond-maintenanceSaltLakeCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Salt Lake City | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Salt Lake City. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, salt lake city pond maintenance, pond maintenance salt lake city"
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Professional pond maintenance services in Salt Lake City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        ...
        <div className="container">
          ...
          <section className="testimonials-section">
            <h2>What Salt Lake City Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSaltLakeCityPage;