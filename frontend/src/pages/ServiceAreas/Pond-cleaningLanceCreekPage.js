...
const Pond-cleaningLanceCreekPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lance Creek | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lance Creek. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lance creek pond cleaning, pond cleaning lance creek"
        canonical="https://utahwatergardens.com/pond-cleaning-lance-creek"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lance Creek",
          "description": "Professional pond cleaning services in Lance Creek",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lance Creek"
        subtitle="Professional pond services for Pond Cleaning Services in Lance Creek and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lance Creek"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lance Creek</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lance Creek Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lance Creek Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lance Creek Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lance Creek Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLanceCreekPage;