...
const Pond-dredgingLaBargePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging La Barge | Professional Pond Dredging Services"
        description="Expert pond dredging services in La Barge. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, la barge pond dredging, pond dredging la barge"
        canonical="https://utahwatergardens.com/pond-dredging-la-barge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services La Barge",
          "description": "Professional pond dredging services in La Barge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in La Barge"
        subtitle="Professional pond services for Pond Dredging Services in La Barge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in La Barge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in La Barge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Barge Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Barge Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Barge Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Barge Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLaBargePage;