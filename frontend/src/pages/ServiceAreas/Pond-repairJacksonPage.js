...
const Pond-repairJacksonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Jackson | Professional Pond Repair Services"
        description="Expert pond repair services in Jackson. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, jackson pond repair, pond repair jackson"
        canonical="https://utahwatergardens.com/pond-repair-jackson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Jackson",
          "description": "Professional pond repair services in Jackson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Jackson"
        subtitle="Professional pond services for Pond Repair Services in Jackson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Jackson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Jackson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jackson Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jackson Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jackson Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jackson Customers Say About Our Pond Repair</h2>
...
export default Pond-repairJacksonPage;