...
const Pond-maintenanceWoodsCrossPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Woods Cross | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Woods Cross. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, woods cross pond maintenance, pond maintenance woods cross"
        canonical="https://utahwatergardens.com/pond-maintenance-woods-cross"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Woods Cross",
          "description": "Professional pond maintenance services in Woods Cross",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Woods Cross"
        subtitle="Professional pond services for Pond Maintenance Services in Woods Cross and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Woods Cross"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Woods Cross</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Woods Cross Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Woods Cross Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Woods Cross Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Woods Cross Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceWoodsCrossPage;