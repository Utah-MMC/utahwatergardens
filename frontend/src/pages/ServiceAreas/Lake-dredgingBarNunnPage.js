...
const Lake-dredgingBarNunnPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Bar Nunn | Professional Lake Dredging Services"
        description="Expert lake dredging services in Bar Nunn. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, bar nunn lake dredging, lake dredging bar nunn"
        canonical="https://utahwatergardens.com/lake-dredging-bar-nunn"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Bar Nunn",
          "description": "Professional lake dredging services in Bar Nunn",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Bar Nunn"
        subtitle="Professional pond services for Lake Dredging Services in Bar Nunn and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Bar Nunn"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Bar Nunn</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bar Nunn Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bar Nunn Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bar Nunn Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bar Nunn Customers Say About Our Lake Dredging</h2>
