...
const Pond-maintenanceRiverdalePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Riverdale | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Riverdale. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, riverdale pond maintenance, pond maintenance riverdale"
        canonical="https://utahwatergardens.com/pond-maintenance-riverdale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Riverdale",
          "description": "Professional pond maintenance services in Riverdale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Riverdale"
        subtitle="Professional pond services for Pond Maintenance Services in Riverdale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Riverdale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Riverdale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Riverdale Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Riverdale Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Riverdale Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Riverdale Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceRiverdalePage;