...
const Pond-cleaningTelluridePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Telluride | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Telluride. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, telluride pond cleaning, pond cleaning telluride"
        canonical="https://utahwatergardens.com/pond-cleaning-telluride"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Telluride",
          "description": "Professional pond cleaning services in Telluride",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Telluride"
        subtitle="Professional pond services for Pond Cleaning Services in Telluride and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Telluride"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Telluride</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Telluride Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Telluride Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Telluride Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Telluride Customers Say About Our Pond Cleaning</h2>
