...
const Pond-repairSurprisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Surprise | Professional Pond Repair Services"
        description="Expert pond repair services in Surprise. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, surprise pond repair, pond repair surprise"
        canonical="https://utahwatergardens.com/pond-repair-surprise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Surprise",
          "description": "Professional pond repair services in Surprise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Surprise"
        subtitle="Professional pond services for Pond Repair Services in Surprise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Surprise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Surprise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Surprise Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Surprise Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Surprise Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Surprise Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSurprisePage;