...
const Pond-cleaningHyrumPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Hyrum | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Hyrum. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, hyrum pond cleaning, pond cleaning hyrum"
        canonical="https://utahwatergardens.com/pond-cleaning-hyrum"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Hyrum",
          "description": "Professional pond cleaning services in Hyrum",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Hyrum"
        subtitle="Professional pond services for Pond Cleaning Services in Hyrum and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Hyrum"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Hyrum</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hyrum Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hyrum Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hyrum Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hyrum Customers Say About Our Pond Cleaning</h2>
