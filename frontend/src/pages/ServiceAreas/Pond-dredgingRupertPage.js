...
const Pond-dredgingRupertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Rupert | Professional Pond Dredging Services"
        description="Expert pond dredging services in Rupert. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, rupert pond dredging, pond dredging rupert"
        canonical="https://utahwatergardens.com/pond-dredging-rupert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Rupert",
          "description": "Professional pond dredging services in Rupert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Rupert"
        subtitle="Professional pond services for Pond Dredging Services in Rupert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Rupert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Rupert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rupert Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rupert Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rupert Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rupert Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingRupertPage;