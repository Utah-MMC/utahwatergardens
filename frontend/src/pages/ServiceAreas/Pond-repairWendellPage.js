...
const Pond-repairWendellPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Wendell | Professional Pond Repair Services"
        description="Expert pond repair services in Wendell. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, wendell pond repair, pond repair wendell"
        canonical="https://utahwatergardens.com/pond-repair-wendell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Wendell",
          "description": "Professional pond repair services in Wendell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Wendell"
        subtitle="Professional pond services for Pond Repair Services in Wendell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Wendell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Wendell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Wendell Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Wendell Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Wendell Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Wendell Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWendellPage;