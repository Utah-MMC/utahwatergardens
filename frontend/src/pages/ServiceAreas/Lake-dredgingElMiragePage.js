...
const Lake-dredgingElMiragePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging El Mirage | Professional Lake Dredging Services"
        description="Expert lake dredging services in El Mirage. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, el mirage lake dredging, lake dredging el mirage"
        canonical="https://utahwatergardens.com/lake-dredging-el-mirage"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services El Mirage",
          "description": "Professional lake dredging services in El Mirage",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in El Mirage"
        subtitle="Professional pond services for Lake Dredging Services in El Mirage and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in El Mirage"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in El Mirage</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our El Mirage Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="El Mirage Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our El Mirage Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What El Mirage Customers Say About Our Lake Dredging</h2>
