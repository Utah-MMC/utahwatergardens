...
const Pond-cleaningLakeShorePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Lake Shore | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Lake Shore. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, lake shore pond cleaning, pond cleaning lake shore"
        canonical="https://utahwatergardens.com/pond-cleaning-lake-shore"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Lake Shore",
          "description": "Professional pond cleaning services in Lake Shore",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Lake Shore"
        subtitle="Professional pond services for Pond Cleaning Services in Lake Shore and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Lake Shore"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Lake Shore</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Lake Shore Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Lake Shore Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Lake Shore Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Lake Shore Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningLakeShorePage;