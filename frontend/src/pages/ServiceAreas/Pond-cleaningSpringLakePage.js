...
const Pond-cleaningSpringLakePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Spring Lake | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Spring Lake. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, spring lake pond cleaning, pond cleaning spring lake"
        canonical="https://utahwatergardens.com/pond-cleaning-spring-lake"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Spring Lake",
          "description": "Professional pond cleaning services in Spring Lake",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Spring Lake"
        subtitle="Professional pond services for Pond Cleaning Services in Spring Lake and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Spring Lake"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Spring Lake</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Spring Lake Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Spring Lake Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Spring Lake Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Spring Lake Customers Say About Our Pond Cleaning</h2>
