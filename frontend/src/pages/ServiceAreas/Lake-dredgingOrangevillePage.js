...
const Lake-dredgingOrangevillePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Orangeville | Professional Lake Dredging Services"
        description="Expert lake dredging services in Orangeville. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, orangeville lake dredging, lake dredging orangeville"
        canonical="https://utahwatergardens.com/lake-dredging-orangeville"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Orangeville",
          "description": "Professional lake dredging services in Orangeville",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Orangeville"
        subtitle="Professional pond services for Lake Dredging Services in Orangeville and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Orangeville"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Orangeville</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Orangeville Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Orangeville Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Orangeville Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Orangeville Customers Say About Our Lake Dredging</h2>
