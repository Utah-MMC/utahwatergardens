...
const Pond-maintenanceGreybullPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Greybull | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Greybull. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, greybull pond maintenance, pond maintenance greybull"
        canonical="https://utahwatergardens.com/pond-maintenance-greybull"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Greybull",
          "description": "Professional pond maintenance services in Greybull",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Greybull"
        subtitle="Professional pond services for Pond Maintenance Services in Greybull and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Greybull"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Greybull</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Greybull Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Greybull Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Greybull Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Greybull Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceGreybullPage;