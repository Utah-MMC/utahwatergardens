...
const Pond-dredgingVictorPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Victor | Professional Pond Dredging Services"
        description="Expert pond dredging services in Victor. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, victor pond dredging, pond dredging victor"
        canonical="https://utahwatergardens.com/pond-dredging-victor"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Victor",
          "description": "Professional pond dredging services in Victor",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Victor"
        subtitle="Professional pond services for Pond Dredging Services in Victor and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Victor"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Victor</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Victor Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Victor Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Victor Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Victor Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingVictorPage;