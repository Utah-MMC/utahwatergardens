...
const Pond-repairKunaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Kuna | Professional Pond Repair Services"
        description="Expert pond repair services in Kuna. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, kuna pond repair, pond repair kuna"
        canonical="https://utahwatergardens.com/pond-repair-kuna"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Kuna",
          "description": "Professional pond repair services in Kuna",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Kuna"
        subtitle="Professional pond services for Pond Repair Services in Kuna and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Kuna"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Kuna</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kuna Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kuna Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kuna Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kuna Customers Say About Our Pond Repair</h2>
...
export default Pond-repairKunaPage;