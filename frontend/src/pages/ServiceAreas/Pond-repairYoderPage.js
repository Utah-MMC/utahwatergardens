...
const Pond-repairYoderPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Yoder | Professional Pond Repair Services"
        description="Expert pond repair services in Yoder. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, yoder pond repair, pond repair yoder"
        canonical="https://utahwatergardens.com/pond-repair-yoder"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Yoder",
          "description": "Professional pond repair services in Yoder",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Yoder"
        subtitle="Professional pond services for Pond Repair Services in Yoder and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Yoder"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Yoder</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Yoder Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Yoder Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Yoder Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Yoder Customers Say About Our Pond Repair</h2>
...
export default Pond-repairYoderPage;