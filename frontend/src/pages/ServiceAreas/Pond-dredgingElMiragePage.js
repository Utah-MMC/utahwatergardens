...
const Pond-dredgingElMiragePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging El Mirage | Professional Pond Dredging Services"
        description="Expert pond dredging services in El Mirage. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, el mirage pond dredging, pond dredging el mirage"
        canonical="https://utahwatergardens.com/pond-dredging-el-mirage"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services El Mirage",
          "description": "Professional pond dredging services in El Mirage",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in El Mirage"
        subtitle="Professional pond services for Pond Dredging Services in El Mirage and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in El Mirage"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in El Mirage</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our El Mirage Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="El Mirage Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our El Mirage Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What El Mirage Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingElMiragePage;