...
const Pond-constructionJayEmPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Jay Em | Professional Pond Construction Services"
        description="Expert pond construction services in Jay Em. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, jay em pond construction, pond construction jay em"
        canonical="https://utahwatergardens.com/pond-construction-jay-em"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Jay Em",
          "description": "Professional pond construction services in Jay Em",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Jay Em"
        subtitle="Professional pond services for Pond Construction Services in Jay Em and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Jay Em"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Jay Em</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jay Em Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jay Em Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jay Em Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jay Em Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionJayEmPage;