...
const Pond-dredgingLaVerkinPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging La Verkin | Professional Pond Dredging Services"
        description="Expert pond dredging services in La Verkin. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, la verkin pond dredging, pond dredging la verkin"
        canonical="https://utahwatergardens.com/pond-dredging-la-verkin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services La Verkin",
          "description": "Professional pond dredging services in La Verkin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in La Verkin"
        subtitle="Professional pond services for Pond Dredging Services in La Verkin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in La Verkin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in La Verkin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Verkin Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Verkin Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Verkin Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Verkin Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingLaVerkinPage;