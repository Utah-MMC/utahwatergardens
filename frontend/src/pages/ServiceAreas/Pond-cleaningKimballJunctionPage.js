...
const Pond-cleaningKimballJunctionPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Kimball Junction | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Kimball Junction. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, kimball junction pond cleaning, pond cleaning kimball junction"
        canonical="https://utahwatergardens.com/pond-cleaning-kimball-junction"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Kimball Junction",
          "description": "Professional pond cleaning services in Kimball Junction",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Kimball Junction"
        subtitle="Professional pond services for Pond Cleaning Services in Kimball Junction and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Kimball Junction"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Kimball Junction</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Kimball Junction Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Kimball Junction Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Kimball Junction Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Kimball Junction Customers Say About Our Pond Cleaning</h2>
