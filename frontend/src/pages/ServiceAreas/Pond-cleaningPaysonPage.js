...
const Pond-cleaningPaysonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Payson | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Payson. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, payson pond cleaning, pond cleaning payson"
        canonical="https://utahwatergardens.com/pond-cleaning-payson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Payson",
          "description": "Professional pond cleaning services in Payson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Payson"
        subtitle="Professional pond services for Pond Cleaning Services in Payson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Payson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Payson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Payson Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Payson Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Payson Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Payson Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningPaysonPage;