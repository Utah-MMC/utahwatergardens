...
const Pond-cleaningDeltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Delta | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Delta. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, delta pond cleaning, pond cleaning delta"
        canonical="https://utahwatergardens.com/pond-cleaning-delta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Delta",
          "description": "Professional pond cleaning services in Delta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Delta"
        subtitle="Professional pond services for Pond Cleaning Services in Delta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Delta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Delta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Delta Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Delta Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Delta Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Delta Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDeltaPage;