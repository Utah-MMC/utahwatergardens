...
const Pond-dredgingClarkstonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Clarkston | Professional Pond Dredging Services"
        description="Expert pond dredging services in Clarkston. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, clarkston pond dredging, pond dredging clarkston"
        canonical="https://utahwatergardens.com/pond-dredging-clarkston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Clarkston",
          "description": "Professional pond dredging services in Clarkston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Clarkston"
        subtitle="Professional pond services for Pond Dredging Services in Clarkston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Clarkston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Clarkston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Clarkston Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Clarkston Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Clarkston Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Clarkston Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingClarkstonPage;