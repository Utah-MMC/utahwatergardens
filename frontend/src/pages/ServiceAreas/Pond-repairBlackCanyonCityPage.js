...
const Pond-repairBlackCanyonCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Black Canyon City | Professional Pond Repair Services"
        description="Expert pond repair services in Black Canyon City. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, black canyon city pond repair, pond repair black canyon city"
        canonical="https://utahwatergardens.com/pond-repair-black-canyon-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Black Canyon City",
          "description": "Professional pond repair services in Black Canyon City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Black Canyon City"
        subtitle="Professional pond services for Pond Repair Services in Black Canyon City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Black Canyon City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Black Canyon City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Black Canyon City Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Black Canyon City Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Black Canyon City Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Black Canyon City Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBlackCanyonCityPage;