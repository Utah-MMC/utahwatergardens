...
const Pond-repairJayEmPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Jay Em | Professional Pond Repair Services"
        description="Expert pond repair services in Jay Em. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, jay em pond repair, pond repair jay em"
        canonical="https://utahwatergardens.com/pond-repair-jay-em"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Jay Em",
          "description": "Professional pond repair services in Jay Em",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Jay Em"
        subtitle="Professional pond services for Pond Repair Services in Jay Em and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Jay Em"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Jay Em</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Jay Em Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Jay Em Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Jay Em Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Jay Em Customers Say About Our Pond Repair</h2>
...
export default Pond-repairJayEmPage;