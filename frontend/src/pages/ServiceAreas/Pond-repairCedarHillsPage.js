...
const Pond-repairCedarHillsPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Cedar Hills | Professional Pond Repair Services"
        description="Expert pond repair services in Cedar Hills. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, cedar hills pond repair, pond repair cedar hills"
        canonical="https://utahwatergardens.com/pond-repair-cedar-hills"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Cedar Hills",
          "description": "Professional pond repair services in Cedar Hills",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Cedar Hills"
        subtitle="Professional pond services for Pond Repair Services in Cedar Hills and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Cedar Hills"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Cedar Hills</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Cedar Hills Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Cedar Hills Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Cedar Hills Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Cedar Hills Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCedarHillsPage;