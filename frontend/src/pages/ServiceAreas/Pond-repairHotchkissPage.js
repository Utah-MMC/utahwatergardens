...
const Pond-repairHotchkissPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Hotchkiss | Professional Pond Repair Services"
        description="Expert pond repair services in Hotchkiss. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, hotchkiss pond repair, pond repair hotchkiss"
        canonical="https://utahwatergardens.com/pond-repair-hotchkiss"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Hotchkiss",
          "description": "Professional pond repair services in Hotchkiss",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Hotchkiss"
        subtitle="Professional pond services for Pond Repair Services in Hotchkiss and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Hotchkiss"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Hotchkiss</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hotchkiss Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hotchkiss Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hotchkiss Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hotchkiss Customers Say About Our Pond Repair</h2>
...
export default Pond-repairHotchkissPage;