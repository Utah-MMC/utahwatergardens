...
const HarvestingSummerlinPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Summerlin | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Summerlin. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, summerlin aquatic plant harvesting, aquatic plant harvesting summerlin"
        canonical="https://utahwatergardens.com/harvesting-summerlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Summerlin",
          "description": "Professional aquatic plant harvesting services in Summerlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Summerlin"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Summerlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Summerlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Summerlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Summerlin Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Summerlin Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Summerlin Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Summerlin Customers Say About Our Aquatic Plant Harvesting</h2>
