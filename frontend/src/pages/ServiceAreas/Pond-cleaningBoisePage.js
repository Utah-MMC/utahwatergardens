...
const Pond-cleaningBoisePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Boise | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Boise. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, boise pond cleaning, pond cleaning boise"
        canonical="https://utahwatergardens.com/pond-cleaning-boise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Boise",
          "description": "Professional pond cleaning services in Boise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Boise"
        subtitle="Professional pond services for Pond Cleaning Services in Boise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Boise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Boise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boise Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boise Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boise Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boise Customers Say About Our Pond Cleaning</h2>
