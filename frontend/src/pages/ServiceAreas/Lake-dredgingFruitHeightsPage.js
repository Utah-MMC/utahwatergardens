...
const Lake-dredgingFruitHeightsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Fruit Heights | Professional Lake Dredging Services"
        description="Expert lake dredging services in Fruit Heights. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, fruit heights lake dredging, lake dredging fruit heights"
        canonical="https://utahwatergardens.com/lake-dredging-fruit-heights"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Fruit Heights",
          "description": "Professional lake dredging services in Fruit Heights",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Fruit Heights"
        subtitle="Professional pond services for Lake Dredging Services in Fruit Heights and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Fruit Heights"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Fruit Heights</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Fruit Heights Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Fruit Heights Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Fruit Heights Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Fruit Heights Customers Say About Our Lake Dredging</h2>
