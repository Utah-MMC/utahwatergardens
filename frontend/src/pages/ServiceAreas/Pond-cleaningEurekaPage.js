...
const Pond-cleaningEurekaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Eureka | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Eureka. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, eureka pond cleaning, pond cleaning eureka"
        canonical="https://utahwatergardens.com/pond-cleaning-eureka"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Eureka",
          "description": "Professional pond cleaning services in Eureka",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Eureka"
        subtitle="Professional pond services for Pond Cleaning Services in Eureka and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Eureka"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Eureka</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eureka Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eureka Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eureka Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eureka Customers Say About Our Pond Cleaning</h2>
