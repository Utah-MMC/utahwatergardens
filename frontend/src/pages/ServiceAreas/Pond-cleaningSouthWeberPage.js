...
const Pond-cleaningSouthWeberPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning South Weber | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in South Weber. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, south weber pond cleaning, pond cleaning south weber"
        canonical="https://utahwatergardens.com/pond-cleaning-south-weber"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services South Weber",
          "description": "Professional pond cleaning services in South Weber",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in South Weber"
        subtitle="Professional pond services for Pond Cleaning Services in South Weber and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in South Weber"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in South Weber</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Weber Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Weber Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Weber Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Weber Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningSouthWeberPage;