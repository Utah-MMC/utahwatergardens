...
const Pond-cleaningPromontoryPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Promontory | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Promontory. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, promontory pond cleaning, pond cleaning promontory"
        canonical="https://utahwatergardens.com/pond-cleaning-promontory"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Promontory",
          "description": "Professional pond cleaning services in Promontory",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Promontory"
        subtitle="Professional pond services for Pond Cleaning Services in Promontory and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Promontory"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Promontory</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Promontory Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Promontory Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Promontory Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Promontory Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningPromontoryPage;