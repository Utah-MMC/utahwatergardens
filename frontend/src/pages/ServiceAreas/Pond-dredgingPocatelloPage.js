...
const Pond-dredgingPocatelloPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Pocatello | Professional Pond Dredging Services"
        description="Expert pond dredging services in Pocatello. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, pocatello pond dredging, pond dredging pocatello"
        canonical="https://utahwatergardens.com/pond-dredging-pocatello"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Pocatello",
          "description": "Professional pond dredging services in Pocatello",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Pocatello"
        subtitle="Professional pond services for Pond Dredging Services in Pocatello and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Pocatello"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Pocatello</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pocatello Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pocatello Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pocatello Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pocatello Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPocatelloPage;