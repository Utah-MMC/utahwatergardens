...
const Pond-repairDeltaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Delta | Professional Pond Repair Services"
        description="Expert pond repair services in Delta. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, delta pond repair, pond repair delta"
        canonical="https://utahwatergardens.com/pond-repair-delta"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Delta",
          "description": "Professional pond repair services in Delta",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Delta"
        subtitle="Professional pond services for Pond Repair Services in Delta and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Delta"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Delta</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Delta Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Delta Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Delta Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Delta Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDeltaPage;