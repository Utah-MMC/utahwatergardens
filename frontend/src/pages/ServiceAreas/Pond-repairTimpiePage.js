...
const Pond-repairTimpiePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Timpie | Professional Pond Repair Services"
        description="Expert pond repair services in Timpie. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, timpie pond repair, pond repair timpie"
        canonical="https://utahwatergardens.com/pond-repair-timpie"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Timpie",
          "description": "Professional pond repair services in Timpie",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Timpie"
        subtitle="Professional pond services for Pond Repair Services in Timpie and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Timpie"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Timpie</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Timpie Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Timpie Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Timpie Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Timpie Customers Say About Our Pond Repair</h2>
...
export default Pond-repairTimpiePage;