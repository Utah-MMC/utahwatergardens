...
const Pond-cleaningRosettePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Rosette | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Rosette. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, rosette pond cleaning, pond cleaning rosette"
        canonical="https://utahwatergardens.com/pond-cleaning-rosette"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Rosette",
          "description": "Professional pond cleaning services in Rosette",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Rosette"
        subtitle="Professional pond services for Pond Cleaning Services in Rosette and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Rosette"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Rosette</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rosette Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rosette Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rosette Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rosette Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningRosettePage;