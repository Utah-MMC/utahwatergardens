...
const Lake-dredgingGuernseyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Guernsey | Professional Lake Dredging Services"
        description="Expert lake dredging services in Guernsey. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, guernsey lake dredging, lake dredging guernsey"
        canonical="https://utahwatergardens.com/lake-dredging-guernsey"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Guernsey",
          "description": "Professional lake dredging services in Guernsey",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Guernsey"
        subtitle="Professional pond services for Lake Dredging Services in Guernsey and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Guernsey"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Guernsey</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Guernsey Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Guernsey Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Guernsey Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Guernsey Customers Say About Our Lake Dredging</h2>
