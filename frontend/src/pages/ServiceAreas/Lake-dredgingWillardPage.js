...
const Lake-dredgingWillardPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Willard | Professional Lake Dredging Services"
        description="Expert lake dredging services in Willard. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, willard lake dredging, lake dredging willard"
        canonical="https://utahwatergardens.com/lake-dredging-willard"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Willard",
          "description": "Professional lake dredging services in Willard",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Willard"
        subtitle="Professional pond services for Lake Dredging Services in Willard and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Willard"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Willard</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Willard Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Willard Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Willard Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Willard Customers Say About Our Lake Dredging</h2>
