...
const Pond-dredgingEthetePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Ethete | Professional Pond Dredging Services"
        description="Expert pond dredging services in Ethete. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, ethete pond dredging, pond dredging ethete"
        canonical="https://utahwatergardens.com/pond-dredging-ethete"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Ethete",
          "description": "Professional pond dredging services in Ethete",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Ethete"
        subtitle="Professional pond services for Pond Dredging Services in Ethete and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Ethete"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Ethete</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ethete Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ethete Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ethete Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ethete Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingEthetePage;