...
const Lake-dredgingRichfieldPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Richfield | Professional Lake Dredging Services"
        description="Expert lake dredging services in Richfield. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, richfield lake dredging, lake dredging richfield"
        canonical="https://utahwatergardens.com/lake-dredging-richfield"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Richfield",
          "description": "Professional lake dredging services in Richfield",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Richfield"
        subtitle="Professional pond services for Lake Dredging Services in Richfield and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Richfield"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Richfield</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Richfield Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Richfield Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Richfield Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Richfield Customers Say About Our Lake Dredging</h2>
