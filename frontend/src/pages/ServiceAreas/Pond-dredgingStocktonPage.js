...
const Pond-dredgingStocktonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Stockton | Professional Pond Dredging Services"
        description="Expert pond dredging services in Stockton. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, stockton pond dredging, pond dredging stockton"
        canonical="https://utahwatergardens.com/pond-dredging-stockton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Stockton",
          "description": "Professional pond dredging services in Stockton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Stockton"
        subtitle="Professional pond services for Pond Dredging Services in Stockton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Stockton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Stockton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Stockton Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Stockton Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Stockton Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Stockton Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingStocktonPage;