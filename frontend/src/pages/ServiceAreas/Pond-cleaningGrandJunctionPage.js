...
const Pond-cleaningGrandJunctionPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Grand Junction | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Grand Junction. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, grand junction pond cleaning, pond cleaning grand junction"
        canonical="https://utahwatergardens.com/pond-cleaning-grand-junction"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Grand Junction",
          "description": "Professional pond cleaning services in Grand Junction",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Grand Junction"
        subtitle="Professional pond services for Pond Cleaning Services in Grand Junction and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Grand Junction"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Grand Junction</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Grand Junction Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Grand Junction Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Grand Junction Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Grand Junction Customers Say About Our Pond Cleaning</h2>
