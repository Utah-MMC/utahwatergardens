...
const Lake-dredgingBoulderPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Boulder | Professional Lake Dredging Services"
        description="Expert lake dredging services in Boulder. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, boulder lake dredging, lake dredging boulder"
        canonical="https://utahwatergardens.com/lake-dredging-boulder"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Boulder",
          "description": "Professional lake dredging services in Boulder",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Boulder"
        subtitle="Professional pond services for Lake Dredging Services in Boulder and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Boulder"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Boulder</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Boulder Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Boulder Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Boulder Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Boulder Customers Say About Our Lake Dredging</h2>
