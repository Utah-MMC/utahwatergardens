...
const Pond-cleaningPortagePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Portage | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Portage. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, portage pond cleaning, pond cleaning portage"
        canonical="https://utahwatergardens.com/pond-cleaning-portage"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Portage",
          "description": "Professional pond cleaning services in Portage",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Portage"
        subtitle="Professional pond services for Pond Cleaning Services in Portage and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Portage"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Portage</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Portage Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Portage Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Portage Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Portage Customers Say About Our Pond Cleaning</h2>
