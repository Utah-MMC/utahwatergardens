...
const Lake-dredgingWestJordanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging West Jordan | Professional Lake Dredging Services"
        description="Expert lake dredging services in West Jordan. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, west jordan lake dredging, lake dredging west jordan"
        canonical="https://utahwatergardens.com/lake-dredging-west-jordan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services West Jordan",
          "description": "Professional lake dredging services in West Jordan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in West Jordan"
        subtitle="Professional pond services for Lake Dredging Services in West Jordan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in West Jordan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in West Jordan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Jordan Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Jordan Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Jordan Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Jordan Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingWestJordanPage;