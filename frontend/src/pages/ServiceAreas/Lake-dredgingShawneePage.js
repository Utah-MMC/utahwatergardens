...
const Lake-dredgingShawneePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Shawnee | Professional Lake Dredging Services"
        description="Expert lake dredging services in Shawnee. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, shawnee lake dredging, lake dredging shawnee"
        canonical="https://utahwatergardens.com/lake-dredging-shawnee"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Shawnee",
          "description": "Professional lake dredging services in Shawnee",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Shawnee"
        subtitle="Professional pond services for Lake Dredging Services in Shawnee and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Shawnee"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Shawnee</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Shawnee Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Shawnee Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Shawnee Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Shawnee Customers Say About Our Lake Dredging</h2>
