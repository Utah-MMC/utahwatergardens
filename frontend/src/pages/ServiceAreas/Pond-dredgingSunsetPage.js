...
const Pond-dredgingSunsetPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Sunset | Professional Pond Dredging Services"
        description="Expert pond dredging services in Sunset. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, sunset pond dredging, pond dredging sunset"
        canonical="https://utahwatergardens.com/pond-dredging-sunset"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Sunset",
          "description": "Professional pond dredging services in Sunset",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Sunset"
        subtitle="Professional pond services for Pond Dredging Services in Sunset and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Sunset"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Sunset</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sunset Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sunset Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sunset Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sunset Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSunsetPage;