...
const Pond-repairWoodsCrossPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Woods Cross | Professional Pond Repair Services"
        description="Expert pond repair services in Woods Cross. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, woods cross pond repair, pond repair woods cross"
        canonical="https://utahwatergardens.com/pond-repair-woods-cross"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Woods Cross",
          "description": "Professional pond repair services in Woods Cross",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Woods Cross"
        subtitle="Professional pond services for Pond Repair Services in Woods Cross and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Woods Cross"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Woods Cross</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Woods Cross Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Woods Cross Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Woods Cross Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Woods Cross Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWoodsCrossPage;