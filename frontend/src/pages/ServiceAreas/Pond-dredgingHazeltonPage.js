...
const Pond-dredgingHazeltonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Hazelton | Professional Pond Dredging Services"
        description="Expert pond dredging services in Hazelton. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, hazelton pond dredging, pond dredging hazelton"
        canonical="https://utahwatergardens.com/pond-dredging-hazelton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Hazelton",
          "description": "Professional pond dredging services in Hazelton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Hazelton"
        subtitle="Professional pond services for Pond Dredging Services in Hazelton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Hazelton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Hazelton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Hazelton Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Hazelton Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Hazelton Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Hazelton Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHazeltonPage;