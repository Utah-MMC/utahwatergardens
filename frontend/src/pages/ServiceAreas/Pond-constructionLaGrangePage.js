...
const Pond-constructionLaGrangePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction La Grange | Professional Pond Construction Services"
        description="Expert pond construction services in La Grange. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, la grange pond construction, pond construction la grange"
        canonical="https://utahwatergardens.com/pond-construction-la-grange"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services La Grange",
          "description": "Professional pond construction services in La Grange",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in La Grange"
        subtitle="Professional pond services for Pond Construction Services in La Grange and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in La Grange"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in La Grange</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our La Grange Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="La Grange Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our La Grange Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What La Grange Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionLaGrangePage;