...
const Pond-maintenanceAlamoPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Alamo | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Alamo. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, alamo pond maintenance, pond maintenance alamo"
        canonical="https://utahwatergardens.com/pond-maintenance-alamo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Alamo",
          "description": "Professional pond maintenance services in Alamo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Alamo"
        subtitle="Professional pond services for Pond Maintenance Services in Alamo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Alamo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Alamo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Alamo Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Alamo Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Alamo Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Alamo Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceAlamoPage;