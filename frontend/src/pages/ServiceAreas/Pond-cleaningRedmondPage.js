...
const Pond-cleaningRedmondPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Redmond | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Redmond. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, redmond pond cleaning, pond cleaning redmond"
        canonical="https://utahwatergardens.com/pond-cleaning-redmond"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Redmond",
          "description": "Professional pond cleaning services in Redmond",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Redmond"
        subtitle="Professional pond services for Pond Cleaning Services in Redmond and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Redmond"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Redmond</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Redmond Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Redmond Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Redmond Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Redmond Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningRedmondPage;