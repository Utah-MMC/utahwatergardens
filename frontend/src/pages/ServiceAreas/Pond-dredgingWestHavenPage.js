...
const Pond-dredgingWestHavenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging West Haven | Professional Pond Dredging Services"
        description="Expert pond dredging services in West Haven. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, west haven pond dredging, pond dredging west haven"
        canonical="https://utahwatergardens.com/pond-dredging-west-haven"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services West Haven",
          "description": "Professional pond dredging services in West Haven",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in West Haven"
        subtitle="Professional pond services for Pond Dredging Services in West Haven and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in West Haven"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in West Haven</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Haven Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Haven Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Haven Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Haven Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWestHavenPage;