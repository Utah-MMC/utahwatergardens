...
const Pond-repairDeweyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Dewey | Professional Pond Repair Services"
        description="Expert pond repair services in Dewey. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, dewey pond repair, pond repair dewey"
        canonical="https://utahwatergardens.com/pond-repair-dewey"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Dewey",
          "description": "Professional pond repair services in Dewey",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Dewey"
        subtitle="Professional pond services for Pond Repair Services in Dewey and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Dewey"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Dewey</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Dewey Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Dewey Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Dewey Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Dewey Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDeweyPage;