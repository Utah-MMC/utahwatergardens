...
const Pond-maintenanceSouthOgdenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance South Ogden | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in South Ogden. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, south ogden pond maintenance, pond maintenance south ogden"
        canonical="https://utahwatergardens.com/pond-maintenance-south-ogden"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services South Ogden",
          "description": "Professional pond maintenance services in South Ogden",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in South Ogden"
        subtitle="Professional pond services for Pond Maintenance Services in South Ogden and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in South Ogden"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in South Ogden</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Ogden Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Ogden Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Ogden Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Ogden Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceSouthOgdenPage;