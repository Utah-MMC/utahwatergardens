...
const Lake-dredgingBurleyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Burley | Professional Lake Dredging Services"
        description="Expert lake dredging services in Burley. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, burley lake dredging, lake dredging burley"
        canonical="https://utahwatergardens.com/lake-dredging-burley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Burley",
          "description": "Professional lake dredging services in Burley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Burley"
        subtitle="Professional pond services for Lake Dredging Services in Burley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Burley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Burley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Burley Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Burley Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Burley Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Burley Customers Say About Our Lake Dredging</h2>
