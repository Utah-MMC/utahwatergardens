...
const Pond-repairSalemPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Salem | Professional Pond Repair Services"
        description="Expert pond repair services in Salem. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, salem pond repair, pond repair salem"
        canonical="https://utahwatergardens.com/pond-repair-salem"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Salem",
          "description": "Professional pond repair services in Salem",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Salem"
        subtitle="Professional pond services for Pond Repair Services in Salem and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Salem"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Salem</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Salem Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Salem Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Salem Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Salem Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSalemPage;