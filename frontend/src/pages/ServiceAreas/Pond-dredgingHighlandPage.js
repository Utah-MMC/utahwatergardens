...
const Pond-dredgingHighlandPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Highland | Professional Pond Dredging Services"
        description="Expert pond dredging services in Highland. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, highland pond dredging, pond dredging highland"
        canonical="https://utahwatergardens.com/pond-dredging-highland"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Highland",
          "description": "Professional pond dredging services in Highland",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Highland"
        subtitle="Professional pond services for Pond Dredging Services in Highland and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Highland"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Highland</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Highland Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Highland Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Highland Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Highland Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingHighlandPage;