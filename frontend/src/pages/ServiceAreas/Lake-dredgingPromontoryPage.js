...
const Lake-dredgingPromontoryPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Promontory | Professional Lake Dredging Services"
        description="Expert lake dredging services in Promontory. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, promontory lake dredging, lake dredging promontory"
        canonical="https://utahwatergardens.com/lake-dredging-promontory"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Promontory",
          "description": "Professional lake dredging services in Promontory",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Promontory"
        subtitle="Professional pond services for Lake Dredging Services in Promontory and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Promontory"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Promontory</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Promontory Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Promontory Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Promontory Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Promontory Customers Say About Our Lake Dredging</h2>
