...
const HarvestingRupertPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Rupert | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Rupert. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, rupert aquatic plant harvesting, aquatic plant harvesting rupert"
        canonical="https://utahwatergardens.com/harvesting-rupert"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Rupert",
          "description": "Professional aquatic plant harvesting services in Rupert",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Rupert"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Rupert and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Rupert"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Rupert</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rupert Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rupert Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rupert Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rupert Customers Say About Our Aquatic Plant Harvesting</h2>
