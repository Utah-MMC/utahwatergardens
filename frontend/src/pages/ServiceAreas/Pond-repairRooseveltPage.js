...
const Pond-repairRooseveltPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Roosevelt | Professional Pond Repair Services"
        description="Expert pond repair services in Roosevelt. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, roosevelt pond repair, pond repair roosevelt"
        canonical="https://utahwatergardens.com/pond-repair-roosevelt"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Roosevelt",
          "description": "Professional pond repair services in Roosevelt",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Roosevelt"
        subtitle="Professional pond services for Pond Repair Services in Roosevelt and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Roosevelt"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Roosevelt</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Roosevelt Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Roosevelt Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Roosevelt Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Roosevelt Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRooseveltPage;