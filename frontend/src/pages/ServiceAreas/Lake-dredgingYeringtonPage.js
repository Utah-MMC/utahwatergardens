...
const Lake-dredgingYeringtonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Yerington | Professional Lake Dredging Services"
        description="Expert lake dredging services in Yerington. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, yerington lake dredging, lake dredging yerington"
        canonical="https://utahwatergardens.com/lake-dredging-yerington"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Yerington",
          "description": "Professional lake dredging services in Yerington",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Yerington"
        subtitle="Professional pond services for Lake Dredging Services in Yerington and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Yerington"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Yerington</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Yerington Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Yerington Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Yerington Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Yerington Customers Say About Our Lake Dredging</h2>
