...
const Pond-repairCastlefordPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Castleford | Professional Pond Repair Services"
        description="Expert pond repair services in Castleford. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, castleford pond repair, pond repair castleford"
        canonical="https://utahwatergardens.com/pond-repair-castleford"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Castleford",
          "description": "Professional pond repair services in Castleford",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Castleford"
        subtitle="Professional pond services for Pond Repair Services in Castleford and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Castleford"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Castleford</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Castleford Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Castleford Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Castleford Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Castleford Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCastlefordPage;