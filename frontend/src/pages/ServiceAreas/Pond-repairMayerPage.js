...
const Pond-repairMayerPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Mayer | Professional Pond Repair Services"
        description="Expert pond repair services in Mayer. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, mayer pond repair, pond repair mayer"
        canonical="https://utahwatergardens.com/pond-repair-mayer"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Mayer",
          "description": "Professional pond repair services in Mayer",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Mayer"
        subtitle="Professional pond services for Pond Repair Services in Mayer and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Mayer"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Mayer</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Mayer Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Mayer Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Mayer Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Mayer Customers Say About Our Pond Repair</h2>
...
export default Pond-repairMayerPage;