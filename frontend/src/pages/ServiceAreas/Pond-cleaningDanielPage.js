...
const Pond-cleaningDanielPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Daniel | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Daniel. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, daniel pond cleaning, pond cleaning daniel"
        canonical="https://utahwatergardens.com/pond-cleaning-daniel"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Daniel",
          "description": "Professional pond cleaning services in Daniel",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Daniel"
        subtitle="Professional pond services for Pond Cleaning Services in Daniel and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Daniel"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Daniel</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Daniel Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Daniel Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Daniel Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Daniel Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningDanielPage;