...
const Pond-dredgingWestPointPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging West Point | Professional Pond Dredging Services"
        description="Expert pond dredging services in West Point. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, west point pond dredging, pond dredging west point"
        canonical="https://utahwatergardens.com/pond-dredging-west-point"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services West Point",
          "description": "Professional pond dredging services in West Point",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in West Point"
        subtitle="Professional pond services for Pond Dredging Services in West Point and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in West Point"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in West Point</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Point Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Point Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Point Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Point Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingWestPointPage;