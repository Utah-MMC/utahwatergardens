...
const Pond-dredgingIvinsPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Ivins | Professional Pond Dredging Services"
        description="Expert pond dredging services in Ivins. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, ivins pond dredging, pond dredging ivins"
        canonical="https://utahwatergardens.com/pond-dredging-ivins"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Ivins",
          "description": "Professional pond dredging services in Ivins",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Ivins"
        subtitle="Professional pond services for Pond Dredging Services in Ivins and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Ivins"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Ivins</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ivins Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ivins Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ivins Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ivins Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingIvinsPage;