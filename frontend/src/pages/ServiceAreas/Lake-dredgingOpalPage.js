...
const Lake-dredgingOpalPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Opal | Professional Lake Dredging Services"
        description="Expert lake dredging services in Opal. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, opal lake dredging, lake dredging opal"
        canonical="https://utahwatergardens.com/lake-dredging-opal"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Opal",
          "description": "Professional lake dredging services in Opal",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Opal"
        subtitle="Professional pond services for Lake Dredging Services in Opal and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Opal"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Opal</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Opal Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Opal Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Opal Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Opal Customers Say About Our Lake Dredging</h2>
