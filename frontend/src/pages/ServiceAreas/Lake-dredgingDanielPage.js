...
const Lake-dredgingDanielPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Daniel | Professional Lake Dredging Services"
        description="Expert lake dredging services in Daniel. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, daniel lake dredging, lake dredging daniel"
        canonical="https://utahwatergardens.com/lake-dredging-daniel"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Daniel",
          "description": "Professional lake dredging services in Daniel",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Daniel"
        subtitle="Professional pond services for Lake Dredging Services in Daniel and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Daniel"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Daniel</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Daniel Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Daniel Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Daniel Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Daniel Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingDanielPage;