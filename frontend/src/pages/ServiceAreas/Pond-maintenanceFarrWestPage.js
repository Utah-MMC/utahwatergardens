...
const Pond-maintenanceFarrWestPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Farr West | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Farr West. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, farr west pond maintenance, pond maintenance farr west"
        canonical="https://utahwatergardens.com/pond-maintenance-farr-west"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Farr West",
          "description": "Professional pond maintenance services in Farr West",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Farr West"
        subtitle="Professional pond services for Pond Maintenance Services in Farr West and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Farr West"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Farr West</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farr West Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farr West Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farr West Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farr West Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceFarrWestPage;