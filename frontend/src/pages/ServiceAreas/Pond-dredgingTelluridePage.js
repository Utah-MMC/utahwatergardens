...
const Pond-dredgingTelluridePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Telluride | Professional Pond Dredging Services"
        description="Expert pond dredging services in Telluride. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, telluride pond dredging, pond dredging telluride"
        canonical="https://utahwatergardens.com/pond-dredging-telluride"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Telluride",
          "description": "Professional pond dredging services in Telluride",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Telluride"
        subtitle="Professional pond services for Pond Dredging Services in Telluride and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Telluride"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Telluride</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Telluride Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Telluride Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Telluride Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Telluride Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingTelluridePage;