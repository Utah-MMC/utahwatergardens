...
const Pond-repairWestHavenPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair West Haven | Professional Pond Repair Services"
        description="Expert pond repair services in West Haven. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, west haven pond repair, pond repair west haven"
        canonical="https://utahwatergardens.com/pond-repair-west-haven"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services West Haven",
          "description": "Professional pond repair services in West Haven",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in West Haven"
        subtitle="Professional pond services for Pond Repair Services in West Haven and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in West Haven"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in West Haven</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our West Haven Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="West Haven Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our West Haven Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What West Haven Customers Say About Our Pond Repair</h2>
...
export default Pond-repairWestHavenPage;