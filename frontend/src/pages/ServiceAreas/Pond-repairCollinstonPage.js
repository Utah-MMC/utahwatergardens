...
const Pond-repairCollinstonPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Collinston | Professional Pond Repair Services"
        description="Expert pond repair services in Collinston. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, collinston pond repair, pond repair collinston"
        canonical="https://utahwatergardens.com/pond-repair-collinston"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Collinston",
          "description": "Professional pond repair services in Collinston",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Collinston"
        subtitle="Professional pond services for Pond Repair Services in Collinston and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Collinston"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Collinston</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Collinston Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Collinston Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Collinston Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Collinston Customers Say About Our Pond Repair</h2>
...
export default Pond-repairCollinstonPage;