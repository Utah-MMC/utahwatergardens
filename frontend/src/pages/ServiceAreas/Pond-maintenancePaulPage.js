...
const Pond-maintenancePaulPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance Paul | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in Paul. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, paul pond maintenance, pond maintenance paul"
        canonical="https://utahwatergardens.com/pond-maintenance-paul"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services Paul",
          "description": "Professional pond maintenance services in Paul",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in Paul"
        subtitle="Professional pond services for Pond Maintenance Services in Paul and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in Paul"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in Paul</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Paul Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Paul Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Paul Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Paul Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenancePaulPage;