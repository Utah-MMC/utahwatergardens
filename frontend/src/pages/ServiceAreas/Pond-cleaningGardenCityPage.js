...
const Pond-cleaningGardenCityPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Garden City | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Garden City. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, garden city pond cleaning, pond cleaning garden city"
        canonical="https://utahwatergardens.com/pond-cleaning-garden-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Garden City",
          "description": "Professional pond cleaning services in Garden City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Garden City"
        subtitle="Professional pond services for Pond Cleaning Services in Garden City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Garden City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Garden City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Garden City Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Garden City Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Garden City Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Garden City Customers Say About Our Pond Cleaning</h2>
