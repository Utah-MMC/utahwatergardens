...
const Lake-dredgingNorthSaltLakePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging North Salt Lake | Professional Lake Dredging Services"
        description="Expert lake dredging services in North Salt Lake. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, north salt lake lake dredging, lake dredging north salt lake"
        canonical="https://utahwatergardens.com/lake-dredging-north-salt-lake"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services North Salt Lake",
          "description": "Professional lake dredging services in North Salt Lake",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in North Salt Lake"
        subtitle="Professional pond services for Lake Dredging Services in North Salt Lake and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in North Salt Lake"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in North Salt Lake</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our North Salt Lake Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="North Salt Lake Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our North Salt Lake Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What North Salt Lake Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingNorthSaltLakePage;