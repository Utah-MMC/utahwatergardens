  ...
  return (
    <div className="service-area-page">
      <PageHero 
        ...
        subtitle="Professional pond services for Payson and surrounding Utah County areas"
      ...
      <div className="container">
        ...
        >
          <h2>Ready to Get Started in Payson?</h2>
          <p>Contact us today for a free consultation and quote on your Payson pond project.</p>
