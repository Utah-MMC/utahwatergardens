...
const Pond-constructionVanTassellPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Van Tassell | Professional Pond Construction Services"
        description="Expert pond construction services in Van Tassell. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, van tassell pond construction, pond construction van tassell"
        canonical="https://utahwatergardens.com/pond-construction-van-tassell"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Van Tassell",
          "description": "Professional pond construction services in Van Tassell",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Van Tassell"
        subtitle="Professional pond services for Pond Construction Services in Van Tassell and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Van Tassell"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Van Tassell</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Van Tassell Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Van Tassell Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Van Tassell Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Van Tassell Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionVanTassellPage;