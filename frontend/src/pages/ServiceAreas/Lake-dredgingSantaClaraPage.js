...
const Lake-dredgingSantaClaraPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Santa Clara | Professional Lake Dredging Services"
        description="Expert lake dredging services in Santa Clara. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, santa clara lake dredging, lake dredging santa clara"
        canonical="https://utahwatergardens.com/lake-dredging-santa-clara"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Santa Clara",
          "description": "Professional lake dredging services in Santa Clara",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Santa Clara"
        subtitle="Professional pond services for Lake Dredging Services in Santa Clara and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Santa Clara"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Santa Clara</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Santa Clara Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Santa Clara Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Santa Clara Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Santa Clara Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingSantaClaraPage;