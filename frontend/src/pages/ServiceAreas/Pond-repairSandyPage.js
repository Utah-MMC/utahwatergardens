...
const Pond-repairSandyPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Sandy | Professional Pond Repair Services"
        description="Expert pond repair services in Sandy. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, sandy pond repair, pond repair sandy"
        canonical="https://utahwatergardens.com/pond-repair-sandy"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Sandy",
          "description": "Professional pond repair services in Sandy",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Sandy"
        subtitle="Professional pond services for Pond Repair Services in Sandy and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Sandy"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Sandy</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Sandy Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Sandy Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Sandy Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Sandy Customers Say About Our Pond Repair</h2>
...
export default Pond-repairSandyPage;