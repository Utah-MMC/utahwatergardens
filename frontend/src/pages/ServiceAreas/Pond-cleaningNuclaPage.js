...
const Pond-cleaningNuclaPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Nucla | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Nucla. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, nucla pond cleaning, pond cleaning nucla"
        canonical="https://utahwatergardens.com/pond-cleaning-nucla"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Nucla",
          "description": "Professional pond cleaning services in Nucla",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Nucla"
        subtitle="Professional pond services for Pond Cleaning Services in Nucla and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Nucla"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Nucla</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Nucla Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Nucla Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Nucla Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Nucla Customers Say About Our Pond Cleaning</h2>
