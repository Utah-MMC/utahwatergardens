...
const Pond-constructionCarlinPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Carlin | Professional Pond Construction Services"
        description="Expert pond construction services in Carlin. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, carlin pond construction, pond construction carlin"
        canonical="https://utahwatergardens.com/pond-construction-carlin"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Carlin",
          "description": "Professional pond construction services in Carlin",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Carlin"
        subtitle="Professional pond services for Pond Construction Services in Carlin and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Carlin"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Carlin</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Carlin Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Carlin Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Carlin Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Carlin Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionCarlinPage;