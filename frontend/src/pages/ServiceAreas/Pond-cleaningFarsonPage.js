...
const Pond-cleaningFarsonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Farson | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Farson. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, farson pond cleaning, pond cleaning farson"
        canonical="https://utahwatergardens.com/pond-cleaning-farson"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Farson",
          "description": "Professional pond cleaning services in Farson",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Farson"
        subtitle="Professional pond services for Pond Cleaning Services in Farson and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Farson"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Farson</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Farson Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Farson Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Farson Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Farson Customers Say About Our Pond Cleaning</h2>
...
export default Pond-cleaningFarsonPage;