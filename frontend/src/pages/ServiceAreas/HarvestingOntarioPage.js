...
const HarvestingOntarioPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Aquatic Plant Harvesting Ontario | Professional Aquatic Plant Harvesting Services"
        description="Expert aquatic plant harvesting services in Ontario. Professional aquatic plant harvesting and management services Licensed & insured. Call (801) 590-8516."
        keywords="aquatic plant harvesting, pond plant management, water plant removal, plant control, ontario aquatic plant harvesting, aquatic plant harvesting ontario"
        canonical="https://utahwatergardens.com/harvesting-ontario"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Aquatic Plant Harvesting Services Ontario",
          "description": "Professional aquatic plant harvesting services in Ontario",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Aquatic Plant Harvesting Services in Ontario"
        subtitle="Professional pond services for Aquatic Plant Harvesting Services in Ontario and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Aquatic Plant Harvesting Services in Ontario"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Aquatic Plant Harvesting in Ontario</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Ontario Aquatic Plant Harvesting?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Ontario Aquatic Plant Harvesting Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Ontario Aquatic Plant Harvesting Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Ontario Customers Say About Our Aquatic Plant Harvesting</h2>
