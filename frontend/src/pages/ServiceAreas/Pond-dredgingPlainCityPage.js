...
const Pond-dredgingPlainCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Plain City | Professional Pond Dredging Services"
        description="Expert pond dredging services in Plain City. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, plain city pond dredging, pond dredging plain city"
        canonical="https://utahwatergardens.com/pond-dredging-plain-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Plain City",
          "description": "Professional pond dredging services in Plain City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Plain City"
        subtitle="Professional pond services for Pond Dredging Services in Plain City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Plain City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Plain City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Plain City Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Plain City Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Plain City Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Plain City Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingPlainCityPage;