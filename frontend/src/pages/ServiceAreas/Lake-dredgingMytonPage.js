...
const Lake-dredgingMytonPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Myton | Professional Lake Dredging Services"
        description="Expert lake dredging services in Myton. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, myton lake dredging, lake dredging myton"
        canonical="https://utahwatergardens.com/lake-dredging-myton"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Myton",
          "description": "Professional lake dredging services in Myton",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Myton"
        subtitle="Professional pond services for Lake Dredging Services in Myton and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Myton"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Myton</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Myton Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Myton Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Myton Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Myton Customers Say About Our Lake Dredging</h2>
