...
const Pond-repairElkRidgePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Elk Ridge | Professional Pond Repair Services"
        description="Expert pond repair services in Elk Ridge. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, elk ridge pond repair, pond repair elk ridge"
        canonical="https://utahwatergardens.com/pond-repair-elk-ridge"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Elk Ridge",
          "description": "Professional pond repair services in Elk Ridge",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Elk Ridge"
        subtitle="Professional pond services for Pond Repair Services in Elk Ridge and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Elk Ridge"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Elk Ridge</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Elk Ridge Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Elk Ridge Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Elk Ridge Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Elk Ridge Customers Say About Our Pond Repair</h2>
...
export default Pond-repairElkRidgePage;