...
const Lake-dredgingBrianHeadPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Brian Head | Professional Lake Dredging Services"
        description="Expert lake dredging services in Brian Head. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, brian head lake dredging, lake dredging brian head"
        canonical="https://utahwatergardens.com/lake-dredging-brian-head"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Brian Head",
          "description": "Professional lake dredging services in Brian Head",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Brian Head"
        subtitle="Professional pond services for Lake Dredging Services in Brian Head and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Brian Head"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Brian Head</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Brian Head Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Brian Head Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Brian Head Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Brian Head Customers Say About Our Lake Dredging</h2>
