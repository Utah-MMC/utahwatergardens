...
const Lake-dredgingSt.GeorgePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging St. George | Professional Lake Dredging Services"
        description="Expert lake dredging services in St. George. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, st. george lake dredging, lake dredging st. george"
        canonical="https://utahwatergardens.com/lake-dredging-st.-george"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services St. George",
          "description": "Professional lake dredging services in St. George",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in St. George"
        subtitle="Professional pond services for Lake Dredging Services in St. George and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in St. George"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in St. George</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our St. George Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="St. George Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our St. George Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What St. George Customers Say About Our Lake Dredging</h2>
