...
const Pond-maintenanceNewRiverPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Maintenance New River | Professional Pond Maintenance Services"
        description="Expert pond maintenance services in New River. Professional pond maintenance and care services for your water feature Licensed & insured. Call (801) 590-8516."
        keywords="pond maintenance, pond care, pond service, water feature maintenance, new river pond maintenance, pond maintenance new river"
        canonical="https://utahwatergardens.com/pond-maintenance-new-river"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Maintenance Services New River",
          "description": "Professional pond maintenance services in New River",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Maintenance Services in New River"
        subtitle="Professional pond services for Pond Maintenance Services in New River and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Maintenance Services in New River"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Maintenance in New River</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our New River Pond Maintenance?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="New River Pond Maintenance Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our New River Pond Maintenance Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What New River Customers Say About Our Pond Maintenance</h2>
...
export default Pond-maintenanceNewRiverPage;