...
const Pond-repairShawneePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Shawnee | Professional Pond Repair Services"
        description="Expert pond repair services in Shawnee. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, shawnee pond repair, pond repair shawnee"
        canonical="https://utahwatergardens.com/pond-repair-shawnee"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Shawnee",
          "description": "Professional pond repair services in Shawnee",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Shawnee"
        subtitle="Professional pond services for Pond Repair Services in Shawnee and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Shawnee"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Shawnee</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Shawnee Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Shawnee Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Shawnee Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Shawnee Customers Say About Our Pond Repair</h2>
...
export default Pond-repairShawneePage;