...
const Pond-cleaningSamakPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Samak | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Samak. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, samak pond cleaning, pond cleaning samak"
        canonical="https://utahwatergardens.com/pond-cleaning-samak"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Samak",
          "description": "Professional pond cleaning services in Samak",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Samak"
        subtitle="Professional pond services for Pond Cleaning Services in Samak and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Samak"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Samak</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Samak Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Samak Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Samak Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Samak Customers Say About Our Pond Cleaning</h2>
