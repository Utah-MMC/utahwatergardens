...
const Lake-dredgingEagleMountainPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Eagle Mountain | Professional Lake Dredging Services"
        description="Expert lake dredging services in Eagle Mountain. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, eagle mountain lake dredging, lake dredging eagle mountain"
        canonical="https://utahwatergardens.com/lake-dredging-eagle-mountain"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Eagle Mountain",
          "description": "Professional lake dredging services in Eagle Mountain",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Eagle Mountain"
        subtitle="Professional pond services for Lake Dredging Services in Eagle Mountain and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Eagle Mountain"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Eagle Mountain</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Eagle Mountain Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Eagle Mountain Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Eagle Mountain Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Eagle Mountain Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingEagleMountainPage;