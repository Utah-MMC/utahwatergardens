...
const Lake-dredgingDecloPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Declo | Professional Lake Dredging Services"
        description="Expert lake dredging services in Declo. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, declo lake dredging, lake dredging declo"
        canonical="https://utahwatergardens.com/lake-dredging-declo"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Declo",
          "description": "Professional lake dredging services in Declo",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Declo"
        subtitle="Professional pond services for Lake Dredging Services in Declo and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Declo"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Declo</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Declo Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Declo Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Declo Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Declo Customers Say About Our Lake Dredging</h2>
...
export default Lake-dredgingDecloPage;