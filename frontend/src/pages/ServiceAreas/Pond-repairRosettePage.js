...
const Pond-repairRosettePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Rosette | Professional Pond Repair Services"
        description="Expert pond repair services in Rosette. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, rosette pond repair, pond repair rosette"
        canonical="https://utahwatergardens.com/pond-repair-rosette"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Rosette",
          "description": "Professional pond repair services in Rosette",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Rosette"
        subtitle="Professional pond services for Pond Repair Services in Rosette and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Rosette"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Rosette</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Rosette Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Rosette Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Rosette Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Rosette Customers Say About Our Pond Repair</h2>
...
export default Pond-repairRosettePage;