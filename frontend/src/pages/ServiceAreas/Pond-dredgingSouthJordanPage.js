...
const Pond-dredgingSouthJordanPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging South Jordan | Professional Pond Dredging Services"
        description="Expert pond dredging services in South Jordan. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, south jordan pond dredging, pond dredging south jordan"
        canonical="https://utahwatergardens.com/pond-dredging-south-jordan"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services South Jordan",
          "description": "Professional pond dredging services in South Jordan",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in South Jordan"
        subtitle="Professional pond services for Pond Dredging Services in South Jordan and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in South Jordan"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in South Jordan</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our South Jordan Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="South Jordan Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our South Jordan Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What South Jordan Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSouthJordanPage;