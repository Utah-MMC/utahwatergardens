...
const Pond-repairBearRiverCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Bear River City | Professional Pond Repair Services"
        description="Expert pond repair services in Bear River City. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, bear river city pond repair, pond repair bear river city"
        canonical="https://utahwatergardens.com/pond-repair-bear-river-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Bear River City",
          "description": "Professional pond repair services in Bear River City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Bear River City"
        subtitle="Professional pond services for Pond Repair Services in Bear River City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Bear River City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Bear River City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Bear River City Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Bear River City Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Bear River City Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Bear River City Customers Say About Our Pond Repair</h2>
...
export default Pond-repairBearRiverCityPage;