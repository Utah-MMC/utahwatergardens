...
const Pond-cleaningTonopahPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Tonopah | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Tonopah. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, tonopah pond cleaning, pond cleaning tonopah"
        canonical="https://utahwatergardens.com/pond-cleaning-tonopah"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Tonopah",
          "description": "Professional pond cleaning services in Tonopah",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Tonopah"
        subtitle="Professional pond services for Pond Cleaning Services in Tonopah and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Tonopah"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Tonopah</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Tonopah Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Tonopah Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Tonopah Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Tonopah Customers Say About Our Pond Cleaning</h2>
