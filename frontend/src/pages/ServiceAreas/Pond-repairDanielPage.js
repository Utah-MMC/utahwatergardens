...
const Pond-repairDanielPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Daniel | Professional Pond Repair Services"
        description="Expert pond repair services in Daniel. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, daniel pond repair, pond repair daniel"
        canonical="https://utahwatergardens.com/pond-repair-daniel"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Daniel",
          "description": "Professional pond repair services in Daniel",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Daniel"
        subtitle="Professional pond services for Pond Repair Services in Daniel and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Daniel"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Daniel</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Daniel Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Daniel Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Daniel Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Daniel Customers Say About Our Pond Repair</h2>
...
export default Pond-repairDanielPage;