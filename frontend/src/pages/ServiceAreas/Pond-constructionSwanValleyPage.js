...
const Pond-constructionSwanValleyPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Construction Swan Valley | Professional Pond Construction Services"
        description="Expert pond construction services in Swan Valley. Custom pond design and construction services for your property Licensed & insured. Call (801) 590-8516."
        keywords="pond construction, custom pond design, koi pond construction, water feature installation, swan valley pond construction, pond construction swan valley"
        canonical="https://utahwatergardens.com/pond-construction-swan-valley"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Construction Services Swan Valley",
          "description": "Professional pond construction services in Swan Valley",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Construction Services in Swan Valley"
        subtitle="Professional pond services for Pond Construction Services in Swan Valley and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Construction Services in Swan Valley"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Construction in Swan Valley</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Swan Valley Pond Construction?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Swan Valley Pond Construction Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Swan Valley Pond Construction Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Swan Valley Customers Say About Our Pond Construction</h2>
...
export default Pond-constructionSwanValleyPage;