...
const Pond-dredgingSurprisePage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Dredging Surprise | Professional Pond Dredging Services"
        description="Expert pond dredging services in Surprise. Professional pond dredging services to restore water depth and quality Licensed & insured. Call (801) 590-8516."
        keywords="pond dredging, pond excavation, pond restoration, sediment removal, surprise pond dredging, pond dredging surprise"
        canonical="https://utahwatergardens.com/pond-dredging-surprise"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Dredging Services Surprise",
          "description": "Professional pond dredging services in Surprise",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Dredging Services in Surprise"
        subtitle="Professional pond services for Pond Dredging Services in Surprise and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Dredging Services in Surprise"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Dredging in Surprise</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Surprise Pond Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Surprise Pond Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Surprise Pond Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Surprise Customers Say About Our Pond Dredging</h2>
...
export default Pond-dredgingSurprisePage;