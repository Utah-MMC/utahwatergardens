...
const Pond-repairPlainCityPage = () => {
  const services = [
    {
  ...
  return (
    <>
      <SEO 
        title="Pond Repair Plain City | Professional Pond Repair Services"
        description="Expert pond repair services in Plain City. Professional pond repair and equipment maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond repair, pond pump repair, pond filter repair, pond liner repair, plain city pond repair, pond repair plain city"
        canonical="https://utahwatergardens.com/pond-repair-plain-city"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Repair Services Plain City",
          "description": "Professional pond repair services in Plain City",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Repair Services in Plain City"
        subtitle="Professional pond services for Pond Repair Services in Plain City and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Repair Services in Plain City"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Repair in Plain City</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Plain City Pond Repair?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Plain City Pond Repair Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Plain City Pond Repair Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Plain City Customers Say About Our Pond Repair</h2>
...
export default Pond-repairPlainCityPage;