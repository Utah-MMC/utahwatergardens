...
const Lake-dredgingPocatelloPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Lake Dredging Pocatello | Professional Lake Dredging Services"
        description="Expert lake dredging services in Pocatello. Professional lake dredging services for large water bodies Licensed & insured. Call (801) 590-8516."
        keywords="lake dredging, lake restoration, lake excavation, sediment removal, lake maintenance, pocatello lake dredging, lake dredging pocatello"
        canonical="https://utahwatergardens.com/lake-dredging-pocatello"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Lake Dredging Services Pocatello",
          "description": "Professional lake dredging services in Pocatello",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Lake Dredging Services in Pocatello"
        subtitle="Professional pond services for Lake Dredging Services in Pocatello and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Lake Dredging Services in Pocatello"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Lake Dredging in Pocatello</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Pocatello Lake Dredging?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Pocatello Lake Dredging Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Pocatello Lake Dredging Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Pocatello Customers Say About Our Lake Dredging</h2>
