...
const Pond-cleaningScottsdalePage = () => {
  ...
  return (
    <>
      <SEO 
        title="Pond Cleaning Scottsdale | Professional Pond Cleaning Services"
        description="Expert pond cleaning services in Scottsdale. Professional pond cleaning and maintenance services Licensed & insured. Call (801) 590-8516."
        keywords="pond cleaning, pond cleaning services, algae removal, pond maintenance, scottsdale pond cleaning, pond cleaning scottsdale"
        canonical="https://utahwatergardens.com/pond-cleaning-scottsdale"
      />
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Pond Cleaning Services Scottsdale",
          "description": "Professional pond cleaning services in Scottsdale",
          "provider": {
            "@type": "LocalBusiness",
      ...
      <div className="service-area-page">
        <StandardHero 
        title="Pond Cleaning Services in Scottsdale"
        subtitle="Professional pond services for Pond Cleaning Services in Scottsdale and surrounding areas"
        backgroundImage="/images/IMG_8910-rotated-topaz-enhance-2.1x.jpeg"
        backgroundImageAlt="Professional pond services in Pond Cleaning Services in Scottsdale"
      ...
      />
        ...
        <div className="container">
          ...
          <section className="location-overview first-section-gradient">
            <h2>Professional Pond Cleaning in Scottsdale</h2>
            <p>
            ...
            <div className="location-details">
              <div className="location-info">
                <h3>Why Choose Our Scottsdale Pond Cleaning?</h3>
                <ul>
              ...
              <div className="location-map">
                <iframe
                  ...
                  title="Scottsdale Pond Cleaning Service Area"
                ></iframe>
          ...
          <section className="services-section">
            <h2>Our Scottsdale Pond Cleaning Services</h2>
          ...
          <section className="testimonials-section">
            <h2>What Scottsdale Customers Say About Our Pond Cleaning</h2>
